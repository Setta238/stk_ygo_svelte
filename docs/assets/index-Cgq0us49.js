var ba=Object.defineProperty;var _a=(n,e,t)=>e in n?ba(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var l=(n,e,t)=>_a(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const qn=!1;var Jn=Array.isArray,Fa=Array.prototype.indexOf,ei=Array.from,Oi=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,Zi=Object.getOwnPropertyDescriptors,Ha=Object.prototype,Ka=Array.prototype,ti=Object.getPrototypeOf;function Sa(n){return typeof n=="function"}const Ze=()=>{};function Wa(n){return typeof(n==null?void 0:n.then)=="function"}function Pa(n){return n()}function Ln(n){for(var e=0;e<n.length;e++)n[e]()}const We=2,Ii=4,yn=8,vn=16,rt=32,Xt=64,kn=128,Se=256,mn=512,Me=1024,st=2048,qt=4096,it=8192,gn=16384,Ui=32768,Bn=65536,ji=1<<17,qa=1<<19,$i=1<<20,at=Symbol("$state"),La=Symbol("legacy props"),Ra=Symbol("");function Yi(n){return n===this.v}function zi(n,e){return n!=n?e==e:n!==e||n!==null&&typeof n=="object"||typeof n=="function"}function ni(n){return!zi(n,this.v)}function Oa(n){throw new Error("https://svelte.dev/e/effect_in_teardown")}function Za(){throw new Error("https://svelte.dev/e/effect_in_unowned_derived")}function Ia(n){throw new Error("https://svelte.dev/e/effect_orphan")}function Ua(){throw new Error("https://svelte.dev/e/effect_update_depth_exceeded")}function ja(n){throw new Error("https://svelte.dev/e/props_invalid_value")}function $a(){throw new Error("https://svelte.dev/e/state_descriptors_fixed")}function Ya(){throw new Error("https://svelte.dev/e/state_prototype_fixed")}function za(){throw new Error("https://svelte.dev/e/state_unsafe_local_read")}function Va(){throw new Error("https://svelte.dev/e/state_unsafe_mutation")}let Jt=!1,Ga=!1;function Qa(){Jt=!0}const ii=1,ai=2,Vi=4,Xa=8,Ja=16,er=1,tr=2,nr=4,ir=8,ar=16,rr=1,sr=2,or=4,Ar=1,lr=2,Be=Symbol();let De=null;function un(n){De=n}function Ne(n,e=!1,t){De={p:De,c:null,e:null,m:!1,s:n,x:null,l:null},Jt&&!e&&(De.l={s:null,u:null,r1:[],r2:Ee(!1)})}function be(n){const e=De;if(e!==null){const o=e.e;if(o!==null){var t=de,i=ce;e.e=null;try{for(var a=0;a<o.length;a++){var r=o[a];qe(r.effect),Pe(r.reaction),Ot(r.fn)}}finally{qe(t),Pe(i)}}De=e.p,e.m=!0}return{}}function Lt(){return!Jt||De!==null&&De.l===null}function Ee(n,e){var t={f:0,v:n,reactions:null,equals:Yi,rv:0,wv:0};return t}function dr(n){return Gi(Ee(n))}function Wt(n,e=!1){var i;const t=Ee(n);return e||(t.equals=ni),Jt&&De!==null&&De.l!==null&&((i=De.l).s??(i.s=[])).push(t),t}function Ce(n,e=!1){return Gi(Wt(n,e))}function Gi(n){return ce!==null&&!Ye&&ce.f&We&&(ze===null?yr([n]):ze.push(n)),n}function Fe(n,e){return G(n,Ve(()=>A(n))),e}function G(n,e){return ce!==null&&!Ye&&Lt()&&ce.f&(We|vn)&&(ze===null||!ze.includes(n))&&Va(),kt(n,e)}function kt(n,e){return n.equals(e)||(n.v,n.v=e,n.wv=ma(),Qi(n,st),Lt()&&de!==null&&de.f&Me&&!(de.f&(rt|Xt))&&(Je===null?vr([n]):Je.push(n))),e}function Qi(n,e){var t=n.reactions;if(t!==null)for(var i=Lt(),a=t.length,r=0;r<a;r++){var o=t[r],s=o.f;s&st||!i&&o===de||(Ge(o,e),s&(Me|Se)&&(s&We?Qi(o,qt):bn(o)))}}let Xi=!1;function At(n,e=null,t){if(typeof n!="object"||n===null||at in n)return n;const i=ti(n);if(i!==Ha&&i!==Ka)return n;var a=new Map,r=Jn(n),o=Ee(0);r&&a.set("length",Ee(n.length));var s;return new Proxy(n,{defineProperty(d,p,c){(!("value"in c)||c.configurable===!1||c.enumerable===!1||c.writable===!1)&&$a();var m=a.get(p);return m===void 0?(m=Ee(c.value),a.set(p,m)):G(m,At(c.value,s)),!0},deleteProperty(d,p){var c=a.get(p);if(c===void 0)p in d&&a.set(p,Ee(Be));else{if(r&&typeof p=="string"){var m=a.get("length"),k=Number(p);Number.isInteger(k)&&k<m.v&&G(m,k)}G(c,Be),hi(o)}return!0},get(d,p,c){var w;if(p===at)return n;var m=a.get(p),k=p in d;if(m===void 0&&(!k||(w=Ft(d,p))!=null&&w.writable)&&(m=Ee(At(k?d[p]:Be,s)),a.set(p,m)),m!==void 0){var h=A(m);return h===Be?void 0:h}return Reflect.get(d,p,c)},getOwnPropertyDescriptor(d,p){var c=Reflect.getOwnPropertyDescriptor(d,p);if(c&&"value"in c){var m=a.get(p);m&&(c.value=A(m))}else if(c===void 0){var k=a.get(p),h=k==null?void 0:k.v;if(k!==void 0&&h!==Be)return{enumerable:!0,configurable:!0,value:h,writable:!0}}return c},has(d,p){var h;if(p===at)return!0;var c=a.get(p),m=c!==void 0&&c.v!==Be||Reflect.has(d,p);if(c!==void 0||de!==null&&(!m||(h=Ft(d,p))!=null&&h.writable)){c===void 0&&(c=Ee(m?At(d[p],s):Be),a.set(p,c));var k=A(c);if(k===Be)return!1}return m},set(d,p,c,m){var E;var k=a.get(p),h=p in d;if(r&&p==="length")for(var w=c;w<k.v;w+=1){var y=a.get(w+"");y!==void 0?G(y,Be):w in d&&(y=Ee(Be),a.set(w+"",y))}k===void 0?(!h||(E=Ft(d,p))!=null&&E.writable)&&(k=Ee(void 0),G(k,At(c,s)),a.set(p,k)):(h=k.v!==Be,G(k,At(c,s)));var _=Reflect.getOwnPropertyDescriptor(d,p);if(_!=null&&_.set&&_.set.call(m,c),!h){if(r&&typeof p=="string"){var N=a.get("length"),v=Number(p);Number.isInteger(v)&&v>=N.v&&G(N,v+1)}hi(o)}return!0},ownKeys(d){A(o);var p=Reflect.ownKeys(d).filter(k=>{var h=a.get(k);return h===void 0||h.v!==Be});for(var[c,m]of a)m.v!==Be&&!(c in d)&&p.push(c);return p},setPrototypeOf(){Ya()}})}function hi(n,e=1){G(n,n.v+e)}function wi(n){return n!==null&&typeof n=="object"&&at in n?n[at]:n}function Ji(n,e){return Object.is(wi(n),wi(e))}var fi,ea,ta,na;function pr(){if(fi===void 0){fi=window,ea=/Firefox/.test(navigator.userAgent);var n=Element.prototype,e=Node.prototype;ta=Ft(e,"firstChild").get,na=Ft(e,"nextSibling").get,n.__click=void 0,n.__className="",n.__attributes=null,n.__styles=null,n.__e=void 0,Text.prototype.__t=void 0}}function En(n=""){return document.createTextNode(n)}function hn(n){return ta.call(n)}function xn(n){return na.call(n)}function u(n,e){return hn(n)}function ee(n,e){{var t=hn(n);return t instanceof Comment&&t.data===""?xn(t):t}}function f(n,e=1,t=!1){let i=n;for(;e--;)i=xn(i);return i}function cr(n){n.textContent=""}function Dt(n){var e=We|st,t=ce!==null&&ce.f&We?ce:null;return de===null||t!==null&&t.f&Se?e|=Se:de.f|=$i,{ctx:De,deps:null,effects:null,equals:Yi,f:e,fn:n,reactions:null,rv:0,v:null,wv:0,parent:t??de}}function ye(n){const e=Dt(n);return e.equals=ni,e}function ia(n){var e=n.effects;if(e!==null){n.effects=null;for(var t=0;t<e.length;t+=1)mt(e[t])}}function kr(n){for(var e=n.parent;e!==null;){if(!(e.f&We))return e;e=e.parent}return null}function mr(n){var e,t=de;qe(kr(n));try{ia(n),e=ha(n)}finally{qe(t)}return e}function aa(n){var e=mr(n),t=(dt||n.f&Se)&&n.deps!==null?qt:Me;Ge(n,t),n.equals(e)||(n.v=e,n.wv=ma())}function ra(n){de===null&&ce===null&&Ia(),ce!==null&&ce.f&Se&&de===null&&Za(),oi&&Oa()}function ur(n,e){var t=e.last;t===null?e.last=e.first=n:(t.next=n,n.prev=t,e.last=n)}function Rt(n,e,t,i=!0){var a=(n&Xt)!==0,r=de,o={ctx:De,deps:null,nodes_start:null,nodes_end:null,f:n|st,first:null,fn:e,last:null,next:null,parent:a?null:r,prev:null,teardown:null,transitions:null,wv:0};if(t){var s=Ht;try{Di(!0),Ai(o),o.f|=Ui}catch(c){throw mt(o),c}finally{Di(s)}}else e!==null&&bn(o);var d=t&&o.deps===null&&o.first===null&&o.nodes_start===null&&o.teardown===null&&(o.f&($i|kn))===0;if(!d&&!a&&i&&(r!==null&&ur(o,r),ce!==null&&ce.f&We)){var p=ce;(p.effects??(p.effects=[])).push(o)}return o}function ri(n){const e=Rt(yn,null,!1);return Ge(e,Me),e.teardown=n,e}function Ci(n){ra();var e=de!==null&&(de.f&rt)!==0&&De!==null&&!De.m;if(e){var t=De;(t.e??(t.e=[])).push({fn:n,effect:de,reaction:ce})}else{var i=Ot(n);return i}}function hr(n){return ra(),Tn(n)}function wr(n){const e=Rt(Xt,n,!0);return(t={})=>new Promise(i=>{t.outro?ft(e,()=>{mt(e),i(void 0)}):(mt(e),i(void 0))})}function Ot(n){return Rt(Ii,n,!1)}function Tn(n){return Rt(yn,n,!0)}function L(n,e=[],t=Dt){const i=e.map(t);return Mn(()=>n(...i.map(A)))}function Mn(n,e=0){return Rt(yn|vn|e,n,!0)}function yt(n,e=!0){return Rt(yn|rt,n,!0,e)}function sa(n){var e=n.teardown;if(e!==null){const t=oi,i=ce;yi(!0),Pe(null);try{e.call(null)}finally{yi(t),Pe(i)}}}function oa(n,e=!1){var t=n.first;for(n.first=n.last=null;t!==null;){var i=t.next;mt(t,e),t=i}}function fr(n){for(var e=n.first;e!==null;){var t=e.next;e.f&rt||mt(e),e=t}}function mt(n,e=!0){var t=!1;if((e||n.f&qa)&&n.nodes_start!==null){for(var i=n.nodes_start,a=n.nodes_end;i!==null;){var r=i===a?null:xn(i);i.remove(),i=r}t=!0}oa(n,e&&!t),Cn(n,0),Ge(n,gn);var o=n.transitions;if(o!==null)for(const d of o)d.stop();sa(n);var s=n.parent;s!==null&&s.first!==null&&Aa(n),n.next=n.prev=n.teardown=n.ctx=n.deps=n.fn=n.nodes_start=n.nodes_end=null}function Aa(n){var e=n.parent,t=n.prev,i=n.next;t!==null&&(t.next=i),i!==null&&(i.prev=t),e!==null&&(e.first===n&&(e.first=i),e.last===n&&(e.last=t))}function ft(n,e){var t=[];si(n,t,!0),la(t,()=>{mt(n),e&&e()})}function la(n,e){var t=n.length;if(t>0){var i=()=>--t||e();for(var a of n)a.out(i)}else e()}function si(n,e,t){if(!(n.f&it)){if(n.f^=it,n.transitions!==null)for(const o of n.transitions)(o.is_global||t)&&e.push(o);for(var i=n.first;i!==null;){var a=i.next,r=(i.f&Bn)!==0||(i.f&rt)!==0;si(i,e,r?t:!1),i=a}}}function Pt(n){da(n,!0)}function da(n,e){if(n.f&it){n.f^=it,n.f&Me||(n.f^=Me),en(n)&&(Ge(n,st),bn(n));for(var t=n.first;t!==null;){var i=t.next,a=(t.f&Bn)!==0||(t.f&rt)!==0;da(t,a?e:!1),t=i}if(n.transitions!==null)for(const r of n.transitions)(r.is_global||e)&&r.in()}}let wn=!1,Rn=[];function pa(){wn=!1;const n=Rn.slice();Rn=[],Ln(n)}function vt(n){wn||(wn=!0,queueMicrotask(pa)),Rn.push(n)}function Cr(){wn&&pa()}const ca=0,Dr=1;let ln=!1,dn=ca,Vt=!1,Gt=null,Ht=!1,oi=!1;function Di(n){Ht=n}function yi(n){oi=n}let ht=[],Kt=0;let ce=null,Ye=!1;function Pe(n){ce=n}let de=null;function qe(n){de=n}let ze=null;function yr(n){ze=n}let xe=null,_e=0,Je=null;function vr(n){Je=n}let ka=1,fn=0,dt=!1,lt=null;function ma(){return++ka}function en(n){var m;var e=n.f;if(e&st)return!0;if(e&qt){var t=n.deps,i=(e&Se)!==0;if(t!==null){var a,r,o=(e&mn)!==0,s=i&&de!==null&&!dt,d=t.length;if(o||s){var p=n,c=p.parent;for(a=0;a<d;a++)r=t[a],(o||!((m=r==null?void 0:r.reactions)!=null&&m.includes(p)))&&(r.reactions??(r.reactions=[])).push(p);o&&(p.f^=mn),s&&c!==null&&!(c.f&Se)&&(p.f^=Se)}for(a=0;a<d;a++)if(r=t[a],en(r)&&aa(r),r.wv>n.wv)return!0}(!i||de!==null&&!dt)&&Ge(n,Me)}return!1}function gr(n,e){for(var t=e;t!==null;){if(t.f&kn)try{t.fn(n);return}catch{t.f^=kn}t=t.parent}throw ln=!1,n}function Br(n){return(n.f&gn)===0&&(n.parent===null||(n.parent.f&kn)===0)}function Nn(n,e,t,i){if(ln){if(t===null&&(ln=!1),Br(e))throw n;return}t!==null&&(ln=!0);{gr(n,e);return}}function ua(n,e,t=!0){var i=n.reactions;if(i!==null)for(var a=0;a<i.length;a++){var r=i[a];r.f&We?ua(r,e,!1):e===r&&(t?Ge(r,st):r.f&Me&&Ge(r,qt),bn(r))}}function ha(n){var h;var e=xe,t=_e,i=Je,a=ce,r=dt,o=ze,s=De,d=Ye,p=n.f;xe=null,_e=0,Je=null,ce=p&(rt|Xt)?null:n,dt=(p&Se)!==0&&(!Ht||a===null||d),ze=null,un(n.ctx),Ye=!1,fn++;try{var c=(0,n.fn)(),m=n.deps;if(xe!==null){var k;if(Cn(n,_e),m!==null&&_e>0)for(m.length=_e+xe.length,k=0;k<xe.length;k++)m[_e+k]=xe[k];else n.deps=m=xe;if(!dt)for(k=_e;k<m.length;k++)((h=m[k]).reactions??(h.reactions=[])).push(n)}else m!==null&&_e<m.length&&(Cn(n,_e),m.length=_e);if(Lt()&&Je!==null&&!Ye&&m!==null&&!(n.f&(We|qt|st)))for(k=0;k<Je.length;k++)ua(Je[k],n);return a!==null&&fn++,c}finally{xe=e,_e=t,Je=i,ce=a,dt=r,ze=o,un(s),Ye=d}}function Er(n,e){let t=e.reactions;if(t!==null){var i=Fa.call(t,n);if(i!==-1){var a=t.length-1;a===0?t=e.reactions=null:(t[i]=t[a],t.pop())}}t===null&&e.f&We&&(xe===null||!xe.includes(e))&&(Ge(e,qt),e.f&(Se|mn)||(e.f^=mn),ia(e),Cn(e,0))}function Cn(n,e){var t=n.deps;if(t!==null)for(var i=e;i<t.length;i++)Er(n,t[i])}function Ai(n){var e=n.f;if(!(e&gn)){Ge(n,Me);var t=de,i=De;de=n;try{e&vn?fr(n):oa(n),sa(n);var a=ha(n);n.teardown=typeof a=="function"?a:null,n.wv=ka;var r=n.deps,o;qn&&Ga&&n.f&st}catch(s){Nn(s,n,t,i||n.ctx)}finally{de=t}}}function wa(){if(Kt>1e3){Kt=0;try{Ua()}catch(n){if(Gt!==null)Nn(n,Gt,null);else throw n}}Kt++}function fa(n){var e=n.length;if(e!==0){wa();var t=Ht;Ht=!0;try{for(var i=0;i<e;i++){var a=n[i];a.f&Me||(a.f^=Me);var r=Mr(a);xr(r)}}finally{Ht=t}}}function xr(n){var e=n.length;if(e!==0)for(var t=0;t<e;t++){var i=n[t];if(!(i.f&(gn|it)))try{en(i)&&(Ai(i),i.deps===null&&i.first===null&&i.nodes_start===null&&(i.teardown===null?Aa(i):i.fn=null))}catch(a){Nn(a,i,null,i.ctx)}}}function Tr(){if(Vt=!1,Kt>1001)return;const n=ht;ht=[],fa(n),Vt||(Kt=0,Gt=null)}function bn(n){dn===ca&&(Vt||(Vt=!0,queueMicrotask(Tr))),Gt=n;for(var e=n;e.parent!==null;){e=e.parent;var t=e.f;if(t&(Xt|rt)){if(!(t&Me))return;e.f^=Me}}ht.push(e)}function Mr(n){var e=[],t=n.first;e:for(;t!==null;){var i=t.f,a=(i&rt)!==0,r=a&&(i&Me)!==0,o=t.next;if(!r&&!(i&it)){if(i&Ii)e.push(t);else if(a)t.f^=Me;else{var s=ce;try{ce=t,en(t)&&Ai(t)}catch(c){Nn(c,t,null,t.ctx)}finally{ce=s}}var d=t.first;if(d!==null){t=d;continue}}if(o===null){let c=t.parent;for(;c!==null;){if(n===c)break e;var p=c.next;if(p!==null){t=p;continue e}c=c.parent}}t=o}return e}function li(n){var e=dn,t=ht;try{wa();const a=[];dn=Dr,ht=a,Vt=!1,fa(t);var i=n==null?void 0:n();return Cr(),(ht.length>0||a.length>0)&&li(),Kt=0,Gt=null,i}finally{dn=e,ht=t}}async function Nr(){await Promise.resolve(),li()}function A(n){var e=n.f,t=(e&We)!==0;if(lt!==null&&lt.add(n),ce!==null&&!Ye){ze!==null&&ze.includes(n)&&za();var i=ce.deps;n.rv<fn&&(n.rv=fn,xe===null&&i!==null&&i[_e]===n?_e++:xe===null?xe=[n]:(!dt||!xe.includes(n))&&xe.push(n))}else if(t&&n.deps===null&&n.effects===null){var a=n,r=a.parent;r!==null&&!(r.f&Se)&&(a.f^=Se)}return t&&(a=n,en(a)&&aa(a)),n.v}function br(n){var e=lt;lt=new Set;var t=lt,i;try{if(Ve(n),e!==null)for(i of lt)e.add(i)}finally{lt=e}return t}function Ca(n){var e=br(()=>Ve(n));for(var t of e)if(t.f&ji)for(const i of t.deps||[])i.f&We||kt(i,i.v);else kt(t,t.v)}function Ve(n){var e=Ye;try{return Ye=!0,n()}finally{Ye=e}}const _r=-7169;function Ge(n,e){n.f=n.f&_r|e}function Fr(n){if(!(typeof n!="object"||!n||n instanceof EventTarget)){if(at in n)On(n);else if(!Array.isArray(n))for(let e in n){const t=n[e];typeof t=="object"&&t&&at in t&&On(t)}}}function On(n,e=new Set){if(typeof n=="object"&&n!==null&&!(n instanceof EventTarget)&&!e.has(n)){e.add(n),n instanceof Date&&n.getTime();for(let i in n)try{On(n[i],e)}catch{}const t=ti(n);if(t!==Object.prototype&&t!==Array.prototype&&t!==Map.prototype&&t!==Set.prototype&&t!==Date.prototype){const i=Zi(t);for(let a in i){const r=i[a].get;if(r)try{r.call(n)}catch{}}}}}const Hr=["touchstart","touchmove"];function Kr(n){return Hr.includes(n)}let vi=!1;function Sr(){vi||(vi=!0,document.addEventListener("reset",n=>{Promise.resolve().then(()=>{var e;if(!n.defaultPrevented)for(const t of n.target.elements)(e=t.__on_r)==null||e.call(t)})},{capture:!0}))}function di(n){var e=ce,t=de;Pe(null),qe(null);try{return n()}finally{Pe(e),qe(t)}}function pi(n,e,t,i=t){n.addEventListener(e,()=>di(t));const a=n.__on_r;a?n.__on_r=()=>{a(),i(!0)}:n.__on_r=()=>i(!0),Sr()}const Da=new Set,Zn=new Set;function Wr(n,e,t,i={}){function a(r){if(i.capture||Ut.call(e,r),!r.cancelBubble)return di(()=>t==null?void 0:t.call(this,r))}return n.startsWith("pointer")||n.startsWith("touch")||n==="wheel"?vt(()=>{e.addEventListener(n,a,i)}):e.addEventListener(n,a,i),a}function ve(n,e,t,i,a){var r={capture:i,passive:a},o=Wr(n,e,t,r);(e===document.body||e===window||e===document)&&ri(()=>{e.removeEventListener(n,o,r)})}function ci(n){for(var e=0;e<n.length;e++)Da.add(n[e]);for(var t of Zn)t(n)}function Ut(n){var v;var e=this,t=e.ownerDocument,i=n.type,a=((v=n.composedPath)==null?void 0:v.call(n))||[],r=a[0]||n.target,o=0,s=n.__root;if(s){var d=a.indexOf(s);if(d!==-1&&(e===document||e===window)){n.__root=e;return}var p=a.indexOf(e);if(p===-1)return;d<=p&&(o=d)}if(r=a[o]||n.target,r!==e){Oi(n,"currentTarget",{configurable:!0,get(){return r||t}});var c=ce,m=de;Pe(null),qe(null);try{for(var k,h=[];r!==null;){var w=r.assignedSlot||r.parentNode||r.host||null;try{var y=r["__"+i];if(y!==void 0&&!r.disabled)if(Jn(y)){var[_,...N]=y;_.apply(r,[n,...N])}else y.call(r,n)}catch(E){k?h.push(E):k=E}if(n.cancelBubble||w===e||w===null)break;r=w}if(k){for(let E of h)queueMicrotask(()=>{throw E});throw k}}finally{n.__root=e,delete n.currentTarget,Pe(c),qe(m)}}}function Pr(n){var e=document.createElement("template");return e.innerHTML=n,e.content}function Dn(n,e){var t=de;t.nodes_start===null&&(t.nodes_start=n,t.nodes_end=e)}function M(n,e){var t=(e&Ar)!==0,i=(e&lr)!==0,a,r=!n.startsWith("<!>");return()=>{a===void 0&&(a=Pr(r?n:"<!>"+n),t||(a=hn(a)));var o=i||ea?document.importNode(a,!0):a.cloneNode(!0);if(t){var s=hn(o),d=o.lastChild;Dn(s,d)}else Dn(o,o);return o}}function Tt(n=""){{var e=En(n+"");return Dn(e,e),e}}function he(){var n=document.createDocumentFragment(),e=document.createComment(""),t=En();return n.append(e,t),Dn(e,t),n}function C(n,e){n!==null&&n.before(e)}let In=!0;function F(n,e){var t=e==null?"":typeof e=="object"?e+"":e;t!==(n.__t??(n.__t=n.nodeValue))&&(n.__t=t,n.nodeValue=t+"")}function qr(n,e){return Lr(n,e)}const Mt=new Map;function Lr(n,{target:e,anchor:t,props:i={},events:a,context:r,intro:o=!0}){pr();var s=new Set,d=m=>{for(var k=0;k<m.length;k++){var h=m[k];if(!s.has(h)){s.add(h);var w=Kr(h);e.addEventListener(h,Ut,{passive:w});var y=Mt.get(h);y===void 0?(document.addEventListener(h,Ut,{passive:w}),Mt.set(h,1)):Mt.set(h,y+1)}}};d(ei(Da)),Zn.add(d);var p=void 0,c=wr(()=>{var m=t??e.appendChild(En());return yt(()=>{if(r){Ne({});var k=De;k.c=r}a&&(i.$$events=a),In=o,p=n(m,i)||{},In=!0,r&&be()}),()=>{var w;for(var k of s){e.removeEventListener(k,Ut);var h=Mt.get(k);--h===0?(document.removeEventListener(k,Ut),Mt.delete(k)):Mt.set(k,h)}Zn.delete(d),m!==t&&((w=m.parentNode)==null||w.removeChild(m))}});return Rr.set(p,c),p}let Rr=new WeakMap;const Hn=0,sn=1,Kn=2;function Un(n,e,t,i,a){var r=n,o=Lt(),s=De,d=Be,p,c,m,k=(o?Ee:Wt)(void 0),h=(o?Ee:Wt)(void 0),w=!1;function y(N,v){w=!0,v&&(qe(_),Pe(_),un(s));try{N===Hn&&t&&(p?Pt(p):p=yt(()=>t(r))),N===sn&&i&&(c?Pt(c):c=yt(()=>i(r,k))),N!==Hn&&p&&ft(p,()=>p=null),N!==sn&&c&&ft(c,()=>c=null),N!==Kn&&m&&ft(m,()=>m=null)}finally{v&&(un(null),Pe(null),qe(null),li())}}var _=Mn(()=>{if(d!==(d=e())){if(Wa(d)){var N=d;w=!1,N.then(v=>{N===d&&(kt(k,v),y(sn,!0))},v=>{if(N===d)throw kt(h,v),y(Kn,!0),h.v}),vt(()=>{w||y(Hn,!0)})}else kt(k,d),y(sn,!1);return()=>d=Be}})}function R(n,e,t=!1){var i=n,a=null,r=null,o=Be,s=t?Bn:0,d=!1;const p=(m,k=!0)=>{d=!0,c(k,m)},c=(m,k)=>{o!==(o=m)&&(o?(a?Pt(a):k&&(a=yt(()=>k(i))),r&&ft(r,()=>{r=null})):(r?Pt(r):k&&(r=yt(()=>k(i))),a&&ft(a,()=>{a=null})))};Mn(()=>{d=!1,e(p),d||c(null,null)},s)}function me(n,e){return e}function Or(n,e,t,i){for(var a=[],r=e.length,o=0;o<r;o++)si(e[o].e,a,!0);var s=r>0&&a.length===0&&t!==null;if(s){var d=t.parentNode;cr(d),d.append(t),i.clear(),ot(n,e[0].prev,e[r-1].next)}la(a,()=>{for(var p=0;p<r;p++){var c=e[p];s||(i.delete(c.k),ot(n,c.prev,c.next)),mt(c.e,!s)}})}function ue(n,e,t,i,a,r=null){var o=n,s={flags:e,items:new Map,first:null},d=(e&Vi)!==0;if(d){var p=n;o=p.appendChild(En())}var c=null,m=!1,k=ye(()=>{var h=t();return Jn(h)?h:h==null?[]:ei(h)});Mn(()=>{var h=A(k),w=h.length;m&&w===0||(m=w===0,Zr(h,s,o,a,e,i,t),r!==null&&(w===0?c?Pt(c):c=yt(()=>r(o)):c!==null&&ft(c,()=>{c=null})),A(k))})}function Zr(n,e,t,i,a,r,o){var z,D,q,j;var s=(a&Xa)!==0,d=(a&(ii|ai))!==0,p=n.length,c=e.items,m=e.first,k=m,h,w=null,y,_=[],N=[],v,E,H,P;if(s)for(P=0;P<p;P+=1)v=n[P],E=r(v,P),H=c.get(E),H!==void 0&&((z=H.a)==null||z.measure(),(y??(y=new Set)).add(H));for(P=0;P<p;P+=1){if(v=n[P],E=r(v,P),H=c.get(E),H===void 0){var $=k?k.e.nodes_start:t;w=Ur($,e,w,w===null?e.first:w.next,v,E,P,i,a,o),c.set(E,w),_=[],N=[],k=w.next;continue}if(d&&Ir(H,v,P,a),H.e.f&it&&(Pt(H.e),s&&((D=H.a)==null||D.unfix(),(y??(y=new Set)).delete(H))),H!==k){if(h!==void 0&&h.has(H)){if(_.length<N.length){var ie=N[0],B;w=ie.prev;var Z=_[0],ae=_[_.length-1];for(B=0;B<_.length;B+=1)gi(_[B],ie,t);for(B=0;B<N.length;B+=1)h.delete(N[B]);ot(e,Z.prev,ae.next),ot(e,w,Z),ot(e,ae,ie),k=ie,w=ae,P-=1,_=[],N=[]}else h.delete(H),gi(H,k,t),ot(e,H.prev,H.next),ot(e,H,w===null?e.first:w.next),ot(e,w,H),w=H;continue}for(_=[],N=[];k!==null&&k.k!==E;)k.e.f&it||(h??(h=new Set)).add(k),N.push(k),k=k.next;if(k===null)continue;H=k}_.push(H),w=H,k=H.next}if(k!==null||h!==void 0){for(var Ae=h===void 0?[]:ei(h);k!==null;)k.e.f&it||Ae.push(k),k=k.next;var pe=Ae.length;if(pe>0){var ke=a&Vi&&p===0?t:null;if(s){for(P=0;P<pe;P+=1)(q=Ae[P].a)==null||q.measure();for(P=0;P<pe;P+=1)(j=Ae[P].a)==null||j.fix()}Or(e,Ae,ke,c)}}s&&vt(()=>{var X;if(y!==void 0)for(H of y)(X=H.a)==null||X.apply()}),de.first=e.first&&e.first.e,de.last=w&&w.e}function Ir(n,e,t,i){i&ii&&kt(n.v,e),i&ai?kt(n.i,t):n.i=t}function Ur(n,e,t,i,a,r,o,s,d,p){var c=(d&ii)!==0,m=(d&Ja)===0,k=c?m?Wt(a):Ee(a):a,h=d&ai?Ee(o):o,w={i:h,v:k,k:r,a:null,e:null,prev:t,next:i};try{return w.e=yt(()=>s(n,k,h,p),Xi),w.e.prev=t&&t.e,w.e.next=i&&i.e,t===null?e.first=w:(t.next=w,t.e.next=w.e),i!==null&&(i.prev=w,i.e.prev=w.e),w}finally{}}function gi(n,e,t){for(var i=n.next?n.next.e.nodes_start:t,a=e?e.e.nodes_start:t,r=n.e.nodes_start;r!==i;){var o=xn(r);a.before(r),r=o}}function ot(n,e,t){e===null?n.first=t:(e.next=t,e.e.next=t&&t.e),t!==null&&(t.prev=e,t.e.prev=e&&e.e)}function St(n,e,t,i){var a=n.__attributes??(n.__attributes={});a[e]!==(a[e]=t)&&(e==="style"&&"__styles"in n&&(n.__styles={}),e==="loading"&&(n[Ra]=t),t==null?n.removeAttribute(e):typeof t!="string"&&jr(n).includes(e)?n[e]=t:n.setAttribute(e,t))}var Bi=new Map;function jr(n){var e=Bi.get(n.nodeName);if(e)return e;Bi.set(n.nodeName,e=[]);for(var t,i=n,a=Element.prototype;a!==i;){t=Zi(i);for(var r in t)t[r].set&&e.push(r);i=ti(i)}return e}function fe(n,e,t){var i=n.__className,a=$r(e);(i!==a||Xi)&&(e==null?n.removeAttribute("class"):n.className=a,n.__className=a)}function $r(n,e){return(n??"")+""}const Yr=()=>performance.now(),nt={tick:n=>requestAnimationFrame(n),now:()=>Yr(),tasks:new Set};function ya(){const n=nt.now();nt.tasks.forEach(e=>{e.c(n)||(nt.tasks.delete(e),e.f())}),nt.tasks.size!==0&&nt.tick(ya)}function zr(n){let e;return nt.tasks.size===0&&nt.tick(ya),{promise:new Promise(t=>{nt.tasks.add(e={c:n,f:t})}),abort(){nt.tasks.delete(e)}}}function on(n,e){di(()=>{n.dispatchEvent(new CustomEvent(e))})}function Vr(n){if(n==="float")return"cssFloat";if(n==="offset")return"cssOffset";if(n.startsWith("--"))return n;const e=n.split("-");return e.length===1?e[0]:e[0]+e.slice(1).map(t=>t[0].toUpperCase()+t.slice(1)).join("")}function Ei(n){const e={},t=n.split(";");for(const i of t){const[a,r]=i.split(":");if(!a||r===void 0)break;const o=Vr(a.trim());e[o]=r.trim()}return e}const Gr=n=>n;function Nt(n,e,t,i){var a=(n&rr)!==0,r=(n&sr)!==0,o=a&&r,s=(n&or)!==0,d=o?"both":a?"in":"out",p,c=e.inert,m=e.style.overflow,k,h;function w(){var E=ce,H=de;Pe(null),qe(null);try{return p??(p=t()(e,(i==null?void 0:i())??{},{direction:d}))}finally{Pe(E),qe(H)}}var y={is_global:s,in(){var E;if(e.inert=c,!a){h==null||h.abort(),(E=h==null?void 0:h.reset)==null||E.call(h);return}r||k==null||k.abort(),on(e,"introstart"),k=jn(e,w(),h,1,()=>{on(e,"introend"),k==null||k.abort(),k=p=void 0,e.style.overflow=m})},out(E){if(!r){E==null||E(),p=void 0;return}e.inert=!0,on(e,"outrostart"),h=jn(e,w(),k,0,()=>{on(e,"outroend"),E==null||E()})},stop:()=>{k==null||k.abort(),h==null||h.abort()}},_=de;if((_.transitions??(_.transitions=[])).push(y),a&&In){var N=s;if(!N){for(var v=_.parent;v&&v.f&Bn;)for(;(v=v.parent)&&!(v.f&vn););N=!v||(v.f&Ui)!==0}N&&Ot(()=>{Ve(()=>y.in())})}}function jn(n,e,t,i,a){var r=i===1;if(Sa(e)){var o,s=!1;return vt(()=>{if(!s){var _=e({direction:r?"in":"out"});o=jn(n,_,t,i,a)}}),{abort:()=>{s=!0,o==null||o.abort()},deactivate:()=>o.deactivate(),reset:()=>o.reset(),t:()=>o.t()}}if(t==null||t.deactivate(),!(e!=null&&e.duration))return a(),{abort:Ze,deactivate:Ze,reset:Ze,t:()=>i};const{delay:d=0,css:p,tick:c,easing:m=Gr}=e;var k=[];if(r&&t===void 0&&(c&&c(0,1),p)){var h=Ei(p(0,1));k.push(h,h)}var w=()=>1-i,y=n.animate(k,{duration:d});return y.onfinish=()=>{var _=(t==null?void 0:t.t())??1-i;t==null||t.abort();var N=i-_,v=e.duration*Math.abs(N),E=[];if(v>0){var H=!1;if(p)for(var P=Math.ceil(v/16.666666666666668),$=0;$<=P;$+=1){var ie=_+N*m($/P),B=Ei(p(ie,1-ie));E.push(B),H||(H=B.overflow==="hidden")}H&&(n.style.overflow="hidden"),w=()=>{var Z=y.currentTime;return _+N*m(Z/v)},c&&zr(()=>{if(y.playState!=="running")return!1;var Z=w();return c(Z,1-Z),!0})}y=n.animate(E,{duration:v,fill:"forwards"}),y.onfinish=()=>{w=()=>i,c==null||c(i,1-i),a()}},{abort:()=>{y&&(y.cancel(),y.effect=null,y.onfinish=Ze)},deactivate:()=>{a=Ze},reset:()=>{i===0&&(c==null||c(1,0))},t:()=>w()}}function $n(n,e,t=e){var i=Lt();pi(n,"input",a=>{var r=a?n.defaultValue:n.value;if(r=Wn(n)?Pn(r):r,t(r),i&&r!==(r=e())){var o=n.selectionStart,s=n.selectionEnd;n.value=r??"",s!==null&&(n.selectionStart=o,n.selectionEnd=Math.min(s,n.value.length))}}),Ve(e)==null&&n.value&&t(Wn(n)?Pn(n.value):n.value),Tn(()=>{var a=e();Wn(n)&&a===Pn(n.value)||n.type==="date"&&!a&&!n.value||a!==n.value&&(n.value=a??"")})}const Sn=new Set;function bt(n,e,t,i,a=i){var r=t.getAttribute("type")==="checkbox",o=n;if(e!==null)for(var s of e)o=o[s]??(o[s]=[]);o.push(t),pi(t,"change",()=>{var d=t.__value;r&&(d=Qr(o,d,t.checked)),a(d)},()=>a(r?[]:null)),Tn(()=>{var d=i();r?(d=d||[],t.checked=d.includes(t.__value)):t.checked=Ji(t.__value,d)}),ri(()=>{var d=o.indexOf(t);d!==-1&&o.splice(d,1)}),Sn.has(o)||(Sn.add(o),vt(()=>{o.sort((d,p)=>d.compareDocumentPosition(p)===4?-1:1),Sn.delete(o)})),vt(()=>{})}function Qr(n,e,t){for(var i=new Set,a=0;a<n.length;a+=1)n[a].checked&&i.add(n[a].__value);return t||i.delete(e),Array.from(i)}function Wn(n){var e=n.type;return e==="number"||e==="range"}function Pn(n){return n===""?null:+n}function va(n,e,t){if(n.multiple)return Jr(n,e);for(var i of n.options){var a=zt(i);if(Ji(a,e)){i.selected=!0;return}}(!t||e!==void 0)&&(n.selectedIndex=-1)}function Xr(n,e){Ot(()=>{var t=new MutationObserver(()=>{var i=n.__value;va(n,i)});return t.observe(n,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value"]}),()=>{t.disconnect()}})}function ga(n,e,t=e){var i=!0;pi(n,"change",a=>{var r=a?"[selected]":":checked",o;if(n.multiple)o=[].map.call(n.querySelectorAll(r),zt);else{var s=n.querySelector(r)??n.querySelector("option:not([disabled])");o=s&&zt(s)}t(o)}),Ot(()=>{var a=e();if(va(n,a,i),i&&a===void 0){var r=n.querySelector(":checked");r!==null&&(a=zt(r),t(a))}n.__value=a,i=!1}),Xr(n)}function Jr(n,e){for(var t of n.options)t.selected=~e.indexOf(zt(t))}function zt(n){return"__value"in n?n.__value:n.value}function xi(n,e){return n===e||(n==null?void 0:n[at])===e}function es(n={},e,t,i){return Ot(()=>{var a,r;return Tn(()=>{a=r,r=[],Ve(()=>{n!==t(...r)&&(e(n,...r),a&&xi(t(...a),n)&&e(null,...a))})}),()=>{vt(()=>{r&&xi(t(...r),n)&&e(null,...r)})}}),n}function Le(n=!1){const e=De,t=e.l.u;if(!t)return;let i=()=>Fr(e.s);if(n){let a=0,r={};const o=Dt(()=>{let s=!1;const d=e.s;for(const p in d)d[p]!==r[p]&&(r[p]=d[p],s=!0);return s&&a++,a});i=()=>A(o)}t.b.length&&hr(()=>{Ti(e,i),Ln(t.b)}),Ci(()=>{const a=Ve(()=>t.m.map(Pa));return()=>{for(const r of a)typeof r=="function"&&r()}}),t.a.length&&Ci(()=>{Ti(e,i),Ln(t.a)})}function Ti(n,e){if(n.l.s)for(const t of n.l.s)A(t);e()}function Ba(n,e,t){if(n==null)return e(void 0),Ze;const i=Ve(()=>n.subscribe(e,t));return i.unsubscribe?()=>i.unsubscribe():i}const _t=[];function ts(n,e=Ze){let t=null;const i=new Set;function a(s){if(zi(n,s)&&(n=s,t)){const d=!_t.length;for(const p of i)p[1](),_t.push(p,n);if(d){for(let p=0;p<_t.length;p+=2)_t[p][0](_t[p+1]);_t.length=0}}}function r(s){a(s(n))}function o(s,d=Ze){const p=[s,d];return i.add(p),i.size===1&&(t=e(a,r)||Ze),s(n),()=>{i.delete(p),i.size===0&&t&&(t(),t=null)}}return{set:a,update:r,subscribe:o}}function ns(n){let e;return Ba(n,t=>e=t)(),e}let An=!1,Yn=Symbol();function is(n,e,t){const i=t[e]??(t[e]={store:null,source:Wt(void 0),unsubscribe:Ze});if(i.store!==n&&!(Yn in t))if(i.unsubscribe(),i.store=n??null,n==null)i.source.v=void 0,i.unsubscribe=Ze;else{var a=!0;i.unsubscribe=Ba(n,r=>{a?i.source.v=r:G(i.source,r)}),a=!1}return n&&Yn in t?ns(n):A(i.source)}function as(){const n={};function e(){ri(()=>{for(var t in n)n[t].unsubscribe();Oi(n,Yn,{enumerable:!1,value:!0})})}return[n,e]}function rs(n){var e=An;try{return An=!1,[n(),An]}finally{An=e}}function we(n,e,t,i){var ie;var a=(t&er)!==0,r=!Jt||(t&tr)!==0,o=(t&ir)!==0,s=(t&ar)!==0,d=!1,p;o?[p,d]=rs(()=>n[e]):p=n[e];var c=at in n||La in n,m=o&&(((ie=Ft(n,e))==null?void 0:ie.set)??(c&&e in n&&(B=>n[e]=B)))||void 0,k=i,h=!0,w=!1,y=()=>(w=!0,h&&(h=!1,s?k=Ve(i):k=i),k);p===void 0&&i!==void 0&&(m&&r&&ja(),p=y(),m&&m(p));var _;if(r)_=()=>{var B=n[e];return B===void 0?y():(h=!0,w=!1,B)};else{var N=(a?Dt:ye)(()=>n[e]);N.f|=ji,_=()=>{var B=A(N);return B!==void 0&&(k=void 0),B===void 0?k:B}}if(!(t&nr))return _;if(m){var v=n.$$legacy;return function(B,Z){return arguments.length>0?((!r||!Z||v||d)&&m(Z?_():B),B):_()}}var E=!1,H=!1,P=Wt(p),$=Dt(()=>{var B=_(),Z=A(P);return E?(E=!1,H=!0,Z):(H=!1,P.v=B)});return a||($.equals=ni),function(B,Z){if(lt!==null&&(E=H,_(),A(P)),arguments.length>0){const ae=Z?A($):r&&o?At(B):B;return $.equals(ae)||(E=!0,G(P,ae),w&&k!==void 0&&(k=ae),Ve(()=>A($))),B}return A($)}}const ss="5";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(ss);Qa();class os{constructor(e,t,i){l(this,"_dbname");l(this,"_dbversion");l(this,"dbPromise");l(this,"getTran",async(e,t)=>(await this.dbPromise).transaction(e,t));l(this,"reset",async()=>(await indexedDB.databases().then(e=>{console.log(e)}),await new Promise((e,t)=>{const i=indexedDB.deleteDatabase(this._dbname);i.onsuccess=()=>{console.log("onsuccess"),e()},i.onerror=a=>{console.log("onerror"),t(a)}})));l(this,"getAll",async e=>{const t=await this.dbPromise;return new Promise((i,a)=>{const s=t.transaction([e],"readonly").objectStore(e).getAll();s.onsuccess=()=>{i(s.result)},s.onerror=d=>{a(d)}})});l(this,"get",async(e,t)=>{const i=await this.dbPromise;return new Promise((a,r)=>{const d=i.transaction([e],"readonly").objectStore(e).get(t);d.onsuccess=()=>{a(d.result)},d.onerror=p=>{r(p)}})});l(this,"getMany",async(e,t)=>{const r=(await this.dbPromise).transaction([e],"readonly").objectStore(e),o=t.map(s=>new Promise((d,p)=>{const c=r.get(s);c.onsuccess=()=>{d(c.result)},c.onerror=m=>{p(m)}}));return await Promise.all(o)});l(this,"putRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),r=a.objectStore(e),o=t.map(s=>({record:s,request:r.put(s)}));return new Promise((s,d)=>{a.oncomplete=()=>s(o.map(p=>Object.assign({id:p.request.result},p.record))),a.onerror=p=>d(p)})});l(this,"deleteRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),r=a.objectStore(e),o=t.map(s=>({key:s,request:r.delete(s)}));return new Promise((s,d)=>{a.oncomplete=()=>{console.log(o.map(p=>p.request.result)),s()},a.onerror=p=>d(p)})});this._dbname=e,this._dbversion=t,this.dbPromise=new Promise((a,r)=>{const o=indexedDB.open(e,t);o.onsuccess=s=>{if(console.log(s),!s.target){console.log("event.target is undefined"),r("event.target is undefined");return}const d=s.target.result;if(!d){console.log("event.target.result is undefined"),r("event.target.result is undefined");return}d.onversionchange=p=>{console.log(p),d.close()},a(d)},o.onupgradeneeded=s=>{console.log("onupgradeneeded");const d=s.target.result;i.filter(p=>!d.objectStoreNames.contains(p)).map(p=>d.createObjectStore(p,{keyPath:"id",autoIncrement:!0}))},o.onerror=s=>{console.log(s),r(s)},o.onblocked=s=>{console.log(s),r(s)}}),console.log(this.dbPromise)}get dbversion(){return this._dbversion}}class He{constructor(){l(this,"handlers",[])}append(e){this.handlers.push(e)}remove(e){this.handlers=this.handlers.filter(t=>t!==e)}trigger(e){this.handlers.slice(0).forEach(t=>t(e))}clear(){this.handlers.splice(0)}expose(){return this}}class Mi{constructor(){l(this,"handler")}set(e){this.handler=e}async call(e){if(!this.handler)throw Error("illegal state error");return await this.handler(e)}expose(){return this}}class ki{constructor(e,t,i,a){l(this,"_name");l(this,"_createVersion");l(this,"mountResolver",()=>{});l(this,"_indexedDb");l(this,"onInsertEvent",new He);l(this,"onBeforeInsertEvent",new Mi);l(this,"onUpdateEvent",new He);l(this,"onBeforeUpdateEvent",new Mi);l(this,"onDeleteEvent",new He);l(this,"prepareInitialRecords",()=>{const e=new Date;return this._prepareInitialRecords().map(t=>Object.assign(t,{createdAt:e,updatedAt:e,dbVersion:this._createVersion}))});l(this,"resolveMount",()=>this.mountResolver());l(this,"patchForInsert",(e,t)=>{e.newRecords.forEach(i=>{console.log(i),t[i.id]=i})});l(this,"patchForUpdate",(e,t)=>{e.recordPairs.forEach(i=>{console.log(t[i.newRecord.id],i.newRecord),t[i.newRecord.id]={...i.newRecord}})});l(this,"patchForDelete",(e,t)=>{e.oldRecords.forEach(i=>{console.log(i),delete t[i.id]})});this._indexedDb=e,this._name=t,this._createVersion=e.dbversion,this.getAll().then(r=>r.reduce((o,s)=>(o[s.id]=s,o),{})).then(r=>{console.log(this.name,r),this.onBeforeInsertEvent.set(i??(()=>Promise.resolve())),this.onBeforeUpdateEvent.set(a??(()=>Promise.resolve()))})}get name(){return this._name}get createVersion(){return this._createVersion}get oninsert(){return this.onInsertEvent.expose()}get onbeforeinsert(){return this.onBeforeInsertEvent.expose()}get onupdate(){return this.onUpdateEvent.expose()}get onbeforeupdate(){return this.onBeforeUpdateEvent.expose()}get ondelete(){return this.onDeleteEvent.expose()}getAll(){return this._indexedDb.getAll(this.name)}get(e){return this._indexedDb.get(this.name,e)}async insertMany(e){const t=new Date,i=e.map(r=>{const o={createdAt:t,updatedAt:t,dbVersion:this._createVersion};return Object.assign(r,o)});await this.onBeforeInsertEvent.call({sender:this,newRecords:i,timestamp:t});const a=await this._indexedDb.putRecords(this.name,i);return this.onInsertEvent.trigger({sender:this,newRecords:a,timestamp:t}),a}async insert(e){return(await this.insertMany([e]))[0]}async updateMany(e,t){const i=new Date,a=[];return(await this._indexedDb.getMany(this.name,e)).forEach(o=>{const s={...o},d={...s};a.push({newRecord:Object.assign(t(d),{updatedAt:i,dbVersion:this._createVersion}),oldRecord:s})}),await this.onBeforeUpdateEvent.call({sender:this,recordPairs:a,timestamp:i}),await this._indexedDb.putRecords(this.name,a.map(o=>o.newRecord)),this.onUpdateEvent.trigger({sender:this,recordPairs:a,timestamp:i}),a.map(o=>o.newRecord)}async update(e,t){return(await this.updateMany([e],t))[0]}async delete(e){const t=new Date,i=await this._indexedDb.getMany(this.name,e);await this._indexedDb.deleteRecords(this.name,e),this.onDeleteEvent.trigger({sender:this,oldRecords:i,timestamp:t})}}const As={"１３人目の埋葬者":{name:"１３人目の埋葬者",nameKana:"",description:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",pendulumDescription:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",kind:"Monster",monsterCategories:["Normal"],level:3,attack:1200,defense:900,attribute:"Dark",type:"Zombie",wikiName:"《１３人目の埋葬者》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%A3%B1%A3%B3%BF%CD%CC%DC%A4%CE%CB%E4%C1%F2%BC%D4%A1%D5",wikiTextAll:`通常モンスター
...
そのモンスターを手札に加える。`}},ls=["Deck","ExtraDeck"],ds={Deck:"メインデッキ",ExtraDeck:"エクストラデッキ"},zn=["Monster","Spell","Trap"],Ea={Monster:"モンスター",Spell:"魔法",Trap:"罠"},Qt=["Fusion","Syncro","Xyz","Link"],xa=[...Qt,"SpecialSummon"],ps=["Toon","Spirit","Union","Gemini","FlipEffect"],cs=["Tuner","Effect","Normal","Pendulum","Token"],Ni=[...xa,...ps,...cs],_n={Syncro:"シンクロ",Fusion:"融合",Xyz:"エクシーズ",Link:"リンク",SpecialSummon:"特殊召喚",Toon:"トゥーン",Spirit:"スピリット",Union:"ユニオン",Gemini:"デュアル",FlipEffect:"リバース",Tuner:"チューナー",Effect:"効果",Normal:"通常",Pendulum:"ペンデュラム",Token:"トークン"},tn={Syncro:"🎵",Fusion:"🌀",Xyz:"📰",Link:"⛓️",SpecialSummon:"🔯",Toon:"📖",Spirit:"👻",Union:"🚗",Gemini:"👫",FlipEffect:"🔄",Tuner:"🎶",Effect:"✨",Normal:"🔘",Pendulum:"💠",Token:"🐏"},bi=["Light","Dark","Earth","Water","Fire","Wind","Divine"],mi={Light:"光",Dark:"闇",Earth:"地",Water:"水",Fire:"炎",Wind:"風",Divine:"神"},_i=["Aqua","Beast","BeastWarrior","CreatorGod","Cyberse","Dinosaur","DivineBeast","Dragon","Fairy","Fiend","Fish","Insect","Illusion","Machine","Plant","Psychic","Pyro","Reptile","Rock","SeaSerpent","Spellcaster","Thunder","Warrior","WingedBeast","Wyrm","Zombie"],Fi=["Normal","Continuous","Field","QuickPlay","Equip","Ritual"],nn={Normal:"通常",Continuous:"永続",Field:"フィールド",QuickPlay:"速攻",Equip:"装備",Ritual:"儀式"},Hi=["Normal","Continuous","Counter"],an={Normal:"通常",Continuous:"永続",Counter:"カウンター"},Fn={Aqua:"水",Beast:"獣",BeastWarrior:"獣戦士",CreatorGod:"創造神",Cyberse:"サイバース",Dinosaur:"恐竜",DivineBeast:"幻獣神",Dragon:"ドラゴン",Fairy:"天使",Fiend:"悪魔",Fish:"魚",Insect:"昆虫",Illusion:"幻想魔",Machine:"機械",Plant:"植物",Psychic:"サイキック",Pyro:"炎",Reptile:"爬虫類",Rock:"岩石",SeaSerpent:"海竜",Spellcaster:"魔法使い",Thunder:"雷",Warrior:"戦士",WingedBeast:"鳥獣",Wyrm:"幻竜",Zombie:"アンデット"},rn={Aqua:"🚰",Beast:"🐅",BeastWarrior:"🦁",CreatorGod:"🔆",Cyberse:"💻️",Dinosaur:"🦖",DivineBeast:"💫",Dragon:"🐲",Fairy:"👼",Fiend:"👿",Fish:"🐟️",Insect:"🦋",Illusion:"🤡",Machine:"🤖",Plant:"🌱",Psychic:"👁️",Pyro:"🔥",Reptile:"🦎",Rock:"⛰",SeaSerpent:"🐍",Spellcaster:"🧙",Thunder:"⚡️",Warrior:"⚔️",WingedBeast:"🦅",Wyrm:"🐉",Zombie:"🦴"},Ke=class Ke{constructor(e){l(this,"id");l(this,"name");l(this,"description");l(this,"save",async e=>{const t=e??{id:this.id,name:this.name,description:this.description},i=await Ke.tblHeader.update(this.id,a=>({...a,...t}));return new Ke(i)});this.id=e.id,this.name=e.name,this.description=e.description}};l(Ke,"tblHeader"),l(Ke,"getOrCreateNew",async e=>{Ke.tblHeader||(Ke.tblHeader=new ks(e));const t=await Ke.tblHeader.getAll();if(t.length)return new Ke(t[0]);const i=await Ke.tblHeader.insert({name:"あなた",description:"ここの文字列を何に使うかは未定。"});return new Ke(i)});let Vn=Ke;class ks extends ki{constructor(t){super(t,"TblDuelistProfile");l(this,"_prepareInitialRecords",()=>[])}}let ms=-1;const us=[{id:ms--,name:"NPC",description:""}];class Ki{constructor(e,t,i,a,r){l(this,"duel");l(this,"seat");l(this,"_entity");l(this,"profile");l(this,"deckInfo");l(this,"duelistType");l(this,"lifeLog");l(this,"normalSummonCount");l(this,"specialSummonCount");l(this,"maxNormalSummonCount");l(this,"_lp");l(this,"battleDamage",(e,t)=>this.setLp(this._lp-e,t,"BattleDamage"));l(this,"effectDamage",(e,t)=>this.setLp(this._lp-e,t,"EffectDamage"));l(this,"lostLp",(e,t)=>this.setLp(this._lp-e,t,"Lost"));l(this,"payLp",(e,t)=>this.setLp(this._lp-e,t,"Pay"));l(this,"heal",(e,t)=>this.setLp(this._lp+e,t,"Heal"));l(this,"setLp",(e,t,i)=>{const a={clock:this.duel.clock,reason:i||"Set",beforeLp:this._lp,afterLp:e,entity:t};return this.lifeLog.push(a),this._lp=e,this.duel.log.info(`ライフポイント変動：${a.afterLp-a.beforeLp}（${a.beforeLp} ⇒ ${a.afterLp}）`,this),a});l(this,"getOpponentPlayer",()=>this.duel.firstPlayer===this?this.duel.secondPlayer:this.duel.firstPlayer);l(this,"getHandCell",()=>this.duel.field.getCells("Hand").filter(e=>e.owner===this)[0]);l(this,"getDeckCell",()=>this.duel.field.getCells("Deck").filter(e=>e.owner===this)[0]);l(this,"getExtraDeck",()=>this.duel.field.getCells("ExtraDeck").filter(e=>e.owner===this)[0]);l(this,"getGraveyard",()=>this.duel.field.getCells("Graveyard").filter(e=>e.owner===this)[0]);l(this,"getFieldZone",()=>this.duel.field.getCells("FieldSpellZone").filter(e=>e.owner===this)[0]);l(this,"getBanished",()=>this.duel.field.getCells("Banished").filter(e=>e.owner===this)[0]);l(this,"getMonsterZones",()=>this.duel.field.getCells("MonsterZone").filter(e=>e.owner===this));l(this,"getExtraMonsterZones",()=>this.duel.field.getCells("ExtraMonsterZone").filter(e=>{var t;return((t=e.cardEntities[0])==null?void 0:t.controller)===this}));l(this,"getSpellTrapZones",()=>this.duel.field.getCells("SpellAndTrapZone").filter(e=>e.owner===this));l(this,"getEmptyMonsterZones",()=>this.getMonsterZones().filter(e=>e.cardEntities.length===0));l(this,"getEmptyExtraZones",()=>this.getExtraMonsterZones().length===0?this.getMonsterZones().filter(e=>e.cardEntities.length===0):[]);l(this,"getAvailableMonsterZones",()=>this.getMonsterZones().filter(e=>e.isAvailable));l(this,"getAvailableExtraZones",()=>this.getExtraMonsterZones().length===0?this.duel.field.getCells("ExtraMonsterZone").filter(e=>e.isAvailable):[]);l(this,"getAvailableSpellTrapZones",()=>this.getSpellTrapZones().filter(e=>e.isAvailable));l(this,"getReleasableMonsters",()=>this.getMonstersOnField());l(this,"getMonstersOnField",()=>this.duel.field.getMonstersOnField().filter(e=>e.controller===this));l(this,"getAttackTargetMonsters",()=>this.duel.field.getMonstersOnField().filter(e=>e.status.isSelectableForAttack&&e.controller!==this));l(this,"draw",async(e,t)=>{const i=await this.duel.field.draw(this,e,t);if(!i)throw new pt(this.getOpponentPlayer());return i});l(this,"shuffleDeck",()=>{this.getDeckCell().shuffle(),this.duel.log.info("デッキをシャッフル。",this)});this.duel=e,this.seat=t,this.profile=i,this.duelistType=a,this.deckInfo=r,this.lifeLog=[],this.normalSummonCount=0,this.specialSummonCount=0,this.maxNormalSummonCount=1,this._lp=8e3}get entity(){const e=this.getHandCell().entities.find(t=>t.entityType==="Duelist");return e||wt.createPlayerEntity(this)}get lp(){return this._lp}get isTurnPlayer(){return this.duel.getTurnPlayer()===this}}Array.prototype.shuffle=function(){return this.map(e=>({item:e,seq:Math.random()})).toSorted((e,t)=>e.seq-t.seq).map(e=>e.item)};Array.prototype.randomPick=function(n){return this.shuffle().slice(0,n)};Array.prototype.reset=function(...n){this.splice(0),this.push(...n)};Array.prototype.union=function(n){return this.filter(n.includes,n)};Array.prototype.getAllOnOffPattern=function(){const n=[];return this.forEach(e=>{if(n.length==0){n.push([e]),n.push([]);return}n.forEach(t=>n.push([...t,e]))}),n};const Si=["Deck","ExtraDeck","Graveyard","Banished"],Gn={0:{0:"Hand"},1:{0:"Deck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"ExtraDeck"},2:{0:"Graveyard",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"FieldSpellZone"},3:{0:"Banished",1:"Disable",2:"ExtraMonsterZone",3:"Disable",4:"ExtraMonsterZone",5:"Disable",6:"Banished"},4:{0:"FieldSpellZone",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"Graveyard"},5:{0:"ExtraDeck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"Deck"},6:{0:"Hand"}};class hs{constructor(e,t,i,a){l(this,"onUpdateEvent",new He);l(this,"field");l(this,"row");l(this,"column");l(this,"cellType");l(this,"owner");l(this,"_entities");l(this,"releaseEntities",(e,t,i)=>(this._entities=this._entities.filter(a=>!e.includes(a)),e.forEach(a=>{a.movedAs.splice(0),a.movedAs.push(...new Set(t)),a.movedAt=a.field.duel.clock,a.movedBy=i,a.movedFrom=this}),this.onUpdateEvent.trigger(),e));l(this,"acceptEntities",(e,t)=>{t==="Bottom"?this._entities.push(...e):t==="Top"&&this._entities.unshift(...e),this._entities.forEach(i=>{i.fieldCell=this}),this.onUpdateEvent.trigger()});l(this,"shuffle",()=>{this._entities=this.entities.shuffle()});this.field=e,this.row=t,this.column=i,this.cellType=Gn[t][i],this.owner=a,this._entities=[]}get onUpdate(){return this.onUpdateEvent.expose()}get entities(){return this._entities}get cardEntities(){return this._entities.filter(e=>Rs.find(t=>t===e.entityType))}get targetForAttack(){return this.cellType==="Hand"?this._entities.find(e=>e.entityType==="Duelist"):this.cardEntities[0]}get isAvailable(){return this._entities.length===0}}class ws{constructor(e){l(this,"cells");l(this,"duel");l(this,"getAllCells",()=>this.cells.flat());l(this,"getCells",(...e)=>this.getAllCells().filter(t=>e.includes(t.cellType)));l(this,"getAllEntities",()=>this.getAllCells().map(e=>e.entities).flat());l(this,"getAllCardEntities",()=>this.getAllCells().map(e=>e.cardEntities).flat());l(this,"getMonstersOnField",()=>this.getCells("MonsterZone","ExtraMonsterZone").map(e=>e.cardEntities).filter(e=>e.length>0).map(e=>e[0]).filter(e=>e.entityType!=="Squatter"));l(this,"getEntities",e=>this.getAllEntities().filter(t=>t.controller===e));l(this,"pushDeck",e=>{e.deckInfo.cardNames.map(t=>Te[t]).filter(t=>t).forEach(t=>wt.createCardEntity(this,e,t)),this.duel.log.info(`デッキをセット。メイン${e.getDeckCell().cardEntities.length}枚。エクストラ${e.getExtraDeck().cardEntities.length}枚。`,e)});l(this,"prepareHands",async e=>await this.draw(e,5));l(this,"draw",async(e,t,i)=>{const a=await this._draw(e,t,i);if(!a)throw new pt(e.getOpponentPlayer());return a});l(this,"drawSameTime",async(e,t,i,a,r)=>{const o=await this._draw(e,t,r),s=await this._draw(i,t,r);if(o&&s)return!0;throw o?new pt(e):s?new pt(e):new pt});l(this,"_draw",async(e,t,i)=>{var o;if(t<1)return!0;const a=e.getDeckCell(),r=[];for(const s of Array(t)){if(!a.cardEntities.length)return this.duel.log.info(r.length>0?`デッキからカードを${t}枚ドローしようとしたが、${r.length}枚しかドローできなかった。${r}`:"デッキからカードをドローできなかった。",e),this.duel.isEnded=!0,e.setLp(0),!1;const d=a.cardEntities[0];await d.draw(i?["Effect"]:["Rule"],i),r.push(((o=d.origin)==null?void 0:o.name)||"!名称取得失敗!")}return this.duel.log.info(`デッキからカードを${r.length}枚ドロー。${r}。`,e),!0});l(this,"payMonstersForSpecialSummonCost",async(e,t,i,a,r,o,s)=>{if(i>0&&t.length<i)return;const d=await this.duel.view.waitSelectEntities(e,t,i,a,"素材とするモンスターを選択",s);if(console.log(d),!!d){for(const p of d)await p.release(["Release",...r],o);return this.duel.log.info(`${d.map(p=>p.status.name).join(", ")}を素材とした（${[...new Set(d.flatMap(p=>p.movedAs))].join(", ")}）。`,e),d}});l(this,"release",async(e,t,i,a,r,o,s,d)=>{if(i>0&&t.length<i)return;const p=await this.duel.view.waitSelectEntities(e,t,i,m=>(s||m.length>0)&&(i<0||m.length===i),"リリースするモンスターを選択",d);if(!p)return;const c=[];for(const m of p)await m.release(["Release",a,...r],o),c.push(m);return this.duel.log.info(`${c.map(m=>m.status.name).join(", ")}をリリース（${[...new Set(c.flatMap(m=>m.movedAs))].join(", ")}）。`,e),c});l(this,"discard",async(e,t,i,a,r,o)=>{const s=o||(()=>!0),d=e.getHandCell().cardEntities.filter(s);if(d.length<t)return[];let p=[];return(r||e).duelistType==="NPC"?p=d.randomPick(t):p=await this.duel.view.waitSelectEntities(r||e,d,t,c=>c.length===t,`${t}枚カードを捨てる。`,!1)||[],await this._sendGraveyardMany(p,["Discard",...i],a),this.duel.log.info(`手札からカードを${p.length}枚捨てた。${p.map(c=>{var m;return(m=c.origin)==null?void 0:m.name})}。`,e),p});l(this,"summonMany",async(e,t,i,a,r,o,s)=>{const d=await Promise.all(e.map(async p=>this._summon(p,t(p),i(p),a,r,o,s?s(p):void 0)));if(d.find(p=>!p))throw new ct("想定されない返却値",d);return d});l(this,"summon",async(e,t,i,a,r,o,s,d=!1)=>{const p=await this._summon(e,t,i,a,r,o,s,d);if(p)return this.duel.log.info(`${p.status.name}を召喚（${[...r,a].join(",")}）。`,s??(o==null?void 0:o.controller)??e.controller),p});l(this,"_summon",async(e,t,i,a,r,o,s,d=!1)=>{const p=s??(o==null?void 0:o.controller)??e.controller;let c=t.randomPick(1)[0],m=i.randomPick(1)[0];if((i.length>1||t.length>1)&&p.duelistType!=="NPC"){const k=i.length>1?"カードを召喚先へドラッグ。":"表示形式を選択。",h=t.map(N=>wt.createDammyAction(e,N,i,N)),w=this.duel.view.modalController.selectAction(this.duel.view,{title:k,actions:h,cancelable:!1}),y=this.duel.view.waitSubAction(p,h,k,d).then(N=>N.actionWIP),_=await Promise.any([w,y]);if(!_&&!d)throw new ct("",_);if(!_)return;m=_.cell||m,c=_.pos||c}return console.log(m,c,a,r,o),await e.summon(m,c,a,r,o),e});l(this,"activateSpellTrapFromHand",async(e,t,i,a,r,o=!1)=>{const s=r??(a==null?void 0:a.controller)??e.controller;let d=t.randomPick(1)[0];if(t.length>1&&s.duelistType!=="NPC"){const p=[wt.createDammyAction(e,"カードの発動",t,void 0)];this.duel.view.modalController.selectAction(this.duel.view,{title:"カードを魔法罠ゾーンへドラッグ",actions:p,cancelable:!1});const c=await this.duel.view.waitSubAction(s,p,"カードを魔法罠ゾーンへドラッグ。",o),m=c.actionWIP;if(!m&&!o)throw new ct("",c);if(!m)return;d=m.cell||d}return await e.activateSpellTrapFromHand(d,i,a),e});l(this,"destroyMany",async(e,t,i)=>await this._sendGraveyardMany(e,[...t,"Destroy"],i));l(this,"sendGraveyardMany",async(e,t,i)=>await this._sendGraveyardMany(e,t,i));l(this,"_sendGraveyardMany",async(e,t,i)=>{for(const a of e)await a.sendGraveyard(t,i);return e.filter(a=>a.entityType!=="Token")});l(this,"setSpellTrap",async(e,t,i,a,r=!1)=>{let o=t[0];const s=a??(i==null?void 0:i.controller)??e.controller;if(t.length>1&&s.duelistType!=="NPC"){const d=[wt.createDammyAction(e,"セット",t)],p=this.duel.view.modalController.selectAction(this.duel.view,{title:"カードをセット先へドラッグ",actions:d,cancelable:r}),c=this.duel.view.waitSubAction(s,d,"カードをセット先へドラッグ",r),m=await Promise.any([p,c.then(k=>k.actionWIP)]);if(!m&&!r)throw new ct("",m);if(!m)return;o=m.cell||o}await e.setAsSpellTrap(o,["SpellTrapSet"],i),this.duel.log.info(`${e.status.name}をセット（SpellTrapSet）。`,a??(i==null?void 0:i.controller)??e.controller)});this.duel=e,this.cells=[...Array(7)].map(()=>[]);for(const t of Object.keys(Gn).map(Number))for(const i of Object.keys(Gn[t]).map(Number))this.cells[t][i]=new hs(this,t,i,t<3?e.duelists.Above:t>3?e.duelists.Below:i===0?e.duelists.Above:i===6?e.duelists.Below:void 0)}}let fs=class{constructor(e){l(this,"onUpdateEvent",new He);l(this,"nextSeq");l(this,"records",[]);l(this,"duel");l(this,"dispose",()=>{this.onUpdateEvent.clear()});l(this,"error",e=>{console.error(e);const t=["エラー発生"];e instanceof Error?(e instanceof ct&&(t.push("-- エラーメッセージ --"),t.push(e.message),t.push("-- 関連オブジェクト --"),e.items.forEach(i=>t.push(JSON.stringify(i)))),t.push("-- エラー名称 --"),t.push(e.name||"エラー名称取得失敗"),t.push("-- スタックトレース --"),t.push(e.stack||"スタックトレース取得失敗")):(t.push("-- エラー型特定失敗 --"),t.push(JSON.stringify(e))),this.info(t)});l(this,"info",(e,t)=>{const i=Array.isArray(e)?e.join(`
`):e;this.records.push({seq:this.nextSeq++,turn:this.duel.clock.turn,phase:this.duel.phase,phaseStep:this.duel.phaseStep,clock:this.duel.clock,duelist:t,text:i}),this.onUpdateEvent.trigger()});this.nextSeq=0,this.duel=e}get onUpdate(){return this.onUpdateEvent.expose()}};const Wi=["DuelEntitiesSelector","DuelActionSelector"];class Cs{constructor(e){l(this,"onUpdateEvent",new He);l(this,"states");l(this,"view");l(this,"cancelAll",()=>{Wi.forEach(e=>this.states[e]="Disable"),console.info(this,"cancelAll"),this.onUpdateEvent.trigger()});l(this,"duelEntitiesSelectorArg",{title:"対象を選択",entities:[],validator:()=>!0,qty:-1,cancelable:!1});l(this,"duelEntitiesSelectorValue");l(this,"duelEntitiesSelectorResolve",()=>{});l(this,"selectDuelEntities",async e=>(this.duelEntitiesSelectorArg=e,this.states.DuelEntitiesSelector="Shown",this.onUpdateEvent.trigger(),new Promise(t=>{this.duelEntitiesSelectorResolve=i=>{this.states.DuelEntitiesSelector="Disable",this.onUpdateEvent.trigger(),t(i)}})));l(this,"cardActionSelectorArg",{title:"カード操作を選択。",actions:[],cancelable:!1});l(this,"cardActionSelectorResolve",()=>{});l(this,"cardActionSelectorValue");l(this,"selectAction",async(e,t)=>(this.cardActionSelectorArg=t,this.states.DuelActionSelector="Shown",e.onWaitEnd.append(this.cancelAll),this.onUpdateEvent.trigger(),new Promise(i=>{this.cardActionSelectorResolve=a=>{console.log(a),this.states.DuelActionSelector="Disable",e.onWaitEnd.remove(this.cancelAll),this.onUpdateEvent.trigger(),i(a)}})));this.view=e,this.states=Wi.reduce((t,i)=>(t[i]="Disable",t),{})}get onUpdate(){return this.onUpdateEvent.expose()}}class Ds{constructor(e){l(this,"onDuelUpdateEvent",new He);l(this,"requireUpdate",()=>{this.onDuelUpdateEvent.trigger()});l(this,"onWaitStartEvent",new He);l(this,"onWaitEndEvent",new He);l(this,"onDragStartEvent",new He);l(this,"onDragEndEvent",new He);l(this,"onAnimationStartEvent",new He);l(this,"onShowCardEntityEvent",new He);l(this,"duel");l(this,"modalController");l(this,"message");l(this,"waitMode");l(this,"infoBoardState");l(this,"infoBoardCell");l(this,"getCell",(e,t)=>this.duel.field.cells[e][t]);l(this,"showCardInfo",e=>{this.onShowCardEntityEvent.trigger(e)});l(this,"dispose",()=>{this.onDragStartEvent.clear(),this.onDragEndEvent.clear(),this.onDuelUpdateEvent.clear(),this.onWaitStartEvent.clear(),this.onWaitEndEvent.clear()});l(this,"waitFieldAction",async(e,t)=>{if(console.log(e),this.duel.getTurnPlayer().duelistType==="NPC"){const i=e.toSorted((a,r)=>(r.entity.atk||0)-(a.entity.atk||0)).find(a=>a.playType==="NormalSummon"||a.playType==="SpecialSummon");return i?{actionWIP:i}:{phaseChange:this.duel.nextPhaseList[0]}}return await this._waitDuelistAction(e,"SelectFieldAction",t)});l(this,"waitQuickEffect",async(e,t,i)=>{if(e.length===0)return;const a=[];return a.push(this.modalController.selectAction(this,{title:t,actions:e,cancelable:i}).then(r=>r&&r)),a.push(this._waitDuelistAction(e,"SelectAction",this.message).then(r=>r.actionWIP)),await Promise.any(a)});l(this,"waitSubAction",async(e,t,i,a=!1)=>{if(e.duelistType==="NPC")throw Error("Not implemented");return await this._waitDuelistAction(t,"SelectAction",i,void 0,void 0,void 0,a)});l(this,"waitSelectEntities",async(e,t,i,a,r,o=!1)=>{let s=[];if(i&&t.length===i)return[...t];if(e.duelistType==="NPC"){for(;!a(s);){const p=i&&i>0?i:Math.floor(Math.random()*t.length)+1;s=t.randomPick(p)}return s}this.waitMode=t.every(p=>(p.fieldCell.cellType==="MonsterZone"||p.fieldCell.cellType==="ExtraMonsterZone")&&p.getIndexInCell()===0||p.fieldCell.cellType==="Hand"&&p.controller===e)?"SelectFieldEntities":"SelectEntities",console.log(this.waitMode);const d=await this._waitDuelistAction([],this.waitMode,r,t,i,a,o);return console.log(d),d.selectedEntities});l(this,"_waitDuelistAction",async(e,t,i,a,r,o,s=!1)=>{this.waitMode=t,this.message=i,this.onDuelUpdateEvent.trigger();const d=await new Promise(p=>{const c={resolve:p,enableActions:e,qty:r,entitiesValidator:o||(()=>!1),selectableEntities:a||[]};console.log(a),console.log(o),console.log(this.waitMode),console.log(this.waitMode==="SelectEntities"),a&&o&&this.waitMode==="SelectEntities"&&(c.duelEntitiesSelectorArg={title:i,entities:a,validator:o,qty:r??-1,cancelable:!1}),console.log(c),this.onWaitStartEvent.trigger(c)});if(console.log(d),this.waitMode="None",this.onWaitEndEvent.trigger(),d.surrender)throw new pt(this.duel.duelists.Above);if(!s&&d.cancel)throw new ct("キャンセル不可のアクションがキャンセルされた。",d,e,t,a);return d});l(this,"waitAnimation",async e=>(this.onDuelUpdateEvent.trigger(),new Promise(t=>this.onAnimationStartEvent.trigger({...e,resolve:t}))));l(this,"setDraggingActions",e=>{this.onDragStartEvent.trigger(e),this.requireUpdate()});l(this,"removeDraggingActions",()=>{this.onDragEndEvent.trigger()});this.duel=e,this.message="",this.waitMode="None",this.infoBoardState="Log",this.infoBoardCell=e.duelists.Below.getExtraDeck(),this.modalController=new Cs(this)}get onDuelUpdate(){return this.onDuelUpdateEvent.expose()}get onWaitStart(){return this.onWaitStartEvent.expose()}get onWaitEnd(){return this.onWaitEndEvent.expose()}get onDragStart(){return this.onDragStartEvent.expose()}get onDragEnd(){return this.onDragEndEvent.expose()}get onAnimation(){return this.onAnimationStartEvent.expose()}get onShowCardEntity(){return this.onShowCardEntityEvent.expose()}}class ys{constructor(){l(this,"_turn",0);l(this,"_phaseSeq",0);l(this,"_stepSeq",0);l(this,"_chainSeq",0);l(this,"_chainBlockSeq",0);l(this,"_procSeq",0);l(this,"_procTotalSeq",0);l(this,"incrementTurn",()=>{this._turn++,this._phaseSeq=0,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});l(this,"incrementPhaseSeq",()=>{this._phaseSeq++,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});l(this,"incrementStepSeq",()=>{this._stepSeq++,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});l(this,"incrementChainSeq",()=>{this._chainSeq++,this._chainBlockSeq=0,this._procSeq=0});l(this,"incrementChainBlockSeq",()=>{this._chainBlockSeq++,this._procSeq=0});l(this,"incrementProcSeq",()=>{this._procSeq++,this._procTotalSeq++});l(this,"toString",()=>`${this.procTotalSeq}(t${this.turn}-p${this.phaseSeq}-ps${this.stepSeq}-c${this.chainSeq}-cb${this.chainBlockSeq}-p${this.procSeq})`)}get turn(){return this._turn}get phaseSeq(){return this._phaseSeq}get stepSeq(){return this._stepSeq}get chainSeq(){return this._chainSeq}get chainBlockSeq(){return this._chainBlockSeq}get procSeq(){return this._procSeq}get procTotalSeq(){return this._procTotalSeq}}class pt extends Error{constructor(t){const i=t?`デュエルが終了した。勝者：${t.profile.name}`:"デュエルが終了した。ドロー。";super(i);l(this,"winner");this.winner=t}}class ct extends Error{constructor(t,...i){super("message");l(this,"message");l(this,"items");this.message=t,this.items=i}}class vs{constructor(e,t,i,a,r,o){l(this,"view");l(this,"log");l(this,"clock");l(this,"phase");l(this,"phaseStep");l(this,"nextPhaseList");l(this,"field");l(this,"attackingMonster");l(this,"targetForAttack");l(this,"duelists");l(this,"priorityHolder");l(this,"isEnded");l(this,"coin",!1);l(this,"getTurnPlayer",()=>this.clock.turn%2===0?this.secondPlayer:this.firstPlayer);l(this,"getNonTurnPlayer",()=>this.clock.turn%2===0?this.firstPlayer:this.secondPlayer);l(this,"main",async()=>{console.info("main start!"),this.coin=Math.random()>.5,this.priorityHolder=this.firstPlayer,this.log.info("【デュエル開始】"),this.log.info(`先攻：${this.firstPlayer.profile.name}`),Object.values(this.duelists).forEach(this.field.pushDeck),Object.values(this.duelists).forEach(e=>e.shuffleDeck()),await Promise.all(Object.values(this.duelists).map(this.field.prepareHands)),console.log("hoge"),this.moveNextPhase("draw"),this.view.requireUpdate();try{for(;!this.isEnded&&(this.phase==="draw"?await this.procDrawPhase():this.phase==="standby"?await this.procStanbyPhase():this.phase==="main1"?await this.procMainPhase():this.phase==="battle"?await this.procBattlePhase():this.phase==="main2"?await this.procMainPhase():this.phase==="end"&&await this.procEndPhase(),!(this.clock.turn>1e3)););}catch(e){e instanceof pt?(console.info(e),this.isEnded=!0,this.log.info(e.winner?`デュエル終了。勝者${e.winner.profile.name}`:"引き分け")):e instanceof Error&&this.log.error(e)}finally{this.view.requireUpdate(),this.view.dispose(),this.log.dispose()}});l(this,"moveNextPhase",e=>{this.clock.turn<1?this.phase="draw":e==="draw"?this.log.info("ターン終了。",this.getTurnPlayer()):this.log.info(`フェイズ移行（${this.phase}→${e}）`,this.getTurnPlayer()),e==="draw"?this.clock.incrementTurn():this.clock.incrementPhaseSeq(),this.phase=e,this.phaseStep=void 0,this.phase==="main2"||this.clock.turn===1?this.nextPhaseList=["end"]:this.phase==="battle"?this.nextPhaseList=["main2"]:this.phase==="main1"?this.nextPhaseList=["battle","end"]:this.nextPhaseList=[]});l(this,"declareAnAttack",(e,t)=>{this.attackingMonster=e,this.targetForAttack=t,e.status.attackCount++,this.log.info(`攻撃宣言：${e.status.name} ⇒ ${t.status.name}`,e.controller)});l(this,"procDrawPhase",async()=>{for(Object.values(this.duelists).forEach(e=>{e.normalSummonCount=0,e.specialSummonCount=0}),this.log.info("ドローフェイズ開始。",this.getTurnPlayer()),this.clock.turn===1?this.log.info("先攻プレイヤーはドローできない。",this.getTurnPlayer()):await this.field.draw(this.getTurnPlayer(),1);await this.procChainBlock(););this.field.getMonstersOnField().forEach(e=>{e.status.attackCount=0,e.status.battlePotisionChangeCount=0}),this.moveNextPhase("standby")});l(this,"procStanbyPhase",async()=>{for(;await this.procChainBlock(););this.moveNextPhase("main1")});l(this,"procMainPhase",async()=>{for(;;){this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["NormalSummon","SpellTrapSet","SpecialSummon","ChangeBattlePosition","IgnitionEffect","QuickEffect","CardActivation"],["Normal","Quick","Counter"]),"あなたの手番です。");if(console.log(e),e.actionWIP){if([...Ls].includes(e.actionWIP.playType)){const i=await e.actionWIP.prepare(e.actionWIP.cell,!0);if(!i)continue;await e.actionWIP.execute(this.priorityHolder,e.actionWIP.cell,i),this.clock.incrementProcSeq()}else console.log(e),await this.procChainBlock(e.actionWIP);for(;await this.procChainBlock(););continue}const t=e.phaseChange;if(t){if(this.priorityHolder=this.getNonTurnPlayer(),await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect","TriggerEffect"],["Quick","Counter"]),"",!0)){this.procChainBlock();continue}this.moveNextPhase(t);return}}});l(this,"procBattlePhase",async()=>{await this.procBattlePhaseStartStep(),await this.procBattlePhaseBattleStep(),await this.procBattlePhaseEndStep()});l(this,"procBattlePhaseStartStep",async()=>{for(this.phaseStep="start",this.priorityHolder=this.getTurnPlayer(),this.attackingMonster=void 0,this.targetForAttack=void 0;await this.procChainBlock(););});l(this,"procBattlePhaseBattleStep",async()=>{for(;;){this.phaseStep="battle",this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["Battle"],["Normal"]),"攻撃モンスターと対象を選択。");if(console.log(e),e.phaseChange)break;if(e.actionWIP){for(await e.actionWIP.execute(this.priorityHolder,e.actionWIP.cell),this.clock.incrementProcSeq();await this.procChainBlock(););this.clock.incrementStepSeq(),await this.procBattlePhaseDamageStep()}}this.clock.incrementStepSeq()});l(this,"procBattlePhaseDamageStep",async()=>{this.phaseStep="damage";const e=this.attackingMonster,t=this.targetForAttack;if(!e||!e.atk)throw new ct("想定されない状態",this.attackingMonster,this.targetForAttack);this.log.info("ダメージステップ開始時",this.getTurnPlayer()),this.log.info("ダメージ計算前",this.getTurnPlayer()),(t==null?void 0:t.battlePotion)==="Set"&&t.setBattlePosition("Defense"),this.log.info("ダメージ計算時",this.getTurnPlayer());const i=e.atk,a=((t==null?void 0:t.battlePotion)==="Attack"?t.atk:t==null?void 0:t.def)||0;!t||t.entityType==="Duelist"?e.controller.getOpponentPlayer().battleDamage(i-a,e):i>0&&i>a?(t.battlePotion==="Attack"&&e.controller.getOpponentPlayer().battleDamage(i-a,e),t.isDying=!0):i<a?(e.controller.battleDamage(a-i,t),t.battlePotion==="Attack"&&(e.isDying=!0)):i===a&&t.battlePotion==="Attack"&&(e.isDying=!0,t.isDying=!0);const r=Object.values(this.duelists).filter(o=>o.lp<=0);if(r.length>0)throw new pt(Object.values(this.duelists).filter(o=>!r.includes(o)).pop());e.isDying&&await this.field.destroyMany([e],["BattleDestroy"],t),t!=null&&t.isDying&&await this.field.destroyMany([t],["BattleDestroy"],e),this.log.info("ダメージ計算後",this.getTurnPlayer()),this.log.info("ダメージステップ終了時",this.getTurnPlayer()),this.clock.incrementStepSeq()});l(this,"procBattlePhaseEndStep",async()=>{for(this.phaseStep="end",this.priorityHolder=this.getTurnPlayer();await this.procChainBlock(););this.moveNextPhase("main2")});l(this,"procEndPhase",async()=>{for(;await this.procChainBlock(););for(;;){const t=this.getTurnPlayer().getHandCell().cardEntities.length;if(t<7)break;await this.field.discard(this.getTurnPlayer(),t-6,["Rule"])}this.moveNextPhase("draw")});l(this,"procChainBlock",async(e,t)=>{const i=this.clock.chainBlockSeq===0;let a;const r=t??Object.values(this.duelists).flatMap(o=>(this.priorityHolder=o,this.getEnableActions(["TriggerMandatoryEffect","TriggerEffect"],["Normal"])));console.log(r);try{if(e||r.length>0&&await this.selectTriggerEffect(r))return a=e,!0;let o=0;for(;o<2;){this.priorityHolder=this.priorityHolder.getOpponentPlayer();const s=await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect"],["Normal","Quick","Counter"]),"クイックエフェクト発動タイミング。効果を発動しますか？",!0);if(s)return a=s,!0;o++}return!1}finally{if(console.log(a),a){const o=a.entity.controller;a.playType==="CardActivation"?this.log.info(`${a.entity.nm}を発動`,o):this.log.info(`${a.entity.nm}«${a.title}»を発動`,o);const s=await a.prepare(a.cell);this.clock.incrementProcSeq(),this.clock.incrementChainBlockSeq(),await this.procChainBlock(void 0,r.filter(d=>d.seq!==(a==null?void 0:a.seq))),this.log.info(`${a.entity.nm}«${a.title}»の効果処理`,o),await a.execute(o,a.cell,s),this.clock.incrementProcSeq(),i&&(await Promise.all(this.field.getAllCells().filter(d=>d.cellType==="SpellAndTrapZone").flatMap(d=>d.entities).filter(d=>d.isDying).map(d=>d.sendGraveyard(["Rule"]))),this.clock.incrementChainSeq())}}});l(this,"selectTriggerEffect",async e=>{if(e.length>0)for(const t of["TriggerMandatoryEffect","TriggerEffect"])for(const i of[this.getTurnPlayer(),this.getNonTurnPlayer()]){this.priorityHolder=i;const a=e.filter(o=>o.playType===t&&o.entity.controller===i);if(a.length===0)continue;if(a.length===1&&t==="TriggerMandatoryEffect")return a[0];const r=await this.view.waitQuickEffect(a,"効果を選択。",t==="TriggerEffect");if(r)return r}});l(this,"getEnableActions",(e,t)=>this.field.getAllCardEntities().filter(i=>i.controller===this.priorityHolder).flatMap(i=>i.actions).filter(i=>i.executableCells.includes(i.entity.fieldCell.cellType)).filter(i=>e.includes(i.playType)).filter(i=>t.includes(i.spellSpeed)).filter(i=>i.validate()));this.phase="end",this.clock=new ys,this.nextPhaseList=[],this.isEnded=!1,this.duelists={Below:new Ki(this,"Below",e,t,i),Above:new Ki(this,"Above",a,r,o)},this.priorityHolder=this.firstPlayer,this.field=new ws(this),this.view=new Ds(this),this.log=new fs(this)}get firstPlayer(){return this.coin?this.duelists.Below:this.duelists.Above}get secondPlayer(){return this.coin?this.duelists.Above:this.duelists.Below}}const gs=n=>{if(n.controller.normalSummonCount>=n.controller.maxNormalSummonCount||!n.status.level)return;const e=n.controller.getAvailableMonsterZones();return n.status.level<5?e.length>0?e:void 0:n.controller.getReleasableMonsters().length<(n.status.level<7?1:2)?void 0:[]},Bs=async(n,e,t)=>{if(!n.status.level)return[];if(n.status.level<5)return[];let i=t;const a=n.controller.getReleasableMonsters(),r=n.controller.getExtraMonsterZones(),o=n.status.level<7?1:2;r.length>=o&&a.filter(d=>d.fieldCell.cellType!=="ExtraMonsterZone");const s=await n.field.release(n.controller,n.controller.getReleasableMonsters(),o,"Cost",["AdvanceSummonRelease","Rule"],n,i);if(s)return i=!1,s},Es=async(n,e,t)=>{if(!n.status.level)return!1;const i=["Rule","NormalSummon"];t&&t.length>0&&(n.materials.reset(...t),i.push("AdvanceSummon"));const a=n.controller.getAvailableMonsterZones();return await n.field.summon(n,["Attack","Set"],e?[e]:a,"NormalSummon",i,n,void 0,t&&t.length===0),n.controller.normalSummonCount++,!0},xs=n=>{if(n.status.attackCount>0||n.battlePotion!=="Attack"||!n.controller.isTurnPlayer)return;const e=n.controller.getAttackTargetMonsters();return e.length>0?e.map(t=>t.fieldCell):[n.controller.getOpponentPlayer().getHandCell()]},Ts=async(n,e)=>{if(n.status.attackCount>0||n.battlePotion!=="Attack")return!1;if(e!=null&&e.targetForAttack)return n.field.duel.declareAnAttack(n,e==null?void 0:e.targetForAttack),!0;const t=n.controller.getAttackTargetMonsters(),i=n.controller.getOpponentPlayer().entity;if(t.length===0)return n.field.duel.declareAnAttack(n,i),!0;if(t.length===1)return n.field.duel.declareAnAttack(n,t[0]),!0;const a=await n.field.duel.view.waitSelectEntities(n.controller,t,1,r=>r.length===1,"攻撃対象を選択。",!0);return a?(n.field.duel.declareAnAttack(n,a[0]),!0):!1},Ms=n=>{if(!(n.status.battlePotisionChangeCount>0||n.status.attackCount>0||!n.controller.isTurnPlayer))return[]},Ns=async n=>n.status.battlePotisionChangeCount>0||!n.controller.isTurnPlayer?!1:(n.setBattlePosition(n.battlePotion==="Attack"?"Defense":"Attack"),n.status.battlePotisionChangeCount++,!0),bs=n=>{if(n.status.spellCategory==="Field"){const t=n.controller.getFieldZone();return t.isAvailable?[t]:void 0}const e=n.controller.getAvailableSpellTrapZones();return e.length>0?e:void 0},_s=async(n,e,t)=>{const i=n.controller.getAvailableSpellTrapZones();return i.length===0?!1:(await n.field.setSpellTrap(n,t?[t]:i,void 0,n.controller,!0),!0)},et=(n,e=()=>!0)=>{if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return[];const t=n.controller.getAvailableSpellTrapZones();return t.length>0&&e(n)?t:void 0},$e=async(n,e,t)=>{if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return n.setNonFieldPosition("FaceUp",!0),!0;if(n.fieldCell.cellType==="Hand"){const i=["SpellTrapActivate"],a=t?[t]:n.controller.getAvailableSpellTrapZones();return await n.field.activateSpellTrapFromHand(n,a,i,n,n.controller,!0),!0}return!1},Ta=(n,e,t,i)=>!(e.some(a=>!a.status.canBeSyncroMaterial)||e.some(a=>a.fieldCell.cellType!=="Hand"&&a.fieldCell.cellType!=="MonsterZone"&&a.fieldCell.cellType!=="ExtraMonsterZone")||e.some(a=>a.fieldCell.cellType==="Hand")&&e.every(a=>!a.status.allowHandSyncro)||e.some(a=>!a.lvl)||e.map(a=>a.lvl??0).reduce((a,r)=>a+r,0)!==(n.origin.level??-1)||!t(e.filter(a=>{var r;return(r=a.status.monsterCategories)==null?void 0:r.some(o=>o==="Tuner")}))||!i(e.filter(a=>{var r;return(r=a.status.monsterCategories)==null?void 0:r.every(o=>o!=="Tuner")}))),Fs=(n,e=i=>i.length===1,t=i=>i.length>0)=>{let i=[...n.controller.getMonstersOnField().filter(a=>a.battlePotion!=="Set"),...n.controller.getHandCell().entities.filter(a=>a.origin.kind==="Monster")].filter(a=>a.status.canBeSyncroMaterial);if(i.every(a=>!a.status.allowHandSyncro)&&(i=n.controller.getMonstersOnField()),!(i.length<2)){for(const a of i.getAllOnOffPattern())if(Ta(n,a,e,t))return[]}},Hs=async(n,e,t,i=r=>r.length===1,a=r=>r.length>0)=>{let r=[...n.controller.getMonstersOnField(),...n.controller.getHandCell().entities.filter(s=>s.origin.kind==="Monster")].filter(s=>s.battlePotion!=="Set").filter(s=>s.status.canBeSyncroMaterial);if(r.every(s=>!s.status.allowHandSyncro)&&(r=n.controller.getMonstersOnField()),r.length<2)return;console.log(r);const o=await n.field.payMonstersForSpecialSummonCost(n.controller,r,-1,s=>Ta(n,s,i,a),["SyncroMaterial","Rule"],n,t);if(console.log(o),!!o)return o},Ks=async(n,e,t,i)=>{i&&i.length>0&&n.materials.reset(...i);const a=[...e.getAvailableMonsterZones(),...e.getAvailableExtraZones()];return await n.field.summon(n,["Attack","Defense"],t?[t]:a,"SyncroSummon",["Rule","SpecialSummon"],n,void 0,i&&i.length===0),e.specialSummonCount++,n.canReborn=!0,!0},Qn={title:"通常召喚",playType:"NormalSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:gs,prepare:(n,e,t)=>Bs(n,e,t),execute:(n,e,t,i)=>Es(n,t,i)},jt={title:"攻撃宣言",playType:"Battle",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:xs,prepare:async()=>!0,execute:(n,e,t)=>Ts(n,t)},$t={title:"表示形式変更",playType:"ChangeBattlePosition",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:Ms,prepare:async()=>!0,execute:n=>Ns(n)},je={title:"セット",playType:"SpellTrapSet",spellSpeed:"Normal",executableCells:["Hand"],validate:bs,prepare:async()=>!0,execute:(n,e,t)=>_s(n,"Set",t)},Pi=(n=t=>t.length===1,e=t=>t.length>0)=>({title:"シンクロ召喚",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["ExtraDeck"],validate:t=>Fs(t,n,e),prepare:(t,i,a)=>Hs(t,i,a,n,e),execute:(t,i,a,r)=>Ks(t,i,a,r)}),Ss=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>et(e,t=>t.controller.getDeckCell().cardEntities.filter(n).length>0),prepare:async(e,t)=>(e.isDying=!0,await $e(e,void 0,t)),execute:async(e,t)=>{const i=t.getDeckCell().cardEntities.filter(n);if(i.length===0)return!1;const a=await e.field.duel.view.waitSelectEntities(t,i,1,r=>r.length===1,"手札に加えるカードを選択",!1);for(const r of a??[])await r.addToHand(["Effect"],e);return t.shuffleDeck(),!0}}),Ws=(n,e)=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:t=>et(t,i=>i.controller.getGraveyard().cardEntities.filter(n).length>=e),prepare:async(t,i)=>(t.isDying=!0,await $e(t,void 0,i)),execute:async(t,i)=>{const a=i.getGraveyard().cardEntities.filter(n);if(a.length===0)return!1;const r=await t.field.duel.view.waitSelectEntities(i,a,e,o=>o.length===e,"手札に加えるカードを選択",!1);for(const o of r??[])await o.addToHand(["Effect"],t);return!0}}),Ps=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>et(e,t=>t.controller.getHandCell().cardEntities.filter(n).length>0&&t.controller.getDeckCell().cardEntities.length>1),prepare:async(e,t)=>(e.isDying=!0,await e.field.discard(e.controller,1,["Discard","Cost"],e,e.controller,n),await $e(e,void 0,t)),execute:async(e,t)=>(await t.draw(2,e),!0)}),qs=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:()=>[],prepare:async(e,t)=>(e.isDying=!0,await $e(e,void 0,t)),execute:async(e,t)=>{const[i,a]=n(e);return a>0?t.getOpponentPlayer().heal(a,e):a<0&&t.getOpponentPlayer().effectDamage(Math.abs(a),e),i>0?t.heal(i,e):i<0&&t.effectDamage(Math.abs(i),e),!0}}),Ls=["NormalSummon","SpecialSummon","ChangeBattlePosition","Battle","SpellTrapSet","SpellTrapActivate"],Rs=["Card","Token","Avatar"],pn=(n,e)=>{const t=n.monsterCategories??[],i=e.monsterCategories??[];for(const a of Qt.toReversed()){if(t.includes(a)&&!i.includes(a))return 1;if(!t.includes(a)&&i.includes(a))return-1}if(n.kind===e.kind){if(n.kind==="Monster"){if((n.link??0)!==(e.link??0))return(n.link??0)-(e.link??0);if((n.rank??0)!==(e.rank??0))return(n.rank??0)-(e.rank??0);if((n.level??0)!==(e.level??0))return(n.level??0)-(e.level??0);if((n.attack??0)!==(e.attack??0))return(n.attack??0)-(e.attack??0);if((n.defense??0)!==(e.defense??0))return(n.defense??0)-(e.defense??0)}return n.name.localeCompare(e.name,"Ja")}for(const a of zn){if(n.kind===a)return-1;if(e.kind===a)return 1}return n.name.localeCompare(e.name,"Ja")},Os=(n,e)=>pn(n.origin,e.origin),ge=class ge{constructor(e,t,i,a,r,o,s,d,p){l(this,"seq");l(this,"origin");l(this,"entityType");l(this,"face");l(this,"isUnderControl");l(this,"_battlePosition");l(this,"orientation");l(this,"controller");l(this,"owner");l(this,"field");l(this,"fieldCell");l(this,"movedBy");l(this,"movedAs");l(this,"movedFrom");l(this,"movedAt");l(this,"isDying");l(this,"isVanished");l(this,"canReborn");l(this,"materials");l(this,"status");l(this,"actions",[]);l(this,"getIndexInCell",()=>{const e=this.fieldCell.cardEntities.indexOf(this);if(e<0)throw new ct("エンティティとセルの状態が矛盾している。",[this,this.fieldCell]);return e});l(this,"setBattlePosition",e=>{this._battlePosition=e,this.orientation=e==="Attack"?"Vertical":"Horizontal",this.face=e==="Set"?"FaceDown":"FaceUp",this.isUnderControl=!0});l(this,"setNonFieldPosition",(e,t)=>{this._battlePosition=void 0,this.orientation=e==="XysMaterial"?"Horizontal":"Vertical",this.face=e==="FaceUp"?"FaceUp":"FaceDown",this.isUnderControl=t});l(this,"summon",async(e,t,i,a,r)=>{const o={Attack:"AttackSummon",Defense:"DefenseSummon",Set:"SetSummon"};e.isAvailable&&(this.setBattlePosition(t),await this._moveTo(e,"Top",[i,o[t],...a],r),this.status.battlePotisionChangeCount=1)});l(this,"release",async(e,t)=>{await this.sendGraveyard([...e,"Release"],t)});l(this,"destroy",async(e,t,i)=>{await this.sendGraveyard([...t,e,"Destroy"],i)});l(this,"sendGraveyard",async(e,t)=>{this.setNonFieldPosition("FaceUp",!0);const i=this.owner.getGraveyard();await this._moveTo(i,"Top",e,t)});l(this,"banish",async(e,t)=>{console.log(this),this.setNonFieldPosition("FaceUp",!0);const i=this.owner.getBanished();await this._moveTo(i,"Top",e,t)});l(this,"setAsSpellTrap",async(e,t,i)=>{await this._moveTo(e,"Top",[...t,"SpellTrapSet"],i),this.setNonFieldPosition("Set",!0)});l(this,"activateSpellTrapFromHand",async(e,t,i)=>{this.setNonFieldPosition("FaceUp",!0),await this._moveTo(e,"Top",[...t,"SpellTrapActivate"],i),this.isDying=!0});l(this,"activateSpellTrapOnField",async()=>{this.setNonFieldPosition("FaceUp",!0),this.isDying=!0});l(this,"draw",async(e,t)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",[...e,"Draw"],t),this.setNonFieldPosition("Set",!0)});l(this,"addToHand",async(e,t)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",e,t),this.setNonFieldPosition("Set",!0)});l(this,"_moveTo",async(e,t,i,a)=>{if(!e)throw new Error("illegal argument: to");if(this.field.duel.clock.turn>0&&await this.field.duel.view.waitAnimation({entity:this,to:e,index:t,count:0}),this.fieldCell.releaseEntities([this],i,a),this.entityType==="Token"&&this.fieldCell.cellType!=="MonsterZone"){this.field.duel.log.info(`${this.nm}は消滅した。`,a==null?void 0:a.controller);return}e.acceptEntities([this],t)});var c;this.seq=ge.nextEntitySeq++,this.owner=e,this.controller=t,this.field=i,this.fieldCell=a,this.entityType=r,this.origin=o,this.status={...JSON.parse(JSON.stringify(o)),canAttack:!0,isEffective:!0,canDirectAttack:!1,attackCount:0,isSelectableForAttack:!0,canBeSyncroMaterial:!0},this.face=s,this.isUnderControl=d,this.orientation=p,this.movedAs=["Rule"],this.movedAt=i.duel.clock,this.isDying=!1,this.isVanished=!1,this.canReborn=((c=this.origin.monsterCategories)==null?void 0:c.union(xa).length)===0,this.materials=[],a.acceptEntities([this],"Top")}get nm(){return this.status.name}get atk(){return this.status.attack}get def(){return this.status.defense}get lvl(){return this.status.level}get rank(){return this.status.rank}get attr(){return this.status.attribute?[this.status.attribute]:[]}get type(){return this.status.type?[this.status.type]:[]}get psL(){return[this.status.pendulumScaleL]}get psR(){return[this.status.pendulumScaleR]}get battlePotion(){return this._battlePosition}};l(ge,"nextActionSeq",0),l(ge,"nextEntitySeq",0),l(ge,"actionDic",{}),l(ge,"createCardActionList",(e,t)=>{const i=t.map(a=>({seq:ge.nextActionSeq++,title:a.title,entity:e,playType:a.playType,spellSpeed:a.spellSpeed,executableCells:a.executableCells,validate:()=>a.validate(e),prepare:r=>a.prepare(e,r),execute:(r,o,s)=>a.execute(e,r,o,s)}));return i.forEach(a=>ge.actionDic[a.seq]=a),i}),l(ge,"createPlayerEntity",e=>{const t=e.getHandCell();return new ge(e,e,e.duel.field,t,"Duelist",{name:e.profile.name,kind:"Monster"},"FaceUp",!0,"Vertical")}),l(ge,"createCardEntity",(e,t,i)=>{var s;const a=i.monsterCategories&&i.monsterCategories.union(Qt).length?t.getExtraDeck():t.getDeckCell(),r=new ge(t,t,e,a,"Card",i,"FaceDown",!1,"Vertical");Object.hasOwn(Te,r.origin.name)||e.duel.log.info(`未実装カード${i.name}がデッキに投入された。`,t);const o=Te[r.origin.name];return o.kind==="Monster"&&((s=o.monsterCategories)!=null&&s.includes("Normal"))?r.actions.push(...ge.createCardActionList(r,[Qn,jt,$t])):r.actions.push(...ge.createCardActionList(r,Xn.get(r.origin.name)||[])),r}),l(ge,"createDammyAction",(e,t,i,a)=>({seq:ge.nextActionSeq++,title:t,entity:e,playType:"Dammy",spellSpeed:"Dammy",executableCells:[e.fieldCell.cellType],validate:()=>i,prepare:async()=>{},execute:async()=>!1,pos:a,cell:i[0],dragAndDropOnly:i.length>1}));let wt=ge;const Zs=()=>{const n=[],e={name:"サイバー・ドラゴン",actions:[Qn,jt,$t,{title:"特殊召喚",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:r=>{const o=r.field.getMonstersOnField();if(o.length==0||o.some(d=>d.controller===r.controller))return;const s=r.controller.getAvailableMonsterZones();return s.length>0?s:void 0},prepare:async()=>!0,execute:async(r,o,s)=>{const d=r.controller.getAvailableMonsterZones();return console.log(d),await r.field.summon(r,["Attack","Defense"],s?[s]:d,"SpecialSummon",["Rule"],r,void 0,!0),r.controller.specialSummonCount++,!0}}]};n.push(e);const t={name:"Ｄ－ＨＥＲＯ ディアボリックガイ",actions:[Qn,jt,$t,{title:"特殊召喚",playType:"IgnitionEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:r=>r.controller.getDeckCell().cardEntities.filter(s=>s.nm==="Ｄ－ＨＥＲＯ ディアボリックガイ").length===0?void 0:r.controller.getAvailableMonsterZones().length>0?[]:void 0,prepare:async r=>{console.log(r),await r.banish(["Cost"],r)},execute:async(r,o,s)=>{const d=r.controller.getAvailableMonsterZones();if(!d.length)return!1;const p=r.controller.getDeckCell().cardEntities.find(c=>c.nm==="Ｄ－ＨＥＲＯ ディアボリックガイ");return p?(console.log(s,d),await r.field.summon(p,["Attack","Defense"],s?[s]:d,"SpecialSummon",["Effect"],r),r.controller.specialSummonCount++,!0):!1}}]};n.push(t);const i={name:"大地の騎士ガイアナイト",actions:[jt,$t,Pi()]};n.push(i),n.push({...i,name:"スクラップ・デスデーモン"});const a={name:"ナチュル・ガオドレイク",actions:[jt,$t,Pi(r=>r.length===1&&r.every(o=>o.attr.some(s=>s==="Earth")),r=>r.length>0&&r.every(o=>o.attr.some(s=>s==="Earth")))]};return n.push(a),console.log(n),n},Is=()=>{const n=[],e={name:"強欲な壺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:et,prepare:async(s,d)=>(s.isDying=!0,await $e(s,void 0,d)),execute:async(s,d)=>(await s.field.draw(d,2,s),!0)},je]};n.push(e);const t={name:"天使の施し",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:et,prepare:async(s,d)=>(s.isDying=!0,await $e(s,void 0,d)),execute:async(s,d)=>(await s.field.draw(s.controller,3,s),await s.field.discard(d,2,["Effect","Discard"],s),!0)},je]};n.push(t);const i={name:"成金ゴブリン",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:et,prepare:async(s,d)=>(s.isDying=!0,await $e(s,void 0,d)),execute:async(s,d)=>(await s.field.draw(s.controller,1,s),s.field.duel.clock.incrementProcSeq(),d.getOpponentPlayer().heal(1e3,s),!0)},je]};n.push(i);const a={name:"おろかな埋葬",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:s=>et(s,d=>d.controller.getDeckCell().cardEntities.some(p=>p.status.kind==="Monster")),prepare:async(s,d)=>(s.isDying=!0,await $e(s,void 0,d)),execute:async(s,d)=>{const p=d.getDeckCell().cardEntities.filter(m=>m.status.kind==="Monster");if(p.length===0)return!1;const c=await s.field.duel.view.waitSelectEntities(d,p,1,m=>m.length===1,"墓地に送るモンスターを選択",!1);for(const m of c??[])await s.field.sendGraveyardMany([m],["Effect"],s);return await d.shuffleDeck(),!0}},je]};n.push(a);const r={name:"死者蘇生",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:s=>et(s,d=>d.field.getCells("Graveyard").flatMap(p=>p.cardEntities).filter(p=>p.origin.kind==="Monster"&&p.canReborn).length>0&&d.controller.getAvailableMonsterZones().length>0),prepare:async(s,d)=>{s.isDying=!0;const p=await s.field.duel.view.waitSelectEntities(s.controller,s.field.getCells("Graveyard").flatMap(c=>c.cardEntities).filter(c=>c.origin.kind==="Monster"&&c.canReborn),1,c=>c.length===1,"蘇生対象とするモンスターを選択",!1);return await $e(s,void 0,d),p==null?void 0:p[0]},execute:async(s,d,p,c)=>{const m=d.getEmptyMonsterZones();return c.controller=d,await s.field.summon(c,["Attack","Defense"],m,"SpecialSummon",["Effect"],s,void 0,!1),s.controller.specialSummonCount++,!0}},je]};n.push(r);const o={name:"光の援軍",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:s=>et(s,d=>d.controller.getDeckCell().cardEntities.filter(p=>p.status.kind==="Monster").filter(p=>(p.lvl??13)<5).some(p=>p.status.nameTags&&p.status.nameTags.includes("ライトロード"))&&d.controller.getDeckCell().cardEntities.length>3),prepare:async(s,d)=>{s.isDying=!0;const p=s.controller.getDeckCell();return Array(3).forEach(()=>p.cardEntities[0].sendGraveyard(["Cost"],s)),await $e(s,void 0,d)},execute:async(s,d)=>{const p=d.getDeckCell().cardEntities.filter(m=>m.status.kind==="Monster").filter(m=>(m.lvl??13)<5).filter(m=>m.status.nameTags&&m.status.nameTags.includes("ライトロード"));if(p.length===0)return!1;const c=await s.field.duel.view.waitSelectEntities(d,p,1,m=>m.length===1,"手札に加えるモンスターを選択",!1);for(const m of c??[])await m.addToHand(["Effect"],s);return!0}},je]};return n.push(o),[{name:"増援",filter:s=>s.origin.kind==="Monster"&&s.origin.type==="Warrior"&&(s.origin.level??5)<5},{name:"化石調査",filter:s=>s.origin.kind==="Monster"&&s.origin.type==="Dinosaur"&&(s.origin.level??6)<6},{name:"Ｅ－エマージェンシーコール",filter:s=>s.origin.kind==="Monster"&&(s.origin.nameTags??[]).includes("Ｅ・ＨＥＲＯ")},{name:"召集の聖刻印",filter:s=>s.origin.kind==="Monster"&&(s.origin.nameTags??[]).includes("聖刻")},{name:"召喚師のスキル",filter:s=>s.origin.kind==="Monster"&&(s.origin.monsterCategories??[]).includes("Normal")&&(s.origin.level??4)>4},{name:"トゥーンのもくじ",filter:s=>(s.origin.nameTags??[]).includes("トゥーン")},{name:"融合賢者",filter:s=>s.origin.name==="融合"},{name:"虹の架け橋",filter:s=>s.origin.kind!=="Monster"&&(s.origin.nameTags??[]).includes("宝玉")},{name:"紫炎の狼煙",filter:s=>s.origin.kind==="Monster"&&(s.origin.nameTags??[]).includes("六武衆")&&(s.origin.level??4)<4},{name:"テラ・フォーミング",filter:s=>s.origin.kind==="Spell"&&s.origin.spellCategory==="Field"},{name:"コール・リゾネーター",filter:s=>s.origin.kind==="Monster"&&(s.origin.nameTags??[]).includes("リゾネーター")}].forEach(s=>{n.push({name:s.name,actions:[Ss(s.filter),je]})}),[{name:"戦士の生還",filter:s=>s.status.kind==="Monster"&&s.type.includes("Warrior"),qty:1},{name:"ダーク・バースト",filter:s=>s.status.kind==="Monster"&&s.attr.includes("Dark")&&(s.atk??9999)<=1500,qty:1},{name:"悪夢再び",filter:s=>s.status.kind==="Monster"&&s.attr.includes("Dark")&&(s.def??9999)===0,qty:2},{name:"サルベージ",filter:s=>s.status.kind==="Monster"&&s.attr.includes("Water")&&(s.atk??9999)<=1500,qty:2},{name:"バッテリーリサイクル",filter:s=>s.status.kind==="Monster"&&s.type.includes("Thunder")&&(s.atk??9999)<=1500,qty:2},{name:"闇の量産工場",filter:s=>s.status.kind==="Monster"&&(s.status.monsterCategories??[]).includes("Normal"),qty:2}].forEach(s=>{n.push({name:s.name,actions:[Ws(s.filter,s.qty),je]})}),[{name:"トレード・イン",filter:s=>s.status.kind==="Monster"&&(s.lvl??0)===8},{name:"調和の宝札",filter:s=>s.status.kind==="Monster"&&(s.origin.monsterCategories??[]).includes("Tuner")&&s.type.includes("Dragon")&&(s.atk??9999)<=1e3},{name:"デステニー・ドロー",filter:s=>s.status.kind==="Monster"&&(s.origin.nameTags??[]).includes("Ｄ－ＨＥＲＯ")}].forEach(s=>{n.push({name:s.name,actions:[Ps(s.filter),je]})}),[{name:"火の粉",calcHeal:()=>[0,-200]},{name:"雷鳴",calcHeal:()=>[0,-300]},{name:"ファイヤー・ボール",calcHeal:()=>[0,-500]},{name:"火あぶりの刑",calcHeal:()=>[0,-600]},{name:"昼夜の大火事",calcHeal:()=>[0,-800]},{name:"火炎地獄",calcHeal:()=>[-500,-1e3]},{name:"盗人ゴブリン",calcHeal:()=>[500,-500]},{name:"ブルー・ポーション",calcHeal:()=>[400,0]},{name:"レッド・ポーション",calcHeal:()=>[500,0]},{name:"ゴブリンの秘薬",calcHeal:()=>[600,0]},{name:"天使の生き血",calcHeal:()=>[800,0]},{name:"治療の神 ディアン・ケト",calcHeal:()=>[1e3,0]},{name:"恵みの雨",calcHeal:()=>[1e3,1e3]}].forEach(s=>{n.push({name:s.name,actions:[qs(s.calcHeal),je]})}),n},Us=()=>{const n=[...Zs(),...Is()];return console.log(n),n},Ma=new Map;Us().forEach(n=>{Ma.set(n.name,n.actions)});const Xn=Ma,js=As,Te=Object.values(js).reduce((n,e)=>(n[e.name]=e,n),{}),re=class re{constructor(e,t){l(this,"id");l(this,"name");l(this,"description");l(this,"lastUsedAt");l(this,"cardNames");l(this,"getIllegalCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(Te).includes(e)))));l(this,"getDisableCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(Te).includes(e)))));l(this,"createCardInfos",()=>{const e=this.getIllegalCardNames();if(e.length>0)throw new Error(`存在しないカード名からデッキを生成しようとした。${e}`);return this.cardNames.map(t=>Te==null?void 0:Te[t]).filter(t=>t)});l(this,"copy",async()=>re.createNewDeck(this.name,this.description,this.cardNames));l(this,"updateTimestamp",async()=>{await re.tblHeader.update(this.id,e=>({...e,lastUsedAt:new Date}))});l(this,"saveDeckInfo",async e=>{const t=e??this;await re.tblHeader.update(this.id,r=>({...r,name:t.name,description:t.description}));const i=(await re.tblDetail.getAll()).filter(r=>r.deckId===this.id);console.log(t.cardNames),await re.tblDetail.delete(i.map(r=>r.id));const a=await re.tblDetail.insertMany(t.cardNames.map((r,o)=>({deckId:this.id,seq:o,name:r,description:""})));return console.log(a),new re(await re.tblHeader.get(this.id),a)});l(this,"delete",async()=>{await re.tblHeader.delete([this.id]);const e=(await re.tblDetail.getAll()).filter(t=>t.deckId===this.id);await re.tblDetail.delete(e.map(t=>t.id))});this.id=e.id,this.name=e.name,this.description=e.description,this.lastUsedAt=e.lastUsedAt,this.cardNames=t.filter(i=>i.deckId===this.id).map(i=>i.name)}};l(re,"idb"),l(re,"tblHeader"),l(re,"tblDetail"),l(re,"getAllDeckInfo",async e=>{if(e&&(re.idb=e),!re.idb)throw new Error("illegal argument: idb is undefined.");re.tblHeader||(re.tblHeader=new $s(re.idb)),re.tblDetail||(re.tblDetail=new Ys(re.idb));const t=await re.tblHeader.getAll(),i=await re.tblDetail.getAll();return t.length?t.map(a=>new re(a,i)):[await re.prepareSampleDeck()]}),l(re,"createNewDeck",async(e,t,i)=>{const a=await re.tblHeader.insert({name:e,description:t,lastUsedAt:new Date}),r=await re.tblDetail.insertMany(i.map((o,s)=>({deckId:a.id,seq:s,name:o,description:""})));return new re(a,r)}),l(re,"prepareSampleDeck",async()=>await re.createNewDeck(cn[0].name,cn[0].description,cn[0].cardNames));let Ct=re;class $s extends ki{constructor(t){super(t,"TblDeckHeader");l(this,"_prepareInitialRecords",()=>[])}}class Ys extends ki{constructor(t){super(t,"TblDeckDetail");l(this,"_prepareInitialRecords",()=>[])}}let zs=-1,Yt=["おろかな埋葬","成金ゴブリン","強欲な壺","天使の施し","増援","死者蘇生","Ｅ－エマージェンシーコール","サイバー・ドラゴン","ナチュル・ガオドレイク","スクラップ・デスデーモン","大地の騎士ガイアナイト"];Yt=[...Yt,...Yt,...Yt,"アレキサンドライドラゴン","ジェネティック・ワーウルフ","機界騎士アヴラム","ジョングルグールの幻術師","ゾンビーノ","幻のグリフォン","フロストザウルス","エレキテルドラゴン","青眼の白龍","幻殻竜","しゃりの軍貫","チューン・ウォリアー","ライドロン","Ａ・マインド","ウォーター・スピリット","エンジェル・トランペッター","ガード・オブ・フレムベル","ギャラクシーサーペント","ジェネクス・コントローラー","スペース・オマジナイ・ウサギ","ハロハロ","ライブラの魔法秤","ラブラドライドラゴン","守護竜ユスティア","竜核の呪霊者","Ｅ・ＨＥＲＯ クレイマン","Ｅ・ＨＥＲＯ スパークマン","Ｅ・ＨＥＲＯ ネオス","Ｅ・ＨＥＲＯ バーストレディ","Ｅ・ＨＥＲＯ フェザーマン"];const cn=[{id:zs--,name:"サンプルデッキ１",description:"",lastUsedAt:new Date,cardNames:Yt}];function Vs(n){const e=n-1;return e*e*e+1}function qi(n,e){for(const t in e)n[t]=e[t];return n}function Gs({fallback:n,...e}){const t=new Map,i=new Map;function a(o,s,d){const{delay:p=0,duration:c=$=>Math.sqrt($)*30,easing:m=Vs}=qi(qi({},e),d),k=o.getBoundingClientRect(),h=s.getBoundingClientRect(),w=k.left-h.left,y=k.top-h.top,_=k.width/h.width,N=k.height/h.height,v=Math.sqrt(w*w+y*y),E=getComputedStyle(s),H=E.transform==="none"?"":E.transform,P=+E.opacity;return{delay:p,duration:typeof c=="function"?c(v):c,easing:m,css:($,ie)=>`
			   opacity: ${$*P};
			   transform-origin: top left;
			   transform: ${H} translate(${ie*w}px,${ie*y}px) scale(${$+(1-$)*_}, ${$+(1-$)*N});
		   `}}function r(o,s,d){return(p,c)=>(o.set(c.key,p),()=>{if(s.has(c.key)){const m=s.get(c.key);return s.delete(c.key),a(m,p,c)}return o.delete(c.key),n&&n(p,c,d)})}return[r(i,t,!1),r(t,i,!0)]}var Qs=M("<div></div>"),Xs=M('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>'),Js=M('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div> <div class="svelte-1y7jo5c"> </div></div>'),eo=M('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div> <div class="svelte-1y7jo5c"> </div></div>'),to=M('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>'),no=M('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div></div> <div class="duel_card_row duel_card_row_wide svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>',1),io=M('<button><div class="duel_card duel_card_face_up svelte-1y7jo5c"><div class="duel_card_row svelte-1y7jo5c" style="position:relative"><div class="svelte-1y7jo5c"> </div> <!></div> <!> <!> <!></div></button>'),ao=M('<div class="duel_card duel_card_face_down duel_card_face_down_defense svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div></div>'),ro=M('<div class="duel_card duel_card_face_down svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div></div>');function tt(n,e){Ne(e,!1);let t=we(e,"entity",8),i=we(e,"state",8,"Disabled"),a=we(e,"selectedList",28,()=>[]),r=we(e,"isVisibleForcibly",8,!1),o=we(e,"isWideMode",8,!1),s=we(e,"actions",24,()=>[]),d=we(e,"cardActionResolve",8),p=we(e,"entitySelectResolve",8,()=>{}),c=Ce(!1),m=()=>{},k=we(e,"qty",12,void 0);const h=B=>{G(c,!1),k(B.qty),m=B.resolve};t().field.duel.view.onWaitStart.append(h);let w=Ce(!1);const y=()=>{if(i()!=="Disabled"&&(console.log(k()),i()==="Selectable"&&k()&&k()===1)){if(a().some(B=>B.seq!==t().seq)){a([t()]);return}k()&&k()===1&&p()&&p()([t()])}},_=()=>{(t().face==="FaceUp"||t().owner===t().field.duel.duelists.Below&&(t().isUnderControl||r()))&&t().field.duel.view.showCardInfo(t())},N=()=>{if(console.log(t(),i()),_(),i()==="Disabled")return;if(i()==="Selectable"){G(c,!A(c)),a(A(c)?[...a(),t()]:a().filter(Z=>Z!==t()));return}if(s().length===0)return;if(s().length===1){if(s()[0].dragAndDropOnly)return;if(d()){d()(s()[0]);return}console.log(s()[0],m),m({actionWIP:s()[0]});return}const B=t().field.duel.view;B.modalController.selectAction(B,{title:"行動を選択。",actions:s(),cancelable:!0}).then(Z=>{m({actionWIP:Z})})},v=B=>{console.info("drag start",B,s()),t().field.duel.view.setDraggingActions(s()),G(w,!0)},E=B=>{console.info("drag end",B,s()),t().field.duel.view.removeDraggingActions(),B.dataTransfer&&G(w,!1)};Le();var H=he(),P=ee(H);{var $=B=>{var Z=io(),ae=u(Z),Ae=u(ae),pe=u(Ae),ke=u(pe),z=f(pe,2);ue(z,1,()=>t().attr,me,(b,W)=>{var S=Qs();L(()=>fe(S,`monster_attr ${A(W)??""} svelte-1y7jo5c`)),C(b,S)});var D=f(Ae,2);{var q=b=>{var W=Xs(),S=u(W),Y=u(S),ne=f(S,2),V=u(ne);L((Q,se)=>{F(Y,Q),F(V,se)},[()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0)],ye),C(b,W)},j=b=>{var W=he(),S=ee(W);{var Y=V=>{var Q=Js(),se=f(u(Q),2),te=u(se);L(()=>F(te,`${nn[t().status.spellCategory]??""}魔法`)),C(V,Q)},ne=V=>{var Q=he(),se=ee(Q);{var te=x=>{var g=eo(),U=f(u(g),2),T=u(U);L(()=>F(T,`${an[t().status.trapCategory]??""}罠`)),C(x,g)};R(se,x=>{t().status.kind==="Trap"&&t().status.trapCategory&&x(te)},!0)}C(V,Q)};R(S,V=>{t().status.kind==="Spell"&&t().status.spellCategory?V(Y):V(ne,!1)},!0)}C(b,W)};R(D,b=>{t().status.kind==="Monster"?b(q):b(j,!1)})}var X=f(D,2);{var J=b=>{var W=to(),S=u(W),Y=u(S),ne=f(S,2),V=u(ne);L(()=>{F(Y,`◀ ${t().psL??""}`),F(V,`${t().psR??""} ▶`)}),C(b,W)};R(X,b=>{var W;(W=t().status.monsterCategories)!=null&&W.includes("Pendulum")&&b(J)})}var K=f(X,2);{var I=b=>{var W=no(),S=ee(W),Y=u(S),ne=u(Y),V=f(S,2),Q=u(V),se=u(Q),te=f(Q,2),x=u(te);L((g,U,T)=>{St(Y,"title",g),F(ne,U),F(se,T),F(x,`${t().atk??"?"} / ${t().def??"?"}`)},[()=>{var g;return(g=t().status.monsterCategories)==null?void 0:g.join(" ")},()=>{var g;return(g=t().status.monsterCategories)==null?void 0:g.map(U=>tn[U]+(o()?_n[U]:"")).join()},()=>t().type.map(g=>rn[g]+(o()?Fn[g]:"")).join()],ye),C(b,W)};R(K,b=>{t().status.kind==="Monster"&&b(I)})}L(b=>{fe(Z,`duel_card button_style_reset ${t().status.kind??""} ${b??""} ${(A(c)?"duel_card_selected":"")??""} ${i()??""} duel_card_${t().orientation??""} ${(A(w)?"isDragging":"")??""} ${(o()?"duel_card_wide":"")??""} svelte-1y7jo5c`),St(Z,"draggable",i()==="Draggable"),St(Z,"title",t().nm),F(ke,t().nm)},[()=>{var b;return((b=t().status.monsterCategories)==null?void 0:b.join(" "))||""}],ye),ve("dragstart",Z,v),ve("dragend",Z,E),ve("click",Z,N),ve("dblclick",Z,y),ve("mouseenter",Z,_),C(B,Z)},ie=B=>{var Z=he(),ae=ee(Z);{var Ae=ke=>{var z=ao();C(ke,z)},pe=ke=>{var z=ro();C(ke,z)};R(ae,ke=>{t().battlePotion==="Set"?ke(Ae):ke(pe,!1)},!0)}C(B,Z)};R(P,B=>{t().face==="FaceUp"||r()||t().controller.seat==="Below"&&t().isUnderControl?B($):B(ie,!1)})}C(n,H),be()}var so=M('<div class="phase_display svelte-1mupj1p"><span class="svelte-1mupj1p"> </span> </div>'),oo=M('<div class="lifepoint_display svelte-1mupj1p"><div class="svelte-1mupj1p"> </div> <div class="svelte-1mupj1p"> </div></div>'),Ao=(n,e,t)=>e(A(t)),lo=M('<div class="svelte-1mupj1p"><button class="phase_button svelte-1mupj1p"> </button></div>'),po=M("<div><!></div>"),co=M('<div class="svelte-1mupj1p"><!></div>'),ko=M("<div><!></div>"),mo=M("<!> <!> <!>",1),uo=M('<div style="position: absolute;" class="card_animation_receiver svelte-1mupj1p"><!></div>'),ho=M('<div style="position: absolute; display:flex;justify-content: center;" class="svelte-1mupj1p"><!></div>'),wo=M('<div style="position: absolute; bottom:0rem" class="svelte-1mupj1p"> </div>'),fo=M("<!> <!>",1),Co=M('<div class="badge svelte-1mupj1p"> </div>'),Do=M('<div class="card_animation_receiver svelte-1mupj1p"><!></div>'),yo=M("<!> <!> <!> <!>",1),vo=M('<td><div role="listitem"><!></div></td>');function go(n,e){Ne(e,!1);let t=we(e,"view",8),i=we(e,"row",8),a=we(e,"column",8),r=we(e,"selectedList",28,()=>[]),o=Ce(t().getCell(i(),a()));const s=()=>{G(o,t().getCell(i(),a()))};A(o).onUpdate.append(s),t().onDuelUpdate.append(s),t().modalController.onUpdate.append(s);let d=Ce([]),p=()=>{},c;const m=D=>{G(v,void 0),r().reset(),p=D.resolve,G(d,D.enableActions),c=D.selectableEntities,D.entitiesValidator};t().onWaitStart.append(m);let k,h=Ce(!1);const w=D=>{k=D,G(h,D.some(q=>{var j;return(j=q.validate())==null?void 0:j.includes(A(o))})||!1),s()},y=()=>{k=void 0,G(h,!1),s()};t().onDragStart.append(w),t().onDragEnd.append(y);const[_,N]=iA;let v=Ce(void 0);const E=D=>{if(A(o)===D.to||A(o).entities.includes(D.entity)){console.log(D),G(v,D);const q=D.resolve;G(o,A(o)),setTimeout(()=>{G(v,void 0),D.count++,D.count>1&&q()},600)}};t().onAnimation.append(E);const H=D=>{console.info(D),p({phaseChange:D})},P=()=>(A(o).cellType==="Deck"||A(o).cellType==="ExtraDeck"||A(o).cellType==="Graveyard"||A(o).cellType==="Banished")&&A(o).entities.flatMap(D=>D.actions).filter(D=>A(d).map(q=>q.seq).some(q=>q===D.seq)).length>0,$=()=>{if(Fe(o,A(o).field.duel.view.infoBoardState="Log"),A(o).cellType==="Deck"||A(o).cellType==="ExtraDeck"||A(o).cellType==="Graveyard"||A(o).cellType==="Banished"){Fe(o,A(o).field.duel.view.infoBoardState="CellInfo"),Fe(o,A(o).field.duel.view.infoBoardCell=A(o)),A(o).field.duel.view.requireUpdate();const D=A(o).entities.flatMap(q=>q.actions).filter(q=>A(d).map(j=>j.seq).some(j=>j===q.seq));if(console.log(A(d)),console.log(D),D.length){const q=A(o).field.duel.view;q.modalController.selectAction(q,{title:"カードを選択。",actions:D,cancelable:!0}).then(j=>{p({actionWIP:j})});return}}A(o).field.duel.view.requireUpdate(),console.info(A(o))},ie=D=>{D.preventDefault(),D.dataTransfer&&(D.dataTransfer.dropEffect="move")},B=D=>{D.preventDefault(),console.info("drop",D,A(h),k),D.dataTransfer&&(D.dataTransfer.dropEffect="move");try{A(h)&&k&&(console.info(k,A(o)),k.length===1?p({actionWIP:{...k[0],cell:A(o)}}):k.length>1&&(A(o).field.duel.view.modalController.cancelAll(),A(o).field.duel.view.modalController.selectAction(A(o).field.duel.view,{title:"選択",actions:k,cancelable:!1})))}finally{t().removeDraggingActions()}},Z=(...D)=>{if(c&&c.find(X=>D.find(J=>X===J)))return"Selectable";if(!A(d)||A(d).length===0||t().waitMode!=="SelectFieldAction"||Object.values(t().modalController.states).some(X=>X==="Shown"))return"Disabled";const q=A(d).filter(X=>D.includes(X.entity));if(q.length===0)return"Disabled";if(q.length>1)return"Clickable";if(A(d)[0].playType==="RuleDraw")return"Draggable";if(["Deck","ExtraDeck","Graveyard","Banished"].includes(A(o).cellType)||q[0].entity!==D[0])return"Clickable";const j=q[0].validate();return j&&j.length>0?"Draggable":"Clickable"};Le();var ae=vo(),Ae=u(ae);Ae.__click=$;var pe=u(Ae);{var ke=D=>{var q=he(),j=ee(q);{var X=J=>{var K=he(),I=ee(K);{var b=S=>{var Y=so(),ne=u(Y),V=u(ne),Q=f(ne,1,!0);L((se,te)=>{F(V,se),F(Q,te)},[()=>String(A(o).field.duel.clock.turn).padStart(2,"0"),()=>A(o).field.duel.phase.toUpperCase()],ye),C(S,Y)},W=S=>{var Y=he(),ne=ee(Y);{var V=se=>{var te=oo(),x=u(te),g=u(x),U=f(x,2),T=u(U);L(()=>{F(g,A(o).field.duel.duelists.Above.lp),F(T,A(o).field.duel.duelists.Below.lp)}),C(se,te)},Q=se=>{var te=he(),x=ee(te);{var g=U=>{var T=he(),O=ee(T);{var oe=le=>{var Oe=he(),ut=ee(Oe);{var gt=Qe=>{var Xe=he(),Zt=ee(Xe);ue(Zt,1,()=>t().duel.nextPhaseList,me,(It,Bt)=>{var Ie=lo(),Ue=u(Ie);Ue.__click=[Ao,H,Bt];var Et=u(Ue);L(xt=>F(Et,xt),[()=>A(Bt).toUpperCase()],ye),C(It,Ie)}),C(Qe,Xe)};R(ut,Qe=>{t().duel.isEnded||Qe(gt)})}C(le,Oe)};R(O,le=>{t().waitMode==="SelectFieldAction"&&le(oe)})}C(U,T)};R(x,U=>{A(o).column===5&&U(g)},!0)}C(se,te)};R(ne,se=>{A(o).column===3?se(V):se(Q,!1)},!0)}C(S,Y)};R(I,S=>{A(o).column===1?S(b):S(W,!1)})}C(J,K)};R(j,J=>{A(o).row===3&&J(X)})}C(D,q)},z=D=>{var q=he(),j=ee(q);{var X=K=>{var I=mo(),b=ee(I);{var W=V=>{var Q=po(),se=u(Q);tt(se,{get entity(){return A(v).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),L(()=>fe(Q,`card_animation_receiver ${A(o).cellType??""} svelte-1mupj1p`)),Nt(1,Q,()=>N,()=>({key:A(v).entity.seq})),C(V,Q)};R(b,V=>{A(v)&&A(v).entity&&A(v).to===A(o)&&A(v).index==="Top"&&V(W)})}var S=f(b,2);ue(S,1,()=>A(o).cardEntities,me,(V,Q)=>{var se=he(),te=ee(se);{var x=g=>{var U=co(),T=u(U);const O=ye(()=>Z(A(Q))),oe=ye(()=>A(d).filter(le=>le.entity===A(Q)));tt(T,{get entity(){return A(Q)},get state(){return A(O)},get actions(){return A(oe)},cardActionResolve:void 0,get selectedList(){return r()},set selectedList(le){r(le)},$$legacy:!0}),Nt(2,U,()=>_,()=>({key:A(Q).seq})),C(g,U)};R(te,g=>{(!A(v)||A(v).entity.seq!==A(Q).seq)&&g(x)})}C(V,se)});var Y=f(S,2);{var ne=V=>{var Q=ko(),se=u(Q);tt(se,{get entity(){return A(v).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),L(()=>fe(Q,`card_animation_receiver ${A(o).cellType??""} svelte-1mupj1p`)),Nt(1,Q,()=>N,()=>({key:A(v).entity.seq})),C(V,Q)};R(Y,V=>{A(v)&&A(v).entity&&A(v).to===A(o)&&A(v).index==="Bottom"&&V(ne)})}C(K,I)},J=K=>{var I=yo(),b=ee(I);{var W=te=>{var x=uo(),g=u(x);tt(g,{get entity(){return A(v).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Nt(1,x,()=>N,()=>({key:A(v).entity.seq})),C(te,x)};R(b,te=>{A(v)&&A(v).entity&&A(v).to===A(o)&&A(v).index==="Bottom"&&te(W)})}var S=f(b,2);{var Y=te=>{var x=fo(),g=ee(x);ue(g,1,()=>A(o).cardEntities.toReversed(),me,(O,oe,le)=>{var Oe=he(),ut=ee(Oe);{var gt=Qe=>{var Xe=ho(),Zt=u(Xe);const It=ye(()=>le===0&&Si.every(Ie=>Ie!==A(o).cellType)?Z(...A(o).cardEntities):void 0),Bt=ye(()=>le===0?A(d).filter(Ie=>A(o).cardEntities.includes(Ie.entity)):void 0);tt(Zt,{get entity(){return A(oe)},get state(){return A(It)},get actions(){return A(Bt)},cardActionResolve:void 0,get selectedList(){return r()},set selectedList(Ie){r(Ie)},$$legacy:!0}),Nt(2,Xe,()=>_,()=>({key:A(oe).seq})),C(Qe,Xe)};R(ut,Qe=>{(!A(v)||A(v).entity.seq!==A(oe).seq)&&Qe(gt)})}C(O,Oe)});var U=f(g,2);{var T=O=>{var oe=wo(),le=u(oe);L(()=>F(le,`【${(A(o).cardEntities[0].battlePotion==="Attack"?"攻撃表示":A(o).cardEntities[0].battlePotion==="Defense"?"表守備表示":"裏守備表示")??""}】`)),C(O,oe)};R(U,O=>{A(o).cardEntities[0].battlePotion&&O(T)})}C(te,x)};R(S,te=>{A(o).cardEntities.length>0&&te(Y)})}var ne=f(S,2);{var V=te=>{var x=Co(),g=u(x);L(()=>F(g,A(o).cardEntities.length)),C(te,x)};R(ne,te=>{Si.find(x=>x===A(o).cellType)&&te(V)})}var Q=f(ne,2);{var se=te=>{var x=Do(),g=u(x);tt(g,{get entity(){return A(v).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Nt(1,x,()=>N,()=>({key:A(v).entity.seq})),C(te,x)};R(Q,te=>{A(v)&&A(v).entity&&A(v).to===A(o)&&A(v).index==="Top"&&te(se)})}C(K,I)};R(j,K=>{A(o).cellType==="Hand"?K(X):K(J,!1)},!0)}C(D,q)};R(pe,D=>{A(o).cellType==="Disable"?D(ke):D(z,!1)})}L(D=>{fe(ae,`${`duel_field_cell duel_field_cell_${A(o).cellType}`??""} svelte-1mupj1p`),St(ae,"colspan",A(o).cellType==="Hand"?7:1),fe(Ae,`${D??""} svelte-1mupj1p`)},[()=>`duel_card_wrapper ${A(o).cellType} ${A(h)?"can_accept_drop":""} ${P()?"can_action":""}`],ye),ve("dragover",Ae,D=>ie(D)),ve("drop",Ae,D=>B(D)),C(n,ae),be()}ci(["click"]);var Bo=M('<tr><td style=" white-space: nowrap;text-align: center;"> </td><td class="svelte-13svkzh"> </td></tr>'),Eo=M('<div class="duel_log svelte-13svkzh"><table><tbody></tbody></table></div>');function xo(n,e){var d,p;Ne(e,!1);let t=Ce(void 0),i=we(e,"log",12);const a=()=>{i(i()),Nr().then(()=>A(t)&&A(t).scroll(0,A(t).clientHeight*10))};(p=(d=i())==null?void 0:d.onUpdate)==null||p.append(a),Le();var r=Eo(),o=u(r),s=u(o);ue(s,5,()=>i().records,me,(c,m)=>{var k=Bo(),h=u(k),w=u(h),y=f(h),_=u(y);L(()=>{var N,v;fe(h,`duelist ${((N=A(m).duelist)==null?void 0:N.seat)??""} svelte-13svkzh`),F(w,((v=A(m).duelist)==null?void 0:v.profile.name)||"SYSTEM"),F(_,A(m).text)}),C(c,k)}),es(r,c=>G(t,c),()=>A(t)),C(n,r),be()}const To=n=>new Promise(e=>setTimeout(e,n));var Mo=M('<div><div class="duelist_name svelte-12u0sqq"> </div> <div> </div></div>');function Li(n,e){Ne(e,!1);let t=we(e,"duelist",12),i=Ce(0),a=Ce();const r=async()=>{const k=t().lp-A(i);if(!A(a)||Math.abs(k)<10){G(i,t().lp),A(a)&&(A(a)(),G(a,void 0));return}G(i,A(i)+Math.floor(Math.random()*k)),await To(100),r()},o=()=>{t(t()),!A(a)&&t().lp!==A(i)&&new Promise(k=>{G(a,k),Math.abs(t().lp-A(i)),r()})};t().duel.log.onUpdate.append(o),r(),Le();var s=Mo(),d=u(s),p=u(d),c=f(d,2),m=u(c);L(()=>{fe(s,`duelist ${t().seat??""} svelte-12u0sqq`),F(p,t().profile.name),fe(c,`duelist_lp ${(A(a)?"vibration":"")??""} svelte-12u0sqq`),F(m,A(i))}),C(n,s),be()}const No=()=>{};var bo=M("<div><!></div>"),_o=(n,e,t)=>e.resolve(A(t)),Fo=(n,e)=>e.resolve(void 0),Ho=M('<button class="svelte-12javsj">Cancel</button>'),Ko=M('<div class="base svelte-12javsj"><button class="overlay svelte-12javsj">★</button> <div class="window svelte-12javsj"><div> </div> <div class="entities_list svelte-12javsj"></div> <div><button class="svelte-12javsj">OK</button> <!></div></div></div>');function So(n,e){Ne(e,!0);let t=dr(At([]));var i=he(),a=ee(i);{var r=o=>{var s=Ko(),d=u(s);d.__click=[No];var p=f(d,2),c=u(p),m=u(c),k=f(c,2);ue(k,21,()=>e.entities,me,(N,v)=>{var E=bo(),H=u(E);tt(H,{get entity(){return A(v)},isVisibleForcibly:!0,state:"Selectable",entitySelectResolve:P=>e.resolve(P),get qty(){return e.qty},cardActionResolve:void 0,get selectedList(){return A(t)},set selectedList(P){G(t,At(P))}}),C(N,E)});var h=f(k,2),w=u(h);w.__click=[_o,e,t];var y=f(w,2);{var _=N=>{var v=Ho();v.__click=[Fo,e],C(N,v)};R(y,N=>{e.cancelable&&N(_)})}L(N=>{F(m,e.title),w.disabled=N},[()=>!e.validator(A(t))]),C(o,s)};R(a,o=>{o(r)})}C(n,i),be()}ci(["click"]);const Wo=(n,e)=>{e.cancelable&&e.resolve(void 0)};var Po=M('<div class="duel_card_wrapper svelte-11mc7y0"><!> <div> </div></div>'),qo=(n,e)=>e.resolve(),Lo=M('<div><button class="cancel_button svelte-11mc7y0">Cancel</button></div>'),Ro=M('<div><button>★</button> <div><div> </div> <div class="flex svelte-11mc7y0"></div> <!></div></div>');function Oo(n,e){Ne(e,!0);const[t,i]=as(),a=()=>is(r,"$isDragging",t);let r=ts(!1);const o=()=>r.set(!0),s=()=>r.set(!1);e.view.onDragStart.append(o),e.view.onDragEnd.append(s);const d=k=>{const h=k.validate();return h&&h.length>0?"Draggable":"Clickable"};var p=he(),c=ee(p);{var m=k=>{var h=Ro(),w=u(h);w.__click=[Wo,e];var y=f(w,2),_=u(y),N=u(_),v=f(_,2);ue(v,21,()=>e.actions,me,(P,$)=>{var ie=Po(),B=u(ie);const Z=Dt(()=>d(A($))),ae=Dt(()=>e.dragAndDropOnly?[]:[A($)]);tt(B,{get entity(){return A($).entity},isVisibleForcibly:!0,get state(){return A(Z)},get actions(){return A(ae)},get cardActionResolve(){return e.resolve}});var Ae=f(B,2),pe=u(Ae);L(()=>F(pe,`«${A($).title??""}»`)),C(P,ie)});var E=f(v,2);{var H=P=>{var $=Lo(),ie=u($);ie.__click=[qo,e],C(P,$)};R(E,P=>{e.cancelable&&P(H)})}L(()=>{fe(h,`${`base ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),fe(w,`${`overlay ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),fe(y,`${`window ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),F(N,e.title)}),C(k,h)};R(c,k=>{k(m)})}C(n,p),be(),i()}ci(["click"]);var Zo=M('<div class="base svelte-1y912d"><!> <!></div>');function Io(n,e){var p,c;Ne(e,!1);let t=we(e,"modalController",12);const i=()=>{t(t())};(c=(p=t())==null?void 0:p.onUpdate)==null||c.append(i),Le();var a=Zo(),r=u(a);{var o=m=>{So(m,{get title(){return t().duelEntitiesSelectorArg.title},get entities(){return t().duelEntitiesSelectorArg.entities},get validator(){return t().duelEntitiesSelectorArg.validator},get qty(){return t().duelEntitiesSelectorArg.qty},get cancelable(){return t().duelEntitiesSelectorArg.cancelable},resolve:k=>{t().duelEntitiesSelectorResolve(k)}})};R(r,m=>{t().states.DuelEntitiesSelector==="Shown"&&m(o)})}var s=f(r,2);{var d=m=>{const k=ye(()=>t().cardActionSelectorArg.dragAndDropOnly??!1);Oo(m,{get view(){return t().view},get title(){return t().cardActionSelectorArg.title},get actions(){return t().cardActionSelectorArg.actions},get dragAndDropOnly(){return A(k)},get cancelable(){return t().cardActionSelectorArg.cancelable},resolve:h=>{console.info(h),t().cardActionSelectorResolve(h)}})};R(s,m=>{t().states.DuelActionSelector==="Shown"&&m(d)})}C(n,a),be()}var Uo=M('<div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div> <div class="duel_card_info_row svelte-1qhzdl0" style=" justify-content: space-between;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div>',1),jo=M('<div></div> <div class="svelte-1qhzdl0"> </div>',1),$o=M("<div> </div>"),Yo=M("<div> </div>"),zo=M('<div class="duel_card_info_row svelte-1qhzdl0"><!> <!></div> <div class="duel_card_info_row svelte-1qhzdl0"></div>',1),Vo=M('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),Go=M('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),Qo=M('<div><div class="duel_card_info_header svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"> </div></div> <div class="duel_card_info_row svelte-1qhzdl0" style="position:sticky; top:0;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div> <!> <!></div> <div class="duel_card_info_body svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div></div> <div class="duel_card_info_footer svelte-1qhzdl0"><div class="duel_card_info_links svelte-1qhzdl0"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1qhzdl0">⇒遊戯王カードWiki</a></div></div></div>');function Xo(n,e){Ne(e,!1);let t=we(e,"entity",8,void 0);const i=()=>t()?Te[t().origin.name]:void 0;Le();var a=he(),r=ee(a);{var o=s=>{var d=Qo(),p=u(d),c=u(p),m=u(c),k=u(m),h=f(c,2),w=u(h),y=u(w),_=f(w,2),N=u(_),v=f(h,2);{var E=D=>{var q=Uo(),j=ee(q),X=u(j),J=u(X),K=u(J),I=f(j,2),b=u(I),W=u(b),S=f(b,2),Y=u(S);L(()=>{F(K,Te[t().origin.name].pendulumDescription),F(W,`◀ ${t().psL??""}`),F(Y,`${t().psR??""} ▶`)}),C(D,q)};R(v,D=>{var q;(q=t().status.monsterCategories)!=null&&q.includes("Pendulum")&&D(E)})}var H=f(v,2);{var P=D=>{var q=zo(),j=ee(q),X=u(j);ue(X,1,()=>t().attr,me,(b,W)=>{var S=jo(),Y=ee(S),ne=f(Y,2),V=u(ne);L(()=>{fe(Y,`monster_attr ${A(W)??""} svelte-1qhzdl0`),F(V,`${mi[A(W)]??""}属性`)}),C(b,S)});var J=f(X,2);{var K=b=>{var W=$o(),S=u(W);L(()=>{fe(W,`monster_cat ${t().status.type??""} svelte-1qhzdl0`),F(S,`${rn[t().status.type]??""}${Fn[t().status.type]??""}族`)}),C(b,W)};R(J,b=>{t().status.type&&b(K)})}var I=f(j,2);ue(I,5,()=>t().status.monsterCategories??[],me,(b,W)=>{var S=Yo(),Y=u(S);L(()=>{fe(S,`monster_cat ${A(W)??""} svelte-1qhzdl0`),F(Y,`${tn[A(W)]??""}${_n[A(W)]??""}`)}),C(b,S)}),C(D,q)},$=D=>{var q=he(),j=ee(q);{var X=K=>{var I=Vo(),b=f(u(I),2),W=u(b);L(()=>F(W,`${nn[t().status.spellCategory]??""}魔法`)),C(K,I)},J=K=>{var I=he(),b=ee(I);{var W=S=>{var Y=Go(),ne=f(u(Y),2),V=u(ne);L(()=>F(V,`${an[t().status.trapCategory]??""}罠`)),C(S,Y)};R(b,S=>{t().status.kind==="Trap"&&t().status.trapCategory&&S(W)},!0)}C(K,I)};R(j,K=>{t().status.kind==="Spell"&&t().status.spellCategory?K(X):K(J,!1)},!0)}C(D,q)};R(H,D=>{t().status.kind==="Monster"?D(P):D($,!1)})}var ie=f(p,2),B=u(ie),Z=u(B),ae=u(Z),Ae=u(ae),pe=f(ie,2),ke=u(pe),z=u(ke);L((D,q,j,X,J)=>{fe(d,`duel_card duel_card_info ${t().origin.kind??""} ${D??""} svelte-1qhzdl0`),F(k,t().nm),F(y,q),F(N,j),F(Ae,X),St(z,"href",J)},[()=>{var D;return(D=t().origin.monsterCategories)==null?void 0:D.join(" ")},()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0),()=>{var D;return(D=i())==null?void 0:D.description},()=>{var D;return(D=i())==null?void 0:D.wikiHref}],ye),C(s,d)};R(r,s=>{t()&&s(o)})}C(n,a),be()}var Jo=M('<div class="duel_field_cell_info_item svelte-1xj7qf1"><!></div>'),eA=M('<div class="duel_field_cell_info_box svelte-1xj7qf1"><div class="duel_field_cell_info_label svelte-1xj7qf1"> </div> <!></div>'),tA=M('<div class="duel_field_cell_info svelte-1xj7qf1"><div class="duel_field_cell_info_header item_btn svelte-1xj7qf1"><div class="svelte-1xj7qf1"> </div> <div class="svelte-1xj7qf1"> </div></div> <div class="duel_field_cell_info_body svelte-1xj7qf1"></div></div>');function nA(n,e){Ne(e,!1);let t=we(e,"cell",12);const i=()=>{t(t())},a=k=>t().cardEntities.filter(h=>h.face===k);t().field.duel.view.onDuelUpdate.append(i),Le();var r=tA(),o=u(r),s=u(o),d=u(s),p=f(s,2),c=u(p),m=f(o,2);ue(m,4,()=>["FaceUp","FaceDown"],me,(k,h)=>{var w=he(),y=ee(w);{var _=N=>{var v=eA(),E=u(v),H=u(E),P=f(E,2);ue(P,1,()=>a(h).toSorted(Os),me,($,ie)=>{var B=Jo(),Z=u(B);const ae=ye(()=>t().owner===t().field.duel.duelists.Below);tt(Z,{get entity(){return A(ie)},get isVisibleForcibly(){return A(ae)},isWideMode:!0,cardActionResolve:void 0}),C($,B)}),L(()=>F(H,h==="FaceUp"?"表向き":"裏向き")),C(N,v)};R(y,N=>{a(h).length&&N(_)})}C(k,w)}),L(()=>{var k;F(d,(k=t().owner)==null?void 0:k.profile.name),F(c,t().cellType)}),C(n,r),be()}const iA=Gs({duration:400});var aA=M('<div class="duel_field_header_message svelte-accyye"> </div> <div class="duel_field_header_buttons svelte-accyye"><button class="svelte-accyye">サレンダー</button></div>',1),rA=M("<tr></tr>"),sA=M('<table class="duel_field svelte-accyye"><tbody class="svelte-accyye"></tbody></table>'),oA=M('<button class="svelte-accyye">OK</button>'),AA=M('<div style="position:absolute;right:0;top:0"> </div> <div class="flex duel_desk svelte-accyye"><div class="duel_desk_left v_flex svelte-accyye"><!> <!> <!></div> <div class=" duel_desk_center v_flex svelte-accyye"><div class="duel_field_header svelte-accyye"><!></div> <div class="svelte-accyye"><!></div> <div class="duel_field_footer svelte-accyye"><!></div></div> <div class=" duel_desk_right svelte-accyye" style="text-align: left;"><!></div></div> <!>',1);function lA(n,e){Ne(e,!1);let t=we(e,"duel",12),i=()=>{},a=Ce(()=>!0),r=Ce();const o=K=>{i=K.resolve,G(a,K.entitiesValidator),G(r,K.selectableEntities),K.duelEntitiesSelectorArg&&t().view.modalController.selectDuelEntities(K.duelEntitiesSelectorArg).then(I=>{i({selectedEntities:I})})};t().view.onWaitStart.append(o);let s=Ce(void 0);const d=K=>{G(s,K)};t().view.onShowCardEntity.append(d);let p=we(e,"selectedList",28,()=>[]);const c=()=>{t(t())};t().view.onDuelUpdate.append(c);const m=()=>{A(a)(p())&&i({selectedEntities:p()})},k=()=>{i({surrender:!0})};t().main(),Le();var h=AA(),w=ee(h),y=u(w),_=f(w,2),N=u(_),v=u(N);Li(v,{get duelist(){return t().duelists.Above}});var E=f(v,2);Xo(E,{get entity(){return A(s)}});var H=f(E,2);Li(H,{get duelist(){return t().duelists.Below}});var P=f(N,2),$=u(P),ie=u($);{var B=K=>{var I=aA(),b=ee(I),W=u(b),S=f(b,2),Y=u(S);L(()=>F(W,`[TURN:${t().clock.turn}][PHASE:${t().phase}] ${t().view.message}`)),ve("click",Y,k),C(K,I)};R(ie,K=>{t().isEnded||K(B)})}var Z=f($,2),ae=u(Z);{var Ae=K=>{var I=sA(),b=u(I);ue(b,5,()=>t().field.cells,me,(W,S,Y)=>{var ne=rA();fe(ne,`${`duel_desk_row_${Y}`??""} svelte-accyye`),ue(ne,5,()=>A(S),me,(V,Q,se)=>{go(V,{get view(){return t().view},row:Y,column:se,get selectedList(){return p()},set selectedList(te){p(te)},$$legacy:!0})}),C(W,ne)}),C(K,I)};R(ae,K=>{t().clock.turn>0&&K(Ae)})}var pe=f(Z,2),ke=u(pe);{var z=K=>{var I=oA();L(b=>I.disabled=b,[()=>!A(a)(p())],ye),ve("click",I,m),C(K,I)};R(ke,K=>{A(r)&&A(r).length>0&&K(z)})}var D=f(P,2),q=u(D);{var j=K=>{xo(K,{get log(){return t().log}})},X=K=>{var I=he(),b=ee(I);{var W=S=>{nA(S,{get cell(){return t().view.infoBoardCell}})};R(b,S=>{t().view.infoBoardState==="CellInfo"&&S(W)},!0)}C(K,I)};R(q,K=>{t().view.infoBoardState==="Log"?K(j):K(X,!1)})}var J=f(_,2);Io(J,{get modalController(){return t().view.modalController}}),L(K=>F(y,K),[()=>t().clock.toString()],ye),C(n,h),be()}var dA=M("<div></div>"),pA=M('<span> </span> / <span style="display: inline-block;width:2rem;text-align: right;"> </span>',1),cA=M('<li class="deck_editor_item svelte-vivzk2"><div role="listitem"><div class="svelte-vivzk2"><div class="svelte-vivzk2"> </div> <div style="display:flex" class="svelte-vivzk2"><div class="svelte-vivzk2"><!> <!> <!> <!> <!> <!> <!></div> <div style="flex-grow: 1; width:0.1rem" class="svelte-vivzk2"></div> <div class="svelte-vivzk2"><!></div></div></div></div> <button class="button_style_reset svelte-vivzk2">+</button> <button class="button_style_reset svelte-vivzk2">-</button></li>'),kA=M('<div class="deck_editor_card_kind svelte-vivzk2"><span class="svelte-vivzk2"> </span> <ul class="svelte-vivzk2"></ul></div>'),mA=M('<div class="deck_editor_deck_type svelte-vivzk2"><span class="svelte-vivzk2"> </span> <!></div>'),uA=M('<div class="deck_editor_card_list svelte-vivzk2"></div>');function Ri(n,e){Ne(e,!1);let t=we(e,"allCardInfos",8),i=we(e,"deckCardInfos",12),a=we(e,"mode",8),r=we(e,"onAttention",8);const o={Deck:["Monster","Spell","Trap"],ExtraDeck:["Monster"]},s=(m,k)=>(a()==="List"?t():i()).filter(h=>{var w;return Xn.has(h.name)||((w=h.monsterCategories)==null?void 0:w.includes("Normal"))}).filter(h=>!k||h.kind===k).filter(h=>{var w,y;return!m||m==="Deck"&&!((w=h==null?void 0:h.monsterCategories)!=null&&w.union(Qt).length)||m==="ExtraDeck"&&((y=h==null?void 0:h.monsterCategories)==null?void 0:y.union(Qt).length)}).toSorted(pn),d=(m,k)=>{const h=i().filter(y=>y.name===k.name).length;if(h>2)return;const w=m.shiftKey?3-h:1;w<1||(i().push(...Array(w).fill(k)),i().sort(pn),i(i()))},p=(m,k)=>{let h=0;i(i().filter(w=>w.name!==k.name?!0:(h++,!m.shiftKey&&h>1))),i().sort(pn)};Le();var c=uA();ue(c,5,()=>ls,me,(m,k)=>{var h=mA(),w=u(h),y=u(w),_=f(w,2);ue(_,1,()=>o[A(k)],me,(N,v)=>{var E=kA(),H=u(E),P=u(H),$=f(H,2);ue($,5,()=>s(A(k),A(v)),me,(ie,B)=>{var Z=cA(),ae=u(Z),Ae=u(ae),pe=u(Ae),ke=u(pe),z=f(pe,2),D=u(z),q=u(D);{var j=T=>{var O=Tt();L(()=>F(O,`★${A(B).level??""}`)),C(T,O)};R(q,T=>{A(B).level&&T(j)})}var X=f(q,2);{var J=T=>{var O=Tt();L(()=>F(O,`☆${A(B).rank??""}`)),C(T,O)};R(X,T=>{A(B).rank&&T(J)})}var K=f(X,2);{var I=T=>{var O=dA();L(()=>fe(O,`monster_attr ${A(B).attribute??""} svelte-vivzk2`)),C(T,O)};R(K,T=>{A(B).attribute!==void 0&&T(I)})}var b=f(K,2);{var W=T=>{var O=Tt();L(()=>F(O,rn[A(B).type])),C(T,O)};R(b,T=>{A(B).type!==void 0&&T(W)})}var S=f(b,2);ue(S,1,()=>A(B).monsterCategories??[],me,(T,O)=>{var oe=Tt();L(()=>F(oe,tn[A(O)])),C(T,oe)});var Y=f(S,2);{var ne=T=>{var O=Tt();L(()=>F(O,`${nn[A(B).spellCategory]??""}魔法`)),C(T,O)};R(Y,T=>{A(B).spellCategory!==void 0&&T(ne)})}var V=f(Y,2);{var Q=T=>{var O=Tt();L(()=>F(O,`${an[A(B).trapCategory]??""}罠`)),C(T,O)};R(V,T=>{A(B).trapCategory!==void 0&&T(Q)})}var se=f(D,4),te=u(se);{var x=T=>{var O=pA(),oe=ee(O),le=u(oe),Oe=f(oe,2),ut=u(Oe);L(()=>{F(le,A(B).attack),F(ut,A(B).defense??"-")}),C(T,O)};R(te,T=>{A(B).attack!==void 0&&T(x)})}var g=f(ae,2),U=f(g,2);L(T=>{fe(ae,`${T??""} svelte-vivzk2`),F(ke,A(B).name)},[()=>{var T,O;return`deck_editor_card duel_card ${A(B).kind} ${(O=(T=A(B))==null?void 0:T.monsterCategories)==null?void 0:O.join(" ")} ${Xn.has(A(B).name)?"is_implemented":"is_not_implemented"}`}],ye),ve("mouseenter",ae,()=>r()(A(B))),ve("click",g,T=>d(T,A(B))),ve("click",U,T=>p(T,A(B))),C(ie,Z)}),L(()=>F(P,Ea[A(v)])),C(N,E)}),L(()=>F(y,ds[A(k)])),C(m,h)}),C(n,c),be()}var hA=M('<div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_row svelte-1xf9hqi" style=" justify-content: space-between;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div>',1),wA=M('<div></div> <div class="svelte-1xf9hqi"> </div>',1),fA=M("<div> </div>"),CA=M("<div> </div>"),DA=M('<div class="duel_card_info_row svelte-1xf9hqi"><!> <!></div> <div class="duel_card_info_row svelte-1xf9hqi"></div>',1),yA=M('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),vA=M('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),gA=M('<div><div class="duel_card_info_header svelte-1xf9hqi"><div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"> </div></div> <div class="duel_card_info_row svelte-1xf9hqi" style="position:sticky; top:0;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div></div> <div class="duel_card_info_body svelte-1xf9hqi"><!> <!> <div class="duel_card_info_row description svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_links svelte-1xf9hqi"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1xf9hqi">⇒遊戯王カードWiki</a></div></div></div>');function BA(n,e){Ne(e,!1);let t=we(e,"cardInfo",8,void 0);const i=()=>t()?Te[t().name]:void 0;Le();var a=he(),r=ee(a);{var o=s=>{var d=gA(),p=u(d),c=u(p),m=u(c),k=u(m),h=f(c,2),w=u(h),y=u(w),_=f(w,2),N=u(_),v=f(p,2),E=u(v);{var H=z=>{var D=hA(),q=ee(D),j=u(q),X=u(j),J=u(X),K=f(q,2),I=u(K),b=u(I),W=f(I,2),S=u(W);L(()=>{F(J,Te[t().name].pendulumDescription),F(b,`◀ ${t().pendulumScaleL??""}`),F(S,`${t().pendulumScaleR??""} ▶`)}),C(z,D)};R(E,z=>{var D;(D=t().monsterCategories)!=null&&D.includes("Pendulum")&&z(H)})}var P=f(E,2);{var $=z=>{var D=DA(),q=ee(D),j=u(q);{var X=b=>{var W=wA(),S=ee(W),Y=f(S,2),ne=u(Y);L(()=>{fe(S,`monster_attr ${t().attribute??""} svelte-1xf9hqi`),F(ne,`${mi[t().attribute]??""}属性`)}),C(b,W)};R(j,b=>{t().attribute&&b(X)})}var J=f(j,2);{var K=b=>{var W=fA(),S=u(W);L(()=>{fe(W,`monster_cat ${t().type??""} svelte-1xf9hqi`),F(S,`${rn[t().type]??""}${Fn[t().type]??""}族`)}),C(b,W)};R(J,b=>{t().type&&b(K)})}var I=f(q,2);ue(I,5,()=>t().monsterCategories??[],me,(b,W)=>{var S=CA(),Y=u(S);L(()=>{fe(S,`monster_cat ${A(W)??""} svelte-1xf9hqi`),F(Y,`${tn[A(W)]??""}${_n[A(W)]??""}`)}),C(b,S)}),C(z,D)},ie=z=>{var D=he(),q=ee(D);{var j=J=>{var K=yA(),I=f(u(K),2),b=u(I);L(()=>F(b,`${nn[t().spellCategory]??""}魔法`)),C(J,K)},X=J=>{var K=he(),I=ee(K);{var b=W=>{var S=vA(),Y=f(u(S),2),ne=u(Y);L(()=>F(ne,`${an[t().trapCategory]??""}罠`)),C(W,S)};R(I,W=>{t().kind==="Trap"&&t().trapCategory&&W(b)},!0)}C(J,K)};R(q,J=>{t().kind==="Spell"&&t().spellCategory?J(j):J(X,!1)},!0)}C(z,D)};R(P,z=>{t().kind==="Monster"?z($):z(ie,!1)})}var B=f(P,2),Z=u(B),ae=u(Z),Ae=u(ae),pe=f(B,2),ke=u(pe);L((z,D,q,j,X)=>{fe(d,`duel_card duel_card_info ${t().kind??""} ${z??""} svelte-1xf9hqi`),F(k,t().name),F(y,D),F(N,q),F(Ae,j),St(ke,"href",X)},[()=>{var z;return(z=t().monsterCategories)==null?void 0:z.join(" ")},()=>"★".repeat(t().level||0),()=>"☆".repeat(t().rank||0),()=>{var z;return(z=i())==null?void 0:z.description},()=>{var z;return(z=i())==null?void 0:z.wikiHref}],ye),C(s,d)};R(r,s=>{t()&&s(o)})}C(n,a),be()}const EA={0:{aaa:"日",aaaa:"日曜日",ddd:"Sun",dddd:"Sunday"},1:{aaa:"月",aaaa:"月曜日",ddd:"Mon",dddd:"Monday"},2:{aaa:"火",aaaa:"火曜日",ddd:"Tue",dddd:"Tuesday"},3:{aaa:"水",aaaa:"水曜日",ddd:"Wed",dddd:"Wednesday"},4:{aaa:"木",aaaa:"木曜日",ddd:"Thu",dddd:"Thursday"},5:{aaa:"金",aaaa:"金曜日",ddd:"Fri",dddd:"Friday"},6:{aaa:"土",aaaa:"土曜日",ddd:"Sat",dddd:"Saturday"}};class xA{constructor(){l(this,"DefaultSeparator1","/");l(this,"DefaultSeparator2"," ");l(this,"DefaultSeparator3",":");l(this,"createDate",e=>{if(!e)return;const t=new Date(e);if(!isNaN(t.getTime()))return t});l(this,"createDateOr",(e,t)=>this.createDate(e)||t||new Date);l(this,"truncateDate",e=>{const t=e||new Date;return new Date(t.getFullYear(),t.getMonth(),t.getDate())});l(this,"addDate",(e,t)=>{const i=this.createDateOr(e);return i.setDate(i.getDate()+t),i});l(this,"addMonth",(e,t)=>{const i=this.createDateOr(e);return i.setMonth(i.getMonth()+t),i});l(this,"addYear",(e,t)=>{const i=this.createDateOr(e);return i.setFullYear(i.getFullYear()+t),i});l(this,"getDayOfWeek",(e,t="dddd")=>{const i=this.createDate(e);return i?EA[i.getDay()][t]:""});l(this,"formatToYYYYMMDD",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";const a=i.getFullYear().toString(),r=("0"+(i.getMonth()+1)).slice(-2),o=("0"+i.getDate()).slice(-2);return a+t+r+t+o});l(this,"formatToYYYYMM",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getFullYear().toString(),r=("0"+(i.getMonth()+1)).slice(-2);return a+t+r});l(this,"formatToHHMMSS",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getHours(),r=i.getMinutes(),o=i.getSeconds();return("0"+a).slice(-2)+t+("0"+r).slice(-2)+t+("0"+o).slice(-2)});l(this,"formatToHHMM",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=("0"+i.getHours()).slice(-2),r=("0"+i.getMinutes()).slice(-2);return a+t+r});l(this,"formatToYYYYMMDD_HHMM",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const r=this.createDate(e);return r?this.formatToYYYYMMDD(r,t)+i+this.formatToHHMM(r,a):""});l(this,"formatToYYYYMMDD_HHMMSS",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const r=this.createDate(e);return r?this.formatToYYYYMMDD(r,t)+i+this.formatToHHMMSS(r,a):""})}}const Re=new xA;Date.prototype.truncateDate=function(){return Re.truncateDate(this)};Date.prototype.getCloneOr=function(n){return Re.createDateOr(this,n)};Date.prototype.addDate=function(n){return Re.addDate(this,n)};Date.prototype.addMonth=function(n){return Re.addDate(this,n)};Date.prototype.addYear=function(n){return Re.addDate(this,n)};Date.prototype.getDayOfWeek=function(n="dddd"){return Re.getDayOfWeek(this,n)};Date.prototype.formatToYYYYMM=function(n){return Re.formatToYYYYMM(this,n)};Date.prototype.formatToYYYYMMDD=function(n){return Re.formatToYYYYMMDD(this,n)};Date.prototype.formatToYYYYMMDD_HHMM=function(n,e,t){return Re.formatToYYYYMMDD_HHMM(this,n,e,t)};Date.prototype.formatToYYYYMMDD_HHMMSS=function(n,e,t){return Re.formatToYYYYMMDD_HHMMSS(this,n,e,t)};Date.prototype.formatToHHMM=function(n){return Re.formatToHHMM(this,n)};Date.prototype.formatToHHMMSS=function(n){return Re.formatToHHMMSS(this,n)};var TA=M('<label><input type="checkbox"> </label>'),MA=M('<label><input type="checkbox"> </label>'),NA=M('<label><input type="checkbox"> <div style="display: inline-block;"></div> </label>'),bA=M('<label><input type="checkbox"> </label>'),_A=M('<label><input type="checkbox"> </label>'),FA=M('<label><input type="checkbox"> </label>'),HA=M("<option> </option>"),KA=M('<div class="deck_editor_body_right_header svelte-rsq0rf"><div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">編集対象</div> <select></select></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">新規名称</div> <input type="text"></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">操作</div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを保存</button></div> <div class="svelte-rsq0rf"></div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを複製</button></div> <div class="svelte-rsq0rf"><button title="shiftキー押下で確認メッセージスキップ" class="svelte-rsq0rf">デッキを削除</button></div></div></div> <!>',1),SA=M("<div>デッキ情報読込中</div>"),WA=M('<div class="deck_editor svelte-rsq0rf"><div class="deck_editor_header"></div> <div class="deck_editor_body svelte-rsq0rf"><div class="deck_editor_body_left svelte-rsq0rf"><div class="deck_editor_search_box svelte-rsq0rf"><div><div>検索条件</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">名称</div> <div class="svelte-rsq0rf"><input type="text" style="width:70%">※ルビには対応していません</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種類</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">モンスター</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">属性</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種族</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">魔法</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">罠</div> <div class="svelte-rsq0rf"></div></div></div> <!></div> <div class="deck_editor_body_center svelte-rsq0rf"><!></div> <div class="deck_editor_body_right svelte-rsq0rf"><!></div></div></div>');function PA(n,e){Ne(e,!1);const t=[],i=[],a=[],r=[],o=[],s=[],d=async()=>{const g=(await A(m)).find(U=>U.id===A(c));g&&G(h,{...g,cardInfos:g.cardNames.map(U=>Te[U])})},p=()=>Ct.getAllDeckInfo().then(x=>(x.forEach(g=>console.log(g.id,g.lastUsedAt,g.lastUsedAt.getTime())),console.log(Math.max(...x.map(g=>g.lastUsedAt.getTime()))),G(c,(x.find(g=>g.lastUsedAt.getTime()===Math.max(...x.map(U=>U.lastUsedAt.getTime())))??x[0]).id),x));let c=Ce(-1),m=Ce(p());A(m).then(d);const k=()=>{G(m,p()),d()};let h=Ce({id:Number.MIN_VALUE,name:"",description:"",lastUsedAt:new Date,cardInfos:[]}),w=Ce(Te.ゾンビーノ);const y=Ce({name:"",cardKinds:[...zn],monsterCategories:[...Ni].filter(x=>x!=="Normal"&&x!=="Token"),monsterAttributes:[...bi],monsterTypes:[..._i],spellCategories:[...Fi],trapCategories:[...Hi]}),_=()=>Object.values(Te).filter(x=>{var g;if(!A(y).cardKinds.includes(x.kind)||A(y).name.trim().length&&!x.name.includes(A(y).name))return!1;if(x.kind==="Monster")return x.attribute&&!A(y).monsterAttributes.includes(x.attribute)||x.type&&!A(y).monsterTypes.includes(x.type)?!1:(g=x.monsterCategories)==null?void 0:g.union(A(y).monsterCategories).length;if(x.kind==="Spell")return x.spellCategory&&A(y).spellCategories.includes(x.spellCategory);if(x.kind==="Trap")return x.trapCategory&&A(y).trapCategories.includes(x.trapCategory)}),N=x=>{G(w,x)},v=async()=>{const g=(await A(m)).find(U=>U.id===A(c));if(!g)throw new Error("illegal state");return g},E=async()=>{const x=await v();await x.saveDeckInfo({...x,name:A(h).name,cardNames:A(h).cardInfos.map(g=>g.name),lastUsedAt:new Date}),k()},H=async()=>{(await Ct.createNewDeck(`デッキ_${new Date().formatToYYYYMMDD_HHMMSS("","","")}`,`コピー日時：${new Date().formatToYYYYMMDD_HHMMSS("-"," ",":")}`,A(h).cardInfos.map(g=>g.name))).saveDeckInfo(),k()},P=async x=>{const g=await v();!x.shiftKey&&!confirm(`デッキ【${g.name}】を削除します。
よろしいですか？`)||(await g.delete(),k())};Le();var $=WA(),ie=f(u($),2),B=u(ie),Z=u(B),ae=f(u(Z),2),Ae=f(u(ae),2),pe=u(Ae),ke=f(ae,2),z=f(u(ke),2);ue(z,5,()=>zn,me,(x,g)=>{var U=TA(),T=u(U),O,oe=f(T);L(()=>{O!==(O=A(g))&&(T.value=(T.__value=A(g))==null?"":A(g)),F(oe,` ${Ea[A(g)]??""}`)}),bt(t,[],T,()=>(A(g),A(y).cardKinds),le=>Fe(y,A(y).cardKinds=le)),C(x,U)});var D=f(ke,2),q=f(u(D),2);ue(q,5,()=>Ni,me,(x,g)=>{var U=MA(),T=u(U),O,oe=f(T);L(()=>{O!==(O=A(g))&&(T.value=(T.__value=A(g))==null?"":A(g)),F(oe,` ${tn[A(g)]??""}${_n[A(g)]??""}`)}),bt(i,[],T,()=>(A(g),A(y).monsterCategories),le=>Fe(y,A(y).monsterCategories=le)),C(x,U)});var j=f(D,2),X=f(u(j),2);ue(X,5,()=>bi,me,(x,g)=>{var U=NA(),T=u(U),O,oe=f(T,2),le=f(oe);L(()=>{O!==(O=A(g))&&(T.value=(T.__value=A(g))==null?"":A(g)),fe(oe,`monster_attr ${A(w).attribute??""} svelte-rsq0rf`),F(le,` ${mi[A(g)]??""}`)}),bt(a,[],T,()=>(A(g),A(y).monsterAttributes),Oe=>Fe(y,A(y).monsterAttributes=Oe)),C(x,U)});var J=f(j,2),K=f(u(J),2);ue(K,5,()=>_i,me,(x,g)=>{var U=bA(),T=u(U),O,oe=f(T);L(()=>{O!==(O=A(g))&&(T.value=(T.__value=A(g))==null?"":A(g)),F(oe,` ${rn[A(g)]??""}
                ${Fn[A(g)]??""}`)}),bt(r,[],T,()=>(A(g),A(y).monsterTypes),le=>Fe(y,A(y).monsterTypes=le)),C(x,U)});var I=f(J,2),b=f(u(I),2);ue(b,5,()=>Fi,me,(x,g)=>{var U=_A(),T=u(U),O,oe=f(T);L(()=>{O!==(O=A(g))&&(T.value=(T.__value=A(g))==null?"":A(g)),F(oe,` ${nn[A(g)]??""}`)}),bt(o,[],T,()=>(A(g),A(y).spellCategories),le=>Fe(y,A(y).spellCategories=le)),C(x,U)});var W=f(I,2),S=f(u(W),2);ue(S,5,()=>Hi,me,(x,g)=>{var U=FA(),T=u(U),O,oe=f(T);L(()=>{O!==(O=A(g))&&(T.value=(T.__value=A(g))==null?"":A(g)),F(oe,` ${an[A(g)]??""}`)}),bt(s,[],T,()=>(A(g),A(y).trapCategories),le=>Fe(y,A(y).trapCategories=le)),C(x,U)});var Y=f(Z,2);BA(Y,{get cardInfo(){return A(w)}});var ne=f(B,2),V=u(ne);const Q=ye(_);Ri(V,{mode:"List",get allCardInfos(){return A(Q)},onAttention:N,get deckCardInfos(){return A(h).cardInfos},set deckCardInfos(x){Fe(h,A(h).cardInfos=x)},$$legacy:!0});var se=f(ne,2),te=u(se);Un(te,()=>A(m),x=>{var g=SA();C(x,g)},(x,g)=>{var U=KA(),T=ee(U),O=u(T),oe=f(u(O),2);L(()=>{A(c),Ca(()=>{A(g)})}),ue(oe,5,()=>A(g),me,(Ue,Et)=>{var xt=HA(),ui={},Na=u(xt);L(()=>{ui!==(ui=A(Et).id)&&(xt.value=(xt.__value=A(Et).id)==null?"":A(Et).id),F(Na,A(Et).name)}),C(Ue,xt)});var le=f(O,2),Oe=f(u(le),2),ut=f(le,2),gt=f(u(ut),2),Qe=u(gt),Xe=f(gt,4),Zt=u(Xe),It=f(Xe,2),Bt=u(It),Ie=f(T,2);Ri(Ie,{mode:"Deck",allCardInfos:[],onAttention:N,get deckCardInfos(){return A(h).cardInfos},set deckCardInfos(Ue){Fe(h,A(h).cardInfos=Ue)},$$legacy:!0}),ga(oe,()=>A(c),Ue=>G(c,Ue)),ve("change",oe,d),$n(Oe,()=>A(h).name,Ue=>Fe(h,A(h).name=Ue)),ve("click",Qe,E),ve("click",Zt,H),ve("click",Bt,P),C(x,U)}),$n(pe,()=>A(y).name,x=>Fe(y,A(y).name=x)),C(n,$),be()}const qA=["TblDeckHeader","TblDeckDetail","TblDuelistProfile"],LA=3;var RA=M("<option> </option>"),OA=M('<div class="svelte-1np031i"><label for="deck_selector" class="deck_selector svelte-1np031i">デッキ：</label> <select id="deck_selector" class="deck_selector svelte-1np031i"></select></div> <div class="svelte-1np031i"><button class="btn svelte-1np031i">duel start!</button></div>',1),ZA=M('<div class="svelte-1np031i">デッキ情報の読み込み、もしくは作成中...</div>'),IA=M('<div class="svelte-1np031i"><label for="duelist_name" class="duelist_name svelte-1np031i">名前：</label> <input id="duelist_name" class="duelist_name svelte-1np031i" type="text"></div> <!> <div class="svelte-1np031i"><button class="btn svelte-1np031i">deck edit</button></div>',1),UA=M('<div class="svelte-1np031i">デュエリスト情報の読み込み、もしくは作成中...</div>'),jA=M('<div class="app_body svelte-1np031i"><!></div>'),$A=M('<main class="svelte-1np031i"><!> <div class="screen_info svelte-1np031i"></div></main>');function YA(n,e){Ne(e,!1);const t=new os("stk_ygo_svelte",LA,qA);let i=Ce(),a=Ce("None"),r=Ce(0);const o=Vn.getOrCreateNew(t);let s=Ce(Ct.getAllDeckInfo(t).then(E=>(G(r,(E.find(H=>H.lastUsedAt.getTime()===Math.max(...E.map(P=>P.lastUsedAt.getTime())))??E[0]).id),E)));const d=async()=>{let E=(await A(s)).find(H=>H.id===A(r));if(E||(E=(await c()).find(H=>H.id===A(r))),!E)throw new Error("illegal state");return E},p=async()=>{(await o).save()},c=()=>(G(s,Ct.getAllDeckInfo(t).then(E=>(G(r,(E.find(H=>H.lastUsedAt.getTime()===Math.max(...E.map(P=>P.lastUsedAt.getTime())))??E[0]).id),E))),A(s)),m=async()=>{(await A(s)).length||(await Ct.prepareSampleDeck(),c())},k=async()=>{await Promise.all([p(),m()]),(await d()).updateTimestamp(),G(i,new vs(await o,"Player",await d(),us[0],"NPC",cn[0]))},h=async()=>{console.log("hoge"),await Promise.all([p(),m()]),G(a,"DeckEdit")},w=async E=>{await p(),E.key==="Enter"&&!E.repeat&&(await o).save()};m(),Le();var y=$A(),_=u(y);{var N=E=>{lA(E,{get duel(){return A(i)}})},v=E=>{var H=he(),P=ee(H);{var $=B=>{PA(B,{})},ie=B=>{var Z=jA(),ae=u(Z);Un(ae,()=>o,Ae=>{var pe=UA();C(Ae,pe)},(Ae,pe)=>{var ke=IA(),z=ee(ke),D=f(u(z),2),q=f(z,2);Un(q,()=>A(s),J=>{var K=ZA();C(J,K)},(J,K)=>{var I=OA(),b=ee(I),W=f(u(b),2);L(()=>{A(r),Ca(()=>{A(K)})}),ue(W,5,()=>A(K),me,(ne,V)=>{var Q=RA(),se={},te=u(Q);L(()=>{se!==(se=A(V).id)&&(Q.value=(Q.__value=A(V).id)==null?"":A(V).id),F(te,A(V).name)}),C(ne,Q)});var S=f(b,2),Y=u(S);ga(W,()=>A(r),ne=>G(r,ne)),ve("click",Y,k),C(J,I)});var j=f(q,2),X=u(j);$n(D,()=>A(pe).name,J=>A(pe).name=J),ve("keypress",D,w),ve("click",X,h),C(Ae,ke)}),C(B,Z)};R(P,B=>{A(a)==="DeckEdit"?B($):B(ie,!1)},!0)}C(E,H)};R(_,E=>{A(i)?E(N):E(v,!1)})}C(n,y),be()}qr(YA,{target:document.getElementById("app")});
