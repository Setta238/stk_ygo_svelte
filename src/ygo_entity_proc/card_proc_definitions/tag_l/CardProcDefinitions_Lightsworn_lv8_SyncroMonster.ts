...
import { defaultPrepare, getPayBanishCostsActionPartical } from "@ygo_entity_proc/card_actions/CardActions";
    ...
    actions: [
      ...
      },
      {
        ...
        execute: async (myInfo) => {
          ...
          if (!qty) {
            throw new SystemError(`${myInfo.action.entity}の効果を不正な方法で実行しようとした。${myInfo.costInfo}`);
          }
