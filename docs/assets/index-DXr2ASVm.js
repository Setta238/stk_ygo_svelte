var _a=Object.defineProperty;var Fa=(n,e,t)=>e in n?_a(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var d=(n,e,t)=>Fa(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(a){if(a.ep)return;a.ep=!0;const s=t(a);fetch(a.href,s)}})();const Ln=!1;var Jn=Array.isArray,Ha=Array.prototype.indexOf,ei=Array.from,Oi=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,Zi=Object.getOwnPropertyDescriptors,Sa=Object.prototype,Ka=Array.prototype,ti=Object.getPrototypeOf;function Pa(n){return typeof n=="function"}const Ye=()=>{};function qa(n){return typeof(n==null?void 0:n.then)=="function"}function Wa(n){return n()}function Rn(n){for(var e=0;e<n.length;e++)n[e]()}const Le=2,Ui=4,yn=8,vn=16,At=32,Jt=64,mn=128,We=256,un=512,_e=1024,lt=2048,Zt=4096,st=8192,Bn=16384,Ii=32768,En=65536,$i=1<<17,La=1<<19,ji=1<<20,ot=Symbol("$state"),Ra=Symbol("legacy props"),Oa=Symbol("");function Yi(n){return n===this.v}function zi(n,e){return n!=n?e==e:n!==e||n!==null&&typeof n=="object"||typeof n=="function"}function ni(n){return!zi(n,this.v)}function Za(n){throw new Error("https://svelte.dev/e/effect_in_teardown")}function Ua(){throw new Error("https://svelte.dev/e/effect_in_unowned_derived")}function Ia(n){throw new Error("https://svelte.dev/e/effect_orphan")}function $a(){throw new Error("https://svelte.dev/e/effect_update_depth_exceeded")}function ja(n){throw new Error("https://svelte.dev/e/props_invalid_value")}function Ya(){throw new Error("https://svelte.dev/e/state_descriptors_fixed")}function za(){throw new Error("https://svelte.dev/e/state_prototype_fixed")}function Ga(){throw new Error("https://svelte.dev/e/state_unsafe_local_read")}function Va(){throw new Error("https://svelte.dev/e/state_unsafe_mutation")}let en=!1,Qa=!1;function Xa(){en=!0}const ii=1,ai=2,Gi=4,Ja=8,er=16,tr=1,nr=2,ir=4,ar=8,rr=16,sr=1,or=2,Ar=4,lr=1,dr=2,Be=Symbol();let De=null;function hn(n){De=n}function Fe(n,e=!1,t){De={p:De,c:null,e:null,m:!1,s:n,x:null,l:null},en&&!e&&(De.l={s:null,u:null,r1:[],r2:Me(!1)})}function He(n){const e=De;if(e!==null){const o=e.e;if(o!==null){var t=de,i=ce;e.e=null;try{for(var a=0;a<o.length;a++){var s=o[a];Oe(s.effect),Re(s.reaction),$t(s.fn)}}finally{Oe(t),Re(i)}}De=e.p,e.m=!0}return{}}function Ut(){return!en||De!==null&&De.l===null}function Me(n,e){var t={f:0,v:n,reactions:null,equals:Yi,rv:0,wv:0};return t}function pr(n){return Vi(Me(n))}function Lt(n,e=!1){var i;const t=Me(n);return e||(t.equals=ni),en&&De!==null&&De.l!==null&&((i=De.l).s??(i.s=[])).push(t),t}function Ce(n,e=!1){return Vi(Lt(n,e))}function Vi(n){return ce!==null&&!Qe&&ce.f&Le&&(Xe===null?yr([n]):Xe.push(n)),n}function Ke(n,e){return ee(n,Je(()=>A(n))),e}function ee(n,e){return ce!==null&&!Qe&&Ut()&&ce.f&(Le|vn)&&(Xe===null||!Xe.includes(n))&&Va(),ut(n,e)}function ut(n,e){return n.equals(e)||(n.v,n.v=e,n.wv=ma(),Qi(n,lt),Ut()&&de!==null&&de.f&_e&&!(de.f&(At|Jt))&&(it===null?vr([n]):it.push(n))),e}function Qi(n,e){var t=n.reactions;if(t!==null)for(var i=Ut(),a=t.length,s=0;s<a;s++){var o=t[s],k=o.f;k&lt||!i&&o===de||(et(o,e),k&(_e|We)&&(k&Le?Qi(o,Zt):_n(o)))}}let Xi=!1;function ct(n,e=null,t){if(typeof n!="object"||n===null||ot in n)return n;const i=ti(n);if(i!==Sa&&i!==Ka)return n;var a=new Map,s=Jn(n),o=Me(0);s&&a.set("length",Me(n.length));var k;return new Proxy(n,{defineProperty(p,c,m){(!("value"in m)||m.configurable===!1||m.enumerable===!1||m.writable===!1)&&Ya();var f=a.get(c);return f===void 0?(f=Me(m.value),a.set(c,f)):ee(f,ct(m.value,k)),!0},deleteProperty(p,c){var m=a.get(c);if(m===void 0)c in p&&a.set(c,Me(Be));else{if(s&&typeof c=="string"){var f=a.get("length"),r=Number(c);Number.isInteger(r)&&r<f.v&&ee(f,r)}ee(m,Be),hi(o)}return!0},get(p,c,m){var u;if(c===ot)return n;var f=a.get(c),r=c in p;if(f===void 0&&(!r||(u=Pt(p,c))!=null&&u.writable)&&(f=Me(ct(r?p[c]:Be,k)),a.set(c,f)),f!==void 0){var l=A(f);return l===Be?void 0:l}return Reflect.get(p,c,m)},getOwnPropertyDescriptor(p,c){var m=Reflect.getOwnPropertyDescriptor(p,c);if(m&&"value"in m){var f=a.get(c);f&&(m.value=A(f))}else if(m===void 0){var r=a.get(c),l=r==null?void 0:r.v;if(r!==void 0&&l!==Be)return{enumerable:!0,configurable:!0,value:l,writable:!0}}return m},has(p,c){var l;if(c===ot)return!0;var m=a.get(c),f=m!==void 0&&m.v!==Be||Reflect.has(p,c);if(m!==void 0||de!==null&&(!f||(l=Pt(p,c))!=null&&l.writable)){m===void 0&&(m=Me(f?ct(p[c],k):Be),a.set(c,m));var r=A(m);if(r===Be)return!1}return f},set(p,c,m,f){var T;var r=a.get(c),l=c in p;if(s&&c==="length")for(var u=m;u<r.v;u+=1){var w=a.get(u+"");w!==void 0?ee(w,Be):u in p&&(w=Me(Be),a.set(u+"",w))}r===void 0?(!l||(T=Pt(p,c))!=null&&T.writable)&&(r=Me(void 0),ee(r,ct(m,k)),a.set(c,r)):(l=r.v!==Be,ee(r,ct(m,k)));var C=Reflect.getOwnPropertyDescriptor(p,c);if(C!=null&&C.set&&C.set.call(f,m),!l){if(s&&typeof c=="string"){var v=a.get("length"),y=Number(c);Number.isInteger(y)&&y>=v.v&&ee(v,y+1)}hi(o)}return!0},ownKeys(p){A(o);var c=Reflect.ownKeys(p).filter(r=>{var l=a.get(r);return l===void 0||l.v!==Be});for(var[m,f]of a)f.v!==Be&&!(m in p)&&c.push(m);return c},setPrototypeOf(){za()}})}function hi(n,e=1){ee(n,n.v+e)}function fi(n){return n!==null&&typeof n=="object"&&ot in n?n[ot]:n}function Ji(n,e){return Object.is(fi(n),fi(e))}var wi,ea,ta,na;function cr(){if(wi===void 0){wi=window,ea=/Firefox/.test(navigator.userAgent);var n=Element.prototype,e=Node.prototype;ta=Pt(e,"firstChild").get,na=Pt(e,"nextSibling").get,n.__click=void 0,n.__className="",n.__attributes=null,n.__styles=null,n.__e=void 0,Text.prototype.__t=void 0}}function Tn(n=""){return document.createTextNode(n)}function fn(n){return ta.call(n)}function xn(n){return na.call(n)}function h(n,e){return fn(n)}function te(n,e){{var t=fn(n);return t instanceof Comment&&t.data===""?xn(t):t}}function D(n,e=1,t=!1){let i=n;for(;e--;)i=xn(i);return i}function kr(n){n.textContent=""}function Bt(n){var e=Le|lt,t=ce!==null&&ce.f&Le?ce:null;return de===null||t!==null&&t.f&We?e|=We:de.f|=ji,{ctx:De,deps:null,effects:null,equals:Yi,f:e,fn:n,reactions:null,rv:0,v:null,wv:0,parent:t??de}}function ge(n){const e=Bt(n);return e.equals=ni,e}function ia(n){var e=n.effects;if(e!==null){n.effects=null;for(var t=0;t<e.length;t+=1)ht(e[t])}}function mr(n){for(var e=n.parent;e!==null;){if(!(e.f&Le))return e;e=e.parent}return null}function ur(n){var e,t=de;Oe(mr(n));try{ia(n),e=ha(n)}finally{Oe(t)}return e}function aa(n){var e=ur(n),t=(mt||n.f&We)&&n.deps!==null?Zt:_e;et(n,t),n.equals(e)||(n.v=e,n.wv=ma())}function ra(n){de===null&&ce===null&&Ia(),ce!==null&&ce.f&We&&de===null&&Ua(),oi&&Za()}function hr(n,e){var t=e.last;t===null?e.last=e.first=n:(t.next=n,n.prev=t,e.last=n)}function It(n,e,t,i=!0){var a=(n&Jt)!==0,s=de,o={ctx:De,deps:null,nodes_start:null,nodes_end:null,f:n|lt,first:null,fn:e,last:null,next:null,parent:a?null:s,prev:null,teardown:null,transitions:null,wv:0};if(t){var k=qt;try{Di(!0),Ai(o),o.f|=Ii}catch(m){throw ht(o),m}finally{Di(k)}}else e!==null&&_n(o);var p=t&&o.deps===null&&o.first===null&&o.nodes_start===null&&o.teardown===null&&(o.f&(ji|mn))===0;if(!p&&!a&&i&&(s!==null&&hr(o,s),ce!==null&&ce.f&Le)){var c=ce;(c.effects??(c.effects=[])).push(o)}return o}function ri(n){const e=It(yn,null,!1);return et(e,_e),e.teardown=n,e}function Ci(n){ra();var e=de!==null&&(de.f&At)!==0&&De!==null&&!De.m;if(e){var t=De;(t.e??(t.e=[])).push({fn:n,effect:de,reaction:ce})}else{var i=$t(n);return i}}function fr(n){return ra(),Mn(n)}function wr(n){const e=It(Jt,n,!0);return(t={})=>new Promise(i=>{t.outro?Ct(e,()=>{ht(e),i(void 0)}):(ht(e),i(void 0))})}function $t(n){return It(Ui,n,!1)}function Mn(n){return It(yn,n,!0)}function W(n,e=[],t=Bt){const i=e.map(t);return Nn(()=>n(...i.map(A)))}function Nn(n,e=0){return It(yn|vn|e,n,!0)}function Et(n,e=!0){return It(yn|At,n,!0,e)}function sa(n){var e=n.teardown;if(e!==null){const t=oi,i=ce;gi(!0),Re(null);try{e.call(null)}finally{gi(t),Re(i)}}}function oa(n,e=!1){var t=n.first;for(n.first=n.last=null;t!==null;){var i=t.next;ht(t,e),t=i}}function Cr(n){for(var e=n.first;e!==null;){var t=e.next;e.f&At||ht(e),e=t}}function ht(n,e=!0){var t=!1;if((e||n.f&La)&&n.nodes_start!==null){for(var i=n.nodes_start,a=n.nodes_end;i!==null;){var s=i===a?null:xn(i);i.remove(),i=s}t=!0}oa(n,e&&!t),Dn(n,0),et(n,Bn);var o=n.transitions;if(o!==null)for(const p of o)p.stop();sa(n);var k=n.parent;k!==null&&k.first!==null&&Aa(n),n.next=n.prev=n.teardown=n.ctx=n.deps=n.fn=n.nodes_start=n.nodes_end=null}function Aa(n){var e=n.parent,t=n.prev,i=n.next;t!==null&&(t.next=i),i!==null&&(i.prev=t),e!==null&&(e.first===n&&(e.first=i),e.last===n&&(e.last=t))}function Ct(n,e){var t=[];si(n,t,!0),la(t,()=>{ht(n),e&&e()})}function la(n,e){var t=n.length;if(t>0){var i=()=>--t||e();for(var a of n)a.out(i)}else e()}function si(n,e,t){if(!(n.f&st)){if(n.f^=st,n.transitions!==null)for(const o of n.transitions)(o.is_global||t)&&e.push(o);for(var i=n.first;i!==null;){var a=i.next,s=(i.f&En)!==0||(i.f&At)!==0;si(i,e,s?t:!1),i=a}}}function Rt(n){da(n,!0)}function da(n,e){if(n.f&st){n.f^=st,n.f&_e||(n.f^=_e),tn(n)&&(et(n,lt),_n(n));for(var t=n.first;t!==null;){var i=t.next,a=(t.f&En)!==0||(t.f&At)!==0;da(t,a?e:!1),t=i}if(n.transitions!==null)for(const s of n.transitions)(s.is_global||e)&&s.in()}}let wn=!1,On=[];function pa(){wn=!1;const n=On.slice();On=[],Rn(n)}function Tt(n){wn||(wn=!0,queueMicrotask(pa)),On.push(n)}function Dr(){wn&&pa()}const ca=0,gr=1;let dn=!1,pn=ca,Qt=!1,Xt=null,qt=!1,oi=!1;function Di(n){qt=n}function gi(n){oi=n}let wt=[],Wt=0;let ce=null,Qe=!1;function Re(n){ce=n}let de=null;function Oe(n){de=n}let Xe=null;function yr(n){Xe=n}let Ne=null,Se=0,it=null;function vr(n){it=n}let ka=1,Cn=0,mt=!1,kt=null;function ma(){return++ka}function tn(n){var f;var e=n.f;if(e&lt)return!0;if(e&Zt){var t=n.deps,i=(e&We)!==0;if(t!==null){var a,s,o=(e&un)!==0,k=i&&de!==null&&!mt,p=t.length;if(o||k){var c=n,m=c.parent;for(a=0;a<p;a++)s=t[a],(o||!((f=s==null?void 0:s.reactions)!=null&&f.includes(c)))&&(s.reactions??(s.reactions=[])).push(c);o&&(c.f^=un),k&&m!==null&&!(m.f&We)&&(c.f^=We)}for(a=0;a<p;a++)if(s=t[a],tn(s)&&aa(s),s.wv>n.wv)return!0}(!i||de!==null&&!mt)&&et(n,_e)}return!1}function Br(n,e){for(var t=e;t!==null;){if(t.f&mn)try{t.fn(n);return}catch{t.f^=mn}t=t.parent}throw dn=!1,n}function Er(n){return(n.f&Bn)===0&&(n.parent===null||(n.parent.f&mn)===0)}function bn(n,e,t,i){if(dn){if(t===null&&(dn=!1),Er(e))throw n;return}t!==null&&(dn=!0);{Br(n,e);return}}function ua(n,e,t=!0){var i=n.reactions;if(i!==null)for(var a=0;a<i.length;a++){var s=i[a];s.f&Le?ua(s,e,!1):e===s&&(t?et(s,lt):s.f&_e&&et(s,Zt),_n(s))}}function ha(n){var l;var e=Ne,t=Se,i=it,a=ce,s=mt,o=Xe,k=De,p=Qe,c=n.f;Ne=null,Se=0,it=null,ce=c&(At|Jt)?null:n,mt=(c&We)!==0&&(!qt||a===null||p),Xe=null,hn(n.ctx),Qe=!1,Cn++;try{var m=(0,n.fn)(),f=n.deps;if(Ne!==null){var r;if(Dn(n,Se),f!==null&&Se>0)for(f.length=Se+Ne.length,r=0;r<Ne.length;r++)f[Se+r]=Ne[r];else n.deps=f=Ne;if(!mt)for(r=Se;r<f.length;r++)((l=f[r]).reactions??(l.reactions=[])).push(n)}else f!==null&&Se<f.length&&(Dn(n,Se),f.length=Se);if(Ut()&&it!==null&&!Qe&&f!==null&&!(n.f&(Le|Zt|lt)))for(r=0;r<it.length;r++)ua(it[r],n);return a!==null&&Cn++,m}finally{Ne=e,Se=t,it=i,ce=a,mt=s,Xe=o,hn(k),Qe=p}}function Tr(n,e){let t=e.reactions;if(t!==null){var i=Ha.call(t,n);if(i!==-1){var a=t.length-1;a===0?t=e.reactions=null:(t[i]=t[a],t.pop())}}t===null&&e.f&Le&&(Ne===null||!Ne.includes(e))&&(et(e,Zt),e.f&(We|un)||(e.f^=un),ia(e),Dn(e,0))}function Dn(n,e){var t=n.deps;if(t!==null)for(var i=e;i<t.length;i++)Tr(n,t[i])}function Ai(n){var e=n.f;if(!(e&Bn)){et(n,_e);var t=de,i=De;de=n;try{e&vn?Cr(n):oa(n),sa(n);var a=ha(n);n.teardown=typeof a=="function"?a:null,n.wv=ka;var s=n.deps,o;Ln&&Qa&&n.f&lt}catch(k){bn(k,n,t,i||n.ctx)}finally{de=t}}}function fa(){if(Wt>1e3){Wt=0;try{$a()}catch(n){if(Xt!==null)bn(n,Xt,null);else throw n}}Wt++}function wa(n){var e=n.length;if(e!==0){fa();var t=qt;qt=!0;try{for(var i=0;i<e;i++){var a=n[i];a.f&_e||(a.f^=_e);var s=Nr(a);xr(s)}}finally{qt=t}}}function xr(n){var e=n.length;if(e!==0)for(var t=0;t<e;t++){var i=n[t];if(!(i.f&(Bn|st)))try{tn(i)&&(Ai(i),i.deps===null&&i.first===null&&i.nodes_start===null&&(i.teardown===null?Aa(i):i.fn=null))}catch(a){bn(a,i,null,i.ctx)}}}function Mr(){if(Qt=!1,Wt>1001)return;const n=wt;wt=[],wa(n),Qt||(Wt=0,Xt=null)}function _n(n){pn===ca&&(Qt||(Qt=!0,queueMicrotask(Mr))),Xt=n;for(var e=n;e.parent!==null;){e=e.parent;var t=e.f;if(t&(Jt|At)){if(!(t&_e))return;e.f^=_e}}wt.push(e)}function Nr(n){var e=[],t=n.first;e:for(;t!==null;){var i=t.f,a=(i&At)!==0,s=a&&(i&_e)!==0,o=t.next;if(!s&&!(i&st)){if(i&Ui)e.push(t);else if(a)t.f^=_e;else{var k=ce;try{ce=t,tn(t)&&Ai(t)}catch(m){bn(m,t,null,t.ctx)}finally{ce=k}}var p=t.first;if(p!==null){t=p;continue}}if(o===null){let m=t.parent;for(;m!==null;){if(n===m)break e;var c=m.next;if(c!==null){t=c;continue e}m=m.parent}}t=o}return e}function li(n){var e=pn,t=wt;try{fa();const a=[];pn=gr,wt=a,Qt=!1,wa(t);var i=n==null?void 0:n();return Dr(),(wt.length>0||a.length>0)&&li(),Wt=0,Xt=null,i}finally{pn=e,wt=t}}async function br(){await Promise.resolve(),li()}function A(n){var e=n.f,t=(e&Le)!==0;if(kt!==null&&kt.add(n),ce!==null&&!Qe){Xe!==null&&Xe.includes(n)&&Ga();var i=ce.deps;n.rv<Cn&&(n.rv=Cn,Ne===null&&i!==null&&i[Se]===n?Se++:Ne===null?Ne=[n]:(!mt||!Ne.includes(n))&&Ne.push(n))}else if(t&&n.deps===null&&n.effects===null){var a=n,s=a.parent;s!==null&&!(s.f&We)&&(a.f^=We)}return t&&(a=n,tn(a)&&aa(a)),n.v}function _r(n){var e=kt;kt=new Set;var t=kt,i;try{if(Je(n),e!==null)for(i of kt)e.add(i)}finally{kt=e}return t}function Ca(n){var e=_r(()=>Je(n));for(var t of e)if(t.f&$i)for(const i of t.deps||[])i.f&Le||ut(i,i.v);else ut(t,t.v)}function Je(n){var e=Qe;try{return Qe=!0,n()}finally{Qe=e}}const Fr=-7169;function et(n,e){n.f=n.f&Fr|e}function Hr(n){if(!(typeof n!="object"||!n||n instanceof EventTarget)){if(ot in n)Zn(n);else if(!Array.isArray(n))for(let e in n){const t=n[e];typeof t=="object"&&t&&ot in t&&Zn(t)}}}function Zn(n,e=new Set){if(typeof n=="object"&&n!==null&&!(n instanceof EventTarget)&&!e.has(n)){e.add(n),n instanceof Date&&n.getTime();for(let i in n)try{Zn(n[i],e)}catch{}const t=ti(n);if(t!==Object.prototype&&t!==Array.prototype&&t!==Map.prototype&&t!==Set.prototype&&t!==Date.prototype){const i=Zi(t);for(let a in i){const s=i[a].get;if(s)try{s.call(n)}catch{}}}}}const Sr=["touchstart","touchmove"];function Kr(n){return Sr.includes(n)}let yi=!1;function Pr(){yi||(yi=!0,document.addEventListener("reset",n=>{Promise.resolve().then(()=>{var e;if(!n.defaultPrevented)for(const t of n.target.elements)(e=t.__on_r)==null||e.call(t)})},{capture:!0}))}function di(n){var e=ce,t=de;Re(null),Oe(null);try{return n()}finally{Re(e),Oe(t)}}function pi(n,e,t,i=t){n.addEventListener(e,()=>di(t));const a=n.__on_r;a?n.__on_r=()=>{a(),i(!0)}:n.__on_r=()=>i(!0),Pr()}const Da=new Set,Un=new Set;function qr(n,e,t,i={}){function a(s){if(i.capture||zt.call(e,s),!s.cancelBubble)return di(()=>t==null?void 0:t.call(this,s))}return n.startsWith("pointer")||n.startsWith("touch")||n==="wheel"?Tt(()=>{e.addEventListener(n,a,i)}):e.addEventListener(n,a,i),a}function ye(n,e,t,i,a){var s={capture:i,passive:a},o=qr(n,e,t,s);(e===document.body||e===window||e===document)&&ri(()=>{e.removeEventListener(n,o,s)})}function ci(n){for(var e=0;e<n.length;e++)Da.add(n[e]);for(var t of Un)t(n)}function zt(n){var y;var e=this,t=e.ownerDocument,i=n.type,a=((y=n.composedPath)==null?void 0:y.call(n))||[],s=a[0]||n.target,o=0,k=n.__root;if(k){var p=a.indexOf(k);if(p!==-1&&(e===document||e===window)){n.__root=e;return}var c=a.indexOf(e);if(c===-1)return;p<=c&&(o=p)}if(s=a[o]||n.target,s!==e){Oi(n,"currentTarget",{configurable:!0,get(){return s||t}});var m=ce,f=de;Re(null),Oe(null);try{for(var r,l=[];s!==null;){var u=s.assignedSlot||s.parentNode||s.host||null;try{var w=s["__"+i];if(w!==void 0&&!s.disabled)if(Jn(w)){var[C,...v]=w;C.apply(s,[n,...v])}else w.call(s,n)}catch(T){r?l.push(T):r=T}if(n.cancelBubble||u===e||u===null)break;s=u}if(r){for(let T of l)queueMicrotask(()=>{throw T});throw r}}finally{n.__root=e,delete n.currentTarget,Re(m),Oe(f)}}}function Wr(n){var e=document.createElement("template");return e.innerHTML=n,e.content}function gn(n,e){var t=de;t.nodes_start===null&&(t.nodes_start=n,t.nodes_end=e)}function b(n,e){var t=(e&lr)!==0,i=(e&dr)!==0,a,s=!n.startsWith("<!>");return()=>{a===void 0&&(a=Wr(s?n:"<!>"+n),t||(a=fn(a)));var o=i||ea?document.importNode(a,!0):a.cloneNode(!0);if(t){var k=fn(o),p=o.lastChild;gn(k,p)}else gn(o,o);return o}}function _t(n=""){{var e=Tn(n+"");return gn(e,e),e}}function he(){var n=document.createDocumentFragment(),e=document.createComment(""),t=Tn();return n.append(e,t),gn(e,t),n}function g(n,e){n!==null&&n.before(e)}let In=!0;function F(n,e){var t=e==null?"":typeof e=="object"?e+"":e;t!==(n.__t??(n.__t=n.nodeValue))&&(n.__t=t,n.nodeValue=t+"")}function Lr(n,e){return Rr(n,e)}const Ft=new Map;function Rr(n,{target:e,anchor:t,props:i={},events:a,context:s,intro:o=!0}){cr();var k=new Set,p=f=>{for(var r=0;r<f.length;r++){var l=f[r];if(!k.has(l)){k.add(l);var u=Kr(l);e.addEventListener(l,zt,{passive:u});var w=Ft.get(l);w===void 0?(document.addEventListener(l,zt,{passive:u}),Ft.set(l,1)):Ft.set(l,w+1)}}};p(ei(Da)),Un.add(p);var c=void 0,m=wr(()=>{var f=t??e.appendChild(Tn());return Et(()=>{if(s){Fe({});var r=De;r.c=s}a&&(i.$$events=a),In=o,c=n(f,i)||{},In=!0,s&&He()}),()=>{var u;for(var r of k){e.removeEventListener(r,zt);var l=Ft.get(r);--l===0?(document.removeEventListener(r,zt),Ft.delete(r)):Ft.set(r,l)}Un.delete(p),f!==t&&((u=f.parentNode)==null||u.removeChild(f))}});return Or.set(c,m),c}let Or=new WeakMap;const Sn=0,on=1,Kn=2;function $n(n,e,t,i,a){var s=n,o=Ut(),k=De,p=Be,c,m,f,r=(o?Me:Lt)(void 0),l=(o?Me:Lt)(void 0),u=!1;function w(v,y){u=!0,y&&(Oe(C),Re(C),hn(k));try{v===Sn&&t&&(c?Rt(c):c=Et(()=>t(s))),v===on&&i&&(m?Rt(m):m=Et(()=>i(s,r))),v!==Sn&&c&&Ct(c,()=>c=null),v!==on&&m&&Ct(m,()=>m=null),v!==Kn&&f&&Ct(f,()=>f=null)}finally{y&&(hn(null),Re(null),Oe(null),li())}}var C=Nn(()=>{if(p!==(p=e())){if(qa(p)){var v=p;u=!1,v.then(y=>{v===p&&(ut(r,y),w(on,!0))},y=>{if(v===p)throw ut(l,y),w(Kn,!0),l.v}),Tt(()=>{u||w(Sn,!0)})}else ut(r,p),w(on,!1);return()=>p=Be}})}function L(n,e,t=!1){var i=n,a=null,s=null,o=Be,k=t?En:0,p=!1;const c=(f,r=!0)=>{p=!0,m(r,f)},m=(f,r)=>{o!==(o=f)&&(o?(a?Rt(a):r&&(a=Et(()=>r(i))),s&&Ct(s,()=>{s=null})):(s?Rt(s):r&&(s=Et(()=>r(i))),a&&Ct(a,()=>{a=null})))};Nn(()=>{p=!1,e(c),p||m(null,null)},k)}function ke(n,e){return e}function Zr(n,e,t,i){for(var a=[],s=e.length,o=0;o<s;o++)si(e[o].e,a,!0);var k=s>0&&a.length===0&&t!==null;if(k){var p=t.parentNode;kr(p),p.append(t),i.clear(),pt(n,e[0].prev,e[s-1].next)}la(a,()=>{for(var c=0;c<s;c++){var m=e[c];k||(i.delete(m.k),pt(n,m.prev,m.next)),ht(m.e,!k)}})}function me(n,e,t,i,a,s=null){var o=n,k={flags:e,items:new Map,first:null},p=(e&Gi)!==0;if(p){var c=n;o=c.appendChild(Tn())}var m=null,f=!1,r=ge(()=>{var l=t();return Jn(l)?l:l==null?[]:ei(l)});Nn(()=>{var l=A(r),u=l.length;f&&u===0||(f=u===0,Ur(l,k,o,a,e,i,t),s!==null&&(u===0?m?Rt(m):m=Et(()=>s(o)):m!==null&&Ct(m,()=>{m=null})),A(r))})}function Ur(n,e,t,i,a,s,o){var X,x,I,ne;var k=(a&Ja)!==0,p=(a&(ii|ai))!==0,c=n.length,m=e.items,f=e.first,r=f,l,u=null,w,C=[],v=[],y,T,_,q;if(k)for(q=0;q<c;q+=1)y=n[q],T=s(y,q),_=m.get(T),_!==void 0&&((X=_.a)==null||X.measure(),(w??(w=new Set)).add(_));for(q=0;q<c;q+=1){if(y=n[q],T=s(y,q),_=m.get(T),_===void 0){var z=r?r.e.nodes_start:t;u=$r(z,e,u,u===null?e.first:u.next,y,T,q,i,a,o),m.set(T,u),C=[],v=[],r=u.next;continue}if(p&&Ir(_,y,q,a),_.e.f&st&&(Rt(_.e),k&&((x=_.a)==null||x.unfix(),(w??(w=new Set)).delete(_))),_!==r){if(l!==void 0&&l.has(_)){if(C.length<v.length){var ie=v[0],B;u=ie.prev;var O=C[0],re=C[C.length-1];for(B=0;B<C.length;B+=1)vi(C[B],ie,t);for(B=0;B<v.length;B+=1)l.delete(v[B]);pt(e,O.prev,re.next),pt(e,u,O),pt(e,re,ie),r=ie,u=re,q-=1,C=[],v=[]}else l.delete(_),vi(_,r,t),pt(e,_.prev,_.next),pt(e,_,u===null?e.first:u.next),pt(e,u,_),u=_;continue}for(C=[],v=[];r!==null&&r.k!==T;)r.e.f&st||(l??(l=new Set)).add(r),v.push(r),r=r.next;if(r===null)continue;_=r}C.push(_),u=_,r=_.next}if(r!==null||l!==void 0){for(var Ae=l===void 0?[]:ei(l);r!==null;)r.e.f&st||Ae.push(r),r=r.next;var pe=Ae.length;if(pe>0){var ue=a&Gi&&c===0?t:null;if(k){for(q=0;q<pe;q+=1)(I=Ae[q].a)==null||I.measure();for(q=0;q<pe;q+=1)(ne=Ae[q].a)==null||ne.fix()}Zr(e,Ae,ue,m)}}k&&Tt(()=>{var Z;if(w!==void 0)for(_ of w)(Z=_.a)==null||Z.apply()}),de.first=e.first&&e.first.e,de.last=u&&u.e}function Ir(n,e,t,i){i&ii&&ut(n.v,e),i&ai?ut(n.i,t):n.i=t}function $r(n,e,t,i,a,s,o,k,p,c){var m=(p&ii)!==0,f=(p&er)===0,r=m?f?Lt(a):Me(a):a,l=p&ai?Me(o):o,u={i:l,v:r,k:s,a:null,e:null,prev:t,next:i};try{return u.e=Et(()=>k(n,r,l,c),Xi),u.e.prev=t&&t.e,u.e.next=i&&i.e,t===null?e.first=u:(t.next=u,t.e.next=u.e),i!==null&&(i.prev=u,i.e.prev=u.e),u}finally{}}function vi(n,e,t){for(var i=n.next?n.next.e.nodes_start:t,a=e?e.e.nodes_start:t,s=n.e.nodes_start;s!==i;){var o=xn(s);a.before(s),s=o}}function pt(n,e,t){e===null?n.first=t:(e.next=t,e.e.next=t&&t.e),t!==null&&(t.prev=e,t.e.prev=e&&e.e)}function Dt(n,e,t,i){var a=n.__attributes??(n.__attributes={});a[e]!==(a[e]=t)&&(e==="style"&&"__styles"in n&&(n.__styles={}),e==="loading"&&(n[Oa]=t),t==null?n.removeAttribute(e):typeof t!="string"&&jr(n).includes(e)?n[e]=t:n.setAttribute(e,t))}var Bi=new Map;function jr(n){var e=Bi.get(n.nodeName);if(e)return e;Bi.set(n.nodeName,e=[]);for(var t,i=n,a=Element.prototype;a!==i;){t=Zi(i);for(var s in t)t[s].set&&e.push(s);i=ti(i)}return e}function we(n,e,t){var i=n.__className,a=Yr(e);(i!==a||Xi)&&(e==null?n.removeAttribute("class"):n.className=a,n.__className=a)}function Yr(n,e){return(n??"")+""}const zr=()=>performance.now(),rt={tick:n=>requestAnimationFrame(n),now:()=>zr(),tasks:new Set};function ga(){const n=rt.now();rt.tasks.forEach(e=>{e.c(n)||(rt.tasks.delete(e),e.f())}),rt.tasks.size!==0&&rt.tick(ga)}function Gr(n){let e;return rt.tasks.size===0&&rt.tick(ga),{promise:new Promise(t=>{rt.tasks.add(e={c:n,f:t})}),abort(){rt.tasks.delete(e)}}}function An(n,e){di(()=>{n.dispatchEvent(new CustomEvent(e))})}function Vr(n){if(n==="float")return"cssFloat";if(n==="offset")return"cssOffset";if(n.startsWith("--"))return n;const e=n.split("-");return e.length===1?e[0]:e[0]+e.slice(1).map(t=>t[0].toUpperCase()+t.slice(1)).join("")}function Ei(n){const e={},t=n.split(";");for(const i of t){const[a,s]=i.split(":");if(!a||s===void 0)break;const o=Vr(a.trim());e[o]=s.trim()}return e}const Qr=n=>n;function Ht(n,e,t,i){var a=(n&sr)!==0,s=(n&or)!==0,o=a&&s,k=(n&Ar)!==0,p=o?"both":a?"in":"out",c,m=e.inert,f=e.style.overflow,r,l;function u(){var T=ce,_=de;Re(null),Oe(null);try{return c??(c=t()(e,(i==null?void 0:i())??{},{direction:p}))}finally{Re(T),Oe(_)}}var w={is_global:k,in(){var T;if(e.inert=m,!a){l==null||l.abort(),(T=l==null?void 0:l.reset)==null||T.call(l);return}s||r==null||r.abort(),An(e,"introstart"),r=jn(e,u(),l,1,()=>{An(e,"introend"),r==null||r.abort(),r=c=void 0,e.style.overflow=f})},out(T){if(!s){T==null||T(),c=void 0;return}e.inert=!0,An(e,"outrostart"),l=jn(e,u(),r,0,()=>{An(e,"outroend"),T==null||T()})},stop:()=>{r==null||r.abort(),l==null||l.abort()}},C=de;if((C.transitions??(C.transitions=[])).push(w),a&&In){var v=k;if(!v){for(var y=C.parent;y&&y.f&En;)for(;(y=y.parent)&&!(y.f&vn););v=!y||(y.f&Ii)!==0}v&&$t(()=>{Je(()=>w.in())})}}function jn(n,e,t,i,a){var s=i===1;if(Pa(e)){var o,k=!1;return Tt(()=>{if(!k){var C=e({direction:s?"in":"out"});o=jn(n,C,t,i,a)}}),{abort:()=>{k=!0,o==null||o.abort()},deactivate:()=>o.deactivate(),reset:()=>o.reset(),t:()=>o.t()}}if(t==null||t.deactivate(),!(e!=null&&e.duration))return a(),{abort:Ye,deactivate:Ye,reset:Ye,t:()=>i};const{delay:p=0,css:c,tick:m,easing:f=Qr}=e;var r=[];if(s&&t===void 0&&(m&&m(0,1),c)){var l=Ei(c(0,1));r.push(l,l)}var u=()=>1-i,w=n.animate(r,{duration:p});return w.onfinish=()=>{var C=(t==null?void 0:t.t())??1-i;t==null||t.abort();var v=i-C,y=e.duration*Math.abs(v),T=[];if(y>0){var _=!1;if(c)for(var q=Math.ceil(y/16.666666666666668),z=0;z<=q;z+=1){var ie=C+v*f(z/q),B=Ei(c(ie,1-ie));T.push(B),_||(_=B.overflow==="hidden")}_&&(n.style.overflow="hidden"),u=()=>{var O=w.currentTime;return C+v*f(O/y)},m&&Gr(()=>{if(w.playState!=="running")return!1;var O=u();return m(O,1-O),!0})}w=n.animate(T,{duration:y,fill:"forwards"}),w.onfinish=()=>{u=()=>i,m==null||m(i,1-i),a()}},{abort:()=>{w&&(w.cancel(),w.effect=null,w.onfinish=Ye)},deactivate:()=>{a=Ye},reset:()=>{i===0&&(m==null||m(1,0))},t:()=>u()}}function Yn(n,e,t=e){var i=Ut();pi(n,"input",a=>{var s=a?n.defaultValue:n.value;if(s=qn(n)?Wn(s):s,t(s),i&&s!==(s=e())){var o=n.selectionStart,k=n.selectionEnd;n.value=s??"",k!==null&&(n.selectionStart=o,n.selectionEnd=Math.min(k,n.value.length))}}),Je(e)==null&&n.value&&t(qn(n)?Wn(n.value):n.value),Mn(()=>{var a=e();qn(n)&&a===Wn(n.value)||n.type==="date"&&!a&&!n.value||a!==n.value&&(n.value=a??"")})}const Pn=new Set;function St(n,e,t,i,a=i){var s=t.getAttribute("type")==="checkbox",o=n;if(e!==null)for(var k of e)o=o[k]??(o[k]=[]);o.push(t),pi(t,"change",()=>{var p=t.__value;s&&(p=Xr(o,p,t.checked)),a(p)},()=>a(s?[]:null)),Mn(()=>{var p=i();s?(p=p||[],t.checked=p.includes(t.__value)):t.checked=Ji(t.__value,p)}),ri(()=>{var p=o.indexOf(t);p!==-1&&o.splice(p,1)}),Pn.has(o)||(Pn.add(o),Tt(()=>{o.sort((p,c)=>p.compareDocumentPosition(c)===4?-1:1),Pn.delete(o)})),Tt(()=>{})}function Xr(n,e,t){for(var i=new Set,a=0;a<n.length;a+=1)n[a].checked&&i.add(n[a].__value);return t||i.delete(e),Array.from(i)}function qn(n){var e=n.type;return e==="number"||e==="range"}function Wn(n){return n===""?null:+n}function ya(n,e,t){if(n.multiple)return es(n,e);for(var i of n.options){var a=Vt(i);if(Ji(a,e)){i.selected=!0;return}}(!t||e!==void 0)&&(n.selectedIndex=-1)}function Jr(n,e){$t(()=>{var t=new MutationObserver(()=>{var i=n.__value;ya(n,i)});return t.observe(n,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value"]}),()=>{t.disconnect()}})}function va(n,e,t=e){var i=!0;pi(n,"change",a=>{var s=a?"[selected]":":checked",o;if(n.multiple)o=[].map.call(n.querySelectorAll(s),Vt);else{var k=n.querySelector(s)??n.querySelector("option:not([disabled])");o=k&&Vt(k)}t(o)}),$t(()=>{var a=e();if(ya(n,a,i),i&&a===void 0){var s=n.querySelector(":checked");s!==null&&(a=Vt(s),t(a))}n.__value=a,i=!1}),Jr(n)}function es(n,e){for(var t of n.options)t.selected=~e.indexOf(Vt(t))}function Vt(n){return"__value"in n?n.__value:n.value}function Ti(n,e){return n===e||(n==null?void 0:n[ot])===e}function ts(n={},e,t,i){return $t(()=>{var a,s;return Mn(()=>{a=s,s=[],Je(()=>{n!==t(...s)&&(e(n,...s),a&&Ti(t(...a),n)&&e(null,...a))})}),()=>{Tt(()=>{s&&Ti(t(...s),n)&&e(null,...s)})}}),n}function Ze(n=!1){const e=De,t=e.l.u;if(!t)return;let i=()=>Hr(e.s);if(n){let a=0,s={};const o=Bt(()=>{let k=!1;const p=e.s;for(const c in p)p[c]!==s[c]&&(s[c]=p[c],k=!0);return k&&a++,a});i=()=>A(o)}t.b.length&&fr(()=>{xi(e,i),Rn(t.b)}),Ci(()=>{const a=Je(()=>t.m.map(Wa));return()=>{for(const s of a)typeof s=="function"&&s()}}),t.a.length&&Ci(()=>{xi(e,i),Rn(t.a)})}function xi(n,e){if(n.l.s)for(const t of n.l.s)A(t);e()}function Ba(n,e,t){if(n==null)return e(void 0),Ye;const i=Je(()=>n.subscribe(e,t));return i.unsubscribe?()=>i.unsubscribe():i}const Kt=[];function ns(n,e=Ye){let t=null;const i=new Set;function a(k){if(zi(n,k)&&(n=k,t)){const p=!Kt.length;for(const c of i)c[1](),Kt.push(c,n);if(p){for(let c=0;c<Kt.length;c+=2)Kt[c][0](Kt[c+1]);Kt.length=0}}}function s(k){a(k(n))}function o(k,p=Ye){const c=[k,p];return i.add(c),i.size===1&&(t=e(a,s)||Ye),k(n),()=>{i.delete(c),i.size===0&&t&&(t(),t=null)}}return{set:a,update:s,subscribe:o}}function is(n){let e;return Ba(n,t=>e=t)(),e}let ln=!1,zn=Symbol();function as(n,e,t){const i=t[e]??(t[e]={store:null,source:Lt(void 0),unsubscribe:Ye});if(i.store!==n&&!(zn in t))if(i.unsubscribe(),i.store=n??null,n==null)i.source.v=void 0,i.unsubscribe=Ye;else{var a=!0;i.unsubscribe=Ba(n,s=>{a?i.source.v=s:ee(i.source,s)}),a=!1}return n&&zn in t?is(n):A(i.source)}function rs(){const n={};function e(){ri(()=>{for(var t in n)n[t].unsubscribe();Oi(n,zn,{enumerable:!1,value:!0})})}return[n,e]}function ss(n){var e=ln;try{return ln=!1,[n(),ln]}finally{ln=e}}function fe(n,e,t,i){var ie;var a=(t&tr)!==0,s=!en||(t&nr)!==0,o=(t&ar)!==0,k=(t&rr)!==0,p=!1,c;o?[c,p]=ss(()=>n[e]):c=n[e];var m=ot in n||Ra in n,f=o&&(((ie=Pt(n,e))==null?void 0:ie.set)??(m&&e in n&&(B=>n[e]=B)))||void 0,r=i,l=!0,u=!1,w=()=>(u=!0,l&&(l=!1,k?r=Je(i):r=i),r);c===void 0&&i!==void 0&&(f&&s&&ja(),c=w(),f&&f(c));var C;if(s)C=()=>{var B=n[e];return B===void 0?w():(l=!0,u=!1,B)};else{var v=(a?Bt:ge)(()=>n[e]);v.f|=$i,C=()=>{var B=A(v);return B!==void 0&&(r=void 0),B===void 0?r:B}}if(!(t&ir))return C;if(f){var y=n.$$legacy;return function(B,O){return arguments.length>0?((!s||!O||y||p)&&f(O?C():B),B):C()}}var T=!1,_=!1,q=Lt(c),z=Bt(()=>{var B=C(),O=A(q);return T?(T=!1,_=!0,O):(_=!1,q.v=B)});return a||(z.equals=ni),function(B,O){if(kt!==null&&(T=_,C(),A(q)),arguments.length>0){const re=O?A(z):s&&o?ct(B):B;return z.equals(re)||(T=!0,ee(q,re),u&&r!==void 0&&(r=re),Je(()=>A(z))),B}return A(z)}}const os="5";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(os);Xa();class As{constructor(e,t,i){d(this,"_dbname");d(this,"_dbversion");d(this,"dbPromise");d(this,"getTran",async(e,t)=>(await this.dbPromise).transaction(e,t));d(this,"reset",async()=>(await indexedDB.databases().then(e=>{console.log(e)}),await new Promise((e,t)=>{const i=indexedDB.deleteDatabase(this._dbname);i.onsuccess=()=>{console.log("onsuccess"),e()},i.onerror=a=>{console.log("onerror"),t(a)}})));d(this,"getAll",async e=>{const t=await this.dbPromise;return new Promise((i,a)=>{const k=t.transaction([e],"readonly").objectStore(e).getAll();k.onsuccess=()=>{i(k.result)},k.onerror=p=>{a(p)}})});d(this,"get",async(e,t)=>{const i=await this.dbPromise;return new Promise((a,s)=>{const p=i.transaction([e],"readonly").objectStore(e).get(t);p.onsuccess=()=>{a(p.result)},p.onerror=c=>{s(c)}})});d(this,"getMany",async(e,t)=>{const s=(await this.dbPromise).transaction([e],"readonly").objectStore(e),o=t.map(k=>new Promise((p,c)=>{const m=s.get(k);m.onsuccess=()=>{p(m.result)},m.onerror=f=>{c(f)}}));return await Promise.all(o)});d(this,"putRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),s=a.objectStore(e),o=t.map(k=>({record:k,request:s.put(k)}));return new Promise((k,p)=>{a.oncomplete=()=>k(o.map(c=>Object.assign({id:c.request.result},c.record))),a.onerror=c=>p(c)})});d(this,"deleteRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),s=a.objectStore(e),o=t.map(k=>({key:k,request:s.delete(k)}));return new Promise((k,p)=>{a.oncomplete=()=>{console.log(o.map(c=>c.request.result)),k()},a.onerror=c=>p(c)})});this._dbname=e,this._dbversion=t,this.dbPromise=new Promise((a,s)=>{const o=indexedDB.open(e,t);o.onsuccess=k=>{if(console.log(k),!k.target){console.log("event.target is undefined"),s("event.target is undefined");return}const p=k.target.result;if(!p){console.log("event.target.result is undefined"),s("event.target.result is undefined");return}p.onversionchange=c=>{console.log(c),p.close()},a(p)},o.onupgradeneeded=k=>{console.log("onupgradeneeded");const p=k.target.result;i.filter(c=>!p.objectStoreNames.contains(c)).map(c=>p.createObjectStore(c,{keyPath:"id",autoIncrement:!0}))},o.onerror=k=>{console.log(k),s(k)},o.onblocked=k=>{console.log(k),s(k)}}),console.log(this.dbPromise)}get dbversion(){return this._dbversion}}class Pe{constructor(){d(this,"handlers",[])}append(e){this.handlers.push(e)}remove(e){this.handlers=this.handlers.filter(t=>t!==e)}trigger(e){this.handlers.slice(0).forEach(t=>t(e))}clear(){this.handlers.splice(0)}expose(){return this}}class Mi{constructor(){d(this,"handler")}set(e){this.handler=e}async call(e){if(!this.handler)throw Error("illegal state error");return await this.handler(e)}expose(){return this}}class ki{constructor(e,t,i,a){d(this,"_name");d(this,"_createVersion");d(this,"mountResolver",()=>{});d(this,"_indexedDb");d(this,"onInsertEvent",new Pe);d(this,"onBeforeInsertEvent",new Mi);d(this,"onUpdateEvent",new Pe);d(this,"onBeforeUpdateEvent",new Mi);d(this,"onDeleteEvent",new Pe);d(this,"prepareInitialRecords",()=>{const e=new Date;return this._prepareInitialRecords().map(t=>Object.assign(t,{createdAt:e,updatedAt:e,dbVersion:this._createVersion}))});d(this,"resolveMount",()=>this.mountResolver());d(this,"patchForInsert",(e,t)=>{e.newRecords.forEach(i=>{console.log(i),t[i.id]=i})});d(this,"patchForUpdate",(e,t)=>{e.recordPairs.forEach(i=>{console.log(t[i.newRecord.id],i.newRecord),t[i.newRecord.id]={...i.newRecord}})});d(this,"patchForDelete",(e,t)=>{e.oldRecords.forEach(i=>{console.log(i),delete t[i.id]})});this._indexedDb=e,this._name=t,this._createVersion=e.dbversion,this.getAll().then(s=>s.reduce((o,k)=>(o[k.id]=k,o),{})).then(s=>{console.log(this.name,s),this.onBeforeInsertEvent.set(i??(()=>Promise.resolve())),this.onBeforeUpdateEvent.set(a??(()=>Promise.resolve()))})}get name(){return this._name}get createVersion(){return this._createVersion}get oninsert(){return this.onInsertEvent.expose()}get onbeforeinsert(){return this.onBeforeInsertEvent.expose()}get onupdate(){return this.onUpdateEvent.expose()}get onbeforeupdate(){return this.onBeforeUpdateEvent.expose()}get ondelete(){return this.onDeleteEvent.expose()}getAll(){return this._indexedDb.getAll(this.name)}get(e){return this._indexedDb.get(this.name,e)}async insertMany(e){const t=new Date,i=e.map(s=>{const o={createdAt:t,updatedAt:t,dbVersion:this._createVersion};return Object.assign(s,o)});await this.onBeforeInsertEvent.call({sender:this,newRecords:i,timestamp:t});const a=await this._indexedDb.putRecords(this.name,i);return this.onInsertEvent.trigger({sender:this,newRecords:a,timestamp:t}),a}async insert(e){return(await this.insertMany([e]))[0]}async updateMany(e,t){const i=new Date,a=[];return(await this._indexedDb.getMany(this.name,e)).forEach(o=>{const k={...o},p={...k};a.push({newRecord:Object.assign(t(p),{updatedAt:i,dbVersion:this._createVersion}),oldRecord:k})}),await this.onBeforeUpdateEvent.call({sender:this,recordPairs:a,timestamp:i}),await this._indexedDb.putRecords(this.name,a.map(o=>o.newRecord)),this.onUpdateEvent.trigger({sender:this,recordPairs:a,timestamp:i}),a.map(o=>o.newRecord)}async update(e,t){return(await this.updateMany([e],t))[0]}async delete(e){const t=new Date,i=await this._indexedDb.getMany(this.name,e);await this._indexedDb.deleteRecords(this.name,e),this.onDeleteEvent.trigger({sender:this,oldRecords:i,timestamp:t})}}const ls={"１３人目の埋葬者":{name:"１３人目の埋葬者",nameKana:"",description:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",pendulumDescription:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",kind:"Monster",monsterCategories:["Normal"],level:3,attack:1200,defense:900,attribute:"Dark",type:"Zombie",wikiName:"《１３人目の埋葬者》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%A3%B1%A3%B3%BF%CD%CC%DC%A4%CE%CB%E4%C1%F2%BC%D4%A1%D5",wikiTextAll:`通常モンスター
...
粘土でできた頑丈な体を持つＥ・ＨＥＲＯ。
体をはって、仲間のＥ・ＨＥＲＯを守り抜く。`,kind:"Monster",cardId:6312,nameTags:["Ｅ・ＨＥＲＯ"]},"Ｅ・ＨＥＲＯ スパークマン":{name:"Ｅ・ＨＥＲＯ スパークマン",nameKana:"",description:`様々な武器を使いこなす、光の戦士のＥ・ＨＥＲＯ。
...
その闇属性モンスターを手札に加える。`}},qe=class qe{constructor(e){d(this,"id");d(this,"name");d(this,"description");d(this,"save",async e=>{const t=e??{id:this.id,name:this.name,description:this.description},i=await qe.tblHeader.update(this.id,a=>({...a,...t}));return new qe(i)});this.id=e.id,this.name=e.name,this.description=e.description}};d(qe,"tblHeader"),d(qe,"getOrCreateNew",async e=>{qe.tblHeader||(qe.tblHeader=new ds(e));const t=await qe.tblHeader.getAll();if(t.length)return new qe(t[0]);const i=await qe.tblHeader.insert({name:"あなた",description:"ここの文字列を何に使うかは未定。"});return new qe(i)});let Gn=qe;class ds extends ki{constructor(t){super(t,"TblDuelistProfile");d(this,"_prepareInitialRecords",()=>[])}}let ps=-1;const cs=[{id:ps--,name:"NPC",description:""}],ks=["Deck","ExtraDeck"],ms={Deck:"メインデッキ",ExtraDeck:"エクストラデッキ"},Vn=["Monster","Spell","Trap"],Ea={Monster:"モンスター",Spell:"魔法",Trap:"罠"},Ot=["Fusion","Syncro","Xyz","Link"],Ta=[...Ot,"SpecialSummon"],us=["Toon","Spirit","Union","Gemini","FlipEffect"],hs=["Tuner","Effect","Normal","Pendulum","Token"],Ni=[...Ta,...us,...hs],Fn={Syncro:"シンクロ",Fusion:"融合",Xyz:"エクシーズ",Link:"リンク",SpecialSummon:"特殊召喚",Toon:"トゥーン",Spirit:"スピリット",Union:"ユニオン",Gemini:"デュアル",FlipEffect:"リバース",Tuner:"チューナー",Effect:"効果",Normal:"通常",Pendulum:"ペンデュラム",Token:"トークン"},nn={Syncro:"🎵",Fusion:"🌀",Xyz:"📰",Link:"⛓️",SpecialSummon:"🔯",Toon:"📖",Spirit:"👻",Union:"🚗",Gemini:"👫",FlipEffect:"🔄",Tuner:"🎶",Effect:"✨",Normal:"🔘",Pendulum:"💠",Token:"🐏"},bi=["Light","Dark","Earth","Water","Fire","Wind","Divine"],mi={Light:"光",Dark:"闇",Earth:"地",Water:"水",Fire:"炎",Wind:"風",Divine:"神"},_i=["Aqua","Beast","BeastWarrior","CreatorGod","Cyberse","Dinosaur","DivineBeast","Dragon","Fairy","Fiend","Fish","Insect","Illusion","Machine","Plant","Psychic","Pyro","Reptile","Rock","SeaSerpent","Spellcaster","Thunder","Warrior","WingedBeast","Wyrm","Zombie"],Fi=["Normal","Continuous","Field","QuickPlay","Equip","Ritual"],an={Normal:"通常",Continuous:"永続",Field:"フィールド",QuickPlay:"速攻",Equip:"装備",Ritual:"儀式"},Hi=["Normal","Continuous","Counter"],rn={Normal:"通常",Continuous:"永続",Counter:"カウンター"},Hn={Aqua:"水",Beast:"獣",BeastWarrior:"獣戦士",CreatorGod:"創造神",Cyberse:"サイバース",Dinosaur:"恐竜",DivineBeast:"幻獣神",Dragon:"ドラゴン",Fairy:"天使",Fiend:"悪魔",Fish:"魚",Insect:"昆虫",Illusion:"幻想魔",Machine:"機械",Plant:"植物",Psychic:"サイキック",Pyro:"炎",Reptile:"爬虫類",Rock:"岩石",SeaSerpent:"海竜",Spellcaster:"魔法使い",Thunder:"雷",Warrior:"戦士",WingedBeast:"鳥獣",Wyrm:"幻竜",Zombie:"アンデット"},sn={Aqua:"🚰",Beast:"🐅",BeastWarrior:"🦁",CreatorGod:"🔆",Cyberse:"💻️",Dinosaur:"🦖",DivineBeast:"💫",Dragon:"🐲",Fairy:"👼",Fiend:"👿",Fish:"🐟️",Insect:"🦋",Illusion:"🤡",Machine:"🤖",Plant:"🌱",Psychic:"👁️",Pyro:"🔥",Reptile:"🦎",Rock:"⛰",SeaSerpent:"🐍",Spellcaster:"🧙",Thunder:"⚡️",Warrior:"⚔️",WingedBeast:"🦅",Wyrm:"🐉",Zombie:"🦴"};Array.prototype.shuffle=function(){return this.map(e=>({item:e,seq:Math.random()})).toSorted((e,t)=>e.seq-t.seq).map(e=>e.item)};Array.prototype.randomPick=function(n){return this.shuffle().slice(0,n)};Array.prototype.reset=function(...n){this.splice(0),this.push(...n)};Array.prototype.union=function(n){return this.filter(n.includes,n)};Array.prototype.getAllOnOffPattern=function(){const n=[];return this.forEach(e=>{if(n.length==0){n.push([e]),n.push([]);return}n.forEach(t=>n.push([...t,e]))}),n};Array.prototype.getDistinct=function(){return Array.from(new Set(this))};const fs=n=>{if(n.controller.normalSummonCount>=n.controller.maxNormalSummonCount||!n.status.level)return;const e=n.controller.getAvailableMonsterZones();return n.status.level<5?e.length>0?e:void 0:n.controller.getReleasableMonsters().length<(n.status.level<7?1:2)?void 0:[]},ws=async(n,e,t)=>{if(!n.status.level)return[];if(n.status.level<5)return[];let i=t;const a=n.controller.getReleasableMonsters(),s=n.controller.getExtraMonsterZones(),o=n.status.level<7?1:2;s.length>=o&&a.filter(p=>p.fieldCell.cellType!=="ExtraMonsterZone");const k=await n.field.release(n.controller,n.controller.getReleasableMonsters(),o,"Cost",["AdvanceSummonRelease","Rule"],n,i);if(k)return i=!1,k},Cs=async(n,e,t)=>{if(!n.status.level)return!1;const i=["Rule","NormalSummon"];t&&t.length>0&&(n.info.materials.reset(...t),i.push("AdvanceSummon"));const a=n.controller.getAvailableMonsterZones();return await n.field.summon(n,["Attack","Set"],e?[e]:a,"NormalSummon",i,n,void 0,t&&t.length===0),n.controller.normalSummonCount++,!0},Ds=n=>{if(n.status.attackCount>0||n.battlePotion!=="Attack"||!n.controller.isTurnPlayer)return;const e=n.controller.getAttackTargetMonsters();return e.length>0?e.map(t=>t.fieldCell):[n.controller.getOpponentPlayer().getHandCell()]},gs=async(n,e)=>{if(n.status.attackCount>0||n.battlePotion!=="Attack")return!1;if(e!=null&&e.targetForAttack)return n.field.duel.declareAnAttack(n,e==null?void 0:e.targetForAttack),!0;const t=n.controller.getAttackTargetMonsters(),i=n.controller.getOpponentPlayer().entity;if(t.length===0)return n.field.duel.declareAnAttack(n,i),!0;if(t.length===1)return n.field.duel.declareAnAttack(n,t[0]),!0;const a=await n.field.duel.view.waitSelectEntities(n.controller,t,1,s=>s.length===1,"攻撃対象を選択。",!0);return a?(n.field.duel.declareAnAttack(n,a[0]),!0):!1},ys=n=>{if(!(n.status.battlePotisionChangeCount>0||n.status.attackCount>0||!n.controller.isTurnPlayer))return[]},vs=async n=>n.status.battlePotisionChangeCount>0||!n.controller.isTurnPlayer?!1:(n.setBattlePosition(n.battlePotion==="Attack"?"Defense":"Attack"),n.status.battlePotisionChangeCount++,!0),Bs=n=>{if(n.status.spellCategory==="Field"){const t=n.controller.getFieldZone();return t.isAvailable?[t]:void 0}const e=n.controller.getAvailableSpellTrapZones();return e.length>0?e:void 0},Es=async(n,e)=>{const t=n.controller.getAvailableSpellTrapZones();return t.length===0?!1:(await n.field.setSpellTrap(n,e?[e]:t,void 0,n.controller,!0),!0)},Te=n=>{if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return[];const e=n.controller.getAvailableSpellTrapZones();return e.length>0?e:void 0},xe=async(n,e)=>{if(n.info.isDying=!0,n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return n.setNonFieldPosition("FaceUp",!0),!0;if(n.fieldCell.cellType==="Hand"){const t=["SpellTrapActivate"],i=e?[e]:n.controller.getAvailableSpellTrapZones();return await n.field.activateSpellTrapFromHand(n,i,t,n,n.controller,!0),!0}return!1},xa=(n,e,t,i)=>!(e.some(a=>!a.status.canBeSyncroMaterial)||e.some(a=>a.fieldCell.cellType!=="Hand"&&a.fieldCell.cellType!=="MonsterZone"&&a.fieldCell.cellType!=="ExtraMonsterZone")||e.some(a=>a.fieldCell.cellType==="Hand")&&e.every(a=>!a.status.allowHandSyncro)||e.some(a=>!a.lvl)||e.map(a=>a.lvl??0).reduce((a,s)=>a+s,0)!==(n.origin.level??-1)||!t(e.filter(a=>{var s;return(s=a.status.monsterCategories)==null?void 0:s.some(o=>o==="Tuner")}))||!i(e.filter(a=>{var s;return(s=a.status.monsterCategories)==null?void 0:s.every(o=>o!=="Tuner")}))),Ma=(n,e=i=>i.length===1,t=i=>i.length>0)=>{let i=[...n.controller.getMonstersOnField().filter(a=>a.battlePotion!=="Set"),...n.controller.getHandCell().entities.filter(a=>a.origin.kind==="Monster")].filter(a=>a.status.canBeSyncroMaterial);return i.every(a=>!a.status.allowHandSyncro)&&(i=n.controller.getMonstersOnField()),i.length<2?[]:i.getAllOnOffPattern().filter(a=>xa(n,a,e,t))},Ts=(n,e=i=>i.length===1,t=i=>i.length>0)=>Ma(n,e,t).length>0?[]:void 0,xs=async(n,e,t,i=s=>s.length===1,a=s=>s.length>0)=>{const s=Ma(n,i,a);if(s.length===1){for(const p of s[0])await p.sendToGraveyard(["SyncroMaterial","Rule","SpecialSummonMaterial"],n,n.controller);return s[0]}const o=s.flatMap(p=>p).getDistinct(),k=await n.field.sendToGraveyard("シンクロ素材とするモンスターを選択",n.controller,o,-1,p=>xa(n,p,i,a),["SyncroMaterial","Rule","SpecialSummonMaterial"],n,t);if(console.log(k),!!k)return k},Ms=async(n,e,t,i)=>{i&&i.length>0&&n.info.materials.reset(...i);const a=[...e.getAvailableMonsterZones(),...e.getAvailableExtraZones()];return await n.field.summon(n,["Attack","Defense"],t?[t]:a,"SyncroSummon",["Rule","SpecialSummon"],n,void 0,i&&i.length===0),e.specialSummonCount++,n.info.isRebornable=!0,!0},dt={title:"通常召喚",playType:"NormalSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:fs,prepare:(n,e,t)=>ws(n,e,t),execute:(n,e,t,i)=>Cs(n,t,i)},$e={title:"攻撃宣言",playType:"Battle",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:Ds,prepare:async()=>!0,execute:(n,e,t)=>gs(n,t)},je={title:"表示形式変更",playType:"ChangeBattlePosition",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:ys,prepare:async()=>!0,execute:n=>vs(n)},Ee={title:"セット",playType:"SpellTrapSet",spellSpeed:"Normal",executableCells:["Hand"],validate:Bs,prepare:async()=>!0,execute:(n,e,t)=>Es(n,t)},Si=(n=t=>t.length===1,e=t=>t.length>0)=>({title:"シンクロ召喚",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["ExtraDeck"],validate:t=>Ts(t,n,e),prepare:(t,i,a)=>xs(t,i,a,n,e),execute:(t,i,a,s)=>Ms(t,i,a,s)}),Ns=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>{if(e.controller.getDeckCell().cardEntities.filter(n).length!==0)return Te(e)},prepare:xe,execute:async(e,t)=>{const i=t.getDeckCell().cardEntities.filter(n);if(i.length===0)return!1;const a=await e.field.duel.view.waitSelectEntities(t,i,1,s=>s.length===1,"手札に加えるカードを選択",!1);for(const s of a??[])await s.addToHand(["Effect"],e,t);return t.shuffleDeck(),!0}}),bs=(n,e)=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:t=>{if(!(t.controller.getGraveyard().cardEntities.filter(n).length<e))return Te(t)},prepare:xe,execute:async(t,i)=>{const a=i.getGraveyard().cardEntities.filter(n);if(a.length===0)return!1;const s=await t.field.duel.view.waitSelectEntities(i,a,e,o=>o.length===e,"手札に加えるカードを選択",!1);for(const o of s??[])await o.addToHand(["Effect"],t,i);return!0}}),_s=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>{if(e.controller.getHandCell().cardEntities.filter(n).length!==0&&!(e.controller.getDeckCell().cardEntities.length<2))return Te(e)},prepare:async(e,t)=>(await e.controller.discard(1,["Discard","Cost"],e,e.controller,n),await xe(e,t)),execute:async(e,t)=>(await t.draw(2,e,t),!0)}),Fs=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:Te,prepare:xe,execute:async(e,t)=>{const[i,a]=n(e);return a>0?t.getOpponentPlayer().heal(a,e):a<0&&t.getOpponentPlayer().effectDamage(Math.abs(a),e),i>0?t.heal(i,e):i<0&&t.effectDamage(Math.abs(i),e),!0}}),Hs=["NormalSummon","SpecialSummon","ChangeBattlePosition","Battle","SpellTrapSet","SpellTrapActivate"];class Ss{constructor(e,t,i){d(this,"seq");d(this,"entity");d(this,"cardActionBase");d(this,"validate",()=>{if(!(this.isOnlyNTimesPerDuel>0&&this.entity.field.duel.cardActionLog.records.filter(e=>this.isSame(e.cardAction)).filter(e=>e.activater).length>=this.isOnlyNTimesPerDuel)&&!(this.isOnlyNTimesPerTurn>0&&this.entity.field.duel.cardActionLog.records.filter(e=>this.isSameGroupPerTurn(e.cardAction)).filter(e=>e.turn===this.entity.field.duel.clock.turn).filter(e=>e.activater).length>=this.isOnlyNTimesPerTurn))return this.cardActionBase.validate(this.entity)});d(this,"prepare",async e=>{const t=await this.cardActionBase.prepare(this.entity,e);if(t!==void 0)return this.entity.field.duel.cardActionLog.push(this.entity.controller,this),t});d(this,"execute",(e,t,i)=>this.cardActionBase.execute(this.entity,e,t,i));d(this,"isSame",e=>this.entity.origin.name===e.entity.origin.name&&this.title===e.title);d(this,"isSameGroupPerTurn",e=>this.actionGroupNamePerTurn?this.entity.origin.name===e.entity.origin.name&&this.actionGroupNamePerTurn===e.actionGroupNamePerTurn:this.isSame(e));this.seq=e,this.entity=t,this.cardActionBase=i}get title(){return this.cardActionBase.title}get playType(){return this.cardActionBase.playType}get spellSpeed(){return this.cardActionBase.spellSpeed}get hasToTargetCards(){return this.cardActionBase.hasToTargetCards??!1}get executableCells(){return this.cardActionBase.executableCells}get isOnlyNTimesPerDuel(){return this.cardActionBase.isOnlyNTimesPerDuel??0}get isOnlyNTimesPerTurn(){return this.cardActionBase.isOnlyNTimesPerTurn??0}get actionGroupNamePerTurn(){return this.cardActionBase.actionGroupNamePerTurn}}const Ks=["Card","Token","Avatar"],cn=(n,e)=>{const t=n.monsterCategories??[],i=e.monsterCategories??[];for(const a of Ot.toReversed()){if(t.includes(a)&&!i.includes(a))return 1;if(!t.includes(a)&&i.includes(a))return-1}if(n.kind===e.kind){if(n.kind==="Monster"){if((n.link??0)!==(e.link??0))return(n.link??0)-(e.link??0);if((n.rank??0)!==(e.rank??0))return(n.rank??0)-(e.rank??0);if((n.level??0)!==(e.level??0))return(n.level??0)-(e.level??0);if((n.attack??0)!==(e.attack??0))return(n.attack??0)-(e.attack??0);if((n.defense??0)!==(e.defense??0))return(n.defense??0)-(e.defense??0)}return n.name.localeCompare(e.name,"Ja")}for(const a of Vn){if(n.kind===a)return-1;if(e.kind===a)return 1}return n.name.localeCompare(e.name,"Ja")},Ps=(n,e)=>cn(n.origin,e.origin),ve=class ve{constructor(e,t,i,a,s,o,k,p){d(this,"seq");d(this,"origin");d(this,"entityType");d(this,"face");d(this,"isUnderControl");d(this,"_battlePosition");d(this,"orientation");d(this,"controller");d(this,"owner");d(this,"fieldCell");d(this,"wasMovedBy");d(this,"wasMovedByWhom");d(this,"wasMovedAs");d(this,"wasMovedFrom");d(this,"wasMovedAt");d(this,"_status");d(this,"_info");d(this,"actions",[]);d(this,"getIndexInCell",()=>{const e=this.fieldCell.cardEntities.indexOf(this);if(e<0)throw new Ve("エンティティとセルの状態が矛盾している。",[this,this.fieldCell]);return e});d(this,"setBattlePosition",e=>{this._battlePosition=e,this.orientation=e==="Attack"?"Vertical":"Horizontal",this.face=e==="Set"?"FaceDown":"FaceUp",this.isUnderControl=!0});d(this,"setNonFieldPosition",(e,t)=>{this._battlePosition=void 0,this.orientation=e==="XysMaterial"?"Horizontal":"Vertical",this.face=e==="FaceUp"?"FaceUp":"FaceDown",this.isUnderControl=t});d(this,"summon",async(e,t,i,a,s,o)=>{const k={Attack:"AttackSummon",Defense:"DefenseSummon",Set:"SetSummon"};e.isAvailable&&(this.setBattlePosition(t),await this._moveTo(e,"Top",[i,k[t],...a],s,o),this.status.battlePotisionChangeCount=1)});d(this,"setAsSpellTrap",async(e,t,i,a)=>{await this._moveTo(e,"Top",[...t,"SpellTrapSet"],i,a),this.setNonFieldPosition("Set",!0)});d(this,"activateSpellTrapFromHand",async(e,t,i,a)=>{this.setNonFieldPosition("FaceUp",!0),await this._moveTo(e,"Top",[...t,"SpellTrapActivate"],i,a)});d(this,"activateSpellTrapOnField",async()=>{this.setNonFieldPosition("FaceUp",!0)});d(this,"draw",async(e,t,i)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",[...e,"Draw"],t,i),this.setNonFieldPosition("Set",!0)});d(this,"addToHand",async(e,t,i)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",e,t,i),this.setNonFieldPosition("Set",!0)});d(this,"release",async(e,t,i)=>{await this.sendToGraveyard([...e,"Release"],t,i)});d(this,"destroy",async(e,t,i,a)=>{await this.sendToGraveyard([...t,e,"Destroy"],i,a)});d(this,"sendToGraveyard",async(e,t,i)=>{if(this.info.willBeBanished)return await this.banish(e,t,i);if(this.info.willReturnToDeck)return await this.banish(e,t,i);this.info.isDying=!1,this.setNonFieldPosition("FaceUp",!0);const a=this.owner.getGraveyard();await this._moveTo(a,"Top",e,t,i)});d(this,"banish",async(e,t,i)=>{if(this.info.willReturnToDeck)return await this.banish(e,t,i);this.info.isDying=!1,this.setNonFieldPosition("FaceUp",!0);const a=this.owner.getBanished();await this._moveTo(a,"Top",e,t,i),this.info.willBeBanished=!1});d(this,"banishTemporarily",async(e,t,i)=>{if(this.info.willBeBanished)return await this.banish(e,t,i);if(this.info.willReturnToDeck)return await this.banish(e,t,i);throw new Error("not implemented")});d(this,"returnToDeck",async(e,t,i,a)=>{if(this.info.willBeBanished)return await this.banish(t,i,a),this.owner.getBanished();const s=this.origin.monsterCategories&&this.origin.monsterCategories.union(Ot).length?this.owner.getExtraDeck():this.owner.getDeckCell();return this.setNonFieldPosition("Set",!1),this.resetInfo(),this.resetStatus(),await this._moveTo(s,e,t,i,a)});d(this,"_moveTo",async(e,t,i,a,s)=>{if(!e)throw new Error("illegal argument: to");if(this.field.duel.clock.turn>0&&await this.field.duel.view.waitAnimation({entity:this,to:e,index:t,count:0}),this.fieldCell.releaseEntities([this]),this.wasMovedAs.splice(0),this.wasMovedAs.push(...new Set(i)),this.wasMovedAt=this.field.duel.clock.getClone(),this.wasMovedBy=a,this.wasMovedFrom=this.fieldCell,this.wasMovedByWhom=s,this.entityType==="Token"&&this.fieldCell.cellType!=="MonsterZone"){this.field.duel.log.info(`${this.nm}は消滅した。`,this.controller);return}e.acceptEntities([this],t)});d(this,"resetInfo",()=>{var e;this._info={isDying:!1,isVanished:!1,isRebornable:((e=this.origin.monsterCategories)==null?void 0:e.union(Ta).length)===0||(this.origin.canReborn??!1),materials:[],willBeBanished:!1,willReturnToDeck:!1}});d(this,"resetStatus",()=>{this._status={...JSON.parse(JSON.stringify(this.origin)),canAttack:!0,isEffective:!0,canDirectAttack:!1,attackCount:0,isSelectableForAttack:!0,canBeSyncroMaterial:!0,willBeBanished:!1}});this.seq=ve.nextEntitySeq++,this.owner=e,this.controller=t,this.fieldCell=i,this.entityType=a,this.origin=s,this._status=JSON.parse(JSON.stringify(s)),this.resetStatus(),this._info={isDying:!1,isVanished:!1,isRebornable:!0,materials:[],willBeBanished:!1,willReturnToDeck:!1},this.resetInfo(),this.face=o,this.isUnderControl=k,this.orientation=p,this.wasMovedAs=["Rule"],this.wasMovedAt=this.field.duel.clock,this.wasMovedByWhom=e,i.acceptEntities([this],"Top")}get field(){return this.owner.duel.field}get status(){return this._status}get info(){return this._info}get nm(){return this.status.name}get atk(){return this.status.attack}get def(){return this.status.defense}get lvl(){return this.status.level}get rank(){return this.status.rank}get attr(){return this.status.attribute?[this.status.attribute]:[]}get type(){return this.status.type?[this.status.type]:[]}get psL(){return[this.status.pendulumScaleL]}get psR(){return[this.status.pendulumScaleR]}get battlePotion(){return this._battlePosition}};d(ve,"nextActionSeq",0),d(ve,"nextEntitySeq",0),d(ve,"actionDic",{}),d(ve,"createCardActionList",(e,t)=>{const i=t.map(a=>new Ss(ve.nextActionSeq++,e,a));return i.forEach(a=>ve.actionDic[a.seq]=a),i}),d(ve,"createPlayerEntity",e=>{const t=e.getHandCell();return new ve(e,e,t,"Duelist",{name:e.profile.name,kind:"Monster"},"FaceUp",!0,"Vertical")}),d(ve,"createCardEntity",(e,t)=>{var o;const i=t.monsterCategories&&t.monsterCategories.union(Ot).length?e.getExtraDeck():e.getDeckCell(),a=new ve(e,e,i,"Card",t,"FaceDown",!1,"Vertical");Object.hasOwn(be,a.origin.name)||e.duel.log.info(`未実装カード${t.name}がデッキに投入された。`,e);const s=be[a.origin.name];return s.kind==="Monster"&&((o=s.monsterCategories)!=null&&o.includes("Normal"))?a.actions.push(...ve.createCardActionList(a,[dt,$e,je])):a.actions.push(...ve.createCardActionList(a,Xn.get(a.origin.name)||[])),a}),d(ve,"createDammyAction",(e,t,i,a)=>({seq:ve.nextActionSeq++,title:t,entity:e,playType:"Dammy",spellSpeed:"Dammy",executableCells:[e.fieldCell.cellType],hasToTargetCards:!1,isOnlyNTimesPerDuel:0,isOnlyNTimesPerTurn:0,validate:()=>i,prepare:async()=>{},execute:async()=>!1,pos:a,cell:i[0],dragAndDropOnly:i.length>1}));let gt=ve;class Ki{constructor(e,t,i,a,s){d(this,"duel");d(this,"seat");d(this,"_entity");d(this,"profile");d(this,"deckInfo");d(this,"duelistType");d(this,"lifeLog");d(this,"normalSummonCount");d(this,"specialSummonCount");d(this,"maxNormalSummonCount");d(this,"_lp");d(this,"battleDamage",(e,t)=>this.setLp(this._lp-e,t,"BattleDamage"));d(this,"effectDamage",(e,t)=>this.setLp(this._lp-e,t,"EffectDamage"));d(this,"lostLp",(e,t)=>this.setLp(this._lp-e,t,"Lost"));d(this,"payLp",(e,t)=>this.setLp(this._lp-e,t,"Pay"));d(this,"heal",(e,t)=>this.setLp(this._lp+e,t,"Heal"));d(this,"setLp",(e,t,i)=>{const a={clock:this.duel.clock,reason:i||"Set",beforeLp:this._lp,afterLp:e,entity:t};return this.lifeLog.push(a),this._lp=e,this.duel.log.info(`ライフポイント変動：${a.afterLp-a.beforeLp}（${a.beforeLp} ⇒ ${a.afterLp}）`,this),a});d(this,"getOpponentPlayer",()=>this.duel.firstPlayer===this?this.duel.secondPlayer:this.duel.firstPlayer);d(this,"getHandCell",()=>this.duel.field.getCells("Hand").filter(e=>e.owner===this)[0]);d(this,"getDeckCell",()=>this.duel.field.getCells("Deck").filter(e=>e.owner===this)[0]);d(this,"getExtraDeck",()=>this.duel.field.getCells("ExtraDeck").filter(e=>e.owner===this)[0]);d(this,"getGraveyard",()=>this.duel.field.getCells("Graveyard").filter(e=>e.owner===this)[0]);d(this,"getFieldZone",()=>this.duel.field.getCells("FieldSpellZone").filter(e=>e.owner===this)[0]);d(this,"getBanished",()=>this.duel.field.getCells("Banished").filter(e=>e.owner===this)[0]);d(this,"getMonsterZones",()=>this.duel.field.getCells("MonsterZone").filter(e=>e.owner===this));d(this,"getExtraMonsterZones",()=>this.duel.field.getCells("ExtraMonsterZone").filter(e=>{var t;return((t=e.cardEntities[0])==null?void 0:t.controller)===this}));d(this,"getSpellTrapZones",()=>this.duel.field.getCells("SpellAndTrapZone").filter(e=>e.owner===this));d(this,"getEmptyMonsterZones",()=>this.getMonsterZones().filter(e=>e.cardEntities.length===0));d(this,"getEmptyExtraZones",()=>this.getExtraMonsterZones().length===0?this.getMonsterZones().filter(e=>e.cardEntities.length===0):[]);d(this,"getAvailableMonsterZones",()=>this.getMonsterZones().filter(e=>e.isAvailable));d(this,"getAvailableExtraZones",()=>this.getExtraMonsterZones().length===0?this.duel.field.getCells("ExtraMonsterZone").filter(e=>e.isAvailable):[]);d(this,"getAvailableSpellTrapZones",()=>this.getSpellTrapZones().filter(e=>e.isAvailable));d(this,"getReleasableMonsters",()=>this.getMonstersOnField());d(this,"getMonstersOnField",()=>this.duel.field.getMonstersOnField().filter(e=>e.controller===this));d(this,"getAttackTargetMonsters",()=>this.duel.field.getMonstersOnField().filter(e=>e.status.isSelectableForAttack&&e.controller!==this));d(this,"pushDeck",()=>{this.deckInfo.cardNames.map(e=>be[e]).filter(e=>e).forEach(e=>gt.createCardEntity(this,e)),this.duel.log.info(`デッキをセット。メイン${this.getDeckCell().cardEntities.length}枚。エクストラ${this.getExtraDeck().cardEntities.length}枚。`,this)});d(this,"draw",async(e,t,i)=>{var o;if(e<1)return;const a=this.getDeckCell(),s=[];for(const k of Array(e)){if(!a.cardEntities.length)throw this.duel.log.info(s.length>0?`デッキからカードを${e}枚ドローしようとしたが、${s.length}枚しかドローできなかった。${s}`:"デッキからカードをドローできなかった。",this),this.duel.isEnded=!0,this.setLp(0),new yt(this.getOpponentPlayer());const p=a.cardEntities[0];await p.draw(t?["Effect"]:["Rule"],t,i),s.push(((o=p.origin)==null?void 0:o.name)||"!名称取得失敗!")}this.duel.log.info(`デッキからカードを${s.length}枚ドロー。${s}。`,this)});d(this,"shuffleDeck",()=>{this.getDeckCell().shuffle(),this.duel.log.info("デッキをシャッフル。",this)});d(this,"discard",async(e,t,i,a,s,o)=>{const k=s||(()=>!0),p=this.getHandCell().cardEntities.filter(k);if(p.length<e)return[];let c=[];(a||this).duelistType==="NPC"?c=p.randomPick(e):c=await this.duel.view.waitSelectEntities(a||this,p,e,m=>m.length===e,`${e}枚カードを捨てる。`,!1)||[];for(const m of c)await m.sendToGraveyard(["Discard",...t],i,o);return this.duel.log.info(`手札からカードを${c.length}枚捨てた。${c.map(m=>{var f;return(f=m.origin)==null?void 0:f.name})}。`,this),c});this.duel=e,this.seat=t,this.profile=i,this.duelistType=a,this.deckInfo=s,this.lifeLog=[],this.normalSummonCount=0,this.specialSummonCount=0,this.maxNormalSummonCount=1,this._lp=8e3}get entity(){const e=this.getHandCell().entities.find(t=>t.entityType==="Duelist");return e||gt.createPlayerEntity(this)}get lp(){return this._lp}get isTurnPlayer(){return this.duel.getTurnPlayer()===this}}const Pi=["Deck","ExtraDeck","Graveyard","Banished"],Qn={0:{0:"Hand"},1:{0:"Deck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"ExtraDeck"},2:{0:"Graveyard",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"FieldSpellZone"},3:{0:"Banished",1:"Disable",2:"ExtraMonsterZone",3:"Disable",4:"ExtraMonsterZone",5:"Disable",6:"Banished"},4:{0:"FieldSpellZone",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"Graveyard"},5:{0:"ExtraDeck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"Deck"},6:{0:"Hand"}};class qs{constructor(e,t,i,a){d(this,"onUpdateEvent",new Pe);d(this,"field");d(this,"row");d(this,"column");d(this,"cellType");d(this,"owner");d(this,"_entities");d(this,"releaseEntities",e=>(this._entities=this._entities.filter(t=>!e.includes(t)),this.onUpdateEvent.trigger(),e));d(this,"acceptEntities",(e,t)=>{t==="Bottom"?this._entities.push(...e):t==="Top"&&this._entities.unshift(...e),this._entities.forEach(i=>{i.fieldCell=this}),this.onUpdateEvent.trigger()});d(this,"shuffle",()=>{this._entities=this.entities.shuffle()});this.field=e,this.row=t,this.column=i,this.cellType=Qn[t][i],this.owner=a,this._entities=[]}get onUpdate(){return this.onUpdateEvent.expose()}get entities(){return this._entities}get cardEntities(){return this._entities.filter(e=>Ks.find(t=>t===e.entityType))}get targetForAttack(){return this.cellType==="Hand"?this._entities.find(e=>e.entityType==="Duelist"):this.cardEntities[0]}get isAvailable(){return this._entities.length===0}}class Ws{constructor(e){d(this,"cells");d(this,"duel");d(this,"getAllCells",()=>this.cells.flat());d(this,"getCells",(...e)=>this.getAllCells().filter(t=>e.includes(t.cellType)));d(this,"getAllEntities",()=>this.getAllCells().map(e=>e.entities).flat());d(this,"getAllCardEntities",()=>this.getAllCells().map(e=>e.cardEntities).flat());d(this,"getMonstersOnField",()=>this.getCells("MonsterZone","ExtraMonsterZone").map(e=>e.cardEntities).filter(e=>e.length>0).map(e=>e[0]).filter(e=>e.entityType!=="Squatter"));d(this,"getEntities",e=>this.getAllEntities().filter(t=>t.controller===e));d(this,"sendGraveyardAtSameTime",async(e,t,i,a)=>{const s=e.reduce((k,p)=>(k[p.owner.seat].push(p),k),{Above:[],Below:[]}),o=Object.values(s).map(k=>new Promise(p=>{let c=new Promise(m=>m());for(const m of k)c=c.then(()=>m.sendToGraveyard(t,i,a));c.then(()=>p())}));await Promise.all(o)});d(this,"drawAtSameTime",async(e,t,i,a,s,o)=>{const k=[],p=[],c=[e.draw(t,s,o),i.draw(a,s,o)].map(m=>m.catch(f=>{f instanceof yt?f.winner&&k.push(f.winner):p.push(f)}));if(await Promise.all(c),p.length)throw new Ve("ドロー処理で想定されない例外が発生した。",e,t,i,a,s,...p);if(k.length!==0)throw k.length===1?new yt(k[0]):new yt});d(this,"sendToGraveyard",async(e,t,i,a,s,o,k,p)=>{if(a>0&&i.length<a)return;const c=await this.duel.view.waitSelectEntities(t,i,a,s,e,p);if(c){for(const m of c)await m.sendToGraveyard(o,k,t);return this.duel.log.info(`${c.map(m=>m.status.name).join(", ")}を墓地に送った（${o.getDistinct().join(", ")}）。`,t),c}});d(this,"release",async(e,t,i,a,s,o,k,p)=>{if(i>0&&t.length<i)return;const c=await this.duel.view.waitSelectEntities(e,t,i,f=>(k||f.length>0)&&(i<0||f.length===i),"リリースするモンスターを選択",p);if(!c)return;const m=[];for(const f of c)await f.release(["Release",a,...s],o,e),m.push(f);return this.duel.log.info(`${m.map(f=>f.status.name).join(", ")}をリリース（${[...new Set(m.flatMap(f=>f.wasMovedAs))].join(", ")}）。`,e),m});d(this,"summonMany",async(e,t,i,a,s,o,k)=>{const p=await Promise.all(e.map(async c=>this._summon(c,t(c),i(c),a,s,o,k?k(c):void 0)));if(p.find(c=>!c))throw new Ve("想定されない返却値",p);return p});d(this,"summon",async(e,t,i,a,s,o,k,p=!1)=>{const c=await this._summon(e,t,i,a,s,o,k,p);if(c)return this.duel.log.info(`${c.status.name}を召喚（${[...s,a].join(",")}）。`,k??(o==null?void 0:o.controller)??e.controller),c});d(this,"_summon",async(e,t,i,a,s,o,k,p=!1)=>{const c=k??(o==null?void 0:o.controller)??e.controller;let m=t.randomPick(1)[0],f=i.randomPick(1)[0];if((i.length>1||t.length>1)&&c.duelistType!=="NPC"){const r=i.length>1?"カードを召喚先へドラッグ。":"表示形式を選択。",l=t.map(v=>gt.createDammyAction(e,v,i,v)),u=this.duel.view.modalController.selectAction(this.duel.view,{title:r,actions:l,cancelable:!1}),w=this.duel.view.waitSubAction(c,l,r,p).then(v=>v.action),C=await Promise.any([u,w]);if(!C&&!p)throw new Ve("",C);if(!C)return;f=C.cell||f,m=C.pos||m}return console.log(f,m,a,s,o),await e.summon(f,m,a,s,o,c),e});d(this,"activateSpellTrapFromHand",async(e,t,i,a,s,o=!1)=>{const k=s??(a==null?void 0:a.controller)??e.controller;let p=t.randomPick(1)[0];if(t.length>1&&k.duelistType!=="NPC"){const c=[gt.createDammyAction(e,"カードの発動",t,void 0)];this.duel.view.modalController.selectAction(this.duel.view,{title:"カードを魔法罠ゾーンへドラッグ",actions:c,cancelable:!1});const m=await this.duel.view.waitSubAction(k,c,"カードを魔法罠ゾーンへドラッグ。",o),f=m.action;if(!f&&!o)throw new Ve("",m);if(!f)return;p=f.cell||p}return await e.activateSpellTrapFromHand(p,i,a,k),e});d(this,"setSpellTrap",async(e,t,i,a,s=!1)=>{let o=t[0];const k=a??(i==null?void 0:i.controller)??e.controller;if(t.length>1&&k.duelistType!=="NPC"){const p=[gt.createDammyAction(e,"セット",t)],c=this.duel.view.modalController.selectAction(this.duel.view,{title:"カードをセット先へドラッグ",actions:p,cancelable:s}),m=this.duel.view.waitSubAction(k,p,"カードをセット先へドラッグ",s),f=await Promise.any([c,m.then(r=>r.action)]);if(!f&&!s)throw new Ve("",f);if(!f)return;o=f.cell||o}await e.setAsSpellTrap(o,["SpellTrapSet"],i,k),this.duel.log.info(`${e.status.name}をセット（SpellTrapSet）。`,a??(i==null?void 0:i.controller)??e.controller)});this.duel=e,this.cells=[...Array(7)].map(()=>[]);for(const t of Object.keys(Qn).map(Number))for(const i of Object.keys(Qn[t]).map(Number))this.cells[t][i]=new qs(this,t,i,t<3?e.duelists.Above:t>3?e.duelists.Below:i===0?e.duelists.Above:i===6?e.duelists.Below:void 0)}}let Ls=class{constructor(e){d(this,"onUpdateEvent",new Pe);d(this,"nextSeq");d(this,"records",[]);d(this,"duel");d(this,"dispose",()=>{this.onUpdateEvent.clear()});d(this,"error",e=>{console.error(e);const t=["エラー発生"];e instanceof Error?(e instanceof Ve&&(t.push("-- エラーメッセージ --"),t.push(e.message),t.push("-- 関連オブジェクト --"),e.items.forEach(i=>t.push(JSON.stringify(i)))),t.push("-- エラー名称 --"),t.push(e.name||"エラー名称取得失敗"),t.push("-- スタックトレース --"),t.push(e.stack||"スタックトレース取得失敗")):(t.push("-- エラー型特定失敗 --"),t.push(JSON.stringify(e))),this.info(t)});d(this,"info",(e,t)=>{const i=Array.isArray(e)?e.join(`
`):e;this.records.push({seq:this.nextSeq++,turn:this.duel.clock.turn,phase:this.duel.phase,phaseStep:this.duel.phaseStep,clock:this.duel.clock,duelist:t,text:i}),this.onUpdateEvent.trigger()});this.nextSeq=0,this.duel=e}get onUpdate(){return this.onUpdateEvent.expose()}};const qi=["DuelEntitiesSelector","DuelActionSelector"];class Rs{constructor(e){d(this,"onUpdateEvent",new Pe);d(this,"states");d(this,"view");d(this,"cancelAll",()=>{qi.forEach(e=>this.states[e]="Disable"),console.info(this,"cancelAll"),this.onUpdateEvent.trigger()});d(this,"duelEntitiesSelectorArg",{title:"対象を選択",entities:[],validator:()=>!0,qty:-1,cancelable:!1});d(this,"duelEntitiesSelectorValue");d(this,"duelEntitiesSelectorResolve",()=>{});d(this,"selectDuelEntities",async e=>(this.duelEntitiesSelectorArg=e,this.states.DuelEntitiesSelector="Shown",this.onUpdateEvent.trigger(),new Promise(t=>{this.duelEntitiesSelectorResolve=i=>{this.states.DuelEntitiesSelector="Disable",this.onUpdateEvent.trigger(),t(i)}})));d(this,"cardActionSelectorArg",{title:"カード操作を選択。",actions:[],cancelable:!1});d(this,"cardActionSelectorResolve",()=>{});d(this,"cardActionSelectorValue");d(this,"selectAction",async(e,t)=>(this.cardActionSelectorArg=t,this.states.DuelActionSelector="Shown",e.onWaitEnd.append(this.cancelAll),this.onUpdateEvent.trigger(),new Promise(i=>{this.cardActionSelectorResolve=a=>{console.log(a),this.states.DuelActionSelector="Disable",e.onWaitEnd.remove(this.cancelAll),this.onUpdateEvent.trigger(),i(a)}})));this.view=e,this.states=qi.reduce((t,i)=>(t[i]="Disable",t),{})}get onUpdate(){return this.onUpdateEvent.expose()}}class Os{constructor(e){d(this,"onDuelUpdateEvent",new Pe);d(this,"requireUpdate",()=>{this.onDuelUpdateEvent.trigger()});d(this,"onWaitStartEvent",new Pe);d(this,"onWaitEndEvent",new Pe);d(this,"onDragStartEvent",new Pe);d(this,"onDragEndEvent",new Pe);d(this,"onAnimationStartEvent",new Pe);d(this,"onShowCardEntityEvent",new Pe);d(this,"duel");d(this,"modalController");d(this,"message");d(this,"waitMode");d(this,"infoBoardState");d(this,"infoBoardCell");d(this,"getCell",(e,t)=>this.duel.field.cells[e][t]);d(this,"showCardInfo",e=>{this.onShowCardEntityEvent.trigger(e)});d(this,"dispose",()=>{this.onDragStartEvent.clear(),this.onDragEndEvent.clear(),this.onDuelUpdateEvent.clear(),this.onWaitStartEvent.clear(),this.onWaitEndEvent.clear()});d(this,"waitFieldAction",async(e,t)=>{if(console.log(e),this.duel.getTurnPlayer().duelistType==="NPC"){const i=e.toSorted((a,s)=>(s.entity.atk||0)-(a.entity.atk||0)).find(a=>a.playType==="NormalSummon"||a.playType==="SpecialSummon");return i?{action:i}:{phaseChange:this.duel.nextPhaseList[0]}}return await this._waitDuelistAction(e,"SelectFieldAction",t)});d(this,"waitQuickEffect",async(e,t,i)=>{if(e.length===0)return;const a=[];return a.push(this.modalController.selectAction(this,{title:t,actions:e,cancelable:i}).then(s=>s&&s)),a.push(this._waitDuelistAction(e,"SelectAction",this.message).then(s=>s.action)),await Promise.any(a)});d(this,"waitSubAction",async(e,t,i,a=!1)=>{if(e.duelistType==="NPC")throw Error("Not implemented");return await this._waitDuelistAction(t,"SelectAction",i,void 0,void 0,void 0,a)});d(this,"waitSelectEntities",async(e,t,i,a,s,o=!1)=>{let k=[];if(i&&t.length===i)return[...t];if(e.duelistType==="NPC"){for(;!a(k);){const c=i&&i>0?i:Math.floor(Math.random()*t.length)+1;k=t.randomPick(c)}return k}this.waitMode=t.every(c=>(c.fieldCell.cellType==="MonsterZone"||c.fieldCell.cellType==="ExtraMonsterZone")&&c.getIndexInCell()===0||c.fieldCell.cellType==="Hand"&&c.controller===e)?"SelectFieldEntities":"SelectEntities",console.log(this.waitMode);const p=await this._waitDuelistAction([],this.waitMode,s,t,i,a,o);return console.log(p),p.selectedEntities});d(this,"_waitDuelistAction",async(e,t,i,a,s,o,k=!1)=>{this.waitMode=t,this.message=i,this.onDuelUpdateEvent.trigger();const p=await new Promise(c=>{const m={resolve:c,enableActions:e,qty:s,entitiesValidator:o||(()=>!1),selectableEntities:a||[]};console.log(a),console.log(o),console.log(this.waitMode),console.log(this.waitMode==="SelectEntities"),a&&o&&this.waitMode==="SelectEntities"&&(m.duelEntitiesSelectorArg={title:i,entities:a,validator:o,qty:s??-1,cancelable:!1}),console.log(m),this.onWaitStartEvent.trigger(m)});if(console.log(p),this.waitMode="None",this.onWaitEndEvent.trigger(),p.surrender)throw new yt(this.duel.duelists.Above);if(!k&&p.cancel)throw new Ve("キャンセル不可のアクションがキャンセルされた。",p,e,t,a);return p});d(this,"waitAnimation",async e=>(this.onDuelUpdateEvent.trigger(),new Promise(t=>this.onAnimationStartEvent.trigger({...e,resolve:t}))));d(this,"setDraggingActions",e=>{this.onDragStartEvent.trigger(e),this.requireUpdate()});d(this,"removeDraggingActions",()=>{this.onDragEndEvent.trigger()});this.duel=e,this.message="",this.waitMode="None",this.infoBoardState="Log",this.infoBoardCell=e.duelists.Below.getExtraDeck(),this.modalController=new Rs(this)}get onDuelUpdate(){return this.onDuelUpdateEvent.expose()}get onWaitStart(){return this.onWaitStartEvent.expose()}get onWaitEnd(){return this.onWaitEndEvent.expose()}get onDragStart(){return this.onDragStartEvent.expose()}get onDragEnd(){return this.onDragEndEvent.expose()}get onAnimation(){return this.onAnimationStartEvent.expose()}get onShowCardEntity(){return this.onShowCardEntityEvent.expose()}}class Zs{constructor(){d(this,"_turn",0);d(this,"_phaseSeq",0);d(this,"_stepSeq",0);d(this,"_chainSeq",0);d(this,"_chainBlockSeq",0);d(this,"_procSeq",0);d(this,"_procTotalSeq",0);d(this,"incrementTurn",()=>{this._turn++,this._phaseSeq=0,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementPhaseSeq",()=>{this._phaseSeq++,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementStepSeq",()=>{this._stepSeq++,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementChainSeq",()=>{this._chainSeq++,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementChainBlockSeq",()=>{this._chainBlockSeq++,this._procSeq=0});d(this,"incrementProcSeq",()=>{this._procSeq++,this._procTotalSeq++});d(this,"toString",()=>`${this.procTotalSeq}(t${this.turn}-p${this.phaseSeq}-ps${this.stepSeq}-c${this.chainSeq}-cb${this.chainBlockSeq}-p${this.procSeq})`);d(this,"getClone",()=>({turn:this.turn,phaseSeq:this.phaseSeq,stepSeq:this.stepSeq,chainSeq:this.chainSeq,chainBlockSeq:this.chainBlockSeq,procSeq:this.procSeq,procTotalSeq:this.procTotalSeq}));d(this,"isSameChain",e=>this.turn===e.turn&&this.phaseSeq===e.phaseSeq&&this.stepSeq===e.stepSeq&&this.chainSeq===e.chainSeq);d(this,"isPreviousChain",e=>this.turn===e.turn&&this.phaseSeq===e.phaseSeq&&this.stepSeq===e.stepSeq&&this.chainSeq===e.chainSeq+1);d(this,"isPreviousProc",e=>this.procTotalSeq===e.procTotalSeq+1)}get turn(){return this._turn}get phaseSeq(){return this._phaseSeq}get stepSeq(){return this._stepSeq}get chainSeq(){return this._chainSeq}get chainBlockSeq(){return this._chainBlockSeq}get procSeq(){return this._procSeq}get procTotalSeq(){return this._procTotalSeq}}class Us{constructor(e){d(this,"nextSeq");d(this,"records",[]);d(this,"duel");d(this,"push",(e,t)=>{this.records.push({seq:this.nextSeq++,turn:this.duel.clock.turn,activater:e,cardAction:t})});this.nextSeq=0,this.duel=e}}class yt extends Error{constructor(t){const i=t?`デュエルが終了した。勝者：${t.profile.name}`:"デュエルが終了した。ドロー。";super(i);d(this,"winner");this.winner=t}}class Ve extends Error{constructor(t,...i){super("message");d(this,"message");d(this,"items");this.message=t,this.items=i}}class Is{constructor(e,t,i,a,s,o){d(this,"view");d(this,"log");d(this,"cardActionLog");d(this,"clock");d(this,"phase");d(this,"phaseStep");d(this,"nextPhaseList");d(this,"field");d(this,"attackingMonster");d(this,"targetForAttack");d(this,"duelists");d(this,"priorityHolder");d(this,"isEnded");d(this,"coin",!1);d(this,"getTurnPlayer",()=>this.clock.turn%2===0?this.secondPlayer:this.firstPlayer);d(this,"getNonTurnPlayer",()=>this.clock.turn%2===0?this.firstPlayer:this.secondPlayer);d(this,"main",async()=>{console.info("main start!"),this.coin=Math.random()>.5,this.priorityHolder=this.firstPlayer,this.log.info("【デュエル開始】"),this.log.info(`先攻：${this.firstPlayer.profile.name}`),Object.values(this.duelists).forEach(e=>e.pushDeck()),Object.values(this.duelists).forEach(e=>e.shuffleDeck()),await Promise.all(Object.values(this.duelists).map(e=>e.draw(5,void 0,void 0))),this.moveNextPhase("draw"),this.view.requireUpdate();try{for(;!this.isEnded&&(this.phase==="draw"?await this.procDrawPhase():this.phase==="standby"?await this.procStanbyPhase():this.phase==="main1"?await this.procMainPhase():this.phase==="battle"?await this.procBattlePhase():this.phase==="main2"?await this.procMainPhase():this.phase==="end"&&await this.procEndPhase(),!(this.clock.turn>1e3)););}catch(e){e instanceof yt?(console.info(e),this.isEnded=!0,this.log.info(e.winner?`デュエル終了。勝者${e.winner.profile.name}`:"引き分け")):e instanceof Error&&this.log.error(e)}finally{this.view.requireUpdate(),this.view.dispose(),this.log.dispose()}});d(this,"moveNextPhase",e=>{this.clock.turn<1?this.phase="draw":e==="draw"?this.log.info("ターン終了。",this.getTurnPlayer()):this.log.info(`フェイズ移行（${this.phase}→${e}）`,this.getTurnPlayer()),e==="draw"?this.clock.incrementTurn():this.clock.incrementPhaseSeq(),this.phase=e,this.phaseStep=void 0,this.phase==="main2"||this.clock.turn===1?this.nextPhaseList=["end"]:this.phase==="battle"?this.nextPhaseList=["main2"]:this.phase==="main1"?this.nextPhaseList=["battle","end"]:this.nextPhaseList=[]});d(this,"declareAnAttack",(e,t)=>{this.attackingMonster=e,this.targetForAttack=t,e.status.attackCount++,this.log.info(`攻撃宣言：${e.status.name} ⇒ ${t.status.name}`,e.controller)});d(this,"procDrawPhase",async()=>{for(Object.values(this.duelists).forEach(e=>{e.normalSummonCount=0,e.specialSummonCount=0}),this.log.info("ドローフェイズ開始。",this.getTurnPlayer()),this.clock.turn===1?this.log.info("先攻プレイヤーはドローできない。",this.getTurnPlayer()):await this.getTurnPlayer().draw(1,void 0,void 0);await this.procChainBlock(););this.field.getMonstersOnField().forEach(e=>{e.status.attackCount=0,e.status.battlePotisionChangeCount=0}),this.moveNextPhase("standby")});d(this,"procStanbyPhase",async()=>{for(;await this.procChainBlock(););this.moveNextPhase("main1")});d(this,"procMainPhase",async()=>{for(;;){this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["NormalSummon","SpellTrapSet","SpecialSummon","ChangeBattlePosition","IgnitionEffect","QuickEffect","CardActivation"],["Normal","Quick","Counter"]),"あなたの手番です。");if(console.log(e),e.action){if([...Hs].includes(e.action.playType)){const i=await e.action.prepare(e.action.cell,!0);if(!i)continue;await e.action.execute(this.priorityHolder,e.action.cell,i),this.clock.incrementChainSeq()}else console.log(e),await this.procChainBlock(e.action);for(;await this.procChainBlock(););continue}const t=e.phaseChange;if(t){if(this.priorityHolder=this.getNonTurnPlayer(),await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect","TriggerEffect"],["Quick","Counter"]),"",!0)){this.procChainBlock();continue}this.moveNextPhase(t);return}}});d(this,"procBattlePhase",async()=>{await this.procBattlePhaseStartStep(),await this.procBattlePhaseBattleStep(),await this.procBattlePhaseEndStep()});d(this,"procBattlePhaseStartStep",async()=>{for(this.phaseStep="start",this.priorityHolder=this.getTurnPlayer(),this.attackingMonster=void 0,this.targetForAttack=void 0;await this.procChainBlock(););});d(this,"procBattlePhaseBattleStep",async()=>{for(;;){this.phaseStep="battle",this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["Battle"],["Normal"]),"攻撃モンスターと対象を選択。");if(e.phaseChange)break;if(e.action){for(await e.action.execute(this.priorityHolder,e.action.cell),this.clock.incrementChainSeq();await this.procChainBlock(););this.clock.incrementStepSeq(),await this.procBattlePhaseDamageStep()}}this.clock.incrementStepSeq()});d(this,"procBattlePhaseDamageStep",async()=>{this.phaseStep="damage";const e=this.attackingMonster,t=this.targetForAttack;if(!e||!e.atk)throw new Ve("想定されない状態",this.attackingMonster,this.targetForAttack);this.log.info("ダメージステップ開始時",this.getTurnPlayer()),this.log.info("ダメージ計算前",this.getTurnPlayer()),(t==null?void 0:t.battlePotion)==="Set"&&t.setBattlePosition("Defense"),this.log.info("ダメージ計算時",this.getTurnPlayer());const i=e.atk,a=((t==null?void 0:t.battlePotion)==="Attack"?t.atk:t==null?void 0:t.def)||0;!t||t.entityType==="Duelist"?e.controller.getOpponentPlayer().battleDamage(i-a,e):i>0&&i>a?(t.battlePotion==="Attack"&&e.controller.getOpponentPlayer().battleDamage(i-a,e),t.info.isDying=!0):i<a?(e.controller.battleDamage(a-i,t),t.battlePotion==="Attack"&&(e.info.isDying=!0)):i===a&&t.battlePotion==="Attack"&&(e.info.isDying=!0,t.info.isDying=!0);const s=Object.values(this.duelists).filter(o=>o.lp<=0);if(s.length>0)throw new yt(Object.values(this.duelists).filter(o=>!s.includes(o)).pop());t&&e.info.isDying&&t.info.isDying&&e.owner!==t.owner?await Promise.all([e.destroy("BattleDestroy",[],t,t==null?void 0:t.controller),t.destroy("BattleDestroy",[],e,e.controller)]):(e.info.isDying&&await e.destroy("BattleDestroy",[],t,t==null?void 0:t.controller),t!=null&&t.info.isDying&&await t.destroy("BattleDestroy",[],e,e.controller)),this.log.info("ダメージ計算後",this.getTurnPlayer()),this.log.info("ダメージステップ終了時",this.getTurnPlayer()),this.clock.incrementStepSeq()});d(this,"procBattlePhaseEndStep",async()=>{for(this.phaseStep="end",this.priorityHolder=this.getTurnPlayer();await this.procChainBlock(););this.moveNextPhase("main2")});d(this,"procEndPhase",async()=>{for(;await this.procChainBlock(););for(;;){const t=this.getTurnPlayer().getHandCell().cardEntities.length;if(t<7)break;await this.getTurnPlayer().discard(t-6,["Rule"])}this.moveNextPhase("draw")});d(this,"procChainBlock",async(e,t)=>{const i=this.clock.chainBlockSeq===0;let a;console.log(t==null?void 0:t.length);let s=t??Object.values(this.duelists).flatMap(o=>(this.priorityHolder=o,this.getEnableActions(["TriggerMandatoryEffect","TriggerEffect"],["Normal"])));console.log(s.length);try{if(e)return a=e,!0;if(s.length>0){const k=await this.selectTriggerEffect(s);if(k)return console.log(s.length),s=s.filter(p=>p!==k),console.log(s.length),a=k,!0}let o=0;for(;o<2;){this.priorityHolder=this.priorityHolder.getOpponentPlayer();const k=await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect"],["Normal","Quick","Counter"]),"クイックエフェクト発動タイミング。効果を発動しますか？",!0);if(k)return a=k,!0;o++}return!1}finally{if(console.log(a),a){const o=a.entity.controller;a.playType==="CardActivation"?this.log.info(`${a.entity.nm}を発動`,o):this.log.info(`${a.entity.nm}«${a.title}»を発動`,o);const k=await a.prepare(a.cell);this.clock.incrementProcSeq(),this.clock.incrementChainBlockSeq(),await this.procChainBlock(void 0,s.filter(p=>p.seq!==(a==null?void 0:a.seq))),this.log.info(`${a.entity.nm}«${a.title}»の効果処理`,o),await a.execute(o,a.cell,k),this.clock.incrementProcSeq(),i&&(await Promise.all(this.field.getAllCells().filter(p=>p.cellType==="SpellAndTrapZone").flatMap(p=>p.entities).filter(p=>p.info.isDying).map(p=>p.sendToGraveyard(["Rule"],void 0,void 0))),this.clock.incrementChainSeq())}}});d(this,"selectTriggerEffect",async e=>{if(e.length>0)for(const t of["TriggerMandatoryEffect","TriggerEffect"])for(const i of[this.getTurnPlayer(),this.getNonTurnPlayer()]){this.priorityHolder=i;const a=e.filter(o=>o.playType===t&&o.entity.controller===i);if(a.length===0)continue;if(a.length===1&&t==="TriggerMandatoryEffect")return console.log(a[0]),a[0];const s=await this.view.waitQuickEffect(a,"効果を選択。",t==="TriggerEffect");if(s)return s}});d(this,"getEnableActions",(e,t)=>this.field.getAllCardEntities().filter(i=>i.controller===this.priorityHolder).flatMap(i=>i.actions).filter(i=>i.executableCells.includes(i.entity.fieldCell.cellType)).filter(i=>e.includes(i.playType)).filter(i=>t.includes(i.spellSpeed)).filter(i=>i.validate()));this.phase="end",this.clock=new Zs,this.nextPhaseList=[],this.isEnded=!1,this.duelists={Below:new Ki(this,"Below",e,t,i),Above:new Ki(this,"Above",a,s,o)},this.priorityHolder=this.firstPlayer,this.field=new Ws(this),this.view=new Os(this),this.log=new Ls(this),this.cardActionLog=new Us(this)}get firstPlayer(){return this.coin?this.duelists.Below:this.duelists.Above}get secondPlayer(){return this.coin?this.duelists.Above:this.duelists.Below}}const $s=()=>{const n=[],e={title:"特殊召喚",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:r=>{const l=r.field.getMonstersOnField();if(l.length==0||l.some(w=>w.controller===r.controller))return;const u=r.controller.getAvailableMonsterZones();return u.length>0?u:void 0},prepare:async()=>!0,execute:async(r,l,u)=>{const w=r.controller.getAvailableMonsterZones();return await r.field.summon(r,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Rule"],r,void 0,!0),r.controller.specialSummonCount++,!0}},t={name:"サイバー・ドラゴン",actions:[dt,$e,je,e]};n.push(t);const i={name:"アンノウン・シンクロン",actions:[dt,$e,je,{...e,isOnlyNTimesPerDuel:1}]};n.push(i);const a={name:"Ｄ－ＨＥＲＯ ディアボリックガイ",actions:[dt,$e,je,{title:"①リクルート",playType:"IgnitionEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:r=>r.controller.getDeckCell().cardEntities.filter(u=>u.nm==="Ｄ－ＨＥＲＯ ディアボリックガイ").length===0?void 0:r.controller.getAvailableMonsterZones().length>0?[]:void 0,prepare:async r=>{console.log(r),await r.banish(["Cost"],r,r.controller)},execute:async(r,l,u)=>{const w=r.controller.getAvailableMonsterZones();if(!w.length)return!1;const C=r.controller.getDeckCell().cardEntities.find(v=>v.nm==="Ｄ－ＨＥＲＯ ディアボリックガイ");return C?(await r.field.summon(C,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],r),r.controller.specialSummonCount++,!0):!1}}]};n.push(a);const s={name:"ゾンビキャリア",actions:[dt,$e,je,{title:"①自己再生",playType:"IgnitionEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:r=>{if(r.controller.getHandCell().cardEntities.length===0)return;const l=r.controller.getAvailableMonsterZones();return l.length>0?l:void 0},prepare:async r=>{const l=r.controller.getHandCell().cardEntities,u=await r.controller.duel.view.waitSelectEntities(r.controller,l,1,w=>w.length===1,"デッキトップに戻すカードを一枚選択。");if(!u)throw new Ve("キャンセル不可の行動がキャンセルされた。",r);return await u[0].returnToDeck("Top",["Cost"],r,r.controller),!0},execute:async(r,l,u)=>{if(l.duel.clock.isSameChain(r.wasMovedAt))return!1;const w=r.controller.getAvailableMonsterZones();return w.length===0?!1:(await r.field.summon(r,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],r),r.info.willBeBanished=!0,r.controller.specialSummonCount++,!0)}}]};n.push(s);const o={name:"グローアップ・バルブ",actions:[dt,$e,je,{title:"①自己再生",playType:"IgnitionEffect",spellSpeed:"Normal",executableCells:["Graveyard"],isOnlyNTimesPerDuel:1,validate:r=>{if(r.controller.getDeckCell().cardEntities.length===0)return;const l=r.controller.getAvailableMonsterZones();return l.length>0?l:void 0},prepare:async r=>(await r.controller.getDeckCell().cardEntities[0].sendToGraveyard(["Cost"],r,r.controller),!0),execute:async(r,l,u)=>{if(l.duel.clock.isSameChain(r.wasMovedAt))return!1;const w=r.controller.getAvailableMonsterZones();return w.length===0?!1:(await r.field.summon(r,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],r,l),r.info.willBeBanished=!0,r.controller.specialSummonCount++,!0)}}]};n.push(o);const k={name:"終末の騎士",actions:[dt,$e,je,{title:"①墓地送り",playType:"TriggerEffect",spellSpeed:"Normal",executableCells:["MonsterZone"],validate:r=>{if(r.wasMovedAs.union(["SpecialSummon","NormalSummon"]).length!==0&&r.field.duel.clock.isPreviousChain(r.wasMovedAt)&&r.controller.getDeckCell().cardEntities.filter(l=>l.attr.includes("Dark")).length!==0)return[]},prepare:()=>!0,execute:async(r,l)=>{const u=r.controller.getDeckCell().cardEntities.filter(w=>w.attr.includes("Dark"));return u.length===0?!1:(await r.field.sendToGraveyard("墓地に送るモンスターを選択",l,u,1,w=>w.length===1,["Effect"],r,!1),l.shuffleDeck(),!0)}}]};n.push(k);const p={name:"マスマティシャン",actions:[dt,$e,je,{title:"①墓地送り",playType:"TriggerEffect",spellSpeed:"Normal",executableCells:["MonsterZone"],validate:r=>{if(r.wasMovedAs.includes("NormalSummon")&&r.field.duel.clock.isPreviousChain(r.wasMovedAt)&&!r.controller.getDeckCell().cardEntities.filter(l=>(l.lvl??5)<5))return[]},prepare:()=>!0,execute:async(r,l)=>{const u=r.controller.getDeckCell().cardEntities.filter(w=>(w.lvl??5)<5);return u.length===0?!1:(await r.field.sendToGraveyard("墓地に送るモンスターを選択",l,u,1,w=>w.length===1,["Effect"],r,!1),l.shuffleDeck(),!0)}},{title:"②ドロー",playType:"TriggerEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:r=>{if(r.wasMovedAs.includes("BattleDestroy")&&r.field.duel.clock.isPreviousChain(r.wasMovedAt)&&r.controller.getDeckCell().cardEntities.length!==0)return[]},prepare:()=>!0,execute:async(r,l)=>(await l.draw(1,r,l),!0)}]};n.push(p);const c={name:"大地の騎士ガイアナイト",actions:[$e,je,Si()]};n.push(c),n.push({...c,name:"スクラップ・デスデーモン"});const m={name:"ナチュル・ガオドレイク",actions:[$e,je,Si(r=>r.length===1&&r.every(l=>l.attr.some(u=>u==="Earth")),r=>r.length>0&&r.every(l=>l.attr.some(u=>u==="Earth")))]};n.push(m),console.log(n);const f={name:"ライトロード・ビースト ウォルフ",actions:[$e,je,{title:"①自己再生",playType:"TriggerMandatoryEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:r=>{var u;if(!r.field.duel.clock.isPreviousChain(r.wasMovedAt)||((u=r.wasMovedFrom)==null?void 0:u.cellType)!=="Deck")return;const l=r.controller.getAvailableMonsterZones();return console.log(l),l.length>0?[]:void 0},prepare:async r=>(console.log(r),!0),execute:async(r,l,u)=>{if(l.duel.clock.isSameChain(r.wasMovedAt))return!1;const w=r.controller.getAvailableMonsterZones();return!w.length||r.fieldCell.cellType!=="Graveyard"&&r.fieldCell.cellType!=="Banished"||r.face==="FaceDown"?!1:(await r.field.summon(r,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],r),r.controller.specialSummonCount++,!0)}}]};return n.push(f),console.log(n),n},js=()=>{const n=[],e={name:"強欲な壺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(!(r.controller.getDeckCell().cardEntities.length<2))return Te(r)},prepare:xe,execute:async(r,l)=>(await l.draw(2,r,l),!0)},Ee]};n.push(e);const t={name:"貪欲な壺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(!(r.controller.getGraveyard().cardEntities.filter(l=>l.status.kind==="Monster").length<5))return Te(r)},prepare:async(r,l)=>{const u=await r.field.duel.view.waitSelectEntities(r.controller,r.controller.getGraveyard().cardEntities.filter(w=>w.status.kind==="Monster"),5,w=>w.length===5,"デッキに戻すモンスターを選択。",!1);if(u)return await xe(r,l),u},execute:async(r,l,u,w)=>{if(w.some(v=>l.duel.clock.isSameChain(v.wasMovedAt)))return!1;const C=[];for(const v of w){const y=await v.returnToDeck("Top",["Effect"],r,l);y&&C.push(y)}return C.getDistinct().filter(v=>v.cellType==="Deck").forEach(v=>v.shuffle()),await l.draw(2,r,l),!0}},Ee]};n.push(t);const i={name:"天使の施し",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(!(r.controller.getDeckCell().cardEntities.length<3))return Te(r)},prepare:xe,execute:async(r,l)=>(await l.draw(3,r,l),await l.discard(2,["Effect","Discard"],r,l),!0)},Ee]};n.push(i);const a={name:"成金ゴブリン",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(!(r.controller.getDeckCell().cardEntities.length<1))return Te(r)},prepare:xe,execute:async(r,l)=>(await l.draw(1,r,l),r.field.duel.clock.incrementProcSeq(),l.getOpponentPlayer().heal(1e3,r),!0)},Ee]};n.push(a);const s={name:"おろかな埋葬",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(r.controller.getDeckCell().cardEntities.filter(l=>l.status.kind==="Monster").length!==0)return Te(r)},prepare:xe,execute:async(r,l)=>{const u=l.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster");if(u.length===0)return!1;const w=await r.field.duel.view.waitSelectEntities(l,u,1,C=>C.length===1,"墓地に送るモンスターを選択",!1);for(const C of w??[])await C.sendToGraveyard(["Effect"],r,l);return await l.shuffleDeck(),!0}},Ee]};n.push(s);const o={name:"おろかな副葬",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],isOnlyNTimesPerTurn:1,validate:r=>{if(r.controller.getDeckCell().cardEntities.filter(l=>l.status.kind!=="Monster").length!==0)return Te(r)},prepare:xe,execute:async(r,l)=>{const u=l.getDeckCell().cardEntities.filter(C=>C.status.kind!=="Monster");if(u.length===0)return!1;const w=await r.field.duel.view.waitSelectEntities(l,u,1,C=>C.length===1,"墓地に送る魔法罠を選択",!1);for(const C of w??[])await C.sendToGraveyard(["Effect"],r,l);return await l.shuffleDeck(),!0}},Ee]};n.push(o);const k={name:"死者蘇生",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:r=>{if(r.field.getCells("Graveyard").flatMap(l=>l.cardEntities).filter(l=>l.status.kind==="Monster"&&l.info.isRebornable).length!==0&&r.controller.getAvailableMonsterZones().length!==0)return Te(r)},prepare:async(r,l)=>{const u=await r.field.duel.view.waitSelectEntities(r.controller,r.field.getCells("Graveyard").flatMap(w=>w.cardEntities).filter(w=>w.origin.kind==="Monster"&&w.info.isRebornable),1,w=>w.length===1,"蘇生対象とするモンスターを選択",!1);return await xe(r,l),u==null?void 0:u[0]},execute:async(r,l,u,w)=>{const C=l.getEmptyMonsterZones();return w.controller=l,await r.field.summon(w,["Attack","Defense"],C,"SpecialSummon",["Effect"],r,void 0,!1),r.controller.specialSummonCount++,!0}},Ee]};n.push(k);const p={name:"手札抹殺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(!(r.controller.getDeckCell().cardEntities.length<r.controller.getHandCell().cardEntities.filter(l=>l.seq!==r.seq).length)&&r.field.getAllCells().filter(l=>l.cellType==="Hand").flatMap(l=>l.cardEntities).filter(l=>l.seq!==r.seq).length!==0)return Te(r)},prepare:xe,execute:async(r,l)=>{const u=l.getHandCell().cardEntities.length,w=l.getOpponentPlayer().getHandCell().cardEntities.length;return await r.field.sendGraveyardAtSameTime(r.field.getCells("Hand").flatMap(C=>C.cardEntities),["Effect","Discard"],r,l),l.duel.clock.incrementProcSeq(),await r.field.drawAtSameTime(l,u,l.getOpponentPlayer(),w,r,l),!0}},Ee]};n.push(p);const c={name:"光の援軍",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(!(r.controller.getDeckCell().cardEntities.length<4)&&r.controller.getDeckCell().cardEntities.filter(l=>l.status.kind==="Monster").filter(l=>(l.lvl??13)<5).filter(l=>l.status.nameTags&&l.status.nameTags.includes("ライトロード")).length!==0)return Te(r)},prepare:async(r,l)=>{const u=r.controller.getDeckCell();return Array(3).forEach(()=>u.cardEntities[0].sendToGraveyard(["Cost"],r,r.controller)),await xe(r,l)},execute:async(r,l)=>{const u=l.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster").filter(C=>(C.lvl??13)<5).filter(C=>C.status.nameTags&&C.status.nameTags.includes("ライトロード"));if(u.length===0)return!1;const w=await r.field.duel.view.waitSelectEntities(l,u,1,C=>C.length===1,"手札に加えるモンスターを選択",!1);for(const C of w??[])await C.addToHand(["Effect"],r,l);return!0}},Ee]};n.push(c);const m={name:"調律",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{const l=r.controller.getDeckCell().cardEntities;if(!(l.length<2)&&l.filter(u=>{var w;return(w=u.status.nameTags)==null?void 0:w.includes("シンクロン")}).filter(u=>{var w;return(w=u.status.monsterCategories)==null?void 0:w.includes("Tuner")}).length!==0)return Te(r)},prepare:xe,execute:async(r,l)=>{const u=l.getDeckCell().cardEntities;if(u.length<2)return;const w=u.filter(v=>{var y;return(y=v.status.nameTags)==null?void 0:y.includes("シンクロン")}).filter(v=>{var y;return(y=v.status.monsterCategories)==null?void 0:y.includes("Tuner")});if(w.length===0)return!1;const C=await r.field.duel.view.waitSelectEntities(l,w,1,v=>v.length===1,"手札に加えるモンスターを選択",!1);for(const v of C??[])await v.addToHand(["Effect"],r,l);return l.duel.clock.incrementProcSeq(),l.getDeckCell().shuffle(),await l.getDeckCell().cardEntities[0].sendToGraveyard(["Effect"],r,l),!0}},Ee]};n.push(m);const f={name:"ワン・フォー・ワン",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:r=>{if(r.controller.getDeckCell().cardEntities.filter(l=>l.lvl===1).length===0){if(r.controller.getHandCell().cardEntities.filter(l=>l.lvl===1).length===0||r.controller.getHandCell().cardEntities.filter(l=>l.status.kind==="Monster").length<2)return}else if(r.controller.getHandCell().cardEntities.filter(l=>l.status.kind==="Monster").length===0)return;return Te(r)},prepare:async(r,l)=>{let u=r.controller.getHandCell().cardEntities.filter(C=>C.status.kind==="Monster");if(r.controller.getDeckCell().cardEntities.filter(C=>C.lvl===1).length===0){const C=r.controller.getHandCell().cardEntities.filter(v=>v.lvl===1);C.length===1&&(u=u.filter(v=>v!==C[0]))}if(await r.field.sendToGraveyard("墓地送るモンスターを選択",r.controller,u,1,C=>C.length===1,["Cost"],r,!0))return await xe(r,l)},execute:async(r,l)=>{const u=[...r.controller.getDeckCell().cardEntities.filter(C=>C.lvl===1),...r.controller.getHandCell().cardEntities.filter(C=>C.lvl===1)];if(u.length===0)return!1;const w=await r.field.duel.view.waitSelectEntities(l,u,1,C=>C.length===1,"特殊召喚するモンスターを選択",!1);if(!w)throw new Error("illegal state");return await r.field.summon(w[0],["Attack","Defense"],l.getAvailableMonsterZones(),"SpecialSummon",["Effect"],r,l,!1),!0}},Ee]};return n.push(f),[{name:"増援",filter:r=>r.origin.kind==="Monster"&&r.origin.type==="Warrior"&&(r.origin.level??5)<5},{name:"化石調査",filter:r=>r.origin.kind==="Monster"&&r.origin.type==="Dinosaur"&&(r.origin.level??6)<6},{name:"Ｅ－エマージェンシーコール",filter:r=>r.origin.kind==="Monster"&&(r.origin.nameTags??[]).includes("Ｅ・ＨＥＲＯ")},{name:"召集の聖刻印",filter:r=>r.origin.kind==="Monster"&&(r.origin.nameTags??[]).includes("聖刻")},{name:"召喚師のスキル",filter:r=>r.origin.kind==="Monster"&&(r.origin.monsterCategories??[]).includes("Normal")&&(r.origin.level??4)>4},{name:"トゥーンのもくじ",filter:r=>(r.origin.nameTags??[]).includes("トゥーン")},{name:"融合賢者",filter:r=>r.origin.name==="融合"},{name:"虹の架け橋",filter:r=>r.origin.kind!=="Monster"&&(r.origin.nameTags??[]).includes("宝玉")},{name:"紫炎の狼煙",filter:r=>r.origin.kind==="Monster"&&(r.origin.nameTags??[]).includes("六武衆")&&(r.origin.level??4)<4},{name:"テラ・フォーミング",filter:r=>r.origin.kind==="Spell"&&r.origin.spellCategory==="Field"},{name:"コール・リゾネーター",filter:r=>r.origin.kind==="Monster"&&(r.origin.nameTags??[]).includes("リゾネーター")}].forEach(r=>{n.push({name:r.name,actions:[Ns(r.filter),Ee]})}),[{name:"戦士の生還",filter:r=>r.status.kind==="Monster"&&r.type.includes("Warrior"),qty:1},{name:"ダーク・バースト",filter:r=>r.status.kind==="Monster"&&r.attr.includes("Dark")&&(r.atk??9999)<=1500,qty:1},{name:"悪夢再び",filter:r=>r.status.kind==="Monster"&&r.attr.includes("Dark")&&(r.def??9999)===0,qty:2},{name:"サルベージ",filter:r=>r.status.kind==="Monster"&&r.attr.includes("Water")&&(r.atk??9999)<=1500,qty:2},{name:"バッテリーリサイクル",filter:r=>r.status.kind==="Monster"&&r.type.includes("Thunder")&&(r.atk??9999)<=1500,qty:2},{name:"闇の量産工場",filter:r=>r.status.kind==="Monster"&&(r.status.monsterCategories??[]).includes("Normal"),qty:2}].forEach(r=>{n.push({name:r.name,actions:[bs(r.filter,r.qty),Ee]})}),[{name:"トレード・イン",filter:r=>r.status.kind==="Monster"&&(r.lvl??0)===8},{name:"調和の宝札",filter:r=>r.status.kind==="Monster"&&(r.origin.monsterCategories??[]).includes("Tuner")&&r.type.includes("Dragon")&&(r.atk??9999)<=1e3},{name:"デステニー・ドロー",filter:r=>r.status.kind==="Monster"&&(r.origin.nameTags??[]).includes("Ｄ－ＨＥＲＯ")}].forEach(r=>{n.push({name:r.name,actions:[_s(r.filter),Ee]})}),[{name:"火の粉",calcHeal:()=>[0,-200]},{name:"雷鳴",calcHeal:()=>[0,-300]},{name:"ファイヤー・ボール",calcHeal:()=>[0,-500]},{name:"火あぶりの刑",calcHeal:()=>[0,-600]},{name:"昼夜の大火事",calcHeal:()=>[0,-800]},{name:"火炎地獄",calcHeal:()=>[-500,-1e3]},{name:"盗人ゴブリン",calcHeal:()=>[500,-500]},{name:"ブルー・ポーション",calcHeal:()=>[400,0]},{name:"レッド・ポーション",calcHeal:()=>[500,0]},{name:"ゴブリンの秘薬",calcHeal:()=>[600,0]},{name:"天使の生き血",calcHeal:()=>[800,0]},{name:"治療の神 ディアン・ケト",calcHeal:()=>[1e3,0]},{name:"恵みの雨",calcHeal:()=>[1e3,1e3]}].forEach(r=>{n.push({name:r.name,actions:[Fs(r.calcHeal),Ee]})}),n},Ys=()=>{const n=[...$s(),...js()];return console.log(n),n},Na=new Map;Ys().forEach(n=>{Na.set(n.name,n.actions)});const Xn=Na,zs=ls,be=Object.values(zs).reduce((n,e)=>(n[e.name]=e,n),{}),se=class se{constructor(e,t){d(this,"id");d(this,"name");d(this,"description");d(this,"lastUsedAt");d(this,"cardNames");d(this,"getIllegalCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(be).includes(e)))));d(this,"getDisableCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(be).includes(e)))));d(this,"createCardInfos",()=>{const e=this.getIllegalCardNames();if(e.length>0)throw new Error(`存在しないカード名からデッキを生成しようとした。${e}`);return this.cardNames.map(t=>be==null?void 0:be[t]).filter(t=>t)});d(this,"copy",async()=>se.createNewDeck(this.name,this.description,this.cardNames));d(this,"updateTimestamp",async()=>{await se.tblHeader.update(this.id,e=>({...e,lastUsedAt:new Date}))});d(this,"saveDeckInfo",async e=>{const t=e??this;await se.tblHeader.update(this.id,s=>({...s,name:t.name,description:t.description}));const i=(await se.tblDetail.getAll()).filter(s=>s.deckId===this.id);console.log(t.cardNames),await se.tblDetail.delete(i.map(s=>s.id));const a=await se.tblDetail.insertMany(t.cardNames.map((s,o)=>({deckId:this.id,seq:o,name:s,description:""})));return console.log(a),new se(await se.tblHeader.get(this.id),a)});d(this,"delete",async()=>{await se.tblHeader.delete([this.id]);const e=(await se.tblDetail.getAll()).filter(t=>t.deckId===this.id);await se.tblDetail.delete(e.map(t=>t.id))});this.id=e.id,this.name=e.name,this.description=e.description,this.lastUsedAt=e.lastUsedAt,this.cardNames=t.filter(i=>i.deckId===this.id).map(i=>i.name)}};d(se,"idb"),d(se,"tblHeader"),d(se,"tblDetail"),d(se,"getAllDeckInfo",async e=>{if(e&&(se.idb=e),!se.idb)throw new Error("illegal argument: idb is undefined.");se.tblHeader||(se.tblHeader=new Gs(se.idb)),se.tblDetail||(se.tblDetail=new Vs(se.idb));const t=await se.tblHeader.getAll(),i=await se.tblDetail.getAll();return t.length?t.map(a=>new se(a,i)):[await se.prepareSampleDeck()]}),d(se,"createNewDeck",async(e,t,i)=>{const a=await se.tblHeader.insert({name:e,description:t,lastUsedAt:new Date}),s=await se.tblDetail.insertMany(i.map((o,k)=>({deckId:a.id,seq:k,name:o,description:""})));return new se(a,s)}),d(se,"prepareSampleDeck",async()=>await se.createNewDeck(kn[0].name,kn[0].description,kn[0].cardNames));let vt=se;class Gs extends ki{constructor(t){super(t,"TblDeckHeader");d(this,"_prepareInitialRecords",()=>[])}}class Vs extends ki{constructor(t){super(t,"TblDeckDetail");d(this,"_prepareInitialRecords",()=>[])}}let Qs=-1,Gt=["おろかな埋葬","成金ゴブリン","強欲な壺","天使の施し","増援","トレード・イン","調和の宝札","死者蘇生","召喚師のスキル","サイバー・ドラゴン","Ｄ－ＨＥＲＯ ディアボリックガイ","ライトロード・ビースト ウォルフ","ナチュル・ガオドレイク","スクラップ・デスデーモン","大地の騎士ガイアナイト","青眼の白龍"];Gt=[...Gt,...Gt,...Gt,"Ｅ－エマージェンシーコール","闇の量産工場","戦士の生還","トレード・イン","ジェネティック・ワーウルフ","ジョングルグールの幻術師","ゾンビーノ","フロストザウルス","しゃりの軍貫","チューン・ウォリアー","貪欲な壺","ガード・オブ・フレムベル","ギャラクシーサーペント","ハロハロ","ラブラドライドラゴン","守護竜ユスティア","Ｅ・ＨＥＲＯ クレイマン","Ｅ・ＨＥＲＯ スパークマン","Ｅ・ＨＥＲＯ ネオス","Ｅ・ＨＥＲＯ バーストレディ","Ｅ・ＨＥＲＯ フェザーマン"];const kn=[{id:Qs--,name:"サンプルデッキ１",description:"",lastUsedAt:new Date,cardNames:Gt}];function Xs(n){const e=n-1;return e*e*e+1}function Wi(n,e){for(const t in e)n[t]=e[t];return n}function Js({fallback:n,...e}){const t=new Map,i=new Map;function a(o,k,p){const{delay:c=0,duration:m=z=>Math.sqrt(z)*30,easing:f=Xs}=Wi(Wi({},e),p),r=o.getBoundingClientRect(),l=k.getBoundingClientRect(),u=r.left-l.left,w=r.top-l.top,C=r.width/l.width,v=r.height/l.height,y=Math.sqrt(u*u+w*w),T=getComputedStyle(k),_=T.transform==="none"?"":T.transform,q=+T.opacity;return{delay:c,duration:typeof m=="function"?m(y):m,easing:f,css:(z,ie)=>`
			   opacity: ${z*q};
			   transform-origin: top left;
			   transform: ${_} translate(${ie*u}px,${ie*w}px) scale(${z+(1-z)*C}, ${z+(1-z)*v});
		   `}}function s(o,k,p){return(c,m)=>(o.set(m.key,c),()=>{if(k.has(m.key)){const f=k.get(m.key);return k.delete(m.key),a(f,c,m)}return o.delete(m.key),n&&n(c,m,p)})}return[s(i,t,!1),s(t,i,!0)]}var eo=b("<div></div>"),to=b('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>'),no=b('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div> <div class="svelte-1y7jo5c"> </div></div>'),io=b('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div> <div class="svelte-1y7jo5c"> </div></div>'),ao=b('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>'),ro=b('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div></div> <div class="duel_card_row duel_card_row_wide svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>',1),so=b('<button><div class="duel_card duel_card_face_up svelte-1y7jo5c"><div class="duel_card_row svelte-1y7jo5c" style="position:relative"><div class="svelte-1y7jo5c"> </div> <!></div> <!> <!> <!></div></button>'),oo=b('<div class="duel_card duel_card_face_down duel_card_face_down_defense svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div></div>'),Ao=b('<div class="duel_card duel_card_face_down svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div></div>');function at(n,e){Fe(e,!1);let t=fe(e,"entity",8),i=fe(e,"state",8,"Disabled"),a=fe(e,"selectedList",28,()=>[]),s=fe(e,"isVisibleForcibly",8,!1),o=fe(e,"isWideMode",8,!1),k=fe(e,"actions",24,()=>[]),p=fe(e,"cardActionResolve",8),c=fe(e,"entitySelectResolve",8,()=>{}),m=Ce(!1),f=()=>{},r=fe(e,"qty",12,void 0);const l=B=>{ee(m,!1),r(B.qty),f=B.resolve};t().field.duel.view.onWaitStart.append(l);let u=Ce(!1);const w=()=>{if(i()!=="Disabled"&&(console.log(r()),i()==="Selectable"&&r()&&r()===1)){if(a().some(B=>B.seq!==t().seq)){a([t()]);return}r()&&r()===1&&c()&&c()([t()])}},C=()=>{(t().face==="FaceUp"||t().owner===t().field.duel.duelists.Below&&(t().isUnderControl||s()))&&t().field.duel.view.showCardInfo(t())},v=()=>{if(console.log(t(),i()),C(),i()==="Disabled")return;if(i()==="Selectable"){ee(m,!A(m)),a(A(m)?[...a(),t()]:a().filter(O=>O!==t()));return}if(k().length===0)return;if(k().length===1){if(k()[0].dragAndDropOnly)return;if(p()){p()(k()[0]);return}console.log(k()[0],f),f({action:k()[0]});return}const B=t().field.duel.view;B.modalController.selectAction(B,{title:"行動を選択。",actions:k(),cancelable:!0}).then(O=>{f({action:O})})},y=B=>{console.info("drag start",B,k()),t().field.duel.view.setDraggingActions(k()),ee(u,!0)},T=B=>{console.info("drag end",B,k()),t().field.duel.view.removeDraggingActions(),B.dataTransfer&&ee(u,!1)};Ze();var _=he(),q=te(_);{var z=B=>{var O=so(),re=h(O),Ae=h(re),pe=h(Ae),ue=h(pe),X=D(pe,2);me(X,1,()=>t().attr,ke,(S,P)=>{var K=eo();W(()=>we(K,`monster_attr ${A(P)??""} svelte-1y7jo5c`)),g(S,K)});var x=D(Ae,2);{var I=S=>{var P=to(),K=h(P),j=h(K),Y=D(K,2),U=h(Y);W(($,ae)=>{F(j,$),F(U,ae)},[()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0)],ge),g(S,P)},ne=S=>{var P=he(),K=te(P);{var j=U=>{var $=no(),ae=D(h($),2),J=h(ae);W(()=>F(J,`${an[t().status.spellCategory]??""}魔法`)),g(U,$)},Y=U=>{var $=he(),ae=te($);{var J=M=>{var E=io(),V=D(h(E),2),N=h(V);W(()=>F(N,`${rn[t().status.trapCategory]??""}罠`)),g(M,E)};L(ae,M=>{t().status.kind==="Trap"&&t().status.trapCategory&&M(J)},!0)}g(U,$)};L(K,U=>{t().status.kind==="Spell"&&t().status.spellCategory?U(j):U(Y,!1)},!0)}g(S,P)};L(x,S=>{t().status.kind==="Monster"?S(I):S(ne,!1)})}var Z=D(x,2);{var Q=S=>{var P=ao(),K=h(P),j=h(K),Y=D(K,2),U=h(Y);W(()=>{F(j,`◀ ${t().psL??""}`),F(U,`${t().psR??""} ▶`)}),g(S,P)};L(Z,S=>{var P;(P=t().status.monsterCategories)!=null&&P.includes("Pendulum")&&S(Q)})}var H=D(Z,2);{var G=S=>{var P=ro(),K=te(P),j=h(K),Y=h(j),U=D(K,2),$=h(U),ae=h($),J=D($,2),M=h(J);W((E,V,N)=>{Dt(j,"title",E),F(Y,V),F(ae,N),F(M,`${t().atk??"?"} / ${t().def??"?"}`)},[()=>{var E;return(E=t().status.monsterCategories)==null?void 0:E.join(" ")},()=>{var E;return(E=t().status.monsterCategories)==null?void 0:E.map(V=>nn[V]+(o()?Fn[V]:"")).join()},()=>t().type.map(E=>sn[E]+(o()?Hn[E]:"")).join()],ge),g(S,P)};L(H,S=>{t().status.kind==="Monster"&&S(G)})}W(S=>{we(O,`duel_card button_style_reset ${t().status.kind??""} ${S??""} ${(A(m)?"duel_card_selected":"")??""} ${i()??""} duel_card_${t().orientation??""} ${(A(u)?"isDragging":"")??""} ${(o()?"duel_card_wide":"")??""} svelte-1y7jo5c`),Dt(O,"draggable",i()==="Draggable"),Dt(O,"title",t().nm),F(ue,t().nm)},[()=>{var S;return((S=t().status.monsterCategories)==null?void 0:S.join(" "))||""}],ge),ye("dragstart",O,y),ye("dragend",O,T),ye("click",O,v),ye("dblclick",O,w),ye("mouseenter",O,C),g(B,O)},ie=B=>{var O=he(),re=te(O);{var Ae=ue=>{var X=oo();g(ue,X)},pe=ue=>{var X=Ao();g(ue,X)};L(re,ue=>{t().battlePotion==="Set"?ue(Ae):ue(pe,!1)},!0)}g(B,O)};L(q,B=>{t().face==="FaceUp"||s()||t().controller.seat==="Below"&&t().isUnderControl?B(z):B(ie,!1)})}g(n,_),He()}var lo=b('<div class="phase_display svelte-1mupj1p"><span class="svelte-1mupj1p"> </span> </div>'),po=b('<div class="lifepoint_display svelte-1mupj1p"><div class="svelte-1mupj1p"> </div> <div class="svelte-1mupj1p"> </div></div>'),co=(n,e,t)=>e(A(t)),ko=b('<div class="svelte-1mupj1p"><button class="phase_button svelte-1mupj1p"> </button></div>'),mo=b("<div><!></div>"),uo=b('<div class="svelte-1mupj1p"><!></div>'),ho=b("<div><!></div>"),fo=b("<!> <!> <!>",1),wo=b('<div style="position: absolute;" class="card_animation_receiver svelte-1mupj1p"><!></div>'),Co=b('<div style="position: absolute; display:flex;justify-content: center;" class="svelte-1mupj1p"><!></div>'),Do=b('<div style="position: absolute; bottom:0rem" class="svelte-1mupj1p"> </div>'),go=b("<!> <!>",1),yo=b('<div class="badge svelte-1mupj1p"> </div>'),vo=b('<div class="card_animation_receiver svelte-1mupj1p"><!></div>'),Bo=b("<!> <!> <!> <!>",1),Eo=b('<td><div role="listitem"><!></div></td>');function To(n,e){Fe(e,!1);let t=fe(e,"view",8),i=fe(e,"row",8),a=fe(e,"column",8),s=fe(e,"selectedList",28,()=>[]),o=Ce(t().getCell(i(),a()));const k=()=>{ee(o,t().getCell(i(),a()))};A(o).onUpdate.append(k),t().onDuelUpdate.append(k),t().modalController.onUpdate.append(k);let p=Ce([]),c=()=>{},m;const f=x=>{ee(y,void 0),s().reset(),c=x.resolve,ee(p,x.enableActions),m=x.selectableEntities,x.entitiesValidator};t().onWaitStart.append(f);let r,l=Ce(!1);const u=x=>{r=x,ee(l,x.some(I=>{var ne;return(ne=I.validate())==null?void 0:ne.includes(A(o))})||!1),k()},w=()=>{r=void 0,ee(l,!1),k()};t().onDragStart.append(u),t().onDragEnd.append(w);const[C,v]=oA;let y=Ce(void 0);const T=x=>{if(A(o)===x.to||A(o).entities.includes(x.entity)){console.log(x),ee(y,x);const I=x.resolve;ee(o,A(o)),setTimeout(()=>{ee(y,void 0),x.count++,x.count>1&&I()},600)}};t().onAnimation.append(T);const _=x=>{console.info(x),c({phaseChange:x})},q=()=>(A(o).cellType==="Deck"||A(o).cellType==="ExtraDeck"||A(o).cellType==="Graveyard"||A(o).cellType==="Banished")&&A(o).entities.flatMap(x=>x.actions).filter(x=>A(p).map(I=>I.seq).some(I=>I===x.seq)).length>0,z=()=>{if(Ke(o,A(o).field.duel.view.infoBoardState="Log"),A(o).cellType==="Deck"||A(o).cellType==="ExtraDeck"||A(o).cellType==="Graveyard"||A(o).cellType==="Banished"){Ke(o,A(o).field.duel.view.infoBoardState="CellInfo"),Ke(o,A(o).field.duel.view.infoBoardCell=A(o)),A(o).field.duel.view.requireUpdate();const x=A(o).entities.flatMap(I=>I.actions).filter(I=>A(p).map(ne=>ne.seq).some(ne=>ne===I.seq));if(console.log(A(p)),console.log(x),x.length){const I=A(o).field.duel.view;I.modalController.selectAction(I,{title:"カードを選択。",actions:x,cancelable:!0}).then(ne=>{c({action:ne})});return}}A(o).field.duel.view.requireUpdate(),console.info(A(o))},ie=x=>{x.preventDefault(),x.dataTransfer&&(x.dataTransfer.dropEffect="move")},B=x=>{x.preventDefault(),console.info("drop",x,A(l),r),x.dataTransfer&&(x.dataTransfer.dropEffect="move");try{A(l)&&r&&(console.info(r,A(o)),r.length===1?c({action:{...r[0],cell:A(o)}}):r.length>1&&(A(o).field.duel.view.modalController.cancelAll(),A(o).field.duel.view.modalController.selectAction(A(o).field.duel.view,{title:"選択",actions:r,cancelable:!1})))}finally{t().removeDraggingActions()}},O=(...x)=>{if(m&&m.find(Z=>x.find(Q=>Z===Q)))return"Selectable";if(!A(p)||A(p).length===0||t().waitMode!=="SelectFieldAction"||Object.values(t().modalController.states).some(Z=>Z==="Shown"))return"Disabled";const I=A(p).filter(Z=>x.includes(Z.entity));if(I.length===0)return"Disabled";if(I.length>1)return"Clickable";if(A(p)[0].playType==="RuleDraw")return"Draggable";if(["Deck","ExtraDeck","Graveyard","Banished"].includes(A(o).cellType)||I[0].entity!==x[0])return"Clickable";const ne=I[0].validate();return ne&&ne.length>0?"Draggable":"Clickable"};Ze();var re=Eo(),Ae=h(re);Ae.__click=z;var pe=h(Ae);{var ue=x=>{var I=he(),ne=te(I);{var Z=Q=>{var H=he(),G=te(H);{var S=K=>{var j=lo(),Y=h(j),U=h(Y),$=D(Y,1,!0);W((ae,J)=>{F(U,ae),F($,J)},[()=>String(A(o).field.duel.clock.turn).padStart(2,"0"),()=>A(o).field.duel.phase.toUpperCase()],ge),g(K,j)},P=K=>{var j=he(),Y=te(j);{var U=ae=>{var J=po(),M=h(J),E=h(M),V=D(M,2),N=h(V);W(()=>{F(E,A(o).field.duel.duelists.Above.lp),F(N,A(o).field.duel.duelists.Below.lp)}),g(ae,J)},$=ae=>{var J=he(),M=te(J);{var E=V=>{var N=he(),R=te(N);{var oe=le=>{var Ie=he(),ft=te(Ie);{var xt=tt=>{var nt=he(),jt=te(nt);me(jt,1,()=>t().duel.nextPhaseList,ke,(Yt,Mt)=>{var ze=ko(),Ge=h(ze);Ge.__click=[co,_,Mt];var Nt=h(Ge);W(bt=>F(Nt,bt),[()=>A(Mt).toUpperCase()],ge),g(Yt,ze)}),g(tt,nt)};L(ft,tt=>{t().duel.isEnded||tt(xt)})}g(le,Ie)};L(R,le=>{t().waitMode==="SelectFieldAction"&&le(oe)})}g(V,N)};L(M,V=>{A(o).column===5&&V(E)},!0)}g(ae,J)};L(Y,ae=>{A(o).column===3?ae(U):ae($,!1)},!0)}g(K,j)};L(G,K=>{A(o).column===1?K(S):K(P,!1)})}g(Q,H)};L(ne,Q=>{A(o).row===3&&Q(Z)})}g(x,I)},X=x=>{var I=he(),ne=te(I);{var Z=H=>{var G=fo(),S=te(G);{var P=U=>{var $=mo(),ae=h($);at(ae,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),W(()=>we($,`card_animation_receiver ${A(o).cellType??""} svelte-1mupj1p`)),Ht(1,$,()=>v,()=>({key:A(y).entity.seq})),g(U,$)};L(S,U=>{A(y)&&A(y).entity&&A(y).to===A(o)&&A(y).index==="Top"&&U(P)})}var K=D(S,2);me(K,1,()=>A(o).cardEntities,ke,(U,$)=>{var ae=he(),J=te(ae);{var M=E=>{var V=uo(),N=h(V);const R=ge(()=>O(A($))),oe=ge(()=>A(p).filter(le=>le.entity===A($)));at(N,{get entity(){return A($)},get state(){return A(R)},get actions(){return A(oe)},cardActionResolve:void 0,get selectedList(){return s()},set selectedList(le){s(le)},$$legacy:!0}),Ht(2,V,()=>C,()=>({key:A($).seq})),g(E,V)};L(J,E=>{(!A(y)||A(y).entity.seq!==A($).seq)&&E(M)})}g(U,ae)});var j=D(K,2);{var Y=U=>{var $=ho(),ae=h($);at(ae,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),W(()=>we($,`card_animation_receiver ${A(o).cellType??""} svelte-1mupj1p`)),Ht(1,$,()=>v,()=>({key:A(y).entity.seq})),g(U,$)};L(j,U=>{A(y)&&A(y).entity&&A(y).to===A(o)&&A(y).index==="Bottom"&&U(Y)})}g(H,G)},Q=H=>{var G=Bo(),S=te(G);{var P=J=>{var M=wo(),E=h(M);at(E,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Ht(1,M,()=>v,()=>({key:A(y).entity.seq})),g(J,M)};L(S,J=>{A(y)&&A(y).entity&&A(y).to===A(o)&&A(y).index==="Bottom"&&J(P)})}var K=D(S,2);{var j=J=>{var M=go(),E=te(M);me(E,1,()=>A(o).cardEntities.toReversed(),ke,(R,oe,le)=>{var Ie=he(),ft=te(Ie);{var xt=tt=>{var nt=Co(),jt=h(nt);const Yt=ge(()=>le===0&&Pi.every(ze=>ze!==A(o).cellType)?O(...A(o).cardEntities):void 0),Mt=ge(()=>le===0?A(p).filter(ze=>A(o).cardEntities.includes(ze.entity)):void 0);at(jt,{get entity(){return A(oe)},get state(){return A(Yt)},get actions(){return A(Mt)},cardActionResolve:void 0,get selectedList(){return s()},set selectedList(ze){s(ze)},$$legacy:!0}),Ht(2,nt,()=>C,()=>({key:A(oe).seq})),g(tt,nt)};L(ft,tt=>{(!A(y)||A(y).entity.seq!==A(oe).seq)&&tt(xt)})}g(R,Ie)});var V=D(E,2);{var N=R=>{var oe=Do(),le=h(oe);W(()=>F(le,`【${(A(o).cardEntities[0].battlePotion==="Attack"?"攻撃表示":A(o).cardEntities[0].battlePotion==="Defense"?"表守備表示":"裏守備表示")??""}】`)),g(R,oe)};L(V,R=>{A(o).cardEntities[0].battlePotion&&R(N)})}g(J,M)};L(K,J=>{A(o).cardEntities.length>0&&J(j)})}var Y=D(K,2);{var U=J=>{var M=yo(),E=h(M);W(()=>F(E,A(o).cardEntities.length)),g(J,M)};L(Y,J=>{Pi.find(M=>M===A(o).cellType)&&J(U)})}var $=D(Y,2);{var ae=J=>{var M=vo(),E=h(M);at(E,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Ht(1,M,()=>v,()=>({key:A(y).entity.seq})),g(J,M)};L($,J=>{A(y)&&A(y).entity&&A(y).to===A(o)&&A(y).index==="Top"&&J(ae)})}g(H,G)};L(ne,H=>{A(o).cellType==="Hand"?H(Z):H(Q,!1)},!0)}g(x,I)};L(pe,x=>{A(o).cellType==="Disable"?x(ue):x(X,!1)})}W(x=>{we(re,`${`duel_field_cell duel_field_cell_${A(o).cellType}`??""} svelte-1mupj1p`),Dt(re,"colspan",A(o).cellType==="Hand"?7:1),we(Ae,`${x??""} svelte-1mupj1p`)},[()=>`duel_card_wrapper ${A(o).cellType} ${A(l)?"can_accept_drop":""} ${q()?"can_action":""}`],ge),ye("dragover",Ae,x=>ie(x)),ye("drop",Ae,x=>B(x)),g(n,re),He()}ci(["click"]);var xo=b('<tr><td style=" white-space: nowrap;text-align: center;"> </td><td class="svelte-13svkzh"> </td></tr>'),Mo=b('<div class="duel_log svelte-13svkzh"><table><tbody></tbody></table></div>');function No(n,e){var p,c;Fe(e,!1);let t=Ce(void 0),i=fe(e,"log",12);const a=()=>{i(i()),br().then(()=>A(t)&&A(t).scroll(0,A(t).clientHeight*10))};(c=(p=i())==null?void 0:p.onUpdate)==null||c.append(a),Ze();var s=Mo(),o=h(s),k=h(o);me(k,5,()=>i().records,ke,(m,f)=>{var r=xo(),l=h(r),u=h(l),w=D(l),C=h(w);W(()=>{var v,y;we(l,`duelist ${((v=A(f).duelist)==null?void 0:v.seat)??""} svelte-13svkzh`),F(u,((y=A(f).duelist)==null?void 0:y.profile.name)||"SYSTEM"),F(C,A(f).text)}),g(m,r)}),ts(s,m=>ee(t,m),()=>A(t)),g(n,s),He()}const bo=n=>new Promise(e=>setTimeout(e,n));var _o=b('<div><div class="duelist_name svelte-12u0sqq"> </div> <div> </div></div>');function Li(n,e){Fe(e,!1);let t=fe(e,"duelist",12),i=Ce(0),a=Ce();const s=async()=>{const r=t().lp-A(i);if(!A(a)||Math.abs(r)<10){ee(i,t().lp),A(a)&&(A(a)(),ee(a,void 0));return}ee(i,A(i)+Math.floor(Math.random()*r)),await bo(100),s()},o=()=>{t(t()),!A(a)&&t().lp!==A(i)&&new Promise(r=>{ee(a,r),Math.abs(t().lp-A(i)),s()})};t().duel.log.onUpdate.append(o),s(),Ze();var k=_o(),p=h(k),c=h(p),m=D(p,2),f=h(m);W(()=>{we(k,`duelist ${t().seat??""} svelte-12u0sqq`),F(c,t().profile.name),we(m,`duelist_lp ${(A(a)?"vibration":"")??""} svelte-12u0sqq`),F(f,A(i))}),g(n,k),He()}const Fo=()=>{};var Ho=b("<div><!></div>"),So=b("<div></div>"),Ko=(n,e,t)=>e.resolve(A(t)),Po=(n,e)=>e.resolve(void 0),qo=b('<button class="svelte-1h1of0m">Cancel</button>'),Wo=b('<div class="base svelte-1h1of0m"><button class="overlay svelte-1h1of0m">☆</button> <div class="window svelte-1h1of0m"><div> </div> <!> <div><button class="svelte-1h1of0m">OK</button> <!></div></div></div>');function Lo(n,e){Fe(e,!0);let t=pr(ct([]));var i=he(),a=te(i);{var s=o=>{var k=Wo(),p=h(k);p.__click=[Fo];var c=D(p,2),m=h(c),f=h(m),r=D(m,2);me(r,17,()=>e.entities.map(v=>v.controller.seat).getDistinct(),ke,(v,y)=>{var T=So();me(T,21,()=>e.entities.filter(_=>_.controller.seat===A(y)),ke,(_,q)=>{var z=Ho(),ie=h(z);at(ie,{get entity(){return A(q)},isVisibleForcibly:!0,state:"Selectable",entitySelectResolve:B=>e.resolve(B),get qty(){return e.qty},cardActionResolve:void 0,get selectedList(){return A(t)},set selectedList(B){ee(t,ct(B))}}),g(_,z)}),W(()=>we(T,`entities_list ${A(y)??""} svelte-1h1of0m`)),g(v,T)});var l=D(r,2),u=h(l);u.__click=[Ko,e,t];var w=D(u,2);{var C=v=>{var y=qo();y.__click=[Po,e],g(v,y)};L(w,v=>{e.cancelable&&v(C)})}W(v=>{F(f,e.title),u.disabled=v},[()=>!e.validator(A(t))]),g(o,k)};L(a,o=>{o(s)})}g(n,i),He()}ci(["click"]);const Ro=(n,e)=>{e.cancelable&&e.resolve(void 0)};var Oo=b('<div class="duel_card_wrapper svelte-11mc7y0"><!> <div> </div></div>'),Zo=(n,e)=>e.resolve(),Uo=b('<div><button class="cancel_button svelte-11mc7y0">Cancel</button></div>'),Io=b('<div><button>★</button> <div><div> </div> <div class="flex svelte-11mc7y0"></div> <!></div></div>');function $o(n,e){Fe(e,!0);const[t,i]=rs(),a=()=>as(s,"$isDragging",t);let s=ns(!1);const o=()=>s.set(!0),k=()=>s.set(!1);e.view.onDragStart.append(o),e.view.onDragEnd.append(k);const p=r=>{const l=r.validate();return l&&l.length>0?"Draggable":"Clickable"};var c=he(),m=te(c);{var f=r=>{var l=Io(),u=h(l);u.__click=[Ro,e];var w=D(u,2),C=h(w),v=h(C),y=D(C,2);me(y,21,()=>e.actions,ke,(q,z)=>{var ie=Oo(),B=h(ie);const O=Bt(()=>p(A(z))),re=Bt(()=>e.dragAndDropOnly?[]:[A(z)]);at(B,{get entity(){return A(z).entity},isVisibleForcibly:!0,get state(){return A(O)},get actions(){return A(re)},get cardActionResolve(){return e.resolve}});var Ae=D(B,2),pe=h(Ae);W(()=>F(pe,`«${A(z).title??""}»`)),g(q,ie)});var T=D(y,2);{var _=q=>{var z=Uo(),ie=h(z);ie.__click=[Zo,e],g(q,z)};L(T,q=>{e.cancelable&&q(_)})}W(()=>{we(l,`${`base ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(u,`${`overlay ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(w,`${`window ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),F(v,e.title)}),g(r,l)};L(m,r=>{r(f)})}g(n,c),He(),i()}ci(["click"]);var jo=b('<div class="base svelte-1y912d"><!> <!></div>');function Yo(n,e){var c,m;Fe(e,!1);let t=fe(e,"modalController",12);const i=()=>{t(t())};(m=(c=t())==null?void 0:c.onUpdate)==null||m.append(i),Ze();var a=jo(),s=h(a);{var o=f=>{Lo(f,{get title(){return t().duelEntitiesSelectorArg.title},get entities(){return t().duelEntitiesSelectorArg.entities},get validator(){return t().duelEntitiesSelectorArg.validator},get qty(){return t().duelEntitiesSelectorArg.qty},get cancelable(){return t().duelEntitiesSelectorArg.cancelable},resolve:r=>{t().duelEntitiesSelectorResolve(r)}})};L(s,f=>{t().states.DuelEntitiesSelector==="Shown"&&f(o)})}var k=D(s,2);{var p=f=>{const r=ge(()=>t().cardActionSelectorArg.dragAndDropOnly??!1);$o(f,{get view(){return t().view},get title(){return t().cardActionSelectorArg.title},get actions(){return t().cardActionSelectorArg.actions},get dragAndDropOnly(){return A(r)},get cancelable(){return t().cardActionSelectorArg.cancelable},resolve:l=>{console.info(l),t().cardActionSelectorResolve(l)}})};L(k,f=>{t().states.DuelActionSelector==="Shown"&&f(p)})}g(n,a),He()}var zo=b('<div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div> <div class="duel_card_info_row svelte-1qhzdl0" style=" justify-content: space-between;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div>',1),Go=b('<div></div> <div class="svelte-1qhzdl0"> </div>',1),Vo=b("<div> </div>"),Qo=b("<div> </div>"),Xo=b('<div class="duel_card_info_row svelte-1qhzdl0"><!> <!></div> <div class="duel_card_info_row svelte-1qhzdl0"></div>',1),Jo=b('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),eA=b('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),tA=b('<div><div class="duel_card_info_header svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"> </div></div> <div class="duel_card_info_row svelte-1qhzdl0" style="position:sticky; top:0;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div> <!> <!></div> <div class="duel_card_info_body svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div></div> <div class="duel_card_info_footer svelte-1qhzdl0"><div class="duel_card_info_links svelte-1qhzdl0"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1qhzdl0">⇒遊戯王カードWiki</a> <a target="_blank" rel="noopener noreferrer" title="コナミカードデータベース" class="svelte-1qhzdl0"> </a></div></div></div>');function nA(n,e){Fe(e,!1);let t=fe(e,"entity",8,void 0);const i=()=>t()?be[t().origin.name]:void 0,a=()=>{var p;return t()&&(t().origin.cardId??!1)?`https://www.db.yugioh-card.com/yugiohdb/card_search.action?ope=2&cid=${t().origin.cardId}`:`https://www.db.yugioh-card.com/yugiohdb/card_search.action?ope=1&sess=1&rp=10&mode=&sort=1&keyword=${(p=i())==null?void 0:p.name}&stype=1&ctype=&othercon=2&starfr=&starto=&pscalefr=&pscaleto=&linkmarkerfr=&linkmarkerto=&link_m=2&atkfr=&atkto=&deffr=&defto=&releaseDStart=1&releaseMStart=1&releaseYStart=1999&releaseDEnd=&releaseMEnd=&releaseYEnd=`};Ze();var s=he(),o=te(s);{var k=p=>{var c=tA(),m=h(c),f=h(m),r=h(f),l=h(r),u=D(f,2),w=h(u),C=h(w),v=D(w,2),y=h(v),T=D(u,2);{var _=Z=>{var Q=zo(),H=te(Q),G=h(H),S=h(G),P=h(S),K=D(H,2),j=h(K),Y=h(j),U=D(j,2),$=h(U);W(()=>{F(P,be[t().origin.name].pendulumDescription),F(Y,`◀ ${t().psL??""}`),F($,`${t().psR??""} ▶`)}),g(Z,Q)};L(T,Z=>{var Q;(Q=t().status.monsterCategories)!=null&&Q.includes("Pendulum")&&Z(_)})}var q=D(T,2);{var z=Z=>{var Q=Xo(),H=te(Q),G=h(H);me(G,1,()=>t().attr,ke,(j,Y)=>{var U=Go(),$=te(U),ae=D($,2),J=h(ae);W(()=>{we($,`monster_attr ${A(Y)??""} svelte-1qhzdl0`),F(J,`${mi[A(Y)]??""}属性`)}),g(j,U)});var S=D(G,2);{var P=j=>{var Y=Vo(),U=h(Y);W(()=>{we(Y,`monster_cat ${t().status.type??""} svelte-1qhzdl0`),F(U,`${sn[t().status.type]??""}${Hn[t().status.type]??""}族`)}),g(j,Y)};L(S,j=>{t().status.type&&j(P)})}var K=D(H,2);me(K,5,()=>t().status.monsterCategories??[],ke,(j,Y)=>{var U=Qo(),$=h(U);W(()=>{we(U,`monster_cat ${A(Y)??""} svelte-1qhzdl0`),F($,`${nn[A(Y)]??""}${Fn[A(Y)]??""}`)}),g(j,U)}),g(Z,Q)},ie=Z=>{var Q=he(),H=te(Q);{var G=P=>{var K=Jo(),j=D(h(K),2),Y=h(j);W(()=>F(Y,`${an[t().status.spellCategory]??""}魔法`)),g(P,K)},S=P=>{var K=he(),j=te(K);{var Y=U=>{var $=eA(),ae=D(h($),2),J=h(ae);W(()=>F(J,`${rn[t().status.trapCategory]??""}罠`)),g(U,$)};L(j,U=>{t().status.kind==="Trap"&&t().status.trapCategory&&U(Y)},!0)}g(P,K)};L(H,P=>{t().status.kind==="Spell"&&t().status.spellCategory?P(G):P(S,!1)},!0)}g(Z,Q)};L(q,Z=>{t().status.kind==="Monster"?Z(z):Z(ie,!1)})}var B=D(m,2),O=h(B),re=h(O),Ae=h(re),pe=h(Ae),ue=D(B,2),X=h(ue),x=h(X),I=D(x,2),ne=h(I);W((Z,Q,H,G,S,P)=>{var K;we(c,`duel_card duel_card_info ${t().origin.kind??""} ${Z??""} svelte-1qhzdl0`),F(l,t().nm),F(C,Q),F(y,H),F(pe,G),Dt(x,"href",S),Dt(I,"href",P),F(ne,`⇒${((K=t())!=null&&K.origin.cardId?"公式カードページ":"公式で検索")??""}`)},[()=>{var Z;return(Z=t().origin.monsterCategories)==null?void 0:Z.join(" ")},()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0),()=>{var Z;return(Z=i())==null?void 0:Z.description},()=>{var Z;return(Z=i())==null?void 0:Z.wikiHref},a],ge),g(p,c)};L(o,p=>{t()&&p(k)})}g(n,s),He()}var iA=b('<div class="duel_field_cell_info_item svelte-1xj7qf1"><!></div>'),aA=b('<div class="duel_field_cell_info_box svelte-1xj7qf1"><div class="duel_field_cell_info_label svelte-1xj7qf1"> </div> <!></div>'),rA=b('<div class="duel_field_cell_info svelte-1xj7qf1"><div class="duel_field_cell_info_header item_btn svelte-1xj7qf1"><div class="svelte-1xj7qf1"> </div> <div class="svelte-1xj7qf1"> </div></div> <div class="duel_field_cell_info_body svelte-1xj7qf1"></div></div>');function sA(n,e){Fe(e,!1);let t=fe(e,"cell",12);const i=()=>{t(t())},a=r=>t().cardEntities.filter(l=>l.face===r);t().field.duel.view.onDuelUpdate.append(i),Ze();var s=rA(),o=h(s),k=h(o),p=h(k),c=D(k,2),m=h(c),f=D(o,2);me(f,4,()=>["FaceUp","FaceDown"],ke,(r,l)=>{var u=he(),w=te(u);{var C=v=>{var y=aA(),T=h(y),_=h(T),q=D(T,2);me(q,1,()=>a(l).toSorted(Ps),ke,(z,ie)=>{var B=iA(),O=h(B);const re=ge(()=>t().owner===t().field.duel.duelists.Below);at(O,{get entity(){return A(ie)},get isVisibleForcibly(){return A(re)},isWideMode:!0,cardActionResolve:void 0}),g(z,B)}),W(()=>F(_,l==="FaceUp"?"表向き":"裏向き")),g(v,y)};L(w,v=>{a(l).length&&v(C)})}g(r,u)}),W(()=>{var r;F(p,(r=t().owner)==null?void 0:r.profile.name),F(m,t().cellType)}),g(n,s),He()}const oA=Js({duration:400});var AA=b('<div class="duel_field_header_message svelte-accyye"> </div> <div class="duel_field_header_buttons svelte-accyye"><button class="svelte-accyye">サレンダー</button></div>',1),lA=b("<tr></tr>"),dA=b('<table class="duel_field svelte-accyye"><tbody class="svelte-accyye"></tbody></table>'),pA=b('<button class="svelte-accyye">OK</button>'),cA=b('<div style="position:absolute;right:0;top:0"> </div> <div class="flex duel_desk svelte-accyye"><div class="duel_desk_left v_flex svelte-accyye"><!> <!> <!></div> <div class=" duel_desk_center v_flex svelte-accyye"><div class="duel_field_header svelte-accyye"><!></div> <div class="svelte-accyye"><!></div> <div class="duel_field_footer svelte-accyye"><!></div></div> <div class=" duel_desk_right svelte-accyye" style="text-align: left;"><!></div></div> <!>',1);function kA(n,e){Fe(e,!1);let t=fe(e,"duel",12),i=()=>{},a=Ce(()=>!0),s=Ce();const o=H=>{i=H.resolve,ee(a,H.entitiesValidator),ee(s,H.selectableEntities),H.duelEntitiesSelectorArg&&t().view.modalController.selectDuelEntities(H.duelEntitiesSelectorArg).then(G=>{i({selectedEntities:G})})};t().view.onWaitStart.append(o);let k=Ce(void 0);const p=H=>{ee(k,H)};t().view.onShowCardEntity.append(p);let c=fe(e,"selectedList",28,()=>[]);const m=()=>{t(t())};t().view.onDuelUpdate.append(m);const f=()=>{A(a)(c())&&i({selectedEntities:c()})},r=()=>{i({surrender:!0})};t().main(),Ze();var l=cA(),u=te(l),w=h(u),C=D(u,2),v=h(C),y=h(v);Li(y,{get duelist(){return t().duelists.Above}});var T=D(y,2);nA(T,{get entity(){return A(k)}});var _=D(T,2);Li(_,{get duelist(){return t().duelists.Below}});var q=D(v,2),z=h(q),ie=h(z);{var B=H=>{var G=AA(),S=te(G),P=h(S),K=D(S,2),j=h(K);W(()=>F(P,`[TURN:${t().clock.turn}][PHASE:${t().phase}] ${t().view.message}`)),ye("click",j,r),g(H,G)};L(ie,H=>{t().isEnded||H(B)})}var O=D(z,2),re=h(O);{var Ae=H=>{var G=dA(),S=h(G);me(S,5,()=>t().field.cells,ke,(P,K,j)=>{var Y=lA();we(Y,`${`duel_desk_row_${j}`??""} svelte-accyye`),me(Y,5,()=>A(K),ke,(U,$,ae)=>{To(U,{get view(){return t().view},row:j,column:ae,get selectedList(){return c()},set selectedList(J){c(J)},$$legacy:!0})}),g(P,Y)}),g(H,G)};L(re,H=>{t().clock.turn>0&&H(Ae)})}var pe=D(O,2),ue=h(pe);{var X=H=>{var G=pA();W(S=>G.disabled=S,[()=>!A(a)(c())],ge),ye("click",G,f),g(H,G)};L(ue,H=>{A(s)&&A(s).length>0&&H(X)})}var x=D(q,2),I=h(x);{var ne=H=>{No(H,{get log(){return t().log}})},Z=H=>{var G=he(),S=te(G);{var P=K=>{sA(K,{get cell(){return t().view.infoBoardCell}})};L(S,K=>{t().view.infoBoardState==="CellInfo"&&K(P)},!0)}g(H,G)};L(I,H=>{t().view.infoBoardState==="Log"?H(ne):H(Z,!1)})}var Q=D(C,2);Yo(Q,{get modalController(){return t().view.modalController}}),W(H=>F(w,H),[()=>t().clock.toString()],ge),g(n,l),He()}var mA=b("<div></div>"),uA=b('<span> </span> / <span style="display: inline-block;width:2rem;text-align: right;"> </span>',1),hA=b('<li class="deck_editor_item svelte-vivzk2"><div role="listitem"><div class="svelte-vivzk2"><div class="svelte-vivzk2"> </div> <div style="display:flex" class="svelte-vivzk2"><div class="svelte-vivzk2"><!> <!> <!> <!> <!> <!> <!></div> <div style="flex-grow: 1; width:0.1rem" class="svelte-vivzk2"></div> <div class="svelte-vivzk2"><!></div></div></div></div> <button class="button_style_reset svelte-vivzk2">+</button> <button class="button_style_reset svelte-vivzk2">-</button></li>'),fA=b('<div class="deck_editor_card_kind svelte-vivzk2"><span class="svelte-vivzk2"> </span> <ul class="svelte-vivzk2"></ul></div>'),wA=b('<div class="deck_editor_deck_type svelte-vivzk2"><span class="svelte-vivzk2"> </span> <!></div>'),CA=b('<div class="deck_editor_card_list svelte-vivzk2"></div>');function Ri(n,e){Fe(e,!1);let t=fe(e,"allCardInfos",8),i=fe(e,"deckCardInfos",12),a=fe(e,"mode",8),s=fe(e,"onAttention",8);const o={Deck:["Monster","Spell","Trap"],ExtraDeck:["Monster"]},k=(f,r)=>(a()==="List"?t():i()).filter(l=>{var u;return Xn.has(l.name)||((u=l.monsterCategories)==null?void 0:u.includes("Normal"))}).filter(l=>!r||l.kind===r).filter(l=>{var u,w;return!f||f==="Deck"&&!((u=l==null?void 0:l.monsterCategories)!=null&&u.union(Ot).length)||f==="ExtraDeck"&&((w=l==null?void 0:l.monsterCategories)==null?void 0:w.union(Ot).length)}).toSorted(cn),p=(f,r)=>{const l=i().filter(w=>w.name===r.name).length;if(l>2)return;const u=f.shiftKey?3-l:1;u<1||(i().push(...Array(u).fill(r)),i().sort(cn),i(i()))},c=(f,r)=>{let l=0;i(i().filter(u=>u.name!==r.name?!0:(l++,!f.shiftKey&&l>1))),i().sort(cn)};Ze();var m=CA();me(m,5,()=>ks,ke,(f,r)=>{var l=wA(),u=h(l),w=h(u),C=D(u,2);me(C,1,()=>o[A(r)],ke,(v,y)=>{var T=fA(),_=h(T),q=h(_),z=D(_,2);me(z,5,()=>k(A(r),A(y)),ke,(ie,B)=>{var O=hA(),re=h(O),Ae=h(re),pe=h(Ae),ue=h(pe),X=D(pe,2),x=h(X),I=h(x);{var ne=N=>{var R=_t();W(()=>F(R,`★${A(B).level??""}`)),g(N,R)};L(I,N=>{A(B).level&&N(ne)})}var Z=D(I,2);{var Q=N=>{var R=_t();W(()=>F(R,`☆${A(B).rank??""}`)),g(N,R)};L(Z,N=>{A(B).rank&&N(Q)})}var H=D(Z,2);{var G=N=>{var R=mA();W(()=>we(R,`monster_attr ${A(B).attribute??""} svelte-vivzk2`)),g(N,R)};L(H,N=>{A(B).attribute!==void 0&&N(G)})}var S=D(H,2);{var P=N=>{var R=_t();W(()=>F(R,sn[A(B).type])),g(N,R)};L(S,N=>{A(B).type!==void 0&&N(P)})}var K=D(S,2);me(K,1,()=>A(B).monsterCategories??[],ke,(N,R)=>{var oe=_t();W(()=>F(oe,nn[A(R)])),g(N,oe)});var j=D(K,2);{var Y=N=>{var R=_t();W(()=>F(R,`${an[A(B).spellCategory]??""}魔法`)),g(N,R)};L(j,N=>{A(B).spellCategory!==void 0&&N(Y)})}var U=D(j,2);{var $=N=>{var R=_t();W(()=>F(R,`${rn[A(B).trapCategory]??""}罠`)),g(N,R)};L(U,N=>{A(B).trapCategory!==void 0&&N($)})}var ae=D(x,4),J=h(ae);{var M=N=>{var R=uA(),oe=te(R),le=h(oe),Ie=D(oe,2),ft=h(Ie);W(()=>{F(le,A(B).attack),F(ft,A(B).defense??"-")}),g(N,R)};L(J,N=>{A(B).attack!==void 0&&N(M)})}var E=D(re,2),V=D(E,2);W(N=>{we(re,`${N??""} svelte-vivzk2`),F(ue,A(B).name)},[()=>{var N,R;return`deck_editor_card duel_card ${A(B).kind} ${(R=(N=A(B))==null?void 0:N.monsterCategories)==null?void 0:R.join(" ")} ${Xn.has(A(B).name)?"is_implemented":"is_not_implemented"}`}],ge),ye("mouseenter",re,()=>s()(A(B))),ye("click",E,N=>p(N,A(B))),ye("click",V,N=>c(N,A(B))),g(ie,O)}),W(()=>F(q,Ea[A(y)])),g(v,T)}),W(()=>F(w,ms[A(r)])),g(f,l)}),g(n,m),He()}var DA=b('<div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_row svelte-1xf9hqi" style=" justify-content: space-between;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div>',1),gA=b('<div></div> <div class="svelte-1xf9hqi"> </div>',1),yA=b("<div> </div>"),vA=b("<div> </div>"),BA=b('<div class="duel_card_info_row svelte-1xf9hqi"><!> <!></div> <div class="duel_card_info_row svelte-1xf9hqi"></div>',1),EA=b('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),TA=b('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),xA=b('<div><div class="duel_card_info_header svelte-1xf9hqi"><div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"> </div></div> <div class="duel_card_info_row svelte-1xf9hqi" style="position:sticky; top:0;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div></div> <div class="duel_card_info_body svelte-1xf9hqi"><!> <!> <div class="duel_card_info_row description svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_links svelte-1xf9hqi"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1xf9hqi">⇒遊戯王カードWiki</a></div></div></div>');function MA(n,e){Fe(e,!1);let t=fe(e,"cardInfo",8,void 0);const i=()=>t()?be[t().name]:void 0;Ze();var a=he(),s=te(a);{var o=k=>{var p=xA(),c=h(p),m=h(c),f=h(m),r=h(f),l=D(m,2),u=h(l),w=h(u),C=D(u,2),v=h(C),y=D(c,2),T=h(y);{var _=X=>{var x=DA(),I=te(x),ne=h(I),Z=h(ne),Q=h(Z),H=D(I,2),G=h(H),S=h(G),P=D(G,2),K=h(P);W(()=>{F(Q,be[t().name].pendulumDescription),F(S,`◀ ${t().pendulumScaleL??""}`),F(K,`${t().pendulumScaleR??""} ▶`)}),g(X,x)};L(T,X=>{var x;(x=t().monsterCategories)!=null&&x.includes("Pendulum")&&X(_)})}var q=D(T,2);{var z=X=>{var x=BA(),I=te(x),ne=h(I);{var Z=S=>{var P=gA(),K=te(P),j=D(K,2),Y=h(j);W(()=>{we(K,`monster_attr ${t().attribute??""} svelte-1xf9hqi`),F(Y,`${mi[t().attribute]??""}属性`)}),g(S,P)};L(ne,S=>{t().attribute&&S(Z)})}var Q=D(ne,2);{var H=S=>{var P=yA(),K=h(P);W(()=>{we(P,`monster_cat ${t().type??""} svelte-1xf9hqi`),F(K,`${sn[t().type]??""}${Hn[t().type]??""}族`)}),g(S,P)};L(Q,S=>{t().type&&S(H)})}var G=D(I,2);me(G,5,()=>t().monsterCategories??[],ke,(S,P)=>{var K=vA(),j=h(K);W(()=>{we(K,`monster_cat ${A(P)??""} svelte-1xf9hqi`),F(j,`${nn[A(P)]??""}${Fn[A(P)]??""}`)}),g(S,K)}),g(X,x)},ie=X=>{var x=he(),I=te(x);{var ne=Q=>{var H=EA(),G=D(h(H),2),S=h(G);W(()=>F(S,`${an[t().spellCategory]??""}魔法`)),g(Q,H)},Z=Q=>{var H=he(),G=te(H);{var S=P=>{var K=TA(),j=D(h(K),2),Y=h(j);W(()=>F(Y,`${rn[t().trapCategory]??""}罠`)),g(P,K)};L(G,P=>{t().kind==="Trap"&&t().trapCategory&&P(S)},!0)}g(Q,H)};L(I,Q=>{t().kind==="Spell"&&t().spellCategory?Q(ne):Q(Z,!1)},!0)}g(X,x)};L(q,X=>{t().kind==="Monster"?X(z):X(ie,!1)})}var B=D(q,2),O=h(B),re=h(O),Ae=h(re),pe=D(B,2),ue=h(pe);W((X,x,I,ne,Z)=>{we(p,`duel_card duel_card_info ${t().kind??""} ${X??""} svelte-1xf9hqi`),F(r,t().name),F(w,x),F(v,I),F(Ae,ne),Dt(ue,"href",Z)},[()=>{var X;return(X=t().monsterCategories)==null?void 0:X.join(" ")},()=>"★".repeat(t().level||0),()=>"☆".repeat(t().rank||0),()=>{var X;return(X=i())==null?void 0:X.description},()=>{var X;return(X=i())==null?void 0:X.wikiHref}],ge),g(k,p)};L(s,k=>{t()&&k(o)})}g(n,a),He()}const NA={0:{aaa:"日",aaaa:"日曜日",ddd:"Sun",dddd:"Sunday"},1:{aaa:"月",aaaa:"月曜日",ddd:"Mon",dddd:"Monday"},2:{aaa:"火",aaaa:"火曜日",ddd:"Tue",dddd:"Tuesday"},3:{aaa:"水",aaaa:"水曜日",ddd:"Wed",dddd:"Wednesday"},4:{aaa:"木",aaaa:"木曜日",ddd:"Thu",dddd:"Thursday"},5:{aaa:"金",aaaa:"金曜日",ddd:"Fri",dddd:"Friday"},6:{aaa:"土",aaaa:"土曜日",ddd:"Sat",dddd:"Saturday"}};class bA{constructor(){d(this,"DefaultSeparator1","/");d(this,"DefaultSeparator2"," ");d(this,"DefaultSeparator3",":");d(this,"createDate",e=>{if(!e)return;const t=new Date(e);if(!isNaN(t.getTime()))return t});d(this,"createDateOr",(e,t)=>this.createDate(e)||t||new Date);d(this,"truncateDate",e=>{const t=e||new Date;return new Date(t.getFullYear(),t.getMonth(),t.getDate())});d(this,"addDate",(e,t)=>{const i=this.createDateOr(e);return i.setDate(i.getDate()+t),i});d(this,"addMonth",(e,t)=>{const i=this.createDateOr(e);return i.setMonth(i.getMonth()+t),i});d(this,"addYear",(e,t)=>{const i=this.createDateOr(e);return i.setFullYear(i.getFullYear()+t),i});d(this,"getDayOfWeek",(e,t="dddd")=>{const i=this.createDate(e);return i?NA[i.getDay()][t]:""});d(this,"formatToYYYYMMDD",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";const a=i.getFullYear().toString(),s=("0"+(i.getMonth()+1)).slice(-2),o=("0"+i.getDate()).slice(-2);return a+t+s+t+o});d(this,"formatToYYYYMM",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getFullYear().toString(),s=("0"+(i.getMonth()+1)).slice(-2);return a+t+s});d(this,"formatToHHMMSS",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getHours(),s=i.getMinutes(),o=i.getSeconds();return("0"+a).slice(-2)+t+("0"+s).slice(-2)+t+("0"+o).slice(-2)});d(this,"formatToHHMM",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=("0"+i.getHours()).slice(-2),s=("0"+i.getMinutes()).slice(-2);return a+t+s});d(this,"formatToYYYYMMDD_HHMM",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const s=this.createDate(e);return s?this.formatToYYYYMMDD(s,t)+i+this.formatToHHMM(s,a):""});d(this,"formatToYYYYMMDD_HHMMSS",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const s=this.createDate(e);return s?this.formatToYYYYMMDD(s,t)+i+this.formatToHHMMSS(s,a):""})}}const Ue=new bA;Date.prototype.truncateDate=function(){return Ue.truncateDate(this)};Date.prototype.getCloneOr=function(n){return Ue.createDateOr(this,n)};Date.prototype.addDate=function(n){return Ue.addDate(this,n)};Date.prototype.addMonth=function(n){return Ue.addDate(this,n)};Date.prototype.addYear=function(n){return Ue.addDate(this,n)};Date.prototype.getDayOfWeek=function(n="dddd"){return Ue.getDayOfWeek(this,n)};Date.prototype.formatToYYYYMM=function(n){return Ue.formatToYYYYMM(this,n)};Date.prototype.formatToYYYYMMDD=function(n){return Ue.formatToYYYYMMDD(this,n)};Date.prototype.formatToYYYYMMDD_HHMM=function(n,e,t){return Ue.formatToYYYYMMDD_HHMM(this,n,e,t)};Date.prototype.formatToYYYYMMDD_HHMMSS=function(n,e,t){return Ue.formatToYYYYMMDD_HHMMSS(this,n,e,t)};Date.prototype.formatToHHMM=function(n){return Ue.formatToHHMM(this,n)};Date.prototype.formatToHHMMSS=function(n){return Ue.formatToHHMMSS(this,n)};var _A=b('<label><input type="checkbox"> </label>'),FA=b('<label><input type="checkbox"> </label>'),HA=b('<label><input type="checkbox"> <div style="display: inline-block;"></div> </label>'),SA=b('<label><input type="checkbox"> </label>'),KA=b('<label><input type="checkbox"> </label>'),PA=b('<label><input type="checkbox"> </label>'),qA=b("<option> </option>"),WA=b('<div class="deck_editor_body_right_header svelte-rsq0rf"><div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">編集対象</div> <select></select></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">新規名称</div> <input type="text"></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">操作</div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを保存</button></div> <div class="svelte-rsq0rf"></div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを複製</button></div> <div class="svelte-rsq0rf"><button title="shiftキー押下で確認メッセージスキップ" class="svelte-rsq0rf">デッキを削除</button></div></div></div> <!>',1),LA=b("<div>デッキ情報読込中</div>"),RA=b('<div class="deck_editor svelte-rsq0rf"><div class="deck_editor_header"></div> <div class="deck_editor_body svelte-rsq0rf"><div class="deck_editor_body_left svelte-rsq0rf"><div class="deck_editor_search_box svelte-rsq0rf"><div><div>検索条件</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">名称</div> <div class="svelte-rsq0rf"><input type="text" style="width:70%">※ルビには対応していません</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種類</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">モンスター</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">属性</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種族</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">魔法</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">罠</div> <div class="svelte-rsq0rf"></div></div></div> <!></div> <div class="deck_editor_body_center svelte-rsq0rf"><!></div> <div class="deck_editor_body_right svelte-rsq0rf"><!></div></div></div>');function OA(n,e){Fe(e,!1);const t=[],i=[],a=[],s=[],o=[],k=[],p=async()=>{const E=(await A(f)).find(V=>V.id===A(m));E&&ee(l,{...E,cardInfos:E.cardNames.map(V=>be[V])})},c=()=>vt.getAllDeckInfo().then(M=>(M.forEach(E=>console.log(E.id,E.lastUsedAt,E.lastUsedAt.getTime())),console.log(Math.max(...M.map(E=>E.lastUsedAt.getTime()))),ee(m,(M.find(E=>E.lastUsedAt.getTime()===Math.max(...M.map(V=>V.lastUsedAt.getTime())))??M[0]).id),M));let m=Ce(-1),f=Ce(c());A(f).then(p);const r=()=>{ee(f,c()),p()};let l=Ce({id:Number.MIN_VALUE,name:"",description:"",lastUsedAt:new Date,cardInfos:[]}),u=Ce(be.ゾンビーノ);const w=Ce({name:"",cardKinds:[...Vn],monsterCategories:[...Ni].filter(M=>M!=="Normal"&&M!=="Token"),monsterAttributes:[...bi],monsterTypes:[..._i],spellCategories:[...Fi],trapCategories:[...Hi]}),C=()=>Object.values(be).filter(M=>{var E;if(!A(w).cardKinds.includes(M.kind)||A(w).name.trim().length&&!M.name.includes(A(w).name))return!1;if(M.kind==="Monster")return M.attribute&&!A(w).monsterAttributes.includes(M.attribute)||M.type&&!A(w).monsterTypes.includes(M.type)?!1:(E=M.monsterCategories)==null?void 0:E.union(A(w).monsterCategories).length;if(M.kind==="Spell")return M.spellCategory&&A(w).spellCategories.includes(M.spellCategory);if(M.kind==="Trap")return M.trapCategory&&A(w).trapCategories.includes(M.trapCategory)}),v=M=>{ee(u,M)},y=async()=>{const E=(await A(f)).find(V=>V.id===A(m));if(!E)throw new Error("illegal state");return E},T=async()=>{const M=await y();await M.saveDeckInfo({...M,name:A(l).name,cardNames:A(l).cardInfos.map(E=>E.name),lastUsedAt:new Date}),r()},_=async()=>{(await vt.createNewDeck(`デッキ_${new Date().formatToYYYYMMDD_HHMMSS("","","")}`,`コピー日時：${new Date().formatToYYYYMMDD_HHMMSS("-"," ",":")}`,A(l).cardInfos.map(E=>E.name))).saveDeckInfo(),r()},q=async M=>{const E=await y();!M.shiftKey&&!confirm(`デッキ【${E.name}】を削除します。
よろしいですか？`)||(await E.delete(),r())};Ze();var z=RA(),ie=D(h(z),2),B=h(ie),O=h(B),re=D(h(O),2),Ae=D(h(re),2),pe=h(Ae),ue=D(re,2),X=D(h(ue),2);me(X,5,()=>Vn,ke,(M,E)=>{var V=_A(),N=h(V),R,oe=D(N);W(()=>{R!==(R=A(E))&&(N.value=(N.__value=A(E))==null?"":A(E)),F(oe,` ${Ea[A(E)]??""}`)}),St(t,[],N,()=>(A(E),A(w).cardKinds),le=>Ke(w,A(w).cardKinds=le)),g(M,V)});var x=D(ue,2),I=D(h(x),2);me(I,5,()=>Ni,ke,(M,E)=>{var V=FA(),N=h(V),R,oe=D(N);W(()=>{R!==(R=A(E))&&(N.value=(N.__value=A(E))==null?"":A(E)),F(oe,` ${nn[A(E)]??""}${Fn[A(E)]??""}`)}),St(i,[],N,()=>(A(E),A(w).monsterCategories),le=>Ke(w,A(w).monsterCategories=le)),g(M,V)});var ne=D(x,2),Z=D(h(ne),2);me(Z,5,()=>bi,ke,(M,E)=>{var V=HA(),N=h(V),R,oe=D(N,2),le=D(oe);W(()=>{R!==(R=A(E))&&(N.value=(N.__value=A(E))==null?"":A(E)),we(oe,`monster_attr ${A(u).attribute??""} svelte-rsq0rf`),F(le,` ${mi[A(E)]??""}`)}),St(a,[],N,()=>(A(E),A(w).monsterAttributes),Ie=>Ke(w,A(w).monsterAttributes=Ie)),g(M,V)});var Q=D(ne,2),H=D(h(Q),2);me(H,5,()=>_i,ke,(M,E)=>{var V=SA(),N=h(V),R,oe=D(N);W(()=>{R!==(R=A(E))&&(N.value=(N.__value=A(E))==null?"":A(E)),F(oe,` ${sn[A(E)]??""}
                ${Hn[A(E)]??""}`)}),St(s,[],N,()=>(A(E),A(w).monsterTypes),le=>Ke(w,A(w).monsterTypes=le)),g(M,V)});var G=D(Q,2),S=D(h(G),2);me(S,5,()=>Fi,ke,(M,E)=>{var V=KA(),N=h(V),R,oe=D(N);W(()=>{R!==(R=A(E))&&(N.value=(N.__value=A(E))==null?"":A(E)),F(oe,` ${an[A(E)]??""}`)}),St(o,[],N,()=>(A(E),A(w).spellCategories),le=>Ke(w,A(w).spellCategories=le)),g(M,V)});var P=D(G,2),K=D(h(P),2);me(K,5,()=>Hi,ke,(M,E)=>{var V=PA(),N=h(V),R,oe=D(N);W(()=>{R!==(R=A(E))&&(N.value=(N.__value=A(E))==null?"":A(E)),F(oe,` ${rn[A(E)]??""}`)}),St(k,[],N,()=>(A(E),A(w).trapCategories),le=>Ke(w,A(w).trapCategories=le)),g(M,V)});var j=D(O,2);MA(j,{get cardInfo(){return A(u)}});var Y=D(B,2),U=h(Y);const $=ge(C);Ri(U,{mode:"List",get allCardInfos(){return A($)},onAttention:v,get deckCardInfos(){return A(l).cardInfos},set deckCardInfos(M){Ke(l,A(l).cardInfos=M)},$$legacy:!0});var ae=D(Y,2),J=h(ae);$n(J,()=>A(f),M=>{var E=LA();g(M,E)},(M,E)=>{var V=WA(),N=te(V),R=h(N),oe=D(h(R),2);W(()=>{A(m),Ca(()=>{A(E)})}),me(oe,5,()=>A(E),ke,(Ge,Nt)=>{var bt=qA(),ui={},ba=h(bt);W(()=>{ui!==(ui=A(Nt).id)&&(bt.value=(bt.__value=A(Nt).id)==null?"":A(Nt).id),F(ba,A(Nt).name)}),g(Ge,bt)});var le=D(R,2),Ie=D(h(le),2),ft=D(le,2),xt=D(h(ft),2),tt=h(xt),nt=D(xt,4),jt=h(nt),Yt=D(nt,2),Mt=h(Yt),ze=D(N,2);Ri(ze,{mode:"Deck",allCardInfos:[],onAttention:v,get deckCardInfos(){return A(l).cardInfos},set deckCardInfos(Ge){Ke(l,A(l).cardInfos=Ge)},$$legacy:!0}),va(oe,()=>A(m),Ge=>ee(m,Ge)),ye("change",oe,p),Yn(Ie,()=>A(l).name,Ge=>Ke(l,A(l).name=Ge)),ye("click",tt,T),ye("click",jt,_),ye("click",Mt,q),g(M,V)}),Yn(pe,()=>A(w).name,M=>Ke(w,A(w).name=M)),g(n,z),He()}const ZA=["TblDeckHeader","TblDeckDetail","TblDuelistProfile"],UA=3;var IA=b("<option> </option>"),$A=b('<div class="svelte-bc2zvv"><label for="deck_selector" class="deck_selector svelte-bc2zvv">デッキ：</label> <select id="deck_selector" class="deck_selector svelte-bc2zvv"></select></div> <div class="svelte-bc2zvv"><button class="btn svelte-bc2zvv">duel start!</button></div>',1),jA=b('<div class="svelte-bc2zvv">デッキ情報の読み込み、もしくは作成中...</div>'),YA=b('<div class="svelte-bc2zvv"><label for="duelist_name" class="duelist_name svelte-bc2zvv">名前：</label> <input id="duelist_name" class="duelist_name svelte-bc2zvv" type="text"></div> <!> <div class="svelte-bc2zvv"><button class="btn svelte-bc2zvv">deck edit</button></div>',1),zA=b('<div class="svelte-bc2zvv">デュエリスト情報の読み込み、もしくは作成中...</div>'),GA=b('<div class="app_body svelte-bc2zvv"><!></div>'),VA=b('<main class="svelte-bc2zvv"><!> <div class="debug_info svelte-bc2zvv"><span class="screen_info"></span></div></main>');function QA(n,e){Fe(e,!1);const t=new As("stk_ygo_svelte",UA,ZA);let i=Ce(),a=Ce("None"),s=Ce(0);const o=Gn.getOrCreateNew(t);let k=Ce(vt.getAllDeckInfo(t).then(T=>(ee(s,(T.find(_=>_.lastUsedAt.getTime()===Math.max(...T.map(q=>q.lastUsedAt.getTime())))??T[0]).id),T)));const p=async()=>{let T=(await A(k)).find(_=>_.id===A(s));if(T||(T=(await m()).find(_=>_.id===A(s))),!T)throw new Error("illegal state");return T},c=async()=>{(await o).save()},m=()=>(ee(k,vt.getAllDeckInfo(t).then(T=>(ee(s,(T.find(_=>_.lastUsedAt.getTime()===Math.max(...T.map(q=>q.lastUsedAt.getTime())))??T[0]).id),T))),A(k)),f=async()=>{(await A(k)).length||(await vt.prepareSampleDeck(),m())},r=async()=>{await Promise.all([c(),f()]),(await p()).updateTimestamp(),ee(i,new Is(await o,"Player",await p(),cs[0],"NPC",kn[0]))},l=async()=>{console.log("hoge"),await Promise.all([c(),f()]),ee(a,"DeckEdit")},u=async T=>{await c(),T.key==="Enter"&&!T.repeat&&(await o).save()};f(),Ze();var w=VA(),C=h(w);{var v=T=>{kA(T,{get duel(){return A(i)}})},y=T=>{var _=he(),q=te(_);{var z=B=>{OA(B,{})},ie=B=>{var O=GA(),re=h(O);$n(re,()=>o,Ae=>{var pe=zA();g(Ae,pe)},(Ae,pe)=>{var ue=YA(),X=te(ue),x=D(h(X),2),I=D(X,2);$n(I,()=>A(k),Q=>{var H=jA();g(Q,H)},(Q,H)=>{var G=$A(),S=te(G),P=D(h(S),2);W(()=>{A(s),Ca(()=>{A(H)})}),me(P,5,()=>A(H),ke,(Y,U)=>{var $=IA(),ae={},J=h($);W(()=>{ae!==(ae=A(U).id)&&($.value=($.__value=A(U).id)==null?"":A(U).id),F(J,A(U).name)}),g(Y,$)});var K=D(S,2),j=h(K);va(P,()=>A(s),Y=>ee(s,Y)),ye("click",j,r),g(Q,G)});var ne=D(I,2),Z=h(ne);Yn(x,()=>A(pe).name,Q=>A(pe).name=Q),ye("keypress",x,u),ye("click",Z,l),g(Ae,ue)}),g(B,O)};L(q,B=>{A(a)==="DeckEdit"?B(z):B(ie,!1)},!0)}g(T,_)};L(C,T=>{A(i)?T(v):T(y,!1)})}g(n,w),He()}Lr(QA,{target:document.getElementById("app")});
