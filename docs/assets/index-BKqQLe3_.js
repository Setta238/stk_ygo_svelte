var Ka=Object.defineProperty;var Sa=(n,e,t)=>e in n?Ka(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var d=(n,e,t)=>Sa(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const qn=!1;var Qn=Array.isArray,Wa=Array.prototype.indexOf,Xn=Array.from,Oi=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,Ii=Object.getOwnPropertyDescriptors,Pa=Object.prototype,qa=Array.prototype,Jn=Object.getPrototypeOf;function La(n){return typeof n=="function"}const Ie=()=>{};function Ra(n){return typeof(n==null?void 0:n.then)=="function"}function Oa(n){return n()}function Ln(n){for(var e=0;e<n.length;e++)n[e]()}const We=2,Zi=4,yn=8,vn=16,it=32,Vt=64,kn=128,Se=256,mn=512,Me=1024,at=2048,qt=4096,tt=8192,gn=16384,Ui=32768,Bn=65536,$i=1<<17,Ia=1<<19,Yi=1<<20,nt=Symbol("$state"),Za=Symbol("legacy props"),Ua=Symbol("");function zi(n){return n===this.v}function ji(n,e){return n!=n?e==e:n!==e||n!==null&&typeof n=="object"||typeof n=="function"}function ei(n){return!ji(n,this.v)}function $a(n){throw new Error("https://svelte.dev/e/effect_in_teardown")}function Ya(){throw new Error("https://svelte.dev/e/effect_in_unowned_derived")}function za(n){throw new Error("https://svelte.dev/e/effect_orphan")}function ja(){throw new Error("https://svelte.dev/e/effect_update_depth_exceeded")}function Ga(n){throw new Error("https://svelte.dev/e/props_invalid_value")}function Va(){throw new Error("https://svelte.dev/e/state_descriptors_fixed")}function Qa(){throw new Error("https://svelte.dev/e/state_prototype_fixed")}function Xa(){throw new Error("https://svelte.dev/e/state_unsafe_local_read")}function Ja(){throw new Error("https://svelte.dev/e/state_unsafe_mutation")}let Qt=!1,er=!1;function tr(){Qt=!0}const ti=1,ni=2,Gi=4,nr=8,ir=16,ar=1,rr=2,sr=4,or=8,Ar=16,lr=1,dr=2,pr=4,cr=1,kr=2,Be=Symbol();let fe=null;function un(n){fe=n}function Ne(n,e=!1,t){fe={p:fe,c:null,e:null,m:!1,s:n,x:null,l:null},Qt&&!e&&(fe.l={s:null,u:null,r1:[],r2:Ee(!1)})}function be(n){const e=fe;if(e!==null){const s=e.e;if(s!==null){var t=de,i=pe;e.e=null;try{for(var a=0;a<s.length;a++){var r=s[a];qe(r.effect),Pe(r.reaction),Ot(r.fn)}}finally{qe(t),Pe(i)}}fe=e.p,e.m=!0}return{}}function Lt(){return!Qt||fe!==null&&fe.l===null}function Ee(n,e){var t={f:0,v:n,reactions:null,equals:zi,rv:0,wv:0};return t}function mr(n){return Vi(Ee(n))}function Wt(n,e=!1){var i;const t=Ee(n);return e||(t.equals=ei),Qt&&fe!==null&&fe.l!==null&&((i=fe.l).s??(i.s=[])).push(t),t}function ye(n,e=!1){return Vi(Wt(n,e))}function Vi(n){return pe!==null&&!Ue&&pe.f&We&&($e===null?Er([n]):$e.push(n)),n}function Fe(n,e){return Q(n,Ye(()=>A(n))),e}function Q(n,e){return pe!==null&&!Ue&&Lt()&&pe.f&(We|vn)&&($e===null||!$e.includes(n))&&Ja(),kt(n,e)}function kt(n,e){return n.equals(e)||(n.v,n.v=e,n.wv=ma(),Qi(n,at),Lt()&&de!==null&&de.f&Me&&!(de.f&(it|Vt))&&(Qe===null?xr([n]):Qe.push(n))),e}function Qi(n,e){var t=n.reactions;if(t!==null)for(var i=Lt(),a=t.length,r=0;r<a;r++){var s=t[r],o=s.f;o&at||!i&&s===de||(ze(s,e),o&(Me|Se)&&(o&We?Qi(s,qt):bn(s)))}}let Xi=!1;function At(n,e=null,t){if(typeof n!="object"||n===null||nt in n)return n;const i=Jn(n);if(i!==Pa&&i!==qa)return n;var a=new Map,r=Qn(n),s=Ee(0);r&&a.set("length",Ee(n.length));var o;return new Proxy(n,{defineProperty(l,p,c){(!("value"in c)||c.configurable===!1||c.enumerable===!1||c.writable===!1)&&Va();var m=a.get(p);return m===void 0?(m=Ee(c.value),a.set(p,m)):Q(m,At(c.value,o)),!0},deleteProperty(l,p){var c=a.get(p);if(c===void 0)p in l&&a.set(p,Ee(Be));else{if(r&&typeof p=="string"){var m=a.get("length"),k=Number(p);Number.isInteger(k)&&k<m.v&&Q(m,k)}Q(c,Be),mi(s)}return!0},get(l,p,c){var w;if(p===nt)return n;var m=a.get(p),k=p in l;if(m===void 0&&(!k||(w=Ft(l,p))!=null&&w.writable)&&(m=Ee(At(k?l[p]:Be,o)),a.set(p,m)),m!==void 0){var h=A(m);return h===Be?void 0:h}return Reflect.get(l,p,c)},getOwnPropertyDescriptor(l,p){var c=Reflect.getOwnPropertyDescriptor(l,p);if(c&&"value"in c){var m=a.get(p);m&&(c.value=A(m))}else if(c===void 0){var k=a.get(p),h=k==null?void 0:k.v;if(k!==void 0&&h!==Be)return{enumerable:!0,configurable:!0,value:h,writable:!0}}return c},has(l,p){var h;if(p===nt)return!0;var c=a.get(p),m=c!==void 0&&c.v!==Be||Reflect.has(l,p);if(c!==void 0||de!==null&&(!m||(h=Ft(l,p))!=null&&h.writable)){c===void 0&&(c=Ee(m?At(l[p],o):Be),a.set(p,c));var k=A(c);if(k===Be)return!1}return m},set(l,p,c,m){var H;var k=a.get(p),h=p in l;if(r&&p==="length")for(var w=c;w<k.v;w+=1){var D=a.get(w+"");D!==void 0?Q(D,Be):w in l&&(D=Ee(Be),a.set(w+"",D))}k===void 0?(!h||(H=Ft(l,p))!=null&&H.writable)&&(k=Ee(void 0),Q(k,At(c,o)),a.set(p,k)):(h=k.v!==Be,Q(k,At(c,o)));var _=Reflect.getOwnPropertyDescriptor(l,p);if(_!=null&&_.set&&_.set.call(m,c),!h){if(r&&typeof p=="string"){var E=a.get("length"),y=Number(p);Number.isInteger(y)&&y>=E.v&&Q(E,y+1)}mi(s)}return!0},ownKeys(l){A(s);var p=Reflect.ownKeys(l).filter(k=>{var h=a.get(k);return h===void 0||h.v!==Be});for(var[c,m]of a)m.v!==Be&&!(c in l)&&p.push(c);return p},setPrototypeOf(){Qa()}})}function mi(n,e=1){Q(n,n.v+e)}function ui(n){return n!==null&&typeof n=="object"&&nt in n?n[nt]:n}function Ji(n,e){return Object.is(ui(n),ui(e))}var hi,ea,ta,na;function ur(){if(hi===void 0){hi=window,ea=/Firefox/.test(navigator.userAgent);var n=Element.prototype,e=Node.prototype;ta=Ft(e,"firstChild").get,na=Ft(e,"nextSibling").get,n.__click=void 0,n.__className="",n.__attributes=null,n.__styles=null,n.__e=void 0,Text.prototype.__t=void 0}}function En(n=""){return document.createTextNode(n)}function hn(n){return ta.call(n)}function xn(n){return na.call(n)}function u(n,e){return hn(n)}function V(n,e){{var t=hn(n);return t instanceof Comment&&t.data===""?xn(t):t}}function f(n,e=1,t=!1){let i=n;for(;e--;)i=xn(i);return i}function hr(n){n.textContent=""}function Dt(n){var e=We|at,t=pe!==null&&pe.f&We?pe:null;return de===null||t!==null&&t.f&Se?e|=Se:de.f|=Yi,{ctx:fe,deps:null,effects:null,equals:zi,f:e,fn:n,reactions:null,rv:0,v:null,wv:0,parent:t??de}}function Ce(n){const e=Dt(n);return e.equals=ei,e}function ia(n){var e=n.effects;if(e!==null){n.effects=null;for(var t=0;t<e.length;t+=1)mt(e[t])}}function wr(n){for(var e=n.parent;e!==null;){if(!(e.f&We))return e;e=e.parent}return null}function fr(n){var e,t=de;qe(wr(n));try{ia(n),e=ha(n)}finally{qe(t)}return e}function aa(n){var e=fr(n),t=(dt||n.f&Se)&&n.deps!==null?qt:Me;ze(n,t),n.equals(e)||(n.v=e,n.wv=ma())}function ra(n){de===null&&pe===null&&za(),pe!==null&&pe.f&Se&&de===null&&Ya(),ri&&$a()}function Cr(n,e){var t=e.last;t===null?e.last=e.first=n:(t.next=n,n.prev=t,e.last=n)}function Rt(n,e,t,i=!0){var a=(n&Vt)!==0,r=de,s={ctx:fe,deps:null,nodes_start:null,nodes_end:null,f:n|at,first:null,fn:e,last:null,next:null,parent:a?null:r,prev:null,teardown:null,transitions:null,wv:0};if(t){var o=Ht;try{fi(!0),si(s),s.f|=Ui}catch(c){throw mt(s),c}finally{fi(o)}}else e!==null&&bn(s);var l=t&&s.deps===null&&s.first===null&&s.nodes_start===null&&s.teardown===null&&(s.f&(Yi|kn))===0;if(!l&&!a&&i&&(r!==null&&Cr(s,r),pe!==null&&pe.f&We)){var p=pe;(p.effects??(p.effects=[])).push(s)}return s}function ii(n){const e=Rt(yn,null,!1);return ze(e,Me),e.teardown=n,e}function wi(n){ra();var e=de!==null&&(de.f&it)!==0&&fe!==null&&!fe.m;if(e){var t=fe;(t.e??(t.e=[])).push({fn:n,effect:de,reaction:pe})}else{var i=Ot(n);return i}}function Dr(n){return ra(),Tn(n)}function yr(n){const e=Rt(Vt,n,!0);return(t={})=>new Promise(i=>{t.outro?ft(e,()=>{mt(e),i(void 0)}):(mt(e),i(void 0))})}function Ot(n){return Rt(Zi,n,!1)}function Tn(n){return Rt(yn,n,!0)}function L(n,e=[],t=Dt){const i=e.map(t);return Mn(()=>n(...i.map(A)))}function Mn(n,e=0){return Rt(yn|vn|e,n,!0)}function yt(n,e=!0){return Rt(yn|it,n,!0,e)}function sa(n){var e=n.teardown;if(e!==null){const t=ri,i=pe;Ci(!0),Pe(null);try{e.call(null)}finally{Ci(t),Pe(i)}}}function oa(n,e=!1){var t=n.first;for(n.first=n.last=null;t!==null;){var i=t.next;mt(t,e),t=i}}function vr(n){for(var e=n.first;e!==null;){var t=e.next;e.f&it||mt(e),e=t}}function mt(n,e=!0){var t=!1;if((e||n.f&Ia)&&n.nodes_start!==null){for(var i=n.nodes_start,a=n.nodes_end;i!==null;){var r=i===a?null:xn(i);i.remove(),i=r}t=!0}oa(n,e&&!t),Cn(n,0),ze(n,gn);var s=n.transitions;if(s!==null)for(const l of s)l.stop();sa(n);var o=n.parent;o!==null&&o.first!==null&&Aa(n),n.next=n.prev=n.teardown=n.ctx=n.deps=n.fn=n.nodes_start=n.nodes_end=null}function Aa(n){var e=n.parent,t=n.prev,i=n.next;t!==null&&(t.next=i),i!==null&&(i.prev=t),e!==null&&(e.first===n&&(e.first=i),e.last===n&&(e.last=t))}function ft(n,e){var t=[];ai(n,t,!0),la(t,()=>{mt(n),e&&e()})}function la(n,e){var t=n.length;if(t>0){var i=()=>--t||e();for(var a of n)a.out(i)}else e()}function ai(n,e,t){if(!(n.f&tt)){if(n.f^=tt,n.transitions!==null)for(const s of n.transitions)(s.is_global||t)&&e.push(s);for(var i=n.first;i!==null;){var a=i.next,r=(i.f&Bn)!==0||(i.f&it)!==0;ai(i,e,r?t:!1),i=a}}}function Pt(n){da(n,!0)}function da(n,e){if(n.f&tt){n.f^=tt,n.f&Me||(n.f^=Me),Xt(n)&&(ze(n,at),bn(n));for(var t=n.first;t!==null;){var i=t.next,a=(t.f&Bn)!==0||(t.f&it)!==0;da(t,a?e:!1),t=i}if(n.transitions!==null)for(const r of n.transitions)(r.is_global||e)&&r.in()}}let wn=!1,Rn=[];function pa(){wn=!1;const n=Rn.slice();Rn=[],Ln(n)}function vt(n){wn||(wn=!0,queueMicrotask(pa)),Rn.push(n)}function gr(){wn&&pa()}const ca=0,Br=1;let on=!1,An=ca,zt=!1,jt=null,Ht=!1,ri=!1;function fi(n){Ht=n}function Ci(n){ri=n}let ht=[],Kt=0;let pe=null,Ue=!1;function Pe(n){pe=n}let de=null;function qe(n){de=n}let $e=null;function Er(n){$e=n}let xe=null,_e=0,Qe=null;function xr(n){Qe=n}let ka=1,fn=0,dt=!1,lt=null;function ma(){return++ka}function Xt(n){var m;var e=n.f;if(e&at)return!0;if(e&qt){var t=n.deps,i=(e&Se)!==0;if(t!==null){var a,r,s=(e&mn)!==0,o=i&&de!==null&&!dt,l=t.length;if(s||o){var p=n,c=p.parent;for(a=0;a<l;a++)r=t[a],(s||!((m=r==null?void 0:r.reactions)!=null&&m.includes(p)))&&(r.reactions??(r.reactions=[])).push(p);s&&(p.f^=mn),o&&c!==null&&!(c.f&Se)&&(p.f^=Se)}for(a=0;a<l;a++)if(r=t[a],Xt(r)&&aa(r),r.wv>n.wv)return!0}(!i||de!==null&&!dt)&&ze(n,Me)}return!1}function Tr(n,e){for(var t=e;t!==null;){if(t.f&kn)try{t.fn(n);return}catch{t.f^=kn}t=t.parent}throw on=!1,n}function Mr(n){return(n.f&gn)===0&&(n.parent===null||(n.parent.f&kn)===0)}function Nn(n,e,t,i){if(on){if(t===null&&(on=!1),Mr(e))throw n;return}t!==null&&(on=!0);{Tr(n,e);return}}function ua(n,e,t=!0){var i=n.reactions;if(i!==null)for(var a=0;a<i.length;a++){var r=i[a];r.f&We?ua(r,e,!1):e===r&&(t?ze(r,at):r.f&Me&&ze(r,qt),bn(r))}}function ha(n){var h;var e=xe,t=_e,i=Qe,a=pe,r=dt,s=$e,o=fe,l=Ue,p=n.f;xe=null,_e=0,Qe=null,pe=p&(it|Vt)?null:n,dt=(p&Se)!==0&&(!Ht||a===null||l),$e=null,un(n.ctx),Ue=!1,fn++;try{var c=(0,n.fn)(),m=n.deps;if(xe!==null){var k;if(Cn(n,_e),m!==null&&_e>0)for(m.length=_e+xe.length,k=0;k<xe.length;k++)m[_e+k]=xe[k];else n.deps=m=xe;if(!dt)for(k=_e;k<m.length;k++)((h=m[k]).reactions??(h.reactions=[])).push(n)}else m!==null&&_e<m.length&&(Cn(n,_e),m.length=_e);if(Lt()&&Qe!==null&&!Ue&&m!==null&&!(n.f&(We|qt|at)))for(k=0;k<Qe.length;k++)ua(Qe[k],n);return a!==null&&fn++,c}finally{xe=e,_e=t,Qe=i,pe=a,dt=r,$e=s,un(o),Ue=l}}function Nr(n,e){let t=e.reactions;if(t!==null){var i=Wa.call(t,n);if(i!==-1){var a=t.length-1;a===0?t=e.reactions=null:(t[i]=t[a],t.pop())}}t===null&&e.f&We&&(xe===null||!xe.includes(e))&&(ze(e,qt),e.f&(Se|mn)||(e.f^=mn),ia(e),Cn(e,0))}function Cn(n,e){var t=n.deps;if(t!==null)for(var i=e;i<t.length;i++)Nr(n,t[i])}function si(n){var e=n.f;if(!(e&gn)){ze(n,Me);var t=de,i=fe;de=n;try{e&vn?vr(n):oa(n),sa(n);var a=ha(n);n.teardown=typeof a=="function"?a:null,n.wv=ka;var r=n.deps,s;qn&&er&&n.f&at}catch(o){Nn(o,n,t,i||n.ctx)}finally{de=t}}}function wa(){if(Kt>1e3){Kt=0;try{ja()}catch(n){if(jt!==null)Nn(n,jt,null);else throw n}}Kt++}function fa(n){var e=n.length;if(e!==0){wa();var t=Ht;Ht=!0;try{for(var i=0;i<e;i++){var a=n[i];a.f&Me||(a.f^=Me);var r=Fr(a);br(r)}}finally{Ht=t}}}function br(n){var e=n.length;if(e!==0)for(var t=0;t<e;t++){var i=n[t];if(!(i.f&(gn|tt)))try{Xt(i)&&(si(i),i.deps===null&&i.first===null&&i.nodes_start===null&&(i.teardown===null?Aa(i):i.fn=null))}catch(a){Nn(a,i,null,i.ctx)}}}function _r(){if(zt=!1,Kt>1001)return;const n=ht;ht=[],fa(n),zt||(Kt=0,jt=null)}function bn(n){An===ca&&(zt||(zt=!0,queueMicrotask(_r))),jt=n;for(var e=n;e.parent!==null;){e=e.parent;var t=e.f;if(t&(Vt|it)){if(!(t&Me))return;e.f^=Me}}ht.push(e)}function Fr(n){var e=[],t=n.first;e:for(;t!==null;){var i=t.f,a=(i&it)!==0,r=a&&(i&Me)!==0,s=t.next;if(!r&&!(i&tt)){if(i&Zi)e.push(t);else if(a)t.f^=Me;else{var o=pe;try{pe=t,Xt(t)&&si(t)}catch(c){Nn(c,t,null,t.ctx)}finally{pe=o}}var l=t.first;if(l!==null){t=l;continue}}if(s===null){let c=t.parent;for(;c!==null;){if(n===c)break e;var p=c.next;if(p!==null){t=p;continue e}c=c.parent}}t=s}return e}function oi(n){var e=An,t=ht;try{wa();const a=[];An=Br,ht=a,zt=!1,fa(t);var i=n==null?void 0:n();return gr(),(ht.length>0||a.length>0)&&oi(),Kt=0,jt=null,i}finally{An=e,ht=t}}async function Hr(){await Promise.resolve(),oi()}function A(n){var e=n.f,t=(e&We)!==0;if(lt!==null&&lt.add(n),pe!==null&&!Ue){$e!==null&&$e.includes(n)&&Xa();var i=pe.deps;n.rv<fn&&(n.rv=fn,xe===null&&i!==null&&i[_e]===n?_e++:xe===null?xe=[n]:(!dt||!xe.includes(n))&&xe.push(n))}else if(t&&n.deps===null&&n.effects===null){var a=n,r=a.parent;r!==null&&!(r.f&Se)&&(a.f^=Se)}return t&&(a=n,Xt(a)&&aa(a)),n.v}function Kr(n){var e=lt;lt=new Set;var t=lt,i;try{if(Ye(n),e!==null)for(i of lt)e.add(i)}finally{lt=e}return t}function Sr(n){var e=Kr(()=>Ye(n));for(var t of e)if(t.f&$i)for(const i of t.deps||[])i.f&We||kt(i,i.v);else kt(t,t.v)}function Ye(n){var e=Ue;try{return Ue=!0,n()}finally{Ue=e}}const Wr=-7169;function ze(n,e){n.f=n.f&Wr|e}function Pr(n){if(!(typeof n!="object"||!n||n instanceof EventTarget)){if(nt in n)On(n);else if(!Array.isArray(n))for(let e in n){const t=n[e];typeof t=="object"&&t&&nt in t&&On(t)}}}function On(n,e=new Set){if(typeof n=="object"&&n!==null&&!(n instanceof EventTarget)&&!e.has(n)){e.add(n),n instanceof Date&&n.getTime();for(let i in n)try{On(n[i],e)}catch{}const t=Jn(n);if(t!==Object.prototype&&t!==Array.prototype&&t!==Map.prototype&&t!==Set.prototype&&t!==Date.prototype){const i=Ii(t);for(let a in i){const r=i[a].get;if(r)try{r.call(n)}catch{}}}}}const qr=["touchstart","touchmove"];function Lr(n){return qr.includes(n)}let Di=!1;function Rr(){Di||(Di=!0,document.addEventListener("reset",n=>{Promise.resolve().then(()=>{var e;if(!n.defaultPrevented)for(const t of n.target.elements)(e=t.__on_r)==null||e.call(t)})},{capture:!0}))}function Ai(n){var e=pe,t=de;Pe(null),qe(null);try{return n()}finally{Pe(e),qe(t)}}function li(n,e,t,i=t){n.addEventListener(e,()=>Ai(t));const a=n.__on_r;a?n.__on_r=()=>{a(),i(!0)}:n.__on_r=()=>i(!0),Rr()}const Ca=new Set,In=new Set;function Or(n,e,t,i={}){function a(r){if(i.capture||Ut.call(e,r),!r.cancelBubble)return Ai(()=>t==null?void 0:t.call(this,r))}return n.startsWith("pointer")||n.startsWith("touch")||n==="wheel"?vt(()=>{e.addEventListener(n,a,i)}):e.addEventListener(n,a,i),a}function ve(n,e,t,i,a){var r={capture:i,passive:a},s=Or(n,e,t,r);(e===document.body||e===window||e===document)&&ii(()=>{e.removeEventListener(n,s,r)})}function di(n){for(var e=0;e<n.length;e++)Ca.add(n[e]);for(var t of In)t(n)}function Ut(n){var y;var e=this,t=e.ownerDocument,i=n.type,a=((y=n.composedPath)==null?void 0:y.call(n))||[],r=a[0]||n.target,s=0,o=n.__root;if(o){var l=a.indexOf(o);if(l!==-1&&(e===document||e===window)){n.__root=e;return}var p=a.indexOf(e);if(p===-1)return;l<=p&&(s=l)}if(r=a[s]||n.target,r!==e){Oi(n,"currentTarget",{configurable:!0,get(){return r||t}});var c=pe,m=de;Pe(null),qe(null);try{for(var k,h=[];r!==null;){var w=r.assignedSlot||r.parentNode||r.host||null;try{var D=r["__"+i];if(D!==void 0&&!r.disabled)if(Qn(D)){var[_,...E]=D;_.apply(r,[n,...E])}else D.call(r,n)}catch(H){k?h.push(H):k=H}if(n.cancelBubble||w===e||w===null)break;r=w}if(k){for(let H of h)queueMicrotask(()=>{throw H});throw k}}finally{n.__root=e,delete n.currentTarget,Pe(c),qe(m)}}}function Ir(n){var e=document.createElement("template");return e.innerHTML=n,e.content}function Dn(n,e){var t=de;t.nodes_start===null&&(t.nodes_start=n,t.nodes_end=e)}function M(n,e){var t=(e&cr)!==0,i=(e&kr)!==0,a,r=!n.startsWith("<!>");return()=>{a===void 0&&(a=Ir(r?n:"<!>"+n),t||(a=hn(a)));var s=i||ea?document.importNode(a,!0):a.cloneNode(!0);if(t){var o=hn(s),l=s.lastChild;Dn(o,l)}else Dn(s,s);return s}}function Tt(n=""){{var e=En(n+"");return Dn(e,e),e}}function he(){var n=document.createDocumentFragment(),e=document.createComment(""),t=En();return n.append(e,t),Dn(e,t),n}function C(n,e){n!==null&&n.before(e)}let Zn=!0;function b(n,e){var t=e==null?"":typeof e=="object"?e+"":e;t!==(n.__t??(n.__t=n.nodeValue))&&(n.__t=t,n.nodeValue=t+"")}function Zr(n,e){return Ur(n,e)}const Mt=new Map;function Ur(n,{target:e,anchor:t,props:i={},events:a,context:r,intro:s=!0}){ur();var o=new Set,l=m=>{for(var k=0;k<m.length;k++){var h=m[k];if(!o.has(h)){o.add(h);var w=Lr(h);e.addEventListener(h,Ut,{passive:w});var D=Mt.get(h);D===void 0?(document.addEventListener(h,Ut,{passive:w}),Mt.set(h,1)):Mt.set(h,D+1)}}};l(Xn(Ca)),In.add(l);var p=void 0,c=yr(()=>{var m=t??e.appendChild(En());return yt(()=>{if(r){Ne({});var k=fe;k.c=r}a&&(i.$$events=a),Zn=s,p=n(m,i)||{},Zn=!0,r&&be()}),()=>{var w;for(var k of o){e.removeEventListener(k,Ut);var h=Mt.get(k);--h===0?(document.removeEventListener(k,Ut),Mt.delete(k)):Mt.set(k,h)}In.delete(l),m!==t&&((w=m.parentNode)==null||w.removeChild(m))}});return $r.set(p,c),p}let $r=new WeakMap;const Hn=0,an=1,Kn=2;function Da(n,e,t,i,a){var r=n,s=Lt(),o=fe,l=Be,p,c,m,k=(s?Ee:Wt)(void 0),h=(s?Ee:Wt)(void 0),w=!1;function D(E,y){w=!0,y&&(qe(_),Pe(_),un(o));try{E===Hn&&t&&(p?Pt(p):p=yt(()=>t(r))),E===an&&i&&(c?Pt(c):c=yt(()=>i(r,k))),E!==Hn&&p&&ft(p,()=>p=null),E!==an&&c&&ft(c,()=>c=null),E!==Kn&&m&&ft(m,()=>m=null)}finally{y&&(un(null),Pe(null),qe(null),oi())}}var _=Mn(()=>{if(l!==(l=e())){if(Ra(l)){var E=l;w=!1,E.then(y=>{E===l&&(kt(k,y),D(an,!0))},y=>{if(E===l)throw kt(h,y),D(Kn,!0),h.v}),vt(()=>{w||D(Hn,!0)})}else kt(k,l),D(an,!1);return()=>l=Be}})}function R(n,e,t=!1){var i=n,a=null,r=null,s=Be,o=t?Bn:0,l=!1;const p=(m,k=!0)=>{l=!0,c(k,m)},c=(m,k)=>{s!==(s=m)&&(s?(a?Pt(a):k&&(a=yt(()=>k(i))),r&&ft(r,()=>{r=null})):(r?Pt(r):k&&(r=yt(()=>k(i))),a&&ft(a,()=>{a=null})))};Mn(()=>{l=!1,e(p),l||c(null,null)},o)}function ke(n,e){return e}function Yr(n,e,t,i){for(var a=[],r=e.length,s=0;s<r;s++)ai(e[s].e,a,!0);var o=r>0&&a.length===0&&t!==null;if(o){var l=t.parentNode;hr(l),l.append(t),i.clear(),st(n,e[0].prev,e[r-1].next)}la(a,()=>{for(var p=0;p<r;p++){var c=e[p];o||(i.delete(c.k),st(n,c.prev,c.next)),mt(c.e,!o)}})}function me(n,e,t,i,a,r=null){var s=n,o={flags:e,items:new Map,first:null},l=(e&Gi)!==0;if(l){var p=n;s=p.appendChild(En())}var c=null,m=!1,k=Ce(()=>{var h=t();return Qn(h)?h:h==null?[]:Xn(h)});Mn(()=>{var h=A(k),w=h.length;m&&w===0||(m=w===0,zr(h,o,s,a,e,i,t),r!==null&&(w===0?c?Pt(c):c=yt(()=>r(s)):c!==null&&ft(c,()=>{c=null})),A(k))})}function zr(n,e,t,i,a,r,s){var G,v,W,$;var o=(a&nr)!==0,l=(a&(ti|ni))!==0,p=n.length,c=e.items,m=e.first,k=m,h,w=null,D,_=[],E=[],y,H,P,q;if(o)for(q=0;q<p;q+=1)y=n[q],H=r(y,q),P=c.get(H),P!==void 0&&((G=P.a)==null||G.measure(),(D??(D=new Set)).add(P));for(q=0;q<p;q+=1){if(y=n[q],H=r(y,q),P=c.get(H),P===void 0){var Z=k?k.e.nodes_start:t;w=Gr(Z,e,w,w===null?e.first:w.next,y,H,q,i,a,s),c.set(H,w),_=[],E=[],k=w.next;continue}if(l&&jr(P,y,q,a),P.e.f&tt&&(Pt(P.e),o&&((v=P.a)==null||v.unfix(),(D??(D=new Set)).delete(P))),P!==k){if(h!==void 0&&h.has(P)){if(_.length<E.length){var X=E[0],B;w=X.prev;var I=_[0],ee=_[_.length-1];for(B=0;B<_.length;B+=1)yi(_[B],X,t);for(B=0;B<E.length;B+=1)h.delete(E[B]);st(e,I.prev,ee.next),st(e,w,I),st(e,ee,X),k=X,w=ee,q-=1,_=[],E=[]}else h.delete(P),yi(P,k,t),st(e,P.prev,P.next),st(e,P,w===null?e.first:w.next),st(e,w,P),w=P;continue}for(_=[],E=[];k!==null&&k.k!==H;)k.e.f&tt||(h??(h=new Set)).add(k),E.push(k),k=k.next;if(k===null)continue;P=k}_.push(P),w=P,k=P.next}if(k!==null||h!==void 0){for(var Ae=h===void 0?[]:Xn(h);k!==null;)k.e.f&tt||Ae.push(k),k=k.next;var ue=Ae.length;if(ue>0){var De=a&Gi&&p===0?t:null;if(o){for(q=0;q<ue;q+=1)(W=Ae[q].a)==null||W.measure();for(q=0;q<ue;q+=1)($=Ae[q].a)==null||$.fix()}Yr(e,Ae,De,c)}}o&&vt(()=>{var j;if(D!==void 0)for(P of D)(j=P.a)==null||j.apply()}),de.first=e.first&&e.first.e,de.last=w&&w.e}function jr(n,e,t,i){i&ti&&kt(n.v,e),i&ni?kt(n.i,t):n.i=t}function Gr(n,e,t,i,a,r,s,o,l,p){var c=(l&ti)!==0,m=(l&ir)===0,k=c?m?Wt(a):Ee(a):a,h=l&ni?Ee(s):s,w={i:h,v:k,k:r,a:null,e:null,prev:t,next:i};try{return w.e=yt(()=>o(n,k,h,p),Xi),w.e.prev=t&&t.e,w.e.next=i&&i.e,t===null?e.first=w:(t.next=w,t.e.next=w.e),i!==null&&(i.prev=w,i.e.prev=w.e),w}finally{}}function yi(n,e,t){for(var i=n.next?n.next.e.nodes_start:t,a=e?e.e.nodes_start:t,r=n.e.nodes_start;r!==i;){var s=xn(r);a.before(r),r=s}}function st(n,e,t){e===null?n.first=t:(e.next=t,e.e.next=t&&t.e),t!==null&&(t.prev=e,t.e.prev=e&&e.e)}function St(n,e,t,i){var a=n.__attributes??(n.__attributes={});a[e]!==(a[e]=t)&&(e==="style"&&"__styles"in n&&(n.__styles={}),e==="loading"&&(n[Ua]=t),t==null?n.removeAttribute(e):typeof t!="string"&&Vr(n).includes(e)?n[e]=t:n.setAttribute(e,t))}var vi=new Map;function Vr(n){var e=vi.get(n.nodeName);if(e)return e;vi.set(n.nodeName,e=[]);for(var t,i=n,a=Element.prototype;a!==i;){t=Ii(i);for(var r in t)t[r].set&&e.push(r);i=Jn(i)}return e}function we(n,e,t){var i=n.__className,a=Qr(e);(i!==a||Xi)&&(e==null?n.removeAttribute("class"):n.className=a,n.__className=a)}function Qr(n,e){return(n??"")+""}const Xr=()=>performance.now(),et={tick:n=>requestAnimationFrame(n),now:()=>Xr(),tasks:new Set};function ya(){const n=et.now();et.tasks.forEach(e=>{e.c(n)||(et.tasks.delete(e),e.f())}),et.tasks.size!==0&&et.tick(ya)}function Jr(n){let e;return et.tasks.size===0&&et.tick(ya),{promise:new Promise(t=>{et.tasks.add(e={c:n,f:t})}),abort(){et.tasks.delete(e)}}}function rn(n,e){Ai(()=>{n.dispatchEvent(new CustomEvent(e))})}function es(n){if(n==="float")return"cssFloat";if(n==="offset")return"cssOffset";if(n.startsWith("--"))return n;const e=n.split("-");return e.length===1?e[0]:e[0]+e.slice(1).map(t=>t[0].toUpperCase()+t.slice(1)).join("")}function gi(n){const e={},t=n.split(";");for(const i of t){const[a,r]=i.split(":");if(!a||r===void 0)break;const s=es(a.trim());e[s]=r.trim()}return e}const ts=n=>n;function Nt(n,e,t,i){var a=(n&lr)!==0,r=(n&dr)!==0,s=a&&r,o=(n&pr)!==0,l=s?"both":a?"in":"out",p,c=e.inert,m=e.style.overflow,k,h;function w(){var H=pe,P=de;Pe(null),qe(null);try{return p??(p=t()(e,(i==null?void 0:i())??{},{direction:l}))}finally{Pe(H),qe(P)}}var D={is_global:o,in(){var H;if(e.inert=c,!a){h==null||h.abort(),(H=h==null?void 0:h.reset)==null||H.call(h);return}r||k==null||k.abort(),rn(e,"introstart"),k=Un(e,w(),h,1,()=>{rn(e,"introend"),k==null||k.abort(),k=p=void 0,e.style.overflow=m})},out(H){if(!r){H==null||H(),p=void 0;return}e.inert=!0,rn(e,"outrostart"),h=Un(e,w(),k,0,()=>{rn(e,"outroend"),H==null||H()})},stop:()=>{k==null||k.abort(),h==null||h.abort()}},_=de;if((_.transitions??(_.transitions=[])).push(D),a&&Zn){var E=o;if(!E){for(var y=_.parent;y&&y.f&Bn;)for(;(y=y.parent)&&!(y.f&vn););E=!y||(y.f&Ui)!==0}E&&Ot(()=>{Ye(()=>D.in())})}}function Un(n,e,t,i,a){var r=i===1;if(La(e)){var s,o=!1;return vt(()=>{if(!o){var _=e({direction:r?"in":"out"});s=Un(n,_,t,i,a)}}),{abort:()=>{o=!0,s==null||s.abort()},deactivate:()=>s.deactivate(),reset:()=>s.reset(),t:()=>s.t()}}if(t==null||t.deactivate(),!(e!=null&&e.duration))return a(),{abort:Ie,deactivate:Ie,reset:Ie,t:()=>i};const{delay:l=0,css:p,tick:c,easing:m=ts}=e;var k=[];if(r&&t===void 0&&(c&&c(0,1),p)){var h=gi(p(0,1));k.push(h,h)}var w=()=>1-i,D=n.animate(k,{duration:l});return D.onfinish=()=>{var _=(t==null?void 0:t.t())??1-i;t==null||t.abort();var E=i-_,y=e.duration*Math.abs(E),H=[];if(y>0){var P=!1;if(p)for(var q=Math.ceil(y/16.666666666666668),Z=0;Z<=q;Z+=1){var X=_+E*m(Z/q),B=gi(p(X,1-X));H.push(B),P||(P=B.overflow==="hidden")}P&&(n.style.overflow="hidden"),w=()=>{var I=D.currentTime;return _+E*m(I/y)},c&&Jr(()=>{if(D.playState!=="running")return!1;var I=w();return c(I,1-I),!0})}D=n.animate(H,{duration:y,fill:"forwards"}),D.onfinish=()=>{w=()=>i,c==null||c(i,1-i),a()}},{abort:()=>{D&&(D.cancel(),D.effect=null,D.onfinish=Ie)},deactivate:()=>{a=Ie},reset:()=>{i===0&&(c==null||c(1,0))},t:()=>w()}}function $n(n,e,t=e){var i=Lt();li(n,"input",a=>{var r=a?n.defaultValue:n.value;if(r=Wn(n)?Pn(r):r,t(r),i&&r!==(r=e())){var s=n.selectionStart,o=n.selectionEnd;n.value=r??"",o!==null&&(n.selectionStart=s,n.selectionEnd=Math.min(o,n.value.length))}}),Ye(e)==null&&n.value&&t(Wn(n)?Pn(n.value):n.value),Tn(()=>{var a=e();Wn(n)&&a===Pn(n.value)||n.type==="date"&&!a&&!n.value||a!==n.value&&(n.value=a??"")})}const Sn=new Set;function bt(n,e,t,i,a=i){var r=t.getAttribute("type")==="checkbox",s=n;if(e!==null)for(var o of e)s=s[o]??(s[o]=[]);s.push(t),li(t,"change",()=>{var l=t.__value;r&&(l=ns(s,l,t.checked)),a(l)},()=>a(r?[]:null)),Tn(()=>{var l=i();r?(l=l||[],t.checked=l.includes(t.__value)):t.checked=Ji(t.__value,l)}),ii(()=>{var l=s.indexOf(t);l!==-1&&s.splice(l,1)}),Sn.has(s)||(Sn.add(s),vt(()=>{s.sort((l,p)=>l.compareDocumentPosition(p)===4?-1:1),Sn.delete(s)})),vt(()=>{})}function ns(n,e,t){for(var i=new Set,a=0;a<n.length;a+=1)n[a].checked&&i.add(n[a].__value);return t||i.delete(e),Array.from(i)}function Wn(n){var e=n.type;return e==="number"||e==="range"}function Pn(n){return n===""?null:+n}function va(n,e,t){if(n.multiple)return rs(n,e);for(var i of n.options){var a=Yt(i);if(Ji(a,e)){i.selected=!0;return}}(!t||e!==void 0)&&(n.selectedIndex=-1)}function is(n,e){Ot(()=>{var t=new MutationObserver(()=>{var i=n.__value;va(n,i)});return t.observe(n,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value"]}),()=>{t.disconnect()}})}function as(n,e,t=e){var i=!0;li(n,"change",a=>{var r=a?"[selected]":":checked",s;if(n.multiple)s=[].map.call(n.querySelectorAll(r),Yt);else{var o=n.querySelector(r)??n.querySelector("option:not([disabled])");s=o&&Yt(o)}t(s)}),Ot(()=>{var a=e();if(va(n,a,i),i&&a===void 0){var r=n.querySelector(":checked");r!==null&&(a=Yt(r),t(a))}n.__value=a,i=!1}),is(n)}function rs(n,e){for(var t of n.options)t.selected=~e.indexOf(Yt(t))}function Yt(n){return"__value"in n?n.__value:n.value}function Bi(n,e){return n===e||(n==null?void 0:n[nt])===e}function ss(n={},e,t,i){return Ot(()=>{var a,r;return Tn(()=>{a=r,r=[],Ye(()=>{n!==t(...r)&&(e(n,...r),a&&Bi(t(...a),n)&&e(null,...a))})}),()=>{vt(()=>{r&&Bi(t(...r),n)&&e(null,...r)})}}),n}function Le(n=!1){const e=fe,t=e.l.u;if(!t)return;let i=()=>Pr(e.s);if(n){let a=0,r={};const s=Dt(()=>{let o=!1;const l=e.s;for(const p in l)l[p]!==r[p]&&(r[p]=l[p],o=!0);return o&&a++,a});i=()=>A(s)}t.b.length&&Dr(()=>{Ei(e,i),Ln(t.b)}),wi(()=>{const a=Ye(()=>t.m.map(Oa));return()=>{for(const r of a)typeof r=="function"&&r()}}),t.a.length&&wi(()=>{Ei(e,i),Ln(t.a)})}function Ei(n,e){if(n.l.s)for(const t of n.l.s)A(t);e()}function ga(n,e,t){if(n==null)return e(void 0),Ie;const i=Ye(()=>n.subscribe(e,t));return i.unsubscribe?()=>i.unsubscribe():i}const _t=[];function os(n,e=Ie){let t=null;const i=new Set;function a(o){if(ji(n,o)&&(n=o,t)){const l=!_t.length;for(const p of i)p[1](),_t.push(p,n);if(l){for(let p=0;p<_t.length;p+=2)_t[p][0](_t[p+1]);_t.length=0}}}function r(o){a(o(n))}function s(o,l=Ie){const p=[o,l];return i.add(p),i.size===1&&(t=e(a,r)||Ie),o(n),()=>{i.delete(p),i.size===0&&t&&(t(),t=null)}}return{set:a,update:r,subscribe:s}}function As(n){let e;return ga(n,t=>e=t)(),e}let sn=!1,Yn=Symbol();function ls(n,e,t){const i=t[e]??(t[e]={store:null,source:Wt(void 0),unsubscribe:Ie});if(i.store!==n&&!(Yn in t))if(i.unsubscribe(),i.store=n??null,n==null)i.source.v=void 0,i.unsubscribe=Ie;else{var a=!0;i.unsubscribe=ga(n,r=>{a?i.source.v=r:Q(i.source,r)}),a=!1}return n&&Yn in t?As(n):A(i.source)}function ds(){const n={};function e(){ii(()=>{for(var t in n)n[t].unsubscribe();Oi(n,Yn,{enumerable:!1,value:!0})})}return[n,e]}function ps(n){var e=sn;try{return sn=!1,[n(),sn]}finally{sn=e}}function ce(n,e,t,i){var X;var a=(t&ar)!==0,r=!Qt||(t&rr)!==0,s=(t&or)!==0,o=(t&Ar)!==0,l=!1,p;s?[p,l]=ps(()=>n[e]):p=n[e];var c=nt in n||Za in n,m=s&&(((X=Ft(n,e))==null?void 0:X.set)??(c&&e in n&&(B=>n[e]=B)))||void 0,k=i,h=!0,w=!1,D=()=>(w=!0,h&&(h=!1,o?k=Ye(i):k=i),k);p===void 0&&i!==void 0&&(m&&r&&Ga(),p=D(),m&&m(p));var _;if(r)_=()=>{var B=n[e];return B===void 0?D():(h=!0,w=!1,B)};else{var E=(a?Dt:Ce)(()=>n[e]);E.f|=$i,_=()=>{var B=A(E);return B!==void 0&&(k=void 0),B===void 0?k:B}}if(!(t&sr))return _;if(m){var y=n.$$legacy;return function(B,I){return arguments.length>0?((!r||!I||y||l)&&m(I?_():B),B):_()}}var H=!1,P=!1,q=Wt(p),Z=Dt(()=>{var B=_(),I=A(q);return H?(H=!1,P=!0,I):(P=!1,q.v=B)});return a||(Z.equals=ei),function(B,I){if(lt!==null&&(H=P,_(),A(q)),arguments.length>0){const ee=I?A(Z):r&&s?At(B):B;return Z.equals(ee)||(H=!0,Q(q,ee),w&&k!==void 0&&(k=ee),Ye(()=>A(Z))),B}return A(Z)}}const cs="5";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(cs);tr();class ks{constructor(e,t,i){d(this,"_dbname");d(this,"_dbversion");d(this,"dbPromise");d(this,"getTran",async(e,t)=>(await this.dbPromise).transaction(e,t));d(this,"reset",async()=>(await indexedDB.databases().then(e=>{console.log(e)}),await new Promise((e,t)=>{const i=indexedDB.deleteDatabase(this._dbname);i.onsuccess=()=>{console.log("onsuccess"),e()},i.onerror=a=>{console.log("onerror"),t(a)}})));d(this,"getAll",async e=>{const t=await this.dbPromise;return new Promise((i,a)=>{const o=t.transaction([e],"readonly").objectStore(e).getAll();o.onsuccess=()=>{i(o.result)},o.onerror=l=>{a(l)}})});d(this,"get",async(e,t)=>{const i=await this.dbPromise;return new Promise((a,r)=>{const l=i.transaction([e],"readonly").objectStore(e).get(t);l.onsuccess=()=>{a(l.result)},l.onerror=p=>{r(p)}})});d(this,"getMany",async(e,t)=>{const r=(await this.dbPromise).transaction([e],"readonly").objectStore(e),s=t.map(o=>new Promise((l,p)=>{const c=r.get(o);c.onsuccess=()=>{l(c.result)},c.onerror=m=>{p(m)}}));return await Promise.all(s)});d(this,"putRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),r=a.objectStore(e),s=t.map(o=>({record:o,request:r.put(o)}));return new Promise((o,l)=>{a.oncomplete=()=>o(s.map(p=>Object.assign({id:p.request.result},p.record))),a.onerror=p=>l(p)})});d(this,"deleteRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),r=a.objectStore(e),s=t.map(o=>({key:o,request:r.delete(o)}));return new Promise((o,l)=>{a.oncomplete=()=>{console.log(s.map(p=>p.request.result)),o()},a.onerror=p=>l(p)})});this._dbname=e,this._dbversion=t,this.dbPromise=new Promise((a,r)=>{const s=indexedDB.open(e,t);s.onsuccess=o=>{if(console.log(o),!o.target){console.log("event.target is undefined"),r("event.target is undefined");return}const l=o.target.result;if(!l){console.log("event.target.result is undefined"),r("event.target.result is undefined");return}l.onversionchange=p=>{console.log(p),l.close()},a(l)},s.onupgradeneeded=o=>{console.log("onupgradeneeded");const l=o.target.result;i.filter(p=>!l.objectStoreNames.contains(p)).map(p=>l.createObjectStore(p,{keyPath:"id",autoIncrement:!0}))},s.onerror=o=>{console.log(o),r(o)},s.onblocked=o=>{console.log(o),r(o)}}),console.log(this.dbPromise)}get dbversion(){return this._dbversion}}class He{constructor(){d(this,"handlers",[])}append(e){this.handlers.push(e)}remove(e){this.handlers=this.handlers.filter(t=>t!==e)}trigger(e){this.handlers.slice(0).forEach(t=>t(e))}clear(){this.handlers.splice(0)}expose(){return this}}class xi{constructor(){d(this,"handler")}set(e){this.handler=e}async call(e){if(!this.handler)throw Error("illegal state error");return await this.handler(e)}expose(){return this}}class pi{constructor(e,t,i,a){d(this,"_name");d(this,"_createVersion");d(this,"mountResolver",()=>{});d(this,"_indexedDb");d(this,"onInsertEvent",new He);d(this,"onBeforeInsertEvent",new xi);d(this,"onUpdateEvent",new He);d(this,"onBeforeUpdateEvent",new xi);d(this,"onDeleteEvent",new He);d(this,"prepareInitialRecords",()=>{const e=new Date;return this._prepareInitialRecords().map(t=>Object.assign(t,{createdAt:e,updatedAt:e,dbVersion:this._createVersion}))});d(this,"resolveMount",()=>this.mountResolver());d(this,"patchForInsert",(e,t)=>{e.newRecords.forEach(i=>{console.log(i),t[i.id]=i})});d(this,"patchForUpdate",(e,t)=>{e.recordPairs.forEach(i=>{console.log(t[i.newRecord.id],i.newRecord),t[i.newRecord.id]={...i.newRecord}})});d(this,"patchForDelete",(e,t)=>{e.oldRecords.forEach(i=>{console.log(i),delete t[i.id]})});this._indexedDb=e,this._name=t,this._createVersion=e.dbversion,this.getAll().then(r=>r.reduce((s,o)=>(s[o.id]=o,s),{})).then(r=>{console.log(this.name,r),this.onBeforeInsertEvent.set(i??(()=>Promise.resolve())),this.onBeforeUpdateEvent.set(a??(()=>Promise.resolve()))})}get name(){return this._name}get createVersion(){return this._createVersion}get oninsert(){return this.onInsertEvent.expose()}get onbeforeinsert(){return this.onBeforeInsertEvent.expose()}get onupdate(){return this.onUpdateEvent.expose()}get onbeforeupdate(){return this.onBeforeUpdateEvent.expose()}get ondelete(){return this.onDeleteEvent.expose()}getAll(){return this._indexedDb.getAll(this.name)}get(e){return this._indexedDb.get(this.name,e)}async insertMany(e){const t=new Date,i=e.map(r=>{const s={createdAt:t,updatedAt:t,dbVersion:this._createVersion};return Object.assign(r,s)});await this.onBeforeInsertEvent.call({sender:this,newRecords:i,timestamp:t});const a=await this._indexedDb.putRecords(this.name,i);return this.onInsertEvent.trigger({sender:this,newRecords:a,timestamp:t}),a}async insert(e){return(await this.insertMany([e]))[0]}async updateMany(e,t){const i=new Date,a=[];return(await this._indexedDb.getMany(this.name,e)).forEach(s=>{const o={...s},l={...o};a.push({newRecord:Object.assign(t(l),{updatedAt:i,dbVersion:this._createVersion}),oldRecord:o})}),await this.onBeforeUpdateEvent.call({sender:this,recordPairs:a,timestamp:i}),await this._indexedDb.putRecords(this.name,a.map(s=>s.newRecord)),this.onUpdateEvent.trigger({sender:this,recordPairs:a,timestamp:i}),a.map(s=>s.newRecord)}async update(e,t){return(await this.updateMany([e],t))[0]}async delete(e){const t=new Date,i=await this._indexedDb.getMany(this.name,e);await this._indexedDb.deleteRecords(this.name,e),this.onDeleteEvent.trigger({sender:this,oldRecords:i,timestamp:t})}}const ms={"１３人目の埋葬者":{name:"１３人目の埋葬者",nameKana:"",description:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",pendulumDescription:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",kind:"Monster",monsterCategories:["Normal"],level:3,attack:1200,defense:900,attribute:"Dark",type:"Zombie",wikiName:"《１３人目の埋葬者》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%A3%B1%A3%B3%BF%CD%CC%DC%A4%CE%CB%E4%C1%F2%BC%D4%A1%D5",wikiTextAll:`通常モンスター
...
(1)：デッキから「トゥーン」カード１枚を手札に加える。`},紫炎の狼煙:{name:"紫炎の狼煙",nameKana:"",description:"(1)：デッキからレベル３以下の「六武衆」モンスター１体を手札に加える。 ",kind:"Spell",spellCategory:"Normal",wikiName:"《紫炎の狼煙》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%BB%E7%B1%EA%A4%CE%CF%B5%B1%EC%A1%D5",wikiTextAll:`通常魔法
...
この効果で特殊召喚したモンスターは攻撃できず、エンドフェイズに破壊される。`,kind:"Spell",spellCategory:"Normal",wikiName:"《簡易融合》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%B4%CA%B0%D7%CD%BB%B9%E7%A1%D5",wikiTextAll:`通常魔法（制限カード）
このカード名のカードは１ターンに１枚しか発動できない。
(1)：１０００ＬＰを払って発動できる。
レベル５以下の融合モンスター１体を融合召喚扱いとしてＥＸデッキから特殊召喚する。
この効果で特殊召喚したモンスターは攻撃できず、エンドフェイズに破壊される。`},"テラ・フォーミング":{name:"テラ・フォーミング",nameKana:"",description:"(1)：デッキからフィールド魔法カード１枚を手札に加える。",kind:"Spell",spellCategory:"Normal",wikiName:"《テラ・フォーミング》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%A5%C6%A5%E9%A1%A6%A5%D5%A5%A9%A1%BC%A5%DF%A5%F3%A5%B0%A1%D5",wikiTextAll:`通常魔法（制限カード）
...
デッキから「Ｄ－ＨＥＲＯ ディアボリックガイ」１体を特殊召喚する。`,nameTags:["Ｄ－ＨＥＲＯ"]}},us=["Deck","ExtraDeck"],hs={Deck:"メインデッキ",ExtraDeck:"エクストラデッキ"},zn=["Monster","Spell","Trap"],Ba={Monster:"モンスター",Spell:"魔法",Trap:"罠"},Gt=["Fusion","Syncro","Xyz","Link"],Ea=[...Gt,"SpecialSummon"],ws=["Toon","Spirit","Union","Gemini","FlipEffect"],fs=["Tuner","Effect","Normal","Pendulum","Token"],Ti=[...Ea,...ws,...fs],_n={Syncro:"シンクロ",Fusion:"融合",Xyz:"エクシーズ",Link:"リンク",SpecialSummon:"特殊召喚",Toon:"トゥーン",Spirit:"スピリット",Union:"ユニオン",Gemini:"デュアル",FlipEffect:"リバース",Tuner:"チューナー",Effect:"効果",Normal:"通常",Pendulum:"ペンデュラム",Token:"トークン"},Jt={Syncro:"🎵",Fusion:"🌀",Xyz:"📰",Link:"⛓️",SpecialSummon:"🔯",Toon:"📖",Spirit:"👻",Union:"🚗",Gemini:"👫",FlipEffect:"🔄",Tuner:"🎶",Effect:"✨",Normal:"🔘",Pendulum:"💠",Token:"🐏"},Mi=["Light","Dark","Earth","Water","Fire","Wind","Divine"],ci={Light:"光",Dark:"闇",Earth:"地",Water:"水",Fire:"炎",Wind:"風",Divine:"神"},Ni=["Aqua","Beast","BeastWarrior","CreatorGod","Cyberse","Dinosaur","DivineBeast","Dragon","Fairy","Fiend","Fish","Insect","Illusion","Machine","Plant","Psychic","Pyro","Reptile","Rock","SeaSerpent","Spellcaster","Thunder","Warrior","WingedBeast","Wyrm","Zombie"],bi=["Normal","Continuous","Field","QuickPlay","Equip","Ritual"],en={Normal:"通常",Continuous:"永続",Field:"フィールド",QuickPlay:"速攻",Equip:"装備",Ritual:"儀式"},_i=["Normal","Continuous","Counter"],tn={Normal:"通常",Continuous:"永続",Counter:"カウンター"},Fn={Aqua:"水",Beast:"獣",BeastWarrior:"獣戦士",CreatorGod:"創造神",Cyberse:"サイバース",Dinosaur:"恐竜",DivineBeast:"幻獣神",Dragon:"ドラゴン",Fairy:"天使",Fiend:"悪魔",Fish:"魚",Insect:"昆虫",Illusion:"幻想魔",Machine:"機械",Plant:"植物",Psychic:"サイキック",Pyro:"炎",Reptile:"爬虫類",Rock:"岩石",SeaSerpent:"海竜",Spellcaster:"魔法使い",Thunder:"雷",Warrior:"戦士",WingedBeast:"鳥獣",Wyrm:"幻竜",Zombie:"アンデット"},nn={Aqua:"🚰",Beast:"🐅",BeastWarrior:"🦁",CreatorGod:"🔆",Cyberse:"💻️",Dinosaur:"🦖",DivineBeast:"💫",Dragon:"🐲",Fairy:"👼",Fiend:"👿",Fish:"🐟️",Insect:"🦋",Illusion:"🤡",Machine:"🤖",Plant:"🌱",Psychic:"👁️",Pyro:"🔥",Reptile:"🦎",Rock:"⛰",SeaSerpent:"🐍",Spellcaster:"🧙",Thunder:"⚡️",Warrior:"⚔️",WingedBeast:"🦅",Wyrm:"🐉",Zombie:"🦴"},Ke=class Ke{constructor(e){d(this,"id");d(this,"name");d(this,"description");d(this,"save",async e=>{const t=e??{id:this.id,name:this.name,description:this.description},i=await Ke.tblHeader.update(this.id,a=>({...a,...t}));return new Ke(i)});this.id=e.id,this.name=e.name,this.description=e.description}};d(Ke,"tblHeader"),d(Ke,"getOrCreateNew",async e=>{Ke.tblHeader||(Ke.tblHeader=new Cs(e));const t=await Ke.tblHeader.getAll();if(t.length)return new Ke(t[0]);const i=await Ke.tblHeader.insert({name:"あなた",description:"ここの文字列を何に使うかは未定。"});return new Ke(i)});let jn=Ke;class Cs extends pi{constructor(t){super(t,"TblDuelistProfile");d(this,"_prepareInitialRecords",()=>[])}}let Ds=-1;const ys=[{id:Ds--,name:"NPC",description:""}];class Fi{constructor(e,t,i,a,r){d(this,"duel");d(this,"seat");d(this,"_entity");d(this,"profile");d(this,"deckInfo");d(this,"duelistType");d(this,"lifeLog");d(this,"normalSummonCount");d(this,"specialSummonCount");d(this,"maxNormalSummonCount");d(this,"_lp");d(this,"battleDamage",(e,t)=>this.setLp(this._lp-e,t,"BattleDamage"));d(this,"effectDamage",(e,t)=>this.setLp(this._lp-e,t,"EffectDamage"));d(this,"lostLp",(e,t)=>this.setLp(this._lp-e,t,"Lost"));d(this,"payLp",(e,t)=>this.setLp(this._lp-e,t,"Pay"));d(this,"heal",(e,t)=>this.setLp(this._lp+e,t,"Heal"));d(this,"setLp",(e,t,i)=>{const a={clock:this.duel.clock,reason:i||"Set",beforeLp:this._lp,afterLp:e,entity:t};return this.lifeLog.push(a),this._lp=e,this.duel.log.info(`ライフポイント変動：${a.afterLp-a.beforeLp}（${a.beforeLp} ⇒ ${a.afterLp}）`,this),a});d(this,"getOpponentPlayer",()=>this.duel.firstPlayer===this?this.duel.secondPlayer:this.duel.firstPlayer);d(this,"getHandCell",()=>this.duel.field.getCells("Hand").filter(e=>e.owner===this)[0]);d(this,"getDeckCell",()=>this.duel.field.getCells("Deck").filter(e=>e.owner===this)[0]);d(this,"getExtraDeck",()=>this.duel.field.getCells("ExtraDeck").filter(e=>e.owner===this)[0]);d(this,"getGraveyard",()=>this.duel.field.getCells("Graveyard").filter(e=>e.owner===this)[0]);d(this,"getFieldZone",()=>this.duel.field.getCells("FieldSpellZone").filter(e=>e.owner===this)[0]);d(this,"getBanished",()=>this.duel.field.getCells("Banished").filter(e=>e.owner===this)[0]);d(this,"getMonsterZones",()=>this.duel.field.getCells("MonsterZone").filter(e=>e.owner===this));d(this,"getExtraMonsterZones",()=>this.duel.field.getCells("ExtraMonsterZone").filter(e=>{var t;return((t=e.cardEntities[0])==null?void 0:t.controller)===this}));d(this,"getSpellTrapZones",()=>this.duel.field.getCells("SpellAndTrapZone").filter(e=>e.owner===this));d(this,"getEmptyMonsterZones",()=>this.getMonsterZones().filter(e=>e.cardEntities.length===0));d(this,"getEmptyExtraZones",()=>this.getExtraMonsterZones().length===0?this.getMonsterZones().filter(e=>e.cardEntities.length===0):[]);d(this,"getAvailableMonsterZones",()=>this.getMonsterZones().filter(e=>e.isAvailable));d(this,"getAvailableExtraZones",()=>this.getExtraMonsterZones().length===0?this.duel.field.getCells("ExtraMonsterZone").filter(e=>e.isAvailable):[]);d(this,"getAvailableSpellTrapZones",()=>this.getSpellTrapZones().filter(e=>e.isAvailable));d(this,"getReleasableMonsters",()=>this.getMonstersOnField());d(this,"getMonstersOnField",()=>this.duel.field.getMonstersOnField().filter(e=>e.controller===this));d(this,"getAttackTargetMonsters",()=>this.duel.field.getMonstersOnField().filter(e=>e.status.isSelectableForAttack&&e.controller!==this));d(this,"draw",async(e,t)=>{const i=await this.duel.field.draw(this,e,t);if(!i)throw new pt(this.getOpponentPlayer());return i});d(this,"shuffleDeck",()=>{this.getDeckCell().shuffle(),this.duel.log.info("デッキをシャッフル。",this)});this.duel=e,this.seat=t,this.profile=i,this.duelistType=a,this.deckInfo=r,this.lifeLog=[],this.normalSummonCount=0,this.specialSummonCount=0,this.maxNormalSummonCount=1,this._lp=8e3}get entity(){const e=this.getHandCell().entities.find(t=>t.entityType==="Duelist");return e||wt.createPlayerEntity(this)}get lp(){return this._lp}get isTurnPlayer(){return this.duel.getTurnPlayer()===this}}Array.prototype.shuffle=function(){return this.map(e=>({item:e,seq:Math.random()})).toSorted((e,t)=>e.seq-t.seq).map(e=>e.item)};Array.prototype.randomPick=function(n){return this.shuffle().slice(0,n)};Array.prototype.reset=function(...n){this.splice(0),this.push(...n)};Array.prototype.union=function(n){return this.filter(n.includes,n)};Array.prototype.getAllOnOffPattern=function(){const n=[];return this.forEach(e=>{if(n.length==0){n.push([e]),n.push([]);return}n.forEach(t=>n.push([...t,e]))}),n};const Gn={0:{0:"Hand"},1:{0:"Deck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"ExtraDeck"},2:{0:"Graveyard",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"FieldSpellZone"},3:{0:"Banished",1:"Disable",2:"ExtraMonsterZone",3:"Disable",4:"ExtraMonsterZone",5:"Disable",6:"Banished"},4:{0:"FieldSpellZone",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"Graveyard"},5:{0:"ExtraDeck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"Deck"},6:{0:"Hand"}};class vs{constructor(e,t,i,a){d(this,"onUpdateEvent",new He);d(this,"field");d(this,"row");d(this,"column");d(this,"cellType");d(this,"owner");d(this,"_entities");d(this,"releaseEntities",(e,t,i)=>(this._entities=this._entities.filter(a=>!e.includes(a)),e.forEach(a=>{a.movedAs.splice(0),a.movedAs.push(...new Set(t)),a.movedAt=a.field.duel.clock,a.movedBy=i,a.movedFrom=this}),this.onUpdateEvent.trigger(),e));d(this,"acceptEntities",(e,t)=>{t==="Bottom"?this._entities.push(...e):t==="Top"&&this._entities.unshift(...e),this._entities.forEach(i=>{i.fieldCell=this}),this.onUpdateEvent.trigger()});d(this,"shuffle",()=>{this._entities=this.entities.shuffle()});this.field=e,this.row=t,this.column=i,this.cellType=Gn[t][i],this.owner=a,this._entities=[]}get onUpdate(){return this.onUpdateEvent.expose()}get entities(){return this._entities}get cardEntities(){return this._entities.filter(e=>Ls.find(t=>t===e.entityType))}get targetForAttack(){return this.cellType==="Hand"?this._entities.find(e=>e.entityType==="Duelist"):this.cardEntities[0]}get isAvailable(){return this._entities.length===0}}class gs{constructor(e){d(this,"cells");d(this,"duel");d(this,"getAllCells",()=>this.cells.flat());d(this,"getCells",(...e)=>this.getAllCells().filter(t=>e.includes(t.cellType)));d(this,"getAllEntities",()=>this.getAllCells().map(e=>e.entities).flat());d(this,"getAllCardEntities",()=>this.getAllCells().map(e=>e.cardEntities).flat());d(this,"getMonstersOnField",()=>this.getCells("MonsterZone","ExtraMonsterZone").map(e=>e.cardEntities).filter(e=>e.length>0).map(e=>e[0]).filter(e=>e.entityType!=="Squatter"));d(this,"getEntities",e=>this.getAllEntities().filter(t=>t.controller===e));d(this,"pushDeck",e=>{e.deckInfo.cardNames.map(t=>Te[t]).filter(t=>t).forEach(t=>wt.createCardEntity(this,e,t)),this.duel.log.info(`デッキをセット。メイン${e.getDeckCell().cardEntities.length}枚。エクストラ${e.getExtraDeck().cardEntities.length}枚。`,e)});d(this,"prepareHands",async e=>await this.draw(e,5));d(this,"draw",async(e,t,i)=>{const a=await this._draw(e,t,i);if(!a)throw new pt(e.getOpponentPlayer());return a});d(this,"drawSameTime",async(e,t,i,a,r)=>{const s=await this._draw(e,t,r),o=await this._draw(i,t,r);if(s&&o)return!0;throw s?new pt(e):o?new pt(e):new pt});d(this,"_draw",async(e,t,i)=>{var s;if(t<1)return!0;const a=e.getDeckCell(),r=[];for(const o of Array(t)){if(!a.cardEntities.length)return this.duel.log.info(r.length>0?`デッキからカードを${t}枚ドローしようとしたが、${r.length}枚しかドローできなかった。${r}`:"デッキからカードをドローできなかった。",e),this.duel.isEnded=!0,e.setLp(0),!1;const l=a.cardEntities[0];await l.draw(i?["Effect"]:["Rule"],i),r.push(((s=l.origin)==null?void 0:s.name)||"!名称取得失敗!")}return this.duel.log.info(`デッキからカードを${r.length}枚ドロー。${r}。`,e),!0});d(this,"payMonstersForSpecialSummonCost",async(e,t,i,a,r,s,o)=>{if(i>0&&t.length<i)return;const l=await this.duel.view.waitSelectEntities(e,t,i,a,"素材とするモンスターを選択",o);if(console.log(l),!!l){for(const p of l)await p.release(["Release",...r],s);return this.duel.log.info(`${l.map(p=>p.status.name).join(", ")}を素材とした（${[...new Set(l.flatMap(p=>p.movedAs))].join(", ")}）。`,e),l}});d(this,"release",async(e,t,i,a,r,s,o,l)=>{if(i>0&&t.length<i)return;const p=await this.duel.view.waitSelectEntities(e,t,i,m=>(o||m.length>0)&&(i<0||m.length===i),"リリースするモンスターを選択",l);if(!p)return;const c=[];for(const m of p)await m.release(["Release",a,...r],s),c.push(m);return this.duel.log.info(`${c.map(m=>m.status.name).join(", ")}をリリース（${[...new Set(c.flatMap(m=>m.movedAs))].join(", ")}）。`,e),c});d(this,"discard",async(e,t,i,a,r,s)=>{const o=s||(()=>!0),l=e.getHandCell().cardEntities.filter(o);if(l.length<t)return[];let p=[];return(r||e).duelistType==="NPC"?p=l.randomPick(t):p=await this.duel.view.waitSelectEntities(r||e,l,t,c=>c.length===t,`${t}枚カードを捨てる。`,!1)||[],await this._sendGraveyardMany(p,["Discard",...i],a),this.duel.log.info(`手札からカードを${p.length}枚捨てた。${p.map(c=>{var m;return(m=c.origin)==null?void 0:m.name})}。`,e),p});d(this,"summonMany",async(e,t,i,a,r,s,o)=>{const l=await Promise.all(e.map(async p=>this._summon(p,t(p),i(p),a,r,s,o?o(p):void 0)));if(l.find(p=>!p))throw new ct("想定されない返却値",l);return l});d(this,"summon",async(e,t,i,a,r,s,o,l=!1)=>{const p=await this._summon(e,t,i,a,r,s,o,l);if(p)return this.duel.log.info(`${p.status.name}を召喚（${[...r,a].join(",")}）。`,o??(s==null?void 0:s.controller)??e.controller),p});d(this,"_summon",async(e,t,i,a,r,s,o,l=!1)=>{const p=o??(s==null?void 0:s.controller)??e.controller;let c=t.randomPick(1)[0],m=i.randomPick(1)[0];if((i.length>1||t.length>1)&&p.duelistType!=="NPC"){const k=t.map(D=>wt.createDammyAction(e,D,i,D));this.duel.view.modalController.selectAction(this.duel.view,{title:"カードを召喚先へドラッグ。",actions:k,cancelable:!1});const h=await this.duel.view.waitSubAction(p,k,"カードを召喚先へドラッグ。",l),w=h.actionWIP;if(!w&&!l)throw new ct("",h);if(!w)return;m=w.cell||m,c=w.pos||c}return console.log(m,c,a,r,s),await e.summon(m,c,a,r,s),e});d(this,"activateSpellTrapFromHand",async(e,t,i,a,r,s=!1)=>{const o=r??(a==null?void 0:a.controller)??e.controller;let l=t.randomPick(1)[0];if(t.length>1&&o.duelistType!=="NPC"){const p=[wt.createDammyAction(e,"カードの発動",t,void 0)];this.duel.view.modalController.selectAction(this.duel.view,{title:"カードを魔法罠ゾーンへドラッグ",actions:p,cancelable:!1});const c=await this.duel.view.waitSubAction(o,p,"カードを魔法罠ゾーンへドラッグ。",s),m=c.actionWIP;if(!m&&!s)throw new ct("",c);if(!m)return;l=m.cell||l}return await e.activateSpellTrapFromHand(l,i,a),e});d(this,"destroyMany",async(e,t,i)=>await this._sendGraveyardMany(e,[...t,"Destroy"],i));d(this,"sendGraveyardMany",async(e,t,i)=>await this._sendGraveyardMany(e,t,i));d(this,"_sendGraveyardMany",async(e,t,i)=>{for(const a of e)await a.sendGraveyard(t,i);return e.filter(a=>a.entityType!=="Token")});d(this,"setSpellTrap",async(e,t,i,a,r=!1)=>{let s=t[0];const o=a??(i==null?void 0:i.controller)??e.controller;if(t.length>1&&o.duelistType!=="NPC"){const l=[wt.createDammyAction(e,"セット",t)],p=this.duel.view.modalController.selectAction(this.duel.view,{title:"カードをセット先へドラッグ",actions:l,cancelable:r}),c=this.duel.view.waitSubAction(o,l,"カードをセット先へドラッグ",r),m=await Promise.any([p,c.then(k=>k.actionWIP)]);if(!m&&!r)throw new ct("",m);if(!m)return;s=m.cell||s}await e.setAsSpellTrap(s,["SpellTrapSet"],i),this.duel.log.info(`${e.status.name}をセット（SpellTrapSet）。`,a??(i==null?void 0:i.controller)??e.controller)});this.duel=e,this.cells=[...Array(7)].map(()=>[]);for(const t of Object.keys(Gn).map(Number))for(const i of Object.keys(Gn[t]).map(Number))this.cells[t][i]=new vs(this,t,i,t<3?e.duelists.Above:t>3?e.duelists.Below:void 0)}}let Bs=class{constructor(e){d(this,"onUpdateEvent",new He);d(this,"nextSeq");d(this,"records",[]);d(this,"duel");d(this,"dispose",()=>{this.onUpdateEvent.clear()});d(this,"error",e=>{console.error(e);const t=["エラー発生"];e instanceof Error?(e instanceof ct&&(t.push("-- エラーメッセージ --"),t.push(e.message),t.push("-- 関連オブジェクト --"),e.items.forEach(i=>t.push(JSON.stringify(i)))),t.push("-- エラー名称 --"),t.push(e.name||"エラー名称取得失敗"),t.push("-- スタックトレース --"),t.push(e.stack||"スタックトレース取得失敗")):(t.push("-- エラー型特定失敗 --"),t.push(JSON.stringify(e))),this.info(t)});d(this,"info",(e,t)=>{const i=Array.isArray(e)?e.join(`
`):e;this.records.push({seq:this.nextSeq++,turn:this.duel.clock.turn,phase:this.duel.phase,phaseStep:this.duel.phaseStep,clock:this.duel.clock,duelist:t,text:i}),this.onUpdateEvent.trigger()});this.nextSeq=0,this.duel=e}get onUpdate(){return this.onUpdateEvent.expose()}};const Hi=["DuelEntitiesSelector","DuelActionSelector"];class Es{constructor(e){d(this,"onUpdateEvent",new He);d(this,"states");d(this,"view");d(this,"cancelAll",()=>{Hi.forEach(e=>this.states[e]="Disable"),console.info(this,"cancelAll"),this.onUpdateEvent.trigger()});d(this,"duelEntitiesSelectorArg",{title:"対象を選択",entities:[],validator:()=>!0,qty:-1,cancelable:!1});d(this,"duelEntitiesSelectorValue");d(this,"duelEntitiesSelectorResolve",()=>{});d(this,"selectDuelEntities",async e=>(this.duelEntitiesSelectorArg=e,this.states.DuelEntitiesSelector="Shown",this.onUpdateEvent.trigger(),new Promise(t=>{this.duelEntitiesSelectorResolve=i=>{this.states.DuelEntitiesSelector="Disable",this.onUpdateEvent.trigger(),t(i)}})));d(this,"cardActionSelectorArg",{title:"カード操作を選択。",actions:[],cancelable:!1});d(this,"cardActionSelectorResolve",()=>{});d(this,"cardActionSelectorValue");d(this,"selectAction",async(e,t)=>(this.cardActionSelectorArg=t,this.states.DuelActionSelector="Shown",e.onWaitEnd.append(this.cancelAll),this.onUpdateEvent.trigger(),new Promise(i=>{this.cardActionSelectorResolve=a=>{this.states.DuelActionSelector="Disable",e.onWaitEnd.remove(this.cancelAll),this.onUpdateEvent.trigger(),i(a)}})));this.view=e,this.states=Hi.reduce((t,i)=>(t[i]="Disable",t),{})}get onUpdate(){return this.onUpdateEvent.expose()}}class xs{constructor(e){d(this,"onDuelUpdateEvent",new He);d(this,"requireUpdate",()=>{this.onDuelUpdateEvent.trigger()});d(this,"onWaitStartEvent",new He);d(this,"onWaitEndEvent",new He);d(this,"onDragStartEvent",new He);d(this,"onDragEndEvent",new He);d(this,"onAnimationStartEvent",new He);d(this,"onShowCardEntityEvent",new He);d(this,"duel");d(this,"modalController");d(this,"message");d(this,"waitMode");d(this,"infoBoardState");d(this,"infoBoardCell");d(this,"getCell",(e,t)=>this.duel.field.cells[e][t]);d(this,"showCardInfo",e=>{this.onShowCardEntityEvent.trigger(e)});d(this,"dispose",()=>{this.onDragStartEvent.clear(),this.onDragEndEvent.clear(),this.onDuelUpdateEvent.clear(),this.onWaitStartEvent.clear(),this.onWaitEndEvent.clear()});d(this,"waitFieldAction",async(e,t)=>{if(console.log(e),this.duel.getTurnPlayer().duelistType==="NPC"){const i=e.toSorted((a,r)=>(r.entity.atk||0)-(a.entity.atk||0)).find(a=>a.playType==="NormalSummon"||a.playType==="SpecialSummon");return i?{actionWIP:i}:{phaseChange:this.duel.nextPhaseList[0]}}return await this._waitDuelistAction(e,"SelectFieldAction",t)});d(this,"waitQuickEffect",async(e,t,i)=>{if(e.length===0)return;const a=[];return a.push(this.modalController.selectAction(this,{title:t,actions:e,cancelable:i}).then(r=>r&&r)),a.push(this._waitDuelistAction(e,"SelectAction",this.message).then(r=>r.actionWIP)),await Promise.any(a)});d(this,"waitSubAction",async(e,t,i,a=!1)=>{if(e.duelistType==="NPC")throw Error("Not implemented");return await this._waitDuelistAction(t,"SelectAction",i,void 0,void 0,void 0,a)});d(this,"waitSelectEntities",async(e,t,i,a,r,s=!1)=>{let o=[];if(i&&t.length===i)return[...t];if(e.duelistType==="NPC"){for(;!a(o);){const p=i&&i>0?i:Math.floor(Math.random()*t.length)+1;o=t.randomPick(p)}return o}this.waitMode=t.every(p=>(p.fieldCell.cellType==="MonsterZone"||p.fieldCell.cellType==="ExtraMonsterZone")&&p.getIndexInCell()===0||p.fieldCell.cellType==="Hand"&&p.controller===e)?"SelectFieldEntities":"SelectEntities",console.log(this.waitMode);const l=await this._waitDuelistAction([],this.waitMode,r,t,i,a,s);return console.log(l),l.selectedEntities});d(this,"_waitDuelistAction",async(e,t,i,a,r,s,o=!1)=>{this.waitMode=t,this.message=i,this.onDuelUpdateEvent.trigger();const l=await new Promise(p=>{const c={resolve:p,enableActions:e,qty:r,entitiesValidator:s||(()=>!1),selectableEntities:a||[]};console.log(a),console.log(s),console.log(this.waitMode),console.log(this.waitMode==="SelectEntities"),a&&s&&this.waitMode==="SelectEntities"&&(c.duelEntitiesSelectorArg={title:i,entities:a,validator:s,qty:r??-1,cancelable:!1}),this.onWaitStartEvent.trigger(c)});if(this.waitMode="None",this.onWaitEndEvent.trigger(),l.surrender)throw new pt(this.duel.duelists.Above);if(!o&&l.cancel)throw new ct("キャンセル不可のアクションがキャンセルされた。",l,e,t,a);return l});d(this,"waitAnimation",async e=>(this.onDuelUpdateEvent.trigger(),new Promise(t=>this.onAnimationStartEvent.trigger({...e,resolve:t}))));d(this,"setDraggingActions",e=>{this.onDragStartEvent.trigger(e),this.requireUpdate()});d(this,"removeDraggingActions",()=>{this.onDragEndEvent.trigger()});this.duel=e,this.message="",this.waitMode="None",this.infoBoardState="Log",this.infoBoardCell=e.duelists.Below.getExtraDeck(),this.modalController=new Es(this)}get onDuelUpdate(){return this.onDuelUpdateEvent.expose()}get onWaitStart(){return this.onWaitStartEvent.expose()}get onWaitEnd(){return this.onWaitEndEvent.expose()}get onDragStart(){return this.onDragStartEvent.expose()}get onDragEnd(){return this.onDragEndEvent.expose()}get onAnimation(){return this.onAnimationStartEvent.expose()}get onShowCardEntity(){return this.onShowCardEntityEvent.expose()}}class Ts{constructor(){d(this,"_turn",0);d(this,"_phaseSeq",0);d(this,"_stepSeq",0);d(this,"_chainSeq",0);d(this,"_chainBlockSeq",0);d(this,"_procSeq",0);d(this,"_procTotalSeq",0);d(this,"incrementTurn",()=>{this._turn++,this._phaseSeq=0,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementPhaseSeq",()=>{this._phaseSeq++,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementStepSeq",()=>{this._stepSeq++,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementChainSeq",()=>{this._chainSeq++,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementChainBlockSeq",()=>{this._chainBlockSeq++,this._procSeq=0});d(this,"incrementProcSeq",()=>{this._procSeq++,this._procTotalSeq++});d(this,"toString",()=>`${this.procTotalSeq}(t${this.turn}-p${this.phaseSeq}-ps${this.stepSeq}-c${this.chainSeq}-cb${this.chainBlockSeq}-p${this.procSeq})`)}get turn(){return this._turn}get phaseSeq(){return this._phaseSeq}get stepSeq(){return this._stepSeq}get chainSeq(){return this._chainSeq}get chainBlockSeq(){return this._chainBlockSeq}get procSeq(){return this._procSeq}get procTotalSeq(){return this._procTotalSeq}}class pt extends Error{constructor(t){const i=t?`デュエルが終了した。勝者：${t.profile.name}`:"デュエルが終了した。ドロー。";super(i);d(this,"winner");this.winner=t}}class ct extends Error{constructor(t,...i){super("message");d(this,"message");d(this,"items");this.message=t,this.items=i}}class Ms{constructor(e,t,i,a,r,s){d(this,"view");d(this,"log");d(this,"clock");d(this,"phase");d(this,"phaseStep");d(this,"nextPhaseList");d(this,"field");d(this,"attackingMonster");d(this,"targetForAttack");d(this,"duelists");d(this,"priorityHolder");d(this,"isEnded");d(this,"coin",!1);d(this,"getTurnPlayer",()=>this.clock.turn%2===0?this.secondPlayer:this.firstPlayer);d(this,"getNonTurnPlayer",()=>this.clock.turn%2===0?this.firstPlayer:this.secondPlayer);d(this,"main",async()=>{console.info("main start!"),this.coin=Math.random()>.5,this.priorityHolder=this.firstPlayer,this.log.info("【デュエル開始】"),this.log.info(`先攻：${this.firstPlayer.profile.name}`),Object.values(this.duelists).forEach(this.field.pushDeck),Object.values(this.duelists).forEach(e=>e.shuffleDeck()),await Promise.all(Object.values(this.duelists).map(this.field.prepareHands)),console.log("hoge"),this.moveNextPhase("draw"),this.view.requireUpdate();try{for(;!this.isEnded&&(this.phase==="draw"?await this.procDrawPhase():this.phase==="standby"?await this.procStanbyPhase():this.phase==="main1"?await this.procMainPhase():this.phase==="battle"?await this.procBattlePhase():this.phase==="main2"?await this.procMainPhase():this.phase==="end"&&await this.procEndPhase(),!(this.clock.turn>1e3)););}catch(e){e instanceof pt?(console.info(e),this.isEnded=!0,this.log.info(e.winner?`デュエル終了。勝者${e.winner.profile.name}`:"引き分け")):e instanceof Error&&this.log.error(e)}finally{this.view.requireUpdate(),this.view.dispose(),this.log.dispose()}});d(this,"moveNextPhase",e=>{e==="draw"?this.clock.incrementTurn():this.clock.incrementPhaseSeq(),this.clock.turn<1?this.phase="draw":e==="draw"?this.log.info("ターン終了。",this.getTurnPlayer()):this.log.info(`フェイズ移行（${this.phase}→${e}）`,this.getTurnPlayer()),this.phase=e,this.phaseStep=void 0,this.phase==="main2"||this.clock.turn===1?this.nextPhaseList=["end"]:this.phase==="battle"?this.nextPhaseList=["main2"]:this.phase==="main1"?this.nextPhaseList=["battle","end"]:this.nextPhaseList=[]});d(this,"declareAnAttack",(e,t)=>{this.attackingMonster=e,this.targetForAttack=t,e.status.attackCount++,this.log.info(`攻撃宣言：${e.status.name} ⇒ ${t.status.name}`,e.controller)});d(this,"procDrawPhase",async()=>{for(Object.values(this.duelists).forEach(e=>{e.normalSummonCount=0,e.specialSummonCount=0}),this.log.info("ドローフェイズ開始。",this.getTurnPlayer()),this.clock.turn===1?this.log.info("先攻プレイヤーはドローできない。",this.getTurnPlayer()):await this.field.draw(this.getTurnPlayer(),1);await this.procChainBlock(););this.field.getMonstersOnField().forEach(e=>{e.status.attackCount=0,e.status.battlePotisionChangeCount=0}),this.moveNextPhase("standby")});d(this,"procStanbyPhase",async()=>{for(;await this.procChainBlock(););this.moveNextPhase("main1")});d(this,"procMainPhase",async()=>{for(;;){this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["NormalSummon","SpellTrapSet","SpecialSummon","ChangeBattlePosition","IgnitionEffect","QuickEffect","CardActivation"],["Normal","Quick","Counter"]),"あなたの手番です。");if(e.actionWIP){if([...qs].includes(e.actionWIP.playType)){const i=await e.actionWIP.prepare(e.actionWIP.cell,!0);if(console.log(i),!i)continue;await e.actionWIP.execute(this.priorityHolder,e.actionWIP.cell,i),this.clock.incrementProcSeq()}else await this.procChainBlock(e.actionWIP);for(;await this.procChainBlock(););continue}const t=e.phaseChange;if(t){if(this.priorityHolder=this.getNonTurnPlayer(),await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect","TriggerEffect"],["Quick","Counter"]),"",!0)){this.procChainBlock();continue}this.moveNextPhase(t);return}}});d(this,"procBattlePhase",async()=>{await this.procBattlePhaseStartStep(),await this.procBattlePhaseBattleStep(),await this.procBattlePhaseEndStep()});d(this,"procBattlePhaseStartStep",async()=>{for(this.phaseStep="start",this.priorityHolder=this.getTurnPlayer(),this.attackingMonster=void 0,this.targetForAttack=void 0;await this.procChainBlock(););});d(this,"procBattlePhaseBattleStep",async()=>{for(;;){this.phaseStep="battle",this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["Battle"],["Normal"]),"攻撃モンスターと対象を選択。");if(e.phaseChange)break;if(e.actionWIP){for(await e.actionWIP.execute(this.priorityHolder,e.actionWIP.cell),this.clock.incrementProcSeq();await this.procChainBlock(););this.clock.incrementStepSeq(),await this.procBattlePhaseDamageStep()}}this.clock.incrementStepSeq()});d(this,"procBattlePhaseDamageStep",async()=>{this.phaseStep="damage";const e=this.attackingMonster,t=this.targetForAttack;if(!e||!e.atk)throw new ct("想定されない状態",this.attackingMonster,this.targetForAttack);this.log.info("ダメージステップ開始時",this.getTurnPlayer()),this.log.info("ダメージ計算前",this.getTurnPlayer()),(t==null?void 0:t.battlePotion)==="Set"&&t.setBattlePosition("Defense"),this.log.info("ダメージ計算時",this.getTurnPlayer());const i=e.atk,a=((t==null?void 0:t.battlePotion)==="Attack"?t.atk:t==null?void 0:t.def)||0;!t||t.entityType==="Duelist"?e.controller.getOpponentPlayer().battleDamage(i-a,e):i>0&&i>a?(t.battlePotion==="Attack"&&e.controller.getOpponentPlayer().battleDamage(i-a,e),t.isDying=!0):i<a?(e.controller.battleDamage(a-i,t),t.battlePotion==="Attack"&&(e.isDying=!0)):i===a&&t.battlePotion==="Attack"&&(e.isDying=!0,t.isDying=!0);const r=Object.values(this.duelists).filter(s=>s.lp<=0);if(r.length>0)throw new pt(Object.values(this.duelists).filter(s=>!r.includes(s)).pop());e.isDying&&await this.field.destroyMany([e],["BattleDestroy"],t),t!=null&&t.isDying&&await this.field.destroyMany([t],["BattleDestroy"],e),this.log.info("ダメージ計算後",this.getTurnPlayer()),this.log.info("ダメージステップ終了時",this.getTurnPlayer()),this.clock.incrementStepSeq()});d(this,"procBattlePhaseEndStep",async()=>{for(this.phaseStep="end",this.priorityHolder=this.getTurnPlayer();await this.procChainBlock(););this.moveNextPhase("main2")});d(this,"procEndPhase",async()=>{for(;await this.procChainBlock(););for(;;){const t=this.getTurnPlayer().getHandCell().cardEntities.length;if(t<7)break;await this.field.discard(this.getTurnPlayer(),t-6,["Rule"])}this.moveNextPhase("draw")});d(this,"procChainBlock",async(e,t)=>{const i=this.clock.chainBlockSeq===0;let a;const r=t??Object.values(this.duelists).flatMap(s=>(this.priorityHolder=s,this.getEnableActions(["TriggerMandatoryEffect","TriggerEffect"],["Normal"])));try{if(e||r.length>0&&await this.selectTriggerEffect(r))return a=e,!0;let s=0;for(;s<2;){this.priorityHolder=this.priorityHolder.getOpponentPlayer();const o=await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect"],["Normal","Quick","Counter"]),"クイックエフェクト発動タイミング。効果を発動しますか？",!0);if(o)return a=o,!0;s++}return!1}finally{if(a){const s=a.entity.controller;this.log.info(`${a.entity.nm}«${a.title}»を発動`,s);const o=await a.prepare(a.cell);this.clock.incrementProcSeq(),this.clock.incrementChainBlockSeq(),await this.procChainBlock(void 0,r.filter(l=>l.seq!==(a==null?void 0:a.seq))),this.log.info(`${a.entity.nm}«${a.title}»の効果処理`,s),await a.execute(s,a.cell,o),this.clock.incrementProcSeq(),i&&(await Promise.all(this.field.getAllCells().filter(l=>l.cellType==="SpellAndTrapZone").flatMap(l=>l.entities).filter(l=>l.isDying).map(l=>l.sendGraveyard(["Rule"]))),this.clock.incrementChainSeq())}}});d(this,"selectTriggerEffect",async e=>{if(e.length>0)for(const t of["TriggerMandatoryEffect","TriggerEffect"])for(const i of[this.getTurnPlayer(),this.getNonTurnPlayer()]){this.priorityHolder=i;const a=e.filter(s=>s.playType===t&&s.entity.controller===i);if(a.length===0)continue;if(a.length===1&&t==="TriggerMandatoryEffect")return a[0];const r=await this.view.waitQuickEffect(a,"効果を選択。",t==="TriggerEffect");if(r)return r}});d(this,"getEnableActions",(e,t)=>this.field.getAllCardEntities().filter(i=>i.controller===this.priorityHolder).flatMap(i=>i.actions).filter(i=>i.executableCells.includes(i.entity.fieldCell.cellType)).filter(i=>e.includes(i.playType)).filter(i=>t.includes(i.spellSpeed)).filter(i=>i.validate()));this.phase="end",this.clock=new Ts,this.nextPhaseList=[],this.isEnded=!1,this.duelists={Below:new Fi(this,"Below",e,t,i),Above:new Fi(this,"Above",a,r,s)},this.priorityHolder=this.firstPlayer,this.field=new gs(this),this.view=new xs(this),this.log=new Bs(this)}get firstPlayer(){return this.coin?this.duelists.Below:this.duelists.Above}get secondPlayer(){return this.coin?this.duelists.Above:this.duelists.Below}}const xa=n=>{if(n.controller.normalSummonCount>=n.controller.maxNormalSummonCount||!n.status.level)return;const e=n.controller.getAvailableMonsterZones();return n.status.level<5?e.length>0?e:void 0:n.controller.getReleasableMonsters().length<(n.status.level<7?1:2)?void 0:[]},Ta=async(n,e,t,i)=>{if(!n.status.level)return[];if(n.status.level<5)return[];let a=i;const r=n.controller.getReleasableMonsters(),s=n.controller.getExtraMonsterZones(),o=n.status.level<7?1:2;s.length>=o&&r.filter(p=>p.fieldCell.cellType!=="ExtraMonsterZone");const l=await n.field.release(n.controller,n.controller.getReleasableMonsters(),o,"Cost",["AdvanceSummonRelease","Rule"],n,a);if(l)return a=!1,l},Ma=async(n,e,t,i)=>{if(!n.status.level)return!1;const a=["Rule","NormalSummon"];i&&i.length>0&&(n.materials.reset(...i),a.push("AdvanceSummon"));const r=n.controller.getAvailableMonsterZones();return await n.field.summon(n,[e],t?[t]:r,"NormalSummon",a,n,void 0,i&&i.length===0),n.controller.normalSummonCount++,!0},Ns=n=>{if(n.status.attackCount>0||n.battlePotion!=="Attack"||!n.controller.isTurnPlayer)return;const e=n.controller.getAttackTargetMonsters();return e.length>0?e.map(t=>t.fieldCell):[n.controller.getOpponentPlayer().getHandCell()]},bs=async(n,e,t)=>{if(n.status.attackCount>0||n.battlePotion!=="Attack")return!1;if(t!=null&&t.targetForAttack)return n.field.duel.declareAnAttack(n,t==null?void 0:t.targetForAttack),!0;const i=n.controller.getAttackTargetMonsters(),a=n.controller.getOpponentPlayer().entity;if(i.length===0)return n.field.duel.declareAnAttack(n,a),!0;if(i.length===1)return n.field.duel.declareAnAttack(n,i[0]),!0;const r=await n.field.duel.view.waitSelectEntities(n.controller,i,1,s=>s.length===1,"攻撃対象を選択。",!0);return r?(n.field.duel.declareAnAttack(n,r[0]),!0):!1},_s=n=>{if(!(n.status.battlePotisionChangeCount>0||n.status.attackCount>0||!n.controller.isTurnPlayer))return[]},Fs=async n=>n.status.battlePotisionChangeCount>0||!n.controller.isTurnPlayer?!1:(n.setBattlePosition(n.battlePotion==="Attack"?"Defense":"Attack"),n.status.battlePotisionChangeCount++,!0),Hs=n=>{if(n.status.spellCategory==="Field"){const t=n.controller.getFieldZone();return t.isAvailable?[t]:void 0}const e=n.controller.getAvailableSpellTrapZones();return e.length>0?e:void 0},Ks=async(n,e,t)=>{const i=n.controller.getAvailableSpellTrapZones();return i.length===0?!1:(await n.field.setSpellTrap(n,t?[t]:i,void 0,n.controller,!0),!0)},ot=(n,e=()=>!0)=>{if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return[];const t=n.controller.getAvailableSpellTrapZones();return t.length>0&&e(n)?t:void 0},Xe=async(n,e,t)=>{if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return n.setNonFieldPosition("FaceUp",!0),!0;if(n.fieldCell.cellType==="Hand"){const i=["SpellTrapActivate"],a=t?[t]:n.controller.getAvailableSpellTrapZones();return await n.field.activateSpellTrapFromHand(n,a,i,n,n.controller,!0),!0}return!1},Na=(n,e,t,i)=>!(e.some(a=>!a.status.canBeSyncroMaterial)||e.some(a=>a.fieldCell.cellType!=="Hand"&&a.fieldCell.cellType!=="MonsterZone"&&a.fieldCell.cellType!=="ExtraMonsterZone")||e.some(a=>a.fieldCell.cellType==="Hand")&&e.every(a=>!a.status.allowHandSyncro)||e.some(a=>!a.lvl)||e.map(a=>a.lvl??0).reduce((a,r)=>a+r,0)!==(n.origin.level??-1)||!t(e.filter(a=>{var r;return(r=a.status.monsterCategories)==null?void 0:r.some(s=>s==="Tuner")}))||!i(e.filter(a=>{var r;return(r=a.status.monsterCategories)==null?void 0:r.every(s=>s!=="Tuner")}))),Ki=(n,e=i=>i.length===1,t=i=>i.length>0)=>{let i=[...n.controller.getMonstersOnField().filter(a=>a.face==="FaceUp"),...n.controller.getHandCell().entities.filter(a=>a.origin.kind==="Monster")].filter(a=>a.status.canBeSyncroMaterial);if(i.every(a=>!a.status.allowHandSyncro)&&(i=n.controller.getMonstersOnField()),!(i.length<2)){for(const a of i.getAllOnOffPattern())if(Na(n,a,e,t))return[]}},Si=async(n,e,t,i,a=s=>s.length===1,r=s=>s.length>0)=>{let s=[...n.controller.getMonstersOnField(),...n.controller.getHandCell().entities.filter(l=>l.origin.kind==="Monster")].filter(l=>l.status.canBeSyncroMaterial);if(s.every(l=>!l.status.allowHandSyncro)&&(s=n.controller.getMonstersOnField()),s.length<2)return;console.log(s);const o=await n.field.payMonstersForSpecialSummonCost(n.controller,s,-1,l=>Na(n,l,a,r),["SyncroMaterial","Rule"],n,i);if(console.log(o),!!o)return o},Wi=async(n,e,t,i,a)=>{a&&a.length>0&&n.materials.reset(...a);const r=[...e.getAvailableMonsterZones(),...e.getAvailableExtraZones()];return await n.field.summon(n,[t],i?[i]:r,"SyncroSummon",["Rule","SpecialSummon"],n,void 0,a&&a.length===0),e.specialSummonCount++,n.canReborn=!0,!0},ba={title:"召喚",playType:"NormalSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:xa,prepare:(n,e,t)=>Ta(n,"Attack",e,t),execute:(n,e,t,i)=>Ma(n,"Attack",t,i)},_a={title:"セット",playType:"NormalSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:xa,prepare:(n,e,t)=>Ta(n,"Set",e,t),execute:(n,e,t,i)=>Ma(n,"Set",t,i)},ln={title:"攻撃宣言",playType:"Battle",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:Ns,prepare:async()=>!0,execute:(n,e,t)=>bs(n,void 0,t)},dn={title:"表示形式変更",playType:"ChangeBattlePosition",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:_s,prepare:async()=>!0,execute:n=>Fs(n)},Ve={title:"セット",playType:"SpellTrapSet",spellSpeed:"Normal",executableCells:["Hand"],validate:Hs,prepare:async()=>!0,execute:(n,e,t)=>Ks(n,"Set",t)},Pi=(n=t=>t.length===1,e=t=>t.length>0)=>[{title:"シンクロ召喚（攻撃）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["ExtraDeck"],validate:t=>Ki(t,n,e),prepare:(t,i,a)=>Si(t,"Attack",i,a,n,e),execute:(t,i,a,r)=>Wi(t,i,"Attack",a,r)},{title:"シンクロ召喚（守備）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["ExtraDeck"],validate:t=>Ki(t,n,e),prepare:(t,i,a)=>Si(t,"Defense",i,a,n,e),execute:(t,i,a,r)=>Wi(t,i,"Defense",a,r)}],Ss=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>ot(e,t=>t.controller.getDeckCell().cardEntities.filter(n).length>0),prepare:async(e,t)=>(e.isDying=!0,await Xe(e,void 0,t)),execute:async(e,t)=>{const i=t.getDeckCell().cardEntities.filter(n);if(i.length===0)return!1;const a=await e.field.duel.view.waitSelectEntities(t,i,1,r=>r.length===1,"手札に加えるカードを選択",!1);for(const r of a??[])await r.addToHand(["Effect"],e);return t.shuffleDeck(),!0}}),Ws=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>ot(e,t=>t.controller.getHandCell().cardEntities.filter(n).length>0&&t.controller.getDeckCell().cardEntities.length>1),prepare:async(e,t)=>(e.isDying=!0,await e.field.discard(e.controller,1,["Discard","Cost"],e,e.controller,n),await Xe(e,void 0,t)),execute:async(e,t)=>(await t.draw(2,e),!0)}),Ps=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:()=>[],prepare:async(e,t)=>(e.isDying=!0,await Xe(e,void 0,t)),execute:async(e,t)=>{const[i,a]=n(e);return a>0?t.getOpponentPlayer().heal(a,e):a<0&&t.getOpponentPlayer().effectDamage(Math.abs(a),e),i>0?t.heal(i,e):i<0&&t.effectDamage(Math.abs(i),e),!0}}),qs=["NormalSummon","SpecialSummon","ChangeBattlePosition","Battle","SpellTrapSet","SpellTrapActivate"],Ls=["Card","Token","Avatar"],pn=(n,e)=>{const t=n.monsterCategories??[],i=e.monsterCategories??[];for(const a of Gt.toReversed()){if(t.includes(a)&&!i.includes(a))return 1;if(!t.includes(a)&&i.includes(a))return-1}if(n.kind===e.kind){if(n.kind==="Monster"){if((n.link??0)!==(e.link??0))return(n.link??0)-(e.link??0);if((n.rank??0)!==(e.rank??0))return(n.rank??0)-(e.rank??0);if((n.level??0)!==(e.level??0))return(n.level??0)-(e.level??0);if((n.attack??0)!==(e.attack??0))return(n.attack??0)-(e.attack??0);if((n.defense??0)!==(e.defense??0))return(n.defense??0)-(e.defense??0)}return n.name.localeCompare(e.name,"Ja")}for(const a of zn){if(n.kind===a)return-1;if(e.kind===a)return 1}return n.name.localeCompare(e.name)},Rs=(n,e)=>{const t=pn(n.origin,e.origin);return console.log(n.nm,e.nm,t),t},ge=class ge{constructor(e,t,i,a,r,s,o,l,p){d(this,"seq");d(this,"origin");d(this,"entityType");d(this,"face");d(this,"isUnderControl");d(this,"_battlePosition");d(this,"orientation");d(this,"controller");d(this,"owner");d(this,"field");d(this,"fieldCell");d(this,"movedBy");d(this,"movedAs");d(this,"movedFrom");d(this,"movedAt");d(this,"isDying");d(this,"isVanished");d(this,"canReborn");d(this,"materials");d(this,"status");d(this,"actions",[]);d(this,"getIndexInCell",()=>{const e=this.fieldCell.cardEntities.indexOf(this);if(e<0)throw new ct("エンティティとセルの状態が矛盾している。",[this,this.fieldCell]);return e});d(this,"setBattlePosition",e=>{this._battlePosition=e,this.orientation=e==="Attack"?"Vertical":"Horizontal",this.face=e==="Set"?"FaceDown":"FaceUp",this.isUnderControl=!0});d(this,"setNonFieldPosition",(e,t)=>{this._battlePosition=void 0,this.orientation=e==="XysMaterial"?"Horizontal":"Vertical",this.face=e==="FaceUp"?"FaceUp":"FaceDown",this.isUnderControl=t});d(this,"summon",async(e,t,i,a,r)=>{const s={Attack:"AttackSummon",Defense:"DefenseSummon",Set:"SetSummon"};e.isAvailable&&(this.setBattlePosition(t),await this._moveTo(e,"Top",[i,s[t],...a],r),this.status.battlePotisionChangeCount=1)});d(this,"release",async(e,t)=>{await this.sendGraveyard([...e,"Release"],t)});d(this,"destroy",async(e,t,i)=>{await this.sendGraveyard([...t,e,"Destroy"],i)});d(this,"sendGraveyard",async(e,t)=>{this.setNonFieldPosition("FaceUp",!0);const i=this.owner.getGraveyard();await this._moveTo(i,"Top",e,t)});d(this,"setAsSpellTrap",async(e,t,i)=>{await this._moveTo(e,"Top",[...t,"SpellTrapSet"],i),this.setNonFieldPosition("Set",!0)});d(this,"activateSpellTrapFromHand",async(e,t,i)=>{this.setNonFieldPosition("FaceUp",!0),await this._moveTo(e,"Top",[...t,"SpellTrapActivate"],i),this.isDying=!0});d(this,"activateSpellTrapOnField",async()=>{this.setNonFieldPosition("FaceUp",!0),this.isDying=!0});d(this,"draw",async(e,t)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",[...e,"Draw"],t),this.setNonFieldPosition("Set",!0)});d(this,"addToHand",async(e,t)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",e,t),this.setNonFieldPosition("Set",!0)});d(this,"_moveTo",async(e,t,i,a)=>{if(this.field.duel.clock.turn>0&&await this.field.duel.view.waitAnimation({entity:this,to:e,index:t,count:0}),this.fieldCell.releaseEntities([this],i,a),this.entityType==="Token"&&this.fieldCell.cellType!=="MonsterZone"){this.field.duel.log.info(`${this.nm}は消滅した。`,a==null?void 0:a.controller);return}e.acceptEntities([this],t)});var c;this.seq=ge.nextEntitySeq++,this.owner=e,this.controller=t,this.field=i,this.fieldCell=a,this.entityType=r,this.origin=s,this.status={...JSON.parse(JSON.stringify(s)),canAttack:!0,isEffective:!0,canDirectAttack:!1,attackCount:0,isSelectableForAttack:!0,canBeSyncroMaterial:!0},this.face=o,this.isUnderControl=l,this.orientation=p,this.movedAs=["Rule"],this.movedAt=i.duel.clock,this.isDying=!1,this.isVanished=!1,this.canReborn=((c=this.origin.monsterCategories)==null?void 0:c.union(Ea).length)===0,this.materials=[],a.acceptEntities([this],"Top")}get nm(){return this.status.name}get atk(){return this.status.attack}get def(){return this.status.defense}get lvl(){return this.status.level}get rank(){return this.status.rank}get attr(){return this.status.attribute?[this.status.attribute]:[]}get type(){return this.status.type?[this.status.type]:[]}get psL(){return[this.status.pendulumScaleL]}get psR(){return[this.status.pendulumScaleR]}get battlePotion(){return this._battlePosition}};d(ge,"nextActionSeq",0),d(ge,"nextEntitySeq",0),d(ge,"actionDic",{}),d(ge,"createCardActionList",(e,t)=>{const i=t.map(a=>({seq:ge.nextActionSeq++,title:a.title,entity:e,playType:a.playType,spellSpeed:a.spellSpeed,executableCells:a.executableCells,validate:()=>a.validate(e),prepare:r=>a.prepare(e,r),execute:(r,s,o)=>a.execute(e,r,s,o)}));return i.forEach(a=>ge.actionDic[a.seq]=a),i}),d(ge,"createPlayerEntity",e=>{const t=e.getHandCell();return new ge(e,e,e.duel.field,t,"Duelist",{name:e.profile.name,kind:"Monster"},"FaceUp",!0,"Vertical")}),d(ge,"createCardEntity",(e,t,i)=>{var o;const a=i.monsterCategories&&i.monsterCategories.union(Gt).length?t.getExtraDeck():t.getDeckCell(),r=new ge(t,t,e,a,"Card",i,"FaceDown",!1,"Vertical");Object.hasOwn(Te,r.origin.name)||e.duel.log.info(`未実装カード${i.name}がデッキに投入された。`,t);const s=Te[r.origin.name];return s.kind==="Monster"&&((o=s.monsterCategories)!=null&&o.includes("Normal"))?r.actions.push(...ge.createCardActionList(r,[ba,_a,ln,dn])):r.actions.push(...ge.createCardActionList(r,Vn.get(r.origin.name)||[])),r}),d(ge,"createDammyAction",(e,t,i,a)=>({seq:ge.nextActionSeq++,title:t,entity:e,playType:"Dammy",spellSpeed:"Dammy",executableCells:[e.fieldCell.cellType],validate:()=>i,prepare:async()=>{},execute:async()=>!1,pos:a,dragAndDropOnly:!0}));let wt=ge;const Os=()=>{const n=[],e=s=>{const o=s.field.getMonstersOnField();if(o.length==0||o.some(p=>p.controller===s.controller))return;const l=s.controller.getAvailableMonsterZones();return l.length>0?l:void 0},t=async(s,o,l)=>{const p=s.controller.getAvailableMonsterZones();return await s.field.summon(s,[o],l?[l]:p,"SpecialSummon",["Rule"],s,void 0,!0),s.controller.specialSummonCount++,!0},i={name:"サイバー・ドラゴン",actions:[ba,_a,ln,dn,{title:"特殊召喚（攻撃）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:e,prepare:async()=>!0,execute:async(s,o,l)=>(await t(s,"Attack",l),!0)},{title:"特殊召喚（守備）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:e,prepare:async()=>!0,execute:async(s,o,l)=>(await t(s,"Defense",l),!0)}]};n.push(i);const a={name:"大地の騎士ガイアナイト",actions:[ln,dn,...Pi()]};n.push(a),n.push({...a,name:"スクラップ・デスデーモン"});const r={name:"ナチュル・ガオドレイク",actions:[ln,dn,...Pi(s=>s.length===1&&s.every(o=>o.attr.some(l=>l==="Earth")),s=>s.length>0&&s.every(o=>o.attr.some(l=>l==="Earth")))]};return n.push(r),console.log(n),n},Is=()=>{const n=[],e={name:"強欲な壺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:ot,prepare:async(o,l)=>(o.isDying=!0,await Xe(o,void 0,l)),execute:async(o,l)=>(await o.field.draw(l,2,o),!0)},Ve]};n.push(e);const t={name:"天使の施し",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:ot,prepare:async(o,l)=>(o.isDying=!0,await Xe(o,void 0,l)),execute:async(o,l)=>(await o.field.draw(o.controller,3,o),await o.field.discard(l,2,["Effect","Discard"],o),!0)},Ve]};n.push(t);const i={name:"成金ゴブリン",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:ot,prepare:async(o,l)=>(o.isDying=!0,await Xe(o,void 0,l)),execute:async(o,l)=>(await o.field.draw(o.controller,1,o),o.field.duel.clock.incrementProcSeq(),l.getOpponentPlayer().heal(1e3,o),!0)},Ve]};n.push(i);const a={name:"おろかな埋葬",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:o=>ot(o,l=>l.controller.getDeckCell().cardEntities.some(p=>p.status.kind==="Monster")),prepare:async(o,l)=>(o.isDying=!0,await Xe(o,void 0,l)),execute:async(o,l)=>{const p=l.getDeckCell().cardEntities.filter(m=>m.status.kind==="Monster");if(p.length===0)return!1;const c=await o.field.duel.view.waitSelectEntities(l,p,1,m=>m.length===1,"墓地に送るモンスターを選択",!1);for(const m of c??[])await o.field.sendGraveyardMany([m],["Effect"],o);return await l.shuffleDeck(),!0}},Ve]};n.push(a);const r={name:"死者蘇生",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:o=>ot(o,l=>l.field.getCells("Graveyard").flatMap(p=>p.cardEntities).filter(p=>p.origin.kind==="Monster"&&p.canReborn).length>0&&l.controller.getAvailableMonsterZones().length>0),prepare:async(o,l)=>{o.isDying=!0;const p=await o.field.duel.view.waitSelectEntities(o.controller,o.field.getCells("Graveyard").flatMap(c=>c.cardEntities).filter(c=>c.origin.kind==="Monster"&&c.canReborn),1,c=>c.length===1,"蘇生対象とするモンスターを選択",!1);return await Xe(o,void 0,l),p==null?void 0:p[0]},execute:async(o,l,p,c)=>{const m=l.getEmptyMonsterZones();return c.controller=l,await o.field.summon(c,["Attack","Defense"],m,"SpecialSummon",["Effect"],o,void 0,!1),o.controller.specialSummonCount++,!0}},Ve]};n.push(r);const s={name:"光の援軍",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:o=>ot(o,l=>l.controller.getDeckCell().cardEntities.filter(p=>p.status.kind==="Monster").filter(p=>(p.lvl??13)<5).some(p=>p.status.nameTags&&p.status.nameTags.includes("ライトロード"))&&l.controller.getDeckCell().cardEntities.length>3),prepare:async(o,l)=>{o.isDying=!0;const p=o.controller.getDeckCell();return Array(3).forEach(()=>p.cardEntities[0].sendGraveyard(["Cost"],o)),await Xe(o,void 0,l)},execute:async(o,l)=>{const p=l.getDeckCell().cardEntities.filter(m=>m.status.kind==="Monster").filter(m=>(m.lvl??13)<5).filter(m=>m.status.nameTags&&m.status.nameTags.includes("ライトロード"));if(p.length===0)return!1;const c=await o.field.duel.view.waitSelectEntities(l,p,1,m=>m.length===1,"手札に加えるモンスターを選択",!1);for(const m of c??[])await m.addToHand(["Effect"],o);return!0}},Ve]};return n.push(s),[{name:"増援",filter:o=>o.origin.kind==="Monster"&&o.origin.type==="Warrior"&&(o.origin.level??5)<5},{name:"化石調査",filter:o=>o.origin.kind==="Monster"&&o.origin.type==="Dinosaur"&&(o.origin.level??6)<6},{name:"Ｅ－エマージェンシーコール",filter:o=>o.origin.kind==="Monster"&&(o.origin.nameTags??[]).includes("Ｅ・ＨＥＲＯ")},{name:"召集の聖刻印",filter:o=>o.origin.kind==="Monster"&&(o.origin.nameTags??[]).includes("聖刻")},{name:"召喚師のスキル",filter:o=>o.origin.kind==="Monster"&&(o.origin.monsterCategories??[]).includes("Normal")&&(o.origin.level??4)>4},{name:"トゥーンのもくじ",filter:o=>(o.origin.nameTags??[]).includes("トゥーン")},{name:"融合賢者",filter:o=>o.origin.name==="融合"},{name:"虹の架け橋",filter:o=>o.origin.kind!=="Monster"&&(o.origin.nameTags??[]).includes("宝玉")},{name:"紫炎の狼煙",filter:o=>o.origin.kind==="Monster"&&(o.origin.nameTags??[]).includes("六武衆")&&(o.origin.level??4)<4},{name:"テラ・フォーミング",filter:o=>o.origin.kind==="Spell"&&o.origin.spellCategory==="Field"},{name:"コール・リゾネーター",filter:o=>o.origin.kind==="Monster"&&(o.origin.nameTags??[]).includes("リゾネーター")}].forEach(o=>{n.push({name:o.name,actions:[Ss(o.filter),Ve]})}),[{name:"トレード・イン",filter:o=>o.status.kind==="Monster"&&(o.status.level??0)===8},{name:"調和の宝札",filter:o=>o.status.kind==="Monster"&&(o.origin.monsterCategories??[]).includes("Tuner")&&o.status.type==="Dragon"&&(o.status.attack??9999)<=1e3},{name:"デステニー・ドロー",filter:o=>o.status.kind==="Monster"&&(o.origin.nameTags??[]).includes("リゾネーター")}].forEach(o=>{n.push({name:o.name,actions:[Ws(o.filter),Ve]})}),[{name:"火の粉",calcHeal:()=>[0,-200]},{name:"雷鳴",calcHeal:()=>[0,-300]},{name:"ファイヤー・ボール",calcHeal:()=>[0,-500]},{name:"火あぶりの刑",calcHeal:()=>[0,-600]},{name:"昼夜の大火事",calcHeal:()=>[0,-800]},{name:"火炎地獄",calcHeal:()=>[-500,-1e3]},{name:"盗人ゴブリン",calcHeal:()=>[500,-500]},{name:"ブルー・ポーション",calcHeal:()=>[400,0]},{name:"レッド・ポーション",calcHeal:()=>[500,0]},{name:"ゴブリンの秘薬",calcHeal:()=>[600,0]},{name:"天使の生き血",calcHeal:()=>[800,0]},{name:"治療の神 ディアン・ケト",calcHeal:()=>[1e3,0]},{name:"恵みの雨",calcHeal:()=>[1e3,1e3]}].forEach(o=>{n.push({name:o.name,actions:[Ps(o.calcHeal),Ve]})}),n},Zs=()=>{const n=[...Os(),...Is()];return console.log(n),n},Fa=new Map;Zs().forEach(n=>{Fa.set(n.name,n.actions)});const Vn=Fa,Us=ms,Te=Object.values(Us).reduce((n,e)=>(n[e.name]=e,n),{}),re=class re{constructor(e,t){d(this,"id");d(this,"name");d(this,"description");d(this,"lastUsedAt");d(this,"cardNames");d(this,"getIllegalCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(Te).includes(e)))));d(this,"getDisableCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(Te).includes(e)))));d(this,"createCardInfos",()=>{const e=this.getIllegalCardNames();if(e.length>0)throw new Error(`存在しないカード名からデッキを生成しようとした。${e}`);return this.cardNames.map(t=>Te==null?void 0:Te[t]).filter(t=>t)});d(this,"copy",async()=>re.createNewDeck(this.name,this.description,this.cardNames));d(this,"saveDeckInfo",async e=>{const t=e??this;await re.tblHeader.update(this.id,r=>({...r,name:t.name,description:t.description}));const i=(await re.tblDetail.getAll()).filter(r=>r.deckId===this.id);console.log(t.cardNames),await re.tblDetail.delete(i.map(r=>r.id));const a=await re.tblDetail.insertMany(t.cardNames.map((r,s)=>({deckId:this.id,seq:s,name:r,description:""})));return console.log(a),new re(await re.tblHeader.get(this.id),a)});d(this,"delete",async()=>{await re.tblHeader.delete([this.id]);const e=(await re.tblDetail.getAll()).filter(t=>t.deckId===this.id);await re.tblDetail.delete(e.map(t=>t.id))});this.id=e.id,this.name=e.name,this.description=e.description,this.lastUsedAt=e.lastUsedAt,this.cardNames=t.filter(i=>i.deckId===this.id).map(i=>i.name)}};d(re,"idb"),d(re,"tblHeader"),d(re,"tblDetail"),d(re,"getAllDeckInfo",async e=>{if(e&&(re.idb=e),!re.idb)throw new Error("illegal argument: idb is undefined.");re.tblHeader||(re.tblHeader=new $s(re.idb)),re.tblDetail||(re.tblDetail=new Ys(re.idb));const t=await re.tblHeader.getAll(),i=await re.tblDetail.getAll();return t.length?t.map(a=>new re(a,i)):[await re.prepareSampleDeck()]}),d(re,"createNewDeck",async(e,t,i)=>{const a=await re.tblHeader.insert({name:e,description:t,lastUsedAt:new Date}),r=await re.tblDetail.insertMany(i.map((s,o)=>({deckId:a.id,seq:o,name:s,description:""})));return new re(a,r)}),d(re,"prepareSampleDeck",async()=>await re.createNewDeck(cn[0].name,cn[0].description,cn[0].cardNames));let Ct=re;class $s extends pi{constructor(t){super(t,"TblDeckHeader");d(this,"_prepareInitialRecords",()=>[])}}class Ys extends pi{constructor(t){super(t,"TblDeckDetail");d(this,"_prepareInitialRecords",()=>[])}}let zs=-1,$t=["おろかな埋葬","成金ゴブリン","強欲な壺","天使の施し","増援","死者蘇生","Ｅ－エマージェンシーコール","サイバー・ドラゴン","ナチュル・ガオドレイク","スクラップ・デスデーモン","大地の騎士ガイアナイト"];$t=[...$t,...$t,...$t,"アレキサンドライドラゴン","ジェネティック・ワーウルフ","機界騎士アヴラム","ジョングルグールの幻術師","ゾンビーノ","幻のグリフォン","フロストザウルス","エレキテルドラゴン","青眼の白龍","幻殻竜","しゃりの軍貫","チューン・ウォリアー","ライドロン","Ａ・マインド","ウォーター・スピリット","エンジェル・トランペッター","ガード・オブ・フレムベル","ギャラクシーサーペント","ジェネクス・コントローラー","スペース・オマジナイ・ウサギ","ハロハロ","ライブラの魔法秤","ラブラドライドラゴン","守護竜ユスティア","竜核の呪霊者","Ｅ・ＨＥＲＯ クレイマン","Ｅ・ＨＥＲＯ スパークマン","Ｅ・ＨＥＲＯ ネオス","Ｅ・ＨＥＲＯ バーストレディ","Ｅ・ＨＥＲＯ フェザーマン"];const cn=[{id:zs--,name:"サンプルデッキ１",description:"",lastUsedAt:new Date,cardNames:$t}];function js(n){const e=n-1;return e*e*e+1}function qi(n,e){for(const t in e)n[t]=e[t];return n}function Gs({fallback:n,...e}){const t=new Map,i=new Map;function a(s,o,l){const{delay:p=0,duration:c=Z=>Math.sqrt(Z)*30,easing:m=js}=qi(qi({},e),l),k=s.getBoundingClientRect(),h=o.getBoundingClientRect(),w=k.left-h.left,D=k.top-h.top,_=k.width/h.width,E=k.height/h.height,y=Math.sqrt(w*w+D*D),H=getComputedStyle(o),P=H.transform==="none"?"":H.transform,q=+H.opacity;return{delay:p,duration:typeof c=="function"?c(y):c,easing:m,css:(Z,X)=>`
			   opacity: ${Z*q};
			   transform-origin: top left;
			   transform: ${P} translate(${X*w}px,${X*D}px) scale(${Z+(1-Z)*_}, ${Z+(1-Z)*E});
		   `}}function r(s,o,l){return(p,c)=>(s.set(c.key,p),()=>{if(o.has(c.key)){const m=o.get(c.key);return o.delete(c.key),a(m,p,c)}return s.delete(c.key),n&&n(p,c,l)})}return[r(i,t,!1),r(t,i,!0)]}var Vs=M("<div></div>"),Qs=M('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"> </div> <div class="svelte-3b34fd"> </div></div>'),Xs=M('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"></div> <div class="svelte-3b34fd"> </div></div>'),Js=M('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"></div> <div class="svelte-3b34fd"> </div></div>'),eo=M('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"> </div> <div class="svelte-3b34fd"> </div></div>'),to=M('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"> </div></div> <div class="duel_card_row duel_card_row_wide svelte-3b34fd"><div class="svelte-3b34fd"> </div> <div class="svelte-3b34fd"> </div></div>',1),no=M('<button><div class="duel_card duel_card_face_up svelte-3b34fd"><div class="duel_card_row svelte-3b34fd" style="position:relative"><div class="svelte-3b34fd"> </div> <!></div> <!> <!> <!></div></button>'),io=M('<div class="duel_card duel_card_face_down svelte-3b34fd"><div class="svelte-3b34fd"></div></div>');function Je(n,e){Ne(e,!1);let t=ce(e,"entity",8),i=ce(e,"state",8,"Disabled"),a=ce(e,"selectedList",28,()=>[]),r=ce(e,"isVisibleForcibly",8,!1),s=ce(e,"isWideMode",8,!1),o=ce(e,"actions",24,()=>[]),l=ce(e,"cardActionResolve",8),p=ce(e,"entitySelectResolve",8,()=>{}),c=ye(!1),m=()=>{},k=ce(e,"qty",12,void 0);const h=B=>{Q(c,!1),k(B.qty),m=B.resolve};t().field.duel.view.onWaitStart.append(h);let w=ye(!1);const D=()=>{if(i()!=="Disabled"&&(console.log(k()),i()==="Selectable"&&k()&&k()===1)){if(a().some(B=>B.seq!==t().seq)){a([t()]);return}k()&&k()===1&&p()&&p()([t()])}},_=()=>{(t().face==="FaceUp"||t().owner===t().field.duel.duelists.Below&&(t().isUnderControl||r()))&&t().field.duel.view.showCardInfo(t())},E=()=>{if(console.log(t(),i()),_(),i()==="Disabled")return;if(i()==="Selectable"){Q(c,!A(c)),a(A(c)?[...a(),t()]:a().filter(I=>I!==t()));return}if(o().length===0)return;if(o().length===1){if(o()[0].dragAndDropOnly)return;if(l()){l()(o()[0]);return}console.log(o()[0],m),m({actionWIP:o()[0]});return}const B=t().field.duel.view;B.modalController.selectAction(B,{title:"行動を選択。",actions:o(),cancelable:!0}).then(I=>{m({actionWIP:I})})},y=B=>{console.info("drag start",B,o()),t().field.duel.view.setDraggingActions(o()),Q(w,!0)},H=B=>{console.info("drag end",B,o()),t().field.duel.view.removeDraggingActions(),B.dataTransfer&&Q(w,!1)};Le();var P=he(),q=V(P);{var Z=B=>{var I=no(),ee=u(I),Ae=u(ee),ue=u(Ae),De=u(ue),G=f(ue,2);me(G,1,()=>t().attr,ke,(N,S)=>{var F=Vs();L(()=>we(F,`monster_attr ${A(S)??""} svelte-3b34fd`)),C(N,F)});var v=f(Ae,2);{var W=N=>{var S=Qs(),F=u(S),z=u(F),ae=f(F,2),J=u(ae);L((te,oe)=>{b(z,te),b(J,oe)},[()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0)],Ce),C(N,S)},$=N=>{var S=he(),F=V(S);{var z=J=>{var te=Xs(),oe=f(u(te),2),ne=u(oe);L(()=>b(ne,`${en[t().status.spellCategory]??""}魔法`)),C(J,te)},ae=J=>{var te=he(),oe=V(te);{var ne=T=>{var g=Js(),U=f(u(g),2),x=u(U);L(()=>b(x,`${tn[t().status.trapCategory]??""}罠`)),C(T,g)};R(oe,T=>{t().status.kind==="Trap"&&t().status.trapCategory&&T(ne)},!0)}C(J,te)};R(F,J=>{t().status.kind==="Spell"&&t().status.spellCategory?J(z):J(ae,!1)},!0)}C(N,S)};R(v,N=>{t().status.kind==="Monster"?N(W):N($,!1)})}var j=f(v,2);{var ie=N=>{var S=eo(),F=u(S),z=u(F),ae=f(F,2),J=u(ae);L(()=>{b(z,`◀ ${t().psL??""}`),b(J,`${t().psR??""} ▶`)}),C(N,S)};R(j,N=>{var S;(S=t().status.monsterCategories)!=null&&S.includes("Pendulum")&&N(ie)})}var K=f(j,2);{var Y=N=>{var S=to(),F=V(S),z=u(F),ae=u(z),J=f(F,2),te=u(J),oe=u(te),ne=f(te,2),T=u(ne);L((g,U,x)=>{St(z,"title",g),b(ae,U),b(oe,x),b(T,`${t().atk??"?"} / ${t().def??"?"}`)},[()=>{var g;return(g=t().status.monsterCategories)==null?void 0:g.join(" ")},()=>{var g;return(g=t().status.monsterCategories)==null?void 0:g.map(U=>Jt[U]+(s()?_n[U]:"")).join()},()=>t().type.map(g=>nn[g]+(s()?Fn[g]:"")).join()],Ce),C(N,S)};R(K,N=>{t().status.kind==="Monster"&&N(Y)})}L(N=>{we(I,`duel_card button_style_reset ${t().status.kind??""} ${N??""} ${(A(c)?"duel_card_selected":"")??""} ${i()??""} duel_card_${t().orientation??""} ${(A(w)?"isDragging":"")??""} ${(s()?"duel_card_wide":"")??""} svelte-3b34fd`),St(I,"draggable",i()==="Draggable"),St(I,"title",t().nm),b(De,t().nm)},[()=>{var N;return((N=t().status.monsterCategories)==null?void 0:N.join(" "))||""}],Ce),ve("dragstart",I,y),ve("dragend",I,H),ve("click",I,E),ve("dblclick",I,D),ve("mouseenter",I,_),C(B,I)},X=B=>{var I=io();C(B,I)};R(q,B=>{t().face==="FaceUp"||r()||t().controller.seat==="Below"&&t().isUnderControl?B(Z):B(X,!1)})}C(n,P),be()}var ao=M('<div class="phase_display svelte-pz8cwr"><span class="svelte-pz8cwr"> </span> </div>'),ro=M('<div class="lifepoint_display svelte-pz8cwr"><div class="svelte-pz8cwr"> </div> <div class="svelte-pz8cwr"> </div></div>'),so=(n,e,t)=>e(A(t)),oo=M('<div class="svelte-pz8cwr"><button class="phase_button svelte-pz8cwr"> </button></div>'),Ao=M("<div><!></div>"),lo=M('<div class="svelte-pz8cwr"><!></div>'),po=M("<div><!></div>"),co=M("<!> <!> <!>",1),ko=M('<div style="position: absolute;" class="card_animation_receiver svelte-pz8cwr"><!></div>'),mo=M('<div style="position: absolute;" class="svelte-pz8cwr"><!></div>'),uo=M('<div style="position: absolute; bottom:0rem" class="svelte-pz8cwr"> </div>'),ho=M("<!> <!>",1),wo=M('<div class="badge svelte-pz8cwr"> </div>'),fo=M('<div class="card_animation_receiver svelte-pz8cwr"><!></div>'),Co=M("<!> <!> <!> <!>",1),Do=M('<td><div role="listitem"><!></div></td>');function yo(n,e){Ne(e,!1);let t=ce(e,"view",8),i=ce(e,"row",8),a=ce(e,"column",8),r=ce(e,"selectedList",28,()=>[]),s=ye(t().getCell(i(),a()));const o=()=>{Q(s,t().getCell(i(),a()))};A(s).onUpdate.append(o),t().onDuelUpdate.append(o),t().modalController.onUpdate.append(o);let l=ye([]),p=()=>{},c;const m=v=>{Q(y,void 0),r().reset(),p=v.resolve,Q(l,v.enableActions),c=v.selectableEntities,v.entitiesValidator};t().onWaitStart.append(m);let k,h=ye(!1);const w=v=>{k=v,Q(h,v.some(W=>{var $;return($=W.validate())==null?void 0:$.includes(A(s))})||!1),o()},D=()=>{k=void 0,Q(h,!1),o()};t().onDragStart.append(w),t().onDragEnd.append(D);const[_,E]=tA;let y=ye(void 0);const H=v=>{if(A(s)===v.to||A(s).entities.includes(v.entity)){Q(y,v);const W=v.resolve;Q(s,A(s)),setTimeout(()=>{Q(y,void 0),v.count++,v.count>1&&W()},600)}};t().onAnimation.append(H);const P=v=>{console.info(v),p({phaseChange:v})},q=()=>(A(s).cellType==="Deck"||A(s).cellType==="ExtraDeck"||A(s).cellType==="Graveyard"||A(s).cellType==="Banished")&&A(s).entities.flatMap(v=>v.actions).filter(v=>A(l).map(W=>W.seq).some(W=>W===v.seq)).length>0,Z=()=>{if(Fe(s,A(s).field.duel.view.infoBoardState="Log"),A(s).cellType==="Deck"||A(s).cellType==="ExtraDeck"||A(s).cellType==="Graveyard"||A(s).cellType==="Banished"){Fe(s,A(s).field.duel.view.infoBoardState="CellInfo"),Fe(s,A(s).field.duel.view.infoBoardCell=A(s)),A(s).field.duel.view.requireUpdate();const v=A(s).entities.flatMap(W=>W.actions).filter(W=>A(l).map($=>$.seq).some($=>$===W.seq));if(console.log(A(l)),console.log(v),v.length){const W=A(s).field.duel.view;W.modalController.selectAction(W,{title:"カードを選択。",actions:v,cancelable:!0}).then($=>{p({actionWIP:$})});return}}A(s).field.duel.view.requireUpdate(),console.info(A(s))},X=v=>{v.preventDefault(),v.dataTransfer&&(v.dataTransfer.dropEffect="move")},B=v=>{v.preventDefault(),console.info("drop",v,A(h),k),v.dataTransfer&&(v.dataTransfer.dropEffect="move");try{A(h)&&k&&(console.info(k,A(s)),k.length===1?p({actionWIP:{...k[0],cell:A(s)}}):k.length>1&&(A(s).field.duel.view.modalController.cancelAll(),A(s).field.duel.view.modalController.selectAction(A(s).field.duel.view,{title:"選択",actions:k,cancelable:!1})))}finally{t().removeDraggingActions()}},I=(...v)=>{if(c&&c.find(j=>v.find(ie=>j===ie)))return"Selectable";if(!A(l)||A(l).length===0||t().waitMode!=="SelectFieldAction"||Object.values(t().modalController.states).some(j=>j==="Shown"))return"Disabled";const W=A(l).filter(j=>v.includes(j.entity));if(W.length===0)return"Disabled";if(W.length>1)return"Clickable";if(A(l)[0].playType==="RuleDraw")return"Draggable";if(["Deck","ExtraDeck","Graveyard","Banished"].includes(A(s).cellType)||W[0].entity!==v[0])return"Clickable";const $=W[0].validate();return $&&$.length>0?"Draggable":"Clickable"};Le();var ee=Do(),Ae=u(ee);Ae.__click=Z;var ue=u(Ae);{var De=v=>{var W=he(),$=V(W);{var j=ie=>{var K=he(),Y=V(K);{var N=F=>{var z=ao(),ae=u(z),J=u(ae),te=f(ae,1,!0);L((oe,ne)=>{b(J,oe),b(te,ne)},[()=>String(A(s).field.duel.clock.turn).padStart(2,"0"),()=>A(s).field.duel.phase.toUpperCase()],Ce),C(F,z)},S=F=>{var z=he(),ae=V(z);{var J=oe=>{var ne=ro(),T=u(ne),g=u(T),U=f(T,2),x=u(U);L(()=>{b(g,A(s).field.duel.duelists.Above.lp),b(x,A(s).field.duel.duelists.Below.lp)}),C(oe,ne)},te=oe=>{var ne=he(),T=V(ne);{var g=U=>{var x=he(),O=V(x);{var se=le=>{var Oe=he(),ut=V(Oe);{var gt=je=>{var Ge=he(),It=V(Ge);me(It,1,()=>t().duel.nextPhaseList,ke,(Zt,Bt)=>{var rt=oo(),Ze=u(rt);Ze.__click=[so,P,Bt];var Et=u(Ze);L(xt=>b(Et,xt),[()=>A(Bt).toUpperCase()],Ce),C(Zt,rt)}),C(je,Ge)};R(ut,je=>{t().duel.isEnded||je(gt)})}C(le,Oe)};R(O,le=>{t().waitMode==="SelectFieldAction"&&le(se)})}C(U,x)};R(T,U=>{A(s).column===5&&U(g)},!0)}C(oe,ne)};R(ae,oe=>{A(s).column===3?oe(J):oe(te,!1)},!0)}C(F,z)};R(Y,F=>{A(s).column===1?F(N):F(S,!1)})}C(ie,K)};R($,ie=>{A(s).row===3&&ie(j)})}C(v,W)},G=v=>{var W=he(),$=V(W);{var j=K=>{var Y=co(),N=V(Y);{var S=J=>{var te=Ao(),oe=u(te);Je(oe,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),L(()=>we(te,`card_animation_receiver ${A(s).cellType??""} svelte-pz8cwr`)),Nt(1,te,()=>E,()=>({key:A(y).entity.seq})),C(J,te)};R(N,J=>{A(y)&&A(y).entity&&A(y).to===A(s)&&A(y).index==="Top"&&J(S)})}var F=f(N,2);me(F,1,()=>A(s).cardEntities,ke,(J,te)=>{var oe=he(),ne=V(oe);{var T=g=>{var U=lo(),x=u(U);const O=Ce(()=>I(A(te))),se=Ce(()=>A(l).filter(le=>le.entity===A(te)));Je(x,{get entity(){return A(te)},get state(){return A(O)},get actions(){return A(se)},cardActionResolve:void 0,get selectedList(){return r()},set selectedList(le){r(le)},$$legacy:!0}),Nt(2,U,()=>_,()=>({key:A(te).seq})),C(g,U)};R(ne,g=>{(!A(y)||A(y).entity.seq!==A(te).seq)&&g(T)})}C(J,oe)});var z=f(F,2);{var ae=J=>{var te=po(),oe=u(te);Je(oe,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),L(()=>we(te,`card_animation_receiver ${A(s).cellType??""} svelte-pz8cwr`)),Nt(1,te,()=>E,()=>({key:A(y).entity.seq})),C(J,te)};R(z,J=>{A(y)&&A(y).entity&&A(y).to===A(s)&&A(y).index==="Bottom"&&J(ae)})}C(K,Y)},ie=K=>{var Y=Co(),N=V(Y);{var S=ne=>{var T=ko(),g=u(T);Je(g,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Nt(1,T,()=>E,()=>({key:A(y).entity.seq})),C(ne,T)};R(N,ne=>{A(y)&&A(y).entity&&A(y).to===A(s)&&A(y).index==="Bottom"&&ne(S)})}var F=f(N,2);{var z=ne=>{var T=ho(),g=V(T);me(g,1,()=>A(s).cardEntities.toReversed(),ke,(O,se,le)=>{var Oe=he(),ut=V(Oe);{var gt=je=>{var Ge=mo(),It=u(Ge);const Zt=Ce(()=>le===0?I(...A(s).cardEntities):void 0),Bt=Ce(()=>le===0?A(l).filter(rt=>A(s).cardEntities.includes(rt.entity)):void 0);Je(It,{get entity(){return A(se)},get state(){return A(Zt)},get actions(){return A(Bt)},cardActionResolve:void 0,get selectedList(){return r()},set selectedList(rt){r(rt)},$$legacy:!0}),Nt(2,Ge,()=>_,()=>({key:A(se).seq})),C(je,Ge)};R(ut,je=>{(!A(y)||A(y).entity.seq!==A(se).seq)&&je(gt)})}C(O,Oe)});var U=f(g,2);{var x=O=>{var se=uo(),le=u(se);L(()=>b(le,`【${(A(s).cardEntities[0].battlePotion==="Attack"?"攻撃表示":A(s).cardEntities[0].battlePotion==="Defense"?"表守備表示":"裏守備表示")??""}】`)),C(O,se)};R(U,O=>{A(s).cardEntities[0].battlePotion&&O(x)})}C(ne,T)};R(F,ne=>{A(s).cardEntities.length>0&&ne(z)})}var ae=f(F,2);{var J=ne=>{var T=wo(),g=u(T);L(()=>b(g,A(s).cardEntities.length)),C(ne,T)};R(ae,ne=>{(A(s).cellType==="Deck"||A(s).cellType==="ExtraDeck"||A(s).cellType==="Graveyard"||A(s).cellType==="Banished")&&ne(J)})}var te=f(ae,2);{var oe=ne=>{var T=fo(),g=u(T);Je(g,{get entity(){return A(y).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Nt(1,T,()=>E,()=>({key:A(y).entity.seq})),C(ne,T)};R(te,ne=>{A(y)&&A(y).entity&&A(y).to===A(s)&&A(y).index==="Top"&&ne(oe)})}C(K,Y)};R($,K=>{A(s).cellType==="Hand"?K(j):K(ie,!1)},!0)}C(v,W)};R(ue,v=>{A(s).cellType==="Disable"?v(De):v(G,!1)})}L(v=>{we(ee,`${`duel_field_cell duel_field_cell_${A(s).cellType}`??""} svelte-pz8cwr`),St(ee,"colspan",A(s).cellType==="Hand"?7:1),we(Ae,`${v??""} svelte-pz8cwr`)},[()=>`duel_card_wrapper ${A(s).cellType} ${A(h)?"can_accept_drop":""} ${q()?"can_action":""}`],Ce),ve("dragover",Ae,v=>X(v)),ve("drop",Ae,v=>B(v)),C(n,ee),be()}di(["click"]);var vo=M('<tr><td style=" white-space: nowrap;text-align: center;"> </td><td class="svelte-13svkzh"> </td></tr>'),go=M('<div class="duel_log svelte-13svkzh"><table><tbody></tbody></table></div>');function Bo(n,e){var l,p;Ne(e,!1);let t=ye(void 0),i=ce(e,"log",12);const a=()=>{i(i()),Hr().then(()=>A(t)&&A(t).scroll(0,A(t).clientHeight*10))};(p=(l=i())==null?void 0:l.onUpdate)==null||p.append(a),Le();var r=go(),s=u(r),o=u(s);me(o,5,()=>i().records,ke,(c,m)=>{var k=vo(),h=u(k),w=u(h),D=f(h),_=u(D);L(()=>{var E,y;we(h,`duelist ${((E=A(m).duelist)==null?void 0:E.seat)??""} svelte-13svkzh`),b(w,((y=A(m).duelist)==null?void 0:y.profile.name)||"SYSTEM"),b(_,A(m).text)}),C(c,k)}),ss(r,c=>Q(t,c),()=>A(t)),C(n,r),be()}const Eo=n=>new Promise(e=>setTimeout(e,n));var xo=M('<div><div class="duelist_name svelte-12u0sqq"> </div> <div> </div></div>');function Li(n,e){Ne(e,!1);let t=ce(e,"duelist",12),i=ye(0),a=ye();const r=async()=>{const k=t().lp-A(i);if(!A(a)||Math.abs(k)<10){Q(i,t().lp),A(a)&&(A(a)(),Q(a,void 0));return}Q(i,A(i)+Math.floor(Math.random()*k)),await Eo(100),r()},s=()=>{t(t()),!A(a)&&t().lp!==A(i)&&new Promise(k=>{Q(a,k),Math.abs(t().lp-A(i)),r()})};t().duel.log.onUpdate.append(s),r(),Le();var o=xo(),l=u(o),p=u(l),c=f(l,2),m=u(c);L(()=>{we(o,`duelist ${t().seat??""} svelte-12u0sqq`),b(p,t().profile.name),we(c,`duelist_lp ${(A(a)?"vibration":"")??""} svelte-12u0sqq`),b(m,A(i))}),C(n,o),be()}const To=()=>{};var Mo=M("<div><!></div>"),No=(n,e,t)=>e.resolve(A(t)),bo=(n,e)=>e.resolve(void 0),_o=M('<button class="svelte-12javsj">Cancel</button>'),Fo=M('<div class="base svelte-12javsj"><button class="overlay svelte-12javsj">★</button> <div class="window svelte-12javsj"><div> </div> <div class="entities_list svelte-12javsj"></div> <div><button class="svelte-12javsj">OK</button> <!></div></div></div>');function Ho(n,e){Ne(e,!0);let t=mr(At([]));var i=he(),a=V(i);{var r=s=>{var o=Fo(),l=u(o);l.__click=[To];var p=f(l,2),c=u(p),m=u(c),k=f(c,2);me(k,21,()=>e.entities,ke,(E,y)=>{var H=Mo(),P=u(H);Je(P,{get entity(){return A(y)},isVisibleForcibly:!0,state:"Selectable",entitySelectResolve:q=>e.resolve(q),get qty(){return e.qty},cardActionResolve:void 0,get selectedList(){return A(t)},set selectedList(q){Q(t,At(q))}}),C(E,H)});var h=f(k,2),w=u(h);w.__click=[No,e,t];var D=f(w,2);{var _=E=>{var y=_o();y.__click=[bo,e],C(E,y)};R(D,E=>{e.cancelable&&E(_)})}L(E=>{b(m,e.title),w.disabled=E},[()=>!e.validator(A(t))]),C(s,o)};R(a,s=>{s(r)})}C(n,i),be()}di(["click"]);const Ko=(n,e)=>{e.cancelable&&e.resolve(void 0)};var So=M('<div class="duel_card_wrapper svelte-11mc7y0"><!> <div> </div></div>'),Wo=(n,e)=>e.resolve(),Po=M('<div><button class="cancel_button svelte-11mc7y0">Cancel</button></div>'),qo=M('<div><button>★</button> <div><div> </div> <div class="flex svelte-11mc7y0"></div> <!></div></div>');function Lo(n,e){Ne(e,!0);const[t,i]=ds(),a=()=>ls(r,"$isDragging",t);let r=os(!1);const s=()=>r.set(!0),o=()=>r.set(!1);e.view.onDragStart.append(s),e.view.onDragEnd.append(o);const l=k=>{const h=k.validate();return h&&h.length>0?"Draggable":"Clickable"};var p=he(),c=V(p);{var m=k=>{var h=qo(),w=u(h);w.__click=[Ko,e];var D=f(w,2),_=u(D),E=u(_),y=f(_,2);me(y,21,()=>e.actions,ke,(q,Z)=>{var X=So(),B=u(X);const I=Dt(()=>l(A(Z))),ee=Dt(()=>e.dragAndDropOnly?[]:[A(Z)]);Je(B,{get entity(){return A(Z).entity},isVisibleForcibly:!0,get state(){return A(I)},get actions(){return A(ee)},get cardActionResolve(){return e.resolve}});var Ae=f(B,2),ue=u(Ae);L(()=>b(ue,`«${A(Z).title??""}»`)),C(q,X)});var H=f(y,2);{var P=q=>{var Z=Po(),X=u(Z);X.__click=[Wo,e],C(q,Z)};R(H,q=>{e.cancelable&&q(P)})}L(()=>{we(h,`${`base ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(w,`${`overlay ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(D,`${`window ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),b(E,e.title)}),C(k,h)};R(c,k=>{k(m)})}C(n,p),be(),i()}di(["click"]);var Ro=M('<div class="base svelte-1y912d"><!> <!></div>');function Oo(n,e){var p,c;Ne(e,!1);let t=ce(e,"modalController",12);const i=()=>{t(t())};(c=(p=t())==null?void 0:p.onUpdate)==null||c.append(i),Le();var a=Ro(),r=u(a);{var s=m=>{Ho(m,{get title(){return t().duelEntitiesSelectorArg.title},get entities(){return t().duelEntitiesSelectorArg.entities},get validator(){return t().duelEntitiesSelectorArg.validator},get qty(){return t().duelEntitiesSelectorArg.qty},get cancelable(){return t().duelEntitiesSelectorArg.cancelable},resolve:k=>{t().duelEntitiesSelectorResolve(k)}})};R(r,m=>{t().states.DuelEntitiesSelector==="Shown"&&m(s)})}var o=f(r,2);{var l=m=>{const k=Ce(()=>t().cardActionSelectorArg.dragAndDropOnly??!1);Lo(m,{get view(){return t().view},get title(){return t().cardActionSelectorArg.title},get actions(){return t().cardActionSelectorArg.actions},get dragAndDropOnly(){return A(k)},get cancelable(){return t().cardActionSelectorArg.cancelable},resolve:h=>{console.info(h),t().cardActionSelectorResolve(h)}})};R(o,m=>{t().states.DuelActionSelector==="Shown"&&m(l)})}C(n,a),be()}var Io=M('<div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div> <div class="duel_card_info_row svelte-1qhzdl0" style=" justify-content: space-between;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div>',1),Zo=M('<div></div> <div class="svelte-1qhzdl0"> </div>',1),Uo=M("<div> </div>"),$o=M("<div> </div>"),Yo=M('<div class="duel_card_info_row svelte-1qhzdl0"><!> <!></div> <div class="duel_card_info_row svelte-1qhzdl0"></div>',1),zo=M('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),jo=M('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),Go=M('<div><div class="duel_card_info_header svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"> </div></div> <div class="duel_card_info_row svelte-1qhzdl0" style="position:sticky; top:0;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div> <!> <!></div> <div class="duel_card_info_body svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div></div> <div class="duel_card_info_footer svelte-1qhzdl0"><div class="duel_card_info_links svelte-1qhzdl0"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1qhzdl0">⇒遊戯王カードWiki</a></div></div></div>');function Vo(n,e){Ne(e,!1);let t=ce(e,"entity",8,void 0);const i=()=>t()?Te[t().origin.name]:void 0;Le();var a=he(),r=V(a);{var s=o=>{var l=Go(),p=u(l),c=u(p),m=u(c),k=u(m),h=f(c,2),w=u(h),D=u(w),_=f(w,2),E=u(_),y=f(h,2);{var H=v=>{var W=Io(),$=V(W),j=u($),ie=u(j),K=u(ie),Y=f($,2),N=u(Y),S=u(N),F=f(N,2),z=u(F);L(()=>{b(K,Te[t().origin.name].pendulumDescription),b(S,`◀ ${t().psL??""}`),b(z,`${t().psR??""} ▶`)}),C(v,W)};R(y,v=>{var W;(W=t().status.monsterCategories)!=null&&W.includes("Pendulum")&&v(H)})}var P=f(y,2);{var q=v=>{var W=Yo(),$=V(W),j=u($);me(j,1,()=>t().attr,ke,(N,S)=>{var F=Zo(),z=V(F),ae=f(z,2),J=u(ae);L(()=>{we(z,`monster_attr ${A(S)??""} svelte-1qhzdl0`),b(J,`${ci[A(S)]??""}属性`)}),C(N,F)});var ie=f(j,2);{var K=N=>{var S=Uo(),F=u(S);L(()=>{we(S,`monster_cat ${t().status.type??""} svelte-1qhzdl0`),b(F,`${nn[t().status.type]??""}${Fn[t().status.type]??""}族`)}),C(N,S)};R(ie,N=>{t().status.type&&N(K)})}var Y=f($,2);me(Y,5,()=>t().status.monsterCategories??[],ke,(N,S)=>{var F=$o(),z=u(F);L(()=>{we(F,`monster_cat ${A(S)??""} svelte-1qhzdl0`),b(z,`${Jt[A(S)]??""}${_n[A(S)]??""}`)}),C(N,F)}),C(v,W)},Z=v=>{var W=he(),$=V(W);{var j=K=>{var Y=zo(),N=f(u(Y),2),S=u(N);L(()=>b(S,`${en[t().status.spellCategory]??""}魔法`)),C(K,Y)},ie=K=>{var Y=he(),N=V(Y);{var S=F=>{var z=jo(),ae=f(u(z),2),J=u(ae);L(()=>b(J,`${tn[t().status.trapCategory]??""}罠`)),C(F,z)};R(N,F=>{t().status.kind==="Trap"&&t().status.trapCategory&&F(S)},!0)}C(K,Y)};R($,K=>{t().status.kind==="Spell"&&t().status.spellCategory?K(j):K(ie,!1)},!0)}C(v,W)};R(P,v=>{t().status.kind==="Monster"?v(q):v(Z,!1)})}var X=f(p,2),B=u(X),I=u(B),ee=u(I),Ae=u(ee),ue=f(X,2),De=u(ue),G=u(De);L((v,W,$,j,ie)=>{we(l,`duel_card duel_card_info ${t().origin.kind??""} ${v??""} svelte-1qhzdl0`),b(k,t().nm),b(D,W),b(E,$),b(Ae,j),St(G,"href",ie)},[()=>{var v;return(v=t().origin.monsterCategories)==null?void 0:v.join(" ")},()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0),()=>{var v;return(v=i())==null?void 0:v.description},()=>{var v;return(v=i())==null?void 0:v.wikiHref}],Ce),C(o,l)};R(r,o=>{t()&&o(s)})}C(n,a),be()}var Qo=M('<div class="duel_field_cell_info_item svelte-1xj7qf1"><!></div>'),Xo=M('<div class="duel_field_cell_info_box svelte-1xj7qf1"><div class="duel_field_cell_info_label svelte-1xj7qf1"> </div> <!></div>'),Jo=M('<div class="duel_field_cell_info svelte-1xj7qf1"><div class="duel_field_cell_info_header item_btn svelte-1xj7qf1"><div class="svelte-1xj7qf1"> </div> <div class="svelte-1xj7qf1"> </div></div> <div class="duel_field_cell_info_body svelte-1xj7qf1"></div></div>');function eA(n,e){Ne(e,!1);let t=ce(e,"cell",12);const i=()=>{t(t())},a=k=>t().cardEntities.filter(h=>h.face===k);t().field.duel.view.onDuelUpdate.append(i),Le();var r=Jo(),s=u(r),o=u(s),l=u(o),p=f(o,2),c=u(p),m=f(s,2);me(m,4,()=>["FaceUp","FaceDown"],ke,(k,h)=>{var w=he(),D=V(w);{var _=E=>{var y=Xo(),H=u(y),P=u(H),q=f(H,2);me(q,1,()=>a(h).toSorted(Rs),ke,(Z,X)=>{var B=Qo(),I=u(B);const ee=Ce(()=>t().owner===t().field.duel.duelists.Below);Je(I,{get entity(){return A(X)},get isVisibleForcibly(){return A(ee)},isWideMode:!0,cardActionResolve:void 0}),C(Z,B)}),L(()=>b(P,h==="FaceUp"?"表向き":"裏向き")),C(E,y)};R(D,E=>{a(h).length&&E(_)})}C(k,w)}),L(()=>{var k;b(l,(k=t().owner)==null?void 0:k.profile.name),b(c,t().cellType)}),C(n,r),be()}const tA=Gs({duration:400});var nA=M('<div class="duel_field_header_message svelte-accyye"> </div> <div class="duel_field_header_buttons svelte-accyye"><button class="svelte-accyye">サレンダー</button></div>',1),iA=M("<tr></tr>"),aA=M('<table class="duel_field svelte-accyye"><tbody class="svelte-accyye"></tbody></table>'),rA=M('<button class="svelte-accyye">OK</button>'),sA=M('<div style="position:absolute;right:0;top:0"> </div> <div class="flex duel_desk svelte-accyye"><div class="duel_desk_left v_flex svelte-accyye"><!> <!> <!></div> <div class=" duel_desk_center v_flex svelte-accyye"><div class="duel_field_header svelte-accyye"><!></div> <div class="svelte-accyye"><!></div> <div class="duel_field_footer svelte-accyye"><!></div></div> <div class=" duel_desk_right svelte-accyye" style="text-align: left;"><!></div></div> <!>',1);function oA(n,e){Ne(e,!1);let t=ce(e,"duel",12),i=()=>{},a=ye(()=>!0),r=ye();const s=K=>{i=K.resolve,Q(a,K.entitiesValidator),Q(r,K.selectableEntities),K.duelEntitiesSelectorArg&&t().view.modalController.selectDuelEntities(K.duelEntitiesSelectorArg).then(Y=>{i({selectedEntities:Y})})};t().view.onWaitStart.append(s);let o=ye(void 0);const l=K=>{Q(o,K)};t().view.onShowCardEntity.append(l);let p=ce(e,"selectedList",28,()=>[]);const c=()=>{t(t())};t().view.onDuelUpdate.append(c);const m=()=>{A(a)(p())&&i({selectedEntities:p()})},k=()=>{i({surrender:!0})};t().main(),Le();var h=sA(),w=V(h),D=u(w),_=f(w,2),E=u(_),y=u(E);Li(y,{get duelist(){return t().duelists.Above}});var H=f(y,2);Vo(H,{get entity(){return A(o)}});var P=f(H,2);Li(P,{get duelist(){return t().duelists.Below}});var q=f(E,2),Z=u(q),X=u(Z);{var B=K=>{var Y=nA(),N=V(Y),S=u(N),F=f(N,2),z=u(F);L(()=>b(S,`[TURN:${t().clock.turn}][PHASE:${t().phase}] ${t().view.message}`)),ve("click",z,k),C(K,Y)};R(X,K=>{t().isEnded||K(B)})}var I=f(Z,2),ee=u(I);{var Ae=K=>{var Y=aA(),N=u(Y);me(N,5,()=>t().field.cells,ke,(S,F,z)=>{var ae=iA();we(ae,`${`duel_desk_row_${z}`??""} svelte-accyye`),me(ae,5,()=>A(F),ke,(J,te,oe)=>{yo(J,{get view(){return t().view},row:z,column:oe,get selectedList(){return p()},set selectedList(ne){p(ne)},$$legacy:!0})}),C(S,ae)}),C(K,Y)};R(ee,K=>{t().clock.turn>0&&K(Ae)})}var ue=f(I,2),De=u(ue);{var G=K=>{var Y=rA();L(N=>Y.disabled=N,[()=>!A(a)(p())],Ce),ve("click",Y,m),C(K,Y)};R(De,K=>{A(r)&&A(r).length>0&&K(G)})}var v=f(q,2),W=u(v);{var $=K=>{Bo(K,{get log(){return t().log}})},j=K=>{var Y=he(),N=V(Y);{var S=F=>{eA(F,{get cell(){return t().view.infoBoardCell}})};R(N,F=>{t().view.infoBoardState==="CellInfo"&&F(S)},!0)}C(K,Y)};R(W,K=>{t().view.infoBoardState==="Log"?K($):K(j,!1)})}var ie=f(_,2);Oo(ie,{get modalController(){return t().view.modalController}}),L(K=>b(D,K),[()=>t().clock.toString()],Ce),C(n,h),be()}var AA=M("<div></div>"),lA=M('<span> </span> / <span style="display: inline-block;width:2rem;text-align: right;"> </span>',1),dA=M('<li class="deck_editor_item svelte-vivzk2"><div role="listitem"><div class="svelte-vivzk2"><div class="svelte-vivzk2"> </div> <div style="display:flex" class="svelte-vivzk2"><div class="svelte-vivzk2"><!> <!> <!> <!> <!> <!> <!></div> <div style="flex-grow: 1; width:0.1rem" class="svelte-vivzk2"></div> <div class="svelte-vivzk2"><!></div></div></div></div> <button class="button_style_reset svelte-vivzk2">+</button> <button class="button_style_reset svelte-vivzk2">-</button></li>'),pA=M('<div class="deck_editor_card_kind svelte-vivzk2"><span class="svelte-vivzk2"> </span> <ul class="svelte-vivzk2"></ul></div>'),cA=M('<div class="deck_editor_deck_type svelte-vivzk2"><span class="svelte-vivzk2"> </span> <!></div>'),kA=M('<div class="deck_editor_card_list svelte-vivzk2"></div>');function Ri(n,e){Ne(e,!1);let t=ce(e,"allCardInfos",8),i=ce(e,"deckCardInfos",12),a=ce(e,"mode",8),r=ce(e,"onAttention",8);const s={Deck:["Monster","Spell","Trap"],ExtraDeck:["Monster"]},o=(m,k)=>(a()==="List"?t():i()).filter(h=>{var w;return Vn.has(h.name)||((w=h.monsterCategories)==null?void 0:w.includes("Normal"))}).filter(h=>!k||h.kind===k).filter(h=>{var w,D;return!m||m==="Deck"&&!((w=h==null?void 0:h.monsterCategories)!=null&&w.union(Gt).length)||m==="ExtraDeck"&&((D=h==null?void 0:h.monsterCategories)==null?void 0:D.union(Gt).length)}).toSorted(pn),l=(m,k)=>{const h=i().filter(D=>D.name===k.name).length;if(h>2)return;const w=m.shiftKey?3-h:1;w<1||(i().push(...Array(w).fill(k)),i().sort(pn),i(i()))},p=(m,k)=>{let h=0;i(i().filter(w=>w.name!==k.name?!0:(h++,!m.shiftKey&&h>1))),i().sort(pn)};Le();var c=kA();me(c,5,()=>us,ke,(m,k)=>{var h=cA(),w=u(h),D=u(w),_=f(w,2);me(_,1,()=>s[A(k)],ke,(E,y)=>{var H=pA(),P=u(H),q=u(P),Z=f(P,2);me(Z,5,()=>o(A(k),A(y)),ke,(X,B)=>{var I=dA(),ee=u(I),Ae=u(ee),ue=u(Ae),De=u(ue),G=f(ue,2),v=u(G),W=u(v);{var $=x=>{var O=Tt();L(()=>b(O,`★${A(B).level??""}`)),C(x,O)};R(W,x=>{A(B).level&&x($)})}var j=f(W,2);{var ie=x=>{var O=Tt();L(()=>b(O,`☆${A(B).rank??""}`)),C(x,O)};R(j,x=>{A(B).rank&&x(ie)})}var K=f(j,2);{var Y=x=>{var O=AA();L(()=>we(O,`monster_attr ${A(B).attribute??""} svelte-vivzk2`)),C(x,O)};R(K,x=>{A(B).attribute!==void 0&&x(Y)})}var N=f(K,2);{var S=x=>{var O=Tt();L(()=>b(O,nn[A(B).type])),C(x,O)};R(N,x=>{A(B).type!==void 0&&x(S)})}var F=f(N,2);me(F,1,()=>A(B).monsterCategories??[],ke,(x,O)=>{var se=Tt();L(()=>b(se,Jt[A(O)])),C(x,se)});var z=f(F,2);{var ae=x=>{var O=Tt();L(()=>b(O,`${en[A(B).spellCategory]??""}魔法`)),C(x,O)};R(z,x=>{A(B).spellCategory!==void 0&&x(ae)})}var J=f(z,2);{var te=x=>{var O=Tt();L(()=>b(O,`${tn[A(B).trapCategory]??""}罠`)),C(x,O)};R(J,x=>{A(B).trapCategory!==void 0&&x(te)})}var oe=f(v,4),ne=u(oe);{var T=x=>{var O=lA(),se=V(O),le=u(se),Oe=f(se,2),ut=u(Oe);L(()=>{b(le,A(B).attack),b(ut,A(B).defense??"-")}),C(x,O)};R(ne,x=>{A(B).attack!==void 0&&x(T)})}var g=f(ee,2),U=f(g,2);L(x=>{we(ee,`${x??""} svelte-vivzk2`),b(De,A(B).name)},[()=>{var x,O;return`deck_editor_card duel_card ${A(B).kind} ${(O=(x=A(B))==null?void 0:x.monsterCategories)==null?void 0:O.join(" ")} ${Vn.has(A(B).name)?"is_implemented":"is_not_implemented"}`}],Ce),ve("mouseenter",ee,()=>r()(A(B))),ve("click",g,x=>l(x,A(B))),ve("click",U,x=>p(x,A(B))),C(X,I)}),L(()=>b(q,Ba[A(y)])),C(E,H)}),L(()=>b(D,hs[A(k)])),C(m,h)}),C(n,c),be()}var mA=M('<div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_row svelte-1xf9hqi" style=" justify-content: space-between;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div>',1),uA=M('<div></div> <div class="svelte-1xf9hqi"> </div>',1),hA=M("<div> </div>"),wA=M("<div> </div>"),fA=M('<div class="duel_card_info_row svelte-1xf9hqi"><!> <!></div> <div class="duel_card_info_row svelte-1xf9hqi"></div>',1),CA=M('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),DA=M('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),yA=M('<div><div class="duel_card_info_header svelte-1xf9hqi"><div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"> </div></div> <div class="duel_card_info_row svelte-1xf9hqi" style="position:sticky; top:0;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div></div> <div class="duel_card_info_body svelte-1xf9hqi"><!> <!> <div class="duel_card_info_row description svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_links svelte-1xf9hqi"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1xf9hqi">⇒遊戯王カードWiki</a></div></div></div>');function vA(n,e){Ne(e,!1);let t=ce(e,"cardInfo",8,void 0);const i=()=>t()?Te[t().name]:void 0;Le();var a=he(),r=V(a);{var s=o=>{var l=yA(),p=u(l),c=u(p),m=u(c),k=u(m),h=f(c,2),w=u(h),D=u(w),_=f(w,2),E=u(_),y=f(p,2),H=u(y);{var P=G=>{var v=mA(),W=V(v),$=u(W),j=u($),ie=u(j),K=f(W,2),Y=u(K),N=u(Y),S=f(Y,2),F=u(S);L(()=>{b(ie,Te[t().name].pendulumDescription),b(N,`◀ ${t().pendulumScaleL??""}`),b(F,`${t().pendulumScaleR??""} ▶`)}),C(G,v)};R(H,G=>{var v;(v=t().monsterCategories)!=null&&v.includes("Pendulum")&&G(P)})}var q=f(H,2);{var Z=G=>{var v=fA(),W=V(v),$=u(W);{var j=N=>{var S=uA(),F=V(S),z=f(F,2),ae=u(z);L(()=>{we(F,`monster_attr ${t().attribute??""} svelte-1xf9hqi`),b(ae,`${ci[t().attribute]??""}属性`)}),C(N,S)};R($,N=>{t().attribute&&N(j)})}var ie=f($,2);{var K=N=>{var S=hA(),F=u(S);L(()=>{we(S,`monster_cat ${t().type??""} svelte-1xf9hqi`),b(F,`${nn[t().type]??""}${Fn[t().type]??""}族`)}),C(N,S)};R(ie,N=>{t().type&&N(K)})}var Y=f(W,2);me(Y,5,()=>t().monsterCategories??[],ke,(N,S)=>{var F=wA(),z=u(F);L(()=>{we(F,`monster_cat ${A(S)??""} svelte-1xf9hqi`),b(z,`${Jt[A(S)]??""}${_n[A(S)]??""}`)}),C(N,F)}),C(G,v)},X=G=>{var v=he(),W=V(v);{var $=ie=>{var K=CA(),Y=f(u(K),2),N=u(Y);L(()=>b(N,`${en[t().spellCategory]??""}魔法`)),C(ie,K)},j=ie=>{var K=he(),Y=V(K);{var N=S=>{var F=DA(),z=f(u(F),2),ae=u(z);L(()=>b(ae,`${tn[t().trapCategory]??""}罠`)),C(S,F)};R(Y,S=>{t().kind==="Trap"&&t().trapCategory&&S(N)},!0)}C(ie,K)};R(W,ie=>{t().kind==="Spell"&&t().spellCategory?ie($):ie(j,!1)},!0)}C(G,v)};R(q,G=>{t().kind==="Monster"?G(Z):G(X,!1)})}var B=f(q,2),I=u(B),ee=u(I),Ae=u(ee),ue=f(B,2),De=u(ue);L((G,v,W,$,j)=>{we(l,`duel_card duel_card_info ${t().kind??""} ${G??""} svelte-1xf9hqi`),b(k,t().name),b(D,v),b(E,W),b(Ae,$),St(De,"href",j)},[()=>{var G;return(G=t().monsterCategories)==null?void 0:G.join(" ")},()=>"★".repeat(t().level||0),()=>"☆".repeat(t().rank||0),()=>{var G;return(G=i())==null?void 0:G.description},()=>{var G;return(G=i())==null?void 0:G.wikiHref}],Ce),C(o,l)};R(r,o=>{t()&&o(s)})}C(n,a),be()}const gA={0:{aaa:"日",aaaa:"日曜日",ddd:"Sun",dddd:"Sunday"},1:{aaa:"月",aaaa:"月曜日",ddd:"Mon",dddd:"Monday"},2:{aaa:"火",aaaa:"火曜日",ddd:"Tue",dddd:"Tuesday"},3:{aaa:"水",aaaa:"水曜日",ddd:"Wed",dddd:"Wednesday"},4:{aaa:"木",aaaa:"木曜日",ddd:"Thu",dddd:"Thursday"},5:{aaa:"金",aaaa:"金曜日",ddd:"Fri",dddd:"Friday"},6:{aaa:"土",aaaa:"土曜日",ddd:"Sat",dddd:"Saturday"}};class BA{constructor(){d(this,"DefaultSeparator1","/");d(this,"DefaultSeparator2"," ");d(this,"DefaultSeparator3",":");d(this,"createDate",e=>{if(!e)return;const t=new Date(e);if(!isNaN(t.getTime()))return t});d(this,"createDateOr",(e,t)=>this.createDate(e)||t||new Date);d(this,"truncateDate",e=>{const t=e||new Date;return new Date(t.getFullYear(),t.getMonth(),t.getDate())});d(this,"addDate",(e,t)=>{const i=this.createDateOr(e);return i.setDate(i.getDate()+t),i});d(this,"addMonth",(e,t)=>{const i=this.createDateOr(e);return i.setMonth(i.getMonth()+t),i});d(this,"addYear",(e,t)=>{const i=this.createDateOr(e);return i.setFullYear(i.getFullYear()+t),i});d(this,"getDayOfWeek",(e,t="dddd")=>{const i=this.createDate(e);return i?gA[i.getDay()][t]:""});d(this,"formatToYYYYMMDD",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";const a=i.getFullYear().toString(),r=("0"+(i.getMonth()+1)).slice(-2),s=("0"+i.getDate()).slice(-2);return a+t+r+t+s});d(this,"formatToYYYYMM",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getFullYear().toString(),r=("0"+(i.getMonth()+1)).slice(-2);return a+t+r});d(this,"formatToHHMMSS",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getHours(),r=i.getMinutes(),s=i.getSeconds();return("0"+a).slice(-2)+t+("0"+r).slice(-2)+t+("0"+s).slice(-2)});d(this,"formatToHHMM",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=("0"+i.getHours()).slice(-2),r=("0"+i.getMinutes()).slice(-2);return a+t+r});d(this,"formatToYYYYMMDD_HHMM",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const r=this.createDate(e);return r?this.formatToYYYYMMDD(r,t)+i+this.formatToHHMM(r,a):""});d(this,"formatToYYYYMMDD_HHMMSS",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const r=this.createDate(e);return r?this.formatToYYYYMMDD(r,t)+i+this.formatToHHMMSS(r,a):""})}}const Re=new BA;Date.prototype.truncateDate=function(){return Re.truncateDate(this)};Date.prototype.getCloneOr=function(n){return Re.createDateOr(this,n)};Date.prototype.addDate=function(n){return Re.addDate(this,n)};Date.prototype.addMonth=function(n){return Re.addDate(this,n)};Date.prototype.addYear=function(n){return Re.addDate(this,n)};Date.prototype.getDayOfWeek=function(n="dddd"){return Re.getDayOfWeek(this,n)};Date.prototype.formatToYYYYMM=function(n){return Re.formatToYYYYMM(this,n)};Date.prototype.formatToYYYYMMDD=function(n){return Re.formatToYYYYMMDD(this,n)};Date.prototype.formatToYYYYMMDD_HHMM=function(n,e,t){return Re.formatToYYYYMMDD_HHMM(this,n,e,t)};Date.prototype.formatToYYYYMMDD_HHMMSS=function(n,e,t){return Re.formatToYYYYMMDD_HHMMSS(this,n,e,t)};Date.prototype.formatToHHMM=function(n){return Re.formatToHHMM(this,n)};Date.prototype.formatToHHMMSS=function(n){return Re.formatToHHMMSS(this,n)};var EA=M('<label><input type="checkbox"> </label>'),xA=M('<label><input type="checkbox"> </label>'),TA=M('<label><input type="checkbox"> <div style="display: inline-block;"></div> </label>'),MA=M('<label><input type="checkbox"> </label>'),NA=M('<label><input type="checkbox"> </label>'),bA=M('<label><input type="checkbox"> </label>'),_A=M("<option> </option>"),FA=M('<div class="deck_editor_body_right_header svelte-rsq0rf"><div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">編集対象</div> <select></select></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">新規名称</div> <input type="text"></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">操作</div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを保存</button></div> <div class="svelte-rsq0rf"></div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを複製</button></div> <div class="svelte-rsq0rf"><button title="shiftキー押下で確認メッセージスキップ" class="svelte-rsq0rf">デッキを削除</button></div></div></div> <!>',1),HA=M("<div>デッキ情報読込中</div>"),KA=M('<div class="deck_editor svelte-rsq0rf"><div class="deck_editor_header"></div> <div class="deck_editor_body svelte-rsq0rf"><div class="deck_editor_body_left svelte-rsq0rf"><div class="deck_editor_search_box svelte-rsq0rf"><div><div>検索条件</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">名称</div> <div class="svelte-rsq0rf"><input type="text" style="width:70%">※ルビには対応していません</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種類</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">モンスター</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">属性</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種族</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">魔法</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">罠</div> <div class="svelte-rsq0rf"></div></div></div> <!></div> <div class="deck_editor_body_center svelte-rsq0rf"><!></div> <div class="deck_editor_body_right svelte-rsq0rf"><!></div></div></div>');function SA(n,e){Ne(e,!1);const t=[],i=[],a=[],r=[],s=[],o=[],l=async()=>{const g=(await A(m)).find(U=>U.id===A(c));g&&Q(h,{...g,cardInfos:g.cardNames.map(U=>Te[U])})},p=()=>Ct.getAllDeckInfo().then(T=>(T.forEach(g=>console.log(g.id,g.lastUsedAt,g.lastUsedAt.getTime())),console.log(Math.max(...T.map(g=>g.lastUsedAt.getTime()))),Q(c,(T.find(g=>g.lastUsedAt.getTime()===Math.max(...T.map(U=>U.lastUsedAt.getTime())))??T[0]).id),T));let c=ye(-1),m=ye(p());A(m).then(l);const k=()=>{Q(m,p()),l()};let h=ye({id:Number.MIN_VALUE,name:"",description:"",lastUsedAt:new Date,cardInfos:[]}),w=ye(Te.ゾンビーノ);const D=ye({name:"",cardKinds:[...zn],monsterCategories:[...Ti].filter(T=>T!=="Normal"&&T!=="Token"),monsterAttributes:[...Mi],monsterTypes:[...Ni],spellCategories:[...bi],trapCategories:[..._i]}),_=()=>Object.values(Te).filter(T=>{var g;if(!A(D).cardKinds.includes(T.kind)||A(D).name.trim().length&&!T.name.includes(A(D).name))return!1;if(T.kind==="Monster")return T.attribute&&!A(D).monsterAttributes.includes(T.attribute)||T.type&&!A(D).monsterTypes.includes(T.type)?!1:(g=T.monsterCategories)==null?void 0:g.union(A(D).monsterCategories).length;if(T.kind==="Spell")return T.spellCategory&&A(D).spellCategories.includes(T.spellCategory);if(T.kind==="Trap")return T.trapCategory&&A(D).trapCategories.includes(T.trapCategory)}),E=T=>{Q(w,T)},y=async()=>{const g=(await A(m)).find(U=>U.id===A(c));if(!g)throw new Error("illegal state");return g},H=async()=>{const T=await y();await T.saveDeckInfo({...T,name:A(h).name,cardNames:A(h).cardInfos.map(g=>g.name),lastUsedAt:new Date}),k()},P=async()=>{(await Ct.createNewDeck(`デッキ_${new Date().formatToYYYYMMDD_HHMMSS("","","")}`,`コピー日時：${new Date().formatToYYYYMMDD_HHMMSS("-"," ",":")}`,A(h).cardInfos.map(g=>g.name))).saveDeckInfo(),k()},q=async T=>{const g=await y();!T.shiftKey&&!confirm(`デッキ【${g.name}】を削除します。
よろしいですか？`)||(await g.delete(),k())};Le();var Z=KA(),X=f(u(Z),2),B=u(X),I=u(B),ee=f(u(I),2),Ae=f(u(ee),2),ue=u(Ae),De=f(ee,2),G=f(u(De),2);me(G,5,()=>zn,ke,(T,g)=>{var U=EA(),x=u(U),O,se=f(x);L(()=>{O!==(O=A(g))&&(x.value=(x.__value=A(g))==null?"":A(g)),b(se,` ${Ba[A(g)]??""}`)}),bt(t,[],x,()=>(A(g),A(D).cardKinds),le=>Fe(D,A(D).cardKinds=le)),C(T,U)});var v=f(De,2),W=f(u(v),2);me(W,5,()=>Ti,ke,(T,g)=>{var U=xA(),x=u(U),O,se=f(x);L(()=>{O!==(O=A(g))&&(x.value=(x.__value=A(g))==null?"":A(g)),b(se,` ${Jt[A(g)]??""}${_n[A(g)]??""}`)}),bt(i,[],x,()=>(A(g),A(D).monsterCategories),le=>Fe(D,A(D).monsterCategories=le)),C(T,U)});var $=f(v,2),j=f(u($),2);me(j,5,()=>Mi,ke,(T,g)=>{var U=TA(),x=u(U),O,se=f(x,2),le=f(se);L(()=>{O!==(O=A(g))&&(x.value=(x.__value=A(g))==null?"":A(g)),we(se,`monster_attr ${A(w).attribute??""} svelte-rsq0rf`),b(le,` ${ci[A(g)]??""}`)}),bt(a,[],x,()=>(A(g),A(D).monsterAttributes),Oe=>Fe(D,A(D).monsterAttributes=Oe)),C(T,U)});var ie=f($,2),K=f(u(ie),2);me(K,5,()=>Ni,ke,(T,g)=>{var U=MA(),x=u(U),O,se=f(x);L(()=>{O!==(O=A(g))&&(x.value=(x.__value=A(g))==null?"":A(g)),b(se,` ${nn[A(g)]??""}
                ${Fn[A(g)]??""}`)}),bt(r,[],x,()=>(A(g),A(D).monsterTypes),le=>Fe(D,A(D).monsterTypes=le)),C(T,U)});var Y=f(ie,2),N=f(u(Y),2);me(N,5,()=>bi,ke,(T,g)=>{var U=NA(),x=u(U),O,se=f(x);L(()=>{O!==(O=A(g))&&(x.value=(x.__value=A(g))==null?"":A(g)),b(se,` ${en[A(g)]??""}`)}),bt(s,[],x,()=>(A(g),A(D).spellCategories),le=>Fe(D,A(D).spellCategories=le)),C(T,U)});var S=f(Y,2),F=f(u(S),2);me(F,5,()=>_i,ke,(T,g)=>{var U=bA(),x=u(U),O,se=f(x);L(()=>{O!==(O=A(g))&&(x.value=(x.__value=A(g))==null?"":A(g)),b(se,` ${tn[A(g)]??""}`)}),bt(o,[],x,()=>(A(g),A(D).trapCategories),le=>Fe(D,A(D).trapCategories=le)),C(T,U)});var z=f(I,2);vA(z,{get cardInfo(){return A(w)}});var ae=f(B,2),J=u(ae);const te=Ce(_);Ri(J,{mode:"List",get allCardInfos(){return A(te)},onAttention:E,get deckCardInfos(){return A(h).cardInfos},set deckCardInfos(T){Fe(h,A(h).cardInfos=T)},$$legacy:!0});var oe=f(ae,2),ne=u(oe);Da(ne,()=>A(m),T=>{var g=HA();C(T,g)},(T,g)=>{var U=FA(),x=V(U),O=u(x),se=f(u(O),2);L(()=>{A(c),Sr(()=>{A(g)})}),me(se,5,()=>A(g),ke,(Ze,Et)=>{var xt=_A(),ki={},Ha=u(xt);L(()=>{ki!==(ki=A(Et).id)&&(xt.value=(xt.__value=A(Et).id)==null?"":A(Et).id),b(Ha,A(Et).name)}),C(Ze,xt)});var le=f(O,2),Oe=f(u(le),2),ut=f(le,2),gt=f(u(ut),2),je=u(gt),Ge=f(gt,4),It=u(Ge),Zt=f(Ge,2),Bt=u(Zt),rt=f(x,2);Ri(rt,{mode:"Deck",allCardInfos:[],onAttention:E,get deckCardInfos(){return A(h).cardInfos},set deckCardInfos(Ze){Fe(h,A(h).cardInfos=Ze)},$$legacy:!0}),as(se,()=>A(c),Ze=>Q(c,Ze)),ve("change",se,l),$n(Oe,()=>A(h).name,Ze=>Fe(h,A(h).name=Ze)),ve("click",je,H),ve("click",It,P),ve("click",Bt,q),C(T,U)}),$n(ue,()=>A(D).name,T=>Fe(D,A(D).name=T)),C(n,Z),be()}const WA=["TblDeckHeader","TblDeckDetail","TblDuelistProfile"],PA=3;var qA=M('<div class="svelte-irn2ek"><label for="duelist_name" class="duelist_name svelte-irn2ek">名前：</label> <input id="duelist_name" class="duelist_name svelte-irn2ek" type="text"></div> <div class="svelte-irn2ek"><button class="btn svelte-irn2ek">duel start!</button></div> <div class="svelte-irn2ek"><button class="btn svelte-irn2ek">deck edit</button></div>',1),LA=M('<div class="svelte-irn2ek">デュエリスト情報の読み込み、もしくは作成中...</div>'),RA=M('<div class="app_body svelte-irn2ek"><!></div>'),OA=M('<main class="svelte-irn2ek"><!> <div class="screen_info svelte-irn2ek"></div></main>');function IA(n,e){Ne(e,!1);const t=new ks("stk_ygo_svelte",PA,WA);let i=ye(),a=ye("None");const r=jn.getOrCreateNew(t);let s=Ct.getAllDeckInfo(t);const o=async()=>{(await r).save()},l=()=>{s=Ct.getAllDeckInfo(t)},p=async()=>{(await s).length||(await Ct.prepareSampleDeck(),l())},c=async()=>{await Promise.all([o(),p()]),Q(i,new Ms(await r,"Player",(await s)[0],ys[0],"NPC",cn[0]))},m=async()=>{console.log("hoge"),await Promise.all([o(),p()]),Q(a,"DeckEdit")},k=async E=>{await o(),E.key==="Enter"&&!E.repeat&&(await r).save()};p(),Le();var h=OA(),w=u(h);{var D=E=>{oA(E,{get duel(){return A(i)}})},_=E=>{var y=he(),H=V(y);{var P=Z=>{SA(Z,{})},q=Z=>{var X=RA(),B=u(X);Da(B,()=>r,I=>{var ee=LA();C(I,ee)},(I,ee)=>{var Ae=qA(),ue=V(Ae),De=f(u(ue),2),G=f(ue,2),v=u(G),W=f(G,2),$=u(W);$n(De,()=>A(ee).name,j=>A(ee).name=j),ve("keypress",De,k),ve("click",v,c),ve("click",$,m),C(I,Ae)}),C(Z,X)};R(H,Z=>{A(a)==="DeckEdit"?Z(P):Z(q,!1)},!0)}C(E,y)};R(w,E=>{A(i)?E(D):E(_,!1)})}C(n,h),be()}Zr(IA,{target:document.getElementById("app")});
