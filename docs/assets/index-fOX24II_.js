var Ka=Object.defineProperty;var Sa=(n,e,t)=>e in n?Ka(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var A=(n,e,t)=>Sa(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const qn=!1;var Qn=Array.isArray,Wa=Array.prototype.indexOf,Xn=Array.from,Oi=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,Ii=Object.getOwnPropertyDescriptors,Pa=Object.prototype,qa=Array.prototype,Jn=Object.getPrototypeOf;function La(n){return typeof n=="function"}const Ie=()=>{};function Ra(n){return typeof(n==null?void 0:n.then)=="function"}function Oa(n){return n()}function Ln(n){for(var e=0;e<n.length;e++)n[e]()}const We=2,Zi=4,vn=8,yn=16,tt=32,Vt=64,kn=128,Se=256,mn=512,Me=1024,nt=2048,qt=4096,Je=8192,gn=16384,Ui=32768,Bn=65536,$i=1<<17,Ia=1<<19,Yi=1<<20,et=Symbol("$state"),Za=Symbol("legacy props"),Ua=Symbol("");function zi(n){return n===this.v}function ji(n,e){return n!=n?e==e:n!==e||n!==null&&typeof n=="object"||typeof n=="function"}function ei(n){return!ji(n,this.v)}function $a(n){throw new Error("https://svelte.dev/e/effect_in_teardown")}function Ya(){throw new Error("https://svelte.dev/e/effect_in_unowned_derived")}function za(n){throw new Error("https://svelte.dev/e/effect_orphan")}function ja(){throw new Error("https://svelte.dev/e/effect_update_depth_exceeded")}function Ga(n){throw new Error("https://svelte.dev/e/props_invalid_value")}function Va(){throw new Error("https://svelte.dev/e/state_descriptors_fixed")}function Qa(){throw new Error("https://svelte.dev/e/state_prototype_fixed")}function Xa(){throw new Error("https://svelte.dev/e/state_unsafe_local_read")}function Ja(){throw new Error("https://svelte.dev/e/state_unsafe_mutation")}let Qt=!1,er=!1;function tr(){Qt=!0}const ti=1,ni=2,Gi=4,nr=8,ir=16,ar=1,rr=2,sr=4,or=8,Ar=16,lr=1,dr=2,pr=4,cr=1,kr=2,Be=Symbol();let fe=null;function un(n){fe=n}function Ne(n,e=!1,t){fe={p:fe,c:null,e:null,m:!1,s:n,x:null,l:null},Qt&&!e&&(fe.l={s:null,u:null,r1:[],r2:Ee(!1)})}function be(n){const e=fe;if(e!==null){const s=e.e;if(s!==null){var t=de,i=pe;e.e=null;try{for(var a=0;a<s.length;a++){var r=s[a];qe(r.effect),Pe(r.reaction),Ot(r.fn)}}finally{qe(t),Pe(i)}}fe=e.p,e.m=!0}return{}}function Lt(){return!Qt||fe!==null&&fe.l===null}function Ee(n,e){var t={f:0,v:n,reactions:null,equals:zi,rv:0,wv:0};return t}function mr(n){return Vi(Ee(n))}function Wt(n,e=!1){var i;const t=Ee(n);return e||(t.equals=ei),Qt&&fe!==null&&fe.l!==null&&((i=fe.l).s??(i.s=[])).push(t),t}function ve(n,e=!1){return Vi(Wt(n,e))}function Vi(n){return pe!==null&&!Ue&&pe.f&We&&($e===null?Er([n]):$e.push(n)),n}function Fe(n,e){return Q(n,Ye(()=>o(n))),e}function Q(n,e){return pe!==null&&!Ue&&Lt()&&pe.f&(We|yn)&&($e===null||!$e.includes(n))&&Ja(),ct(n,e)}function ct(n,e){return n.equals(e)||(n.v,n.v=e,n.wv=ma(),Qi(n,nt),Lt()&&de!==null&&de.f&Me&&!(de.f&(tt|Vt))&&(Ve===null?xr([n]):Ve.push(n))),e}function Qi(n,e){var t=n.reactions;if(t!==null)for(var i=Lt(),a=t.length,r=0;r<a;r++){var s=t[r],p=s.f;p&nt||!i&&s===de||(ze(s,e),p&(Me|Se)&&(p&We?Qi(s,qt):bn(s)))}}let Xi=!1;function At(n,e=null,t){if(typeof n!="object"||n===null||et in n)return n;const i=Jn(n);if(i!==Pa&&i!==qa)return n;var a=new Map,r=Qn(n),s=Ee(0);r&&a.set("length",Ee(n.length));var p;return new Proxy(n,{defineProperty(d,l,m){(!("value"in m)||m.configurable===!1||m.enumerable===!1||m.writable===!1)&&Va();var f=a.get(l);return f===void 0?(f=Ee(m.value),a.set(l,f)):Q(f,At(m.value,p)),!0},deleteProperty(d,l){var m=a.get(l);if(m===void 0)l in d&&a.set(l,Ee(Be));else{if(r&&typeof l=="string"){var f=a.get("length"),k=Number(l);Number.isInteger(k)&&k<f.v&&Q(f,k)}Q(m,Be),mi(s)}return!0},get(d,l,m){var c;if(l===et)return n;var f=a.get(l),k=l in d;if(f===void 0&&(!k||(c=Ft(d,l))!=null&&c.writable)&&(f=Ee(At(k?d[l]:Be,p)),a.set(l,f)),f!==void 0){var w=o(f);return w===Be?void 0:w}return Reflect.get(d,l,m)},getOwnPropertyDescriptor(d,l){var m=Reflect.getOwnPropertyDescriptor(d,l);if(m&&"value"in m){var f=a.get(l);f&&(m.value=o(f))}else if(m===void 0){var k=a.get(l),w=k==null?void 0:k.v;if(k!==void 0&&w!==Be)return{enumerable:!0,configurable:!0,value:w,writable:!0}}return m},has(d,l){var w;if(l===et)return!0;var m=a.get(l),f=m!==void 0&&m.v!==Be||Reflect.has(d,l);if(m!==void 0||de!==null&&(!f||(w=Ft(d,l))!=null&&w.writable)){m===void 0&&(m=Ee(f?At(d[l],p):Be),a.set(l,m));var k=o(m);if(k===Be)return!1}return f},set(d,l,m,f){var H;var k=a.get(l),w=l in d;if(r&&l==="length")for(var c=m;c<k.v;c+=1){var h=a.get(c+"");h!==void 0?Q(h,Be):c in d&&(h=Ee(Be),a.set(c+"",h))}k===void 0?(!w||(H=Ft(d,l))!=null&&H.writable)&&(k=Ee(void 0),Q(k,At(m,p)),a.set(l,k)):(w=k.v!==Be,Q(k,At(m,p)));var D=Reflect.getOwnPropertyDescriptor(d,l);if(D!=null&&D.set&&D.set.call(f,m),!w){if(r&&typeof l=="string"){var y=a.get("length"),C=Number(l);Number.isInteger(C)&&C>=y.v&&Q(y,C+1)}mi(s)}return!0},ownKeys(d){o(s);var l=Reflect.ownKeys(d).filter(k=>{var w=a.get(k);return w===void 0||w.v!==Be});for(var[m,f]of a)f.v!==Be&&!(m in d)&&l.push(m);return l},setPrototypeOf(){Qa()}})}function mi(n,e=1){Q(n,n.v+e)}function ui(n){return n!==null&&typeof n=="object"&&et in n?n[et]:n}function Ji(n,e){return Object.is(ui(n),ui(e))}var hi,ea,ta,na;function ur(){if(hi===void 0){hi=window,ea=/Firefox/.test(navigator.userAgent);var n=Element.prototype,e=Node.prototype;ta=Ft(e,"firstChild").get,na=Ft(e,"nextSibling").get,n.__click=void 0,n.__className="",n.__attributes=null,n.__styles=null,n.__e=void 0,Text.prototype.__t=void 0}}function En(n=""){return document.createTextNode(n)}function hn(n){return ta.call(n)}function xn(n){return na.call(n)}function u(n,e){return hn(n)}function V(n,e){{var t=hn(n);return t instanceof Comment&&t.data===""?xn(t):t}}function v(n,e=1,t=!1){let i=n;for(;e--;)i=xn(i);return i}function hr(n){n.textContent=""}function Dt(n){var e=We|nt,t=pe!==null&&pe.f&We?pe:null;return de===null||t!==null&&t.f&Se?e|=Se:de.f|=Yi,{ctx:fe,deps:null,effects:null,equals:zi,f:e,fn:n,reactions:null,rv:0,v:null,wv:0,parent:t??de}}function Ce(n){const e=Dt(n);return e.equals=ei,e}function ia(n){var e=n.effects;if(e!==null){n.effects=null;for(var t=0;t<e.length;t+=1)kt(e[t])}}function wr(n){for(var e=n.parent;e!==null;){if(!(e.f&We))return e;e=e.parent}return null}function fr(n){var e,t=de;qe(wr(n));try{ia(n),e=ha(n)}finally{qe(t)}return e}function aa(n){var e=fr(n),t=(dt||n.f&Se)&&n.deps!==null?qt:Me;ze(n,t),n.equals(e)||(n.v=e,n.wv=ma())}function ra(n){de===null&&pe===null&&za(),pe!==null&&pe.f&Se&&de===null&&Ya(),ri&&$a()}function Cr(n,e){var t=e.last;t===null?e.last=e.first=n:(t.next=n,n.prev=t,e.last=n)}function Rt(n,e,t,i=!0){var a=(n&Vt)!==0,r=de,s={ctx:fe,deps:null,nodes_start:null,nodes_end:null,f:n|nt,first:null,fn:e,last:null,next:null,parent:a?null:r,prev:null,teardown:null,transitions:null,wv:0};if(t){var p=Ht;try{fi(!0),si(s),s.f|=Ui}catch(m){throw kt(s),m}finally{fi(p)}}else e!==null&&bn(s);var d=t&&s.deps===null&&s.first===null&&s.nodes_start===null&&s.teardown===null&&(s.f&(Yi|kn))===0;if(!d&&!a&&i&&(r!==null&&Cr(s,r),pe!==null&&pe.f&We)){var l=pe;(l.effects??(l.effects=[])).push(s)}return s}function ii(n){const e=Rt(vn,null,!1);return ze(e,Me),e.teardown=n,e}function wi(n){ra();var e=de!==null&&(de.f&tt)!==0&&fe!==null&&!fe.m;if(e){var t=fe;(t.e??(t.e=[])).push({fn:n,effect:de,reaction:pe})}else{var i=Ot(n);return i}}function Dr(n){return ra(),Tn(n)}function vr(n){const e=Rt(Vt,n,!0);return(t={})=>new Promise(i=>{t.outro?ft(e,()=>{kt(e),i(void 0)}):(kt(e),i(void 0))})}function Ot(n){return Rt(Zi,n,!1)}function Tn(n){return Rt(vn,n,!0)}function L(n,e=[],t=Dt){const i=e.map(t);return Mn(()=>n(...i.map(o)))}function Mn(n,e=0){return Rt(vn|yn|e,n,!0)}function vt(n,e=!0){return Rt(vn|tt,n,!0,e)}function sa(n){var e=n.teardown;if(e!==null){const t=ri,i=pe;Ci(!0),Pe(null);try{e.call(null)}finally{Ci(t),Pe(i)}}}function oa(n,e=!1){var t=n.first;for(n.first=n.last=null;t!==null;){var i=t.next;kt(t,e),t=i}}function yr(n){for(var e=n.first;e!==null;){var t=e.next;e.f&tt||kt(e),e=t}}function kt(n,e=!0){var t=!1;if((e||n.f&Ia)&&n.nodes_start!==null){for(var i=n.nodes_start,a=n.nodes_end;i!==null;){var r=i===a?null:xn(i);i.remove(),i=r}t=!0}oa(n,e&&!t),Cn(n,0),ze(n,gn);var s=n.transitions;if(s!==null)for(const d of s)d.stop();sa(n);var p=n.parent;p!==null&&p.first!==null&&Aa(n),n.next=n.prev=n.teardown=n.ctx=n.deps=n.fn=n.nodes_start=n.nodes_end=null}function Aa(n){var e=n.parent,t=n.prev,i=n.next;t!==null&&(t.next=i),i!==null&&(i.prev=t),e!==null&&(e.first===n&&(e.first=i),e.last===n&&(e.last=t))}function ft(n,e){var t=[];ai(n,t,!0),la(t,()=>{kt(n),e&&e()})}function la(n,e){var t=n.length;if(t>0){var i=()=>--t||e();for(var a of n)a.out(i)}else e()}function ai(n,e,t){if(!(n.f&Je)){if(n.f^=Je,n.transitions!==null)for(const s of n.transitions)(s.is_global||t)&&e.push(s);for(var i=n.first;i!==null;){var a=i.next,r=(i.f&Bn)!==0||(i.f&tt)!==0;ai(i,e,r?t:!1),i=a}}}function Pt(n){da(n,!0)}function da(n,e){if(n.f&Je){n.f^=Je,n.f&Me||(n.f^=Me),Xt(n)&&(ze(n,nt),bn(n));for(var t=n.first;t!==null;){var i=t.next,a=(t.f&Bn)!==0||(t.f&tt)!==0;da(t,a?e:!1),t=i}if(n.transitions!==null)for(const r of n.transitions)(r.is_global||e)&&r.in()}}let wn=!1,Rn=[];function pa(){wn=!1;const n=Rn.slice();Rn=[],Ln(n)}function yt(n){wn||(wn=!0,queueMicrotask(pa)),Rn.push(n)}function gr(){wn&&pa()}const ca=0,Br=1;let on=!1,An=ca,zt=!1,jt=null,Ht=!1,ri=!1;function fi(n){Ht=n}function Ci(n){ri=n}let ut=[],Kt=0;let pe=null,Ue=!1;function Pe(n){pe=n}let de=null;function qe(n){de=n}let $e=null;function Er(n){$e=n}let xe=null,_e=0,Ve=null;function xr(n){Ve=n}let ka=1,fn=0,dt=!1,lt=null;function ma(){return++ka}function Xt(n){var f;var e=n.f;if(e&nt)return!0;if(e&qt){var t=n.deps,i=(e&Se)!==0;if(t!==null){var a,r,s=(e&mn)!==0,p=i&&de!==null&&!dt,d=t.length;if(s||p){var l=n,m=l.parent;for(a=0;a<d;a++)r=t[a],(s||!((f=r==null?void 0:r.reactions)!=null&&f.includes(l)))&&(r.reactions??(r.reactions=[])).push(l);s&&(l.f^=mn),p&&m!==null&&!(m.f&Se)&&(l.f^=Se)}for(a=0;a<d;a++)if(r=t[a],Xt(r)&&aa(r),r.wv>n.wv)return!0}(!i||de!==null&&!dt)&&ze(n,Me)}return!1}function Tr(n,e){for(var t=e;t!==null;){if(t.f&kn)try{t.fn(n);return}catch{t.f^=kn}t=t.parent}throw on=!1,n}function Mr(n){return(n.f&gn)===0&&(n.parent===null||(n.parent.f&kn)===0)}function Nn(n,e,t,i){if(on){if(t===null&&(on=!1),Mr(e))throw n;return}t!==null&&(on=!0);{Tr(n,e);return}}function ua(n,e,t=!0){var i=n.reactions;if(i!==null)for(var a=0;a<i.length;a++){var r=i[a];r.f&We?ua(r,e,!1):e===r&&(t?ze(r,nt):r.f&Me&&ze(r,qt),bn(r))}}function ha(n){var w;var e=xe,t=_e,i=Ve,a=pe,r=dt,s=$e,p=fe,d=Ue,l=n.f;xe=null,_e=0,Ve=null,pe=l&(tt|Vt)?null:n,dt=(l&Se)!==0&&(!Ht||a===null||d),$e=null,un(n.ctx),Ue=!1,fn++;try{var m=(0,n.fn)(),f=n.deps;if(xe!==null){var k;if(Cn(n,_e),f!==null&&_e>0)for(f.length=_e+xe.length,k=0;k<xe.length;k++)f[_e+k]=xe[k];else n.deps=f=xe;if(!dt)for(k=_e;k<f.length;k++)((w=f[k]).reactions??(w.reactions=[])).push(n)}else f!==null&&_e<f.length&&(Cn(n,_e),f.length=_e);if(Lt()&&Ve!==null&&!Ue&&f!==null&&!(n.f&(We|qt|nt)))for(k=0;k<Ve.length;k++)ua(Ve[k],n);return a!==null&&fn++,m}finally{xe=e,_e=t,Ve=i,pe=a,dt=r,$e=s,un(p),Ue=d}}function Nr(n,e){let t=e.reactions;if(t!==null){var i=Wa.call(t,n);if(i!==-1){var a=t.length-1;a===0?t=e.reactions=null:(t[i]=t[a],t.pop())}}t===null&&e.f&We&&(xe===null||!xe.includes(e))&&(ze(e,qt),e.f&(Se|mn)||(e.f^=mn),ia(e),Cn(e,0))}function Cn(n,e){var t=n.deps;if(t!==null)for(var i=e;i<t.length;i++)Nr(n,t[i])}function si(n){var e=n.f;if(!(e&gn)){ze(n,Me);var t=de,i=fe;de=n;try{e&yn?yr(n):oa(n),sa(n);var a=ha(n);n.teardown=typeof a=="function"?a:null,n.wv=ka;var r=n.deps,s;qn&&er&&n.f&nt}catch(p){Nn(p,n,t,i||n.ctx)}finally{de=t}}}function wa(){if(Kt>1e3){Kt=0;try{ja()}catch(n){if(jt!==null)Nn(n,jt,null);else throw n}}Kt++}function fa(n){var e=n.length;if(e!==0){wa();var t=Ht;Ht=!0;try{for(var i=0;i<e;i++){var a=n[i];a.f&Me||(a.f^=Me);var r=Fr(a);br(r)}}finally{Ht=t}}}function br(n){var e=n.length;if(e!==0)for(var t=0;t<e;t++){var i=n[t];if(!(i.f&(gn|Je)))try{Xt(i)&&(si(i),i.deps===null&&i.first===null&&i.nodes_start===null&&(i.teardown===null?Aa(i):i.fn=null))}catch(a){Nn(a,i,null,i.ctx)}}}function _r(){if(zt=!1,Kt>1001)return;const n=ut;ut=[],fa(n),zt||(Kt=0,jt=null)}function bn(n){An===ca&&(zt||(zt=!0,queueMicrotask(_r))),jt=n;for(var e=n;e.parent!==null;){e=e.parent;var t=e.f;if(t&(Vt|tt)){if(!(t&Me))return;e.f^=Me}}ut.push(e)}function Fr(n){var e=[],t=n.first;e:for(;t!==null;){var i=t.f,a=(i&tt)!==0,r=a&&(i&Me)!==0,s=t.next;if(!r&&!(i&Je)){if(i&Zi)e.push(t);else if(a)t.f^=Me;else{var p=pe;try{pe=t,Xt(t)&&si(t)}catch(m){Nn(m,t,null,t.ctx)}finally{pe=p}}var d=t.first;if(d!==null){t=d;continue}}if(s===null){let m=t.parent;for(;m!==null;){if(n===m)break e;var l=m.next;if(l!==null){t=l;continue e}m=m.parent}}t=s}return e}function oi(n){var e=An,t=ut;try{wa();const a=[];An=Br,ut=a,zt=!1,fa(t);var i=n==null?void 0:n();return gr(),(ut.length>0||a.length>0)&&oi(),Kt=0,jt=null,i}finally{An=e,ut=t}}async function Hr(){await Promise.resolve(),oi()}function o(n){var e=n.f,t=(e&We)!==0;if(lt!==null&&lt.add(n),pe!==null&&!Ue){$e!==null&&$e.includes(n)&&Xa();var i=pe.deps;n.rv<fn&&(n.rv=fn,xe===null&&i!==null&&i[_e]===n?_e++:xe===null?xe=[n]:(!dt||!xe.includes(n))&&xe.push(n))}else if(t&&n.deps===null&&n.effects===null){var a=n,r=a.parent;r!==null&&!(r.f&Se)&&(a.f^=Se)}return t&&(a=n,Xt(a)&&aa(a)),n.v}function Kr(n){var e=lt;lt=new Set;var t=lt,i;try{if(Ye(n),e!==null)for(i of lt)e.add(i)}finally{lt=e}return t}function Sr(n){var e=Kr(()=>Ye(n));for(var t of e)if(t.f&$i)for(const i of t.deps||[])i.f&We||ct(i,i.v);else ct(t,t.v)}function Ye(n){var e=Ue;try{return Ue=!0,n()}finally{Ue=e}}const Wr=-7169;function ze(n,e){n.f=n.f&Wr|e}function Pr(n){if(!(typeof n!="object"||!n||n instanceof EventTarget)){if(et in n)On(n);else if(!Array.isArray(n))for(let e in n){const t=n[e];typeof t=="object"&&t&&et in t&&On(t)}}}function On(n,e=new Set){if(typeof n=="object"&&n!==null&&!(n instanceof EventTarget)&&!e.has(n)){e.add(n),n instanceof Date&&n.getTime();for(let i in n)try{On(n[i],e)}catch{}const t=Jn(n);if(t!==Object.prototype&&t!==Array.prototype&&t!==Map.prototype&&t!==Set.prototype&&t!==Date.prototype){const i=Ii(t);for(let a in i){const r=i[a].get;if(r)try{r.call(n)}catch{}}}}}const qr=["touchstart","touchmove"];function Lr(n){return qr.includes(n)}let Di=!1;function Rr(){Di||(Di=!0,document.addEventListener("reset",n=>{Promise.resolve().then(()=>{var e;if(!n.defaultPrevented)for(const t of n.target.elements)(e=t.__on_r)==null||e.call(t)})},{capture:!0}))}function Ai(n){var e=pe,t=de;Pe(null),qe(null);try{return n()}finally{Pe(e),qe(t)}}function li(n,e,t,i=t){n.addEventListener(e,()=>Ai(t));const a=n.__on_r;a?n.__on_r=()=>{a(),i(!0)}:n.__on_r=()=>i(!0),Rr()}const Ca=new Set,In=new Set;function Or(n,e,t,i={}){function a(r){if(i.capture||Ut.call(e,r),!r.cancelBubble)return Ai(()=>t==null?void 0:t.call(this,r))}return n.startsWith("pointer")||n.startsWith("touch")||n==="wheel"?yt(()=>{e.addEventListener(n,a,i)}):e.addEventListener(n,a,i),a}function ye(n,e,t,i,a){var r={capture:i,passive:a},s=Or(n,e,t,r);(e===document.body||e===window||e===document)&&ii(()=>{e.removeEventListener(n,s,r)})}function di(n){for(var e=0;e<n.length;e++)Ca.add(n[e]);for(var t of In)t(n)}function Ut(n){var C;var e=this,t=e.ownerDocument,i=n.type,a=((C=n.composedPath)==null?void 0:C.call(n))||[],r=a[0]||n.target,s=0,p=n.__root;if(p){var d=a.indexOf(p);if(d!==-1&&(e===document||e===window)){n.__root=e;return}var l=a.indexOf(e);if(l===-1)return;d<=l&&(s=d)}if(r=a[s]||n.target,r!==e){Oi(n,"currentTarget",{configurable:!0,get(){return r||t}});var m=pe,f=de;Pe(null),qe(null);try{for(var k,w=[];r!==null;){var c=r.assignedSlot||r.parentNode||r.host||null;try{var h=r["__"+i];if(h!==void 0&&!r.disabled)if(Qn(h)){var[D,...y]=h;D.apply(r,[n,...y])}else h.call(r,n)}catch(H){k?w.push(H):k=H}if(n.cancelBubble||c===e||c===null)break;r=c}if(k){for(let H of w)queueMicrotask(()=>{throw H});throw k}}finally{n.__root=e,delete n.currentTarget,Pe(m),qe(f)}}}function Ir(n){var e=document.createElement("template");return e.innerHTML=n,e.content}function Dn(n,e){var t=de;t.nodes_start===null&&(t.nodes_start=n,t.nodes_end=e)}function N(n,e){var t=(e&cr)!==0,i=(e&kr)!==0,a,r=!n.startsWith("<!>");return()=>{a===void 0&&(a=Ir(r?n:"<!>"+n),t||(a=hn(a)));var s=i||ea?document.importNode(a,!0):a.cloneNode(!0);if(t){var p=hn(s),d=s.lastChild;Dn(p,d)}else Dn(s,s);return s}}function Tt(n=""){{var e=En(n+"");return Dn(e,e),e}}function he(){var n=document.createDocumentFragment(),e=document.createComment(""),t=En();return n.append(e,t),Dn(e,t),n}function g(n,e){n!==null&&n.before(e)}let Zn=!0;function _(n,e){var t=e==null?"":typeof e=="object"?e+"":e;t!==(n.__t??(n.__t=n.nodeValue))&&(n.__t=t,n.nodeValue=t+"")}function Zr(n,e){return Ur(n,e)}const Mt=new Map;function Ur(n,{target:e,anchor:t,props:i={},events:a,context:r,intro:s=!0}){ur();var p=new Set,d=f=>{for(var k=0;k<f.length;k++){var w=f[k];if(!p.has(w)){p.add(w);var c=Lr(w);e.addEventListener(w,Ut,{passive:c});var h=Mt.get(w);h===void 0?(document.addEventListener(w,Ut,{passive:c}),Mt.set(w,1)):Mt.set(w,h+1)}}};d(Xn(Ca)),In.add(d);var l=void 0,m=vr(()=>{var f=t??e.appendChild(En());return vt(()=>{if(r){Ne({});var k=fe;k.c=r}a&&(i.$$events=a),Zn=s,l=n(f,i)||{},Zn=!0,r&&be()}),()=>{var c;for(var k of p){e.removeEventListener(k,Ut);var w=Mt.get(k);--w===0?(document.removeEventListener(k,Ut),Mt.delete(k)):Mt.set(k,w)}In.delete(d),f!==t&&((c=f.parentNode)==null||c.removeChild(f))}});return $r.set(l,m),l}let $r=new WeakMap;const Hn=0,an=1,Kn=2;function Da(n,e,t,i,a){var r=n,s=Lt(),p=fe,d=Be,l,m,f,k=(s?Ee:Wt)(void 0),w=(s?Ee:Wt)(void 0),c=!1;function h(y,C){c=!0,C&&(qe(D),Pe(D),un(p));try{y===Hn&&t&&(l?Pt(l):l=vt(()=>t(r))),y===an&&i&&(m?Pt(m):m=vt(()=>i(r,k))),y!==Hn&&l&&ft(l,()=>l=null),y!==an&&m&&ft(m,()=>m=null),y!==Kn&&f&&ft(f,()=>f=null)}finally{C&&(un(null),Pe(null),qe(null),oi())}}var D=Mn(()=>{if(d!==(d=e())){if(Ra(d)){var y=d;c=!1,y.then(C=>{y===d&&(ct(k,C),h(an,!0))},C=>{if(y===d)throw ct(w,C),h(Kn,!0),w.v}),yt(()=>{c||h(Hn,!0)})}else ct(k,d),h(an,!1);return()=>d=Be}})}function R(n,e,t=!1){var i=n,a=null,r=null,s=Be,p=t?Bn:0,d=!1;const l=(f,k=!0)=>{d=!0,m(k,f)},m=(f,k)=>{s!==(s=f)&&(s?(a?Pt(a):k&&(a=vt(()=>k(i))),r&&ft(r,()=>{r=null})):(r?Pt(r):k&&(r=vt(()=>k(i))),a&&ft(a,()=>{a=null})))};Mn(()=>{d=!1,e(l),d||m(null,null)},p)}function ke(n,e){return e}function Yr(n,e,t,i){for(var a=[],r=e.length,s=0;s<r;s++)ai(e[s].e,a,!0);var p=r>0&&a.length===0&&t!==null;if(p){var d=t.parentNode;hr(d),d.append(t),i.clear(),ot(n,e[0].prev,e[r-1].next)}la(a,()=>{for(var l=0;l<r;l++){var m=e[l];p||(i.delete(m.k),ot(n,m.prev,m.next)),kt(m.e,!p)}})}function me(n,e,t,i,a,r=null){var s=n,p={flags:e,items:new Map,first:null},d=(e&Gi)!==0;if(d){var l=n;s=l.appendChild(En())}var m=null,f=!1,k=Ce(()=>{var w=t();return Qn(w)?w:w==null?[]:Xn(w)});Mn(()=>{var w=o(k),c=w.length;f&&c===0||(f=c===0,zr(w,p,s,a,e,i,t),r!==null&&(c===0?m?Pt(m):m=vt(()=>r(s)):m!==null&&ft(m,()=>{m=null})),o(k))})}function zr(n,e,t,i,a,r,s){var G,B,W,$;var p=(a&nr)!==0,d=(a&(ti|ni))!==0,l=n.length,m=e.items,f=e.first,k=f,w,c=null,h,D=[],y=[],C,H,P,q;if(p)for(q=0;q<l;q+=1)C=n[q],H=r(C,q),P=m.get(H),P!==void 0&&((G=P.a)==null||G.measure(),(h??(h=new Set)).add(P));for(q=0;q<l;q+=1){if(C=n[q],H=r(C,q),P=m.get(H),P===void 0){var Z=k?k.e.nodes_start:t;c=Gr(Z,e,c,c===null?e.first:c.next,C,H,q,i,a,s),m.set(H,c),D=[],y=[],k=c.next;continue}if(d&&jr(P,C,q,a),P.e.f&Je&&(Pt(P.e),p&&((B=P.a)==null||B.unfix(),(h??(h=new Set)).delete(P))),P!==k){if(w!==void 0&&w.has(P)){if(D.length<y.length){var X=y[0],x;c=X.prev;var I=D[0],ee=D[D.length-1];for(x=0;x<D.length;x+=1)vi(D[x],X,t);for(x=0;x<y.length;x+=1)w.delete(y[x]);ot(e,I.prev,ee.next),ot(e,c,I),ot(e,ee,X),k=X,c=ee,q-=1,D=[],y=[]}else w.delete(P),vi(P,k,t),ot(e,P.prev,P.next),ot(e,P,c===null?e.first:c.next),ot(e,c,P),c=P;continue}for(D=[],y=[];k!==null&&k.k!==H;)k.e.f&Je||(w??(w=new Set)).add(k),y.push(k),k=k.next;if(k===null)continue;P=k}D.push(P),c=P,k=P.next}if(k!==null||w!==void 0){for(var Ae=w===void 0?[]:Xn(w);k!==null;)k.e.f&Je||Ae.push(k),k=k.next;var ue=Ae.length;if(ue>0){var De=a&Gi&&l===0?t:null;if(p){for(q=0;q<ue;q+=1)(W=Ae[q].a)==null||W.measure();for(q=0;q<ue;q+=1)($=Ae[q].a)==null||$.fix()}Yr(e,Ae,De,m)}}p&&yt(()=>{var j;if(h!==void 0)for(P of h)(j=P.a)==null||j.apply()}),de.first=e.first&&e.first.e,de.last=c&&c.e}function jr(n,e,t,i){i&ti&&ct(n.v,e),i&ni?ct(n.i,t):n.i=t}function Gr(n,e,t,i,a,r,s,p,d,l){var m=(d&ti)!==0,f=(d&ir)===0,k=m?f?Wt(a):Ee(a):a,w=d&ni?Ee(s):s,c={i:w,v:k,k:r,a:null,e:null,prev:t,next:i};try{return c.e=vt(()=>p(n,k,w,l),Xi),c.e.prev=t&&t.e,c.e.next=i&&i.e,t===null?e.first=c:(t.next=c,t.e.next=c.e),i!==null&&(i.prev=c,i.e.prev=c.e),c}finally{}}function vi(n,e,t){for(var i=n.next?n.next.e.nodes_start:t,a=e?e.e.nodes_start:t,r=n.e.nodes_start;r!==i;){var s=xn(r);a.before(r),r=s}}function ot(n,e,t){e===null?n.first=t:(e.next=t,e.e.next=t&&t.e),t!==null&&(t.prev=e,t.e.prev=e&&e.e)}function St(n,e,t,i){var a=n.__attributes??(n.__attributes={});a[e]!==(a[e]=t)&&(e==="style"&&"__styles"in n&&(n.__styles={}),e==="loading"&&(n[Ua]=t),t==null?n.removeAttribute(e):typeof t!="string"&&Vr(n).includes(e)?n[e]=t:n.setAttribute(e,t))}var yi=new Map;function Vr(n){var e=yi.get(n.nodeName);if(e)return e;yi.set(n.nodeName,e=[]);for(var t,i=n,a=Element.prototype;a!==i;){t=Ii(i);for(var r in t)t[r].set&&e.push(r);i=Jn(i)}return e}function we(n,e,t){var i=n.__className,a=Qr(e);(i!==a||Xi)&&(e==null?n.removeAttribute("class"):n.className=a,n.__className=a)}function Qr(n,e){return(n??"")+""}const Xr=()=>performance.now(),Xe={tick:n=>requestAnimationFrame(n),now:()=>Xr(),tasks:new Set};function va(){const n=Xe.now();Xe.tasks.forEach(e=>{e.c(n)||(Xe.tasks.delete(e),e.f())}),Xe.tasks.size!==0&&Xe.tick(va)}function Jr(n){let e;return Xe.tasks.size===0&&Xe.tick(va),{promise:new Promise(t=>{Xe.tasks.add(e={c:n,f:t})}),abort(){Xe.tasks.delete(e)}}}function rn(n,e){Ai(()=>{n.dispatchEvent(new CustomEvent(e))})}function es(n){if(n==="float")return"cssFloat";if(n==="offset")return"cssOffset";if(n.startsWith("--"))return n;const e=n.split("-");return e.length===1?e[0]:e[0]+e.slice(1).map(t=>t[0].toUpperCase()+t.slice(1)).join("")}function gi(n){const e={},t=n.split(";");for(const i of t){const[a,r]=i.split(":");if(!a||r===void 0)break;const s=es(a.trim());e[s]=r.trim()}return e}const ts=n=>n;function Nt(n,e,t,i){var a=(n&lr)!==0,r=(n&dr)!==0,s=a&&r,p=(n&pr)!==0,d=s?"both":a?"in":"out",l,m=e.inert,f=e.style.overflow,k,w;function c(){var H=pe,P=de;Pe(null),qe(null);try{return l??(l=t()(e,(i==null?void 0:i())??{},{direction:d}))}finally{Pe(H),qe(P)}}var h={is_global:p,in(){var H;if(e.inert=m,!a){w==null||w.abort(),(H=w==null?void 0:w.reset)==null||H.call(w);return}r||k==null||k.abort(),rn(e,"introstart"),k=Un(e,c(),w,1,()=>{rn(e,"introend"),k==null||k.abort(),k=l=void 0,e.style.overflow=f})},out(H){if(!r){H==null||H(),l=void 0;return}e.inert=!0,rn(e,"outrostart"),w=Un(e,c(),k,0,()=>{rn(e,"outroend"),H==null||H()})},stop:()=>{k==null||k.abort(),w==null||w.abort()}},D=de;if((D.transitions??(D.transitions=[])).push(h),a&&Zn){var y=p;if(!y){for(var C=D.parent;C&&C.f&Bn;)for(;(C=C.parent)&&!(C.f&yn););y=!C||(C.f&Ui)!==0}y&&Ot(()=>{Ye(()=>h.in())})}}function Un(n,e,t,i,a){var r=i===1;if(La(e)){var s,p=!1;return yt(()=>{if(!p){var D=e({direction:r?"in":"out"});s=Un(n,D,t,i,a)}}),{abort:()=>{p=!0,s==null||s.abort()},deactivate:()=>s.deactivate(),reset:()=>s.reset(),t:()=>s.t()}}if(t==null||t.deactivate(),!(e!=null&&e.duration))return a(),{abort:Ie,deactivate:Ie,reset:Ie,t:()=>i};const{delay:d=0,css:l,tick:m,easing:f=ts}=e;var k=[];if(r&&t===void 0&&(m&&m(0,1),l)){var w=gi(l(0,1));k.push(w,w)}var c=()=>1-i,h=n.animate(k,{duration:d});return h.onfinish=()=>{var D=(t==null?void 0:t.t())??1-i;t==null||t.abort();var y=i-D,C=e.duration*Math.abs(y),H=[];if(C>0){var P=!1;if(l)for(var q=Math.ceil(C/16.666666666666668),Z=0;Z<=q;Z+=1){var X=D+y*f(Z/q),x=gi(l(X,1-X));H.push(x),P||(P=x.overflow==="hidden")}P&&(n.style.overflow="hidden"),c=()=>{var I=h.currentTime;return D+y*f(I/C)},m&&Jr(()=>{if(h.playState!=="running")return!1;var I=c();return m(I,1-I),!0})}h=n.animate(H,{duration:C,fill:"forwards"}),h.onfinish=()=>{c=()=>i,m==null||m(i,1-i),a()}},{abort:()=>{h&&(h.cancel(),h.effect=null,h.onfinish=Ie)},deactivate:()=>{a=Ie},reset:()=>{i===0&&(m==null||m(1,0))},t:()=>c()}}function $n(n,e,t=e){var i=Lt();li(n,"input",a=>{var r=a?n.defaultValue:n.value;if(r=Wn(n)?Pn(r):r,t(r),i&&r!==(r=e())){var s=n.selectionStart,p=n.selectionEnd;n.value=r??"",p!==null&&(n.selectionStart=s,n.selectionEnd=Math.min(p,n.value.length))}}),Ye(e)==null&&n.value&&t(Wn(n)?Pn(n.value):n.value),Tn(()=>{var a=e();Wn(n)&&a===Pn(n.value)||n.type==="date"&&!a&&!n.value||a!==n.value&&(n.value=a??"")})}const Sn=new Set;function bt(n,e,t,i,a=i){var r=t.getAttribute("type")==="checkbox",s=n;if(e!==null)for(var p of e)s=s[p]??(s[p]=[]);s.push(t),li(t,"change",()=>{var d=t.__value;r&&(d=ns(s,d,t.checked)),a(d)},()=>a(r?[]:null)),Tn(()=>{var d=i();r?(d=d||[],t.checked=d.includes(t.__value)):t.checked=Ji(t.__value,d)}),ii(()=>{var d=s.indexOf(t);d!==-1&&s.splice(d,1)}),Sn.has(s)||(Sn.add(s),yt(()=>{s.sort((d,l)=>d.compareDocumentPosition(l)===4?-1:1),Sn.delete(s)})),yt(()=>{})}function ns(n,e,t){for(var i=new Set,a=0;a<n.length;a+=1)n[a].checked&&i.add(n[a].__value);return t||i.delete(e),Array.from(i)}function Wn(n){var e=n.type;return e==="number"||e==="range"}function Pn(n){return n===""?null:+n}function ya(n,e,t){if(n.multiple)return rs(n,e);for(var i of n.options){var a=Yt(i);if(Ji(a,e)){i.selected=!0;return}}(!t||e!==void 0)&&(n.selectedIndex=-1)}function is(n,e){Ot(()=>{var t=new MutationObserver(()=>{var i=n.__value;ya(n,i)});return t.observe(n,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value"]}),()=>{t.disconnect()}})}function as(n,e,t=e){var i=!0;li(n,"change",a=>{var r=a?"[selected]":":checked",s;if(n.multiple)s=[].map.call(n.querySelectorAll(r),Yt);else{var p=n.querySelector(r)??n.querySelector("option:not([disabled])");s=p&&Yt(p)}t(s)}),Ot(()=>{var a=e();if(ya(n,a,i),i&&a===void 0){var r=n.querySelector(":checked");r!==null&&(a=Yt(r),t(a))}n.__value=a,i=!1}),is(n)}function rs(n,e){for(var t of n.options)t.selected=~e.indexOf(Yt(t))}function Yt(n){return"__value"in n?n.__value:n.value}function Bi(n,e){return n===e||(n==null?void 0:n[et])===e}function ss(n={},e,t,i){return Ot(()=>{var a,r;return Tn(()=>{a=r,r=[],Ye(()=>{n!==t(...r)&&(e(n,...r),a&&Bi(t(...a),n)&&e(null,...a))})}),()=>{yt(()=>{r&&Bi(t(...r),n)&&e(null,...r)})}}),n}function Le(n=!1){const e=fe,t=e.l.u;if(!t)return;let i=()=>Pr(e.s);if(n){let a=0,r={};const s=Dt(()=>{let p=!1;const d=e.s;for(const l in d)d[l]!==r[l]&&(r[l]=d[l],p=!0);return p&&a++,a});i=()=>o(s)}t.b.length&&Dr(()=>{Ei(e,i),Ln(t.b)}),wi(()=>{const a=Ye(()=>t.m.map(Oa));return()=>{for(const r of a)typeof r=="function"&&r()}}),t.a.length&&wi(()=>{Ei(e,i),Ln(t.a)})}function Ei(n,e){if(n.l.s)for(const t of n.l.s)o(t);e()}function ga(n,e,t){if(n==null)return e(void 0),Ie;const i=Ye(()=>n.subscribe(e,t));return i.unsubscribe?()=>i.unsubscribe():i}const _t=[];function os(n,e=Ie){let t=null;const i=new Set;function a(p){if(ji(n,p)&&(n=p,t)){const d=!_t.length;for(const l of i)l[1](),_t.push(l,n);if(d){for(let l=0;l<_t.length;l+=2)_t[l][0](_t[l+1]);_t.length=0}}}function r(p){a(p(n))}function s(p,d=Ie){const l=[p,d];return i.add(l),i.size===1&&(t=e(a,r)||Ie),p(n),()=>{i.delete(l),i.size===0&&t&&(t(),t=null)}}return{set:a,update:r,subscribe:s}}function As(n){let e;return ga(n,t=>e=t)(),e}let sn=!1,Yn=Symbol();function ls(n,e,t){const i=t[e]??(t[e]={store:null,source:Wt(void 0),unsubscribe:Ie});if(i.store!==n&&!(Yn in t))if(i.unsubscribe(),i.store=n??null,n==null)i.source.v=void 0,i.unsubscribe=Ie;else{var a=!0;i.unsubscribe=ga(n,r=>{a?i.source.v=r:Q(i.source,r)}),a=!1}return n&&Yn in t?As(n):o(i.source)}function ds(){const n={};function e(){ii(()=>{for(var t in n)n[t].unsubscribe();Oi(n,Yn,{enumerable:!1,value:!0})})}return[n,e]}function ps(n){var e=sn;try{return sn=!1,[n(),sn]}finally{sn=e}}function ce(n,e,t,i){var X;var a=(t&ar)!==0,r=!Qt||(t&rr)!==0,s=(t&or)!==0,p=(t&Ar)!==0,d=!1,l;s?[l,d]=ps(()=>n[e]):l=n[e];var m=et in n||Za in n,f=s&&(((X=Ft(n,e))==null?void 0:X.set)??(m&&e in n&&(x=>n[e]=x)))||void 0,k=i,w=!0,c=!1,h=()=>(c=!0,w&&(w=!1,p?k=Ye(i):k=i),k);l===void 0&&i!==void 0&&(f&&r&&Ga(),l=h(),f&&f(l));var D;if(r)D=()=>{var x=n[e];return x===void 0?h():(w=!0,c=!1,x)};else{var y=(a?Dt:Ce)(()=>n[e]);y.f|=$i,D=()=>{var x=o(y);return x!==void 0&&(k=void 0),x===void 0?k:x}}if(!(t&sr))return D;if(f){var C=n.$$legacy;return function(x,I){return arguments.length>0?((!r||!I||C||d)&&f(I?D():x),x):D()}}var H=!1,P=!1,q=Wt(l),Z=Dt(()=>{var x=D(),I=o(q);return H?(H=!1,P=!0,I):(P=!1,q.v=x)});return a||(Z.equals=ei),function(x,I){if(lt!==null&&(H=P,D(),o(q)),arguments.length>0){const ee=I?o(Z):r&&s?At(x):x;return Z.equals(ee)||(H=!0,Q(q,ee),c&&k!==void 0&&(k=ee),Ye(()=>o(Z))),x}return o(Z)}}const cs="5";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(cs);tr();class ks{constructor(e,t,i){A(this,"_dbname");A(this,"_dbversion");A(this,"dbPromise");A(this,"getTran",async(e,t)=>(await this.dbPromise).transaction(e,t));A(this,"reset",async()=>(await indexedDB.databases().then(e=>{console.log(e)}),await new Promise((e,t)=>{const i=indexedDB.deleteDatabase(this._dbname);i.onsuccess=()=>{console.log("onsuccess"),e()},i.onerror=a=>{console.log("onerror"),t(a)}})));A(this,"getAll",async e=>{const t=await this.dbPromise;return new Promise((i,a)=>{const p=t.transaction([e],"readonly").objectStore(e).getAll();p.onsuccess=()=>{i(p.result)},p.onerror=d=>{a(d)}})});A(this,"get",async(e,t)=>{const i=await this.dbPromise;return new Promise((a,r)=>{const d=i.transaction([e],"readonly").objectStore(e).get(t);d.onsuccess=()=>{a(d.result)},d.onerror=l=>{r(l)}})});A(this,"getMany",async(e,t)=>{const r=(await this.dbPromise).transaction([e],"readonly").objectStore(e),s=t.map(p=>new Promise((d,l)=>{const m=r.get(p);m.onsuccess=()=>{d(m.result)},m.onerror=f=>{l(f)}}));return await Promise.all(s)});A(this,"putRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),r=a.objectStore(e),s=t.map(p=>({record:p,request:r.put(p)}));return new Promise((p,d)=>{a.oncomplete=()=>p(s.map(l=>Object.assign({id:l.request.result},l.record))),a.onerror=l=>d(l)})});A(this,"deleteRecords",async(e,t)=>{const a=(await this.dbPromise).transaction([e],"readwrite"),r=a.objectStore(e),s=t.map(p=>({key:p,request:r.delete(p)}));return new Promise((p,d)=>{a.oncomplete=()=>{console.log(s.map(l=>l.request.result)),p()},a.onerror=l=>d(l)})});this._dbname=e,this._dbversion=t,this.dbPromise=new Promise((a,r)=>{const s=indexedDB.open(e,t);s.onsuccess=p=>{if(console.log(p),!p.target){console.log("event.target is undefined"),r("event.target is undefined");return}const d=p.target.result;if(!d){console.log("event.target.result is undefined"),r("event.target.result is undefined");return}d.onversionchange=l=>{console.log(l),d.close()},a(d)},s.onupgradeneeded=p=>{console.log("onupgradeneeded");const d=p.target.result;i.filter(l=>!d.objectStoreNames.contains(l)).map(l=>d.createObjectStore(l,{keyPath:"id",autoIncrement:!0}))},s.onerror=p=>{console.log(p),r(p)},s.onblocked=p=>{console.log(p),r(p)}}),console.log(this.dbPromise)}get dbversion(){return this._dbversion}}class He{constructor(){A(this,"handlers",[])}append(e){this.handlers.push(e)}remove(e){this.handlers=this.handlers.filter(t=>t!==e)}trigger(e){this.handlers.slice(0).forEach(t=>t(e))}clear(){this.handlers.splice(0)}expose(){return this}}class xi{constructor(){A(this,"handler")}set(e){this.handler=e}async call(e){if(!this.handler)throw Error("illegal state error");return await this.handler(e)}expose(){return this}}class pi{constructor(e,t,i,a){A(this,"_name");A(this,"_createVersion");A(this,"mountResolver",()=>{});A(this,"_indexedDb");A(this,"onInsertEvent",new He);A(this,"onBeforeInsertEvent",new xi);A(this,"onUpdateEvent",new He);A(this,"onBeforeUpdateEvent",new xi);A(this,"onDeleteEvent",new He);A(this,"prepareInitialRecords",()=>{const e=new Date;return this._prepareInitialRecords().map(t=>Object.assign(t,{createdAt:e,updatedAt:e,dbVersion:this._createVersion}))});A(this,"resolveMount",()=>this.mountResolver());A(this,"patchForInsert",(e,t)=>{e.newRecords.forEach(i=>{console.log(i),t[i.id]=i})});A(this,"patchForUpdate",(e,t)=>{e.recordPairs.forEach(i=>{console.log(t[i.newRecord.id],i.newRecord),t[i.newRecord.id]={...i.newRecord}})});A(this,"patchForDelete",(e,t)=>{e.oldRecords.forEach(i=>{console.log(i),delete t[i.id]})});this._indexedDb=e,this._name=t,this._createVersion=e.dbversion,this.getAll().then(r=>r.reduce((s,p)=>(s[p.id]=p,s),{})).then(r=>{console.log(this.name,r),this.onBeforeInsertEvent.set(i??(()=>Promise.resolve())),this.onBeforeUpdateEvent.set(a??(()=>Promise.resolve()))})}get name(){return this._name}get createVersion(){return this._createVersion}get oninsert(){return this.onInsertEvent.expose()}get onbeforeinsert(){return this.onBeforeInsertEvent.expose()}get onupdate(){return this.onUpdateEvent.expose()}get onbeforeupdate(){return this.onBeforeUpdateEvent.expose()}get ondelete(){return this.onDeleteEvent.expose()}getAll(){return this._indexedDb.getAll(this.name)}get(e){return this._indexedDb.get(this.name,e)}async insertMany(e){const t=new Date,i=e.map(r=>{const s={createdAt:t,updatedAt:t,dbVersion:this._createVersion};return Object.assign(r,s)});await this.onBeforeInsertEvent.call({sender:this,newRecords:i,timestamp:t});const a=await this._indexedDb.putRecords(this.name,i);return this.onInsertEvent.trigger({sender:this,newRecords:a,timestamp:t}),a}async insert(e){return(await this.insertMany([e]))[0]}async updateMany(e,t){const i=new Date,a=[];return(await this._indexedDb.getMany(this.name,e)).forEach(s=>{const p={...s},d={...p};a.push({newRecord:Object.assign(t(d),{updatedAt:i,dbVersion:this._createVersion}),oldRecord:p})}),await this.onBeforeUpdateEvent.call({sender:this,recordPairs:a,timestamp:i}),await this._indexedDb.putRecords(this.name,a.map(s=>s.newRecord)),this.onUpdateEvent.trigger({sender:this,recordPairs:a,timestamp:i}),a.map(s=>s.newRecord)}async update(e,t){return(await this.updateMany([e],t))[0]}async delete(e){const t=new Date,i=await this._indexedDb.getMany(this.name,e);await this._indexedDb.deleteRecords(this.name,e),this.onDeleteEvent.trigger({sender:this,oldRecords:i,timestamp:t})}}const ms={"１３人目の埋葬者":{name:"１３人目の埋葬者",nameKana:"",description:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",pendulumDescription:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",kind:"Monster",monsterCategories:["Normal"],level:3,attack:1200,defense:900,attribute:"Dark",type:"Zombie",wikiName:"《１３人目の埋葬者》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%A3%B1%A3%B3%BF%CD%CC%DC%A4%CE%CB%E4%C1%F2%BC%D4%A1%D5",wikiTextAll:`通常モンスター
...
自分は２枚ドローする。
その後、自分のデッキの上からカードを２枚墓地へ送る。`}},us=["Deck","ExtraDeck"],hs={Deck:"メインデッキ",ExtraDeck:"エクストラデッキ"},zn=["Monster","Spell","Trap"],Ba={Monster:"モンスター",Spell:"魔法",Trap:"罠"},Gt=["Fusion","Syncro","Xyz","Link"],Ea=[...Gt,"SpecialSummon"],ws=["Toon","Spirit","Union","Gemini","FlipEffect"],fs=["Tuner","Effect","Normal","Pendulum","Token"],Ti=[...Ea,...ws,...fs],_n={Syncro:"シンクロ",Fusion:"融合",Xyz:"エクシーズ",Link:"リンク",SpecialSummon:"特殊召喚",Toon:"トゥーン",Spirit:"スピリット",Union:"ユニオン",Gemini:"デュアル",FlipEffect:"リバース",Tuner:"チューナー",Effect:"効果",Normal:"通常",Pendulum:"ペンデュラム",Token:"トークン"},Jt={Syncro:"🎵",Fusion:"🌀",Xyz:"📰",Link:"⛓️",SpecialSummon:"🔯",Toon:"📖",Spirit:"👻",Union:"🚗",Gemini:"👫",FlipEffect:"🔄",Tuner:"🎶",Effect:"✨",Normal:"🔘",Pendulum:"💠",Token:"🐏"},Mi=["Light","Dark","Earth","Water","Fire","Wind","Divine"],ci={Light:"光",Dark:"闇",Earth:"地",Water:"水",Fire:"炎",Wind:"風",Divine:"神"},Ni=["Aqua","Beast","BeastWarrior","CreatorGod","Cyberse","Dinosaur","DivineBeast","Dragon","Fairy","Fiend","Fish","Insect","Illusion","Machine","Plant","Psychic","Pyro","Reptile","Rock","SeaSerpent","Spellcaster","Thunder","Warrior","WingedBeast","Wyrm","Zombie"],bi=["Normal","Continuous","Field","QuickPlay","Equip","Ritual"],en={Normal:"通常",Continuous:"永続",Field:"フィールド",QuickPlay:"速攻",Equip:"装備",Ritual:"儀式"},_i=["Normal","Continuous","Counter"],tn={Normal:"通常",Continuous:"永続",Counter:"カウンター"},Fn={Aqua:"水",Beast:"獣",BeastWarrior:"獣戦士",CreatorGod:"創造神",Cyberse:"サイバース",Dinosaur:"恐竜",DivineBeast:"幻獣神",Dragon:"ドラゴン",Fairy:"天使",Fiend:"悪魔",Fish:"魚",Insect:"昆虫",Illusion:"幻想魔",Machine:"機械",Plant:"植物",Psychic:"サイキック",Pyro:"炎",Reptile:"爬虫類",Rock:"岩石",SeaSerpent:"海竜",Spellcaster:"魔法使い",Thunder:"雷",Warrior:"戦士",WingedBeast:"鳥獣",Wyrm:"幻竜",Zombie:"アンデット"},nn={Aqua:"🚰",Beast:"🐅",BeastWarrior:"🦁",CreatorGod:"🔆",Cyberse:"💻️",Dinosaur:"🦖",DivineBeast:"💫",Dragon:"🐲",Fairy:"👼",Fiend:"👿",Fish:"🐟️",Insect:"🦋",Illusion:"🤡",Machine:"🤖",Plant:"🌱",Psychic:"👁️",Pyro:"🔥",Reptile:"🦎",Rock:"⛰",SeaSerpent:"🐍",Spellcaster:"🧙",Thunder:"⚡️",Warrior:"⚔️",WingedBeast:"🦅",Wyrm:"🐉",Zombie:"🦴"},Ke=class Ke{constructor(e){A(this,"id");A(this,"name");A(this,"description");A(this,"save",async e=>{const t=e??{id:this.id,name:this.name,description:this.description},i=await Ke.tblHeader.update(this.id,a=>({...a,...t}));return new Ke(i)});this.id=e.id,this.name=e.name,this.description=e.description}};A(Ke,"tblHeader"),A(Ke,"getOrCreateNew",async e=>{Ke.tblHeader||(Ke.tblHeader=new Cs(e));const t=await Ke.tblHeader.getAll();if(t.length)return new Ke(t[0]);const i=await Ke.tblHeader.insert({name:"あなた",description:"ここの文字列を何に使うかは未定。"});return new Ke(i)});let jn=Ke;class Cs extends pi{constructor(t){super(t,"TblDuelistProfile");A(this,"_prepareInitialRecords",()=>[])}}let Ds=-1;const vs=[{id:Ds--,name:"NPC",description:""}];class Fi{constructor(e,t,i,a,r){A(this,"duel");A(this,"seat");A(this,"_entity");A(this,"profile");A(this,"deckInfo");A(this,"duelistType");A(this,"lifeLog");A(this,"normalSummonCount");A(this,"specialSummonCount");A(this,"maxNormalSummonCount");A(this,"_lp");A(this,"battleDamage",(e,t)=>this.setLp(this._lp-e,t,"BattleDamage"));A(this,"effectDamage",(e,t)=>this.setLp(this._lp-e,t,"EffectDamage"));A(this,"lostLp",(e,t)=>this.setLp(this._lp-e,t,"Lost"));A(this,"payLp",(e,t)=>this.setLp(this._lp-e,t,"Pay"));A(this,"heal",(e,t)=>this.setLp(this._lp+e,t,"Heal"));A(this,"setLp",(e,t,i)=>{const a={clock:this.duel.clock,reason:i||"Set",beforeLp:this._lp,afterLp:e,entity:t};return this.lifeLog.push(a),this._lp=e,this.duel.log.info(`ライフポイント変動：${a.afterLp-a.beforeLp}（${a.beforeLp} ⇒ ${a.afterLp}）`,this),a});A(this,"getOpponentPlayer",()=>this.duel.firstPlayer===this?this.duel.secondPlayer:this.duel.firstPlayer);A(this,"getHandCell",()=>this.duel.field.getCells("Hand").filter(e=>e.owner===this)[0]);A(this,"getDeckCell",()=>this.duel.field.getCells("Deck").filter(e=>e.owner===this)[0]);A(this,"getExtraDeck",()=>this.duel.field.getCells("ExtraDeck").filter(e=>e.owner===this)[0]);A(this,"getGraveyard",()=>this.duel.field.getCells("Graveyard").filter(e=>e.owner===this)[0]);A(this,"getFieldZone",()=>this.duel.field.getCells("FieldSpellZone").filter(e=>e.owner===this)[0]);A(this,"getBanished",()=>this.duel.field.getCells("Banished").filter(e=>e.owner===this)[0]);A(this,"getMonsterZones",()=>this.duel.field.getCells("MonsterZone").filter(e=>e.owner===this));A(this,"getExtraMonsterZones",()=>this.duel.field.getCells("ExtraMonsterZone").filter(e=>{var t;return((t=e.cardEntities[0])==null?void 0:t.controller)===this}));A(this,"getSpellTrapZones",()=>this.duel.field.getCells("SpellAndTrapZone").filter(e=>e.owner===this));A(this,"getEmptyMonsterZones",()=>this.getMonsterZones().filter(e=>e.cardEntities.length===0));A(this,"getEmptyExtraZones",()=>this.getExtraMonsterZones().length===0?this.getMonsterZones().filter(e=>e.cardEntities.length===0):[]);A(this,"getAvailableMonsterZones",()=>this.getMonsterZones().filter(e=>e.isAvailable));A(this,"getAvailableExtraZones",()=>this.getExtraMonsterZones().length===0?this.duel.field.getCells("ExtraMonsterZone").filter(e=>e.isAvailable):[]);A(this,"getAvailableSpellTrapZones",()=>this.getSpellTrapZones().filter(e=>e.isAvailable));A(this,"getReleasableMonsters",()=>this.getMonstersOnField());A(this,"getMonstersOnField",()=>this.duel.field.getMonstersOnField().filter(e=>e.controller===this));A(this,"getAttackTargetMonsters",()=>this.duel.field.getMonstersOnField().filter(e=>e.status.isSelectableForAttack&&e.controller!==this));A(this,"shuffleDeck",()=>{this.getDeckCell().shuffle(),this.duel.log.info("デッキをシャッフル。",this)});this.duel=e,this.seat=t,this.profile=i,this.duelistType=a,this.deckInfo=r,this.lifeLog=[],this.normalSummonCount=0,this.specialSummonCount=0,this.maxNormalSummonCount=1,this._lp=8e3}get entity(){const e=this.getHandCell().entities.find(t=>t.entityType==="Duelist");return e||wt.createPlayerEntity(this)}get lp(){return this._lp}get isTurnPlayer(){return this.duel.getTurnPlayer()===this}}Array.prototype.shuffle=function(){return this.map(e=>({item:e,seq:Math.random()})).toSorted((e,t)=>e.seq-t.seq).map(e=>e.item)};Array.prototype.randomPick=function(n){return this.shuffle().slice(0,n)};Array.prototype.reset=function(...n){this.splice(0),this.push(...n)};Array.prototype.union=function(n){return this.filter(n.includes,n)};Array.prototype.getAllOnOffPattern=function(){const n=[];return this.forEach(e=>{if(n.length==0){n.push([e]),n.push([]);return}n.forEach(t=>n.push([...t,e]))}),n};const Gn={0:{0:"Hand"},1:{0:"Deck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"ExtraDeck"},2:{0:"Graveyard",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"FieldSpellZone"},3:{0:"Banished",1:"Disable",2:"ExtraMonsterZone",3:"Disable",4:"ExtraMonsterZone",5:"Disable",6:"Banished"},4:{0:"FieldSpellZone",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"Graveyard"},5:{0:"ExtraDeck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"Deck"},6:{0:"Hand"}};class ys{constructor(e,t,i,a){A(this,"onUpdateEvent",new He);A(this,"field");A(this,"row");A(this,"column");A(this,"cellType");A(this,"owner");A(this,"_entities");A(this,"releaseEntities",(e,t,i)=>(this._entities=this._entities.filter(a=>!e.includes(a)),e.forEach(a=>{a.movedAs.splice(0),a.movedAs.push(...new Set(t)),a.movedAt=a.field.duel.clock,a.movedBy=i,a.movedFrom=this}),this.onUpdateEvent.trigger(),e));A(this,"acceptEntities",(e,t)=>{t==="Bottom"?this._entities.push(...e):t==="Top"&&this._entities.unshift(...e),this._entities.forEach(i=>{i.fieldCell=this}),this.onUpdateEvent.trigger()});A(this,"shuffle",()=>{this._entities=this.entities.shuffle()});this.field=e,this.row=t,this.column=i,this.cellType=Gn[t][i],this.owner=a,this._entities=[]}get onUpdate(){return this.onUpdateEvent.expose()}get entities(){return this._entities}get cardEntities(){return this._entities.filter(e=>Ws.find(t=>t===e.entityType))}get targetForAttack(){return this.cellType==="Hand"?this._entities.find(e=>e.entityType==="Duelist"):this.cardEntities[0]}get isAvailable(){return this._entities.length===0}}class gs{constructor(e){A(this,"cells");A(this,"duel");A(this,"getAllCells",()=>this.cells.flat());A(this,"getCells",(...e)=>this.getAllCells().filter(t=>e.includes(t.cellType)));A(this,"getAllEntities",()=>this.getAllCells().map(e=>e.entities).flat());A(this,"getAllCardEntities",()=>this.getAllCells().map(e=>e.cardEntities).flat());A(this,"getMonstersOnField",()=>this.getCells("MonsterZone","ExtraMonsterZone").map(e=>e.cardEntities).filter(e=>e.length>0).map(e=>e[0]).filter(e=>e.entityType!=="Squatter"));A(this,"getEntities",e=>this.getAllEntities().filter(t=>t.controller===e));A(this,"pushDeck",e=>{e.deckInfo.cardNames.map(t=>Te[t]).filter(t=>t).forEach(t=>wt.createCardEntity(this,e,t)),this.duel.log.info(`デッキをセット。メイン${e.getDeckCell().cardEntities.length}枚。エクストラ${e.getExtraDeck().cardEntities.length}枚。`,e)});A(this,"prepareHands",async e=>await this.draw(e,5));A(this,"draw",async(e,t,i)=>{const a=await this._draw(e,t,i);if(!a)throw new ht(e.getOpponentPlayer());return a});A(this,"drawSameTime",async(e,t,i,a,r)=>{const s=await this._draw(e,t,r),p=await this._draw(i,t,r);if(s&&p)return!0;throw s?new ht(e):p?new ht(e):new ht});A(this,"_draw",async(e,t,i)=>{var s;if(t<1)return!0;const a=e.getDeckCell(),r=[];for(const p of Array(t)){if(!a.cardEntities.length)return this.duel.log.info(r.length>0?`デッキからカードを${t}枚ドローしようとしたが、${r.length}枚しかドローできなかった。${r}`:"デッキからカードをドローできなかった。",e),this.duel.isEnded=!0,e.setLp(0),!1;const d=a.cardEntities[0];await d.draw(i?["Effect"]:["Rule"],i),r.push(((s=d.origin)==null?void 0:s.name)||"!名称取得失敗!")}return this.duel.log.info(`デッキからカードを${r.length}枚ドロー。${r}。`,e),!0});A(this,"payMonstersForSpecialSummonCost",async(e,t,i,a,r,s,p)=>{if(i>0&&t.length<i)return;const d=await this.duel.view.waitSelectEntities(e,t,i,a,"素材とするモンスターを選択",p);if(console.log(d),!!d){for(const l of d)await l.release(["Release",...r],s);return this.duel.log.info(`${d.map(l=>l.status.name).join(", ")}を素材とした（${[...new Set(d.flatMap(l=>l.movedAs))].join(", ")}）。`,e),d}});A(this,"release",async(e,t,i,a,r,s,p,d)=>{if(i>0&&t.length<i)return;const l=await this.duel.view.waitSelectEntities(e,t,i,f=>(p||f.length>0)&&(i<0||f.length===i),"リリースするモンスターを選択",d);if(!l)return;const m=[];for(const f of l)await f.release(["Release",a,...r],s),m.push(f);return this.duel.log.info(`${m.map(f=>f.status.name).join(", ")}をリリース（${[...new Set(m.flatMap(f=>f.movedAs))].join(", ")}）。`,e),m});A(this,"discard",async(e,t,i,a,r,s)=>{const p=s||(()=>!0),d=e.getHandCell().cardEntities.filter(p);if(d.length<t)return[];let l=[];return(r||e).duelistType==="NPC"?l=d.randomPick(t):l=await this.duel.view.waitSelectEntities(r||e,d,t,m=>m.length===t,`${t}枚カードを捨てる。`,!1)||[],await this._sendGraveyardMany(l,["Discard",...i],a),this.duel.log.info(`手札からカードを${l.length}枚捨てた。${l.map(m=>{var f;return(f=m.origin)==null?void 0:f.name})}。`,e),l});A(this,"summonMany",async(e,t,i,a,r,s,p)=>{const d=await Promise.all(e.map(async l=>this._summon(l,t(l),i(l),a,r,s,p?p(l):void 0)));if(d.find(l=>!l))throw new pt("想定されない返却値",d);return d});A(this,"summon",async(e,t,i,a,r,s,p,d=!1)=>{const l=await this._summon(e,t,i,a,r,s,p,d);if(l)return this.duel.log.info(`${l.status.name}を召喚（${[...r,a].join(",")}）。`,p??(s==null?void 0:s.controller)??e.controller),l});A(this,"_summon",async(e,t,i,a,r,s,p,d=!1)=>{const l=p??(s==null?void 0:s.controller)??e.controller;let m=t.randomPick(1)[0],f=i.randomPick(1)[0];if((i.length>1||t.length>1)&&l.duelistType!=="NPC"){const k=t.map(h=>wt.createDammyAction(e,h,i,h));this.duel.view.modalController.selectAction(this.duel.view,{title:"カードを召喚先へドラッグ。",actions:k,cancelable:!1});const w=await this.duel.view.waitSubAction(l,k,"カードを召喚先へドラッグ。",d),c=w.actionWIP;if(!c&&!d)throw new pt("",w);if(!c)return;f=c.cell||f,m=c.pos||m}return console.log(f,m,a,r,s),await e.summon(f,m,a,r,s),e});A(this,"activateSpellTrapFromHand",async(e,t,i,a,r,s=!1)=>{const p=r??(a==null?void 0:a.controller)??e.controller;let d=t.randomPick(1)[0];if(t.length>1&&p.duelistType!=="NPC"){const l=[wt.createDammyAction(e,"カードの発動",t,void 0)];this.duel.view.modalController.selectAction(this.duel.view,{title:"カードを魔法罠ゾーンへドラッグ",actions:l,cancelable:!1});const m=await this.duel.view.waitSubAction(p,l,"カードを魔法罠ゾーンへドラッグ。",s),f=m.actionWIP;if(!f&&!s)throw new pt("",m);if(!f)return;d=f.cell||d}return await e.activateSpellTrapFromHand(d,i,a),e});A(this,"destroyMany",async(e,t,i)=>await this._sendGraveyardMany(e,[...t,"Destroy"],i));A(this,"sendGraveyardMany",async(e,t,i)=>await this._sendGraveyardMany(e,t,i));A(this,"_sendGraveyardMany",async(e,t,i)=>{for(const a of e)await a.sendGraveyard(t,i);return e.filter(a=>a.entityType!=="Token")});A(this,"setSpellTrap",async(e,t,i,a,r=!1)=>{let s=t[0];const p=a??(i==null?void 0:i.controller)??e.controller;if(t.length>1&&p.duelistType!=="NPC"){const d=[wt.createDammyAction(e,"セット",t)],l=this.duel.view.modalController.selectAction(this.duel.view,{title:"カードをセット先へドラッグ",actions:d,cancelable:r}),m=this.duel.view.waitSubAction(p,d,"カードをセット先へドラッグ",r),f=await Promise.any([l,m.then(k=>k.actionWIP)]);if(!f&&!r)throw new pt("",f);if(!f)return;s=f.cell||s}await e.setAsSpellTrap(s,["SpellTrapSet"],i),this.duel.log.info(`${e.status.name}をセット（SpellTrapSet）。`,a??(i==null?void 0:i.controller)??e.controller)});this.duel=e,this.cells=[...Array(7)].map(()=>[]);for(const t of Object.keys(Gn).map(Number))for(const i of Object.keys(Gn[t]).map(Number))this.cells[t][i]=new ys(this,t,i,t<3?e.duelists.Above:t>3?e.duelists.Below:void 0)}}let Bs=class{constructor(e){A(this,"onUpdateEvent",new He);A(this,"nextSeq");A(this,"records",[]);A(this,"duel");A(this,"dispose",()=>{this.onUpdateEvent.clear()});A(this,"error",e=>{console.error(e);const t=["エラー発生"];e instanceof Error?(e instanceof pt&&(t.push("-- エラーメッセージ --"),t.push(e.message),t.push("-- 関連オブジェクト --"),e.items.forEach(i=>t.push(JSON.stringify(i)))),t.push("-- エラー名称 --"),t.push(e.name||"エラー名称取得失敗"),t.push("-- スタックトレース --"),t.push(e.stack||"スタックトレース取得失敗")):(t.push("-- エラー型特定失敗 --"),t.push(JSON.stringify(e))),this.info(t)});A(this,"info",(e,t)=>{const i=Array.isArray(e)?e.join(`
`):e;this.records.push({seq:this.nextSeq++,turn:this.duel.clock.turn,phase:this.duel.phase,phaseStep:this.duel.phaseStep,clock:this.duel.clock,duelist:t,text:i}),this.onUpdateEvent.trigger()});this.nextSeq=0,this.duel=e}get onUpdate(){return this.onUpdateEvent.expose()}};const Hi=["DuelEntitiesSelector","DuelActionSelector"];class Es{constructor(e){A(this,"onUpdateEvent",new He);A(this,"states");A(this,"view");A(this,"cancelAll",()=>{Hi.forEach(e=>this.states[e]="Disable"),console.info(this,"cancelAll"),this.onUpdateEvent.trigger()});A(this,"duelEntitiesSelectorArg",{title:"対象を選択",entities:[],validator:()=>!0,qty:-1,cancelable:!1});A(this,"duelEntitiesSelectorValue");A(this,"duelEntitiesSelectorResolve",()=>{});A(this,"selectDuelEntities",async e=>(this.duelEntitiesSelectorArg=e,this.states.DuelEntitiesSelector="Shown",this.onUpdateEvent.trigger(),new Promise(t=>{this.duelEntitiesSelectorResolve=i=>{this.states.DuelEntitiesSelector="Disable",this.onUpdateEvent.trigger(),t(i)}})));A(this,"cardActionSelectorArg",{title:"カード操作を選択。",actions:[],cancelable:!1});A(this,"cardActionSelectorResolve",()=>{});A(this,"cardActionSelectorValue");A(this,"selectAction",async(e,t)=>(this.cardActionSelectorArg=t,this.states.DuelActionSelector="Shown",e.onWaitEnd.append(this.cancelAll),this.onUpdateEvent.trigger(),new Promise(i=>{this.cardActionSelectorResolve=a=>{this.states.DuelActionSelector="Disable",e.onWaitEnd.remove(this.cancelAll),this.onUpdateEvent.trigger(),i(a)}})));this.view=e,this.states=Hi.reduce((t,i)=>(t[i]="Disable",t),{})}get onUpdate(){return this.onUpdateEvent.expose()}}class xs{constructor(e){A(this,"onDuelUpdateEvent",new He);A(this,"requireUpdate",()=>{this.onDuelUpdateEvent.trigger()});A(this,"onWaitStartEvent",new He);A(this,"onWaitEndEvent",new He);A(this,"onDragStartEvent",new He);A(this,"onDragEndEvent",new He);A(this,"onAnimationStartEvent",new He);A(this,"onShowCardEntityEvent",new He);A(this,"duel");A(this,"modalController");A(this,"message");A(this,"waitMode");A(this,"infoBoardState");A(this,"infoBoardCell");A(this,"getCell",(e,t)=>this.duel.field.cells[e][t]);A(this,"showCardInfo",e=>{this.onShowCardEntityEvent.trigger(e)});A(this,"dispose",()=>{this.onDragStartEvent.clear(),this.onDragEndEvent.clear(),this.onDuelUpdateEvent.clear(),this.onWaitStartEvent.clear(),this.onWaitEndEvent.clear()});A(this,"waitFieldAction",async(e,t)=>{if(console.log(e),this.duel.getTurnPlayer().duelistType==="NPC"){const i=e.toSorted((a,r)=>(r.entity.atk||0)-(a.entity.atk||0)).find(a=>a.playType==="NormalSummon"||a.playType==="SpecialSummon");return i?{actionWIP:i}:{phaseChange:this.duel.nextPhaseList[0]}}return await this._waitDuelistAction(e,"SelectFieldAction",t)});A(this,"waitQuickEffect",async(e,t,i)=>{if(e.length===0)return;const a=[];return a.push(this.modalController.selectAction(this,{title:t,actions:e,cancelable:i}).then(r=>r&&r)),a.push(this._waitDuelistAction(e,"SelectAction",this.message).then(r=>r.actionWIP)),await Promise.any(a)});A(this,"waitSubAction",async(e,t,i,a=!1)=>{if(e.duelistType==="NPC")throw Error("Not implemented");return await this._waitDuelistAction(t,"SelectAction",i,void 0,void 0,void 0,a)});A(this,"waitSelectEntities",async(e,t,i,a,r,s=!1)=>{let p=[];if(i&&t.length===i)return[...t];if(e.duelistType==="NPC"){for(;!a(p);){const l=i&&i>0?i:Math.floor(Math.random()*t.length)+1;p=t.randomPick(l)}return p}this.waitMode=t.every(l=>(l.fieldCell.cellType==="MonsterZone"||l.fieldCell.cellType==="ExtraMonsterZone")&&l.getIndexInCell()===0||l.fieldCell.cellType==="Hand"&&l.controller===e)?"SelectFieldEntities":"SelectEntities",console.log(this.waitMode);const d=await this._waitDuelistAction([],this.waitMode,r,t,i,a,s);return console.log(d),d.selectedEntities});A(this,"_waitDuelistAction",async(e,t,i,a,r,s,p=!1)=>{this.waitMode=t,this.message=i,this.onDuelUpdateEvent.trigger();const d=await new Promise(l=>{const m={resolve:l,enableActions:e,qty:r,entitiesValidator:s||(()=>!1),selectableEntities:a||[]};console.log(a),console.log(s),console.log(this.waitMode),console.log(this.waitMode==="SelectEntities"),a&&s&&this.waitMode==="SelectEntities"&&(m.duelEntitiesSelectorArg={title:i,entities:a,validator:s,qty:r??-1,cancelable:!1}),this.onWaitStartEvent.trigger(m)});if(this.waitMode="None",this.onWaitEndEvent.trigger(),d.surrender)throw new ht(this.duel.duelists.Above);if(!p&&d.cancel)throw new pt("キャンセル不可のアクションがキャンセルされた。",d,e,t,a);return d});A(this,"waitAnimation",async e=>(this.onDuelUpdateEvent.trigger(),new Promise(t=>this.onAnimationStartEvent.trigger({...e,resolve:t}))));A(this,"setDraggingActions",e=>{this.onDragStartEvent.trigger(e),this.requireUpdate()});A(this,"removeDraggingActions",()=>{this.onDragEndEvent.trigger()});this.duel=e,this.message="",this.waitMode="None",this.infoBoardState="Log",this.infoBoardCell=e.duelists.Below.getExtraDeck(),this.modalController=new Es(this)}get onDuelUpdate(){return this.onDuelUpdateEvent.expose()}get onWaitStart(){return this.onWaitStartEvent.expose()}get onWaitEnd(){return this.onWaitEndEvent.expose()}get onDragStart(){return this.onDragStartEvent.expose()}get onDragEnd(){return this.onDragEndEvent.expose()}get onAnimation(){return this.onAnimationStartEvent.expose()}get onShowCardEntity(){return this.onShowCardEntityEvent.expose()}}class Ts{constructor(){A(this,"_turn",0);A(this,"_phaseSeq",0);A(this,"_stepSeq",0);A(this,"_chainSeq",0);A(this,"_chainBlockSeq",0);A(this,"_procSeq",0);A(this,"_procTotalSeq",0);A(this,"incrementTurn",()=>{this._turn++,this._phaseSeq=0,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});A(this,"incrementPhaseSeq",()=>{this._phaseSeq++,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});A(this,"incrementStepSeq",()=>{this._stepSeq++,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});A(this,"incrementChainSeq",()=>{this._chainSeq++,this._chainBlockSeq=0,this._procSeq=0});A(this,"incrementChainBlockSeq",()=>{this._chainBlockSeq++,this._procSeq=0});A(this,"incrementProcSeq",()=>{this._procSeq++,this._procTotalSeq++});A(this,"toString",()=>`${this.procTotalSeq}(t${this.turn}-p${this.phaseSeq}-ps${this.stepSeq}-c${this.chainSeq}-cb${this.chainBlockSeq}-p${this.procSeq})`)}get turn(){return this._turn}get phaseSeq(){return this._phaseSeq}get stepSeq(){return this._stepSeq}get chainSeq(){return this._chainSeq}get chainBlockSeq(){return this._chainBlockSeq}get procSeq(){return this._procSeq}get procTotalSeq(){return this._procTotalSeq}}class ht extends Error{constructor(t){const i=t?`デュエルが終了した。勝者：${t.profile.name}`:"デュエルが終了した。ドロー。";super(i);A(this,"winner");this.winner=t}}class pt extends Error{constructor(t,...i){super("message");A(this,"message");A(this,"items");this.message=t,this.items=i}}class Ms{constructor(e,t,i,a,r,s){A(this,"view");A(this,"log");A(this,"clock");A(this,"phase");A(this,"phaseStep");A(this,"nextPhaseList");A(this,"field");A(this,"attackingMonster");A(this,"targetForAttack");A(this,"duelists");A(this,"priorityHolder");A(this,"isEnded");A(this,"coin",!1);A(this,"getTurnPlayer",()=>this.clock.turn%2===0?this.secondPlayer:this.firstPlayer);A(this,"getNonTurnPlayer",()=>this.clock.turn%2===0?this.firstPlayer:this.secondPlayer);A(this,"main",async()=>{console.info("main start!"),this.coin=Math.random()>.5,this.priorityHolder=this.firstPlayer,this.log.info("【デュエル開始】"),this.log.info(`先攻：${this.firstPlayer.profile.name}`),Object.values(this.duelists).forEach(this.field.pushDeck),Object.values(this.duelists).forEach(e=>e.shuffleDeck()),await Promise.all(Object.values(this.duelists).map(this.field.prepareHands)),console.log("hoge"),this.moveNextPhase("draw"),this.view.requireUpdate();try{for(;!this.isEnded&&(this.phase==="draw"?await this.procDrawPhase():this.phase==="standby"?await this.procStanbyPhase():this.phase==="main1"?await this.procMainPhase():this.phase==="battle"?await this.procBattlePhase():this.phase==="main2"?await this.procMainPhase():this.phase==="end"&&await this.procEndPhase(),!(this.clock.turn>1e3)););}catch(e){e instanceof ht?(console.info(e),this.isEnded=!0,this.log.info(e.winner?`デュエル終了。勝者${e.winner.profile.name}`:"引き分け")):e instanceof Error&&this.log.error(e)}finally{this.view.requireUpdate(),this.view.dispose(),this.log.dispose()}});A(this,"moveNextPhase",e=>{e==="draw"?this.clock.incrementTurn():this.clock.incrementPhaseSeq(),this.clock.turn<1?this.phase="draw":e==="draw"?this.log.info("ターン終了。",this.getTurnPlayer()):this.log.info(`フェイズ移行（${this.phase}→${e}）`,this.getTurnPlayer()),this.phase=e,this.phaseStep=void 0,this.phase==="main2"||this.clock.turn===1?this.nextPhaseList=["end"]:this.phase==="battle"?this.nextPhaseList=["main2"]:this.phase==="main1"?this.nextPhaseList=["battle","end"]:this.nextPhaseList=[]});A(this,"declareAnAttack",(e,t)=>{this.attackingMonster=e,this.targetForAttack=t,e.status.attackCount++,this.log.info(`攻撃宣言：${e.status.name} ⇒ ${t.status.name}`,e.controller)});A(this,"procDrawPhase",async()=>{for(Object.values(this.duelists).forEach(e=>{e.normalSummonCount=0,e.specialSummonCount=0}),this.log.info("ドローフェイズ開始。",this.getTurnPlayer()),this.clock.turn===1?this.log.info("先攻プレイヤーはドローできない。",this.getTurnPlayer()):await this.field.draw(this.getTurnPlayer(),1);await this.procChainBlock(););this.field.getMonstersOnField().forEach(e=>{e.status.attackCount=0,e.status.battlePotisionChangeCount=0}),this.moveNextPhase("standby")});A(this,"procStanbyPhase",async()=>{for(;await this.procChainBlock(););this.moveNextPhase("main1")});A(this,"procMainPhase",async()=>{for(;;){this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["NormalSummon","SpellTrapSet","SpecialSummon","ChangeBattlePosition","IgnitionEffect","QuickEffect","CardActivation"],["Normal","Quick","Counter"]),"あなたの手番です。");if(e.actionWIP){if([...Ss].includes(e.actionWIP.playType)){const i=await e.actionWIP.prepare(e.actionWIP.cell,!0);if(console.log(i),!i)continue;await e.actionWIP.execute(this.priorityHolder,e.actionWIP.cell,i),this.clock.incrementProcSeq()}else await this.procChainBlock(e.actionWIP);for(;await this.procChainBlock(););continue}const t=e.phaseChange;if(t){if(this.priorityHolder=this.getNonTurnPlayer(),await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect","TriggerEffect"],["Quick","Counter"]),"",!0)){this.procChainBlock();continue}this.moveNextPhase(t);return}}});A(this,"procBattlePhase",async()=>{await this.procBattlePhaseStartStep(),await this.procBattlePhaseBattleStep(),await this.procBattlePhaseEndStep()});A(this,"procBattlePhaseStartStep",async()=>{for(this.phaseStep="start",this.priorityHolder=this.getTurnPlayer(),this.attackingMonster=void 0,this.targetForAttack=void 0;await this.procChainBlock(););});A(this,"procBattlePhaseBattleStep",async()=>{for(;;){this.phaseStep="battle",this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["Battle"],["Normal"]),"攻撃モンスターと対象を選択。");if(e.phaseChange)break;if(e.actionWIP){for(await e.actionWIP.execute(this.priorityHolder,e.actionWIP.cell),this.clock.incrementProcSeq();await this.procChainBlock(););this.clock.incrementStepSeq(),await this.procBattlePhaseDamageStep()}}this.clock.incrementStepSeq()});A(this,"procBattlePhaseDamageStep",async()=>{this.phaseStep="damage";const e=this.attackingMonster,t=this.targetForAttack;if(!e||!e.atk)throw new pt("想定されない状態",this.attackingMonster,this.targetForAttack);this.log.info("ダメージステップ開始時",this.getTurnPlayer()),this.log.info("ダメージ計算前",this.getTurnPlayer()),(t==null?void 0:t.battlePotion)==="Set"&&t.setBattlePosition("Defense"),this.log.info("ダメージ計算時",this.getTurnPlayer());const i=e.atk,a=((t==null?void 0:t.battlePotion)==="Attack"?t.atk:t==null?void 0:t.def)||0;!t||t.entityType==="Duelist"?e.controller.getOpponentPlayer().battleDamage(i-a,e):i>0&&i>a?(t.battlePotion==="Attack"&&e.controller.getOpponentPlayer().battleDamage(i-a,e),t.isDying=!0):i<a?(e.controller.battleDamage(a-i,t),t.battlePotion==="Attack"&&(e.isDying=!0)):i===a&&t.battlePotion==="Attack"&&(e.isDying=!0,t.isDying=!0);const r=Object.values(this.duelists).filter(s=>s.lp<=0);if(r.length>0)throw new ht(Object.values(this.duelists).filter(s=>!r.includes(s)).pop());e.isDying&&await this.field.destroyMany([e],["BattleDestroy"],t),t!=null&&t.isDying&&await this.field.destroyMany([t],["BattleDestroy"],e),this.log.info("ダメージ計算後",this.getTurnPlayer()),this.log.info("ダメージステップ終了時",this.getTurnPlayer()),this.clock.incrementStepSeq()});A(this,"procBattlePhaseEndStep",async()=>{for(this.phaseStep="end",this.priorityHolder=this.getTurnPlayer();await this.procChainBlock(););this.moveNextPhase("main2")});A(this,"procEndPhase",async()=>{for(;await this.procChainBlock(););for(;;){const t=this.getTurnPlayer().getHandCell().cardEntities.length;if(t<7)break;await this.field.discard(this.getTurnPlayer(),t-6,["Rule"])}this.moveNextPhase("draw")});A(this,"procChainBlock",async(e,t)=>{const i=this.clock.chainBlockSeq===0;let a;const r=t??Object.values(this.duelists).flatMap(s=>(this.priorityHolder=s,this.getEnableActions(["TriggerMandatoryEffect","TriggerEffect"],["Normal"])));try{if(e||r.length>0&&await this.selectTriggerEffect(r))return a=e,!0;let s=0;for(;s<2;){this.priorityHolder=this.priorityHolder.getOpponentPlayer();const p=await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect"],["Normal","Quick","Counter"]),"クイックエフェクト発動タイミング。効果を発動しますか？",!0);if(p)return a=p,!0;s++}return!1}finally{if(a){const s=a.entity.controller;this.log.info(`${a.entity.nm}«${a.title}»を発動`,s);const p=await a.prepare(a.cell);this.clock.incrementProcSeq(),this.clock.incrementChainBlockSeq(),await this.procChainBlock(void 0,r.filter(d=>d.seq!==(a==null?void 0:a.seq))),this.log.info(`${a.entity.nm}«${a.title}»の効果処理`,s),await a.execute(s,a.cell,p),this.clock.incrementProcSeq(),i&&(await Promise.all(this.field.getAllCells().filter(d=>d.cellType==="SpellAndTrapZone").flatMap(d=>d.entities).filter(d=>d.isDying).map(d=>d.sendGraveyard(["Rule"]))),this.clock.incrementChainSeq())}}});A(this,"selectTriggerEffect",async e=>{if(e.length>0)for(const t of["TriggerMandatoryEffect","TriggerEffect"])for(const i of[this.getTurnPlayer(),this.getNonTurnPlayer()]){this.priorityHolder=i;const a=e.filter(s=>s.playType===t&&s.entity.controller===i);if(a.length===0)continue;if(a.length===1&&t==="TriggerMandatoryEffect")return a[0];const r=await this.view.waitQuickEffect(a,"効果を選択。",t==="TriggerEffect");if(r)return r}});A(this,"getEnableActions",(e,t)=>this.field.getAllCardEntities().filter(i=>i.controller===this.priorityHolder).flatMap(i=>i.actions).filter(i=>i.executableCells.includes(i.entity.fieldCell.cellType)).filter(i=>e.includes(i.playType)).filter(i=>t.includes(i.spellSpeed)).filter(i=>i.validate()));this.phase="end",this.clock=new Ts,this.nextPhaseList=[],this.isEnded=!1,this.duelists={Below:new Fi(this,"Below",e,t,i),Above:new Fi(this,"Above",a,r,s)},this.priorityHolder=this.firstPlayer,this.field=new gs(this),this.view=new xs(this),this.log=new Bs(this)}get firstPlayer(){return this.coin?this.duelists.Below:this.duelists.Above}get secondPlayer(){return this.coin?this.duelists.Above:this.duelists.Below}}const xa=n=>{if(n.controller.normalSummonCount>=n.controller.maxNormalSummonCount||!n.status.level)return;const e=n.controller.getAvailableMonsterZones();return n.status.level<5?e.length>0?e:void 0:n.controller.getReleasableMonsters().length<(n.status.level<7?1:2)?void 0:[]},Ta=async(n,e,t,i)=>{if(!n.status.level)return[];if(n.status.level<5)return[];let a=i;const r=n.controller.getReleasableMonsters(),s=n.controller.getExtraMonsterZones(),p=n.status.level<7?1:2;s.length>=p&&r.filter(l=>l.fieldCell.cellType!=="ExtraMonsterZone");const d=await n.field.release(n.controller,n.controller.getReleasableMonsters(),p,"Cost",["AdvanceSummonRelease","Rule"],n,a);if(d)return a=!1,d},Ma=async(n,e,t,i)=>{if(!n.status.level)return!1;const a=["Rule","NormalSummon"];i&&i.length>0&&(n.materials.reset(...i),a.push("AdvanceSummon"));const r=n.controller.getAvailableMonsterZones();return await n.field.summon(n,[e],t?[t]:r,"NormalSummon",a,n,void 0,i&&i.length===0),n.controller.normalSummonCount++,!0},Ns=n=>{if(n.status.attackCount>0||n.battlePotion!=="Attack"||!n.controller.isTurnPlayer)return;const e=n.controller.getAttackTargetMonsters();return e.length>0?e.map(t=>t.fieldCell):[n.controller.getOpponentPlayer().getHandCell()]},bs=async(n,e,t)=>{if(n.status.attackCount>0||n.battlePotion!=="Attack")return!1;if(t!=null&&t.targetForAttack)return n.field.duel.declareAnAttack(n,t==null?void 0:t.targetForAttack),!0;const i=n.controller.getAttackTargetMonsters(),a=n.controller.getOpponentPlayer().entity;if(i.length===0)return n.field.duel.declareAnAttack(n,a),!0;if(i.length===1)return n.field.duel.declareAnAttack(n,i[0]),!0;const r=await n.field.duel.view.waitSelectEntities(n.controller,i,1,s=>s.length===1,"攻撃対象を選択。",!0);return r?(n.field.duel.declareAnAttack(n,r[0]),!0):!1},_s=n=>{if(!(n.status.battlePotisionChangeCount>0||n.status.attackCount>0||!n.controller.isTurnPlayer))return[]},Fs=async n=>n.status.battlePotisionChangeCount>0||!n.controller.isTurnPlayer?!1:(n.setBattlePosition(n.battlePotion==="Attack"?"Defense":"Attack"),n.status.battlePotisionChangeCount++,!0),Hs=n=>{if(n.status.spellCategory==="Field"){const t=n.controller.getFieldZone();return t.isAvailable?[t]:void 0}const e=n.controller.getAvailableSpellTrapZones();return e.length>0?e:void 0},Ks=async(n,e,t)=>{const i=n.controller.getAvailableSpellTrapZones();return i.length===0?!1:(await n.field.setSpellTrap(n,t?[t]:i,void 0,n.controller,!0),!0)},at=(n,e=()=>!0)=>{if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return[];const t=n.controller.getAvailableSpellTrapZones();return t.length>0&&e(n)?t:void 0},rt=async(n,e,t)=>{if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return n.setNonFieldPosition("FaceUp",!0),!0;if(n.fieldCell.cellType==="Hand"){const i=["SpellTrapActivate"],a=t?[t]:n.controller.getAvailableSpellTrapZones();return await n.field.activateSpellTrapFromHand(n,a,i,n,n.controller,!0),!0}return!1},Na=(n,e,t,i)=>!(e.some(a=>!a.status.canBeSyncroMaterial)||e.some(a=>a.fieldCell.cellType!=="Hand"&&a.fieldCell.cellType!=="MonsterZone"&&a.fieldCell.cellType!=="ExtraMonsterZone")||e.some(a=>a.fieldCell.cellType==="Hand")&&e.every(a=>!a.status.allowHandSyncro)||e.some(a=>!a.lvl)||e.map(a=>a.lvl??0).reduce((a,r)=>a+r,0)!==(n.origin.level??-1)||!t(e.filter(a=>{var r;return(r=a.status.monsterCategories)==null?void 0:r.some(s=>s==="Tuner")}))||!i(e.filter(a=>{var r;return(r=a.status.monsterCategories)==null?void 0:r.every(s=>s!=="Tuner")}))),Ki=(n,e=i=>i.length===1,t=i=>i.length>0)=>{let i=[...n.controller.getMonstersOnField().filter(a=>a.face==="FaceUp"),...n.controller.getHandCell().entities.filter(a=>a.origin.kind==="Monster")].filter(a=>a.status.canBeSyncroMaterial);if(i.every(a=>!a.status.allowHandSyncro)&&(i=n.controller.getMonstersOnField()),!(i.length<2)){for(const a of i.getAllOnOffPattern())if(Na(n,a,e,t))return[]}},Si=async(n,e,t,i,a=s=>s.length===1,r=s=>s.length>0)=>{let s=[...n.controller.getMonstersOnField(),...n.controller.getHandCell().entities.filter(d=>d.origin.kind==="Monster")].filter(d=>d.status.canBeSyncroMaterial);if(s.every(d=>!d.status.allowHandSyncro)&&(s=n.controller.getMonstersOnField()),s.length<2)return;console.log(s);const p=await n.field.payMonstersForSpecialSummonCost(n.controller,s,-1,d=>Na(n,d,a,r),["SyncroMaterial","Rule"],n,i);if(console.log(p),!!p)return p},Wi=async(n,e,t,i,a)=>{a&&a.length>0&&n.materials.reset(...a);const r=[...e.getAvailableMonsterZones(),...e.getAvailableExtraZones()];return await n.field.summon(n,[t],i?[i]:r,"SyncroSummon",["Rule","SpecialSummon"],n,void 0,a&&a.length===0),e.specialSummonCount++,n.canReborn=!0,!0},ba={title:"召喚",playType:"NormalSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:xa,prepare:(n,e,t)=>Ta(n,"Attack",e,t),execute:(n,e,t,i)=>Ma(n,"Attack",t,i)},_a={title:"セット",playType:"NormalSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:xa,prepare:(n,e,t)=>Ta(n,"Set",e,t),execute:(n,e,t,i)=>Ma(n,"Set",t,i)},ln={title:"攻撃宣言",playType:"Battle",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:Ns,prepare:async()=>!0,execute:(n,e,t)=>bs(n,void 0,t)},dn={title:"表示形式変更",playType:"ChangeBattlePosition",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:_s,prepare:async()=>!0,execute:n=>Fs(n)},st={title:"セット",playType:"SpellTrapSet",spellSpeed:"Normal",executableCells:["Hand"],validate:Hs,prepare:async()=>!0,execute:(n,e,t)=>Ks(n,"Set",t)},Pi=(n=t=>t.length===1,e=t=>t.length>0)=>[{title:"シンクロ召喚（攻撃）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["ExtraDeck"],validate:t=>Ki(t,n,e),prepare:(t,i,a)=>Si(t,"Attack",i,a,n,e),execute:(t,i,a,r)=>Wi(t,i,"Attack",a,r)},{title:"シンクロ召喚（守備）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["ExtraDeck"],validate:t=>Ki(t,n,e),prepare:(t,i,a)=>Si(t,"Defense",i,a,n,e),execute:(t,i,a,r)=>Wi(t,i,"Defense",a,r)}],Ss=["NormalSummon","SpecialSummon","ChangeBattlePosition","Battle","SpellTrapSet","SpellTrapActivate"],Ws=["Card","Token","Avatar"],pn=(n,e)=>{const t=n.monsterCategories??[],i=e.monsterCategories??[];for(const a of Gt.toReversed()){if(t.includes(a)&&!i.includes(a))return 1;if(!t.includes(a)&&i.includes(a))return-1}if(n.kind===e.kind){if(n.kind==="Monster"){if((n.link??0)!==(e.link??0))return(n.link??0)-(e.link??0);if((n.rank??0)!==(e.rank??0))return(n.rank??0)-(e.rank??0);if((n.level??0)!==(e.level??0))return(n.level??0)-(e.level??0);if((n.attack??0)!==(e.attack??0))return(n.attack??0)-(e.attack??0);if((n.defense??0)!==(e.defense??0))return(n.defense??0)-(e.defense??0)}return n.name.localeCompare(e.name,"Ja")}for(const a of zn){if(n.kind===a)return-1;if(e.kind===a)return 1}return n.name.localeCompare(e.name)},Ps=(n,e)=>{const t=pn(n.origin,e.origin);return console.log(n.nm,e.nm,t),t},ge=class ge{constructor(e,t,i,a,r,s,p,d,l){A(this,"seq");A(this,"origin");A(this,"entityType");A(this,"face");A(this,"isUnderControl");A(this,"_battlePosition");A(this,"orientation");A(this,"controller");A(this,"owner");A(this,"field");A(this,"fieldCell");A(this,"movedBy");A(this,"movedAs");A(this,"movedFrom");A(this,"movedAt");A(this,"isDying");A(this,"isVanished");A(this,"canReborn");A(this,"materials");A(this,"status");A(this,"actions",[]);A(this,"getIndexInCell",()=>{const e=this.fieldCell.cardEntities.indexOf(this);if(e<0)throw new pt("エンティティとセルの状態が矛盾している。",[this,this.fieldCell]);return e});A(this,"setBattlePosition",e=>{this._battlePosition=e,this.orientation=e==="Attack"?"Vertical":"Horizontal",this.face=e==="Set"?"FaceDown":"FaceUp",this.isUnderControl=!0});A(this,"setNonFieldPosition",(e,t)=>{this._battlePosition=void 0,this.orientation=e==="XysMaterial"?"Horizontal":"Vertical",this.face=e==="FaceUp"?"FaceUp":"FaceDown",this.isUnderControl=t});A(this,"summon",async(e,t,i,a,r)=>{const s={Attack:"AttackSummon",Defense:"DefenseSummon",Set:"SetSummon"};e.isAvailable&&(this.setBattlePosition(t),await this._moveTo(e,"Top",[i,s[t],...a],r),this.status.battlePotisionChangeCount=1)});A(this,"release",async(e,t)=>{await this.sendGraveyard([...e,"Release"],t)});A(this,"destroy",async(e,t,i)=>{await this.sendGraveyard([...t,e,"Destroy"],i)});A(this,"sendGraveyard",async(e,t)=>{this.setNonFieldPosition("FaceUp",!0);const i=this.owner.getGraveyard();await this._moveTo(i,"Top",e,t)});A(this,"setAsSpellTrap",async(e,t,i)=>{await this._moveTo(e,"Top",[...t,"SpellTrapSet"],i),this.setNonFieldPosition("Set",!0)});A(this,"activateSpellTrapFromHand",async(e,t,i)=>{this.setNonFieldPosition("FaceUp",!0),await this._moveTo(e,"Top",[...t,"SpellTrapActivate"],i),this.isDying=!0});A(this,"activateSpellTrapOnField",async()=>{this.setNonFieldPosition("FaceUp",!0),this.isDying=!0});A(this,"draw",async(e,t)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",[...e,"Draw"],t),this.setNonFieldPosition("Set",!0)});A(this,"addToHand",async(e,t)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",e,t),this.setNonFieldPosition("Set",!0)});A(this,"_moveTo",async(e,t,i,a)=>{if(this.field.duel.clock.turn>0&&await this.field.duel.view.waitAnimation({entity:this,to:e,index:t,count:0}),this.fieldCell.releaseEntities([this],i,a),this.entityType==="Token"&&this.fieldCell.cellType!=="MonsterZone"){this.field.duel.log.info(`${this.nm}は消滅した。`,a==null?void 0:a.controller);return}e.acceptEntities([this],t)});var m;this.seq=ge.nextEntitySeq++,this.owner=e,this.controller=t,this.field=i,this.fieldCell=a,this.entityType=r,this.origin=s,this.status={...JSON.parse(JSON.stringify(s)),canAttack:!0,isEffective:!0,canDirectAttack:!1,attackCount:0,isSelectableForAttack:!0,canBeSyncroMaterial:!0},this.face=p,this.isUnderControl=d,this.orientation=l,this.movedAs=["Rule"],this.movedAt=i.duel.clock,this.isDying=!1,this.isVanished=!1,this.canReborn=((m=this.origin.monsterCategories)==null?void 0:m.union(Ea).length)===0,this.materials=[],a.acceptEntities([this],"Top")}get nm(){return this.status.name}get atk(){return this.status.attack}get def(){return this.status.defense}get lvl(){return this.status.level}get rank(){return this.status.rank}get attr(){return this.status.attribute?[this.status.attribute]:[]}get type(){return this.status.type?[this.status.type]:[]}get psL(){return[this.status.pendulumScaleL]}get psR(){return[this.status.pendulumScaleR]}get battlePotion(){return this._battlePosition}};A(ge,"nextActionSeq",0),A(ge,"nextEntitySeq",0),A(ge,"actionDic",{}),A(ge,"createCardActionList",(e,t)=>{const i=t.map(a=>({seq:ge.nextActionSeq++,title:a.title,entity:e,playType:a.playType,spellSpeed:a.spellSpeed,executableCells:a.executableCells,validate:()=>a.validate(e),prepare:r=>a.prepare(e,r),execute:(r,s,p)=>a.execute(e,r,s,p)}));return i.forEach(a=>ge.actionDic[a.seq]=a),i}),A(ge,"createPlayerEntity",e=>{const t=e.getHandCell();return new ge(e,e,e.duel.field,t,"Duelist",{name:e.profile.name,kind:"Monster"},"FaceUp",!0,"Vertical")}),A(ge,"createCardEntity",(e,t,i)=>{var p;const a=i.monsterCategories&&i.monsterCategories.union(Gt).length?t.getExtraDeck():t.getDeckCell(),r=new ge(t,t,e,a,"Card",i,"FaceDown",!1,"Vertical");Object.hasOwn(Te,r.origin.name)||e.duel.log.info(`未実装カード${i.name}がデッキに投入された。`,t);const s=Te[r.origin.name];return s.kind==="Monster"&&((p=s.monsterCategories)!=null&&p.includes("Normal"))?r.actions.push(...ge.createCardActionList(r,[ba,_a,ln,dn])):r.actions.push(...ge.createCardActionList(r,Vn.get(r.origin.name)||[])),r}),A(ge,"createDammyAction",(e,t,i,a)=>({seq:ge.nextActionSeq++,title:t,entity:e,playType:"Dammy",spellSpeed:"Dammy",executableCells:[e.fieldCell.cellType],validate:()=>i,prepare:async()=>{},execute:async()=>!1,pos:a,dragAndDropOnly:!0}));let wt=ge;const qs=()=>{const n=[],e=c=>{const h=c.field.getMonstersOnField();if(h.length==0||h.some(y=>y.controller===c.controller))return;const D=c.controller.getEmptyMonsterZones();return D.length>0?D:void 0},t=async(c,h,D)=>{const y=c.controller.getEmptyMonsterZones();return await c.field.summon(c,[h],D?[D]:y,"SpecialSummon",["Rule"],c,void 0,!0),c.controller.specialSummonCount++,!0},i={name:"サイバー・ドラゴン",actions:[ba,_a,ln,dn,{title:"特殊召喚（攻撃）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:e,prepare:async()=>!0,execute:async(c,h,D)=>(await t(c,"Attack",D),!0)},{title:"特殊召喚（守備）",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:e,prepare:async()=>!0,execute:async(c,h,D)=>(await t(c,"Defense",D),!0)}]};n.push(i);const a={name:"大地の騎士ガイアナイト",actions:[ln,dn,...Pi()]};n.push(a),n.push({...a,name:"スクラップ・デスデーモン"});const r={name:"ナチュル・ガオドレイク",actions:[ln,dn,...Pi(c=>c.length===1&&c.every(h=>h.attr.some(D=>D==="Earth")),c=>c.length>0&&c.every(h=>h.attr.some(D=>D==="Earth")))]};n.push(r);const s={name:"強欲な壺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:at,prepare:async(c,h)=>(c.isDying=!0,await rt(c,void 0,h)),execute:async(c,h)=>(await c.field.draw(h,2,c),!0)},st]};n.push(s);const p={name:"天使の施し",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:at,prepare:async(c,h)=>(c.isDying=!0,await rt(c,void 0,h)),execute:async(c,h)=>(await c.field.draw(c.controller,3,c),await c.field.discard(h,2,["Effect","Discard"],c),!0)},st]};n.push(p);const d={name:"成金ゴブリン",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:at,prepare:async(c,h)=>(c.isDying=!0,await rt(c,void 0,h)),execute:async(c,h)=>(await c.field.draw(c.controller,1,c),c.field.duel.clock.incrementProcSeq(),h.getOpponentPlayer().heal(1e3,c),!0)},st]};n.push(d);const l={name:"おろかな埋葬",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:c=>at(c,h=>h.controller.getDeckCell().cardEntities.some(D=>D.status.kind==="Monster")),prepare:async(c,h)=>(c.isDying=!0,await rt(c,void 0,h)),execute:async(c,h)=>{const D=h.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster");if(D.length===0)return!1;const y=await c.field.duel.view.waitSelectEntities(h,D,1,C=>C.length===1,"墓地に送るモンスターを選択",!1);for(const C of y??[])await c.field.sendGraveyardMany([C],["Effect"],c);return await h.shuffleDeck(),!0}},st]};n.push(l);const m={name:"死者蘇生",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:c=>at(c,h=>h.field.getCells("Graveyard").flatMap(D=>D.cardEntities).filter(D=>D.origin.kind==="Monster"&&D.canReborn).length>0&&h.controller.getAvailableMonsterZones().length>0),prepare:async(c,h)=>{c.isDying=!0;const D=await c.field.duel.view.waitSelectEntities(c.controller,c.field.getCells("Graveyard").flatMap(y=>y.cardEntities).filter(y=>y.origin.kind==="Monster"&&y.canReborn),1,y=>y.length===1,"蘇生対象とするモンスターを選択",!1);return await rt(c,void 0,h),D==null?void 0:D[0]},execute:async(c,h,D,y)=>{const C=h.getEmptyMonsterZones();return y.controller=h,await c.field.summon(y,["Attack","Defense"],C,"SpecialSummon",["Effect"],c,void 0,!1),c.controller.specialSummonCount++,!0}},st]};n.push(m);const f={name:"増援",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:c=>at(c,h=>h.controller.getDeckCell().cardEntities.filter(D=>D.status.kind==="Monster").filter(D=>D.status.type==="Warrior").filter(D=>D.status.level&&D.status.level<5).length>0),prepare:async(c,h)=>(c.isDying=!0,await rt(c,void 0,h)),execute:async(c,h)=>{const D=h.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster").filter(C=>C.status.type==="Warrior").filter(C=>C.status.level&&C.status.level<5);if(D.length===0)return!1;const y=await c.field.duel.view.waitSelectEntities(h,D,1,C=>C.length===1,"手札に加えるモンスターを選択",!1);for(const C of y??[])await C.addToHand(["Effect"],c);return!0}},st]};n.push(f);const k={name:"Ｅ－エマージェンシーコール",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:c=>at(c,h=>h.controller.getDeckCell().cardEntities.filter(D=>D.status.kind==="Monster").some(D=>D.status.nameTags&&D.status.nameTags.includes("Ｅ・ＨＥＲＯ"))),prepare:async(c,h)=>(c.isDying=!0,await rt(c,void 0,h)),execute:async(c,h)=>{const D=h.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster").filter(C=>C.status.nameTags&&C.status.nameTags.includes("Ｅ・ＨＥＲＯ"));if(D.length===0)return!1;const y=await c.field.duel.view.waitSelectEntities(h,D,1,C=>C.length===1,"手札に加えるモンスターを選択",!1);for(const C of y??[])await C.addToHand(["Effect"],c);return!0}},st]};n.push(k);const w={name:"光の援軍",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:c=>at(c,h=>h.controller.getDeckCell().cardEntities.filter(D=>D.status.kind==="Monster").filter(D=>(D.lvl??13)<5).some(D=>D.status.nameTags&&D.status.nameTags.includes("ライトロード"))&&h.controller.getDeckCell().cardEntities.length>3),prepare:async(c,h)=>{c.isDying=!0;const D=c.controller.getDeckCell();return Array(3).forEach(()=>D.cardEntities[0].sendGraveyard(["Cost"],c)),await rt(c,void 0,h)},execute:async(c,h)=>{const D=h.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster").filter(C=>(C.lvl??13)<5).filter(C=>C.status.nameTags&&C.status.nameTags.includes("ライトロード"));if(D.length===0)return!1;const y=await c.field.duel.view.waitSelectEntities(h,D,1,C=>C.length===1,"手札に加えるモンスターを選択",!1);for(const C of y??[])await C.addToHand(["Effect"],c);return!0}},st]};return n.push(w),console.log(n),n},Fa=new Map;qs().forEach(n=>{Fa.set(n.name,n.actions)});const Vn=Fa,Ls=ms,Te=Object.values(Ls).reduce((n,e)=>(n[e.name]=e,n),{}),re=class re{constructor(e,t){A(this,"id");A(this,"name");A(this,"description");A(this,"lastUsedAt");A(this,"cardNames");A(this,"getIllegalCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(Te).includes(e)))));A(this,"getDisableCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(Te).includes(e)))));A(this,"createCardInfos",()=>{const e=this.getIllegalCardNames();if(e.length>0)throw new Error(`存在しないカード名からデッキを生成しようとした。${e}`);return this.cardNames.map(t=>Te==null?void 0:Te[t]).filter(t=>t)});A(this,"copy",async()=>re.createNewDeck(this.name,this.description,this.cardNames));A(this,"saveDeckInfo",async e=>{const t=e??this;await re.tblHeader.update(this.id,r=>({...r,name:t.name,description:t.description}));const i=(await re.tblDetail.getAll()).filter(r=>r.deckId===this.id);console.log(t.cardNames),await re.tblDetail.delete(i.map(r=>r.id));const a=await re.tblDetail.insertMany(t.cardNames.map((r,s)=>({deckId:this.id,seq:s,name:r,description:""})));return console.log(a),new re(await re.tblHeader.get(this.id),a)});A(this,"delete",async()=>{await re.tblHeader.delete([this.id]);const e=(await re.tblDetail.getAll()).filter(t=>t.deckId===this.id);await re.tblDetail.delete(e.map(t=>t.id))});this.id=e.id,this.name=e.name,this.description=e.description,this.lastUsedAt=e.lastUsedAt,this.cardNames=t.filter(i=>i.deckId===this.id).map(i=>i.name)}};A(re,"idb"),A(re,"tblHeader"),A(re,"tblDetail"),A(re,"getAllDeckInfo",async e=>{if(e&&(re.idb=e),!re.idb)throw new Error("illegal argument: idb is undefined.");re.tblHeader||(re.tblHeader=new Rs(re.idb)),re.tblDetail||(re.tblDetail=new Os(re.idb));const t=await re.tblHeader.getAll(),i=await re.tblDetail.getAll();return t.length?t.map(a=>new re(a,i)):[await re.prepareSampleDeck()]}),A(re,"createNewDeck",async(e,t,i)=>{const a=await re.tblHeader.insert({name:e,description:t,lastUsedAt:new Date}),r=await re.tblDetail.insertMany(i.map((s,p)=>({deckId:a.id,seq:p,name:s,description:""})));return new re(a,r)}),A(re,"prepareSampleDeck",async()=>await re.createNewDeck(cn[0].name,cn[0].description,cn[0].cardNames));let Ct=re;class Rs extends pi{constructor(t){super(t,"TblDeckHeader");A(this,"_prepareInitialRecords",()=>[])}}class Os extends pi{constructor(t){super(t,"TblDeckDetail");A(this,"_prepareInitialRecords",()=>[])}}let Is=-1,$t=["おろかな埋葬","成金ゴブリン","強欲な壺","天使の施し","増援","死者蘇生","Ｅ－エマージェンシーコール","サイバー・ドラゴン","ナチュル・ガオドレイク","スクラップ・デスデーモン","大地の騎士ガイアナイト"];$t=[...$t,...$t,...$t,"アレキサンドライドラゴン","ジェネティック・ワーウルフ","機界騎士アヴラム","ジョングルグールの幻術師","ゾンビーノ","幻のグリフォン","フロストザウルス","エレキテルドラゴン","青眼の白龍","幻殻竜","しゃりの軍貫","チューン・ウォリアー","ライドロン","Ａ・マインド","ウォーター・スピリット","エンジェル・トランペッター","ガード・オブ・フレムベル","ギャラクシーサーペント","ジェネクス・コントローラー","スペース・オマジナイ・ウサギ","ハロハロ","ライブラの魔法秤","ラブラドライドラゴン","守護竜ユスティア","竜核の呪霊者","Ｅ・ＨＥＲＯ クレイマン","Ｅ・ＨＥＲＯ スパークマン","Ｅ・ＨＥＲＯ ネオス","Ｅ・ＨＥＲＯ バーストレディ","Ｅ・ＨＥＲＯ フェザーマン"];const cn=[{id:Is--,name:"サンプルデッキ１",description:"",lastUsedAt:new Date,cardNames:$t}];function Zs(n){const e=n-1;return e*e*e+1}function qi(n,e){for(const t in e)n[t]=e[t];return n}function Us({fallback:n,...e}){const t=new Map,i=new Map;function a(s,p,d){const{delay:l=0,duration:m=Z=>Math.sqrt(Z)*30,easing:f=Zs}=qi(qi({},e),d),k=s.getBoundingClientRect(),w=p.getBoundingClientRect(),c=k.left-w.left,h=k.top-w.top,D=k.width/w.width,y=k.height/w.height,C=Math.sqrt(c*c+h*h),H=getComputedStyle(p),P=H.transform==="none"?"":H.transform,q=+H.opacity;return{delay:l,duration:typeof m=="function"?m(C):m,easing:f,css:(Z,X)=>`
			   opacity: ${Z*q};
			   transform-origin: top left;
			   transform: ${P} translate(${X*c}px,${X*h}px) scale(${Z+(1-Z)*D}, ${Z+(1-Z)*y});
		   `}}function r(s,p,d){return(l,m)=>(s.set(m.key,l),()=>{if(p.has(m.key)){const f=p.get(m.key);return p.delete(m.key),a(f,l,m)}return s.delete(m.key),n&&n(l,m,d)})}return[r(i,t,!1),r(t,i,!0)]}var $s=N("<div></div>"),Ys=N('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"> </div> <div class="svelte-3b34fd"> </div></div>'),zs=N('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"></div> <div class="svelte-3b34fd"> </div></div>'),js=N('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"></div> <div class="svelte-3b34fd"> </div></div>'),Gs=N('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"> </div> <div class="svelte-3b34fd"> </div></div>'),Vs=N('<div class="duel_card_row svelte-3b34fd"><div class="svelte-3b34fd"> </div></div> <div class="duel_card_row duel_card_row_wide svelte-3b34fd"><div class="svelte-3b34fd"> </div> <div class="svelte-3b34fd"> </div></div>',1),Qs=N('<button><div class="duel_card duel_card_face_up svelte-3b34fd"><div class="duel_card_row svelte-3b34fd" style="position:relative"><div class="svelte-3b34fd"> </div> <!></div> <!> <!> <!></div></button>'),Xs=N('<div class="duel_card duel_card_face_down svelte-3b34fd"><div class="svelte-3b34fd"></div></div>');function Qe(n,e){Ne(e,!1);let t=ce(e,"entity",8),i=ce(e,"state",8,"Disabled"),a=ce(e,"selectedList",28,()=>[]),r=ce(e,"isVisibleForcibly",8,!1),s=ce(e,"isWideMode",8,!1),p=ce(e,"actions",24,()=>[]),d=ce(e,"cardActionResolve",8),l=ce(e,"entitySelectResolve",8,()=>{}),m=ve(!1),f=()=>{},k=ce(e,"qty",12,void 0);const w=x=>{Q(m,!1),k(x.qty),f=x.resolve};t().field.duel.view.onWaitStart.append(w);let c=ve(!1);const h=()=>{if(i()!=="Disabled"&&(console.log(k()),i()==="Selectable"&&k()&&k()===1)){if(a().some(x=>x.seq!==t().seq)){a([t()]);return}k()&&k()===1&&l()&&l()([t()])}},D=()=>{(t().face==="FaceUp"||t().owner===t().field.duel.duelists.Below&&(t().isUnderControl||r()))&&t().field.duel.view.showCardInfo(t())},y=()=>{if(console.log(t(),i()),D(),i()==="Disabled")return;if(i()==="Selectable"){Q(m,!o(m)),a(o(m)?[...a(),t()]:a().filter(I=>I!==t()));return}if(p().length===0)return;if(p().length===1){if(p()[0].dragAndDropOnly)return;if(d()){d()(p()[0]);return}console.log(p()[0],f),f({actionWIP:p()[0]});return}const x=t().field.duel.view;x.modalController.selectAction(x,{title:"行動を選択。",actions:p(),cancelable:!0}).then(I=>{f({actionWIP:I})})},C=x=>{console.info("drag start",x,p()),t().field.duel.view.setDraggingActions(p()),Q(c,!0)},H=x=>{console.info("drag end",x,p()),t().field.duel.view.removeDraggingActions(),x.dataTransfer&&Q(c,!1)};Le();var P=he(),q=V(P);{var Z=x=>{var I=Qs(),ee=u(I),Ae=u(ee),ue=u(Ae),De=u(ue),G=v(ue,2);me(G,1,()=>t().attr,ke,(b,S)=>{var F=$s();L(()=>we(F,`monster_attr ${o(S)??""} svelte-3b34fd`)),g(b,F)});var B=v(Ae,2);{var W=b=>{var S=Ys(),F=u(S),z=u(F),ae=v(F,2),J=u(ae);L((te,oe)=>{_(z,te),_(J,oe)},[()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0)],Ce),g(b,S)},$=b=>{var S=he(),F=V(S);{var z=J=>{var te=zs(),oe=v(u(te),2),ne=u(oe);L(()=>_(ne,`${en[t().status.spellCategory]??""}魔法`)),g(J,te)},ae=J=>{var te=he(),oe=V(te);{var ne=M=>{var E=js(),U=v(u(E),2),T=u(U);L(()=>_(T,`${tn[t().status.trapCategory]??""}罠`)),g(M,E)};R(oe,M=>{t().status.kind==="Trap"&&t().status.trapCategory&&M(ne)},!0)}g(J,te)};R(F,J=>{t().status.kind==="Spell"&&t().status.spellCategory?J(z):J(ae,!1)},!0)}g(b,S)};R(B,b=>{t().status.kind==="Monster"?b(W):b($,!1)})}var j=v(B,2);{var ie=b=>{var S=Gs(),F=u(S),z=u(F),ae=v(F,2),J=u(ae);L(()=>{_(z,`◀ ${t().psL??""}`),_(J,`${t().psR??""} ▶`)}),g(b,S)};R(j,b=>{var S;(S=t().status.monsterCategories)!=null&&S.includes("Pendulum")&&b(ie)})}var K=v(j,2);{var Y=b=>{var S=Vs(),F=V(S),z=u(F),ae=u(z),J=v(F,2),te=u(J),oe=u(te),ne=v(te,2),M=u(ne);L((E,U,T)=>{St(z,"title",E),_(ae,U),_(oe,T),_(M,`${t().atk??"?"} / ${t().def??"?"}`)},[()=>{var E;return(E=t().status.monsterCategories)==null?void 0:E.join(" ")},()=>{var E;return(E=t().status.monsterCategories)==null?void 0:E.map(U=>Jt[U]+(s()?_n[U]:"")).join()},()=>t().type.map(E=>nn[E]+(s()?Fn[E]:"")).join()],Ce),g(b,S)};R(K,b=>{t().status.kind==="Monster"&&b(Y)})}L(b=>{we(I,`duel_card button_style_reset ${t().status.kind??""} ${b??""} ${(o(m)?"duel_card_selected":"")??""} ${i()??""} duel_card_${t().orientation??""} ${(o(c)?"isDragging":"")??""} ${(s()?"duel_card_wide":"")??""} svelte-3b34fd`),St(I,"draggable",i()==="Draggable"),St(I,"title",t().nm),_(De,t().nm)},[()=>{var b;return((b=t().status.monsterCategories)==null?void 0:b.join(" "))||""}],Ce),ye("dragstart",I,C),ye("dragend",I,H),ye("click",I,y),ye("dblclick",I,h),ye("mouseenter",I,D),g(x,I)},X=x=>{var I=Xs();g(x,I)};R(q,x=>{t().face==="FaceUp"||r()||t().controller.seat==="Below"&&t().isUnderControl?x(Z):x(X,!1)})}g(n,P),be()}var Js=N('<div class="phase_display svelte-pz8cwr"><span class="svelte-pz8cwr"> </span> </div>'),eo=N('<div class="lifepoint_display svelte-pz8cwr"><div class="svelte-pz8cwr"> </div> <div class="svelte-pz8cwr"> </div></div>'),to=(n,e,t)=>e(o(t)),no=N('<div class="svelte-pz8cwr"><button class="phase_button svelte-pz8cwr"> </button></div>'),io=N("<div><!></div>"),ao=N('<div class="svelte-pz8cwr"><!></div>'),ro=N("<div><!></div>"),so=N("<!> <!> <!>",1),oo=N('<div style="position: absolute;" class="card_animation_receiver svelte-pz8cwr"><!></div>'),Ao=N('<div style="position: absolute;" class="svelte-pz8cwr"><!></div>'),lo=N('<div style="position: absolute; bottom:0rem" class="svelte-pz8cwr"> </div>'),po=N("<!> <!>",1),co=N('<div class="badge svelte-pz8cwr"> </div>'),ko=N('<div class="card_animation_receiver svelte-pz8cwr"><!></div>'),mo=N("<!> <!> <!> <!>",1),uo=N('<td><div role="listitem"><!></div></td>');function ho(n,e){Ne(e,!1);let t=ce(e,"view",8),i=ce(e,"row",8),a=ce(e,"column",8),r=ce(e,"selectedList",28,()=>[]),s=ve(t().getCell(i(),a()));const p=()=>{Q(s,t().getCell(i(),a()))};o(s).onUpdate.append(p),t().onDuelUpdate.append(p),t().modalController.onUpdate.append(p);let d=ve([]),l=()=>{},m;const f=B=>{Q(C,void 0),r().reset(),l=B.resolve,Q(d,B.enableActions),m=B.selectableEntities,B.entitiesValidator};t().onWaitStart.append(f);let k,w=ve(!1);const c=B=>{k=B,Q(w,B.some(W=>{var $;return($=W.validate())==null?void 0:$.includes(o(s))})||!1),p()},h=()=>{k=void 0,Q(w,!1),p()};t().onDragStart.append(c),t().onDragEnd.append(h);const[D,y]=Vo;let C=ve(void 0);const H=B=>{if(o(s)===B.to||o(s).entities.includes(B.entity)){Q(C,B);const W=B.resolve;Q(s,o(s)),setTimeout(()=>{Q(C,void 0),B.count++,B.count>1&&W()},600)}};t().onAnimation.append(H);const P=B=>{console.info(B),l({phaseChange:B})},q=()=>(o(s).cellType==="Deck"||o(s).cellType==="ExtraDeck"||o(s).cellType==="Graveyard"||o(s).cellType==="Banished")&&o(s).entities.flatMap(B=>B.actions).filter(B=>o(d).map(W=>W.seq).some(W=>W===B.seq)).length>0,Z=()=>{if(Fe(s,o(s).field.duel.view.infoBoardState="Log"),o(s).cellType==="Deck"||o(s).cellType==="ExtraDeck"||o(s).cellType==="Graveyard"||o(s).cellType==="Banished"){Fe(s,o(s).field.duel.view.infoBoardState="CellInfo"),Fe(s,o(s).field.duel.view.infoBoardCell=o(s)),o(s).field.duel.view.requireUpdate();const B=o(s).entities.flatMap(W=>W.actions).filter(W=>o(d).map($=>$.seq).some($=>$===W.seq));if(console.log(o(d)),console.log(B),B.length){const W=o(s).field.duel.view;W.modalController.selectAction(W,{title:"カードを選択。",actions:B,cancelable:!0}).then($=>{l({actionWIP:$})});return}}o(s).field.duel.view.requireUpdate(),console.info(o(s))},X=B=>{B.preventDefault(),B.dataTransfer&&(B.dataTransfer.dropEffect="move")},x=B=>{B.preventDefault(),console.info("drop",B,o(w),k),B.dataTransfer&&(B.dataTransfer.dropEffect="move");try{o(w)&&k&&(console.info(k,o(s)),k.length===1?l({actionWIP:{...k[0],cell:o(s)}}):k.length>1&&(o(s).field.duel.view.modalController.cancelAll(),o(s).field.duel.view.modalController.selectAction(o(s).field.duel.view,{title:"選択",actions:k,cancelable:!1})))}finally{t().removeDraggingActions()}},I=(...B)=>{if(m&&m.find(j=>B.find(ie=>j===ie)))return"Selectable";if(!o(d)||o(d).length===0||t().waitMode!=="SelectFieldAction"||Object.values(t().modalController.states).some(j=>j==="Shown"))return"Disabled";const W=o(d).filter(j=>B.includes(j.entity));if(W.length===0)return"Disabled";if(W.length>1)return"Clickable";if(o(d)[0].playType==="RuleDraw")return"Draggable";if(["Deck","ExtraDeck","Graveyard","Banished"].includes(o(s).cellType)||W[0].entity!==B[0])return"Clickable";const $=W[0].validate();return $&&$.length>0?"Draggable":"Clickable"};Le();var ee=uo(),Ae=u(ee);Ae.__click=Z;var ue=u(Ae);{var De=B=>{var W=he(),$=V(W);{var j=ie=>{var K=he(),Y=V(K);{var b=F=>{var z=Js(),ae=u(z),J=u(ae),te=v(ae,1,!0);L((oe,ne)=>{_(J,oe),_(te,ne)},[()=>String(o(s).field.duel.clock.turn).padStart(2,"0"),()=>o(s).field.duel.phase.toUpperCase()],Ce),g(F,z)},S=F=>{var z=he(),ae=V(z);{var J=oe=>{var ne=eo(),M=u(ne),E=u(M),U=v(M,2),T=u(U);L(()=>{_(E,o(s).field.duel.duelists.Above.lp),_(T,o(s).field.duel.duelists.Below.lp)}),g(oe,ne)},te=oe=>{var ne=he(),M=V(ne);{var E=U=>{var T=he(),O=V(T);{var se=le=>{var Oe=he(),mt=V(Oe);{var gt=je=>{var Ge=he(),It=V(Ge);me(It,1,()=>t().duel.nextPhaseList,ke,(Zt,Bt)=>{var it=no(),Ze=u(it);Ze.__click=[to,P,Bt];var Et=u(Ze);L(xt=>_(Et,xt),[()=>o(Bt).toUpperCase()],Ce),g(Zt,it)}),g(je,Ge)};R(mt,je=>{t().duel.isEnded||je(gt)})}g(le,Oe)};R(O,le=>{t().waitMode==="SelectFieldAction"&&le(se)})}g(U,T)};R(M,U=>{o(s).column===5&&U(E)},!0)}g(oe,ne)};R(ae,oe=>{o(s).column===3?oe(J):oe(te,!1)},!0)}g(F,z)};R(Y,F=>{o(s).column===1?F(b):F(S,!1)})}g(ie,K)};R($,ie=>{o(s).row===3&&ie(j)})}g(B,W)},G=B=>{var W=he(),$=V(W);{var j=K=>{var Y=so(),b=V(Y);{var S=J=>{var te=io(),oe=u(te);Qe(oe,{get entity(){return o(C).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),L(()=>we(te,`card_animation_receiver ${o(s).cellType??""} svelte-pz8cwr`)),Nt(1,te,()=>y,()=>({key:o(C).entity.seq})),g(J,te)};R(b,J=>{o(C)&&o(C).entity&&o(C).to===o(s)&&o(C).index==="Top"&&J(S)})}var F=v(b,2);me(F,1,()=>o(s).cardEntities,ke,(J,te)=>{var oe=he(),ne=V(oe);{var M=E=>{var U=ao(),T=u(U);const O=Ce(()=>I(o(te))),se=Ce(()=>o(d).filter(le=>le.entity===o(te)));Qe(T,{get entity(){return o(te)},get state(){return o(O)},get actions(){return o(se)},cardActionResolve:void 0,get selectedList(){return r()},set selectedList(le){r(le)},$$legacy:!0}),Nt(2,U,()=>D,()=>({key:o(te).seq})),g(E,U)};R(ne,E=>{(!o(C)||o(C).entity.seq!==o(te).seq)&&E(M)})}g(J,oe)});var z=v(F,2);{var ae=J=>{var te=ro(),oe=u(te);Qe(oe,{get entity(){return o(C).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),L(()=>we(te,`card_animation_receiver ${o(s).cellType??""} svelte-pz8cwr`)),Nt(1,te,()=>y,()=>({key:o(C).entity.seq})),g(J,te)};R(z,J=>{o(C)&&o(C).entity&&o(C).to===o(s)&&o(C).index==="Bottom"&&J(ae)})}g(K,Y)},ie=K=>{var Y=mo(),b=V(Y);{var S=ne=>{var M=oo(),E=u(M);Qe(E,{get entity(){return o(C).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Nt(1,M,()=>y,()=>({key:o(C).entity.seq})),g(ne,M)};R(b,ne=>{o(C)&&o(C).entity&&o(C).to===o(s)&&o(C).index==="Bottom"&&ne(S)})}var F=v(b,2);{var z=ne=>{var M=po(),E=V(M);me(E,1,()=>o(s).cardEntities.toReversed(),ke,(O,se,le)=>{var Oe=he(),mt=V(Oe);{var gt=je=>{var Ge=Ao(),It=u(Ge);const Zt=Ce(()=>le===0?I(...o(s).cardEntities):void 0),Bt=Ce(()=>le===0?o(d).filter(it=>o(s).cardEntities.includes(it.entity)):void 0);Qe(It,{get entity(){return o(se)},get state(){return o(Zt)},get actions(){return o(Bt)},cardActionResolve:void 0,get selectedList(){return r()},set selectedList(it){r(it)},$$legacy:!0}),Nt(2,Ge,()=>D,()=>({key:o(se).seq})),g(je,Ge)};R(mt,je=>{(!o(C)||o(C).entity.seq!==o(se).seq)&&je(gt)})}g(O,Oe)});var U=v(E,2);{var T=O=>{var se=lo(),le=u(se);L(()=>_(le,`【${(o(s).cardEntities[0].battlePotion==="Attack"?"攻撃表示":o(s).cardEntities[0].battlePotion==="Defense"?"表守備表示":"裏守備表示")??""}】`)),g(O,se)};R(U,O=>{o(s).cardEntities[0].battlePotion&&O(T)})}g(ne,M)};R(F,ne=>{o(s).cardEntities.length>0&&ne(z)})}var ae=v(F,2);{var J=ne=>{var M=co(),E=u(M);L(()=>_(E,o(s).cardEntities.length)),g(ne,M)};R(ae,ne=>{(o(s).cellType==="Deck"||o(s).cellType==="ExtraDeck"||o(s).cellType==="Graveyard"||o(s).cellType==="Banished")&&ne(J)})}var te=v(ae,2);{var oe=ne=>{var M=ko(),E=u(M);Qe(E,{get entity(){return o(C).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Nt(1,M,()=>y,()=>({key:o(C).entity.seq})),g(ne,M)};R(te,ne=>{o(C)&&o(C).entity&&o(C).to===o(s)&&o(C).index==="Top"&&ne(oe)})}g(K,Y)};R($,K=>{o(s).cellType==="Hand"?K(j):K(ie,!1)},!0)}g(B,W)};R(ue,B=>{o(s).cellType==="Disable"?B(De):B(G,!1)})}L(B=>{we(ee,`${`duel_field_cell duel_field_cell_${o(s).cellType}`??""} svelte-pz8cwr`),St(ee,"colspan",o(s).cellType==="Hand"?7:1),we(Ae,`${B??""} svelte-pz8cwr`)},[()=>`duel_card_wrapper ${o(s).cellType} ${o(w)?"can_accept_drop":""} ${q()?"can_action":""}`],Ce),ye("dragover",Ae,B=>X(B)),ye("drop",Ae,B=>x(B)),g(n,ee),be()}di(["click"]);var wo=N('<tr><td style=" white-space: nowrap;text-align: center;"> </td><td class="svelte-13svkzh"> </td></tr>'),fo=N('<div class="duel_log svelte-13svkzh"><table><tbody></tbody></table></div>');function Co(n,e){var d,l;Ne(e,!1);let t=ve(void 0),i=ce(e,"log",12);const a=()=>{i(i()),Hr().then(()=>o(t)&&o(t).scroll(0,o(t).clientHeight*10))};(l=(d=i())==null?void 0:d.onUpdate)==null||l.append(a),Le();var r=fo(),s=u(r),p=u(s);me(p,5,()=>i().records,ke,(m,f)=>{var k=wo(),w=u(k),c=u(w),h=v(w),D=u(h);L(()=>{var y,C;we(w,`duelist ${((y=o(f).duelist)==null?void 0:y.seat)??""} svelte-13svkzh`),_(c,((C=o(f).duelist)==null?void 0:C.profile.name)||"SYSTEM"),_(D,o(f).text)}),g(m,k)}),ss(r,m=>Q(t,m),()=>o(t)),g(n,r),be()}const Do=n=>new Promise(e=>setTimeout(e,n));var vo=N('<div><div class="duelist_name svelte-12u0sqq"> </div> <div> </div></div>');function Li(n,e){Ne(e,!1);let t=ce(e,"duelist",12),i=ve(0),a=ve();const r=async()=>{const k=t().lp-o(i);if(!o(a)||Math.abs(k)<10){Q(i,t().lp),o(a)&&(o(a)(),Q(a,void 0));return}Q(i,o(i)+Math.floor(Math.random()*k)),await Do(100),r()},s=()=>{t(t()),!o(a)&&t().lp!==o(i)&&new Promise(k=>{Q(a,k),Math.abs(t().lp-o(i)),r()})};t().duel.log.onUpdate.append(s),r(),Le();var p=vo(),d=u(p),l=u(d),m=v(d,2),f=u(m);L(()=>{we(p,`duelist ${t().seat??""} svelte-12u0sqq`),_(l,t().profile.name),we(m,`duelist_lp ${(o(a)?"vibration":"")??""} svelte-12u0sqq`),_(f,o(i))}),g(n,p),be()}const yo=()=>{};var go=N("<div><!></div>"),Bo=(n,e,t)=>e.resolve(o(t)),Eo=(n,e)=>e.resolve(void 0),xo=N('<button class="svelte-12javsj">Cancel</button>'),To=N('<div class="base svelte-12javsj"><button class="overlay svelte-12javsj">★</button> <div class="window svelte-12javsj"><div> </div> <div class="entities_list svelte-12javsj"></div> <div><button class="svelte-12javsj">OK</button> <!></div></div></div>');function Mo(n,e){Ne(e,!0);let t=mr(At([]));var i=he(),a=V(i);{var r=s=>{var p=To(),d=u(p);d.__click=[yo];var l=v(d,2),m=u(l),f=u(m),k=v(m,2);me(k,21,()=>e.entities,ke,(y,C)=>{var H=go(),P=u(H);Qe(P,{get entity(){return o(C)},isVisibleForcibly:!0,state:"Selectable",entitySelectResolve:q=>e.resolve(q),get qty(){return e.qty},cardActionResolve:void 0,get selectedList(){return o(t)},set selectedList(q){Q(t,At(q))}}),g(y,H)});var w=v(k,2),c=u(w);c.__click=[Bo,e,t];var h=v(c,2);{var D=y=>{var C=xo();C.__click=[Eo,e],g(y,C)};R(h,y=>{e.cancelable&&y(D)})}L(y=>{_(f,e.title),c.disabled=y},[()=>!e.validator(o(t))]),g(s,p)};R(a,s=>{s(r)})}g(n,i),be()}di(["click"]);const No=(n,e)=>{e.cancelable&&e.resolve(void 0)};var bo=N('<div class="duel_card_wrapper svelte-11mc7y0"><!> <div> </div></div>'),_o=(n,e)=>e.resolve(),Fo=N('<div><button class="cancel_button svelte-11mc7y0">Cancel</button></div>'),Ho=N('<div><button>★</button> <div><div> </div> <div class="flex svelte-11mc7y0"></div> <!></div></div>');function Ko(n,e){Ne(e,!0);const[t,i]=ds(),a=()=>ls(r,"$isDragging",t);let r=os(!1);const s=()=>r.set(!0),p=()=>r.set(!1);e.view.onDragStart.append(s),e.view.onDragEnd.append(p);const d=k=>{const w=k.validate();return w&&w.length>0?"Draggable":"Clickable"};var l=he(),m=V(l);{var f=k=>{var w=Ho(),c=u(w);c.__click=[No,e];var h=v(c,2),D=u(h),y=u(D),C=v(D,2);me(C,21,()=>e.actions,ke,(q,Z)=>{var X=bo(),x=u(X);const I=Dt(()=>d(o(Z))),ee=Dt(()=>e.dragAndDropOnly?[]:[o(Z)]);Qe(x,{get entity(){return o(Z).entity},isVisibleForcibly:!0,get state(){return o(I)},get actions(){return o(ee)},get cardActionResolve(){return e.resolve}});var Ae=v(x,2),ue=u(Ae);L(()=>_(ue,`«${o(Z).title??""}»`)),g(q,X)});var H=v(C,2);{var P=q=>{var Z=Fo(),X=u(Z);X.__click=[_o,e],g(q,Z)};R(H,q=>{e.cancelable&&q(P)})}L(()=>{we(w,`${`base ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(c,`${`overlay ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(h,`${`window ${a()?"minimum_mode":""}`??""} svelte-11mc7y0`),_(y,e.title)}),g(k,w)};R(m,k=>{k(f)})}g(n,l),be(),i()}di(["click"]);var So=N('<div class="base svelte-1y912d"><!> <!></div>');function Wo(n,e){var l,m;Ne(e,!1);let t=ce(e,"modalController",12);const i=()=>{t(t())};(m=(l=t())==null?void 0:l.onUpdate)==null||m.append(i),Le();var a=So(),r=u(a);{var s=f=>{Mo(f,{get title(){return t().duelEntitiesSelectorArg.title},get entities(){return t().duelEntitiesSelectorArg.entities},get validator(){return t().duelEntitiesSelectorArg.validator},get qty(){return t().duelEntitiesSelectorArg.qty},get cancelable(){return t().duelEntitiesSelectorArg.cancelable},resolve:k=>{t().duelEntitiesSelectorResolve(k)}})};R(r,f=>{t().states.DuelEntitiesSelector==="Shown"&&f(s)})}var p=v(r,2);{var d=f=>{const k=Ce(()=>t().cardActionSelectorArg.dragAndDropOnly??!1);Ko(f,{get view(){return t().view},get title(){return t().cardActionSelectorArg.title},get actions(){return t().cardActionSelectorArg.actions},get dragAndDropOnly(){return o(k)},get cancelable(){return t().cardActionSelectorArg.cancelable},resolve:w=>{console.info(w),t().cardActionSelectorResolve(w)}})};R(p,f=>{t().states.DuelActionSelector==="Shown"&&f(d)})}g(n,a),be()}var Po=N('<div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div> <div class="duel_card_info_row svelte-1qhzdl0" style=" justify-content: space-between;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div>',1),qo=N('<div></div> <div class="svelte-1qhzdl0"> </div>',1),Lo=N("<div> </div>"),Ro=N("<div> </div>"),Oo=N('<div class="duel_card_info_row svelte-1qhzdl0"><!> <!></div> <div class="duel_card_info_row svelte-1qhzdl0"></div>',1),Io=N('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),Zo=N('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),Uo=N('<div><div class="duel_card_info_header svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"> </div></div> <div class="duel_card_info_row svelte-1qhzdl0" style="position:sticky; top:0;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div> <!> <!></div> <div class="duel_card_info_body svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div></div> <div class="duel_card_info_footer svelte-1qhzdl0"><div class="duel_card_info_links svelte-1qhzdl0"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1qhzdl0">⇒遊戯王カードWiki</a></div></div></div>');function $o(n,e){Ne(e,!1);let t=ce(e,"entity",8,void 0);const i=()=>t()?Te[t().origin.name]:void 0;Le();var a=he(),r=V(a);{var s=p=>{var d=Uo(),l=u(d),m=u(l),f=u(m),k=u(f),w=v(m,2),c=u(w),h=u(c),D=v(c,2),y=u(D),C=v(w,2);{var H=B=>{var W=Po(),$=V(W),j=u($),ie=u(j),K=u(ie),Y=v($,2),b=u(Y),S=u(b),F=v(b,2),z=u(F);L(()=>{_(K,Te[t().origin.name].pendulumDescription),_(S,`◀ ${t().psL??""}`),_(z,`${t().psR??""} ▶`)}),g(B,W)};R(C,B=>{var W;(W=t().status.monsterCategories)!=null&&W.includes("Pendulum")&&B(H)})}var P=v(C,2);{var q=B=>{var W=Oo(),$=V(W),j=u($);me(j,1,()=>t().attr,ke,(b,S)=>{var F=qo(),z=V(F),ae=v(z,2),J=u(ae);L(()=>{we(z,`monster_attr ${o(S)??""} svelte-1qhzdl0`),_(J,`${ci[o(S)]??""}属性`)}),g(b,F)});var ie=v(j,2);{var K=b=>{var S=Lo(),F=u(S);L(()=>{we(S,`monster_cat ${t().status.type??""} svelte-1qhzdl0`),_(F,`${nn[t().status.type]??""}${Fn[t().status.type]??""}族`)}),g(b,S)};R(ie,b=>{t().status.type&&b(K)})}var Y=v($,2);me(Y,5,()=>t().status.monsterCategories??[],ke,(b,S)=>{var F=Ro(),z=u(F);L(()=>{we(F,`monster_cat ${o(S)??""} svelte-1qhzdl0`),_(z,`${Jt[o(S)]??""}${_n[o(S)]??""}`)}),g(b,F)}),g(B,W)},Z=B=>{var W=he(),$=V(W);{var j=K=>{var Y=Io(),b=v(u(Y),2),S=u(b);L(()=>_(S,`${en[t().status.spellCategory]??""}魔法`)),g(K,Y)},ie=K=>{var Y=he(),b=V(Y);{var S=F=>{var z=Zo(),ae=v(u(z),2),J=u(ae);L(()=>_(J,`${tn[t().status.trapCategory]??""}罠`)),g(F,z)};R(b,F=>{t().status.kind==="Trap"&&t().status.trapCategory&&F(S)},!0)}g(K,Y)};R($,K=>{t().status.kind==="Spell"&&t().status.spellCategory?K(j):K(ie,!1)},!0)}g(B,W)};R(P,B=>{t().status.kind==="Monster"?B(q):B(Z,!1)})}var X=v(l,2),x=u(X),I=u(x),ee=u(I),Ae=u(ee),ue=v(X,2),De=u(ue),G=u(De);L((B,W,$,j,ie)=>{we(d,`duel_card duel_card_info ${t().origin.kind??""} ${B??""} svelte-1qhzdl0`),_(k,t().nm),_(h,W),_(y,$),_(Ae,j),St(G,"href",ie)},[()=>{var B;return(B=t().origin.monsterCategories)==null?void 0:B.join(" ")},()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0),()=>{var B;return(B=i())==null?void 0:B.description},()=>{var B;return(B=i())==null?void 0:B.wikiHref}],Ce),g(p,d)};R(r,p=>{t()&&p(s)})}g(n,a),be()}var Yo=N('<div class="duel_field_cell_info_item svelte-1xj7qf1"><!></div>'),zo=N('<div class="duel_field_cell_info_box svelte-1xj7qf1"><div class="duel_field_cell_info_label svelte-1xj7qf1"> </div> <!></div>'),jo=N('<div class="duel_field_cell_info svelte-1xj7qf1"><div class="duel_field_cell_info_header item_btn svelte-1xj7qf1"><div class="svelte-1xj7qf1"> </div> <div class="svelte-1xj7qf1"> </div></div> <div class="duel_field_cell_info_body svelte-1xj7qf1"></div></div>');function Go(n,e){Ne(e,!1);let t=ce(e,"cell",12);const i=()=>{t(t())},a=k=>t().cardEntities.filter(w=>w.face===k);t().field.duel.view.onDuelUpdate.append(i),Le();var r=jo(),s=u(r),p=u(s),d=u(p),l=v(p,2),m=u(l),f=v(s,2);me(f,4,()=>["FaceUp","FaceDown"],ke,(k,w)=>{var c=he(),h=V(c);{var D=y=>{var C=zo(),H=u(C),P=u(H),q=v(H,2);me(q,1,()=>a(w).toSorted(Ps),ke,(Z,X)=>{var x=Yo(),I=u(x);const ee=Ce(()=>t().owner===t().field.duel.duelists.Below);Qe(I,{get entity(){return o(X)},get isVisibleForcibly(){return o(ee)},isWideMode:!0,cardActionResolve:void 0}),g(Z,x)}),L(()=>_(P,w==="FaceUp"?"表向き":"裏向き")),g(y,C)};R(h,y=>{a(w).length&&y(D)})}g(k,c)}),L(()=>{var k;_(d,(k=t().owner)==null?void 0:k.profile.name),_(m,t().cellType)}),g(n,r),be()}const Vo=Us({duration:400});var Qo=N('<div class="duel_field_header_message svelte-accyye"> </div> <div class="duel_field_header_buttons svelte-accyye"><button class="svelte-accyye">サレンダー</button></div>',1),Xo=N("<tr></tr>"),Jo=N('<table class="duel_field svelte-accyye"><tbody class="svelte-accyye"></tbody></table>'),eA=N('<button class="svelte-accyye">OK</button>'),tA=N('<div style="position:absolute;right:0;top:0"> </div> <div class="flex duel_desk svelte-accyye"><div class="duel_desk_left v_flex svelte-accyye"><!> <!> <!></div> <div class=" duel_desk_center v_flex svelte-accyye"><div class="duel_field_header svelte-accyye"><!></div> <div class="svelte-accyye"><!></div> <div class="duel_field_footer svelte-accyye"><!></div></div> <div class=" duel_desk_right svelte-accyye" style="text-align: left;"><!></div></div> <!>',1);function nA(n,e){Ne(e,!1);let t=ce(e,"duel",12),i=()=>{},a=ve(()=>!0),r=ve();const s=K=>{i=K.resolve,Q(a,K.entitiesValidator),Q(r,K.selectableEntities),K.duelEntitiesSelectorArg&&t().view.modalController.selectDuelEntities(K.duelEntitiesSelectorArg).then(Y=>{i({selectedEntities:Y})})};t().view.onWaitStart.append(s);let p=ve(void 0);const d=K=>{Q(p,K)};t().view.onShowCardEntity.append(d);let l=ce(e,"selectedList",28,()=>[]);const m=()=>{t(t())};t().view.onDuelUpdate.append(m);const f=()=>{o(a)(l())&&i({selectedEntities:l()})},k=()=>{i({surrender:!0})};t().main(),Le();var w=tA(),c=V(w),h=u(c),D=v(c,2),y=u(D),C=u(y);Li(C,{get duelist(){return t().duelists.Above}});var H=v(C,2);$o(H,{get entity(){return o(p)}});var P=v(H,2);Li(P,{get duelist(){return t().duelists.Below}});var q=v(y,2),Z=u(q),X=u(Z);{var x=K=>{var Y=Qo(),b=V(Y),S=u(b),F=v(b,2),z=u(F);L(()=>_(S,`[TURN:${t().clock.turn}][PHASE:${t().phase}] ${t().view.message}`)),ye("click",z,k),g(K,Y)};R(X,K=>{t().isEnded||K(x)})}var I=v(Z,2),ee=u(I);{var Ae=K=>{var Y=Jo(),b=u(Y);me(b,5,()=>t().field.cells,ke,(S,F,z)=>{var ae=Xo();we(ae,`${`duel_desk_row_${z}`??""} svelte-accyye`),me(ae,5,()=>o(F),ke,(J,te,oe)=>{ho(J,{get view(){return t().view},row:z,column:oe,get selectedList(){return l()},set selectedList(ne){l(ne)},$$legacy:!0})}),g(S,ae)}),g(K,Y)};R(ee,K=>{t().clock.turn>0&&K(Ae)})}var ue=v(I,2),De=u(ue);{var G=K=>{var Y=eA();L(b=>Y.disabled=b,[()=>!o(a)(l())],Ce),ye("click",Y,f),g(K,Y)};R(De,K=>{o(r)&&o(r).length>0&&K(G)})}var B=v(q,2),W=u(B);{var $=K=>{Co(K,{get log(){return t().log}})},j=K=>{var Y=he(),b=V(Y);{var S=F=>{Go(F,{get cell(){return t().view.infoBoardCell}})};R(b,F=>{t().view.infoBoardState==="CellInfo"&&F(S)},!0)}g(K,Y)};R(W,K=>{t().view.infoBoardState==="Log"?K($):K(j,!1)})}var ie=v(D,2);Wo(ie,{get modalController(){return t().view.modalController}}),L(K=>_(h,K),[()=>t().clock.toString()],Ce),g(n,w),be()}var iA=N("<div></div>"),aA=N('<span> </span> / <span style="display: inline-block;width:2rem;text-align: right;"> </span>',1),rA=N('<li class="deck_editor_item svelte-vivzk2"><div role="listitem"><div class="svelte-vivzk2"><div class="svelte-vivzk2"> </div> <div style="display:flex" class="svelte-vivzk2"><div class="svelte-vivzk2"><!> <!> <!> <!> <!> <!> <!></div> <div style="flex-grow: 1; width:0.1rem" class="svelte-vivzk2"></div> <div class="svelte-vivzk2"><!></div></div></div></div> <button class="button_style_reset svelte-vivzk2">+</button> <button class="button_style_reset svelte-vivzk2">-</button></li>'),sA=N('<div class="deck_editor_card_kind svelte-vivzk2"><span class="svelte-vivzk2"> </span> <ul class="svelte-vivzk2"></ul></div>'),oA=N('<div class="deck_editor_deck_type svelte-vivzk2"><span class="svelte-vivzk2"> </span> <!></div>'),AA=N('<div class="deck_editor_card_list svelte-vivzk2"></div>');function Ri(n,e){Ne(e,!1);let t=ce(e,"allCardInfos",8),i=ce(e,"deckCardInfos",12),a=ce(e,"mode",8),r=ce(e,"onAttention",8);const s={Deck:["Monster","Spell","Trap"],ExtraDeck:["Monster"]},p=(f,k)=>(a()==="List"?t():i()).filter(w=>{var c;return Vn.has(w.name)||((c=w.monsterCategories)==null?void 0:c.includes("Normal"))}).filter(w=>!k||w.kind===k).filter(w=>{var c,h;return!f||f==="Deck"&&!((c=w==null?void 0:w.monsterCategories)!=null&&c.union(Gt).length)||f==="ExtraDeck"&&((h=w==null?void 0:w.monsterCategories)==null?void 0:h.union(Gt).length)}).toSorted(pn),d=(f,k)=>{const w=i().filter(h=>h.name===k.name).length;if(w>2)return;const c=f.shiftKey?3-w:1;c<1||(i().push(...Array(c).fill(k)),i().sort(pn),i(i()))},l=(f,k)=>{let w=0;i(i().filter(c=>c.name!==k.name?!0:(w++,!f.shiftKey&&w>1))),i().sort(pn)};Le();var m=AA();me(m,5,()=>us,ke,(f,k)=>{var w=oA(),c=u(w),h=u(c),D=v(c,2);me(D,1,()=>s[o(k)],ke,(y,C)=>{var H=sA(),P=u(H),q=u(P),Z=v(P,2);me(Z,5,()=>p(o(k),o(C)),ke,(X,x)=>{var I=rA(),ee=u(I),Ae=u(ee),ue=u(Ae),De=u(ue),G=v(ue,2),B=u(G),W=u(B);{var $=T=>{var O=Tt();L(()=>_(O,`★${o(x).level??""}`)),g(T,O)};R(W,T=>{o(x).level&&T($)})}var j=v(W,2);{var ie=T=>{var O=Tt();L(()=>_(O,`☆${o(x).rank??""}`)),g(T,O)};R(j,T=>{o(x).rank&&T(ie)})}var K=v(j,2);{var Y=T=>{var O=iA();L(()=>we(O,`monster_attr ${o(x).attribute??""} svelte-vivzk2`)),g(T,O)};R(K,T=>{o(x).attribute!==void 0&&T(Y)})}var b=v(K,2);{var S=T=>{var O=Tt();L(()=>_(O,nn[o(x).type])),g(T,O)};R(b,T=>{o(x).type!==void 0&&T(S)})}var F=v(b,2);me(F,1,()=>o(x).monsterCategories??[],ke,(T,O)=>{var se=Tt();L(()=>_(se,Jt[o(O)])),g(T,se)});var z=v(F,2);{var ae=T=>{var O=Tt();L(()=>_(O,`${en[o(x).spellCategory]??""}魔法`)),g(T,O)};R(z,T=>{o(x).spellCategory!==void 0&&T(ae)})}var J=v(z,2);{var te=T=>{var O=Tt();L(()=>_(O,`${tn[o(x).trapCategory]??""}罠`)),g(T,O)};R(J,T=>{o(x).trapCategory!==void 0&&T(te)})}var oe=v(B,4),ne=u(oe);{var M=T=>{var O=aA(),se=V(O),le=u(se),Oe=v(se,2),mt=u(Oe);L(()=>{_(le,o(x).attack),_(mt,o(x).defense??"-")}),g(T,O)};R(ne,T=>{o(x).attack!==void 0&&T(M)})}var E=v(ee,2),U=v(E,2);L(T=>{we(ee,`${T??""} svelte-vivzk2`),_(De,o(x).name)},[()=>{var T,O;return`deck_editor_card duel_card ${o(x).kind} ${(O=(T=o(x))==null?void 0:T.monsterCategories)==null?void 0:O.join(" ")} ${Vn.has(o(x).name)?"is_implemented":"is_not_implemented"}`}],Ce),ye("mouseenter",ee,()=>r()(o(x))),ye("click",E,T=>d(T,o(x))),ye("click",U,T=>l(T,o(x))),g(X,I)}),L(()=>_(q,Ba[o(C)])),g(y,H)}),L(()=>_(h,hs[o(k)])),g(f,w)}),g(n,m),be()}var lA=N('<div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_row svelte-1xf9hqi" style=" justify-content: space-between;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div>',1),dA=N('<div></div> <div class="svelte-1xf9hqi"> </div>',1),pA=N("<div> </div>"),cA=N("<div> </div>"),kA=N('<div class="duel_card_info_row svelte-1xf9hqi"><!> <!></div> <div class="duel_card_info_row svelte-1xf9hqi"></div>',1),mA=N('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),uA=N('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),hA=N('<div><div class="duel_card_info_header svelte-1xf9hqi"><div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"> </div></div> <div class="duel_card_info_row svelte-1xf9hqi" style="position:sticky; top:0;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div></div> <div class="duel_card_info_body svelte-1xf9hqi"><!> <!> <div class="duel_card_info_row description svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_links svelte-1xf9hqi"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1xf9hqi">⇒遊戯王カードWiki</a></div></div></div>');function wA(n,e){Ne(e,!1);let t=ce(e,"cardInfo",8,void 0);const i=()=>t()?Te[t().name]:void 0;Le();var a=he(),r=V(a);{var s=p=>{var d=hA(),l=u(d),m=u(l),f=u(m),k=u(f),w=v(m,2),c=u(w),h=u(c),D=v(c,2),y=u(D),C=v(l,2),H=u(C);{var P=G=>{var B=lA(),W=V(B),$=u(W),j=u($),ie=u(j),K=v(W,2),Y=u(K),b=u(Y),S=v(Y,2),F=u(S);L(()=>{_(ie,Te[t().name].pendulumDescription),_(b,`◀ ${t().pendulumScaleL??""}`),_(F,`${t().pendulumScaleR??""} ▶`)}),g(G,B)};R(H,G=>{var B;(B=t().monsterCategories)!=null&&B.includes("Pendulum")&&G(P)})}var q=v(H,2);{var Z=G=>{var B=kA(),W=V(B),$=u(W);{var j=b=>{var S=dA(),F=V(S),z=v(F,2),ae=u(z);L(()=>{we(F,`monster_attr ${t().attribute??""} svelte-1xf9hqi`),_(ae,`${ci[t().attribute]??""}属性`)}),g(b,S)};R($,b=>{t().attribute&&b(j)})}var ie=v($,2);{var K=b=>{var S=pA(),F=u(S);L(()=>{we(S,`monster_cat ${t().type??""} svelte-1xf9hqi`),_(F,`${nn[t().type]??""}${Fn[t().type]??""}族`)}),g(b,S)};R(ie,b=>{t().type&&b(K)})}var Y=v(W,2);me(Y,5,()=>t().monsterCategories??[],ke,(b,S)=>{var F=cA(),z=u(F);L(()=>{we(F,`monster_cat ${o(S)??""} svelte-1xf9hqi`),_(z,`${Jt[o(S)]??""}${_n[o(S)]??""}`)}),g(b,F)}),g(G,B)},X=G=>{var B=he(),W=V(B);{var $=ie=>{var K=mA(),Y=v(u(K),2),b=u(Y);L(()=>_(b,`${en[t().spellCategory]??""}魔法`)),g(ie,K)},j=ie=>{var K=he(),Y=V(K);{var b=S=>{var F=uA(),z=v(u(F),2),ae=u(z);L(()=>_(ae,`${tn[t().trapCategory]??""}罠`)),g(S,F)};R(Y,S=>{t().kind==="Trap"&&t().trapCategory&&S(b)},!0)}g(ie,K)};R(W,ie=>{t().kind==="Spell"&&t().spellCategory?ie($):ie(j,!1)},!0)}g(G,B)};R(q,G=>{t().kind==="Monster"?G(Z):G(X,!1)})}var x=v(q,2),I=u(x),ee=u(I),Ae=u(ee),ue=v(x,2),De=u(ue);L((G,B,W,$,j)=>{we(d,`duel_card duel_card_info ${t().kind??""} ${G??""} svelte-1xf9hqi`),_(k,t().name),_(h,B),_(y,W),_(Ae,$),St(De,"href",j)},[()=>{var G;return(G=t().monsterCategories)==null?void 0:G.join(" ")},()=>"★".repeat(t().level||0),()=>"☆".repeat(t().rank||0),()=>{var G;return(G=i())==null?void 0:G.description},()=>{var G;return(G=i())==null?void 0:G.wikiHref}],Ce),g(p,d)};R(r,p=>{t()&&p(s)})}g(n,a),be()}const fA={0:{aaa:"日",aaaa:"日曜日",ddd:"Sun",dddd:"Sunday"},1:{aaa:"月",aaaa:"月曜日",ddd:"Mon",dddd:"Monday"},2:{aaa:"火",aaaa:"火曜日",ddd:"Tue",dddd:"Tuesday"},3:{aaa:"水",aaaa:"水曜日",ddd:"Wed",dddd:"Wednesday"},4:{aaa:"木",aaaa:"木曜日",ddd:"Thu",dddd:"Thursday"},5:{aaa:"金",aaaa:"金曜日",ddd:"Fri",dddd:"Friday"},6:{aaa:"土",aaaa:"土曜日",ddd:"Sat",dddd:"Saturday"}};class CA{constructor(){A(this,"DefaultSeparator1","/");A(this,"DefaultSeparator2"," ");A(this,"DefaultSeparator3",":");A(this,"createDate",e=>{if(!e)return;const t=new Date(e);if(!isNaN(t.getTime()))return t});A(this,"createDateOr",(e,t)=>this.createDate(e)||t||new Date);A(this,"truncateDate",e=>{const t=e||new Date;return new Date(t.getFullYear(),t.getMonth(),t.getDate())});A(this,"addDate",(e,t)=>{const i=this.createDateOr(e);return i.setDate(i.getDate()+t),i});A(this,"addMonth",(e,t)=>{const i=this.createDateOr(e);return i.setMonth(i.getMonth()+t),i});A(this,"addYear",(e,t)=>{const i=this.createDateOr(e);return i.setFullYear(i.getFullYear()+t),i});A(this,"getDayOfWeek",(e,t="dddd")=>{const i=this.createDate(e);return i?fA[i.getDay()][t]:""});A(this,"formatToYYYYMMDD",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";const a=i.getFullYear().toString(),r=("0"+(i.getMonth()+1)).slice(-2),s=("0"+i.getDate()).slice(-2);return a+t+r+t+s});A(this,"formatToYYYYMM",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getFullYear().toString(),r=("0"+(i.getMonth()+1)).slice(-2);return a+t+r});A(this,"formatToHHMMSS",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=i.getHours(),r=i.getMinutes(),s=i.getSeconds();return("0"+a).slice(-2)+t+("0"+r).slice(-2)+t+("0"+s).slice(-2)});A(this,"formatToHHMM",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const a=("0"+i.getHours()).slice(-2),r=("0"+i.getMinutes()).slice(-2);return a+t+r});A(this,"formatToYYYYMMDD_HHMM",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const r=this.createDate(e);return r?this.formatToYYYYMMDD(r,t)+i+this.formatToHHMM(r,a):""});A(this,"formatToYYYYMMDD_HHMMSS",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,a=this.DefaultSeparator3)=>{const r=this.createDate(e);return r?this.formatToYYYYMMDD(r,t)+i+this.formatToHHMMSS(r,a):""})}}const Re=new CA;Date.prototype.truncateDate=function(){return Re.truncateDate(this)};Date.prototype.getCloneOr=function(n){return Re.createDateOr(this,n)};Date.prototype.addDate=function(n){return Re.addDate(this,n)};Date.prototype.addMonth=function(n){return Re.addDate(this,n)};Date.prototype.addYear=function(n){return Re.addDate(this,n)};Date.prototype.getDayOfWeek=function(n="dddd"){return Re.getDayOfWeek(this,n)};Date.prototype.formatToYYYYMM=function(n){return Re.formatToYYYYMM(this,n)};Date.prototype.formatToYYYYMMDD=function(n){return Re.formatToYYYYMMDD(this,n)};Date.prototype.formatToYYYYMMDD_HHMM=function(n,e,t){return Re.formatToYYYYMMDD_HHMM(this,n,e,t)};Date.prototype.formatToYYYYMMDD_HHMMSS=function(n,e,t){return Re.formatToYYYYMMDD_HHMMSS(this,n,e,t)};Date.prototype.formatToHHMM=function(n){return Re.formatToHHMM(this,n)};Date.prototype.formatToHHMMSS=function(n){return Re.formatToHHMMSS(this,n)};var DA=N('<label><input type="checkbox"> </label>'),vA=N('<label><input type="checkbox"> </label>'),yA=N('<label><input type="checkbox"> <div style="display: inline-block;"></div> </label>'),gA=N('<label><input type="checkbox"> </label>'),BA=N('<label><input type="checkbox"> </label>'),EA=N('<label><input type="checkbox"> </label>'),xA=N("<option> </option>"),TA=N('<div class="deck_editor_body_right_header svelte-rsq0rf"><div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">編集対象</div> <select></select></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">新規名称</div> <input type="text"></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">操作</div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを保存</button></div> <div class="svelte-rsq0rf"></div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを複製</button></div> <div class="svelte-rsq0rf"><button title="shiftキー押下で確認メッセージスキップ" class="svelte-rsq0rf">デッキを削除</button></div></div></div> <!>',1),MA=N("<div>デッキ情報読込中</div>"),NA=N('<div class="deck_editor svelte-rsq0rf"><div class="deck_editor_header"></div> <div class="deck_editor_body svelte-rsq0rf"><div class="deck_editor_body_left svelte-rsq0rf"><div class="deck_editor_search_box svelte-rsq0rf"><div><div>検索条件</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">名称</div> <div class="svelte-rsq0rf"><input type="text" style="width:70%">※ルビには対応していません</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種類</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">モンスター</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">属性</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種族</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">魔法</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">罠</div> <div class="svelte-rsq0rf"></div></div></div> <!></div> <div class="deck_editor_body_center svelte-rsq0rf"><!></div> <div class="deck_editor_body_right svelte-rsq0rf"><!></div></div></div>');function bA(n,e){Ne(e,!1);const t=[],i=[],a=[],r=[],s=[],p=[],d=async()=>{const E=(await o(f)).find(U=>U.id===o(m));E&&Q(w,{...E,cardInfos:E.cardNames.map(U=>Te[U])})},l=()=>Ct.getAllDeckInfo().then(M=>(M.forEach(E=>console.log(E.id,E.lastUsedAt,E.lastUsedAt.getTime())),console.log(Math.max(...M.map(E=>E.lastUsedAt.getTime()))),Q(m,(M.find(E=>E.lastUsedAt.getTime()===Math.max(...M.map(U=>U.lastUsedAt.getTime())))??M[0]).id),M));let m=ve(-1),f=ve(l());o(f).then(d);const k=()=>{Q(f,l()),d()};let w=ve({id:Number.MIN_VALUE,name:"",description:"",lastUsedAt:new Date,cardInfos:[]}),c=ve(Te.ゾンビーノ);const h=ve({name:"",cardKinds:[...zn],monsterCategories:[...Ti].filter(M=>M!=="Normal"&&M!=="Token"),monsterAttributes:[...Mi],monsterTypes:[...Ni],spellCategories:[...bi],trapCategories:[..._i]}),D=()=>Object.values(Te).filter(M=>{var E;if(!o(h).cardKinds.includes(M.kind)||o(h).name.trim().length&&!M.name.includes(o(h).name))return!1;if(M.kind==="Monster")return M.attribute&&!o(h).monsterAttributes.includes(M.attribute)||M.type&&!o(h).monsterTypes.includes(M.type)?!1:(E=M.monsterCategories)==null?void 0:E.union(o(h).monsterCategories).length;if(M.kind==="Spell")return M.spellCategory&&o(h).spellCategories.includes(M.spellCategory);if(M.kind==="Trap")return M.trapCategory&&o(h).trapCategories.includes(M.trapCategory)}),y=M=>{Q(c,M)},C=async()=>{const E=(await o(f)).find(U=>U.id===o(m));if(!E)throw new Error("illegal state");return E},H=async()=>{const M=await C();await M.saveDeckInfo({...M,name:o(w).name,cardNames:o(w).cardInfos.map(E=>E.name),lastUsedAt:new Date}),k()},P=async()=>{(await Ct.createNewDeck(`デッキ_${new Date().formatToYYYYMMDD_HHMMSS("","","")}`,`コピー日時：${new Date().formatToYYYYMMDD_HHMMSS("-"," ",":")}`,o(w).cardInfos.map(E=>E.name))).saveDeckInfo(),k()},q=async M=>{const E=await C();!M.shiftKey&&!confirm(`デッキ【${E.name}】を削除します。
よろしいですか？`)||(await E.delete(),k())};Le();var Z=NA(),X=v(u(Z),2),x=u(X),I=u(x),ee=v(u(I),2),Ae=v(u(ee),2),ue=u(Ae),De=v(ee,2),G=v(u(De),2);me(G,5,()=>zn,ke,(M,E)=>{var U=DA(),T=u(U),O,se=v(T);L(()=>{O!==(O=o(E))&&(T.value=(T.__value=o(E))==null?"":o(E)),_(se,` ${Ba[o(E)]??""}`)}),bt(t,[],T,()=>(o(E),o(h).cardKinds),le=>Fe(h,o(h).cardKinds=le)),g(M,U)});var B=v(De,2),W=v(u(B),2);me(W,5,()=>Ti,ke,(M,E)=>{var U=vA(),T=u(U),O,se=v(T);L(()=>{O!==(O=o(E))&&(T.value=(T.__value=o(E))==null?"":o(E)),_(se,` ${Jt[o(E)]??""}${_n[o(E)]??""}`)}),bt(i,[],T,()=>(o(E),o(h).monsterCategories),le=>Fe(h,o(h).monsterCategories=le)),g(M,U)});var $=v(B,2),j=v(u($),2);me(j,5,()=>Mi,ke,(M,E)=>{var U=yA(),T=u(U),O,se=v(T,2),le=v(se);L(()=>{O!==(O=o(E))&&(T.value=(T.__value=o(E))==null?"":o(E)),we(se,`monster_attr ${o(c).attribute??""} svelte-rsq0rf`),_(le,` ${ci[o(E)]??""}`)}),bt(a,[],T,()=>(o(E),o(h).monsterAttributes),Oe=>Fe(h,o(h).monsterAttributes=Oe)),g(M,U)});var ie=v($,2),K=v(u(ie),2);me(K,5,()=>Ni,ke,(M,E)=>{var U=gA(),T=u(U),O,se=v(T);L(()=>{O!==(O=o(E))&&(T.value=(T.__value=o(E))==null?"":o(E)),_(se,` ${nn[o(E)]??""}
                ${Fn[o(E)]??""}`)}),bt(r,[],T,()=>(o(E),o(h).monsterTypes),le=>Fe(h,o(h).monsterTypes=le)),g(M,U)});var Y=v(ie,2),b=v(u(Y),2);me(b,5,()=>bi,ke,(M,E)=>{var U=BA(),T=u(U),O,se=v(T);L(()=>{O!==(O=o(E))&&(T.value=(T.__value=o(E))==null?"":o(E)),_(se,` ${en[o(E)]??""}`)}),bt(s,[],T,()=>(o(E),o(h).spellCategories),le=>Fe(h,o(h).spellCategories=le)),g(M,U)});var S=v(Y,2),F=v(u(S),2);me(F,5,()=>_i,ke,(M,E)=>{var U=EA(),T=u(U),O,se=v(T);L(()=>{O!==(O=o(E))&&(T.value=(T.__value=o(E))==null?"":o(E)),_(se,` ${tn[o(E)]??""}`)}),bt(p,[],T,()=>(o(E),o(h).trapCategories),le=>Fe(h,o(h).trapCategories=le)),g(M,U)});var z=v(I,2);wA(z,{get cardInfo(){return o(c)}});var ae=v(x,2),J=u(ae);const te=Ce(D);Ri(J,{mode:"List",get allCardInfos(){return o(te)},onAttention:y,get deckCardInfos(){return o(w).cardInfos},set deckCardInfos(M){Fe(w,o(w).cardInfos=M)},$$legacy:!0});var oe=v(ae,2),ne=u(oe);Da(ne,()=>o(f),M=>{var E=MA();g(M,E)},(M,E)=>{var U=TA(),T=V(U),O=u(T),se=v(u(O),2);L(()=>{o(m),Sr(()=>{o(E)})}),me(se,5,()=>o(E),ke,(Ze,Et)=>{var xt=xA(),ki={},Ha=u(xt);L(()=>{ki!==(ki=o(Et).id)&&(xt.value=(xt.__value=o(Et).id)==null?"":o(Et).id),_(Ha,o(Et).name)}),g(Ze,xt)});var le=v(O,2),Oe=v(u(le),2),mt=v(le,2),gt=v(u(mt),2),je=u(gt),Ge=v(gt,4),It=u(Ge),Zt=v(Ge,2),Bt=u(Zt),it=v(T,2);Ri(it,{mode:"Deck",allCardInfos:[],onAttention:y,get deckCardInfos(){return o(w).cardInfos},set deckCardInfos(Ze){Fe(w,o(w).cardInfos=Ze)},$$legacy:!0}),as(se,()=>o(m),Ze=>Q(m,Ze)),ye("change",se,d),$n(Oe,()=>o(w).name,Ze=>Fe(w,o(w).name=Ze)),ye("click",je,H),ye("click",It,P),ye("click",Bt,q),g(M,U)}),$n(ue,()=>o(h).name,M=>Fe(h,o(h).name=M)),g(n,Z),be()}const _A=["TblDeckHeader","TblDeckDetail","TblDuelistProfile"],FA=3;var HA=N('<div class="svelte-irn2ek"><label for="duelist_name" class="duelist_name svelte-irn2ek">名前：</label> <input id="duelist_name" class="duelist_name svelte-irn2ek" type="text"></div> <div class="svelte-irn2ek"><button class="btn svelte-irn2ek">duel start!</button></div> <div class="svelte-irn2ek"><button class="btn svelte-irn2ek">deck edit</button></div>',1),KA=N('<div class="svelte-irn2ek">デュエリスト情報の読み込み、もしくは作成中...</div>'),SA=N('<div class="app_body svelte-irn2ek"><!></div>'),WA=N('<main class="svelte-irn2ek"><!> <div class="screen_info svelte-irn2ek"></div></main>');function PA(n,e){Ne(e,!1);const t=new ks("stk_ygo_svelte",FA,_A);let i=ve(),a=ve("None");const r=jn.getOrCreateNew(t);let s=Ct.getAllDeckInfo(t);const p=async()=>{(await r).save()},d=()=>{s=Ct.getAllDeckInfo(t)},l=async()=>{(await s).length||(await Ct.prepareSampleDeck(),d())},m=async()=>{await Promise.all([p(),l()]),Q(i,new Ms(await r,"Player",(await s)[0],vs[0],"NPC",cn[0]))},f=async()=>{console.log("hoge"),await Promise.all([p(),l()]),Q(a,"DeckEdit")},k=async y=>{await p(),y.key==="Enter"&&!y.repeat&&(await r).save()};l(),Le();var w=WA(),c=u(w);{var h=y=>{nA(y,{get duel(){return o(i)}})},D=y=>{var C=he(),H=V(C);{var P=Z=>{bA(Z,{})},q=Z=>{var X=SA(),x=u(X);Da(x,()=>r,I=>{var ee=KA();g(I,ee)},(I,ee)=>{var Ae=HA(),ue=V(Ae),De=v(u(ue),2),G=v(ue,2),B=u(G),W=v(G,2),$=u(W);$n(De,()=>o(ee).name,j=>o(ee).name=j),ye("keypress",De,k),ye("click",B,m),ye("click",$,f),g(I,Ae)}),g(Z,X)};R(H,Z=>{o(a)==="DeckEdit"?Z(P):Z(q,!1)},!0)}g(y,C)};R(c,y=>{o(i)?y(h):y(D,!1)})}g(n,w),be()}Zr(PA,{target:document.getElementById("app")});
