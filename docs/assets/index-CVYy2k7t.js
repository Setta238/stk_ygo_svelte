var Ha=Object.defineProperty;var Sa=(n,e,t)=>e in n?Ha(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var d=(n,e,t)=>Sa(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const Ln=!1;var Xn=Array.isArray,Ka=Array.prototype.indexOf,ei=Array.from,Oi=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,Zi=Object.getOwnPropertyDescriptors,Pa=Object.prototype,qa=Array.prototype,ti=Object.getPrototypeOf;function Wa(n){return typeof n=="function"}const Ge=()=>{};function La(n){return typeof(n==null?void 0:n.then)=="function"}function Ra(n){return n()}function Rn(n){for(var e=0;e<n.length;e++)n[e]()}const Oe=2,Ui=4,gn=8,vn=16,At=32,Xt=64,mn=128,Re=256,un=512,_e=1024,dt=2048,Zt=4096,ot=8192,Bn=16384,Ii=32768,En=65536,$i=1<<17,Oa=1<<19,ji=1<<20,lt=Symbol("$state"),Za=Symbol("legacy props"),Ua=Symbol("");function Gi(n){return n===this.v}function Yi(n,e){return n!=n?e==e:n!==e||n!==null&&typeof n=="object"||typeof n=="function"}function ni(n){return!Yi(n,this.v)}function Ia(n){throw new Error("https://svelte.dev/e/effect_in_teardown")}function $a(){throw new Error("https://svelte.dev/e/effect_in_unowned_derived")}function ja(n){throw new Error("https://svelte.dev/e/effect_orphan")}function Ga(){throw new Error("https://svelte.dev/e/effect_update_depth_exceeded")}function Ya(n){throw new Error("https://svelte.dev/e/props_invalid_value")}function za(){throw new Error("https://svelte.dev/e/state_descriptors_fixed")}function Va(){throw new Error("https://svelte.dev/e/state_prototype_fixed")}function Qa(){throw new Error("https://svelte.dev/e/state_unsafe_local_read")}function Ja(){throw new Error("https://svelte.dev/e/state_unsafe_mutation")}let en=!1,Xa=!1;function er(){en=!0}const ii=1,ai=2,zi=4,tr=8,nr=16,ir=1,ar=2,rr=4,sr=8,or=16,lr=1,Ar=2,dr=4,pr=1,cr=2,Be=Symbol();let De=null;function hn(n){De=n}function Fe(n,e=!1,t){De={p:De,c:null,e:null,m:!1,s:n,x:null,l:null},en&&!e&&(De.l={s:null,u:null,r1:[],r2:Me(!1)})}function He(n){const e=De;if(e!==null){const o=e.e;if(o!==null){var t=de,i=pe;e.e=null;try{for(var r=0;r<o.length;r++){var s=o[r];Ue(s.effect),Ze(s.reaction),$t(s.fn)}}finally{Ue(t),Ze(i)}}De=e.p,e.m=!0}return{}}function Ut(){return!en||De!==null&&De.l===null}function Me(n,e){var t={f:0,v:n,reactions:null,equals:Gi,rv:0,wv:0};return t}function kr(n){return Vi(Me(n))}function Lt(n,e=!1){var i;const t=Me(n);return e||(t.equals=ni),en&&De!==null&&De.l!==null&&((i=De.l).s??(i.s=[])).push(t),t}function Ce(n,e=!1){return Vi(Lt(n,e))}function Vi(n){return pe!==null&&!Qe&&pe.f&Oe&&(Je===null?Br([n]):Je.push(n)),n}function Ke(n,e){return te(n,Xe(()=>l(n))),e}function te(n,e){return pe!==null&&!Qe&&Ut()&&pe.f&(Oe|vn)&&(Je===null||!Je.includes(n))&&Ja(),ut(n,e)}function ut(n,e){return n.equals(e)||(n.v,n.v=e,n.wv=ma(),Qi(n,dt),Ut()&&de!==null&&de.f&_e&&!(de.f&(At|Xt))&&(at===null?Er([n]):at.push(n))),e}function Qi(n,e){var t=n.reactions;if(t!==null)for(var i=Ut(),r=t.length,s=0;s<r;s++){var o=t[s],k=o.f;k&dt||!i&&o===de||(et(o,e),k&(_e|Re)&&(k&Oe?Qi(o,Zt):_n(o)))}}let Ji=!1;function ct(n,e=null,t){if(typeof n!="object"||n===null||lt in n)return n;const i=ti(n);if(i!==Pa&&i!==qa)return n;var r=new Map,s=Xn(n),o=Me(0);s&&r.set("length",Me(n.length));var k;return new Proxy(n,{defineProperty(p,c,m){(!("value"in m)||m.configurable===!1||m.enumerable===!1||m.writable===!1)&&za();var f=r.get(c);return f===void 0?(f=Me(m.value),r.set(c,f)):te(f,ct(m.value,k)),!0},deleteProperty(p,c){var m=r.get(c);if(m===void 0)c in p&&r.set(c,Me(Be));else{if(s&&typeof c=="string"){var f=r.get("length"),a=Number(c);Number.isInteger(a)&&a<f.v&&te(f,a)}te(m,Be),hi(o)}return!0},get(p,c,m){var u;if(c===lt)return n;var f=r.get(c),a=c in p;if(f===void 0&&(!a||(u=Pt(p,c))!=null&&u.writable)&&(f=Me(ct(a?p[c]:Be,k)),r.set(c,f)),f!==void 0){var A=l(f);return A===Be?void 0:A}return Reflect.get(p,c,m)},getOwnPropertyDescriptor(p,c){var m=Reflect.getOwnPropertyDescriptor(p,c);if(m&&"value"in m){var f=r.get(c);f&&(m.value=l(f))}else if(m===void 0){var a=r.get(c),A=a==null?void 0:a.v;if(a!==void 0&&A!==Be)return{enumerable:!0,configurable:!0,value:A,writable:!0}}return m},has(p,c){var A;if(c===lt)return!0;var m=r.get(c),f=m!==void 0&&m.v!==Be||Reflect.has(p,c);if(m!==void 0||de!==null&&(!f||(A=Pt(p,c))!=null&&A.writable)){m===void 0&&(m=Me(f?ct(p[c],k):Be),r.set(c,m));var a=l(m);if(a===Be)return!1}return f},set(p,c,m,f){var S;var a=r.get(c),A=c in p;if(s&&c==="length")for(var u=m;u<a.v;u+=1){var w=r.get(u+"");w!==void 0?te(w,Be):u in p&&(w=Me(Be),r.set(u+"",w))}a===void 0?(!A||(S=Pt(p,c))!=null&&S.writable)&&(a=Me(void 0),te(a,ct(m,k)),r.set(c,a)):(A=a.v!==Be,te(a,ct(m,k)));var C=Reflect.getOwnPropertyDescriptor(p,c);if(C!=null&&C.set&&C.set.call(f,m),!A){if(s&&typeof c=="string"){var v=r.get("length"),g=Number(c);Number.isInteger(g)&&g>=v.v&&te(v,g+1)}hi(o)}return!0},ownKeys(p){l(o);var c=Reflect.ownKeys(p).filter(a=>{var A=r.get(a);return A===void 0||A.v!==Be});for(var[m,f]of r)f.v!==Be&&!(m in p)&&c.push(m);return c},setPrototypeOf(){Va()}})}function hi(n,e=1){te(n,n.v+e)}function fi(n){return n!==null&&typeof n=="object"&&lt in n?n[lt]:n}function Xi(n,e){return Object.is(fi(n),fi(e))}var wi,ea,ta,na;function mr(){if(wi===void 0){wi=window,ea=/Firefox/.test(navigator.userAgent);var n=Element.prototype,e=Node.prototype;ta=Pt(e,"firstChild").get,na=Pt(e,"nextSibling").get,n.__click=void 0,n.__className="",n.__attributes=null,n.__styles=null,n.__e=void 0,Text.prototype.__t=void 0}}function Tn(n=""){return document.createTextNode(n)}function fn(n){return ta.call(n)}function xn(n){return na.call(n)}function h(n,e){return fn(n)}function ie(n,e){{var t=fn(n);return t instanceof Comment&&t.data===""?xn(t):t}}function D(n,e=1,t=!1){let i=n;for(;e--;)i=xn(i);return i}function ur(n){n.textContent=""}function Bt(n){var e=Oe|dt,t=pe!==null&&pe.f&Oe?pe:null;return de===null||t!==null&&t.f&Re?e|=Re:de.f|=ji,{ctx:De,deps:null,effects:null,equals:Gi,f:e,fn:n,reactions:null,rv:0,v:null,wv:0,parent:t??de}}function ye(n){const e=Bt(n);return e.equals=ni,e}function ia(n){var e=n.effects;if(e!==null){n.effects=null;for(var t=0;t<e.length;t+=1)ht(e[t])}}function hr(n){for(var e=n.parent;e!==null;){if(!(e.f&Oe))return e;e=e.parent}return null}function fr(n){var e,t=de;Ue(hr(n));try{ia(n),e=ha(n)}finally{Ue(t)}return e}function aa(n){var e=fr(n),t=(mt||n.f&Re)&&n.deps!==null?Zt:_e;et(n,t),n.equals(e)||(n.v=e,n.wv=ma())}function ra(n){de===null&&pe===null&&ja(),pe!==null&&pe.f&Re&&de===null&&$a(),oi&&Ia()}function wr(n,e){var t=e.last;t===null?e.last=e.first=n:(t.next=n,n.prev=t,e.last=n)}function It(n,e,t,i=!0){var r=(n&Xt)!==0,s=de,o={ctx:De,deps:null,nodes_start:null,nodes_end:null,f:n|dt,first:null,fn:e,last:null,next:null,parent:r?null:s,prev:null,teardown:null,transitions:null,wv:0};if(t){var k=qt;try{Di(!0),li(o),o.f|=Ii}catch(m){throw ht(o),m}finally{Di(k)}}else e!==null&&_n(o);var p=t&&o.deps===null&&o.first===null&&o.nodes_start===null&&o.teardown===null&&(o.f&(ji|mn))===0;if(!p&&!r&&i&&(s!==null&&wr(o,s),pe!==null&&pe.f&Oe)){var c=pe;(c.effects??(c.effects=[])).push(o)}return o}function ri(n){const e=It(gn,null,!1);return et(e,_e),e.teardown=n,e}function Ci(n){ra();var e=de!==null&&(de.f&At)!==0&&De!==null&&!De.m;if(e){var t=De;(t.e??(t.e=[])).push({fn:n,effect:de,reaction:pe})}else{var i=$t(n);return i}}function Cr(n){return ra(),Mn(n)}function Dr(n){const e=It(Xt,n,!0);return(t={})=>new Promise(i=>{t.outro?Ct(e,()=>{ht(e),i(void 0)}):(ht(e),i(void 0))})}function $t(n){return It(Ui,n,!1)}function Mn(n){return It(gn,n,!0)}function W(n,e=[],t=Bt){const i=e.map(t);return Nn(()=>n(...i.map(l)))}function Nn(n,e=0){return It(gn|vn|e,n,!0)}function Et(n,e=!0){return It(gn|At,n,!0,e)}function sa(n){var e=n.teardown;if(e!==null){const t=oi,i=pe;yi(!0),Ze(null);try{e.call(null)}finally{yi(t),Ze(i)}}}function oa(n,e=!1){var t=n.first;for(n.first=n.last=null;t!==null;){var i=t.next;ht(t,e),t=i}}function yr(n){for(var e=n.first;e!==null;){var t=e.next;e.f&At||ht(e),e=t}}function ht(n,e=!0){var t=!1;if((e||n.f&Oa)&&n.nodes_start!==null){for(var i=n.nodes_start,r=n.nodes_end;i!==null;){var s=i===r?null:xn(i);i.remove(),i=s}t=!0}oa(n,e&&!t),Dn(n,0),et(n,Bn);var o=n.transitions;if(o!==null)for(const p of o)p.stop();sa(n);var k=n.parent;k!==null&&k.first!==null&&la(n),n.next=n.prev=n.teardown=n.ctx=n.deps=n.fn=n.nodes_start=n.nodes_end=null}function la(n){var e=n.parent,t=n.prev,i=n.next;t!==null&&(t.next=i),i!==null&&(i.prev=t),e!==null&&(e.first===n&&(e.first=i),e.last===n&&(e.last=t))}function Ct(n,e){var t=[];si(n,t,!0),Aa(t,()=>{ht(n),e&&e()})}function Aa(n,e){var t=n.length;if(t>0){var i=()=>--t||e();for(var r of n)r.out(i)}else e()}function si(n,e,t){if(!(n.f&ot)){if(n.f^=ot,n.transitions!==null)for(const o of n.transitions)(o.is_global||t)&&e.push(o);for(var i=n.first;i!==null;){var r=i.next,s=(i.f&En)!==0||(i.f&At)!==0;si(i,e,s?t:!1),i=r}}}function Rt(n){da(n,!0)}function da(n,e){if(n.f&ot){n.f^=ot,n.f&_e||(n.f^=_e),tn(n)&&(et(n,dt),_n(n));for(var t=n.first;t!==null;){var i=t.next,r=(t.f&En)!==0||(t.f&At)!==0;da(t,r?e:!1),t=i}if(n.transitions!==null)for(const s of n.transitions)(s.is_global||e)&&s.in()}}let wn=!1,On=[];function pa(){wn=!1;const n=On.slice();On=[],Rn(n)}function Tt(n){wn||(wn=!0,queueMicrotask(pa)),On.push(n)}function gr(){wn&&pa()}const ca=0,vr=1;let dn=!1,pn=ca,Qt=!1,Jt=null,qt=!1,oi=!1;function Di(n){qt=n}function yi(n){oi=n}let wt=[],Wt=0;let pe=null,Qe=!1;function Ze(n){pe=n}let de=null;function Ue(n){de=n}let Je=null;function Br(n){Je=n}let Ne=null,Se=0,at=null;function Er(n){at=n}let ka=1,Cn=0,mt=!1,kt=null;function ma(){return++ka}function tn(n){var f;var e=n.f;if(e&dt)return!0;if(e&Zt){var t=n.deps,i=(e&Re)!==0;if(t!==null){var r,s,o=(e&un)!==0,k=i&&de!==null&&!mt,p=t.length;if(o||k){var c=n,m=c.parent;for(r=0;r<p;r++)s=t[r],(o||!((f=s==null?void 0:s.reactions)!=null&&f.includes(c)))&&(s.reactions??(s.reactions=[])).push(c);o&&(c.f^=un),k&&m!==null&&!(m.f&Re)&&(c.f^=Re)}for(r=0;r<p;r++)if(s=t[r],tn(s)&&aa(s),s.wv>n.wv)return!0}(!i||de!==null&&!mt)&&et(n,_e)}return!1}function Tr(n,e){for(var t=e;t!==null;){if(t.f&mn)try{t.fn(n);return}catch{t.f^=mn}t=t.parent}throw dn=!1,n}function xr(n){return(n.f&Bn)===0&&(n.parent===null||(n.parent.f&mn)===0)}function bn(n,e,t,i){if(dn){if(t===null&&(dn=!1),xr(e))throw n;return}t!==null&&(dn=!0);{Tr(n,e);return}}function ua(n,e,t=!0){var i=n.reactions;if(i!==null)for(var r=0;r<i.length;r++){var s=i[r];s.f&Oe?ua(s,e,!1):e===s&&(t?et(s,dt):s.f&_e&&et(s,Zt),_n(s))}}function ha(n){var A;var e=Ne,t=Se,i=at,r=pe,s=mt,o=Je,k=De,p=Qe,c=n.f;Ne=null,Se=0,at=null,pe=c&(At|Xt)?null:n,mt=(c&Re)!==0&&(!qt||r===null||p),Je=null,hn(n.ctx),Qe=!1,Cn++;try{var m=(0,n.fn)(),f=n.deps;if(Ne!==null){var a;if(Dn(n,Se),f!==null&&Se>0)for(f.length=Se+Ne.length,a=0;a<Ne.length;a++)f[Se+a]=Ne[a];else n.deps=f=Ne;if(!mt)for(a=Se;a<f.length;a++)((A=f[a]).reactions??(A.reactions=[])).push(n)}else f!==null&&Se<f.length&&(Dn(n,Se),f.length=Se);if(Ut()&&at!==null&&!Qe&&f!==null&&!(n.f&(Oe|Zt|dt)))for(a=0;a<at.length;a++)ua(at[a],n);return r!==null&&Cn++,m}finally{Ne=e,Se=t,at=i,pe=r,mt=s,Je=o,hn(k),Qe=p}}function Mr(n,e){let t=e.reactions;if(t!==null){var i=Ka.call(t,n);if(i!==-1){var r=t.length-1;r===0?t=e.reactions=null:(t[i]=t[r],t.pop())}}t===null&&e.f&Oe&&(Ne===null||!Ne.includes(e))&&(et(e,Zt),e.f&(Re|un)||(e.f^=un),ia(e),Dn(e,0))}function Dn(n,e){var t=n.deps;if(t!==null)for(var i=e;i<t.length;i++)Mr(n,t[i])}function li(n){var e=n.f;if(!(e&Bn)){et(n,_e);var t=de,i=De;de=n;try{e&vn?yr(n):oa(n),sa(n);var r=ha(n);n.teardown=typeof r=="function"?r:null,n.wv=ka;var s=n.deps,o;Ln&&Xa&&n.f&dt}catch(k){bn(k,n,t,i||n.ctx)}finally{de=t}}}function fa(){if(Wt>1e3){Wt=0;try{Ga()}catch(n){if(Jt!==null)bn(n,Jt,null);else throw n}}Wt++}function wa(n){var e=n.length;if(e!==0){fa();var t=qt;qt=!0;try{for(var i=0;i<e;i++){var r=n[i];r.f&_e||(r.f^=_e);var s=_r(r);Nr(s)}}finally{qt=t}}}function Nr(n){var e=n.length;if(e!==0)for(var t=0;t<e;t++){var i=n[t];if(!(i.f&(Bn|ot)))try{tn(i)&&(li(i),i.deps===null&&i.first===null&&i.nodes_start===null&&(i.teardown===null?la(i):i.fn=null))}catch(r){bn(r,i,null,i.ctx)}}}function br(){if(Qt=!1,Wt>1001)return;const n=wt;wt=[],wa(n),Qt||(Wt=0,Jt=null)}function _n(n){pn===ca&&(Qt||(Qt=!0,queueMicrotask(br))),Jt=n;for(var e=n;e.parent!==null;){e=e.parent;var t=e.f;if(t&(Xt|At)){if(!(t&_e))return;e.f^=_e}}wt.push(e)}function _r(n){var e=[],t=n.first;e:for(;t!==null;){var i=t.f,r=(i&At)!==0,s=r&&(i&_e)!==0,o=t.next;if(!s&&!(i&ot)){if(i&Ui)e.push(t);else if(r)t.f^=_e;else{var k=pe;try{pe=t,tn(t)&&li(t)}catch(m){bn(m,t,null,t.ctx)}finally{pe=k}}var p=t.first;if(p!==null){t=p;continue}}if(o===null){let m=t.parent;for(;m!==null;){if(n===m)break e;var c=m.next;if(c!==null){t=c;continue e}m=m.parent}}t=o}return e}function Ai(n){var e=pn,t=wt;try{fa();const r=[];pn=vr,wt=r,Qt=!1,wa(t);var i=n==null?void 0:n();return gr(),(wt.length>0||r.length>0)&&Ai(),Wt=0,Jt=null,i}finally{pn=e,wt=t}}async function Fr(){await Promise.resolve(),Ai()}function l(n){var e=n.f,t=(e&Oe)!==0;if(kt!==null&&kt.add(n),pe!==null&&!Qe){Je!==null&&Je.includes(n)&&Qa();var i=pe.deps;n.rv<Cn&&(n.rv=Cn,Ne===null&&i!==null&&i[Se]===n?Se++:Ne===null?Ne=[n]:(!mt||!Ne.includes(n))&&Ne.push(n))}else if(t&&n.deps===null&&n.effects===null){var r=n,s=r.parent;s!==null&&!(s.f&Re)&&(r.f^=Re)}return t&&(r=n,tn(r)&&aa(r)),n.v}function Hr(n){var e=kt;kt=new Set;var t=kt,i;try{if(Xe(n),e!==null)for(i of kt)e.add(i)}finally{kt=e}return t}function Ca(n){var e=Hr(()=>Xe(n));for(var t of e)if(t.f&$i)for(const i of t.deps||[])i.f&Oe||ut(i,i.v);else ut(t,t.v)}function Xe(n){var e=Qe;try{return Qe=!0,n()}finally{Qe=e}}const Sr=-7169;function et(n,e){n.f=n.f&Sr|e}function Kr(n){if(!(typeof n!="object"||!n||n instanceof EventTarget)){if(lt in n)Zn(n);else if(!Array.isArray(n))for(let e in n){const t=n[e];typeof t=="object"&&t&&lt in t&&Zn(t)}}}function Zn(n,e=new Set){if(typeof n=="object"&&n!==null&&!(n instanceof EventTarget)&&!e.has(n)){e.add(n),n instanceof Date&&n.getTime();for(let i in n)try{Zn(n[i],e)}catch{}const t=ti(n);if(t!==Object.prototype&&t!==Array.prototype&&t!==Map.prototype&&t!==Set.prototype&&t!==Date.prototype){const i=Zi(t);for(let r in i){const s=i[r].get;if(s)try{s.call(n)}catch{}}}}}const Pr=["touchstart","touchmove"];function qr(n){return Pr.includes(n)}let gi=!1;function Wr(){gi||(gi=!0,document.addEventListener("reset",n=>{Promise.resolve().then(()=>{var e;if(!n.defaultPrevented)for(const t of n.target.elements)(e=t.__on_r)==null||e.call(t)})},{capture:!0}))}function di(n){var e=pe,t=de;Ze(null),Ue(null);try{return n()}finally{Ze(e),Ue(t)}}function pi(n,e,t,i=t){n.addEventListener(e,()=>di(t));const r=n.__on_r;r?n.__on_r=()=>{r(),i(!0)}:n.__on_r=()=>i(!0),Wr()}const Da=new Set,Un=new Set;function Lr(n,e,t,i={}){function r(s){if(i.capture||Yt.call(e,s),!s.cancelBubble)return di(()=>t==null?void 0:t.call(this,s))}return n.startsWith("pointer")||n.startsWith("touch")||n==="wheel"?Tt(()=>{e.addEventListener(n,r,i)}):e.addEventListener(n,r,i),r}function ge(n,e,t,i,r){var s={capture:i,passive:r},o=Lr(n,e,t,s);(e===document.body||e===window||e===document)&&ri(()=>{e.removeEventListener(n,o,s)})}function ci(n){for(var e=0;e<n.length;e++)Da.add(n[e]);for(var t of Un)t(n)}function Yt(n){var g;var e=this,t=e.ownerDocument,i=n.type,r=((g=n.composedPath)==null?void 0:g.call(n))||[],s=r[0]||n.target,o=0,k=n.__root;if(k){var p=r.indexOf(k);if(p!==-1&&(e===document||e===window)){n.__root=e;return}var c=r.indexOf(e);if(c===-1)return;p<=c&&(o=p)}if(s=r[o]||n.target,s!==e){Oi(n,"currentTarget",{configurable:!0,get(){return s||t}});var m=pe,f=de;Ze(null),Ue(null);try{for(var a,A=[];s!==null;){var u=s.assignedSlot||s.parentNode||s.host||null;try{var w=s["__"+i];if(w!==void 0&&!s.disabled)if(Xn(w)){var[C,...v]=w;C.apply(s,[n,...v])}else w.call(s,n)}catch(S){a?A.push(S):a=S}if(n.cancelBubble||u===e||u===null)break;s=u}if(a){for(let S of A)queueMicrotask(()=>{throw S});throw a}}finally{n.__root=e,delete n.currentTarget,Ze(m),Ue(f)}}}function Rr(n){var e=document.createElement("template");return e.innerHTML=n,e.content}function yn(n,e){var t=de;t.nodes_start===null&&(t.nodes_start=n,t.nodes_end=e)}function N(n,e){var t=(e&pr)!==0,i=(e&cr)!==0,r,s=!n.startsWith("<!>");return()=>{r===void 0&&(r=Rr(s?n:"<!>"+n),t||(r=fn(r)));var o=i||ea?document.importNode(r,!0):r.cloneNode(!0);if(t){var k=fn(o),p=o.lastChild;yn(k,p)}else yn(o,o);return o}}function _t(n=""){{var e=Tn(n+"");return yn(e,e),e}}function he(){var n=document.createDocumentFragment(),e=document.createComment(""),t=Tn();return n.append(e,t),yn(e,t),n}function y(n,e){n!==null&&n.before(e)}let In=!0;function _(n,e){var t=e==null?"":typeof e=="object"?e+"":e;t!==(n.__t??(n.__t=n.nodeValue))&&(n.__t=t,n.nodeValue=t+"")}function Or(n,e){return Zr(n,e)}const Ft=new Map;function Zr(n,{target:e,anchor:t,props:i={},events:r,context:s,intro:o=!0}){mr();var k=new Set,p=f=>{for(var a=0;a<f.length;a++){var A=f[a];if(!k.has(A)){k.add(A);var u=qr(A);e.addEventListener(A,Yt,{passive:u});var w=Ft.get(A);w===void 0?(document.addEventListener(A,Yt,{passive:u}),Ft.set(A,1)):Ft.set(A,w+1)}}};p(ei(Da)),Un.add(p);var c=void 0,m=Dr(()=>{var f=t??e.appendChild(Tn());return Et(()=>{if(s){Fe({});var a=De;a.c=s}r&&(i.$$events=r),In=o,c=n(f,i)||{},In=!0,s&&He()}),()=>{var u;for(var a of k){e.removeEventListener(a,Yt);var A=Ft.get(a);--A===0?(document.removeEventListener(a,Yt),Ft.delete(a)):Ft.set(a,A)}Un.delete(p),f!==t&&((u=f.parentNode)==null||u.removeChild(f))}});return Ur.set(c,m),c}let Ur=new WeakMap;const Sn=0,on=1,Kn=2;function $n(n,e,t,i,r){var s=n,o=Ut(),k=De,p=Be,c,m,f,a=(o?Me:Lt)(void 0),A=(o?Me:Lt)(void 0),u=!1;function w(v,g){u=!0,g&&(Ue(C),Ze(C),hn(k));try{v===Sn&&t&&(c?Rt(c):c=Et(()=>t(s))),v===on&&i&&(m?Rt(m):m=Et(()=>i(s,a))),v!==Sn&&c&&Ct(c,()=>c=null),v!==on&&m&&Ct(m,()=>m=null),v!==Kn&&f&&Ct(f,()=>f=null)}finally{g&&(hn(null),Ze(null),Ue(null),Ai())}}var C=Nn(()=>{if(p!==(p=e())){if(La(p)){var v=p;u=!1,v.then(g=>{v===p&&(ut(a,g),w(on,!0))},g=>{if(v===p)throw ut(A,g),w(Kn,!0),A.v}),Tt(()=>{u||w(Sn,!0)})}else ut(a,p),w(on,!1);return()=>p=Be}})}function R(n,e,t=!1){var i=n,r=null,s=null,o=Be,k=t?En:0,p=!1;const c=(f,a=!0)=>{p=!0,m(a,f)},m=(f,a)=>{o!==(o=f)&&(o?(r?Rt(r):a&&(r=Et(()=>a(i))),s&&Ct(s,()=>{s=null})):(s?Rt(s):a&&(s=Et(()=>a(i))),r&&Ct(r,()=>{r=null})))};Nn(()=>{p=!1,e(c),p||m(null,null)},k)}function ce(n,e){return e}function Ir(n,e,t,i){for(var r=[],s=e.length,o=0;o<s;o++)si(e[o].e,r,!0);var k=s>0&&r.length===0&&t!==null;if(k){var p=t.parentNode;ur(p),p.append(t),i.clear(),pt(n,e[0].prev,e[s-1].next)}Aa(r,()=>{for(var c=0;c<s;c++){var m=e[c];k||(i.delete(m.k),pt(n,m.prev,m.next)),ht(m.e,!k)}})}function ke(n,e,t,i,r,s=null){var o=n,k={flags:e,items:new Map,first:null},p=(e&zi)!==0;if(p){var c=n;o=c.appendChild(Tn())}var m=null,f=!1,a=ye(()=>{var A=t();return Xn(A)?A:A==null?[]:ei(A)});Nn(()=>{var A=l(a),u=A.length;f&&u===0||(f=u===0,$r(A,k,o,r,e,i,t),s!==null&&(u===0?m?Rt(m):m=Et(()=>s(o)):m!==null&&Ct(m,()=>{m=null})),l(a))})}function $r(n,e,t,i,r,s,o){var X,x,I,ne;var k=(r&tr)!==0,p=(r&(ii|ai))!==0,c=n.length,m=e.items,f=e.first,a=f,A,u=null,w,C=[],v=[],g,S,q,L;if(k)for(L=0;L<c;L+=1)g=n[L],S=s(g,L),q=m.get(S),q!==void 0&&((X=q.a)==null||X.measure(),(w??(w=new Set)).add(q));for(L=0;L<c;L+=1){if(g=n[L],S=s(g,L),q=m.get(S),q===void 0){var b=a?a.e.nodes_start:t;u=Gr(b,e,u,u===null?e.first:u.next,g,S,L,i,r,o),m.set(S,u),C=[],v=[],a=u.next;continue}if(p&&jr(q,g,L,r),q.e.f&ot&&(Rt(q.e),k&&((x=q.a)==null||x.unfix(),(w??(w=new Set)).delete(q))),q!==a){if(A!==void 0&&A.has(q)){if(C.length<v.length){var $=v[0],E;u=$.prev;var U=C[0],re=C[C.length-1];for(E=0;E<C.length;E+=1)vi(C[E],$,t);for(E=0;E<v.length;E+=1)A.delete(v[E]);pt(e,U.prev,re.next),pt(e,u,U),pt(e,re,$),a=$,u=re,L-=1,C=[],v=[]}else A.delete(q),vi(q,a,t),pt(e,q.prev,q.next),pt(e,q,u===null?e.first:u.next),pt(e,u,q),u=q;continue}for(C=[],v=[];a!==null&&a.k!==S;)a.e.f&ot||(A??(A=new Set)).add(a),v.push(a),a=a.next;if(a===null)continue;q=a}C.push(q),u=q,a=q.next}if(a!==null||A!==void 0){for(var se=A===void 0?[]:ei(A);a!==null;)a.e.f&ot||se.push(a),a=a.next;var me=se.length;if(me>0){var ue=r&zi&&c===0?t:null;if(k){for(L=0;L<me;L+=1)(I=se[L].a)==null||I.measure();for(L=0;L<me;L+=1)(ne=se[L].a)==null||ne.fix()}Ir(e,se,ue,m)}}k&&Tt(()=>{var Z;if(w!==void 0)for(q of w)(Z=q.a)==null||Z.apply()}),de.first=e.first&&e.first.e,de.last=u&&u.e}function jr(n,e,t,i){i&ii&&ut(n.v,e),i&ai?ut(n.i,t):n.i=t}function Gr(n,e,t,i,r,s,o,k,p,c){var m=(p&ii)!==0,f=(p&nr)===0,a=m?f?Lt(r):Me(r):r,A=p&ai?Me(o):o,u={i:A,v:a,k:s,a:null,e:null,prev:t,next:i};try{return u.e=Et(()=>k(n,a,A,c),Ji),u.e.prev=t&&t.e,u.e.next=i&&i.e,t===null?e.first=u:(t.next=u,t.e.next=u.e),i!==null&&(i.prev=u,i.e.prev=u.e),u}finally{}}function vi(n,e,t){for(var i=n.next?n.next.e.nodes_start:t,r=e?e.e.nodes_start:t,s=n.e.nodes_start;s!==i;){var o=xn(s);r.before(s),s=o}}function pt(n,e,t){e===null?n.first=t:(e.next=t,e.e.next=t&&t.e),t!==null&&(t.prev=e,t.e.prev=e&&e.e)}function Dt(n,e,t,i){var r=n.__attributes??(n.__attributes={});r[e]!==(r[e]=t)&&(e==="style"&&"__styles"in n&&(n.__styles={}),e==="loading"&&(n[Ua]=t),t==null?n.removeAttribute(e):typeof t!="string"&&Yr(n).includes(e)?n[e]=t:n.setAttribute(e,t))}var Bi=new Map;function Yr(n){var e=Bi.get(n.nodeName);if(e)return e;Bi.set(n.nodeName,e=[]);for(var t,i=n,r=Element.prototype;r!==i;){t=Zi(i);for(var s in t)t[s].set&&e.push(s);i=ti(i)}return e}function we(n,e,t){var i=n.__className,r=zr(e);(i!==r||Ji)&&(e==null?n.removeAttribute("class"):n.className=r,n.__className=r)}function zr(n,e){return(n??"")+""}const Vr=()=>performance.now(),st={tick:n=>requestAnimationFrame(n),now:()=>Vr(),tasks:new Set};function ya(){const n=st.now();st.tasks.forEach(e=>{e.c(n)||(st.tasks.delete(e),e.f())}),st.tasks.size!==0&&st.tick(ya)}function Qr(n){let e;return st.tasks.size===0&&st.tick(ya),{promise:new Promise(t=>{st.tasks.add(e={c:n,f:t})}),abort(){st.tasks.delete(e)}}}function ln(n,e){di(()=>{n.dispatchEvent(new CustomEvent(e))})}function Jr(n){if(n==="float")return"cssFloat";if(n==="offset")return"cssOffset";if(n.startsWith("--"))return n;const e=n.split("-");return e.length===1?e[0]:e[0]+e.slice(1).map(t=>t[0].toUpperCase()+t.slice(1)).join("")}function Ei(n){const e={},t=n.split(";");for(const i of t){const[r,s]=i.split(":");if(!r||s===void 0)break;const o=Jr(r.trim());e[o]=s.trim()}return e}const Xr=n=>n;function Ht(n,e,t,i){var r=(n&lr)!==0,s=(n&Ar)!==0,o=r&&s,k=(n&dr)!==0,p=o?"both":r?"in":"out",c,m=e.inert,f=e.style.overflow,a,A;function u(){var S=pe,q=de;Ze(null),Ue(null);try{return c??(c=t()(e,(i==null?void 0:i())??{},{direction:p}))}finally{Ze(S),Ue(q)}}var w={is_global:k,in(){var S;if(e.inert=m,!r){A==null||A.abort(),(S=A==null?void 0:A.reset)==null||S.call(A);return}s||a==null||a.abort(),ln(e,"introstart"),a=jn(e,u(),A,1,()=>{ln(e,"introend"),a==null||a.abort(),a=c=void 0,e.style.overflow=f})},out(S){if(!s){S==null||S(),c=void 0;return}e.inert=!0,ln(e,"outrostart"),A=jn(e,u(),a,0,()=>{ln(e,"outroend"),S==null||S()})},stop:()=>{a==null||a.abort(),A==null||A.abort()}},C=de;if((C.transitions??(C.transitions=[])).push(w),r&&In){var v=k;if(!v){for(var g=C.parent;g&&g.f&En;)for(;(g=g.parent)&&!(g.f&vn););v=!g||(g.f&Ii)!==0}v&&$t(()=>{Xe(()=>w.in())})}}function jn(n,e,t,i,r){var s=i===1;if(Wa(e)){var o,k=!1;return Tt(()=>{if(!k){var C=e({direction:s?"in":"out"});o=jn(n,C,t,i,r)}}),{abort:()=>{k=!0,o==null||o.abort()},deactivate:()=>o.deactivate(),reset:()=>o.reset(),t:()=>o.t()}}if(t==null||t.deactivate(),!(e!=null&&e.duration))return r(),{abort:Ge,deactivate:Ge,reset:Ge,t:()=>i};const{delay:p=0,css:c,tick:m,easing:f=Xr}=e;var a=[];if(s&&t===void 0&&(m&&m(0,1),c)){var A=Ei(c(0,1));a.push(A,A)}var u=()=>1-i,w=n.animate(a,{duration:p});return w.onfinish=()=>{var C=(t==null?void 0:t.t())??1-i;t==null||t.abort();var v=i-C,g=e.duration*Math.abs(v),S=[];if(g>0){var q=!1;if(c)for(var L=Math.ceil(g/16.666666666666668),b=0;b<=L;b+=1){var $=C+v*f(b/L),E=Ei(c($,1-$));S.push(E),q||(q=E.overflow==="hidden")}q&&(n.style.overflow="hidden"),u=()=>{var U=w.currentTime;return C+v*f(U/g)},m&&Qr(()=>{if(w.playState!=="running")return!1;var U=u();return m(U,1-U),!0})}w=n.animate(S,{duration:g,fill:"forwards"}),w.onfinish=()=>{u=()=>i,m==null||m(i,1-i),r()}},{abort:()=>{w&&(w.cancel(),w.effect=null,w.onfinish=Ge)},deactivate:()=>{r=Ge},reset:()=>{i===0&&(m==null||m(1,0))},t:()=>u()}}function Gn(n,e,t=e){var i=Ut();pi(n,"input",r=>{var s=r?n.defaultValue:n.value;if(s=qn(n)?Wn(s):s,t(s),i&&s!==(s=e())){var o=n.selectionStart,k=n.selectionEnd;n.value=s??"",k!==null&&(n.selectionStart=o,n.selectionEnd=Math.min(k,n.value.length))}}),Xe(e)==null&&n.value&&t(qn(n)?Wn(n.value):n.value),Mn(()=>{var r=e();qn(n)&&r===Wn(n.value)||n.type==="date"&&!r&&!n.value||r!==n.value&&(n.value=r??"")})}const Pn=new Set;function St(n,e,t,i,r=i){var s=t.getAttribute("type")==="checkbox",o=n;if(e!==null)for(var k of e)o=o[k]??(o[k]=[]);o.push(t),pi(t,"change",()=>{var p=t.__value;s&&(p=es(o,p,t.checked)),r(p)},()=>r(s?[]:null)),Mn(()=>{var p=i();s?(p=p||[],t.checked=p.includes(t.__value)):t.checked=Xi(t.__value,p)}),ri(()=>{var p=o.indexOf(t);p!==-1&&o.splice(p,1)}),Pn.has(o)||(Pn.add(o),Tt(()=>{o.sort((p,c)=>p.compareDocumentPosition(c)===4?-1:1),Pn.delete(o)})),Tt(()=>{})}function es(n,e,t){for(var i=new Set,r=0;r<n.length;r+=1)n[r].checked&&i.add(n[r].__value);return t||i.delete(e),Array.from(i)}function qn(n){var e=n.type;return e==="number"||e==="range"}function Wn(n){return n===""?null:+n}function ga(n,e,t){if(n.multiple)return ns(n,e);for(var i of n.options){var r=Vt(i);if(Xi(r,e)){i.selected=!0;return}}(!t||e!==void 0)&&(n.selectedIndex=-1)}function ts(n,e){$t(()=>{var t=new MutationObserver(()=>{var i=n.__value;ga(n,i)});return t.observe(n,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value"]}),()=>{t.disconnect()}})}function va(n,e,t=e){var i=!0;pi(n,"change",r=>{var s=r?"[selected]":":checked",o;if(n.multiple)o=[].map.call(n.querySelectorAll(s),Vt);else{var k=n.querySelector(s)??n.querySelector("option:not([disabled])");o=k&&Vt(k)}t(o)}),$t(()=>{var r=e();if(ga(n,r,i),i&&r===void 0){var s=n.querySelector(":checked");s!==null&&(r=Vt(s),t(r))}n.__value=r,i=!1}),ts(n)}function ns(n,e){for(var t of n.options)t.selected=~e.indexOf(Vt(t))}function Vt(n){return"__value"in n?n.__value:n.value}function Ti(n,e){return n===e||(n==null?void 0:n[lt])===e}function is(n={},e,t,i){return $t(()=>{var r,s;return Mn(()=>{r=s,s=[],Xe(()=>{n!==t(...s)&&(e(n,...s),r&&Ti(t(...r),n)&&e(null,...r))})}),()=>{Tt(()=>{s&&Ti(t(...s),n)&&e(null,...s)})}}),n}function Ie(n=!1){const e=De,t=e.l.u;if(!t)return;let i=()=>Kr(e.s);if(n){let r=0,s={};const o=Bt(()=>{let k=!1;const p=e.s;for(const c in p)p[c]!==s[c]&&(s[c]=p[c],k=!0);return k&&r++,r});i=()=>l(o)}t.b.length&&Cr(()=>{xi(e,i),Rn(t.b)}),Ci(()=>{const r=Xe(()=>t.m.map(Ra));return()=>{for(const s of r)typeof s=="function"&&s()}}),t.a.length&&Ci(()=>{xi(e,i),Rn(t.a)})}function xi(n,e){if(n.l.s)for(const t of n.l.s)l(t);e()}function Ba(n,e,t){if(n==null)return e(void 0),Ge;const i=Xe(()=>n.subscribe(e,t));return i.unsubscribe?()=>i.unsubscribe():i}const Kt=[];function as(n,e=Ge){let t=null;const i=new Set;function r(k){if(Yi(n,k)&&(n=k,t)){const p=!Kt.length;for(const c of i)c[1](),Kt.push(c,n);if(p){for(let c=0;c<Kt.length;c+=2)Kt[c][0](Kt[c+1]);Kt.length=0}}}function s(k){r(k(n))}function o(k,p=Ge){const c=[k,p];return i.add(c),i.size===1&&(t=e(r,s)||Ge),k(n),()=>{i.delete(c),i.size===0&&t&&(t(),t=null)}}return{set:r,update:s,subscribe:o}}function rs(n){let e;return Ba(n,t=>e=t)(),e}let An=!1,Yn=Symbol();function ss(n,e,t){const i=t[e]??(t[e]={store:null,source:Lt(void 0),unsubscribe:Ge});if(i.store!==n&&!(Yn in t))if(i.unsubscribe(),i.store=n??null,n==null)i.source.v=void 0,i.unsubscribe=Ge;else{var r=!0;i.unsubscribe=Ba(n,s=>{r?i.source.v=s:te(i.source,s)}),r=!1}return n&&Yn in t?rs(n):l(i.source)}function os(){const n={};function e(){ri(()=>{for(var t in n)n[t].unsubscribe();Oi(n,Yn,{enumerable:!1,value:!0})})}return[n,e]}function ls(n){var e=An;try{return An=!1,[n(),An]}finally{An=e}}function fe(n,e,t,i){var $;var r=(t&ir)!==0,s=!en||(t&ar)!==0,o=(t&sr)!==0,k=(t&or)!==0,p=!1,c;o?[c,p]=ls(()=>n[e]):c=n[e];var m=lt in n||Za in n,f=o&&((($=Pt(n,e))==null?void 0:$.set)??(m&&e in n&&(E=>n[e]=E)))||void 0,a=i,A=!0,u=!1,w=()=>(u=!0,A&&(A=!1,k?a=Xe(i):a=i),a);c===void 0&&i!==void 0&&(f&&s&&Ya(),c=w(),f&&f(c));var C;if(s)C=()=>{var E=n[e];return E===void 0?w():(A=!0,u=!1,E)};else{var v=(r?Bt:ye)(()=>n[e]);v.f|=$i,C=()=>{var E=l(v);return E!==void 0&&(a=void 0),E===void 0?a:E}}if(!(t&rr))return C;if(f){var g=n.$$legacy;return function(E,U){return arguments.length>0?((!s||!U||g||p)&&f(U?C():E),E):C()}}var S=!1,q=!1,L=Lt(c),b=Bt(()=>{var E=C(),U=l(L);return S?(S=!1,q=!0,U):(q=!1,L.v=E)});return r||(b.equals=ni),function(E,U){if(kt!==null&&(S=q,C(),l(L)),arguments.length>0){const re=U?l(b):s&&o?ct(E):E;return b.equals(re)||(S=!0,te(L,re),u&&a!==void 0&&(a=re),Xe(()=>l(b))),E}return l(b)}}const As="5";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(As);er();class ds{constructor(e,t,i){d(this,"_dbname");d(this,"_dbversion");d(this,"dbPromise");d(this,"getTran",async(e,t)=>(await this.dbPromise).transaction(e,t));d(this,"reset",async()=>(await indexedDB.databases().then(e=>{console.log(e)}),await new Promise((e,t)=>{const i=indexedDB.deleteDatabase(this._dbname);i.onsuccess=()=>{console.log("onsuccess"),e()},i.onerror=r=>{console.log("onerror"),t(r)}})));d(this,"getAll",async e=>{const t=await this.dbPromise;return new Promise((i,r)=>{const k=t.transaction([e],"readonly").objectStore(e).getAll();k.onsuccess=()=>{i(k.result)},k.onerror=p=>{r(p)}})});d(this,"get",async(e,t)=>{const i=await this.dbPromise;return new Promise((r,s)=>{const p=i.transaction([e],"readonly").objectStore(e).get(t);p.onsuccess=()=>{r(p.result)},p.onerror=c=>{s(c)}})});d(this,"getMany",async(e,t)=>{const s=(await this.dbPromise).transaction([e],"readonly").objectStore(e),o=t.map(k=>new Promise((p,c)=>{const m=s.get(k);m.onsuccess=()=>{p(m.result)},m.onerror=f=>{c(f)}}));return await Promise.all(o)});d(this,"putRecords",async(e,t)=>{const r=(await this.dbPromise).transaction([e],"readwrite"),s=r.objectStore(e),o=t.map(k=>({record:k,request:s.put(k)}));return new Promise((k,p)=>{r.oncomplete=()=>k(o.map(c=>Object.assign({id:c.request.result},c.record))),r.onerror=c=>p(c)})});d(this,"deleteRecords",async(e,t)=>{const r=(await this.dbPromise).transaction([e],"readwrite"),s=r.objectStore(e),o=t.map(k=>({key:k,request:s.delete(k)}));return new Promise((k,p)=>{r.oncomplete=()=>{console.log(o.map(c=>c.request.result)),k()},r.onerror=c=>p(c)})});this._dbname=e,this._dbversion=t,this.dbPromise=new Promise((r,s)=>{const o=indexedDB.open(e,t);o.onsuccess=k=>{if(console.log(k),!k.target){console.log("event.target is undefined"),s("event.target is undefined");return}const p=k.target.result;if(!p){console.log("event.target.result is undefined"),s("event.target.result is undefined");return}p.onversionchange=c=>{console.log(c),p.close()},r(p)},o.onupgradeneeded=k=>{console.log("onupgradeneeded");const p=k.target.result;i.filter(c=>!p.objectStoreNames.contains(c)).map(c=>p.createObjectStore(c,{keyPath:"id",autoIncrement:!0}))},o.onerror=k=>{console.log(k),s(k)},o.onblocked=k=>{console.log(k),s(k)}}),console.log(this.dbPromise)}get dbversion(){return this._dbversion}}class Pe{constructor(){d(this,"handlers",[])}append(e){this.handlers.push(e)}remove(e){this.handlers=this.handlers.filter(t=>t!==e)}trigger(e){this.handlers.slice(0).forEach(t=>t(e))}clear(){this.handlers.splice(0)}expose(){return this}}class Mi{constructor(){d(this,"handler")}set(e){this.handler=e}async call(e){if(!this.handler)throw Error("illegal state error");return await this.handler(e)}expose(){return this}}class ki{constructor(e,t,i,r){d(this,"_name");d(this,"_createVersion");d(this,"mountResolver",()=>{});d(this,"_indexedDb");d(this,"onInsertEvent",new Pe);d(this,"onBeforeInsertEvent",new Mi);d(this,"onUpdateEvent",new Pe);d(this,"onBeforeUpdateEvent",new Mi);d(this,"onDeleteEvent",new Pe);d(this,"prepareInitialRecords",()=>{const e=new Date;return this._prepareInitialRecords().map(t=>Object.assign(t,{createdAt:e,updatedAt:e,dbVersion:this._createVersion}))});d(this,"resolveMount",()=>this.mountResolver());d(this,"patchForInsert",(e,t)=>{e.newRecords.forEach(i=>{console.log(i),t[i.id]=i})});d(this,"patchForUpdate",(e,t)=>{e.recordPairs.forEach(i=>{console.log(t[i.newRecord.id],i.newRecord),t[i.newRecord.id]={...i.newRecord}})});d(this,"patchForDelete",(e,t)=>{e.oldRecords.forEach(i=>{console.log(i),delete t[i.id]})});this._indexedDb=e,this._name=t,this._createVersion=e.dbversion,this.getAll().then(s=>s.reduce((o,k)=>(o[k.id]=k,o),{})).then(s=>{console.log(this.name,s),this.onBeforeInsertEvent.set(i??(()=>Promise.resolve())),this.onBeforeUpdateEvent.set(r??(()=>Promise.resolve()))})}get name(){return this._name}get createVersion(){return this._createVersion}get oninsert(){return this.onInsertEvent.expose()}get onbeforeinsert(){return this.onBeforeInsertEvent.expose()}get onupdate(){return this.onUpdateEvent.expose()}get onbeforeupdate(){return this.onBeforeUpdateEvent.expose()}get ondelete(){return this.onDeleteEvent.expose()}getAll(){return this._indexedDb.getAll(this.name)}get(e){return this._indexedDb.get(this.name,e)}async insertMany(e){const t=new Date,i=e.map(s=>{const o={createdAt:t,updatedAt:t,dbVersion:this._createVersion};return Object.assign(s,o)});await this.onBeforeInsertEvent.call({sender:this,newRecords:i,timestamp:t});const r=await this._indexedDb.putRecords(this.name,i);return this.onInsertEvent.trigger({sender:this,newRecords:r,timestamp:t}),r}async insert(e){return(await this.insertMany([e]))[0]}async updateMany(e,t){const i=new Date,r=[];return(await this._indexedDb.getMany(this.name,e)).forEach(o=>{const k={...o},p={...k};r.push({newRecord:Object.assign(t(p),{updatedAt:i,dbVersion:this._createVersion}),oldRecord:k})}),await this.onBeforeUpdateEvent.call({sender:this,recordPairs:r,timestamp:i}),await this._indexedDb.putRecords(this.name,r.map(o=>o.newRecord)),this.onUpdateEvent.trigger({sender:this,recordPairs:r,timestamp:i}),r.map(o=>o.newRecord)}async update(e,t){return(await this.updateMany([e],t))[0]}async delete(e){const t=new Date,i=await this._indexedDb.getMany(this.name,e);await this._indexedDb.deleteRecords(this.name,e),this.onDeleteEvent.trigger({sender:this,oldRecords:i,timestamp:t})}}const ps={"１３人目の埋葬者":{name:"１３人目の埋葬者",nameKana:"",description:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",pendulumDescription:"誰もいないはずの１３番目の墓から突然現れたゾンビ。",kind:"Monster",monsterCategories:["Normal"],level:3,attack:1200,defense:900,attribute:"Dark",type:"Zombie",wikiName:"《１３人目の埋葬者》",wikiHref:"https://yugioh-wiki.net/index.php?%A1%D4%A3%B1%A3%B3%BF%CD%CC%DC%A4%CE%CB%E4%C1%F2%BC%D4%A1%D5",wikiTextAll:`通常モンスター
...
(1)：相手フィールドにモンスターが存在し、自分フィールドにモンスターが存在しない場合、
このカードは手札から特殊召喚できる。`,nameTags:["シンクロン"]},ゾンビキャリア:{name:"ゾンビキャリア",nameKana:"",description:`(1)：このカードが墓地に存在する場合、手札を１枚デッキの一番上に戻して発動できる。
このカードを特殊召喚する。
...
このカードを特殊召喚する。`},"ダーク・バースト":{name:"ダーク・バースト",nameKana:"",description:`(1)：自分の墓地の攻撃力１５００以下の闇属性モンスター１体を対象として発動できる。
...
フィールドゾーンに「アンデットワールド」が存在する場合、
手札に加えず特殊召喚する事もできる。
この効果の発動後、ターン終了時まで自分はアンデット族モンスターしか特殊召喚できない。`},"キラー・トマト":{name:"キラー・トマト",nameKana:"",description:`(1)：このカードが戦闘で破壊され墓地へ送られた時に発動できる。
...
「キラー・ポテト」を除く、攻撃力１５００以下の闇属性モンスター１体をデッキから攻撃表示で特殊召喚する。`}},Le=class Le{constructor(e){d(this,"id");d(this,"name");d(this,"description");d(this,"save",async e=>{const t=e??{id:this.id,name:this.name,description:this.description},i=await Le.tblHeader.update(this.id,r=>({...r,...t}));return new Le(i)});this.id=e.id,this.name=e.name,this.description=e.description}};d(Le,"tblHeader"),d(Le,"getOrCreateNew",async e=>{Le.tblHeader||(Le.tblHeader=new cs(e));const t=await Le.tblHeader.getAll();if(t.length)return new Le(t[0]);const i=await Le.tblHeader.insert({name:"あなた",description:"ここの文字列を何に使うかは未定。"});return new Le(i)});let zn=Le;class cs extends ki{constructor(t){super(t,"TblDuelistProfile");d(this,"_prepareInitialRecords",()=>[])}}let ks=-1;const ms=[{id:ks--,name:"NPC",description:""}],us=["Deck","ExtraDeck"],hs={Deck:"メインデッキ",ExtraDeck:"エクストラデッキ"},Vn=["Monster","Spell","Trap"],Ea={Monster:"モンスター",Spell:"魔法",Trap:"罠"},Ot=["Fusion","Syncro","Xyz","Link"],Ta=[...Ot,"SpecialSummon"],fs=["Toon","Spirit","Union","Gemini","FlipEffect"],ws=["Tuner","Effect","Normal","Pendulum","Token"],Ni=[...Ta,...fs,...ws],Fn={Syncro:"シンクロ",Fusion:"融合",Xyz:"エクシーズ",Link:"リンク",SpecialSummon:"特殊召喚",Toon:"トゥーン",Spirit:"スピリット",Union:"ユニオン",Gemini:"デュアル",FlipEffect:"リバース",Tuner:"チューナー",Effect:"効果",Normal:"通常",Pendulum:"ペンデュラム",Token:"トークン"},nn={Syncro:"🎵",Fusion:"🌀",Xyz:"📰",Link:"⛓️",SpecialSummon:"🔯",Toon:"📖",Spirit:"👻",Union:"🚗",Gemini:"👫",FlipEffect:"🔄",Tuner:"🎶",Effect:"✨",Normal:"🔘",Pendulum:"💠",Token:"🐏"},bi=["Light","Dark","Earth","Water","Fire","Wind","Divine"],mi={Light:"光",Dark:"闇",Earth:"地",Water:"水",Fire:"炎",Wind:"風",Divine:"神"},_i=["Aqua","Beast","BeastWarrior","CreatorGod","Cyberse","Dinosaur","DivineBeast","Dragon","Fairy","Fiend","Fish","Insect","Illusion","Machine","Plant","Psychic","Pyro","Reptile","Rock","SeaSerpent","Spellcaster","Thunder","Warrior","WingedBeast","Wyrm","Zombie"],Fi=["Normal","Continuous","Field","QuickPlay","Equip","Ritual"],an={Normal:"通常",Continuous:"永続",Field:"フィールド",QuickPlay:"速攻",Equip:"装備",Ritual:"儀式"},Hi=["Normal","Continuous","Counter"],rn={Normal:"通常",Continuous:"永続",Counter:"カウンター"},Hn={Aqua:"水",Beast:"獣",BeastWarrior:"獣戦士",CreatorGod:"創造神",Cyberse:"サイバース",Dinosaur:"恐竜",DivineBeast:"幻獣神",Dragon:"ドラゴン",Fairy:"天使",Fiend:"悪魔",Fish:"魚",Insect:"昆虫",Illusion:"幻想魔",Machine:"機械",Plant:"植物",Psychic:"サイキック",Pyro:"炎",Reptile:"爬虫類",Rock:"岩石",SeaSerpent:"海竜",Spellcaster:"魔法使い",Thunder:"雷",Warrior:"戦士",WingedBeast:"鳥獣",Wyrm:"幻竜",Zombie:"アンデット"},sn={Aqua:"🚰",Beast:"🐅",BeastWarrior:"🦁",CreatorGod:"🔆",Cyberse:"💻️",Dinosaur:"🦖",DivineBeast:"💫",Dragon:"🐲",Fairy:"👼",Fiend:"👿",Fish:"🐟️",Insect:"🦋",Illusion:"🤡",Machine:"🤖",Plant:"🌱",Psychic:"👁️",Pyro:"🔥",Reptile:"🦎",Rock:"⛰",SeaSerpent:"🐍",Spellcaster:"🧙",Thunder:"⚡️",Warrior:"⚔️",WingedBeast:"🦅",Wyrm:"🐉",Zombie:"🦴"},Si=["Deck","ExtraDeck","Graveyard","Banished"],xa=["MonsterZone","ExtraMonsterZone"],Cs=["SpellAndTrapZone","FieldSpellZone"],Ma=[...xa,...Cs],Qn={0:{0:"Hand"},1:{0:"Deck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"ExtraDeck"},2:{0:"Graveyard",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"FieldSpellZone"},3:{0:"Banished",1:"Disable",2:"ExtraMonsterZone",3:"Disable",4:"ExtraMonsterZone",5:"Disable",6:"Banished"},4:{0:"FieldSpellZone",1:"MonsterZone",2:"MonsterZone",3:"MonsterZone",4:"MonsterZone",5:"MonsterZone",6:"Graveyard"},5:{0:"ExtraDeck",1:"SpellAndTrapZone",2:"SpellAndTrapZone",3:"SpellAndTrapZone",4:"SpellAndTrapZone",5:"SpellAndTrapZone",6:"Deck"},6:{0:"Hand"}};class Ds{constructor(e,t,i,r){d(this,"onUpdateEvent",new Pe);d(this,"field");d(this,"row");d(this,"column");d(this,"cellType");d(this,"owner");d(this,"_entities");d(this,"releaseEntities",e=>(this._entities=this._entities.filter(t=>!e.includes(t)),this.onUpdateEvent.trigger(),e));d(this,"acceptEntities",(e,t)=>{t==="Bottom"?this._entities.push(...e):t==="Top"&&this._entities.unshift(...e),this._entities.forEach(i=>{i.fieldCell=this}),this.onUpdateEvent.trigger()});d(this,"shuffle",()=>{this._entities=this.entities.shuffle()});this.field=e,this.row=t,this.column=i,this.cellType=Qn[t][i],this.owner=r,this._entities=[]}get onUpdate(){return this.onUpdateEvent.expose()}get entities(){return this._entities}get cardEntities(){return this._entities.filter(e=>Rs.find(t=>t===e.entityType))}get targetForAttack(){return this.cellType==="Hand"?this._entities.find(e=>e.entityType==="Duelist"):this.cardEntities[0]}get isAvailable(){return this._entities.length===0}}Array.prototype.shuffle=function(){return this.map(e=>({item:e,seq:Math.random()})).toSorted((e,t)=>e.seq-t.seq).map(e=>e.item)};Array.prototype.randomPick=function(n){return this.shuffle().slice(0,n)};Array.prototype.reset=function(...n){this.splice(0),this.push(...n)};Array.prototype.union=function(n){return this.filter(n.includes,n)};Array.prototype.getAllOnOffPattern=function(){const n=[];return this.forEach(e=>{if(n.length==0){n.push([e]),n.push([]);return}n.forEach(t=>n.push([...t,e]))}),n};Array.prototype.getDistinct=function(){return Array.from(new Set(this))};const ys=n=>{if(n.controller.normalSummonCount>=n.controller.maxNormalSummonCount||!n.status.level)return;const e=n.controller.getAvailableMonsterZones();return n.status.level<5?e.length>0?e:void 0:n.controller.getReleasableMonsters().length<(n.status.level<7?1:2)?void 0:[]},gs=async(n,e,t)=>{if(!n.status.level)return[];if(n.status.level<5)return[];let i=t;const r=n.controller.getReleasableMonsters(),s=n.controller.getExtraMonsterZones(),o=n.status.level<7?1:2;s.length>=o&&r.filter(p=>p.fieldCell.cellType!=="ExtraMonsterZone");const k=await n.field.release(n.controller,n.controller.getReleasableMonsters(),o,"Cost",["AdvanceSummonRelease","Rule"],n,i);if(k)return i=!1,k},vs=async(n,e,t)=>{if(!n.status.level)return!1;const i=["Rule","NormalSummon"];t&&t.length>0&&(n.info.materials.reset(...t),i.push("AdvanceSummon"));const r=n.controller.getAvailableMonsterZones();return await n.field.summon(n,["Attack","Set"],e?[e]:r,"NormalSummon",i,n,void 0,t&&t.length===0),n.controller.normalSummonCount++,!0},Bs=n=>{if(n.info.attackCount>0||n.battlePotion!=="Attack"||!n.controller.isTurnPlayer)return;const e=n.controller.getAttackTargetMonsters();return e.length>0?e.map(t=>t.fieldCell):[n.controller.getOpponentPlayer().getHandCell()]},Es=async(n,e)=>{if(n.info.attackCount>0||n.battlePotion!=="Attack")return!1;if(e!=null&&e.targetForAttack)return n.field.duel.declareAnAttack(n,e==null?void 0:e.targetForAttack),!0;const t=n.controller.getAttackTargetMonsters(),i=n.controller.getOpponentPlayer().entity;if(t.length===0)return n.field.duel.declareAnAttack(n,i),!0;if(t.length===1)return n.field.duel.declareAnAttack(n,t[0]),!0;const r=await n.field.duel.view.waitSelectEntities(n.controller,t,1,s=>s.length===1,"攻撃対象を選択。",!0);return r?(n.field.duel.declareAnAttack(n,r[0]),!0):!1},Ts=n=>{if(!(n.info.battlePotisionChangeCount>0||n.info.attackCount>0||!n.controller.isTurnPlayer))return[]},xs=async n=>n.info.battlePotisionChangeCount>0||!n.controller.isTurnPlayer?!1:(n.setBattlePosition(n.battlePotion==="Attack"?"Defense":"Attack"),n.info.battlePotisionChangeCount++,!0),Ms=n=>{if(n.status.spellCategory==="Field"){const t=n.controller.getFieldZone();return t.isAvailable?[t]:void 0}const e=n.controller.getAvailableSpellTrapZones();return e.length>0?e:void 0},Ns=async(n,e)=>{const t=n.controller.getAvailableSpellTrapZones();return t.length===0?!1:(await n.field.setSpellTrap(n,e?[e]:t,void 0,n.controller,!0),n.info.isSettingSickness=n.status.kind==="Trap"||n.status.spellCategory==="QuickPlay",!0)},Te=n=>{if(n.info.isDying)return;if(n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return n.info.isSettingSickness?void 0:[];const e=n.controller.getAvailableSpellTrapZones();return e.length>0?e:void 0},xe=async(n,e)=>{if(n.info.isDying=!0,n.fieldCell.cellType==="FieldSpellZone"&&n.face==="FaceDown")return n.setNonFieldPosition("FaceUp",!0),!0;if(n.fieldCell.cellType==="Hand"){const t=["SpellTrapActivate"],i=e?[e]:n.controller.getAvailableSpellTrapZones();return await n.field.activateSpellTrapFromHand(n,i,t,n,n.controller,!0),!0}return!1},Na=(n,e,t,i)=>!(e.some(r=>!r.status.canBeSyncroMaterial)||e.some(r=>r.fieldCell.cellType!=="Hand"&&r.fieldCell.cellType!=="MonsterZone"&&r.fieldCell.cellType!=="ExtraMonsterZone")||e.some(r=>r.fieldCell.cellType==="Hand")&&e.every(r=>!r.status.allowHandSyncro)||e.some(r=>!r.lvl)||e.map(r=>r.lvl??0).reduce((r,s)=>r+s,0)!==(n.origin.level??-1)||!t(e.filter(r=>{var s;return(s=r.status.monsterCategories)==null?void 0:s.some(o=>o==="Tuner")}))||!i(e.filter(r=>{var s;return(s=r.status.monsterCategories)==null?void 0:s.every(o=>o!=="Tuner")}))),ba=(n,e=i=>i.length===1,t=i=>i.length>0)=>{let i=[...n.controller.getMonstersOnField().filter(r=>r.battlePotion!=="Set"),...n.controller.getHandCell().entities.filter(r=>r.origin.kind==="Monster")].filter(r=>r.status.canBeSyncroMaterial);return i.every(r=>!r.status.allowHandSyncro)&&(i=n.controller.getMonstersOnField()),i.length<2?[]:i.getAllOnOffPattern().filter(r=>Na(n,r,e,t))},bs=(n,e=i=>i.length===1,t=i=>i.length>0)=>ba(n,e,t).length>0?[]:void 0,_s=async(n,e,t,i=s=>s.length===1,r=s=>s.length>0)=>{const s=ba(n,i,r);if(s.length===1){for(const p of s[0])await p.sendToGraveyard(["SyncroMaterial","Rule","SpecialSummonMaterial"],n,n.controller);return s[0]}const o=s.flatMap(p=>p).getDistinct(),k=await n.field.sendToGraveyard("シンクロ素材とするモンスターを選択",n.controller,o,-1,p=>Na(n,p,i,r),["SyncroMaterial","Rule","SpecialSummonMaterial"],n,t);if(console.log(k),!!k)return k},Fs=async(n,e,t,i)=>{i&&i.length>0&&n.info.materials.reset(...i);const r=[...e.getAvailableMonsterZones(),...e.getAvailableExtraZones()];return await n.field.summon(n,["Attack","Defense"],t?[t]:r,"SyncroSummon",["Rule","SpecialSummon"],n,void 0,i&&i.length===0),e.specialSummonCount++,n.info.isRebornable=!0,!0},it={title:"通常召喚",playType:"NormalSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:ys,prepare:(n,e,t)=>gs(n,e,t),execute:(n,e,t,i)=>vs(n,t,i)},qe={title:"攻撃宣言",playType:"Battle",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:Bs,prepare:async()=>!0,execute:(n,e,t)=>Es(n,t)},We={title:"表示形式変更",playType:"ChangeBattlePosition",spellSpeed:"Normal",executableCells:["MonsterZone","ExtraMonsterZone"],validate:Ts,prepare:async()=>!0,execute:n=>xs(n)},Ee={title:"セット",playType:"SpellTrapSet",spellSpeed:"Normal",executableCells:["Hand"],validate:Ms,prepare:async()=>!0,execute:(n,e,t)=>Ns(n,t)},Hs=(n,e,t,i,r)=>({title:"①リクルート",playType:"TriggerEffect",spellSpeed:"Normal",executableCells:r,canExecuteOnDamageStep:!0,validate:s=>{if(s.wasMovedAs.union(i).length!==0&&s.isMoveAtPreviousChain&&s.controller.getDeckCell().cardEntities.filter(n).length!==0)return[]},prepare:async()=>!0,execute:async(s,o)=>{const k=s.controller.getDeckCell().cardEntities.filter(n);if(k.length===0)return!1;const p=await s.field.duel.view.waitSelectEntities(o,k,e.length===1?e[0]:-1,c=>e.includes(c.length),"特殊召喚するモンスターを選択",!1);if(!p)throw new Error("illegal state");for(const c of p)await s.field.summon(c,t,o.getAvailableMonsterZones(),"SpecialSummon",["Effect"],s,o,!1);return o.shuffleDeck(),!0}}),Ki=(n=t=>t.length===1,e=t=>t.length>0)=>({title:"シンクロ召喚",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["ExtraDeck"],validate:t=>bs(t,n,e),prepare:(t,i,r)=>_s(t,i,r,n,e),execute:(t,i,r,s)=>Fs(t,i,r,s)}),Ss=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>{if(e.controller.getDeckCell().cardEntities.filter(n).length!==0)return Te(e)},prepare:xe,execute:async(e,t)=>{const i=t.getDeckCell().cardEntities.filter(n);if(i.length===0)return!1;const r=await e.field.duel.view.waitSelectEntities(t,i,1,s=>s.length===1,"手札に加えるカードを選択",!1);for(const s of r??[])await s.addToHand(["Effect"],e,t);return t.shuffleDeck(),!0}}),Ks=(n,e)=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:t=>{if(!(t.controller.getGraveyard().cardEntities.filter(n).length<e))return Te(t)},prepare:xe,execute:async(t,i)=>{const r=i.getGraveyard().cardEntities.filter(n);if(r.length===0)return!1;const s=await t.field.duel.view.waitSelectEntities(i,r,e,o=>o.length===e,"手札に加えるカードを選択",!1);for(const o of s??[])await o.addToHand(["Effect"],t,i);return!0}}),Ps=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:e=>{if(e.controller.getHandCell().cardEntities.filter(n).length!==0&&!(e.controller.getDeckCell().cardEntities.length<2))return Te(e)},prepare:async(e,t)=>(await e.controller.discard(1,["Discard","Cost"],e,e.controller,n),await xe(e,t)),execute:async(e,t)=>(await t.draw(2,e,t),!0)}),qs=n=>({title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:Te,prepare:xe,execute:async(e,t)=>{const[i,r]=n(e);return r>0?t.getOpponentPlayer().heal(r,e):r<0&&t.getOpponentPlayer().effectDamage(Math.abs(r),e),i>0?t.heal(i,e):i<0&&t.effectDamage(Math.abs(i),e),!0}}),Ws=["NormalSummon","SpecialSummon","ChangeBattlePosition","Battle","SpellTrapSet","SpellTrapActivate"];class Ls{constructor(e,t,i){d(this,"seq");d(this,"entity");d(this,"cardActionBase");d(this,"validate",()=>{if(!(this.isOnlyNTimesPerDuel>0&&this.entity.field.duel.cardActionLog.records.filter(e=>this.isSame(e.cardAction)).filter(e=>e.activater).length>=this.isOnlyNTimesPerDuel)&&!(this.isOnlyNTimesPerTurn>0&&this.entity.field.duel.cardActionLog.records.filter(e=>this.isSameGroupPerTurn(e.cardAction)).filter(e=>e.turn===this.entity.field.duel.clock.turn).filter(e=>e.activater).length>=this.isOnlyNTimesPerTurn))return this.cardActionBase.validate(this.entity)});d(this,"prepare",async e=>{const t=await this.cardActionBase.prepare(this.entity,e);if(t!==void 0)return this.entity.field.duel.cardActionLog.push(this.entity.controller,this),t});d(this,"execute",(e,t,i)=>this.cardActionBase.execute(this.entity,e,t,i));d(this,"isSame",e=>this.entity.origin.name===e.entity.origin.name&&this.title===e.title);d(this,"isSameGroupPerTurn",e=>this.actionGroupNamePerTurn?this.entity.origin.name===e.entity.origin.name&&this.actionGroupNamePerTurn===e.actionGroupNamePerTurn:this.isSame(e));this.seq=e,this.entity=t,this.cardActionBase=i}get title(){return this.cardActionBase.title}get playType(){return this.cardActionBase.playType}get spellSpeed(){return this.cardActionBase.spellSpeed}get hasToTargetCards(){return this.cardActionBase.hasToTargetCards??!1}get executableCells(){return this.cardActionBase.executableCells}get isOnlyNTimesPerDuel(){return this.cardActionBase.isOnlyNTimesPerDuel??0}get isOnlyNTimesPerTurn(){return this.cardActionBase.isOnlyNTimesPerTurn??0}get actionGroupNamePerTurn(){return this.cardActionBase.actionGroupNamePerTurn}get canExecuteOnDamageStep(){return this.cardActionBase.canExecuteOnDamageStep??!1}}const Rs=["Card","Token","Avatar"],cn=(n,e)=>{const t=n.monsterCategories??[],i=e.monsterCategories??[];for(const r of Ot.toReversed()){if(t.includes(r)&&!i.includes(r))return 1;if(!t.includes(r)&&i.includes(r))return-1}if(n.kind===e.kind){if(n.kind==="Monster"){if((n.link??0)!==(e.link??0))return(n.link??0)-(e.link??0);if((n.rank??0)!==(e.rank??0))return(n.rank??0)-(e.rank??0);if((n.level??0)!==(e.level??0))return(n.level??0)-(e.level??0);if((n.attack??0)!==(e.attack??0))return(n.attack??0)-(e.attack??0);if((n.defense??0)!==(e.defense??0))return(n.defense??0)-(e.defense??0)}return n.name.localeCompare(e.name,"Ja")}for(const r of Vn){if(n.kind===r)return-1;if(e.kind===r)return 1}return n.name.localeCompare(e.name,"Ja")},Os=(n,e)=>cn(n.origin,e.origin),ve=class ve{constructor(e,t,i,r,s,o,k,p){d(this,"seq");d(this,"origin");d(this,"entityType");d(this,"face");d(this,"isUnderControl");d(this,"_battlePosition");d(this,"orientation");d(this,"controller");d(this,"owner");d(this,"fieldCell");d(this,"wasMovedBy");d(this,"wasMovedByWhom");d(this,"wasMovedAs");d(this,"wasMovedFrom");d(this,"wasMovedAt");d(this,"_status");d(this,"_info");d(this,"actions",[]);d(this,"getIndexInCell",()=>{const e=this.fieldCell.cardEntities.indexOf(this);if(e<0)throw new Ve("エンティティとセルの状態が矛盾している。",[this,this.fieldCell]);return e});d(this,"setBattlePosition",e=>{this._battlePosition=e,this.orientation=e==="Attack"?"Vertical":"Horizontal",this.face=e==="Set"?"FaceDown":"FaceUp",this.isUnderControl=!0});d(this,"setNonFieldPosition",(e,t)=>{this._battlePosition=void 0,this.orientation=e==="XysMaterial"?"Horizontal":"Vertical",this.face=e==="FaceUp"?"FaceUp":"FaceDown",this.isUnderControl=t});d(this,"summon",async(e,t,i,r,s,o)=>{const k={Attack:"AttackSummon",Defense:"DefenseSummon",Set:"SetSummon"};e.isAvailable&&(this.setBattlePosition(t),await this._moveTo(e,"Top",[i,k[t],...r],s,o),this.info.battlePotisionChangeCount=1)});d(this,"setAsSpellTrap",async(e,t,i,r)=>{await this._moveTo(e,"Top",[...t,"SpellTrapSet"],i,r),this.setNonFieldPosition("Set",!0)});d(this,"activateSpellTrapFromHand",async(e,t,i,r)=>{this.setNonFieldPosition("FaceUp",!0),await this._moveTo(e,"Top",[...t,"SpellTrapActivate"],i,r)});d(this,"activateSpellTrapOnField",async()=>{this.setNonFieldPosition("FaceUp",!0)});d(this,"draw",async(e,t,i)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",[...e,"Draw"],t,i),this.setNonFieldPosition("Set",!0)});d(this,"addToHand",async(e,t,i)=>{await this._moveTo(this.owner.getHandCell(),"Bottom",e,t,i),this.setNonFieldPosition("Set",!0)});d(this,"release",async(e,t,i)=>{await this.sendToGraveyard([...e,"Release"],t,i)});d(this,"destroy",async(e,t,i,r)=>{await this.sendToGraveyard([...t,e,"Destroy"],i,r)});d(this,"sendToGraveyard",async(e,t,i)=>{if(this.info.willBeBanished)return await this.banish(e,t,i);if(this.info.willReturnToDeck)return await this.banish(e,t,i);this.info.isDying=!1,this.setNonFieldPosition("FaceUp",!0);const r=this.owner.getGraveyard();await this._moveTo(r,"Top",e,t,i)});d(this,"banish",async(e,t,i)=>{if(this.info.willReturnToDeck)return await this.banish(e,t,i);this.info.isDying=!1,this.setNonFieldPosition("FaceUp",!0);const r=this.owner.getBanished();await this._moveTo(r,"Top",e,t,i),this.info.willBeBanished=!1});d(this,"banishTemporarily",async(e,t,i)=>{if(this.info.willBeBanished)return await this.banish(e,t,i);if(this.info.willReturnToDeck)return await this.banish(e,t,i);throw this.initForTurn(),new Error("not implemented")});d(this,"returnToDeck",async(e,t,i,r)=>{if(this.info.willBeBanished)return await this.banish(t,i,r),this.owner.getBanished();const s=this.origin.monsterCategories&&this.origin.monsterCategories.union(Ot).length?this.owner.getExtraDeck():this.owner.getDeckCell();return this.setNonFieldPosition("Set",!1),this.resetInfo(),this.resetStatus(),await this._moveTo(s,e,t,i,r)});d(this,"_moveTo",async(e,t,i,r,s)=>{if(!e)throw new Error("illegal argument: to");if(this.field.duel.clock.turn>0&&await this.field.duel.view.waitAnimation({entity:this,to:e,index:t,count:0}),this.fieldCell.releaseEntities([this]),(this.fieldCell.cellType!==e.cellType||this.fieldCell.cellType==="ExtraMonsterZone"&&e.cellType==="MonsterZone")&&(this.wasMovedAs.reset(...new Set(i)),this.wasMovedAt=this.field.duel.clock.getClone(),this.wasMovedBy=r,this.wasMovedFrom=this.fieldCell,this.wasMovedByWhom=s),this.entityType==="Token"&&Ma.every(o=>o!==this.fieldCell.cellType)){this.field.duel.log.info(`${this.nm}は消滅した。`,this.controller);return}e.owner&&(this.controller=e.owner),e.acceptEntities([this],t)});d(this,"initForTurn",()=>{this.info.isSettingSickness=!1,this.info.attackCount=0,this.info.battlePotisionChangeCount=0});d(this,"resetInfo",()=>{var e;this._info={isDying:!1,isVanished:!1,isRebornable:((e=this.origin.monsterCategories)==null?void 0:e.union(Ta).length)===0||(this.origin.canReborn??!1),isSettingSickness:!1,materials:[],willBeBanished:!1,willReturnToDeck:!1,attackCount:0,battlePotisionChangeCount:0}});d(this,"resetStatus",()=>{this._status={...JSON.parse(JSON.stringify(this.origin)),canAttack:!0,isEffective:!0,canDirectAttack:!1,attackCount:0,isSelectableForAttack:!0,canBeSyncroMaterial:!0,willBeBanished:!1}});this.seq=ve.nextEntitySeq++,this.owner=e,this.controller=t,this.fieldCell=i,this.entityType=r,this.origin=s,this._status=JSON.parse(JSON.stringify(s)),this.resetStatus(),this._info={attackCount:0,battlePotisionChangeCount:0,isDying:!1,isVanished:!1,isRebornable:!0,isSettingSickness:!1,materials:[],willBeBanished:!1,willReturnToDeck:!1},this.resetInfo(),this.face=o,this.isUnderControl=k,this.orientation=p,this.wasMovedAs=["Rule"],this.wasMovedAt=this.field.duel.clock,this.wasMovedByWhom=e,i.acceptEntities([this],"Top")}get field(){return this.owner.duel.field}get status(){return this._status}get info(){return this._info}get nm(){return this.status.name}get atk(){return this.status.attack}get def(){return this.status.defense}get lvl(){return this.status.level}get rank(){return this.status.rank}get attr(){return this.status.attribute?[this.status.attribute]:[]}get type(){return this.status.type?[this.status.type]:[]}get psL(){return[this.status.pendulumScaleL]}get psR(){return[this.status.pendulumScaleR]}get isMoveAtPreviousChain(){return this.field.duel.clock.isPreviousChain(this.wasMovedAt)}get battlePotion(){return this._battlePosition}};d(ve,"nextActionSeq",0),d(ve,"nextEntitySeq",0),d(ve,"actionDic",{}),d(ve,"createCardActionList",(e,t)=>{const i=t.map(r=>new Ls(ve.nextActionSeq++,e,r));return i.forEach(r=>ve.actionDic[r.seq]=r),i}),d(ve,"createPlayerEntity",e=>{const t=e.getHandCell();return new ve(e,e,t,"Duelist",{name:e.profile.name,kind:"Monster"},"FaceUp",!0,"Vertical")}),d(ve,"createCardEntity",(e,t)=>{var o;const i=t.monsterCategories&&t.monsterCategories.union(Ot).length?e.getExtraDeck():e.getDeckCell(),r=new ve(e,e,i,"Card",t,"FaceDown",!1,"Vertical");Object.hasOwn(be,r.origin.name)||e.duel.log.info(`未実装カード${t.name}がデッキに投入された。`,e);const s=be[r.origin.name];return s.kind==="Monster"&&((o=s.monsterCategories)!=null&&o.includes("Normal"))?r.actions.push(...ve.createCardActionList(r,[it,qe,We])):r.actions.push(...ve.createCardActionList(r,Jn.get(r.origin.name)||[])),r}),d(ve,"createDammyAction",(e,t,i,r)=>({seq:ve.nextActionSeq++,title:t,entity:e,playType:"Dammy",spellSpeed:"Dammy",executableCells:[e.fieldCell.cellType],hasToTargetCards:!1,isOnlyNTimesPerDuel:0,isOnlyNTimesPerTurn:0,validate:()=>i,prepare:async()=>{},execute:async()=>!1,pos:r,cell:i[0],dragAndDropOnly:i.length>1}));let yt=ve;class Pi{constructor(e,t,i,r,s){d(this,"duel");d(this,"seat");d(this,"_entity");d(this,"profile");d(this,"deckInfo");d(this,"duelistType");d(this,"lifeLog");d(this,"normalSummonCount");d(this,"specialSummonCount");d(this,"maxNormalSummonCount");d(this,"_lp");d(this,"battleDamage",(e,t)=>this.setLp(this._lp-e,t,"BattleDamage"));d(this,"effectDamage",(e,t)=>this.setLp(this._lp-e,t,"EffectDamage"));d(this,"lostLp",(e,t)=>this.setLp(this._lp-e,t,"Lost"));d(this,"payLp",(e,t)=>this.setLp(this._lp-e,t,"Pay"));d(this,"heal",(e,t)=>this.setLp(this._lp+e,t,"Heal"));d(this,"setLp",(e,t,i)=>{const r={clock:this.duel.clock,reason:i||"Set",beforeLp:this._lp,afterLp:e,entity:t};return this.lifeLog.push(r),this._lp=e,this.duel.log.info(`ライフポイント変動：${r.afterLp-r.beforeLp}（${r.beforeLp} ⇒ ${r.afterLp}）`,this),r});d(this,"getOpponentPlayer",()=>this.duel.firstPlayer===this?this.duel.secondPlayer:this.duel.firstPlayer);d(this,"getHandCell",()=>this.duel.field.getCells("Hand").filter(e=>e.owner===this)[0]);d(this,"getDeckCell",()=>this.duel.field.getCells("Deck").filter(e=>e.owner===this)[0]);d(this,"getExtraDeck",()=>this.duel.field.getCells("ExtraDeck").filter(e=>e.owner===this)[0]);d(this,"getGraveyard",()=>this.duel.field.getCells("Graveyard").filter(e=>e.owner===this)[0]);d(this,"getFieldZone",()=>this.duel.field.getCells("FieldSpellZone").filter(e=>e.owner===this)[0]);d(this,"getBanished",()=>this.duel.field.getCells("Banished").filter(e=>e.owner===this)[0]);d(this,"getMonsterZones",()=>this.duel.field.getCells("MonsterZone").filter(e=>e.owner===this));d(this,"getExtraMonsterZones",()=>this.duel.field.getCells("ExtraMonsterZone").filter(e=>{var t;return((t=e.cardEntities[0])==null?void 0:t.controller)===this}));d(this,"getSpellTrapZones",()=>this.duel.field.getCells("SpellAndTrapZone").filter(e=>e.owner===this));d(this,"getEmptyMonsterZones",()=>this.getMonsterZones().filter(e=>e.cardEntities.length===0));d(this,"getEmptyExtraZones",()=>this.getExtraMonsterZones().length===0?this.getMonsterZones().filter(e=>e.cardEntities.length===0):[]);d(this,"getAvailableMonsterZones",()=>this.getMonsterZones().filter(e=>e.isAvailable));d(this,"getAvailableExtraZones",()=>this.getExtraMonsterZones().length===0?this.duel.field.getCells("ExtraMonsterZone").filter(e=>e.isAvailable):[]);d(this,"getAvailableSpellTrapZones",()=>this.getSpellTrapZones().filter(e=>e.isAvailable));d(this,"getReleasableMonsters",()=>this.getMonstersOnField());d(this,"getMonstersOnField",()=>this.duel.field.getMonstersOnField().filter(e=>e.controller===this));d(this,"getAttackTargetMonsters",()=>this.duel.field.getMonstersOnField().filter(e=>e.status.isSelectableForAttack&&e.controller!==this));d(this,"pushDeck",()=>{this.deckInfo.cardNames.map(e=>be[e]).filter(e=>e).forEach(e=>yt.createCardEntity(this,e)),this.duel.log.info(`デッキをセット。メイン${this.getDeckCell().cardEntities.length}枚。エクストラ${this.getExtraDeck().cardEntities.length}枚。`,this)});d(this,"draw",async(e,t,i)=>{var o;if(e<1)return;const r=this.getDeckCell(),s=[];for(const k of Array(e)){if(!r.cardEntities.length)throw this.duel.log.info(s.length>0?`デッキからカードを${e}枚ドローしようとしたが、${s.length}枚しかドローできなかった。${s}`:"デッキからカードをドローできなかった。",this),this.duel.isEnded=!0,this.setLp(0),new gt(this.getOpponentPlayer());const p=r.cardEntities[0];await p.draw(t?["Effect"]:["Rule"],t,i),s.push(((o=p.origin)==null?void 0:o.name)||"!名称取得失敗!")}this.duel.log.info(`デッキからカードを${s.length}枚ドロー。${s}。`,this)});d(this,"shuffleDeck",()=>{this.getDeckCell().shuffle(),this.duel.log.info("デッキをシャッフル。",this)});d(this,"discard",async(e,t,i,r,s,o)=>{const k=s||(()=>!0),p=this.getHandCell().cardEntities.filter(k);if(p.length<e)return[];let c=[];(r||this).duelistType==="NPC"?c=p.randomPick(e):c=await this.duel.view.waitSelectEntities(r||this,p,e,m=>m.length===e,`${e}枚カードを捨てる。`,!1)||[];for(const m of c)await m.sendToGraveyard(["Discard",...t],i,o);return this.duel.log.info(`手札からカードを${c.length}枚捨てた。${c.map(m=>{var f;return(f=m.origin)==null?void 0:f.name})}。`,this),c});this.duel=e,this.seat=t,this.profile=i,this.duelistType=r,this.deckInfo=s,this.lifeLog=[],this.normalSummonCount=0,this.specialSummonCount=0,this.maxNormalSummonCount=1,this._lp=8e3}get entity(){const e=this.getHandCell().entities.find(t=>t.entityType==="Duelist");return e||yt.createPlayerEntity(this)}get lp(){return this._lp}get isTurnPlayer(){return this.duel.getTurnPlayer()===this}}class Zs{constructor(e){d(this,"cells");d(this,"duel");d(this,"getAllCells",()=>this.cells.flat());d(this,"getCells",(...e)=>this.getAllCells().filter(t=>e.includes(t.cellType)));d(this,"getAllEntities",()=>this.getAllCells().map(e=>e.entities).flat());d(this,"getAllCardEntities",()=>this.getAllCells().map(e=>e.cardEntities).flat());d(this,"getMonstersOnField",()=>this.getCells(...xa).map(e=>e.cardEntities).filter(e=>e.length>0).map(e=>e[0]));d(this,"getEntiteisOnField",()=>this.getCells(...Ma).map(e=>e.cardEntities).filter(e=>e.length>0).map(e=>e[0]));d(this,"getEntities",e=>this.getAllEntities().filter(t=>t.controller===e));d(this,"sendGraveyardAtSameTime",async(e,t,i,r)=>{const s=e.reduce((k,p)=>(k[p.owner.seat].push(p),k),{Above:[],Below:[]}),o=Object.values(s).map(k=>new Promise(p=>{let c=new Promise(m=>m());for(const m of k)c=c.then(()=>m.sendToGraveyard(t,i,r));c.then(()=>p())}));await Promise.all(o)});d(this,"drawAtSameTime",async(e,t,i,r,s,o)=>{const k=[],p=[],c=[e.draw(t,s,o),i.draw(r,s,o)].map(m=>m.catch(f=>{f instanceof gt?f.winner&&k.push(f.winner):p.push(f)}));if(await Promise.all(c),p.length)throw new Ve("ドロー処理で想定されない例外が発生した。",e,t,i,r,s,...p);if(k.length!==0)throw k.length===1?new gt(k[0]):new gt});d(this,"sendToGraveyard",async(e,t,i,r,s,o,k,p)=>{if(r>0&&i.length<r)return;const c=await this.duel.view.waitSelectEntities(t,i,r,s,e,p);if(c){for(const m of c)await m.sendToGraveyard(o,k,t);return this.duel.log.info(`${c.map(m=>m.status.name).join(", ")}を墓地に送った（${o.getDistinct().join(", ")}）。`,t),c}});d(this,"release",async(e,t,i,r,s,o,k,p)=>{if(i>0&&t.length<i)return;const c=await this.duel.view.waitSelectEntities(e,t,i,f=>(k||f.length>0)&&(i<0||f.length===i),"リリースするモンスターを選択",p);if(!c)return;const m=[];for(const f of c)await f.release(["Release",r,...s],o,e),m.push(f);return this.duel.log.info(`${m.map(f=>f.status.name).join(", ")}をリリース（${[...new Set(m.flatMap(f=>f.wasMovedAs))].join(", ")}）。`,e),m});d(this,"summonMany",async(e,t,i,r,s,o,k)=>{const p=await Promise.all(e.map(async c=>this._summon(c,t(c),i(c),r,s,o,k?k(c):void 0)));if(p.find(c=>!c))throw new Ve("想定されない返却値",p);return p});d(this,"summon",async(e,t,i,r,s,o,k,p=!1)=>{const c=await this._summon(e,t,i,r,s,o,k,p);if(c)return this.duel.log.info(`${c.status.name}を召喚（${[...s,r].join(",")}）。`,k??(o==null?void 0:o.controller)??e.controller),c});d(this,"_summon",async(e,t,i,r,s,o,k,p=!1)=>{const c=k??(o==null?void 0:o.controller)??e.controller;let m=t.randomPick(1)[0],f=i.randomPick(1)[0];if((i.length>1||t.length>1)&&c.duelistType!=="NPC"){const a=i.length>1?"カードを召喚先へドラッグ。":"表示形式を選択。",A=t.map(v=>yt.createDammyAction(e,v,i,v)),u=this.duel.view.modalController.selectAction(this.duel.view,{title:a,actions:A,cancelable:!1}),w=this.duel.view.waitSubAction(c,A,a,p).then(v=>v.action),C=await Promise.any([u,w]);if(!C&&!p)throw new Ve("",C);if(!C)return;f=C.cell||f,m=C.pos||m}return console.log(f,m,r,s,o),await e.summon(f,m,r,s,o,c),e});d(this,"activateSpellTrapFromHand",async(e,t,i,r,s,o=!1)=>{const k=s??(r==null?void 0:r.controller)??e.controller;let p=t.randomPick(1)[0];if(t.length>1&&k.duelistType!=="NPC"){const c=[yt.createDammyAction(e,"カードの発動",t,void 0)];this.duel.view.modalController.selectAction(this.duel.view,{title:"カードを魔法罠ゾーンへドラッグ",actions:c,cancelable:!1});const m=await this.duel.view.waitSubAction(k,c,"カードを魔法罠ゾーンへドラッグ。",o),f=m.action;if(!f&&!o)throw new Ve("",m);if(!f)return;p=f.cell||p}return await e.activateSpellTrapFromHand(p,i,r,k),e});d(this,"setSpellTrap",async(e,t,i,r,s=!1)=>{let o=t[0];const k=r??(i==null?void 0:i.controller)??e.controller;if(t.length>1&&k.duelistType!=="NPC"){const p=[yt.createDammyAction(e,"セット",t)],c=this.duel.view.modalController.selectAction(this.duel.view,{title:"カードをセット先へドラッグ",actions:p,cancelable:s}),m=this.duel.view.waitSubAction(k,p,"カードをセット先へドラッグ",s),f=await Promise.any([c,m.then(a=>a.action)]);if(!f&&!s)throw new Ve("",f);if(!f)return;o=f.cell||o}await e.setAsSpellTrap(o,["SpellTrapSet"],i,k),this.duel.log.info(`${e.status.name}をセット（SpellTrapSet）。`,r??(i==null?void 0:i.controller)??e.controller)});this.duel=e,this.cells=[...Array(7)].map(()=>[]);for(const t of Object.keys(Qn).map(Number))for(const i of Object.keys(Qn[t]).map(Number))this.cells[t][i]=new Ds(this,t,i,t<3?e.duelists.Above:t>3?e.duelists.Below:i===0?e.duelists.Above:i===6?e.duelists.Below:void 0)}}let Us=class{constructor(e){d(this,"onUpdateEvent",new Pe);d(this,"nextSeq");d(this,"records",[]);d(this,"duel");d(this,"dispose",()=>{this.onUpdateEvent.clear()});d(this,"error",e=>{console.error(e);const t=["エラー発生"];e instanceof Error?(e instanceof Ve&&(t.push("-- エラーメッセージ --"),t.push(e.message),t.push("-- 関連オブジェクト --"),e.items.forEach(i=>t.push(JSON.stringify(i)))),t.push("-- エラー名称 --"),t.push(e.name||"エラー名称取得失敗"),t.push("-- スタックトレース --"),t.push(e.stack||"スタックトレース取得失敗")):(t.push("-- エラー型特定失敗 --"),t.push(JSON.stringify(e))),this.info(t)});d(this,"info",(e,t)=>{const i=Array.isArray(e)?e.join(`
`):e;this.records.push({seq:this.nextSeq++,turn:this.duel.clock.turn,phase:this.duel.phase,phaseStep:this.duel.phaseStep,clock:this.duel.clock,duelist:t,text:i}),this.onUpdateEvent.trigger()});this.nextSeq=0,this.duel=e}get onUpdate(){return this.onUpdateEvent.expose()}};const qi=["DuelEntitiesSelector","DuelActionSelector"];class Is{constructor(e){d(this,"onUpdateEvent",new Pe);d(this,"states");d(this,"view");d(this,"cancelAll",()=>{qi.forEach(e=>this.states[e]="Disable"),console.info(this,"cancelAll"),this.onUpdateEvent.trigger()});d(this,"duelEntitiesSelectorArg",{title:"対象を選択",entities:[],validator:()=>!0,qty:-1,cancelable:!1});d(this,"duelEntitiesSelectorValue");d(this,"duelEntitiesSelectorResolve",()=>{});d(this,"selectDuelEntities",async e=>(this.duelEntitiesSelectorArg=e,this.states.DuelEntitiesSelector="Shown",this.onUpdateEvent.trigger(),new Promise(t=>{this.duelEntitiesSelectorResolve=i=>{this.states.DuelEntitiesSelector="Disable",this.onUpdateEvent.trigger(),t(i)}})));d(this,"cardActionSelectorArg",{title:"カード操作を選択。",actions:[],cancelable:!1});d(this,"cardActionSelectorResolve",()=>{});d(this,"cardActionSelectorValue");d(this,"selectAction",async(e,t)=>(this.cardActionSelectorArg=t,this.states.DuelActionSelector="Shown",e.onWaitEnd.append(this.cancelAll),this.onUpdateEvent.trigger(),new Promise(i=>{this.cardActionSelectorResolve=r=>{console.log(r),this.states.DuelActionSelector="Disable",e.onWaitEnd.remove(this.cancelAll),this.onUpdateEvent.trigger(),i(r)}})));this.view=e,this.states=qi.reduce((t,i)=>(t[i]="Disable",t),{})}get onUpdate(){return this.onUpdateEvent.expose()}}class $s{constructor(e){d(this,"onDuelUpdateEvent",new Pe);d(this,"requireUpdate",()=>{this.onDuelUpdateEvent.trigger()});d(this,"onWaitStartEvent",new Pe);d(this,"onWaitEndEvent",new Pe);d(this,"onDragStartEvent",new Pe);d(this,"onDragEndEvent",new Pe);d(this,"onAnimationStartEvent",new Pe);d(this,"onShowCardEntityEvent",new Pe);d(this,"duel");d(this,"modalController");d(this,"message");d(this,"waitMode");d(this,"infoBoardState");d(this,"infoBoardCell");d(this,"getCell",(e,t)=>this.duel.field.cells[e][t]);d(this,"showCardInfo",e=>{this.onShowCardEntityEvent.trigger(e)});d(this,"dispose",()=>{this.onDragStartEvent.clear(),this.onDragEndEvent.clear(),this.onDuelUpdateEvent.clear(),this.onWaitStartEvent.clear(),this.onWaitEndEvent.clear()});d(this,"waitFieldAction",async(e,t)=>{if(console.log(e),this.duel.getTurnPlayer().duelistType==="NPC"){const i=e.toSorted((r,s)=>(s.entity.atk||0)-(r.entity.atk||0)).find(r=>r.playType==="NormalSummon"||r.playType==="SpecialSummon"||r.playType==="CardActivation");return i?{action:i}:{phaseChange:this.duel.nextPhaseList[0]}}return await this._waitDuelistAction(e,"SelectFieldAction",t)});d(this,"waitQuickEffect",async(e,t,i)=>{if(e.length===0)return;const r=[];return r.push(this.modalController.selectAction(this,{title:t,actions:e,cancelable:i}).then(s=>s&&s)),r.push(this._waitDuelistAction(e,"SelectAction",this.message).then(s=>s.action)),await Promise.any(r)});d(this,"waitSubAction",async(e,t,i,r=!1)=>{if(e.duelistType==="NPC")throw Error("Not implemented");return await this._waitDuelistAction(t,"SelectAction",i,void 0,void 0,void 0,r)});d(this,"waitSelectEntities",async(e,t,i,r,s,o=!1)=>{let k=[];if(i&&t.length===i)return[...t];if(e.duelistType==="NPC"){for(;!r(k);){const c=i&&i>0?i:Math.floor(Math.random()*t.length)+1;k=t.randomPick(c)}return k}this.waitMode=t.every(c=>(c.fieldCell.cellType==="MonsterZone"||c.fieldCell.cellType==="ExtraMonsterZone")&&c.getIndexInCell()===0||c.fieldCell.cellType==="Hand"&&c.controller===e)?"SelectFieldEntities":"SelectEntities",console.log(this.waitMode);const p=await this._waitDuelistAction([],this.waitMode,s,t,i,r,o);return console.log(p),p.selectedEntities});d(this,"_waitDuelistAction",async(e,t,i,r,s,o,k=!1)=>{this.waitMode=t,this.message=i,this.onDuelUpdateEvent.trigger();const p=await new Promise(c=>{const m={resolve:c,enableActions:e,qty:s,entitiesValidator:o||(()=>!1),selectableEntities:r||[]};console.log(r),console.log(o),console.log(this.waitMode),console.log(this.waitMode==="SelectEntities"),r&&o&&this.waitMode==="SelectEntities"&&(m.duelEntitiesSelectorArg={title:i,entities:r,validator:o,qty:s??-1,cancelable:!1}),console.log(m),this.onWaitStartEvent.trigger(m)});if(console.log(p),this.waitMode="None",this.onWaitEndEvent.trigger(),p.surrender)throw new gt(this.duel.duelists.Above);if(!k&&p.cancel)throw new Ve("キャンセル不可のアクションがキャンセルされた。",p,e,t,r);return p});d(this,"waitAnimation",async e=>(this.onDuelUpdateEvent.trigger(),new Promise(t=>this.onAnimationStartEvent.trigger({...e,resolve:t}))));d(this,"setDraggingActions",e=>{this.onDragStartEvent.trigger(e),this.requireUpdate()});d(this,"removeDraggingActions",()=>{this.onDragEndEvent.trigger()});this.duel=e,this.message="",this.waitMode="None",this.infoBoardState="Log",this.infoBoardCell=e.duelists.Below.getExtraDeck(),this.modalController=new Is(this)}get onDuelUpdate(){return this.onDuelUpdateEvent.expose()}get onWaitStart(){return this.onWaitStartEvent.expose()}get onWaitEnd(){return this.onWaitEndEvent.expose()}get onDragStart(){return this.onDragStartEvent.expose()}get onDragEnd(){return this.onDragEndEvent.expose()}get onAnimation(){return this.onAnimationStartEvent.expose()}get onShowCardEntity(){return this.onShowCardEntityEvent.expose()}}class js{constructor(){d(this,"_turn",0);d(this,"_phaseSeq",0);d(this,"_stepSeq",0);d(this,"_chainSeq",0);d(this,"_chainBlockSeq",0);d(this,"_procSeq",0);d(this,"_procTotalSeq",0);d(this,"incrementTurn",()=>{this._turn++,this._phaseSeq=0,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementPhaseSeq",()=>{this._phaseSeq++,this._stepSeq=0,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementStepSeq",()=>{this._stepSeq++,this._chainSeq=0,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementChainSeq",()=>{this._chainSeq++,this._chainBlockSeq=0,this._procSeq=0});d(this,"incrementChainBlockSeq",()=>{this._chainBlockSeq++,this._procSeq=0});d(this,"incrementProcSeq",()=>{this._procSeq++,this._procTotalSeq++});d(this,"toString",()=>`${this.procTotalSeq}(t${this.turn}-p${this.phaseSeq}-ps${this.stepSeq}-c${this.chainSeq}-cb${this.chainBlockSeq}-p${this.procSeq})`);d(this,"getClone",()=>({turn:this.turn,phaseSeq:this.phaseSeq,stepSeq:this.stepSeq,chainSeq:this.chainSeq,chainBlockSeq:this.chainBlockSeq,procSeq:this.procSeq,procTotalSeq:this.procTotalSeq}));d(this,"isSameChain",e=>this.turn===e.turn&&this.phaseSeq===e.phaseSeq&&this.stepSeq===e.stepSeq&&this.chainSeq===e.chainSeq);d(this,"isPreviousChain",e=>this.turn===e.turn&&this.phaseSeq===e.phaseSeq&&this.stepSeq===e.stepSeq&&this.chainSeq===e.chainSeq+1);d(this,"isPreviousProc",e=>this.procTotalSeq===e.procTotalSeq+1)}get turn(){return this._turn}get phaseSeq(){return this._phaseSeq}get stepSeq(){return this._stepSeq}get chainSeq(){return this._chainSeq}get chainBlockSeq(){return this._chainBlockSeq}get procSeq(){return this._procSeq}get procTotalSeq(){return this._procTotalSeq}}class Gs{constructor(e){d(this,"nextSeq");d(this,"records",[]);d(this,"duel");d(this,"push",(e,t)=>{this.records.push({seq:this.nextSeq++,turn:this.duel.clock.turn,activater:e,cardAction:t})});this.nextSeq=0,this.duel=e}}class gt extends Error{constructor(t){const i=t?`デュエルが終了した。勝者：${t.profile.name}`:"デュエルが終了した。ドロー。";super(i);d(this,"winner");this.winner=t}}class Ve extends Error{constructor(t,...i){super("message");d(this,"message");d(this,"items");this.message=t,this.items=i}}class Ys{constructor(e,t,i,r,s,o){d(this,"view");d(this,"log");d(this,"cardActionLog");d(this,"clock");d(this,"phase");d(this,"phaseStep");d(this,"nextPhaseList");d(this,"field");d(this,"attackingMonster");d(this,"targetForAttack");d(this,"duelists");d(this,"priorityHolder");d(this,"isEnded");d(this,"coin",!1);d(this,"getTurnPlayer",()=>this.clock.turn%2===0?this.secondPlayer:this.firstPlayer);d(this,"getNonTurnPlayer",()=>this.clock.turn%2===0?this.firstPlayer:this.secondPlayer);d(this,"main",async()=>{console.info("main start!"),this.coin=Math.random()>.5,this.priorityHolder=this.firstPlayer,this.log.info("【デュエル開始】"),this.log.info(`先攻：${this.firstPlayer.profile.name}`),Object.values(this.duelists).forEach(e=>e.pushDeck()),Object.values(this.duelists).forEach(e=>e.shuffleDeck()),await Promise.all(Object.values(this.duelists).map(e=>e.draw(5,void 0,void 0))),this.moveNextPhase("draw"),this.view.requireUpdate();try{for(;!this.isEnded&&(this.phase==="draw"?await this.procDrawPhase():this.phase==="standby"?await this.procStanbyPhase():this.phase==="main1"?await this.procMainPhase():this.phase==="battle"?await this.procBattlePhase():this.phase==="main2"?await this.procMainPhase():this.phase==="end"&&await this.procEndPhase(),!(this.clock.turn>1e3)););}catch(e){e instanceof gt?(console.info(e),this.isEnded=!0,this.log.info(e.winner?`デュエル終了。勝者${e.winner.profile.name}`:"引き分け")):e instanceof Error&&this.log.error(e)}finally{this.view.requireUpdate(),this.view.dispose(),this.log.dispose()}});d(this,"moveNextPhase",e=>{this.clock.turn<1?this.phase="draw":e==="draw"?this.log.info("ターン終了。",this.getTurnPlayer()):this.log.info(`フェイズ移行（${this.phase}→${e}）`,this.getTurnPlayer()),e==="draw"?this.clock.incrementTurn():this.clock.incrementPhaseSeq(),this.phase=e,this.phaseStep=void 0,this.phase==="main2"||this.clock.turn===1?this.nextPhaseList=["end"]:this.phase==="battle"?this.nextPhaseList=["main2"]:this.phase==="main1"?this.nextPhaseList=["battle","end"]:this.nextPhaseList=[]});d(this,"declareAnAttack",(e,t)=>{this.attackingMonster=e,this.targetForAttack=t,e.info.attackCount++,this.log.info(`攻撃宣言：${e.status.name} ⇒ ${t.status.name}`,e.controller)});d(this,"procDrawPhase",async()=>{for(Object.values(this.duelists).forEach(e=>{e.normalSummonCount=0,e.specialSummonCount=0}),this.log.info("ドローフェイズ開始。",this.getTurnPlayer()),this.clock.turn===1?this.log.info("先攻プレイヤーはドローできない。",this.getTurnPlayer()):await this.getTurnPlayer().draw(1,void 0,void 0);await this.procChainBlock(););this.field.getEntiteisOnField().forEach(e=>e.initForTurn()),this.moveNextPhase("standby")});d(this,"procStanbyPhase",async()=>{for(;await this.procChainBlock(););this.moveNextPhase("main1")});d(this,"procMainPhase",async()=>{for(;;){this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["NormalSummon","SpellTrapSet","SpecialSummon","ChangeBattlePosition","IgnitionEffect","QuickEffect","CardActivation"],["Normal","Quick","Counter"]),"あなたの手番です。");if(console.log(e),e.action){if([...Ws].includes(e.action.playType)){const i=await e.action.prepare(e.action.cell,!0);if(!i)continue;await e.action.execute(this.priorityHolder,e.action.cell,i),this.clock.incrementChainSeq()}else console.log(e),await this.procChainBlock(e.action);for(;await this.procChainBlock(););continue}const t=e.phaseChange;if(t){if(this.priorityHolder=this.getNonTurnPlayer(),await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect","TriggerEffect"],["Quick","Counter"]),"",!0)){this.procChainBlock();continue}this.moveNextPhase(t);return}}});d(this,"procBattlePhase",async()=>{await this.procBattlePhaseStartStep(),await this.procBattlePhaseBattleStep(),await this.procBattlePhaseEndStep()});d(this,"procBattlePhaseStartStep",async()=>{for(this.phaseStep="start",this.priorityHolder=this.getTurnPlayer(),this.attackingMonster=void 0,this.targetForAttack=void 0;await this.procChainBlock(););});d(this,"procBattlePhaseBattleStep",async()=>{for(;;){this.phaseStep="battle",this.priorityHolder=this.getTurnPlayer();const e=await this.view.waitFieldAction(this.getEnableActions(["Battle"],["Normal"]),"攻撃モンスターと対象を選択。");if(e.phaseChange)break;if(e.action){for(await e.action.execute(this.priorityHolder,e.action.cell),this.clock.incrementChainSeq();await this.procChainBlock(););this.clock.incrementStepSeq(),await this.procBattlePhaseDamageStep()}}this.clock.incrementStepSeq()});d(this,"procBattlePhaseDamageStep",async()=>{this.phaseStep="damage";const e=this.attackingMonster,t=this.targetForAttack;if(!e||!e.atk)throw new Ve("想定されない状態",this.attackingMonster,this.targetForAttack);this.log.info("ダメージステップ開始時",this.getTurnPlayer()),this.log.info("ダメージ計算前",this.getTurnPlayer()),(t==null?void 0:t.battlePotion)==="Set"&&t.setBattlePosition("Defense"),this.log.info("ダメージ計算時",this.getTurnPlayer());const i=e.atk,r=((t==null?void 0:t.battlePotion)==="Attack"?t.atk:t==null?void 0:t.def)||0;!t||t.entityType==="Duelist"?e.controller.getOpponentPlayer().battleDamage(i-r,e):i>0&&i>r?(t.battlePotion==="Attack"&&e.controller.getOpponentPlayer().battleDamage(i-r,e),t.info.isDying=!0):i<r?(e.controller.battleDamage(r-i,t),t.battlePotion==="Attack"&&(e.info.isDying=!0)):i===r&&t.battlePotion==="Attack"&&(e.info.isDying=!0,t.info.isDying=!0);const s=Object.values(this.duelists).filter(o=>o.lp<=0);if(s.length>0)throw new gt(Object.values(this.duelists).filter(o=>!s.includes(o)).pop());for(t&&e.info.isDying&&t.info.isDying&&e.owner!==t.owner?await Promise.all([e.destroy("BattleDestroy",[],t,t==null?void 0:t.controller),t.destroy("BattleDestroy",[],e,e.controller)]):(e.info.isDying&&await e.destroy("BattleDestroy",[],t,t==null?void 0:t.controller),t!=null&&t.info.isDying&&await t.destroy("BattleDestroy",[],e,e.controller)),this.clock.incrementChainSeq(),this.log.info("ダメージ計算後",this.getTurnPlayer());await this.procChainBlock(););this.log.info("ダメージステップ終了時",this.getTurnPlayer()),this.clock.incrementStepSeq()});d(this,"procBattlePhaseEndStep",async()=>{for(this.phaseStep="end",this.priorityHolder=this.getTurnPlayer();await this.procChainBlock(););this.moveNextPhase("main2")});d(this,"procEndPhase",async()=>{for(;await this.procChainBlock(););for(;;){const t=this.getTurnPlayer().getHandCell().cardEntities.length;if(t<7)break;await this.getTurnPlayer().discard(t-6,["Rule"])}this.moveNextPhase("draw")});d(this,"procChainBlock",async(e,t)=>{const i=this.clock.chainBlockSeq===0;let r;console.log(t==null?void 0:t.length);let s=t??Object.values(this.duelists).flatMap(o=>(this.priorityHolder=o,this.getEnableActions(["TriggerMandatoryEffect","TriggerEffect"],["Normal"])));console.log(s.length);try{if(e)return r=e,!0;if(s.length>0){const k=await this.selectTriggerEffect(s);if(k)return console.log(s.length),s=s.filter(p=>p!==k),console.log(s.length),r=k,!0}let o=0;for(;o<2;){this.priorityHolder=this.priorityHolder.getOpponentPlayer();const k=await this.view.waitQuickEffect(this.getEnableActions(["QuickEffect"],["Normal","Quick","Counter"]),"クイックエフェクト発動タイミング。効果を発動しますか？",!0);if(k)return r=k,!0;o++}return!1}finally{if(console.log(r),r){const o=r.entity.controller;r.playType==="CardActivation"?this.log.info(`${r.entity.nm}を発動`,o):this.log.info(`${r.entity.nm}«${r.title}»を発動`,o);const k=await r.prepare(r.cell);this.clock.incrementProcSeq(),this.clock.incrementChainBlockSeq(),await this.procChainBlock(void 0,s.filter(p=>p.seq!==(r==null?void 0:r.seq))),this.log.info(`${r.entity.nm}«${r.title}»の効果処理`,o),await r.execute(o,r.cell,k),this.clock.incrementProcSeq(),i&&(await Promise.all(this.field.getAllCells().filter(p=>p.cellType==="SpellAndTrapZone").flatMap(p=>p.entities).filter(p=>p.info.isDying).map(p=>p.sendToGraveyard(["Rule"],void 0,void 0))),this.clock.incrementChainSeq())}}});d(this,"selectTriggerEffect",async e=>{if(e.length>0)for(const t of["TriggerMandatoryEffect","TriggerEffect"])for(const i of[this.getTurnPlayer(),this.getNonTurnPlayer()]){this.priorityHolder=i;const r=e.filter(o=>o.playType===t&&o.entity.controller===i);if(r.length===0)continue;if(r.length===1&&t==="TriggerMandatoryEffect")return console.log(r[0]),r[0];const s=await this.view.waitQuickEffect(r,"効果を選択。",t==="TriggerEffect");if(s)return s}});d(this,"getEnableActions",(e,t)=>this.field.getAllCardEntities().filter(i=>i.controller===this.priorityHolder).flatMap(i=>i.actions).filter(i=>i.executableCells.includes(i.entity.fieldCell.cellType)).filter(i=>e.includes(i.playType)).filter(i=>t.includes(i.spellSpeed)).filter(i=>i.validate()));this.phase="end",this.clock=new js,this.nextPhaseList=[],this.isEnded=!1,this.duelists={Below:new Pi(this,"Below",e,t,i),Above:new Pi(this,"Above",r,s,o)},this.priorityHolder=this.firstPlayer,this.field=new Zs(this),this.view=new $s(this),this.log=new Us(this),this.cardActionLog=new Gs(this)}get firstPlayer(){return this.coin?this.duelists.Below:this.duelists.Above}get secondPlayer(){return this.coin?this.duelists.Above:this.duelists.Below}}const zs=()=>{const n=[],e={title:"特殊召喚",playType:"SpecialSummon",spellSpeed:"Normal",executableCells:["Hand"],validate:a=>{const A=a.field.getMonstersOnField();if(A.length==0||A.some(w=>w.controller===a.controller))return;const u=a.controller.getAvailableMonsterZones();return u.length>0?u:void 0},prepare:async()=>!0,execute:async(a,A,u)=>{const w=a.controller.getAvailableMonsterZones();return await a.field.summon(a,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Rule"],a,void 0,!0),a.controller.specialSummonCount++,!0}},t={name:"サイバー・ドラゴン",actions:[it,qe,We,e]};n.push(t);const i={name:"アンノウン・シンクロン",actions:[it,qe,We,{...e,isOnlyNTimesPerDuel:1}]};n.push(i);const r={name:"Ｄ－ＨＥＲＯ ディアボリックガイ",actions:[it,qe,We,{title:"①リクルート",playType:"IgnitionEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:a=>a.controller.getDeckCell().cardEntities.filter(u=>u.nm==="Ｄ－ＨＥＲＯ ディアボリックガイ").length===0?void 0:a.controller.getAvailableMonsterZones().length>0?[]:void 0,prepare:async a=>{console.log(a),await a.banish(["Cost"],a,a.controller)},execute:async(a,A,u)=>{const w=a.controller.getAvailableMonsterZones();if(!w.length)return!1;const C=a.controller.getDeckCell().cardEntities.find(v=>v.nm==="Ｄ－ＨＥＲＯ ディアボリックガイ");return C?(await a.field.summon(C,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],a),a.controller.specialSummonCount++,!0):!1}}]};n.push(r);const s={name:"ゾンビキャリア",actions:[it,qe,We,{title:"①自己再生",playType:"IgnitionEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:a=>{if(a.controller.getHandCell().cardEntities.length===0)return;const A=a.controller.getAvailableMonsterZones();return A.length>0?A:void 0},prepare:async a=>{const A=a.controller.getHandCell().cardEntities,u=await a.controller.duel.view.waitSelectEntities(a.controller,A,1,w=>w.length===1,"デッキトップに戻すカードを一枚選択。");if(!u)throw new Ve("キャンセル不可の行動がキャンセルされた。",a);return await u[0].returnToDeck("Top",["Cost"],a,a.controller),!0},execute:async(a,A,u)=>{if(A.duel.clock.isSameChain(a.wasMovedAt))return!1;const w=a.controller.getAvailableMonsterZones();return w.length===0?!1:(await a.field.summon(a,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],a),a.info.willBeBanished=!0,a.controller.specialSummonCount++,!0)}}]};n.push(s);const o={name:"グローアップ・バルブ",actions:[it,qe,We,{title:"①自己再生",playType:"IgnitionEffect",spellSpeed:"Normal",executableCells:["Graveyard"],isOnlyNTimesPerDuel:1,validate:a=>{if(a.controller.getDeckCell().cardEntities.length===0)return;const A=a.controller.getAvailableMonsterZones();return A.length>0?A:void 0},prepare:async a=>(await a.controller.getDeckCell().cardEntities[0].sendToGraveyard(["Cost"],a,a.controller),!0),execute:async(a,A,u)=>{if(A.duel.clock.isSameChain(a.wasMovedAt))return!1;const w=a.controller.getAvailableMonsterZones();return w.length===0?!1:(await a.field.summon(a,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],a,A),a.controller.specialSummonCount++,!0)}}]};n.push(o);const k={name:"終末の騎士",actions:[it,qe,We,{title:"①墓地送り",playType:"TriggerEffect",spellSpeed:"Normal",executableCells:["MonsterZone"],canExecuteOnDamageStep:!0,validate:a=>{if(a.wasMovedAs.union(["SpecialSummon","NormalSummon"]).length!==0&&a.field.duel.clock.isPreviousChain(a.wasMovedAt)&&a.controller.getDeckCell().cardEntities.filter(A=>A.attr.includes("Dark")).length!==0)return[]},prepare:()=>!0,execute:async(a,A)=>{const u=a.controller.getDeckCell().cardEntities.filter(w=>w.attr.includes("Dark"));return u.length===0?!1:(await a.field.sendToGraveyard("墓地に送るモンスターを選択",A,u,1,w=>w.length===1,["Effect"],a,!1),A.shuffleDeck(),!0)}}]};n.push(k);const p={name:"マスマティシャン",actions:[it,qe,We,{title:"①墓地送り",playType:"TriggerEffect",spellSpeed:"Normal",executableCells:["MonsterZone"],validate:a=>{if(a.wasMovedAs.includes("NormalSummon")&&a.isMoveAtPreviousChain&&a.controller.getDeckCell().cardEntities.find(A=>(A.lvl??5)<5))return[]},prepare:()=>!0,execute:async(a,A)=>{const u=a.controller.getDeckCell().cardEntities.filter(w=>(w.lvl??5)<5);return u.length===0?!1:(await a.field.sendToGraveyard("墓地に送るモンスターを選択",A,u,1,w=>w.length===1,["Effect"],a,!1),A.shuffleDeck(),!0)}},{title:"②ドロー",playType:"TriggerEffect",spellSpeed:"Normal",executableCells:["Graveyard"],canExecuteOnDamageStep:!0,validate:a=>{if(a.wasMovedAs.includes("BattleDestroy")&&a.isMoveAtPreviousChain&&a.controller.getDeckCell().cardEntities.length!==0)return[]},prepare:()=>!0,execute:async(a,A)=>(await A.draw(1,a,A),!0)}]};n.push(p);const c={name:"大地の騎士ガイアナイト",actions:[qe,We,Ki()]};n.push(c),n.push({...c,name:"スクラップ・デスデーモン"});const m={name:"ナチュル・ガオドレイク",actions:[qe,We,Ki(a=>a.length===1&&a.every(A=>A.attr.some(u=>u==="Earth")),a=>a.length>0&&a.every(A=>A.attr.some(u=>u==="Earth")))]};n.push(m);const f={name:"ライトロード・ビースト ウォルフ",actions:[qe,We,{title:"①自己再生",playType:"TriggerMandatoryEffect",spellSpeed:"Normal",executableCells:["Graveyard"],validate:a=>{var u;if(!a.field.duel.clock.isPreviousChain(a.wasMovedAt)||((u=a.wasMovedFrom)==null?void 0:u.cellType)!=="Deck")return;const A=a.controller.getAvailableMonsterZones();return console.log(A),A.length>0?[]:void 0},prepare:async a=>(console.log(a),!0),execute:async(a,A,u)=>{if(A.duel.clock.isSameChain(a.wasMovedAt))return!1;const w=a.controller.getAvailableMonsterZones();return!w.length||a.fieldCell.cellType!=="Graveyard"&&a.fieldCell.cellType!=="Banished"||a.face==="FaceDown"?!1:(await a.field.summon(a,["Attack","Defense"],u?[u]:w,"SpecialSummon",["Effect"],a),a.controller.specialSummonCount++,!0)}}]};return n.push(f),[{name:"キラー・ポテト",filter:a=>a.attr.includes("Dark")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["EffectDestroy"],executableCells:["Graveyard"]},{name:"キラー・トマト",filter:a=>a.attr.includes("Dark")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"巨大ネズミ",filter:a=>a.attr.includes("Earth")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"グリズリーマザー",filter:a=>a.attr.includes("Water")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"シャインエンジェル",filter:a=>a.attr.includes("Light")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ドラゴンフライ",filter:a=>a.attr.includes("Wind")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ＵＦＯタートル",filter:a=>a.attr.includes("Fire")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"荒野の女戦士",filter:a=>a.attr.includes("Earth")&&a.type.includes("Warrior")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"リトル・トルーパー",filter:a=>a.type.includes("Warrior")&&(a.lvl??9999)<3,qtyList:[1],posList:["Set"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard","Banished"]},{name:"破面竜",filter:a=>a.type.includes("Warrior")&&(a.def??9999)<=1500,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"共鳴虫",filter:a=>a.type.includes("Insect")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ピラミッド・タートル",filter:a=>a.type.includes("Zombie")&&(a.def??9999)<=2e3,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ユーフォロイド",filter:a=>a.type.includes("Machine")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ヘル・セキュリティ",filter:a=>a.type.includes("Fiend")&&(a.lvl??9999)===1,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ガスタ・イグル",filter:a=>(a.status.nameTags??[]).includes("ガスタ")&&(a.status.monsterCategories??[]).includes("Tuner"),qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"幻影の魔術士",filter:a=>(a.status.nameTags??[]).includes("ＨＥＲＯ")&&(a.atk??9999)<=1e3,qtyList:[1],posList:["Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ジェネクス・サーチャー",filter:a=>(a.status.nameTags??[]).includes("ジェネクス")&&(a.atk??9999)<=1500,qtyList:[1],posList:["Attack"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"紫炎の足軽",filter:a=>(a.status.nameTags??[]).includes("六武衆")&&(a.lvl??12)<=3,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"スレイブ・エイプ",filter:a=>(a.status.nameTags??[]).includes("剣闘獣")&&(a.lvl??12)<=4,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ゼンマイハニー",filter:a=>(a.status.nameTags??[]).includes("ゼンマイ")&&(a.lvl??12)<=4,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ＸＸ－セイバー エマーズブレイド",filter:a=>(a.status.nameTags??[]).includes("Ｘ－セイバー")&&(a.lvl??12)<=4,qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"軍隊竜",filter:a=>a.nm==="軍隊竜",qtyList:[1],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"アサルト・ガンドッグ",filter:a=>a.nm==="アサルト・ガンドッグ",qtyList:[1,2,3,4,5],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]},{name:"ハイエナ",filter:a=>a.nm==="ハイエナ",qtyList:[1,2,3,4,5],posList:["Attack","Defense"],destoryTypes:["BattleDestroy"],executableCells:["Graveyard"]}].forEach(a=>{n.push({name:a.name,actions:[Hs(a.filter,a.qtyList,a.posList,a.destoryTypes,a.executableCells),qe,We,it]})}),n},Vs=()=>{const n=[],e={name:"強欲な壺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(!(a.controller.getDeckCell().cardEntities.length<2))return Te(a)},prepare:xe,execute:async(a,A)=>(await A.draw(2,a,A),!0)},Ee]};n.push(e);const t={name:"貪欲な壺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(!(a.controller.getGraveyard().cardEntities.filter(A=>A.status.kind==="Monster").length<5))return Te(a)},prepare:async(a,A)=>{const u=await a.field.duel.view.waitSelectEntities(a.controller,a.controller.getGraveyard().cardEntities.filter(w=>w.status.kind==="Monster"),5,w=>w.length===5,"デッキに戻すモンスターを選択。",!1);if(u)return await xe(a,A),u},execute:async(a,A,u,w)=>{if(w.some(v=>A.duel.clock.isSameChain(v.wasMovedAt)))return!1;const C=[];for(const v of w){const g=await v.returnToDeck("Top",["Effect"],a,A);g&&C.push(g)}return C.getDistinct().filter(v=>v.cellType==="Deck").forEach(v=>v.shuffle()),await A.draw(2,a,A),!0}},Ee]};n.push(t);const i={name:"天使の施し",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(!(a.controller.getDeckCell().cardEntities.length<3))return Te(a)},prepare:xe,execute:async(a,A)=>(await A.draw(3,a,A),await A.discard(2,["Effect","Discard"],a,A),!0)},Ee]};n.push(i);const r={name:"成金ゴブリン",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(!(a.controller.getDeckCell().cardEntities.length<1))return Te(a)},prepare:xe,execute:async(a,A)=>(await A.draw(1,a,A),a.field.duel.clock.incrementProcSeq(),A.getOpponentPlayer().heal(1e3,a),!0)},Ee]};n.push(r);const s={name:"おろかな埋葬",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(a.controller.getDeckCell().cardEntities.filter(A=>A.status.kind==="Monster").length!==0)return Te(a)},prepare:xe,execute:async(a,A)=>{const u=A.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster");if(u.length===0)return!1;const w=await a.field.duel.view.waitSelectEntities(A,u,1,C=>C.length===1,"墓地に送るモンスターを選択",!1);for(const C of w??[])await C.sendToGraveyard(["Effect"],a,A);return await A.shuffleDeck(),!0}},Ee]};n.push(s);const o={name:"おろかな副葬",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],isOnlyNTimesPerTurn:1,validate:a=>{if(a.controller.getDeckCell().cardEntities.filter(A=>A.status.kind!=="Monster").length!==0)return Te(a)},prepare:xe,execute:async(a,A)=>{const u=A.getDeckCell().cardEntities.filter(C=>C.status.kind!=="Monster");if(u.length===0)return!1;const w=await a.field.duel.view.waitSelectEntities(A,u,1,C=>C.length===1,"墓地に送る魔法罠を選択",!1);for(const C of w??[])await C.sendToGraveyard(["Effect"],a,A);return await A.shuffleDeck(),!0}},Ee]};n.push(o);const k={name:"死者蘇生",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],hasToTargetCards:!0,validate:a=>{if(a.field.getCells("Graveyard").flatMap(A=>A.cardEntities).filter(A=>A.status.kind==="Monster"&&A.info.isRebornable).length!==0&&a.controller.getAvailableMonsterZones().length!==0)return Te(a)},prepare:async(a,A)=>{const u=await a.field.duel.view.waitSelectEntities(a.controller,a.field.getCells("Graveyard").flatMap(w=>w.cardEntities).filter(w=>w.origin.kind==="Monster"&&w.info.isRebornable),1,w=>w.length===1,"蘇生対象とするモンスターを選択",!1);return await xe(a,A),u==null?void 0:u[0]},execute:async(a,A,u,w)=>{const C=A.getEmptyMonsterZones();return w.controller=A,await a.field.summon(w,["Attack","Defense"],C,"SpecialSummon",["Effect"],a,void 0,!1),a.controller.specialSummonCount++,!0}},Ee]};n.push(k);const p={name:"手札抹殺",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(!(a.controller.getDeckCell().cardEntities.length<a.controller.getHandCell().cardEntities.filter(A=>A.seq!==a.seq).length)&&a.field.getAllCells().filter(A=>A.cellType==="Hand").flatMap(A=>A.cardEntities).filter(A=>A.seq!==a.seq).length!==0)return Te(a)},prepare:xe,execute:async(a,A)=>{const u=A.getHandCell().cardEntities.length,w=A.getOpponentPlayer().getHandCell().cardEntities.length;return await a.field.sendGraveyardAtSameTime(a.field.getCells("Hand").flatMap(C=>C.cardEntities),["Effect","Discard"],a,A),A.duel.clock.incrementProcSeq(),await a.field.drawAtSameTime(A,u,A.getOpponentPlayer(),w,a,A),!0}},Ee]};n.push(p);const c={name:"光の援軍",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(!(a.controller.getDeckCell().cardEntities.length<4)&&a.controller.getDeckCell().cardEntities.filter(A=>A.status.kind==="Monster").filter(A=>(A.lvl??13)<5).filter(A=>A.status.nameTags&&A.status.nameTags.includes("ライトロード")).length!==0)return Te(a)},prepare:async(a,A)=>{const u=a.controller.getDeckCell();return Array(3).forEach(()=>u.cardEntities[0].sendToGraveyard(["Cost"],a,a.controller)),await xe(a,A)},execute:async(a,A)=>{const u=A.getDeckCell().cardEntities.filter(C=>C.status.kind==="Monster").filter(C=>(C.lvl??13)<5).filter(C=>C.status.nameTags&&C.status.nameTags.includes("ライトロード"));if(u.length===0)return!1;const w=await a.field.duel.view.waitSelectEntities(A,u,1,C=>C.length===1,"手札に加えるモンスターを選択",!1);for(const C of w??[])await C.addToHand(["Effect"],a,A);return!0}},Ee]};n.push(c);const m={name:"調律",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{const A=a.controller.getDeckCell().cardEntities;if(!(A.length<2)&&A.filter(u=>{var w;return(w=u.status.nameTags)==null?void 0:w.includes("シンクロン")}).filter(u=>{var w;return(w=u.status.monsterCategories)==null?void 0:w.includes("Tuner")}).length!==0)return Te(a)},prepare:xe,execute:async(a,A)=>{const u=A.getDeckCell().cardEntities;if(u.length<2)return;const w=u.filter(v=>{var g;return(g=v.status.nameTags)==null?void 0:g.includes("シンクロン")}).filter(v=>{var g;return(g=v.status.monsterCategories)==null?void 0:g.includes("Tuner")});if(w.length===0)return!1;const C=await a.field.duel.view.waitSelectEntities(A,w,1,v=>v.length===1,"手札に加えるモンスターを選択",!1);for(const v of C??[])await v.addToHand(["Effect"],a,A);return A.duel.clock.incrementProcSeq(),A.getDeckCell().shuffle(),await A.getDeckCell().cardEntities[0].sendToGraveyard(["Effect"],a,A),!0}},Ee]};n.push(m);const f={name:"ワン・フォー・ワン",actions:[{title:"発動",playType:"CardActivation",spellSpeed:"Normal",executableCells:["Hand","SpellAndTrapZone"],validate:a=>{if(a.controller.getDeckCell().cardEntities.filter(A=>A.lvl===1).length===0){if(a.controller.getHandCell().cardEntities.filter(A=>A.lvl===1).length===0||a.controller.getHandCell().cardEntities.filter(A=>A.status.kind==="Monster").length<2)return}else if(a.controller.getHandCell().cardEntities.filter(A=>A.status.kind==="Monster").length===0)return;return Te(a)},prepare:async(a,A)=>{let u=a.controller.getHandCell().cardEntities.filter(C=>C.status.kind==="Monster");if(a.controller.getDeckCell().cardEntities.filter(C=>C.lvl===1).length===0){const C=a.controller.getHandCell().cardEntities.filter(v=>v.lvl===1);C.length===1&&(u=u.filter(v=>v!==C[0]))}if(await a.field.sendToGraveyard("墓地送るモンスターを選択",a.controller,u,1,C=>C.length===1,["Cost"],a,!0))return await xe(a,A)},execute:async(a,A)=>{const u=[...a.controller.getDeckCell().cardEntities.filter(C=>C.lvl===1),...a.controller.getHandCell().cardEntities.filter(C=>C.lvl===1)];if(u.length===0)return!1;const w=await a.field.duel.view.waitSelectEntities(A,u,1,C=>C.length===1,"特殊召喚するモンスターを選択",!1);if(!w)throw new Error("illegal state");return await a.field.summon(w[0],["Attack","Defense"],A.getAvailableMonsterZones(),"SpecialSummon",["Effect"],a,A,!1),A.shuffleDeck(),!0}},Ee]};return n.push(f),[{name:"増援",filter:a=>a.origin.kind==="Monster"&&a.origin.type==="Warrior"&&(a.origin.level??5)<5},{name:"化石調査",filter:a=>a.origin.kind==="Monster"&&a.origin.type==="Dinosaur"&&(a.origin.level??6)<6},{name:"Ｅ－エマージェンシーコール",filter:a=>a.origin.kind==="Monster"&&(a.origin.nameTags??[]).includes("Ｅ・ＨＥＲＯ")},{name:"召集の聖刻印",filter:a=>a.origin.kind==="Monster"&&(a.origin.nameTags??[]).includes("聖刻")},{name:"召喚師のスキル",filter:a=>a.origin.kind==="Monster"&&(a.origin.monsterCategories??[]).includes("Normal")&&(a.origin.level??4)>4},{name:"トゥーンのもくじ",filter:a=>(a.origin.nameTags??[]).includes("トゥーン")},{name:"融合賢者",filter:a=>a.origin.name==="融合"},{name:"虹の架け橋",filter:a=>a.origin.kind!=="Monster"&&(a.origin.nameTags??[]).includes("宝玉")},{name:"紫炎の狼煙",filter:a=>a.origin.kind==="Monster"&&(a.origin.nameTags??[]).includes("六武衆")&&(a.origin.level??4)<4},{name:"テラ・フォーミング",filter:a=>a.origin.kind==="Spell"&&a.origin.spellCategory==="Field"},{name:"コール・リゾネーター",filter:a=>a.origin.kind==="Monster"&&(a.origin.nameTags??[]).includes("リゾネーター")}].forEach(a=>{n.push({name:a.name,actions:[Ss(a.filter),Ee]})}),[{name:"戦士の生還",filter:a=>a.status.kind==="Monster"&&a.type.includes("Warrior"),qty:1},{name:"ダーク・バースト",filter:a=>a.status.kind==="Monster"&&a.attr.includes("Dark")&&(a.atk??9999)<=1500,qty:1},{name:"悪夢再び",filter:a=>a.status.kind==="Monster"&&a.attr.includes("Dark")&&(a.def??9999)===0,qty:2},{name:"サルベージ",filter:a=>a.status.kind==="Monster"&&a.attr.includes("Water")&&(a.atk??9999)<=1500,qty:2},{name:"バッテリーリサイクル",filter:a=>a.status.kind==="Monster"&&a.type.includes("Thunder")&&(a.atk??9999)<=1500,qty:2},{name:"闇の量産工場",filter:a=>a.status.kind==="Monster"&&(a.status.monsterCategories??[]).includes("Normal"),qty:2}].forEach(a=>{n.push({name:a.name,actions:[Ks(a.filter,a.qty),Ee]})}),[{name:"トレード・イン",filter:a=>a.status.kind==="Monster"&&(a.lvl??0)===8},{name:"調和の宝札",filter:a=>a.status.kind==="Monster"&&(a.origin.monsterCategories??[]).includes("Tuner")&&a.type.includes("Dragon")&&(a.atk??9999)<=1e3},{name:"デステニー・ドロー",filter:a=>a.status.kind==="Monster"&&(a.origin.nameTags??[]).includes("Ｄ－ＨＥＲＯ")}].forEach(a=>{n.push({name:a.name,actions:[Ps(a.filter),Ee]})}),[{name:"火の粉",calcHeal:()=>[0,-200]},{name:"雷鳴",calcHeal:()=>[0,-300]},{name:"ファイヤー・ボール",calcHeal:()=>[0,-500]},{name:"火あぶりの刑",calcHeal:()=>[0,-600]},{name:"昼夜の大火事",calcHeal:()=>[0,-800]},{name:"火炎地獄",calcHeal:()=>[-500,-1e3]},{name:"盗人ゴブリン",calcHeal:()=>[500,-500]},{name:"ブルー・ポーション",calcHeal:()=>[400,0]},{name:"レッド・ポーション",calcHeal:()=>[500,0]},{name:"ゴブリンの秘薬",calcHeal:()=>[600,0]},{name:"天使の生き血",calcHeal:()=>[800,0]},{name:"治療の神 ディアン・ケト",calcHeal:()=>[1e3,0]},{name:"恵みの雨",calcHeal:()=>[1e3,1e3]}].forEach(a=>{n.push({name:a.name,actions:[qs(a.calcHeal),Ee]})}),n},Qs=()=>{const n=[...zs(),...Vs()];return n.forEach(e=>console.log(e.name)),n},_a=new Map;Qs().forEach(n=>{_a.set(n.name,n.actions)});const Jn=_a,Js=ps,be=Object.values(Js).reduce((n,e)=>(n[e.name]=e,n),{}),oe=class oe{constructor(e,t){d(this,"id");d(this,"name");d(this,"description");d(this,"lastUsedAt");d(this,"cardNames");d(this,"getIllegalCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(be).includes(e)))));d(this,"getDisableCardNames",()=>Array.from(new Set(this.cardNames.filter(e=>!Object.keys(be).includes(e)))));d(this,"createCardInfos",()=>{const e=this.getIllegalCardNames();if(e.length>0)throw new Error(`存在しないカード名からデッキを生成しようとした。${e}`);return this.cardNames.map(t=>be==null?void 0:be[t]).filter(t=>t)});d(this,"copy",async()=>oe.createNewDeck(this.name,this.description,this.cardNames));d(this,"updateTimestamp",async()=>{await oe.tblHeader.update(this.id,e=>({...e,lastUsedAt:new Date}))});d(this,"saveDeckInfo",async e=>{const t=e??this;await oe.tblHeader.update(this.id,s=>({...s,name:t.name,description:t.description,lastUsedAt:new Date}));const i=(await oe.tblDetail.getAll()).filter(s=>s.deckId===this.id);console.log(t.cardNames),await oe.tblDetail.delete(i.map(s=>s.id));const r=await oe.tblDetail.insertMany(t.cardNames.map((s,o)=>({deckId:this.id,seq:o,name:s,description:""})));return console.log(r),new oe(await oe.tblHeader.get(this.id),r)});d(this,"delete",async()=>{await oe.tblHeader.delete([this.id]);const e=(await oe.tblDetail.getAll()).filter(t=>t.deckId===this.id);await oe.tblDetail.delete(e.map(t=>t.id))});this.id=e.id,this.name=e.name,this.description=e.description,this.lastUsedAt=e.lastUsedAt,this.cardNames=t.filter(i=>i.deckId===this.id).map(i=>i.name)}};d(oe,"idb"),d(oe,"tblHeader"),d(oe,"tblDetail"),d(oe,"getAllDeckInfo",async e=>{if(e&&(oe.idb=e),!oe.idb)throw new Error("illegal argument: idb is undefined.");oe.tblHeader||(oe.tblHeader=new Xs(oe.idb)),oe.tblDetail||(oe.tblDetail=new eo(oe.idb));const t=await oe.tblHeader.getAll(),i=await oe.tblDetail.getAll();return t.length?t.map(r=>new oe(r,i)):[await oe.prepareSampleDeck()]}),d(oe,"createNewDeck",async(e,t,i)=>{const r=await oe.tblHeader.insert({name:e,description:t,lastUsedAt:new Date}),s=await oe.tblDetail.insertMany(i.map((o,k)=>({deckId:r.id,seq:k,name:o,description:""})));return new oe(r,s)}),d(oe,"prepareSampleDeck",async()=>await oe.createNewDeck(kn[0].name,kn[0].description,kn[0].cardNames));let vt=oe;class Xs extends ki{constructor(t){super(t,"TblDeckHeader");d(this,"_prepareInitialRecords",()=>[])}}class eo extends ki{constructor(t){super(t,"TblDeckDetail");d(this,"_prepareInitialRecords",()=>[])}}let to=-1,zt=["おろかな埋葬","成金ゴブリン","強欲な壺","天使の施し","増援","トレード・イン","調和の宝札","死者蘇生","召喚師のスキル","サイバー・ドラゴン","Ｄ－ＨＥＲＯ ディアボリックガイ","ライトロード・ビースト ウォルフ","ナチュル・ガオドレイク","スクラップ・デスデーモン","大地の騎士ガイアナイト","青眼の白龍"];zt=[...zt,...zt,...zt,"Ｅ－エマージェンシーコール","闇の量産工場","戦士の生還","トレード・イン","ジェネティック・ワーウルフ","ジョングルグールの幻術師","ゾンビーノ","フロストザウルス","しゃりの軍貫","チューン・ウォリアー","貪欲な壺","ガード・オブ・フレムベル","ギャラクシーサーペント","ハロハロ","ラブラドライドラゴン","守護竜ユスティア","Ｅ・ＨＥＲＯ クレイマン","Ｅ・ＨＥＲＯ スパークマン","Ｅ・ＨＥＲＯ ネオス","Ｅ・ＨＥＲＯ バーストレディ","Ｅ・ＨＥＲＯ フェザーマン"];const kn=[{id:to--,name:"サンプルデッキ１",description:"",lastUsedAt:new Date,cardNames:zt}];function no(n){const e=n-1;return e*e*e+1}function Wi(n,e){for(const t in e)n[t]=e[t];return n}function io({fallback:n,...e}){const t=new Map,i=new Map;function r(o,k,p){const{delay:c=0,duration:m=b=>Math.sqrt(b)*30,easing:f=no}=Wi(Wi({},e),p),a=o.getBoundingClientRect(),A=k.getBoundingClientRect(),u=a.left-A.left,w=a.top-A.top,C=a.width/A.width,v=a.height/A.height,g=Math.sqrt(u*u+w*w),S=getComputedStyle(k),q=S.transform==="none"?"":S.transform,L=+S.opacity;return{delay:c,duration:typeof m=="function"?m(g):m,easing:f,css:(b,$)=>`
			   opacity: ${b*L};
			   transform-origin: top left;
			   transform: ${q} translate(${$*u}px,${$*w}px) scale(${b+(1-b)*C}, ${b+(1-b)*v});
		   `}}function s(o,k,p){return(c,m)=>(o.set(m.key,c),()=>{if(k.has(m.key)){const f=k.get(m.key);return k.delete(m.key),r(f,c,m)}return o.delete(m.key),n&&n(c,m,p)})}return[s(i,t,!1),s(t,i,!0)]}var ao=N("<div></div>"),ro=N('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>'),so=N('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div> <div class="svelte-1y7jo5c"> </div></div>'),oo=N('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div> <div class="svelte-1y7jo5c"> </div></div>'),lo=N('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>'),Ao=N('<div class="duel_card_row svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div></div> <div class="duel_card_row duel_card_row_wide svelte-1y7jo5c"><div class="svelte-1y7jo5c"> </div> <div class="svelte-1y7jo5c"> </div></div>',1),po=N('<button><div class="duel_card duel_card_face_up svelte-1y7jo5c"><div class="duel_card_row svelte-1y7jo5c" style="position:relative"><div class="svelte-1y7jo5c"> </div> <!></div> <!> <!> <!></div></button>'),co=N('<div class="duel_card duel_card_face_down duel_card_face_down_defense svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div></div>'),ko=N('<div class="duel_card duel_card_face_down svelte-1y7jo5c"><div class="svelte-1y7jo5c"></div></div>');function rt(n,e){Fe(e,!1);let t=fe(e,"entity",8),i=fe(e,"state",8,"Disabled"),r=fe(e,"selectedList",28,()=>[]),s=fe(e,"isVisibleForcibly",8,!1),o=fe(e,"isWideMode",8,!1),k=fe(e,"actions",24,()=>[]),p=fe(e,"cardActionResolve",8),c=fe(e,"entitySelectResolve",8,()=>{}),m=Ce(!1),f=()=>{},a=fe(e,"qty",12,void 0);const A=E=>{te(m,!1),a(E.qty),f=E.resolve};t().field.duel.view.onWaitStart.append(A);let u=Ce(!1);const w=()=>{if(i()!=="Disabled"&&(console.log(a()),i()==="Selectable"&&a()&&a()===1)){if(r().some(E=>E.seq!==t().seq)){r([t()]);return}a()&&a()===1&&c()&&c()([t()])}},C=()=>{(t().face==="FaceUp"||t().owner===t().field.duel.duelists.Below&&(t().isUnderControl||s()))&&t().field.duel.view.showCardInfo(t())},v=()=>{if(console.log(t(),i()),C(),i()==="Disabled")return;if(i()==="Selectable"){te(m,!l(m)),r(l(m)?[...r(),t()]:r().filter(U=>U!==t()));return}if(k().length===0)return;if(k().length===1){if(k()[0].dragAndDropOnly)return;if(p()){p()(k()[0]);return}console.log(k()[0],f),f({action:k()[0]});return}const E=t().field.duel.view;E.modalController.selectAction(E,{title:"行動を選択。",actions:k(),cancelable:!0}).then(U=>{f({action:U})})},g=E=>{console.info("drag start",E,k()),t().field.duel.view.setDraggingActions(k()),te(u,!0)},S=E=>{console.info("drag end",E,k()),t().field.duel.view.removeDraggingActions(),E.dataTransfer&&te(u,!1)};Ie();var q=he(),L=ie(q);{var b=E=>{var U=po(),re=h(U),se=h(re),me=h(se),ue=h(me),X=D(me,2);ke(X,1,()=>t().attr,ce,(F,P)=>{var H=ao();W(()=>we(H,`monster_attr ${l(P)??""} svelte-1y7jo5c`)),y(F,H)});var x=D(se,2);{var I=F=>{var P=ro(),H=h(P),j=h(H),z=D(H,2),G=h(z);W((Q,ae)=>{_(j,Q),_(G,ae)},[()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0)],ye),y(F,P)},ne=F=>{var P=he(),H=ie(P);{var j=G=>{var Q=so(),ae=D(h(Q),2),J=h(ae);W(()=>_(J,`${an[t().status.spellCategory]??""}魔法`)),y(G,Q)},z=G=>{var Q=he(),ae=ie(Q);{var J=T=>{var B=oo(),Y=D(h(B),2),M=h(Y);W(()=>_(M,`${rn[t().status.trapCategory]??""}罠`)),y(T,B)};R(ae,T=>{t().status.kind==="Trap"&&t().status.trapCategory&&T(J)},!0)}y(G,Q)};R(H,G=>{t().status.kind==="Spell"&&t().status.spellCategory?G(j):G(z,!1)},!0)}y(F,P)};R(x,F=>{t().status.kind==="Monster"?F(I):F(ne,!1)})}var Z=D(x,2);{var ee=F=>{var P=lo(),H=h(P),j=h(H),z=D(H,2),G=h(z);W(()=>{_(j,`◀ ${t().psL??""}`),_(G,`${t().psR??""} ▶`)}),y(F,P)};R(Z,F=>{var P;(P=t().status.monsterCategories)!=null&&P.includes("Pendulum")&&F(ee)})}var K=D(Z,2);{var V=F=>{var P=Ao(),H=ie(P),j=h(H),z=h(j),G=D(H,2),Q=h(G),ae=h(Q),J=D(Q,2),T=h(J);W((B,Y,M)=>{Dt(j,"title",B),_(z,Y),_(ae,M),_(T,`${t().atk??"?"} / ${t().def??"?"}`)},[()=>{var B;return(B=t().status.monsterCategories)==null?void 0:B.join(" ")},()=>{var B;return(B=t().status.monsterCategories)==null?void 0:B.map(Y=>nn[Y]+(o()?Fn[Y]:"")).join()},()=>t().type.map(B=>sn[B]+(o()?Hn[B]:"")).join()],ye),y(F,P)};R(K,F=>{t().status.kind==="Monster"&&F(V)})}W(F=>{we(U,`duel_card button_style_reset ${t().status.kind??""} ${F??""} ${(l(m)?"duel_card_selected":"")??""} ${i()??""} duel_card_${t().orientation??""} ${(l(u)?"isDragging":"")??""} ${(o()?"duel_card_wide":"")??""} svelte-1y7jo5c`),Dt(U,"draggable",i()==="Draggable"),Dt(U,"title",t().nm),_(ue,t().nm)},[()=>{var F;return((F=t().status.monsterCategories)==null?void 0:F.join(" "))||""}],ye),ge("dragstart",U,g),ge("dragend",U,S),ge("click",U,v),ge("dblclick",U,w),ge("mouseenter",U,C),y(E,U)},$=E=>{var U=he(),re=ie(U);{var se=ue=>{var X=co();y(ue,X)},me=ue=>{var X=ko();y(ue,X)};R(re,ue=>{t().battlePotion==="Set"?ue(se):ue(me,!1)},!0)}y(E,U)};R(L,E=>{t().face==="FaceUp"||s()||t().controller.seat==="Below"&&t().isUnderControl?E(b):E($,!1)})}y(n,q),He()}var mo=N('<div class="phase_display svelte-1mupj1p"><span class="svelte-1mupj1p"> </span> </div>'),uo=N('<div class="lifepoint_display svelte-1mupj1p"><div class="svelte-1mupj1p"> </div> <div class="svelte-1mupj1p"> </div></div>'),ho=(n,e,t)=>e(l(t)),fo=N('<div class="svelte-1mupj1p"><button class="phase_button svelte-1mupj1p"> </button></div>'),wo=N("<div><!></div>"),Co=N('<div class="svelte-1mupj1p"><!></div>'),Do=N("<div><!></div>"),yo=N("<!> <!> <!>",1),go=N('<div style="position: absolute;" class="card_animation_receiver svelte-1mupj1p"><!></div>'),vo=N('<div style="position: absolute; display:flex;justify-content: center;" class="svelte-1mupj1p"><!></div>'),Bo=N('<div style="position: absolute; bottom:0rem" class="svelte-1mupj1p"> </div>'),Eo=N("<!> <!>",1),To=N('<div class="badge svelte-1mupj1p"> </div>'),xo=N('<div class="card_animation_receiver svelte-1mupj1p"><!></div>'),Mo=N("<!> <!> <!> <!>",1),No=N('<td><div role="listitem"><!></div></td>');function bo(n,e){Fe(e,!1);let t=fe(e,"view",8),i=fe(e,"row",8),r=fe(e,"column",8),s=fe(e,"selectedList",28,()=>[]),o=Ce(t().getCell(i(),r()));const k=()=>{te(o,t().getCell(i(),r()))};l(o).onUpdate.append(k),t().onDuelUpdate.append(k),t().modalController.onUpdate.append(k);let p=Ce([]),c=()=>{},m;const f=x=>{te(g,void 0),s().reset(),c=x.resolve,te(p,x.enableActions),m=x.selectableEntities,x.entitiesValidator};t().onWaitStart.append(f);let a,A=Ce(!1);const u=x=>{a=x,te(A,x.some(I=>{var ne;return(ne=I.validate())==null?void 0:ne.includes(l(o))})||!1),k()},w=()=>{a=void 0,te(A,!1),k()};t().onDragStart.append(u),t().onDragEnd.append(w);const[C,v]=pl;let g=Ce(void 0);const S=x=>{if(l(o)===x.to||l(o).entities.includes(x.entity)){console.log(x),te(g,x);const I=x.resolve;te(o,l(o)),setTimeout(()=>{te(g,void 0),x.count++,x.count>1&&I()},600)}};t().onAnimation.append(S);const q=x=>{console.info(x),c({phaseChange:x})},L=()=>(l(o).cellType==="Deck"||l(o).cellType==="ExtraDeck"||l(o).cellType==="Graveyard"||l(o).cellType==="Banished")&&l(o).entities.flatMap(x=>x.actions).filter(x=>l(p).map(I=>I.seq).some(I=>I===x.seq)).length>0,b=()=>{if(Ke(o,l(o).field.duel.view.infoBoardState="Log"),l(o).cellType==="Deck"||l(o).cellType==="ExtraDeck"||l(o).cellType==="Graveyard"||l(o).cellType==="Banished"){Ke(o,l(o).field.duel.view.infoBoardState="CellInfo"),Ke(o,l(o).field.duel.view.infoBoardCell=l(o)),l(o).field.duel.view.requireUpdate();const x=l(o).entities.flatMap(I=>I.actions).filter(I=>l(p).map(ne=>ne.seq).some(ne=>ne===I.seq));if(console.log(l(p)),console.log(x),x.length){const I=l(o).field.duel.view;I.modalController.selectAction(I,{title:"カードを選択。",actions:x,cancelable:!0}).then(ne=>{c({action:ne})});return}}l(o).field.duel.view.requireUpdate(),console.info(l(o))},$=x=>{x.preventDefault(),x.dataTransfer&&(x.dataTransfer.dropEffect="move")},E=x=>{x.preventDefault(),console.info("drop",x,l(A),a),x.dataTransfer&&(x.dataTransfer.dropEffect="move");try{l(A)&&a&&(console.info(a,l(o)),a.length===1?c({action:{...a[0],cell:l(o)}}):a.length>1&&(l(o).field.duel.view.modalController.cancelAll(),l(o).field.duel.view.modalController.selectAction(l(o).field.duel.view,{title:"選択",actions:a,cancelable:!1})))}finally{t().removeDraggingActions()}},U=(...x)=>{if(m&&m.find(Z=>x.find(ee=>Z===ee)))return"Selectable";if(!l(p)||l(p).length===0||t().waitMode!=="SelectFieldAction"||Object.values(t().modalController.states).some(Z=>Z==="Shown"))return"Disabled";const I=l(p).filter(Z=>x.includes(Z.entity));if(I.length===0)return"Disabled";if(I.length>1)return"Clickable";if(l(p)[0].playType==="RuleDraw")return"Draggable";if(["Deck","ExtraDeck","Graveyard","Banished"].includes(l(o).cellType)||I[0].entity!==x[0])return"Clickable";const ne=I[0].validate();return ne&&ne.length>0?"Draggable":"Clickable"};Ie();var re=No(),se=h(re);se.__click=b;var me=h(se);{var ue=x=>{var I=he(),ne=ie(I);{var Z=ee=>{var K=he(),V=ie(K);{var F=H=>{var j=mo(),z=h(j),G=h(z),Q=D(z,1,!0);W((ae,J)=>{_(G,ae),_(Q,J)},[()=>String(l(o).field.duel.clock.turn).padStart(2,"0"),()=>l(o).field.duel.phase.toUpperCase()],ye),y(H,j)},P=H=>{var j=he(),z=ie(j);{var G=ae=>{var J=uo(),T=h(J),B=h(T),Y=D(T,2),M=h(Y);W(()=>{_(B,l(o).field.duel.duelists.Above.lp),_(M,l(o).field.duel.duelists.Below.lp)}),y(ae,J)},Q=ae=>{var J=he(),T=ie(J);{var B=Y=>{var M=he(),O=ie(M);{var le=Ae=>{var je=he(),ft=ie(je);{var xt=tt=>{var nt=he(),jt=ie(nt);ke(jt,1,()=>t().duel.nextPhaseList,ce,(Gt,Mt)=>{var Ye=fo(),ze=h(Ye);ze.__click=[ho,q,Mt];var Nt=h(ze);W(bt=>_(Nt,bt),[()=>l(Mt).toUpperCase()],ye),y(Gt,Ye)}),y(tt,nt)};R(ft,tt=>{t().duel.isEnded||tt(xt)})}y(Ae,je)};R(O,Ae=>{t().waitMode==="SelectFieldAction"&&Ae(le)})}y(Y,M)};R(T,Y=>{l(o).column===5&&Y(B)},!0)}y(ae,J)};R(z,ae=>{l(o).column===3?ae(G):ae(Q,!1)},!0)}y(H,j)};R(V,H=>{l(o).column===1?H(F):H(P,!1)})}y(ee,K)};R(ne,ee=>{l(o).row===3&&ee(Z)})}y(x,I)},X=x=>{var I=he(),ne=ie(I);{var Z=K=>{var V=yo(),F=ie(V);{var P=G=>{var Q=wo(),ae=h(Q);rt(ae,{get entity(){return l(g).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),W(()=>we(Q,`card_animation_receiver ${l(o).cellType??""} svelte-1mupj1p`)),Ht(1,Q,()=>v,()=>({key:l(g).entity.seq})),y(G,Q)};R(F,G=>{l(g)&&l(g).entity&&l(g).to===l(o)&&l(g).index==="Top"&&G(P)})}var H=D(F,2);ke(H,1,()=>l(o).cardEntities,ce,(G,Q)=>{var ae=he(),J=ie(ae);{var T=B=>{var Y=Co(),M=h(Y);const O=ye(()=>U(l(Q))),le=ye(()=>l(p).filter(Ae=>Ae.entity===l(Q)));rt(M,{get entity(){return l(Q)},get state(){return l(O)},get actions(){return l(le)},cardActionResolve:void 0,get selectedList(){return s()},set selectedList(Ae){s(Ae)},$$legacy:!0}),Ht(2,Y,()=>C,()=>({key:l(Q).seq})),y(B,Y)};R(J,B=>{(!l(g)||l(g).entity.seq!==l(Q).seq)&&B(T)})}y(G,ae)});var j=D(H,2);{var z=G=>{var Q=Do(),ae=h(Q);rt(ae,{get entity(){return l(g).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),W(()=>we(Q,`card_animation_receiver ${l(o).cellType??""} svelte-1mupj1p`)),Ht(1,Q,()=>v,()=>({key:l(g).entity.seq})),y(G,Q)};R(j,G=>{l(g)&&l(g).entity&&l(g).to===l(o)&&l(g).index==="Bottom"&&G(z)})}y(K,V)},ee=K=>{var V=Mo(),F=ie(V);{var P=J=>{var T=go(),B=h(T);rt(B,{get entity(){return l(g).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Ht(1,T,()=>v,()=>({key:l(g).entity.seq})),y(J,T)};R(F,J=>{l(g)&&l(g).entity&&l(g).to===l(o)&&l(g).index==="Bottom"&&J(P)})}var H=D(F,2);{var j=J=>{var T=Eo(),B=ie(T);ke(B,1,()=>l(o).cardEntities.toReversed(),ce,(O,le,Ae)=>{var je=he(),ft=ie(je);{var xt=tt=>{var nt=vo(),jt=h(nt);const Gt=ye(()=>Ae===0&&Si.every(Ye=>Ye!==l(o).cellType)?U(...l(o).cardEntities):void 0),Mt=ye(()=>Ae===0?l(p).filter(Ye=>l(o).cardEntities.includes(Ye.entity)):void 0);rt(jt,{get entity(){return l(le)},get state(){return l(Gt)},get actions(){return l(Mt)},cardActionResolve:void 0,get selectedList(){return s()},set selectedList(Ye){s(Ye)},$$legacy:!0}),Ht(2,nt,()=>C,()=>({key:l(le).seq})),y(tt,nt)};R(ft,tt=>{(!l(g)||l(g).entity.seq!==l(le).seq)&&tt(xt)})}y(O,je)});var Y=D(B,2);{var M=O=>{var le=Bo(),Ae=h(le);W(()=>_(Ae,`【${(l(o).cardEntities[0].battlePotion==="Attack"?"攻撃表示":l(o).cardEntities[0].battlePotion==="Defense"?"表守備表示":"裏守備表示")??""}】`)),y(O,le)};R(Y,O=>{l(o).cardEntities[0].battlePotion&&O(M)})}y(J,T)};R(H,J=>{l(o).cardEntities.length>0&&J(j)})}var z=D(H,2);{var G=J=>{var T=To(),B=h(T);W(()=>_(B,l(o).cardEntities.length)),y(J,T)};R(z,J=>{Si.find(T=>T===l(o).cellType)&&J(G)})}var Q=D(z,2);{var ae=J=>{var T=xo(),B=h(T);rt(B,{get entity(){return l(g).entity},state:"Disabled",actions:[],cardActionResolve:void 0}),Ht(1,T,()=>v,()=>({key:l(g).entity.seq})),y(J,T)};R(Q,J=>{l(g)&&l(g).entity&&l(g).to===l(o)&&l(g).index==="Top"&&J(ae)})}y(K,V)};R(ne,K=>{l(o).cellType==="Hand"?K(Z):K(ee,!1)},!0)}y(x,I)};R(me,x=>{l(o).cellType==="Disable"?x(ue):x(X,!1)})}W(x=>{we(re,`${`duel_field_cell duel_field_cell_${l(o).cellType}`??""} svelte-1mupj1p`),Dt(re,"colspan",l(o).cellType==="Hand"?7:1),we(se,`${x??""} svelte-1mupj1p`)},[()=>`duel_card_wrapper ${l(o).cellType} ${l(A)?"can_accept_drop":""} ${L()?"can_action":""}`],ye),ge("dragover",se,x=>$(x)),ge("drop",se,x=>E(x)),y(n,re),He()}ci(["click"]);var _o=N('<tr><td style=" white-space: nowrap;text-align: center;"> </td><td class="svelte-13svkzh"> </td></tr>'),Fo=N('<div class="duel_log svelte-13svkzh"><table><tbody></tbody></table></div>');function Ho(n,e){var p,c;Fe(e,!1);let t=Ce(void 0),i=fe(e,"log",12);const r=()=>{i(i()),Fr().then(()=>l(t)&&l(t).scroll(0,l(t).clientHeight*10))};(c=(p=i())==null?void 0:p.onUpdate)==null||c.append(r),Ie();var s=Fo(),o=h(s),k=h(o);ke(k,5,()=>i().records,ce,(m,f)=>{var a=_o(),A=h(a),u=h(A),w=D(A),C=h(w);W(()=>{var v,g;we(A,`duelist ${((v=l(f).duelist)==null?void 0:v.seat)??""} svelte-13svkzh`),_(u,((g=l(f).duelist)==null?void 0:g.profile.name)||"SYSTEM"),_(C,l(f).text)}),y(m,a)}),is(s,m=>te(t,m),()=>l(t)),y(n,s),He()}const So=n=>new Promise(e=>setTimeout(e,n));var Ko=N('<div><div class="duelist_name svelte-12u0sqq"> </div> <div> </div></div>');function Li(n,e){Fe(e,!1);let t=fe(e,"duelist",12),i=Ce(0),r=Ce();const s=async()=>{const a=t().lp-l(i);if(!l(r)||Math.abs(a)<10){te(i,t().lp),l(r)&&(l(r)(),te(r,void 0));return}te(i,l(i)+Math.floor(Math.random()*a)),await So(100),s()},o=()=>{t(t()),!l(r)&&t().lp!==l(i)&&new Promise(a=>{te(r,a),Math.abs(t().lp-l(i)),s()})};t().duel.log.onUpdate.append(o),s(),Ie();var k=Ko(),p=h(k),c=h(p),m=D(p,2),f=h(m);W(()=>{we(k,`duelist ${t().seat??""} svelte-12u0sqq`),_(c,t().profile.name),we(m,`duelist_lp ${(l(r)?"vibration":"")??""} svelte-12u0sqq`),_(f,l(i))}),y(n,k),He()}const Po=()=>{};var qo=N("<div><!></div>"),Wo=N("<div></div>"),Lo=(n,e,t)=>e.resolve(l(t)),Ro=(n,e)=>e.resolve(void 0),Oo=N('<button class="svelte-1h1of0m">Cancel</button>'),Zo=N('<div class="base svelte-1h1of0m"><button class="overlay svelte-1h1of0m">☆</button> <div class="window svelte-1h1of0m"><div> </div> <!> <div><button class="svelte-1h1of0m">OK</button> <!></div></div></div>');function Uo(n,e){Fe(e,!0);let t=kr(ct([]));var i=he(),r=ie(i);{var s=o=>{var k=Zo(),p=h(k);p.__click=[Po];var c=D(p,2),m=h(c),f=h(m),a=D(m,2);ke(a,17,()=>e.entities.map(v=>v.controller.seat).getDistinct(),ce,(v,g)=>{var S=Wo();ke(S,21,()=>e.entities.filter(q=>q.controller.seat===l(g)),ce,(q,L)=>{var b=qo(),$=h(b);rt($,{get entity(){return l(L)},isVisibleForcibly:!0,state:"Selectable",entitySelectResolve:E=>e.resolve(E),get qty(){return e.qty},cardActionResolve:void 0,get selectedList(){return l(t)},set selectedList(E){te(t,ct(E))}}),y(q,b)}),W(()=>we(S,`entities_list ${l(g)??""} svelte-1h1of0m`)),y(v,S)});var A=D(a,2),u=h(A);u.__click=[Lo,e,t];var w=D(u,2);{var C=v=>{var g=Oo();g.__click=[Ro,e],y(v,g)};R(w,v=>{e.cancelable&&v(C)})}W(v=>{_(f,e.title),u.disabled=v},[()=>!e.validator(l(t))]),y(o,k)};R(r,o=>{o(s)})}y(n,i),He()}ci(["click"]);const Io=(n,e)=>{e.cancelable&&e.resolve(void 0)};var $o=N('<div class="duel_card_wrapper svelte-11mc7y0"><!> <div> </div></div>'),jo=(n,e)=>e.resolve(),Go=N('<div><button class="cancel_button svelte-11mc7y0">Cancel</button></div>'),Yo=N('<div><button>★</button> <div><div> </div> <div class="flex svelte-11mc7y0"></div> <!></div></div>');function zo(n,e){Fe(e,!0);const[t,i]=os(),r=()=>ss(s,"$isDragging",t);let s=as(!1);const o=()=>s.set(!0),k=()=>s.set(!1);e.view.onDragStart.append(o),e.view.onDragEnd.append(k);const p=a=>{const A=a.validate();return A&&A.length>0?"Draggable":"Clickable"};var c=he(),m=ie(c);{var f=a=>{var A=Yo(),u=h(A);u.__click=[Io,e];var w=D(u,2),C=h(w),v=h(C),g=D(C,2);ke(g,21,()=>e.actions,ce,(L,b)=>{var $=$o(),E=h($);const U=Bt(()=>p(l(b))),re=Bt(()=>e.dragAndDropOnly?[]:[l(b)]);rt(E,{get entity(){return l(b).entity},isVisibleForcibly:!0,get state(){return l(U)},get actions(){return l(re)},get cardActionResolve(){return e.resolve}});var se=D(E,2),me=h(se);W(()=>_(me,`«${l(b).title??""}»`)),y(L,$)});var S=D(g,2);{var q=L=>{var b=Go(),$=h(b);$.__click=[jo,e],y(L,b)};R(S,L=>{e.cancelable&&L(q)})}W(()=>{we(A,`${`base ${r()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(u,`${`overlay ${r()?"minimum_mode":""}`??""} svelte-11mc7y0`),we(w,`${`window ${r()?"minimum_mode":""}`??""} svelte-11mc7y0`),_(v,e.title)}),y(a,A)};R(m,a=>{a(f)})}y(n,c),He(),i()}ci(["click"]);var Vo=N('<div class="base svelte-1y912d"><!> <!></div>');function Qo(n,e){var c,m;Fe(e,!1);let t=fe(e,"modalController",12);const i=()=>{t(t())};(m=(c=t())==null?void 0:c.onUpdate)==null||m.append(i),Ie();var r=Vo(),s=h(r);{var o=f=>{Uo(f,{get title(){return t().duelEntitiesSelectorArg.title},get entities(){return t().duelEntitiesSelectorArg.entities},get validator(){return t().duelEntitiesSelectorArg.validator},get qty(){return t().duelEntitiesSelectorArg.qty},get cancelable(){return t().duelEntitiesSelectorArg.cancelable},resolve:a=>{t().duelEntitiesSelectorResolve(a)}})};R(s,f=>{t().states.DuelEntitiesSelector==="Shown"&&f(o)})}var k=D(s,2);{var p=f=>{const a=ye(()=>t().cardActionSelectorArg.dragAndDropOnly??!1);zo(f,{get view(){return t().view},get title(){return t().cardActionSelectorArg.title},get actions(){return t().cardActionSelectorArg.actions},get dragAndDropOnly(){return l(a)},get cancelable(){return t().cardActionSelectorArg.cancelable},resolve:A=>{console.info(A),t().cardActionSelectorResolve(A)}})};R(k,f=>{t().states.DuelActionSelector==="Shown"&&f(p)})}y(n,r),He()}var Jo=N('<div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div> <div class="duel_card_info_row svelte-1qhzdl0" style=" justify-content: space-between;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div>',1),Xo=N('<div></div> <div class="svelte-1qhzdl0"> </div>',1),el=N("<div> </div>"),tl=N("<div> </div>"),nl=N('<div class="duel_card_info_row svelte-1qhzdl0"><!> <!></div> <div class="duel_card_info_row svelte-1qhzdl0"></div>',1),il=N('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),al=N('<div class="duel_card_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"></div> <div class="svelte-1qhzdl0"> </div></div>'),rl=N('<div><div class="duel_card_info_header svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"> </div></div> <div class="duel_card_info_row svelte-1qhzdl0" style="position:sticky; top:0;"><div class="svelte-1qhzdl0"> </div> <div class="svelte-1qhzdl0"> </div></div> <!> <!></div> <div class="duel_card_info_body svelte-1qhzdl0"><div class="duel_card_info_row svelte-1qhzdl0"><div class="svelte-1qhzdl0"><pre class="description svelte-1qhzdl0"> </pre></div></div></div> <div class="duel_card_info_footer svelte-1qhzdl0"><div class="duel_card_info_links svelte-1qhzdl0"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1qhzdl0">⇒遊戯王カードWiki</a> <a target="_blank" rel="noopener noreferrer" title="コナミカードデータベース" class="svelte-1qhzdl0"> </a></div></div></div>');function sl(n,e){Fe(e,!1);let t=fe(e,"entity",8,void 0);const i=()=>t()?be[t().origin.name]:void 0,r=()=>{var p;return t()&&(t().origin.cardId??!1)?`https://www.db.yugioh-card.com/yugiohdb/card_search.action?ope=2&cid=${t().origin.cardId}`:`https://www.db.yugioh-card.com/yugiohdb/card_search.action?ope=1&sess=1&rp=10&mode=&sort=1&keyword=${(p=i())==null?void 0:p.name}&stype=1&ctype=&othercon=2&starfr=&starto=&pscalefr=&pscaleto=&linkmarkerfr=&linkmarkerto=&link_m=2&atkfr=&atkto=&deffr=&defto=&releaseDStart=1&releaseMStart=1&releaseYStart=1999&releaseDEnd=&releaseMEnd=&releaseYEnd=`};Ie();var s=he(),o=ie(s);{var k=p=>{var c=rl(),m=h(c),f=h(m),a=h(f),A=h(a),u=D(f,2),w=h(u),C=h(w),v=D(w,2),g=h(v),S=D(u,2);{var q=Z=>{var ee=Jo(),K=ie(ee),V=h(K),F=h(V),P=h(F),H=D(K,2),j=h(H),z=h(j),G=D(j,2),Q=h(G);W(()=>{_(P,be[t().origin.name].pendulumDescription),_(z,`◀ ${t().psL??""}`),_(Q,`${t().psR??""} ▶`)}),y(Z,ee)};R(S,Z=>{var ee;(ee=t().status.monsterCategories)!=null&&ee.includes("Pendulum")&&Z(q)})}var L=D(S,2);{var b=Z=>{var ee=nl(),K=ie(ee),V=h(K);ke(V,1,()=>t().attr,ce,(j,z)=>{var G=Xo(),Q=ie(G),ae=D(Q,2),J=h(ae);W(()=>{we(Q,`monster_attr ${l(z)??""} svelte-1qhzdl0`),_(J,`${mi[l(z)]??""}属性`)}),y(j,G)});var F=D(V,2);{var P=j=>{var z=el(),G=h(z);W(()=>{we(z,`monster_cat ${t().status.type??""} svelte-1qhzdl0`),_(G,`${sn[t().status.type]??""}${Hn[t().status.type]??""}族`)}),y(j,z)};R(F,j=>{t().status.type&&j(P)})}var H=D(K,2);ke(H,5,()=>t().status.monsterCategories??[],ce,(j,z)=>{var G=tl(),Q=h(G);W(()=>{we(G,`monster_cat ${l(z)??""} svelte-1qhzdl0`),_(Q,`${nn[l(z)]??""}${Fn[l(z)]??""}`)}),y(j,G)}),y(Z,ee)},$=Z=>{var ee=he(),K=ie(ee);{var V=P=>{var H=il(),j=D(h(H),2),z=h(j);W(()=>_(z,`${an[t().status.spellCategory]??""}魔法`)),y(P,H)},F=P=>{var H=he(),j=ie(H);{var z=G=>{var Q=al(),ae=D(h(Q),2),J=h(ae);W(()=>_(J,`${rn[t().status.trapCategory]??""}罠`)),y(G,Q)};R(j,G=>{t().status.kind==="Trap"&&t().status.trapCategory&&G(z)},!0)}y(P,H)};R(K,P=>{t().status.kind==="Spell"&&t().status.spellCategory?P(V):P(F,!1)},!0)}y(Z,ee)};R(L,Z=>{t().status.kind==="Monster"?Z(b):Z($,!1)})}var E=D(m,2),U=h(E),re=h(U),se=h(re),me=h(se),ue=D(E,2),X=h(ue),x=h(X),I=D(x,2),ne=h(I);W((Z,ee,K,V,F,P)=>{var H;we(c,`duel_card duel_card_info ${t().origin.kind??""} ${Z??""} svelte-1qhzdl0`),_(A,t().nm),_(C,ee),_(g,K),_(me,V),Dt(x,"href",F),Dt(I,"href",P),_(ne,`⇒${((H=t())!=null&&H.origin.cardId?"公式カードページ":"公式で検索")??""}`)},[()=>{var Z;return(Z=t().origin.monsterCategories)==null?void 0:Z.join(" ")},()=>"★".repeat(t().status.level||0),()=>"☆".repeat(t().status.rank||0),()=>{var Z;return(Z=i())==null?void 0:Z.description},()=>{var Z;return(Z=i())==null?void 0:Z.wikiHref},r],ye),y(p,c)};R(o,p=>{t()&&p(k)})}y(n,s),He()}var ol=N('<div class="duel_field_cell_info_item svelte-1xj7qf1"><!></div>'),ll=N('<div class="duel_field_cell_info_box svelte-1xj7qf1"><div class="duel_field_cell_info_label svelte-1xj7qf1"> </div> <!></div>'),Al=N('<div class="duel_field_cell_info svelte-1xj7qf1"><div class="duel_field_cell_info_header item_btn svelte-1xj7qf1"><div class="svelte-1xj7qf1"> </div> <div class="svelte-1xj7qf1"> </div></div> <div class="duel_field_cell_info_body svelte-1xj7qf1"></div></div>');function dl(n,e){Fe(e,!1);let t=fe(e,"cell",12);const i=()=>{t(t())},r=a=>t().cardEntities.filter(A=>A.face===a);t().field.duel.view.onDuelUpdate.append(i),Ie();var s=Al(),o=h(s),k=h(o),p=h(k),c=D(k,2),m=h(c),f=D(o,2);ke(f,4,()=>["FaceUp","FaceDown"],ce,(a,A)=>{var u=he(),w=ie(u);{var C=v=>{var g=ll(),S=h(g),q=h(S),L=D(S,2);ke(L,1,()=>r(A).toSorted(Os),ce,(b,$)=>{var E=ol(),U=h(E);const re=ye(()=>t().owner===t().field.duel.duelists.Below);rt(U,{get entity(){return l($)},get isVisibleForcibly(){return l(re)},isWideMode:!0,cardActionResolve:void 0}),y(b,E)}),W(()=>_(q,A==="FaceUp"?"表向き":"裏向き")),y(v,g)};R(w,v=>{r(A).length&&v(C)})}y(a,u)}),W(()=>{var a;_(p,(a=t().owner)==null?void 0:a.profile.name),_(m,t().cellType)}),y(n,s),He()}const pl=io({duration:400});var cl=N('<div class="duel_field_header_message svelte-accyye"> </div> <div class="duel_field_header_buttons svelte-accyye"><button class="svelte-accyye">サレンダー</button></div>',1),kl=N("<tr></tr>"),ml=N('<table class="duel_field svelte-accyye"><tbody class="svelte-accyye"></tbody></table>'),ul=N('<button class="svelte-accyye">OK</button>'),hl=N('<div style="position:absolute;right:0;top:0"> </div> <div class="flex duel_desk svelte-accyye"><div class="duel_desk_left v_flex svelte-accyye"><!> <!> <!></div> <div class=" duel_desk_center v_flex svelte-accyye"><div class="duel_field_header svelte-accyye"><!></div> <div class="svelte-accyye"><!></div> <div class="duel_field_footer svelte-accyye"><!></div></div> <div class=" duel_desk_right svelte-accyye" style="text-align: left;"><!></div></div> <!>',1);function fl(n,e){Fe(e,!1);let t=fe(e,"duel",12),i=()=>{},r=Ce(()=>!0),s=Ce();const o=K=>{i=K.resolve,te(r,K.entitiesValidator),te(s,K.selectableEntities),K.duelEntitiesSelectorArg&&t().view.modalController.selectDuelEntities(K.duelEntitiesSelectorArg).then(V=>{i({selectedEntities:V})})};t().view.onWaitStart.append(o);let k=Ce(void 0);const p=K=>{te(k,K)};t().view.onShowCardEntity.append(p);let c=fe(e,"selectedList",28,()=>[]);const m=()=>{t(t())};t().view.onDuelUpdate.append(m);const f=()=>{l(r)(c())&&i({selectedEntities:c()})},a=()=>{i({surrender:!0})};t().main(),Ie();var A=hl(),u=ie(A),w=h(u),C=D(u,2),v=h(C),g=h(v);Li(g,{get duelist(){return t().duelists.Above}});var S=D(g,2);sl(S,{get entity(){return l(k)}});var q=D(S,2);Li(q,{get duelist(){return t().duelists.Below}});var L=D(v,2),b=h(L),$=h(b);{var E=K=>{var V=cl(),F=ie(V),P=h(F),H=D(F,2),j=h(H);W(()=>_(P,`[TURN:${t().clock.turn}][PHASE:${t().phase}] ${t().view.message}`)),ge("click",j,a),y(K,V)};R($,K=>{t().isEnded||K(E)})}var U=D(b,2),re=h(U);{var se=K=>{var V=ml(),F=h(V);ke(F,5,()=>t().field.cells,ce,(P,H,j)=>{var z=kl();we(z,`${`duel_desk_row_${j}`??""} svelte-accyye`),ke(z,5,()=>l(H),ce,(G,Q,ae)=>{bo(G,{get view(){return t().view},row:j,column:ae,get selectedList(){return c()},set selectedList(J){c(J)},$$legacy:!0})}),y(P,z)}),y(K,V)};R(re,K=>{t().clock.turn>0&&K(se)})}var me=D(U,2),ue=h(me);{var X=K=>{var V=ul();W(F=>V.disabled=F,[()=>!l(r)(c())],ye),ge("click",V,f),y(K,V)};R(ue,K=>{l(s)&&l(s).length>0&&K(X)})}var x=D(L,2),I=h(x);{var ne=K=>{Ho(K,{get log(){return t().log}})},Z=K=>{var V=he(),F=ie(V);{var P=H=>{dl(H,{get cell(){return t().view.infoBoardCell}})};R(F,H=>{t().view.infoBoardState==="CellInfo"&&H(P)},!0)}y(K,V)};R(I,K=>{t().view.infoBoardState==="Log"?K(ne):K(Z,!1)})}var ee=D(C,2);Qo(ee,{get modalController(){return t().view.modalController}}),W(K=>_(w,K),[()=>t().clock.toString()],ye),y(n,A),He()}var wl=N("<div></div>"),Cl=N('<span> </span> / <span style="display: inline-block;width:2rem;text-align: right;"> </span>',1),Dl=N('<li class="deck_editor_item svelte-vivzk2"><div role="listitem"><div class="svelte-vivzk2"><div class="svelte-vivzk2"> </div> <div style="display:flex" class="svelte-vivzk2"><div class="svelte-vivzk2"><!> <!> <!> <!> <!> <!> <!></div> <div style="flex-grow: 1; width:0.1rem" class="svelte-vivzk2"></div> <div class="svelte-vivzk2"><!></div></div></div></div> <button class="button_style_reset svelte-vivzk2">+</button> <button class="button_style_reset svelte-vivzk2">-</button></li>'),yl=N('<div class="deck_editor_card_kind svelte-vivzk2"><span class="svelte-vivzk2"> </span> <ul class="svelte-vivzk2"></ul></div>'),gl=N('<div class="deck_editor_deck_type svelte-vivzk2"><span class="svelte-vivzk2"> </span> <!></div>'),vl=N('<div class="deck_editor_card_list svelte-vivzk2"></div>');function Ri(n,e){Fe(e,!1);let t=fe(e,"allCardInfos",8),i=fe(e,"deckCardInfos",12),r=fe(e,"mode",8),s=fe(e,"onAttention",8);const o={Deck:["Monster","Spell","Trap"],ExtraDeck:["Monster"]},k=(f,a)=>(r()==="List"?t():i()).filter(A=>{var u;return Jn.has(A.name)||((u=A.monsterCategories)==null?void 0:u.includes("Normal"))}).filter(A=>!a||A.kind===a).filter(A=>{var u,w;return!f||f==="Deck"&&!((u=A==null?void 0:A.monsterCategories)!=null&&u.union(Ot).length)||f==="ExtraDeck"&&((w=A==null?void 0:A.monsterCategories)==null?void 0:w.union(Ot).length)}).toSorted(cn),p=(f,a)=>{const A=i().filter(w=>w.name===a.name).length;if(A>2)return;const u=f.shiftKey?3-A:1;u<1||(i().push(...Array(u).fill(a)),i().sort(cn),i(i()))},c=(f,a)=>{let A=0;i(i().filter(u=>u.name!==a.name?!0:(A++,!f.shiftKey&&A>1))),i().sort(cn)};Ie();var m=vl();ke(m,5,()=>us,ce,(f,a)=>{var A=gl(),u=h(A),w=h(u),C=D(u,2);ke(C,1,()=>o[l(a)],ce,(v,g)=>{var S=yl(),q=h(S),L=h(q),b=D(q,2);ke(b,5,()=>k(l(a),l(g)),ce,($,E)=>{var U=Dl(),re=h(U),se=h(re),me=h(se),ue=h(me),X=D(me,2),x=h(X),I=h(x);{var ne=M=>{var O=_t();W(()=>_(O,`★${l(E).level??""}`)),y(M,O)};R(I,M=>{l(E).level&&M(ne)})}var Z=D(I,2);{var ee=M=>{var O=_t();W(()=>_(O,`☆${l(E).rank??""}`)),y(M,O)};R(Z,M=>{l(E).rank&&M(ee)})}var K=D(Z,2);{var V=M=>{var O=wl();W(()=>we(O,`monster_attr ${l(E).attribute??""} svelte-vivzk2`)),y(M,O)};R(K,M=>{l(E).attribute!==void 0&&M(V)})}var F=D(K,2);{var P=M=>{var O=_t();W(()=>_(O,sn[l(E).type])),y(M,O)};R(F,M=>{l(E).type!==void 0&&M(P)})}var H=D(F,2);ke(H,1,()=>l(E).monsterCategories??[],ce,(M,O)=>{var le=_t();W(()=>_(le,nn[l(O)])),y(M,le)});var j=D(H,2);{var z=M=>{var O=_t();W(()=>_(O,`${an[l(E).spellCategory]??""}魔法`)),y(M,O)};R(j,M=>{l(E).spellCategory!==void 0&&M(z)})}var G=D(j,2);{var Q=M=>{var O=_t();W(()=>_(O,`${rn[l(E).trapCategory]??""}罠`)),y(M,O)};R(G,M=>{l(E).trapCategory!==void 0&&M(Q)})}var ae=D(x,4),J=h(ae);{var T=M=>{var O=Cl(),le=ie(O),Ae=h(le),je=D(le,2),ft=h(je);W(()=>{_(Ae,l(E).attack),_(ft,l(E).defense??"-")}),y(M,O)};R(J,M=>{l(E).attack!==void 0&&M(T)})}var B=D(re,2),Y=D(B,2);W(M=>{we(re,`${M??""} svelte-vivzk2`),_(ue,l(E).name)},[()=>{var M,O;return`deck_editor_card duel_card ${l(E).kind} ${(O=(M=l(E))==null?void 0:M.monsterCategories)==null?void 0:O.join(" ")} ${Jn.has(l(E).name)?"is_implemented":"is_not_implemented"}`}],ye),ge("mouseenter",re,()=>s()(l(E))),ge("click",B,M=>p(M,l(E))),ge("click",Y,M=>c(M,l(E))),y($,U)}),W(()=>_(L,Ea[l(g)])),y(v,S)}),W(()=>_(w,hs[l(a)])),y(f,A)}),y(n,m),He()}var Bl=N('<div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_row svelte-1xf9hqi" style=" justify-content: space-between;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div>',1),El=N('<div></div> <div class="svelte-1xf9hqi"> </div>',1),Tl=N("<div> </div>"),xl=N("<div> </div>"),Ml=N('<div class="duel_card_info_row svelte-1xf9hqi"><!> <!></div> <div class="duel_card_info_row svelte-1xf9hqi"></div>',1),Nl=N('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),bl=N('<div class="duel_card_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"></div> <div class="svelte-1xf9hqi"> </div></div>'),_l=N('<div><div class="duel_card_info_header svelte-1xf9hqi"><div class="duel_card_info_row svelte-1xf9hqi"><div class="svelte-1xf9hqi"> </div></div> <div class="duel_card_info_row svelte-1xf9hqi" style="position:sticky; top:0;"><div class="svelte-1xf9hqi"> </div> <div class="svelte-1xf9hqi"> </div></div></div> <div class="duel_card_info_body svelte-1xf9hqi"><!> <!> <div class="duel_card_info_row description svelte-1xf9hqi"><div class="svelte-1xf9hqi"><pre class="description svelte-1xf9hqi"> </pre></div></div> <div class="duel_card_info_links svelte-1xf9hqi"><a target="_blank" rel="noopener noreferrer" title="遊戯王カードWiki" class="svelte-1xf9hqi">⇒遊戯王カードWiki</a></div></div></div>');function Fl(n,e){Fe(e,!1);let t=fe(e,"cardInfo",8,void 0);const i=()=>t()?be[t().name]:void 0;Ie();var r=he(),s=ie(r);{var o=k=>{var p=_l(),c=h(p),m=h(c),f=h(m),a=h(f),A=D(m,2),u=h(A),w=h(u),C=D(u,2),v=h(C),g=D(c,2),S=h(g);{var q=X=>{var x=Bl(),I=ie(x),ne=h(I),Z=h(ne),ee=h(Z),K=D(I,2),V=h(K),F=h(V),P=D(V,2),H=h(P);W(()=>{_(ee,be[t().name].pendulumDescription),_(F,`◀ ${t().pendulumScaleL??""}`),_(H,`${t().pendulumScaleR??""} ▶`)}),y(X,x)};R(S,X=>{var x;(x=t().monsterCategories)!=null&&x.includes("Pendulum")&&X(q)})}var L=D(S,2);{var b=X=>{var x=Ml(),I=ie(x),ne=h(I);{var Z=F=>{var P=El(),H=ie(P),j=D(H,2),z=h(j);W(()=>{we(H,`monster_attr ${t().attribute??""} svelte-1xf9hqi`),_(z,`${mi[t().attribute]??""}属性`)}),y(F,P)};R(ne,F=>{t().attribute&&F(Z)})}var ee=D(ne,2);{var K=F=>{var P=Tl(),H=h(P);W(()=>{we(P,`monster_cat ${t().type??""} svelte-1xf9hqi`),_(H,`${sn[t().type]??""}${Hn[t().type]??""}族`)}),y(F,P)};R(ee,F=>{t().type&&F(K)})}var V=D(I,2);ke(V,5,()=>t().monsterCategories??[],ce,(F,P)=>{var H=xl(),j=h(H);W(()=>{we(H,`monster_cat ${l(P)??""} svelte-1xf9hqi`),_(j,`${nn[l(P)]??""}${Fn[l(P)]??""}`)}),y(F,H)}),y(X,x)},$=X=>{var x=he(),I=ie(x);{var ne=ee=>{var K=Nl(),V=D(h(K),2),F=h(V);W(()=>_(F,`${an[t().spellCategory]??""}魔法`)),y(ee,K)},Z=ee=>{var K=he(),V=ie(K);{var F=P=>{var H=bl(),j=D(h(H),2),z=h(j);W(()=>_(z,`${rn[t().trapCategory]??""}罠`)),y(P,H)};R(V,P=>{t().kind==="Trap"&&t().trapCategory&&P(F)},!0)}y(ee,K)};R(I,ee=>{t().kind==="Spell"&&t().spellCategory?ee(ne):ee(Z,!1)},!0)}y(X,x)};R(L,X=>{t().kind==="Monster"?X(b):X($,!1)})}var E=D(L,2),U=h(E),re=h(U),se=h(re),me=D(E,2),ue=h(me);W((X,x,I,ne,Z)=>{we(p,`duel_card duel_card_info ${t().kind??""} ${X??""} svelte-1xf9hqi`),_(a,t().name),_(w,x),_(v,I),_(se,ne),Dt(ue,"href",Z)},[()=>{var X;return(X=t().monsterCategories)==null?void 0:X.join(" ")},()=>"★".repeat(t().level||0),()=>"☆".repeat(t().rank||0),()=>{var X;return(X=i())==null?void 0:X.description},()=>{var X;return(X=i())==null?void 0:X.wikiHref}],ye),y(k,p)};R(s,k=>{t()&&k(o)})}y(n,r),He()}const Hl={0:{aaa:"日",aaaa:"日曜日",ddd:"Sun",dddd:"Sunday"},1:{aaa:"月",aaaa:"月曜日",ddd:"Mon",dddd:"Monday"},2:{aaa:"火",aaaa:"火曜日",ddd:"Tue",dddd:"Tuesday"},3:{aaa:"水",aaaa:"水曜日",ddd:"Wed",dddd:"Wednesday"},4:{aaa:"木",aaaa:"木曜日",ddd:"Thu",dddd:"Thursday"},5:{aaa:"金",aaaa:"金曜日",ddd:"Fri",dddd:"Friday"},6:{aaa:"土",aaaa:"土曜日",ddd:"Sat",dddd:"Saturday"}};class Sl{constructor(){d(this,"DefaultSeparator1","/");d(this,"DefaultSeparator2"," ");d(this,"DefaultSeparator3",":");d(this,"createDate",e=>{if(!e)return;const t=new Date(e);if(!isNaN(t.getTime()))return t});d(this,"createDateOr",(e,t)=>this.createDate(e)||t||new Date);d(this,"truncateDate",e=>{const t=e||new Date;return new Date(t.getFullYear(),t.getMonth(),t.getDate())});d(this,"addDate",(e,t)=>{const i=this.createDateOr(e);return i.setDate(i.getDate()+t),i});d(this,"addMonth",(e,t)=>{const i=this.createDateOr(e);return i.setMonth(i.getMonth()+t),i});d(this,"addYear",(e,t)=>{const i=this.createDateOr(e);return i.setFullYear(i.getFullYear()+t),i});d(this,"getDayOfWeek",(e,t="dddd")=>{const i=this.createDate(e);return i?Hl[i.getDay()][t]:""});d(this,"formatToYYYYMMDD",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";const r=i.getFullYear().toString(),s=("0"+(i.getMonth()+1)).slice(-2),o=("0"+i.getDate()).slice(-2);return r+t+s+t+o});d(this,"formatToYYYYMM",(e,t=this.DefaultSeparator1)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const r=i.getFullYear().toString(),s=("0"+(i.getMonth()+1)).slice(-2);return r+t+s});d(this,"formatToHHMMSS",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const r=i.getHours(),s=i.getMinutes(),o=i.getSeconds();return("0"+r).slice(-2)+t+("0"+s).slice(-2)+t+("0"+o).slice(-2)});d(this,"formatToHHMM",(e,t=this.DefaultSeparator3)=>{const i=this.createDate(e);if(!i)return"";t||(t="");const r=("0"+i.getHours()).slice(-2),s=("0"+i.getMinutes()).slice(-2);return r+t+s});d(this,"formatToYYYYMMDD_HHMM",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,r=this.DefaultSeparator3)=>{const s=this.createDate(e);return s?this.formatToYYYYMMDD(s,t)+i+this.formatToHHMM(s,r):""});d(this,"formatToYYYYMMDD_HHMMSS",(e,t=this.DefaultSeparator1,i=this.DefaultSeparator2,r=this.DefaultSeparator3)=>{const s=this.createDate(e);return s?this.formatToYYYYMMDD(s,t)+i+this.formatToHHMMSS(s,r):""})}}const $e=new Sl;Date.prototype.truncateDate=function(){return $e.truncateDate(this)};Date.prototype.getCloneOr=function(n){return $e.createDateOr(this,n)};Date.prototype.addDate=function(n){return $e.addDate(this,n)};Date.prototype.addMonth=function(n){return $e.addDate(this,n)};Date.prototype.addYear=function(n){return $e.addDate(this,n)};Date.prototype.getDayOfWeek=function(n="dddd"){return $e.getDayOfWeek(this,n)};Date.prototype.formatToYYYYMM=function(n){return $e.formatToYYYYMM(this,n)};Date.prototype.formatToYYYYMMDD=function(n){return $e.formatToYYYYMMDD(this,n)};Date.prototype.formatToYYYYMMDD_HHMM=function(n,e,t){return $e.formatToYYYYMMDD_HHMM(this,n,e,t)};Date.prototype.formatToYYYYMMDD_HHMMSS=function(n,e,t){return $e.formatToYYYYMMDD_HHMMSS(this,n,e,t)};Date.prototype.formatToHHMM=function(n){return $e.formatToHHMM(this,n)};Date.prototype.formatToHHMMSS=function(n){return $e.formatToHHMMSS(this,n)};var Kl=N('<label><input type="checkbox"> </label>'),Pl=N('<label><input type="checkbox"> </label>'),ql=N('<label><input type="checkbox"> <div style="display: inline-block;"></div> </label>'),Wl=N('<label><input type="checkbox"> </label>'),Ll=N('<label><input type="checkbox"> </label>'),Rl=N('<label><input type="checkbox"> </label>'),Ol=N("<option> </option>"),Zl=N('<div class="deck_editor_body_right_header svelte-rsq0rf"><div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">編集対象</div> <select></select></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">新規名称</div> <input type="text"></div> <div class="deck_editor_body_right_header_row svelte-rsq0rf"><div class="svelte-rsq0rf">操作</div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを保存</button></div> <div class="svelte-rsq0rf"></div> <div class="svelte-rsq0rf"><button class="svelte-rsq0rf">デッキを複製</button></div> <div class="svelte-rsq0rf"><button title="shiftキー押下で確認メッセージスキップ" class="svelte-rsq0rf">デッキを削除</button></div></div></div> <!>',1),Ul=N("<div>デッキ情報読込中</div>"),Il=N('<div class="deck_editor svelte-rsq0rf"><div class="deck_editor_header"></div> <div class="deck_editor_body svelte-rsq0rf"><div class="deck_editor_body_left svelte-rsq0rf"><div class="deck_editor_search_box svelte-rsq0rf"><div><div>検索条件</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">名称</div> <div class="svelte-rsq0rf"><input type="text" style="width:70%">※ルビには対応していません</div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種類</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">モンスター</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">属性</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">種族</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">魔法</div> <div class="svelte-rsq0rf"></div></div> <div class="deck_editor_search_box_row svelte-rsq0rf"><div class="svelte-rsq0rf">罠</div> <div class="svelte-rsq0rf"></div></div></div> <!></div> <div class="deck_editor_body_center svelte-rsq0rf"><!></div> <div class="deck_editor_body_right svelte-rsq0rf"><!></div></div></div>');function $l(n,e){Fe(e,!1);const t=[],i=[],r=[],s=[],o=[],k=[],p=async()=>{const B=(await l(f)).find(Y=>Y.id===l(m));B&&te(A,{...B,cardInfos:B.cardNames.map(Y=>be[Y])})},c=()=>vt.getAllDeckInfo().then(T=>(T.forEach(B=>console.log(B.id,B.lastUsedAt,B.lastUsedAt.getTime())),console.log(Math.max(...T.map(B=>B.lastUsedAt.getTime()))),te(m,(T.find(B=>B.lastUsedAt.getTime()===Math.max(...T.map(Y=>Y.lastUsedAt.getTime())))??T[0]).id),T));let m=Ce(-1),f=Ce(c());l(f).then(p);const a=()=>{te(f,c()),p()};let A=Ce({id:Number.MIN_VALUE,name:"",description:"",lastUsedAt:new Date,cardInfos:[]}),u=Ce(be.ゾンビーノ);const w=Ce({name:"",cardKinds:[...Vn],monsterCategories:[...Ni].filter(T=>T!=="Normal"&&T!=="Token"),monsterAttributes:[...bi],monsterTypes:[..._i],spellCategories:[...Fi],trapCategories:[...Hi]}),C=()=>Object.values(be).filter(T=>{var B;if(!l(w).cardKinds.includes(T.kind)||l(w).name.trim().length&&!T.name.includes(l(w).name))return!1;if(T.kind==="Monster")return T.attribute&&!l(w).monsterAttributes.includes(T.attribute)||T.type&&!l(w).monsterTypes.includes(T.type)?!1:(B=T.monsterCategories)==null?void 0:B.union(l(w).monsterCategories).length;if(T.kind==="Spell")return T.spellCategory&&l(w).spellCategories.includes(T.spellCategory);if(T.kind==="Trap")return T.trapCategory&&l(w).trapCategories.includes(T.trapCategory)}),v=T=>{te(u,T)},g=async()=>{const B=(await l(f)).find(Y=>Y.id===l(m));if(!B)throw new Error("illegal state");return B},S=async()=>{const T=await g();await T.saveDeckInfo({...T,name:l(A).name,cardNames:l(A).cardInfos.map(B=>B.name),lastUsedAt:new Date}),a()},q=async()=>{(await vt.createNewDeck(`デッキ_${new Date().formatToYYYYMMDD_HHMMSS("","","")}`,`コピー日時：${new Date().formatToYYYYMMDD_HHMMSS("-"," ",":")}`,l(A).cardInfos.map(B=>B.name))).saveDeckInfo(),a()},L=async T=>{const B=await g();!T.shiftKey&&!confirm(`デッキ【${B.name}】を削除します。
よろしいですか？`)||(await B.delete(),a())};Ie();var b=Il(),$=D(h(b),2),E=h($),U=h(E),re=D(h(U),2),se=D(h(re),2),me=h(se),ue=D(re,2),X=D(h(ue),2);ke(X,5,()=>Vn,ce,(T,B)=>{var Y=Kl(),M=h(Y),O,le=D(M);W(()=>{O!==(O=l(B))&&(M.value=(M.__value=l(B))==null?"":l(B)),_(le,` ${Ea[l(B)]??""}`)}),St(t,[],M,()=>(l(B),l(w).cardKinds),Ae=>Ke(w,l(w).cardKinds=Ae)),y(T,Y)});var x=D(ue,2),I=D(h(x),2);ke(I,5,()=>Ni,ce,(T,B)=>{var Y=Pl(),M=h(Y),O,le=D(M);W(()=>{O!==(O=l(B))&&(M.value=(M.__value=l(B))==null?"":l(B)),_(le,` ${nn[l(B)]??""}${Fn[l(B)]??""}`)}),St(i,[],M,()=>(l(B),l(w).monsterCategories),Ae=>Ke(w,l(w).monsterCategories=Ae)),y(T,Y)});var ne=D(x,2),Z=D(h(ne),2);ke(Z,5,()=>bi,ce,(T,B)=>{var Y=ql(),M=h(Y),O,le=D(M,2),Ae=D(le);W(()=>{O!==(O=l(B))&&(M.value=(M.__value=l(B))==null?"":l(B)),we(le,`monster_attr ${l(u).attribute??""} svelte-rsq0rf`),_(Ae,` ${mi[l(B)]??""}`)}),St(r,[],M,()=>(l(B),l(w).monsterAttributes),je=>Ke(w,l(w).monsterAttributes=je)),y(T,Y)});var ee=D(ne,2),K=D(h(ee),2);ke(K,5,()=>_i,ce,(T,B)=>{var Y=Wl(),M=h(Y),O,le=D(M);W(()=>{O!==(O=l(B))&&(M.value=(M.__value=l(B))==null?"":l(B)),_(le,` ${sn[l(B)]??""}
                ${Hn[l(B)]??""}`)}),St(s,[],M,()=>(l(B),l(w).monsterTypes),Ae=>Ke(w,l(w).monsterTypes=Ae)),y(T,Y)});var V=D(ee,2),F=D(h(V),2);ke(F,5,()=>Fi,ce,(T,B)=>{var Y=Ll(),M=h(Y),O,le=D(M);W(()=>{O!==(O=l(B))&&(M.value=(M.__value=l(B))==null?"":l(B)),_(le,` ${an[l(B)]??""}`)}),St(o,[],M,()=>(l(B),l(w).spellCategories),Ae=>Ke(w,l(w).spellCategories=Ae)),y(T,Y)});var P=D(V,2),H=D(h(P),2);ke(H,5,()=>Hi,ce,(T,B)=>{var Y=Rl(),M=h(Y),O,le=D(M);W(()=>{O!==(O=l(B))&&(M.value=(M.__value=l(B))==null?"":l(B)),_(le,` ${rn[l(B)]??""}`)}),St(k,[],M,()=>(l(B),l(w).trapCategories),Ae=>Ke(w,l(w).trapCategories=Ae)),y(T,Y)});var j=D(U,2);Fl(j,{get cardInfo(){return l(u)}});var z=D(E,2),G=h(z);const Q=ye(C);Ri(G,{mode:"List",get allCardInfos(){return l(Q)},onAttention:v,get deckCardInfos(){return l(A).cardInfos},set deckCardInfos(T){Ke(A,l(A).cardInfos=T)},$$legacy:!0});var ae=D(z,2),J=h(ae);$n(J,()=>l(f),T=>{var B=Ul();y(T,B)},(T,B)=>{var Y=Zl(),M=ie(Y),O=h(M),le=D(h(O),2);W(()=>{l(m),Ca(()=>{l(B)})}),ke(le,5,()=>l(B),ce,(ze,Nt)=>{var bt=Ol(),ui={},Fa=h(bt);W(()=>{ui!==(ui=l(Nt).id)&&(bt.value=(bt.__value=l(Nt).id)==null?"":l(Nt).id),_(Fa,l(Nt).name)}),y(ze,bt)});var Ae=D(O,2),je=D(h(Ae),2),ft=D(Ae,2),xt=D(h(ft),2),tt=h(xt),nt=D(xt,4),jt=h(nt),Gt=D(nt,2),Mt=h(Gt),Ye=D(M,2);Ri(Ye,{mode:"Deck",allCardInfos:[],onAttention:v,get deckCardInfos(){return l(A).cardInfos},set deckCardInfos(ze){Ke(A,l(A).cardInfos=ze)},$$legacy:!0}),va(le,()=>l(m),ze=>te(m,ze)),ge("change",le,p),Gn(je,()=>l(A).name,ze=>Ke(A,l(A).name=ze)),ge("click",tt,S),ge("click",jt,q),ge("click",Mt,L),y(T,Y)}),Gn(me,()=>l(w).name,T=>Ke(w,l(w).name=T)),y(n,b),He()}const jl="2025-03-12 22:17:43",Gl={timestamp:jl},Yl=["TblDeckHeader","TblDeckDetail","TblDuelistProfile"],zl=3;var Vl=N("<option> </option>"),Ql=N('<div class="svelte-bc2zvv"><label for="deck_selector" class="deck_selector svelte-bc2zvv">デッキ：</label> <select id="deck_selector" class="deck_selector svelte-bc2zvv"></select></div> <div class="svelte-bc2zvv"><button class="btn svelte-bc2zvv">duel start!</button></div>',1),Jl=N('<div class="svelte-bc2zvv">デッキ情報の読み込み、もしくは作成中...</div>'),Xl=N('<div class="svelte-bc2zvv"><label for="duelist_name" class="duelist_name svelte-bc2zvv">名前：</label> <input id="duelist_name" class="duelist_name svelte-bc2zvv" type="text"></div> <!> <div class="svelte-bc2zvv"><button class="btn svelte-bc2zvv">deck edit</button></div>',1),eA=N('<div class="svelte-bc2zvv">デュエリスト情報の読み込み、もしくは作成中...</div>'),tA=N('<div class="app_body svelte-bc2zvv"><!></div>'),nA=N('<main class="svelte-bc2zvv"><!> <div class="debug_info svelte-bc2zvv"><span> </span> <span class="screen_info"></span></div></main>');function iA(n,e){Fe(e,!1);const t=new ds("stk_ygo_svelte",zl,Yl);let i=Ce(),r=Ce("None"),s=Ce(0);const o=zn.getOrCreateNew(t);let k=Ce(vt.getAllDeckInfo(t).then(b=>(Promise.all(b.filter($=>!$.lastUsedAt).map($=>{$.saveDeckInfo()})),te(s,(b.find($=>$.lastUsedAt.getTime()===Math.max(...b.map(E=>E.lastUsedAt.getTime())))??b[0]).id),b)));const p=async()=>{let b=(await l(k)).find($=>$.id===l(s));if(b||(b=(await m()).find($=>$.id===l(s))),!b)throw new Error("illegal state");return b},c=async()=>{(await o).save()},m=()=>(te(k,vt.getAllDeckInfo(t).then(b=>(te(s,(b.find($=>$.lastUsedAt.getTime()===Math.max(...b.map(E=>E.lastUsedAt.getTime())))??b[0]).id),b))),l(k)),f=async()=>{(await l(k)).length||(await vt.prepareSampleDeck(),m())},a=async()=>{await Promise.all([c(),f()]),(await p()).updateTimestamp(),te(i,new Ys(await o,"Player",await p(),ms[0],"NPC",kn[0]))},A=async()=>{console.log("hoge"),await Promise.all([c(),f()]),te(r,"DeckEdit")},u=async b=>{await c(),b.key==="Enter"&&!b.repeat&&(await o).save()};f(),Ie();var w=nA(),C=h(w);{var v=b=>{fl(b,{get duel(){return l(i)}})},g=b=>{var $=he(),E=ie($);{var U=se=>{$l(se,{})},re=se=>{var me=tA(),ue=h(me);$n(ue,()=>o,X=>{var x=eA();y(X,x)},(X,x)=>{var I=Xl(),ne=ie(I),Z=D(h(ne),2),ee=D(ne,2);$n(ee,()=>l(k),F=>{var P=Jl();y(F,P)},(F,P)=>{var H=Ql(),j=ie(H),z=D(h(j),2);W(()=>{l(s),Ca(()=>{l(P)})}),ke(z,5,()=>l(P),ce,(ae,J)=>{var T=Vl(),B={},Y=h(T);W(()=>{B!==(B=l(J).id)&&(T.value=(T.__value=l(J).id)==null?"":l(J).id),_(Y,l(J).name)}),y(ae,T)});var G=D(j,2),Q=h(G);va(z,()=>l(s),ae=>te(s,ae)),ge("click",Q,a),y(F,H)});var K=D(ee,2),V=h(K);Gn(Z,()=>l(x).name,F=>l(x).name=F),ge("keypress",Z,u),ge("click",V,A),y(X,I)}),y(se,me)};R(E,se=>{l(r)==="DeckEdit"?se(U):se(re,!1)},!0)}y(b,$)};R(C,b=>{l(i)?b(v):b(g,!1)})}var S=D(C,2),q=h(S),L=h(q);W(()=>_(L,`build at: ${Gl.timestamp}`)),y(n,w),He()}Or(iA,{target:document.getElementById("app")});
